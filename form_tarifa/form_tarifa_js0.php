...
<input type="hidden" name="tramoid" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tramoid']); ?>">
<input type="hidden" name="tipopagoid" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tipopagoid']); ?>">
<input type="hidden" name="vehiculoid" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['vehiculoid']); ?>">
<input type="hidden" name="fechainicio" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['fechainicio']); ?>">
<input type="hidden" name="activo" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['activo']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tarifa"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['where_detal']))
  {
?>  
...
function lookup_casetaid(campo)
{
   dados  = document.F1.casetaid.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_tarifa')?>/form_tarifa.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_casetaid, "casetaid", dados, false);
}
function recebe_casetaid(string)
{
   document.getElementById('id_lookup_casetaid').innerHTML = string;
}
<?php 
