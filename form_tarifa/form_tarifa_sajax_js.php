  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tarifa" == sTestField)
        {
...
?>
  ...
  // ---------- Validate casetaid
  function do_ajax_form_tarifa_validate_casetaid()
  {
    var nomeCampo_casetaid = "casetaid";
    var var_casetaid = scAjaxGetFieldText(nomeCampo_casetaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_casetaid(var_casetaid, var_script_case_init, do_ajax_form_tarifa_validate_casetaid_cb);
  } // do_ajax_form_tarifa_validate_casetaid

  function do_ajax_form_tarifa_validate_casetaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_casetaid_cb

  // ---------- Validate tramoid
  function do_ajax_form_tarifa_validate_tramoid()
  {
    var nomeCampo_tramoid = "tramoid";
    var var_tramoid = scAjaxGetFieldText(nomeCampo_tramoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_tramoid(var_tramoid, var_script_case_init, do_ajax_form_tarifa_validate_tramoid_cb);
  } // do_ajax_form_tarifa_validate_tramoid

  function do_ajax_form_tarifa_validate_tramoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tramoid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_tramoid_cb

  // ---------- Validate tipopagoid
  function do_ajax_form_tarifa_validate_tipopagoid()
  {
    var nomeCampo_tipopagoid = "tipopagoid";
    var var_tipopagoid = scAjaxGetFieldText(nomeCampo_tipopagoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_tipopagoid(var_tipopagoid, var_script_case_init, do_ajax_form_tarifa_validate_tipopagoid_cb);
  } // do_ajax_form_tarifa_validate_tipopagoid

  function do_ajax_form_tarifa_validate_tipopagoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_tipopagoid_cb

  // ---------- Validate vehiculoid
  function do_ajax_form_tarifa_validate_vehiculoid()
  {
    var nomeCampo_vehiculoid = "vehiculoid";
    var var_vehiculoid = scAjaxGetFieldText(nomeCampo_vehiculoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_vehiculoid(var_vehiculoid, var_script_case_init, do_ajax_form_tarifa_validate_vehiculoid_cb);
  } // do_ajax_form_tarifa_validate_vehiculoid

  function do_ajax_form_tarifa_validate_vehiculoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_vehiculoid_cb

  // ---------- Validate fechainicio
  function do_ajax_form_tarifa_validate_fechainicio()
  {
    var nomeCampo_fechainicio = "fechainicio";
    var var_fechainicio = scAjaxGetFieldText(nomeCampo_fechainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_fechainicio(var_fechainicio, var_script_case_init, do_ajax_form_tarifa_validate_fechainicio_cb);
  } // do_ajax_form_tarifa_validate_fechainicio

  function do_ajax_form_tarifa_validate_fechainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_fechainicio_cb

  // ---------- Validate fechafin
  function do_ajax_form_tarifa_validate_fechafin()
  {
    var nomeCampo_fechafin = "fechafin";
    var var_fechafin = scAjaxGetFieldText(nomeCampo_fechafin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_fechafin(var_fechafin, var_script_case_init, do_ajax_form_tarifa_validate_fechafin_cb);
  } // do_ajax_form_tarifa_validate_fechafin

  function do_ajax_form_tarifa_validate_fechafin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_fechafin_cb

  // ---------- Validate importe
  function do_ajax_form_tarifa_validate_importe()
  {
    var nomeCampo_importe = "importe";
    var var_importe = scAjaxGetFieldText(nomeCampo_importe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_importe(var_importe, var_script_case_init, do_ajax_form_tarifa_validate_importe_cb);
  } // do_ajax_form_tarifa_validate_importe

  function do_ajax_form_tarifa_validate_importe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "importe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_importe_cb

  // ---------- Validate importeejeligero
  function do_ajax_form_tarifa_validate_importeejeligero()
  {
    var nomeCampo_importeejeligero = "importeejeligero";
    var var_importeejeligero = scAjaxGetFieldText(nomeCampo_importeejeligero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_importeejeligero(var_importeejeligero, var_script_case_init, do_ajax_form_tarifa_validate_importeejeligero_cb);
  } // do_ajax_form_tarifa_validate_importeejeligero

  function do_ajax_form_tarifa_validate_importeejeligero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_importeejeligero_cb

  // ---------- Validate importeejepesado
  function do_ajax_form_tarifa_validate_importeejepesado()
  {
    var nomeCampo_importeejepesado = "importeejepesado";
    var var_importeejepesado = scAjaxGetFieldText(nomeCampo_importeejepesado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_importeejepesado(var_importeejepesado, var_script_case_init, do_ajax_form_tarifa_validate_importeejepesado_cb);
  } // do_ajax_form_tarifa_validate_importeejepesado

  function do_ajax_form_tarifa_validate_importeejepesado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_importeejepesado_cb

  // ---------- Validate fechacarga
  function do_ajax_form_tarifa_validate_fechacarga()
  {
    var nomeCampo_fechacarga = "fechacarga";
    var var_fechacarga = scAjaxGetFieldText(nomeCampo_fechacarga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_fechacarga(var_fechacarga, var_script_case_init, do_ajax_form_tarifa_validate_fechacarga_cb);
  } // do_ajax_form_tarifa_validate_fechacarga

  function do_ajax_form_tarifa_validate_fechacarga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_fechacarga_cb

  // ---------- Validate activo
  function do_ajax_form_tarifa_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_validate_activo(var_activo, var_script_case_init, do_ajax_form_tarifa_validate_activo_cb);
  } // do_ajax_form_tarifa_validate_activo

  function do_ajax_form_tarifa_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_validate_activo_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_tarifa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tarifa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tarifa_submit_form(var_casetaid, var_tramoid, var_tipopagoid, var_vehiculoid, var_fechainicio, var_fechafin, var_importe, var_importeejeligero, var_importeejepesado, var_fechacarga, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tarifa_submit_form_cb);
  } // do_ajax_form_tarifa_submit_form

  function do_ajax_form_tarifa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tarifa_submit_form_cb_after_alert);
  } // do_ajax_form_tarifa_submit_form_cb
  function do_ajax_form_tarifa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tarifa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tarifa_navigate_form()
  {
    perform_ajax_form_tarifa_navigate_form();
  }

  function perform_ajax_form_tarifa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tarifa_navigate_form(var_casetaid, var_tramoid, var_tipopagoid, var_vehiculoid, var_fechainicio, var_activo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tarifa_navigate_form_cb);
  } // do_ajax_form_tarifa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tarifa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tarifa_navigate_form_cb_after_alert);
  } // do_ajax_form_tarifa_navigate_form_cb
  function do_ajax_form_tarifa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tarifa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tarifa_navigate_form_cb_after_alert

  function sc_hide_form_tarifa_form()
  {
