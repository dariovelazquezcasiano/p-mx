...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tarifa/form_tarifa_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tarifa_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_tarifa_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['recarga'];
}
if ('' != $this->casetaid)
{
    $this->lookup_casetaid($look_rpc_casetaid);
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['link_info']['remove_border']) {
...
<?php
 include_once("form_tarifa_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tarifa'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tarifa'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-3';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_casetaid_label" id="hidden_field_label_casetaid" style="<?php echo $sStyleHidden_casetaid; ?>"><span id="id_label_casetaid"><?php echo $this->nm_new_label['casetaid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['casetaid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['casetaid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tramoid_label" id="hidden_field_label_tramoid" style="<?php echo $sStyleHidden_tramoid; ?>"><span id="id_label_tramoid"><?php echo $this->nm_new_label['tramoid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['tramoid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['tramoid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipopagoid_label" id="hidden_field_label_tipopagoid" style="<?php echo $sStyleHidden_tipopagoid; ?>"><span id="id_label_tipopagoid"><?php echo $this->nm_new_label['tipopagoid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['tipopagoid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['tipopagoid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tipopagoid_line" id="hidden_field_data_tipopagoid" style="<?php echo $sStyleHidden_tipopagoid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipopagoid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculoid_label" id="hidden_field_label_vehiculoid" style="<?php echo $sStyleHidden_vehiculoid; ?>"><span id="id_label_vehiculoid"><?php echo $this->nm_new_label['vehiculoid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['vehiculoid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['vehiculoid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculoid_line" id="hidden_field_data_vehiculoid" style="<?php echo $sStyleHidden_vehiculoid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculoid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechainicio_label" id="hidden_field_label_fechainicio" style="<?php echo $sStyleHidden_fechainicio; ?>"><span id="id_label_fechainicio"><?php echo $this->nm_new_label['fechainicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['fechainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['fechainicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechafin_label" id="hidden_field_label_fechafin" style="<?php echo $sStyleHidden_fechafin; ?>"><span id="id_label_fechafin"><?php echo $this->nm_new_label['fechafin']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importe_label" id="hidden_field_label_importe" style="<?php echo $sStyleHidden_importe; ?>"><span id="id_label_importe"><?php echo $this->nm_new_label['importe']; ?></span></TD>
    <TD class="scFormDataOdd css_importe_line" id="hidden_field_data_importe" style="<?php echo $sStyleHidden_importe; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importe_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeejeligero_label" id="hidden_field_label_importeejeligero" style="<?php echo $sStyleHidden_importeejeligero; ?>"><span id="id_label_importeejeligero"><?php echo $this->nm_new_label['importeejeligero']; ?></span></TD>
    <TD class="scFormDataOdd css_importeejeligero_line" id="hidden_field_data_importeejeligero" style="<?php echo $sStyleHidden_importeejeligero; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importeejeligero_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeejepesado_label" id="hidden_field_label_importeejepesado" style="<?php echo $sStyleHidden_importeejepesado; ?>"><span id="id_label_importeejepesado"><?php echo $this->nm_new_label['importeejepesado']; ?></span></TD>
    <TD class="scFormDataOdd css_importeejepesado_line" id="hidden_field_data_importeejepesado" style="<?php echo $sStyleHidden_importeejepesado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importeejepesado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechacarga_label" id="hidden_field_label_fechacarga" style="<?php echo $sStyleHidden_fechacarga; ?>"><span id="id_label_fechacarga"><?php echo $this->nm_new_label['fechacarga']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['fechacarga']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['fechacarga'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fechacarga_line" id="hidden_field_data_fechacarga" style="<?php echo $sStyleHidden_fechacarga; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechacarga_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_activo_label" id="hidden_field_label_activo" style="<?php echo $sStyleHidden_activo; ?>"><span id="id_label_activo"><?php echo $this->nm_new_label['activo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['activo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['php_cmp_required']['activo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['Lookup_activo'][] = '0'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['Lookup_activo'][] = '1'; ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tarifa");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tarifa");
 parent.scAjaxDetailHeight("form_tarifa", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
