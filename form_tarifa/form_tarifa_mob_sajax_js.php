  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tarifa_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate casetaid
  function do_ajax_form_tarifa_mob_validate_casetaid()
  {
    var nomeCampo_casetaid = "casetaid";
    var var_casetaid = scAjaxGetFieldText(nomeCampo_casetaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_casetaid(var_casetaid, var_script_case_init, do_ajax_form_tarifa_mob_validate_casetaid_cb);
  } // do_ajax_form_tarifa_mob_validate_casetaid

  function do_ajax_form_tarifa_mob_validate_casetaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_casetaid_cb

  // ---------- Validate tramoid
  function do_ajax_form_tarifa_mob_validate_tramoid()
  {
    var nomeCampo_tramoid = "tramoid";
    var var_tramoid = scAjaxGetFieldText(nomeCampo_tramoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_tramoid(var_tramoid, var_script_case_init, do_ajax_form_tarifa_mob_validate_tramoid_cb);
  } // do_ajax_form_tarifa_mob_validate_tramoid

  function do_ajax_form_tarifa_mob_validate_tramoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tramoid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_tramoid_cb

  // ---------- Validate tipopagoid
  function do_ajax_form_tarifa_mob_validate_tipopagoid()
  {
    var nomeCampo_tipopagoid = "tipopagoid";
    var var_tipopagoid = scAjaxGetFieldText(nomeCampo_tipopagoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_tipopagoid(var_tipopagoid, var_script_case_init, do_ajax_form_tarifa_mob_validate_tipopagoid_cb);
  } // do_ajax_form_tarifa_mob_validate_tipopagoid

  function do_ajax_form_tarifa_mob_validate_tipopagoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipopagoid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_tipopagoid_cb

  // ---------- Validate vehiculoid
  function do_ajax_form_tarifa_mob_validate_vehiculoid()
  {
    var nomeCampo_vehiculoid = "vehiculoid";
    var var_vehiculoid = scAjaxGetFieldText(nomeCampo_vehiculoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_vehiculoid(var_vehiculoid, var_script_case_init, do_ajax_form_tarifa_mob_validate_vehiculoid_cb);
  } // do_ajax_form_tarifa_mob_validate_vehiculoid

  function do_ajax_form_tarifa_mob_validate_vehiculoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vehiculoid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_vehiculoid_cb

  // ---------- Validate fechainicio
  function do_ajax_form_tarifa_mob_validate_fechainicio()
  {
    var nomeCampo_fechainicio = "fechainicio";
    var var_fechainicio = scAjaxGetFieldText(nomeCampo_fechainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_fechainicio(var_fechainicio, var_script_case_init, do_ajax_form_tarifa_mob_validate_fechainicio_cb);
  } // do_ajax_form_tarifa_mob_validate_fechainicio

  function do_ajax_form_tarifa_mob_validate_fechainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_fechainicio_cb

  // ---------- Validate fechafin
  function do_ajax_form_tarifa_mob_validate_fechafin()
  {
    var nomeCampo_fechafin = "fechafin";
    var var_fechafin = scAjaxGetFieldText(nomeCampo_fechafin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_fechafin(var_fechafin, var_script_case_init, do_ajax_form_tarifa_mob_validate_fechafin_cb);
  } // do_ajax_form_tarifa_mob_validate_fechafin

  function do_ajax_form_tarifa_mob_validate_fechafin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_fechafin_cb

  // ---------- Validate importe
  function do_ajax_form_tarifa_mob_validate_importe()
  {
    var nomeCampo_importe = "importe";
    var var_importe = scAjaxGetFieldText(nomeCampo_importe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_importe(var_importe, var_script_case_init, do_ajax_form_tarifa_mob_validate_importe_cb);
  } // do_ajax_form_tarifa_mob_validate_importe

  function do_ajax_form_tarifa_mob_validate_importe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "importe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_importe_cb

  // ---------- Validate importeejeligero
  function do_ajax_form_tarifa_mob_validate_importeejeligero()
  {
    var nomeCampo_importeejeligero = "importeejeligero";
    var var_importeejeligero = scAjaxGetFieldText(nomeCampo_importeejeligero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_importeejeligero(var_importeejeligero, var_script_case_init, do_ajax_form_tarifa_mob_validate_importeejeligero_cb);
  } // do_ajax_form_tarifa_mob_validate_importeejeligero

  function do_ajax_form_tarifa_mob_validate_importeejeligero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "importeejeligero";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_importeejeligero_cb

  // ---------- Validate importeejepesado
  function do_ajax_form_tarifa_mob_validate_importeejepesado()
  {
    var nomeCampo_importeejepesado = "importeejepesado";
    var var_importeejepesado = scAjaxGetFieldText(nomeCampo_importeejepesado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_importeejepesado(var_importeejepesado, var_script_case_init, do_ajax_form_tarifa_mob_validate_importeejepesado_cb);
  } // do_ajax_form_tarifa_mob_validate_importeejepesado

  function do_ajax_form_tarifa_mob_validate_importeejepesado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "importeejepesado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_importeejepesado_cb

  // ---------- Validate fechacarga
  function do_ajax_form_tarifa_mob_validate_fechacarga()
  {
    var nomeCampo_fechacarga = "fechacarga";
    var var_fechacarga = scAjaxGetFieldText(nomeCampo_fechacarga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_fechacarga(var_fechacarga, var_script_case_init, do_ajax_form_tarifa_mob_validate_fechacarga_cb);
  } // do_ajax_form_tarifa_mob_validate_fechacarga

  function do_ajax_form_tarifa_mob_validate_fechacarga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechacarga";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_fechacarga_cb

  // ---------- Validate activo
  function do_ajax_form_tarifa_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tarifa_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_tarifa_mob_validate_activo_cb);
  } // do_ajax_form_tarifa_mob_validate_activo

  function do_ajax_form_tarifa_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tarifa_mob_validate_activo_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_tarifa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tarifa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_casetaid = scAjaxGetFieldText("casetaid");
    var var_tramoid = scAjaxGetFieldText("tramoid");
    var var_tipopagoid = scAjaxGetFieldText("tipopagoid");
    var var_vehiculoid = scAjaxGetFieldText("vehiculoid");
    ...
    var var_importeejeligero = scAjaxGetFieldText("importeejeligero");
    var var_importeejepesado = scAjaxGetFieldText("importeejepesado");
    var var_fechacarga = scAjaxGetFieldText("fechacarga");
    ...
    scAjaxProcOn();
    x_ajax_form_tarifa_mob_submit_form(var_casetaid, var_tramoid, var_tipopagoid, var_vehiculoid, var_fechainicio, var_fechafin, var_importe, var_importeejeligero, var_importeejepesado, var_fechacarga, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tarifa_mob_submit_form_cb);
  } // do_ajax_form_tarifa_mob_submit_form

  function do_ajax_form_tarifa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tipopagoid");
      scAjaxHideErrorDisplay("vehiculoid");
      scAjaxHideErrorDisplay("fechainicio");
      scAjaxHideErrorDisplay("fechafin");
      scAjaxHideErrorDisplay("importe");
      scAjaxHideErrorDisplay("importeejeligero");
      scAjaxHideErrorDisplay("importeejepesado");
      scAjaxHideErrorDisplay("fechacarga");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tarifa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tarifa_mob_submit_form_cb
  function do_ajax_form_tarifa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tarifa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tarifa_mob_navigate_form()
  {
    perform_ajax_form_tarifa_mob_navigate_form();
  }

  function perform_ajax_form_tarifa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_tramoid = document.F2.tramoid.value;
    var var_tipopagoid = document.F2.tipopagoid.value;
    var var_vehiculoid = document.F2.vehiculoid.value;
    var var_fechainicio = document.F2.fechainicio.value;
    var var_activo = document.F2.activo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tarifa_mob_navigate_form(var_casetaid, var_tramoid, var_tipopagoid, var_vehiculoid, var_fechainicio, var_activo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tarifa_mob_navigate_form_cb);
  } // do_ajax_form_tarifa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tarifa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tarifa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tramoid.value = scAjaxGetKeyValue("tramoid");
    document.F2.tipopagoid.value = scAjaxGetKeyValue("tipopagoid");
    document.F2.vehiculoid.value = scAjaxGetKeyValue("vehiculoid");
    document.F2.fechainicio.value = scAjaxGetKeyValue("fechainicio");
    document.F2.activo.value = scAjaxGetKeyValue("activo");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tarifa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tarifa_mob_navigate_form_cb
  function do_ajax_form_tarifa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tarifa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tarifa_mob_navigate_form_cb_after_alert

  function sc_hide_form_tarifa_mob_form()
  {
  ...
  ajax_field_list[0] = "casetaid";
  ajax_field_list[1] = "tramoid";
  ajax_field_list[2] = "tipopagoid";
  ajax_field_list[3] = "vehiculoid";
  ajax_field_list[4] = "fechainicio";
  ajax_field_list[5] = "fechafin";
  ajax_field_list[6] = "importe";
  ajax_field_list[7] = "importeejeligero";
  ajax_field_list[8] = "importeejepesado";
  ajax_field_list[9] = "fechacarga";
  ajax_field_list[10] = "activo";
  ...
  var ajax_error_list = {
    ...
    "tramoid": {"label": "Tramo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipopagoid": {"label": "Tipo Pago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vehiculoid": {"label": "Vehiculo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "importe": {"label": "Importe", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "importeejeligero": {"label": "Importe Eje Ligero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "importeejepesado": {"label": "Importe Eje Pesado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechacarga": {"label": "Fecha Carga", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "casetaid": new Array(),
    "tramoid": new Array(),
    "tipopagoid": new Array(),
    "vehiculoid": new Array(),
    "fechainicio": new Array(),
    "fechafin": new Array(),
    "importe": new Array(),
    "importeejeligero": new Array(),
    "importeejepesado": new Array(),
    "fechacarga": new Array(),
    "activo": new Array()
  };
  ajax_field_mult["casetaid"][1] = "casetaid";
  ajax_field_mult["tramoid"][1] = "tramoid";
  ajax_field_mult["tipopagoid"][1] = "tipopagoid";
  ajax_field_mult["vehiculoid"][1] = "vehiculoid";
  ajax_field_mult["fechainicio"][1] = "fechainicio";
  ajax_field_mult["fechafin"][1] = "fechafin";
  ajax_field_mult["importe"][1] = "importe";
  ajax_field_mult["importeejeligero"][1] = "importeejeligero";
  ajax_field_mult["importeejepesado"][1] = "importeejepesado";
  ajax_field_mult["fechacarga"][1] = "fechacarga";
  ...
  var ajax_field_id = {
    ...
    "tipopagoid": new Array("hidden_field_label_tipopagoid", "hidden_field_data_tipopagoid"),
    "vehiculoid": new Array("hidden_field_label_vehiculoid", "hidden_field_data_vehiculoid"),
    ...
    "importeejeligero": new Array("hidden_field_label_importeejeligero", "hidden_field_data_importeejeligero"),
    "importeejepesado": new Array("hidden_field_label_importeejepesado", "hidden_field_data_importeejepesado"),
    "fechacarga": new Array("hidden_field_label_fechacarga", "hidden_field_data_fechacarga"),
  ...
  var ajax_read_only = {
    ...
    "fechafin": "on",
    "importe": "off",
    "importeejeligero": "off",
    "importeejepesado": "off",
    "fechacarga": "on",
    "activo": "on"
  };
