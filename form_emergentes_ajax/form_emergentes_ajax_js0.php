...
<input type="hidden" name="folioini_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['folioini_']); ?>">
<input type="hidden" name="foliofin_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['foliofin_']); ?>">
<input type="hidden" name="vehiculoid_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['vehiculoid_']); ?>">
<input type="hidden" name="pagoid_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['pagoid_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_emergentes_ajax"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_emergentes_ajax_submit_form(y, z);
