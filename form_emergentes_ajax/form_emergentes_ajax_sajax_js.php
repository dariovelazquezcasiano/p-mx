  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_emergentes_ajax" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_emergentes_ajax_form();
	}
...
?>
  ...
  // ---------- Validate vehiculoid_
  function do_ajax_form_emergentes_ajax_validate_vehiculoid_(iNumLinha)
  {
    var nomeCampo_vehiculoid_ = "vehiculoid_" + iNumLinha;
    var var_vehiculoid_ = scAjaxGetFieldSelect(nomeCampo_vehiculoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_ajax_validate_vehiculoid_(var_vehiculoid_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_ajax_validate_vehiculoid__cb);
  } // do_ajax_form_emergentes_ajax_validate_vehiculoid_

  function do_ajax_form_emergentes_ajax_validate_vehiculoid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "vehiculoid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "vehiculoid_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "vehiculoid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "vehiculoid_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_ajax_validate_vehiculoid__cb

  // ---------- Validate pagoid_
  function do_ajax_form_emergentes_ajax_validate_pagoid_(iNumLinha)
  {
    var nomeCampo_pagoid_ = "pagoid_" + iNumLinha;
    var var_pagoid_ = scAjaxGetFieldSelect(nomeCampo_pagoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_ajax_validate_pagoid_(var_pagoid_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_ajax_validate_pagoid__cb);
  } // do_ajax_form_emergentes_ajax_validate_pagoid_

  function do_ajax_form_emergentes_ajax_validate_pagoid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pagoid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pagoid_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pagoid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pagoid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_ajax_validate_pagoid__cb

  // ---------- Validate folioini_
  function do_ajax_form_emergentes_ajax_validate_folioini_(iNumLinha)
  {
    var nomeCampo_folioini_ = "folioini_" + iNumLinha;
    var var_folioini_ = scAjaxGetFieldText(nomeCampo_folioini_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_ajax_validate_folioini_(var_folioini_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_ajax_validate_folioini__cb);
  } // do_ajax_form_emergentes_ajax_validate_folioini_

  function do_ajax_form_emergentes_ajax_validate_folioini__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "folioini_" + iLineNumber;
    }
    else
    {
      sFieldValid = "folioini_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "folioini_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "folioini_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_ajax_validate_folioini__cb

  // ---------- Validate foliofin_
  function do_ajax_form_emergentes_ajax_validate_foliofin_(iNumLinha)
  {
    var nomeCampo_foliofin_ = "foliofin_" + iNumLinha;
    var var_foliofin_ = scAjaxGetFieldText(nomeCampo_foliofin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_ajax_validate_foliofin_(var_foliofin_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_ajax_validate_foliofin__cb);
  } // do_ajax_form_emergentes_ajax_validate_foliofin_

  function do_ajax_form_emergentes_ajax_validate_foliofin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "foliofin_" + iLineNumber;
    }
    else
    {
      sFieldValid = "foliofin_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "foliofin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "foliofin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_ajax_validate_foliofin__cb

  // ---------- Validate cantidad_
  function do_ajax_form_emergentes_ajax_validate_cantidad_(iNumLinha)
  {
  } // do_ajax_form_emergentes_ajax_validate_cantidad_

  function do_ajax_form_emergentes_ajax_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_ajax_validate_cantidad__cb

  // ---------- Validate id_
  function do_ajax_form_emergentes_ajax_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldText(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_ajax_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_ajax_validate_id__cb);
  } // do_ajax_form_emergentes_ajax_validate_id_

  function do_ajax_form_emergentes_ajax_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_ajax_validate_id__cb

  // ---------- Event onchange foliofin_
  function do_ajax_form_emergentes_ajax_event_foliofin__onchange(iSeqForm)
  {
    var var_foliofin_ = scAjaxGetFieldText("foliofin_" + iSeqForm);
    var var_folioini_ = scAjaxGetFieldText("folioini_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldHidden("cantidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_emergentes_ajax_event_foliofin__onchange(var_foliofin_, var_folioini_, var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_emergentes_ajax_event_foliofin__onchange_cb);
  } // do_ajax_form_emergentes_ajax_event_foliofin__onchange

  function do_ajax_form_emergentes_ajax_event_foliofin__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_emergentes_ajax_event_foliofin__onchange_cb_after_alert);
  } // do_ajax_form_emergentes_ajax_event_foliofin__onchange_cb
  function do_ajax_form_emergentes_ajax_event_foliofin__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_emergentes_ajax_event_foliofin__onchange_cb_after_alert

  // ---------- Event onchange folioini_
  function do_ajax_form_emergentes_ajax_event_folioini__onchange(iSeqForm)
  {
    var var_foliofin_ = scAjaxGetFieldText("foliofin_" + iSeqForm);
    var var_folioini_ = scAjaxGetFieldText("folioini_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldHidden("cantidad_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_emergentes_ajax_event_folioini__onchange(var_foliofin_, var_folioini_, var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_emergentes_ajax_event_folioini__onchange_cb);
  } // do_ajax_form_emergentes_ajax_event_folioini__onchange

  function do_ajax_form_emergentes_ajax_event_folioini__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_emergentes_ajax_event_folioini__onchange_cb_after_alert);
  } // do_ajax_form_emergentes_ajax_event_folioini__onchange_cb
  function do_ajax_form_emergentes_ajax_event_folioini__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_emergentes_ajax_event_folioini__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_emergentes_ajax_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_emergentes_ajax_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_emergentes_ajax_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_emergentes_ajax_add_new_line_cb);
  } // do_ajax_form_emergentes_ajax_add_new_line

  function do_ajax_form_emergentes_ajax_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_emergentes_ajax_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_emergentes_ajax_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_folioini_ = scAjaxGetFieldText("folioini_" + iNumLinha);
    var var_foliofin_ = scAjaxGetFieldText("foliofin_" + iNumLinha);
    var var_vehiculoid_ = scAjaxGetFieldSelect("vehiculoid_" + iNumLinha);
    var var_pagoid_ = scAjaxGetFieldSelect("pagoid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_ajax_backup_line(var_id_, var_folioini_, var_foliofin_, var_vehiculoid_, var_pagoid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_emergentes_ajax_backup_line_cb);
  } // do_ajax_form_emergentes_ajax_backup_line

  function do_ajax_form_emergentes_ajax_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_emergentes_ajax_backup_line_cb

  function do_ajax_form_emergentes_ajax_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_emergentes_ajax_cancel_insert

  function do_ajax_form_emergentes_ajax_cancel_update(iSeqVert)
  {
    do_ajax_form_emergentes_ajax_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_emergentes_ajax_cancel_update

  function do_ajax_form_emergentes_ajax_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_emergentes_ajax_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_emergentes_ajax_table_refresh()
  {
    var var_id_ = document.F2.id_.value;
    var var_folioini_ = document.F2.folioini_.value;
    var var_foliofin_ = document.F2.foliofin_.value;
    var var_vehiculoid_ = document.F2.vehiculoid_.value;
    var var_pagoid_ = document.F2.pagoid_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_emergentes_ajax_table_refresh(var_id_, var_folioini_, var_foliofin_, var_vehiculoid_, var_pagoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_emergentes_ajax_table_refresh_cb);
  } //  do_ajax_form_emergentes_ajax_table_refresh

  function do_ajax_form_emergentes_ajax_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.folioini_.value = scAjaxGetKeyValue("folioini_");
    document.F2.foliofin_.value = scAjaxGetKeyValue("foliofin_");
    document.F2.vehiculoid_.value = scAjaxGetKeyValue("vehiculoid_");
    document.F2.pagoid_.value = scAjaxGetKeyValue("pagoid_");
    ...
    scAjaxAlert(do_ajax_form_emergentes_ajax_table_refresh_cb_after_alert);
  } // do_ajax_form_emergentes_ajax_table_refresh_cb
  function do_ajax_form_emergentes_ajax_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_emergentes_ajax_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_emergentes_ajax_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_emergentes_ajax_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_folioini_ = scAjaxGetFieldText("folioini_" + iNumLinha);
    var var_foliofin_ = scAjaxGetFieldText("foliofin_" + iNumLinha);
    var var_cantidad_ = scAjaxGetFieldHidden("cantidad_" + iNumLinha);
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_emergentes_ajax_submit_form(var_vehiculoid_, var_pagoid_, var_folioini_, var_foliofin_, var_cantidad_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_emergentes_ajax_submit_form_cb);
  } // do_ajax_form_emergentes_ajax_submit_form

  function do_ajax_form_emergentes_ajax_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("vehiculoid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pagoid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("folioini_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("foliofin_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_emergentes_ajax_submit_form_cb_after_alert);
  } // do_ajax_form_emergentes_ajax_submit_form_cb
  function do_ajax_form_emergentes_ajax_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_emergentes_ajax_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_emergentes_ajax_navigate_form()
  {
    perform_ajax_form_emergentes_ajax_navigate_form();
  }

  function perform_ajax_form_emergentes_ajax_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_emergentes_ajax_cancel_insert(sc_form_emergentes_ajax_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("vehiculoid_" + iNavForm);
      scAjaxHideErrorDisplay("pagoid_" + iNavForm);
      scAjaxHideErrorDisplay("folioini_" + iNavForm);
      scAjaxHideErrorDisplay("foliofin_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_emergentes_ajax_navigate_form(var_id_, var_folioini_, var_foliofin_, var_vehiculoid_, var_pagoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_emergentes_ajax_navigate_form_cb);
  } // do_ajax_form_emergentes_ajax_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_emergentes_ajax']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_emergentes_ajax_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.folioini_.value = scAjaxGetKeyValue("folioini_" + var_last_index);
    document.F2.foliofin_.value = scAjaxGetKeyValue("foliofin_" + var_last_index);
    document.F2.vehiculoid_.value = scAjaxGetKeyValue("vehiculoid_" + var_last_index);
    document.F2.pagoid_.value = scAjaxGetKeyValue("pagoid_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_emergentes_ajax_navigate_form_cb_after_alert);
  } // do_ajax_form_emergentes_ajax_navigate_form_cb
  function do_ajax_form_emergentes_ajax_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_emergentes_ajax_navigate_form_cb_after_alert

    function sc_form_emergentes_ajax_get_last_line_number()
    {
    ...
    } //sc_form_emergentes_ajax_get_last_line_number

  function sc_hide_form_emergentes_ajax_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "vehiculoid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pagoid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "folioini_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "foliofin_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cantidad_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["vehiculoid_" + iNumLinha] = {"label": "Vehiculo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pagoid_" + iNumLinha] = {"label": "Pago<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["folioini_" + iNumLinha] = {"label": "Folio Ini<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["foliofin_" + iNumLinha] = {"label": "Folio Fin<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["vehiculoid_"][iNumLinha] = "vehiculoid_" + iNumLinha;
    ajax_field_mult["pagoid_"][iNumLinha] = "pagoid_" + iNumLinha;
    ajax_field_mult["folioini_"][iNumLinha] = "folioini_" + iNumLinha;
    ajax_field_mult["foliofin_"][iNumLinha] = "foliofin_" + iNumLinha;
    ajax_field_mult["cantidad_"][iNumLinha] = "cantidad_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["vehiculoid_" + iNumLinha] = new Array("hidden_field_label_vehiculoid_", "hidden_field_data_vehiculoid_" + iNumLinha);
    ajax_field_id["pagoid_" + iNumLinha] = new Array("hidden_field_label_pagoid_", "hidden_field_data_pagoid_" + iNumLinha);
    ajax_field_id["folioini_" + iNumLinha] = new Array("hidden_field_label_folioini_", "hidden_field_data_folioini_" + iNumLinha);
    ajax_field_id["foliofin_" + iNumLinha] = new Array("hidden_field_label_foliofin_", "hidden_field_data_foliofin_" + iNumLinha);
    ajax_field_id["cantidad_" + iNumLinha] = new Array("hidden_field_label_cantidad_", "hidden_field_data_cantidad_" + iNumLinha);
    ajax_error_count["vehiculoid_" + iNumLinha] = "off";
    ajax_error_count["pagoid_" + iNumLinha] = "off";
    ajax_error_count["folioini_" + iNumLinha] = "off";
    ajax_error_count["foliofin_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["vehiculoid_" + iNumLinha] = "on";
    ajax_read_only["pagoid_" + iNumLinha] = "on";
    ajax_read_only["folioini_" + iNumLinha] = "on";
    ajax_read_only["foliofin_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["vehiculoid_" + iNumLinha] = null;
    ajax_error_list["pagoid_" + iNumLinha] = null;
    ajax_error_list["folioini_" + iNumLinha] = null;
    ajax_error_list["foliofin_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["vehiculoid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["vehiculoid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["vehiculoid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["vehiculoid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["vehiculoid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pagoid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pagoid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pagoid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pagoid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pagoid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["folioini_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["folioini_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["folioini_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["folioini_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["folioini_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["foliofin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["foliofin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["foliofin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["foliofin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["foliofin_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['vehiculoid_'])) ? $this->nmgp_cmp_readonly['vehiculoid_'] : 'on';
?>
    scAjaxFieldRead("vehiculoid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pagoid_'])) ? $this->nmgp_cmp_readonly['pagoid_'] : 'on';
?>
    scAjaxFieldRead("pagoid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['folioini_'])) ? $this->nmgp_cmp_readonly['folioini_'] : 'on';
?>
    scAjaxFieldRead("folioini_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['foliofin_'])) ? $this->nmgp_cmp_readonly['foliofin_'] : 'on';
?>
    scAjaxFieldRead("foliofin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("vehiculoid_" + iSeq, "on");
    scAjaxFieldRead("pagoid_" + iSeq, "on");
    scAjaxFieldRead("folioini_" + iSeq, "on");
    scAjaxFieldRead("foliofin_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["vehiculoid_" + iRow] || "on" == ajax_error_count["pagoid_" + iRow] || "on" == ajax_error_count["folioini_" + iRow] || "on" == ajax_error_count["foliofin_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_vehiculoid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pagoid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_folioini_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_foliofin_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["vehiculoid_" + iRow] && "off" == ajax_error_count["pagoid_" + iRow] && "off" == ajax_error_count["folioini_" + iRow] && "off" == ajax_error_count["foliofin_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["vehiculoid_" + iRow] = "off";
        ajax_error_count["pagoid_" + iRow] = "off";
        ajax_error_count["folioini_" + iRow] = "off";
        ajax_error_count["foliofin_" + iRow] = "off";
      ...
      $("#hidden_field_data_vehiculoid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pagoid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_folioini_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_foliofin_" + iRow).removeClass("scFormErrorLine");
