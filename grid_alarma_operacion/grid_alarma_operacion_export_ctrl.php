<?php
@session_start() ;
$_SESSION['scriptcase']['grid_alarma_operacion']['sc_process_barr'] = true;
require_once('../grid_alarma_operacion/index.php');
unset($_SESSION['scriptcase']['grid_alarma_operacion']['sc_process_barr']);
$ExportCtrl = new grid_alarma_operacion_export_control;
$ExportCtrl->Export_barr();

class grid_alarma_operacion_export_control
{
