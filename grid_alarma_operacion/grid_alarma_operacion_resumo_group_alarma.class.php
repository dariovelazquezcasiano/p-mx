...
class grid_alarma_operacion_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_alarma_operacion']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_alarma_operacion']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['grid_alarma_operacion']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['contr_total_geral'] == "OK")
      {
          $this->array_total_alarmaid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['arr_total']['alarmaid'];
      }
      else
      {
          $this->array_total_alarmaid = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['arr_total']['alarmaid'] = $this->array_total_alarmaid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['hora']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['hora'] = "Hora"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['descripcion'] = "Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['consecutivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['consecutivo'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['turnoid'] = "Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['usuarioid'] = "Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['carrilid'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['carrilnacional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['carrilnacional'] = "Carril Nacional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['alarmaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['alarmaid'] = "Alarma"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['casetaid'] = "Caseta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['enviado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['enviado'] = "Enviado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['folio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['labels']['folio'] = "Folio"; 
       }
       //-----
       $this->comp_field_nm = array(
           'alarmaid' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_order']['group_alarma']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_order']['group_alarma'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_order']['group_alarma'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_display']['group_alarma'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_display']['group_alarma'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_display']['group_alarma'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_display']['group_alarma'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_display']['group_alarma'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_display']['group_alarma'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['summarizing_fields_display']['group_alarma'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_alarmaid as $i_alarmaid => $d_alarmaid) {
           if (!isset($i_alarmaid, $this->comp_label[0]) || !in_array($i_alarmaid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_alarmaid[3] ] = $d_alarmaid[2];
               $this->comp_label[0][ $d_alarmaid[3] ] = $d_alarmaid[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_alarmaid => $l_alarmaid) {
           if (isset($this->array_total_alarmaid[$i_alarmaid])) {
               $this->comp_group[$i_alarmaid] = array();
           }
       }
     }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_alarma_operacion@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_alarma_operacion_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_alarma_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_alarma_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_alarma_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_alarma_operacion/grid_alarma_operacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_alarma_operacion_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_alarma_operacion']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_alarma_operacion']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_alarma_operacion_config_pivot.php?nome_apl=grid_alarma_operacion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_alarma_operacion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_alarma_operacion/grid_alarma_operacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_alarma_operacion_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_charts']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_alarma_operacion_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_alarma_operacion_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_alarma_operacion_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['pivot_charts'] as $chart_index => $chart_data)
       {
           $qtd_col++;
           if ($qtd_col > $lim_col)
           {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_alarma_operacion_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       if ($bChartFP)
       {
           ...
           grid_alarma_operacion_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
       }
   }
 }
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alarma_operacion']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($quebra_alarmaid, $quebra_alarmaid_orig)
   {
      //----- Alarma
      if (!isset($this->array_total_alarmaid[$quebra_alarmaid_orig]))
      {
         $this->array_total_alarmaid[$quebra_alarmaid_orig][0] = 1;
         $this->array_total_alarmaid[$quebra_alarmaid_orig][1] = 1;
         $this->array_total_alarmaid[$quebra_alarmaid_orig][2] = $quebra_alarmaid;
         $this->array_total_alarmaid[$quebra_alarmaid_orig][3] = $quebra_alarmaid_orig;
      }
      else
      {
         $this->array_total_alarmaid[$quebra_alarmaid_orig][0]++;
         $this->array_total_alarmaid[$quebra_alarmaid_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->alarmaid = $rs_res->fields[2] ;  
            $this->usuarioid = $rs_res->fields[3] ;  
            $this->consecutivo = $rs_res->fields[4] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->alarmaid, $this->alarmaid_orig);
            }
   }
//
