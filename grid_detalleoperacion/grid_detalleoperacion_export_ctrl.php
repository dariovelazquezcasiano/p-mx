<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleoperacion']['sc_process_barr'] = true;
require_once('../grid_detalleoperacion/index.php');
unset($_SESSION['scriptcase']['grid_detalleoperacion']['sc_process_barr']);
$ExportCtrl = new grid_detalleoperacion_export_control;
$ExportCtrl->Export_barr();

class grid_detalleoperacion_export_control
{
