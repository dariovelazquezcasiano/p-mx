<?php
@session_start() ;
$_SESSION['scriptcase']['grid_eventos_cortes']['sc_process_barr'] = true;
require_once('../grid_eventos_cortes/index.php');
unset($_SESSION['scriptcase']['grid_eventos_cortes']['sc_process_barr']);
$ExportCtrl = new grid_eventos_cortes_export_control;
$ExportCtrl->Export_barr();

class grid_eventos_cortes_export_control
{
