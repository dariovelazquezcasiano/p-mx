  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sc_log" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_sc_log_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_id(var_id, var_script_case_init, do_ajax_form_sc_log_validate_id_cb);
  } // do_ajax_form_sc_log_validate_id

  function do_ajax_form_sc_log_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_id_cb

  // ---------- Validate inserted_date
  function do_ajax_form_sc_log_validate_inserted_date()
  {
    var nomeCampo_inserted_date = "inserted_date";
    var var_inserted_date = scAjaxGetFieldText(nomeCampo_inserted_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_inserted_date(var_inserted_date, var_script_case_init, do_ajax_form_sc_log_validate_inserted_date_cb);
  } // do_ajax_form_sc_log_validate_inserted_date

  function do_ajax_form_sc_log_validate_inserted_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_inserted_date_cb

  // ---------- Validate username
  function do_ajax_form_sc_log_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldText(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_username(var_username, var_script_case_init, do_ajax_form_sc_log_validate_username_cb);
  } // do_ajax_form_sc_log_validate_username

  function do_ajax_form_sc_log_validate_username_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_username_cb

  // ---------- Validate application
  function do_ajax_form_sc_log_validate_application()
  {
    var nomeCampo_application = "application";
    var var_application = scAjaxGetFieldText(nomeCampo_application);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_application(var_application, var_script_case_init, do_ajax_form_sc_log_validate_application_cb);
  } // do_ajax_form_sc_log_validate_application

  function do_ajax_form_sc_log_validate_application_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_application_cb

  // ---------- Validate creator
  function do_ajax_form_sc_log_validate_creator()
  {
    var nomeCampo_creator = "creator";
    var var_creator = scAjaxGetFieldText(nomeCampo_creator);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_creator(var_creator, var_script_case_init, do_ajax_form_sc_log_validate_creator_cb);
  } // do_ajax_form_sc_log_validate_creator

  function do_ajax_form_sc_log_validate_creator_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creator";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_creator_cb

  // ---------- Validate ip_user
  function do_ajax_form_sc_log_validate_ip_user()
  {
    var nomeCampo_ip_user = "ip_user";
    var var_ip_user = scAjaxGetFieldText(nomeCampo_ip_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_ip_user(var_ip_user, var_script_case_init, do_ajax_form_sc_log_validate_ip_user_cb);
  } // do_ajax_form_sc_log_validate_ip_user

  function do_ajax_form_sc_log_validate_ip_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip_user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_ip_user_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_sc_log_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_sc_log_validate_sc_field_0_cb);
  } // do_ajax_form_sc_log_validate_sc_field_0

  function do_ajax_form_sc_log_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_sc_field_0_cb

  // ---------- Validate description
  function do_ajax_form_sc_log_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_validate_description(var_description, var_script_case_init, do_ajax_form_sc_log_validate_description_cb);
  } // do_ajax_form_sc_log_validate_description

  function do_ajax_form_sc_log_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_validate_description_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sc_log_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sc_log_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sc_log_submit_form(var_id, var_inserted_date, var_username, var_application, var_creator, var_ip_user, var_sc_field_0, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sc_log_submit_form_cb);
  } // do_ajax_form_sc_log_submit_form

  function do_ajax_form_sc_log_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sc_log_submit_form_cb_after_alert);
  } // do_ajax_form_sc_log_submit_form_cb
  function do_ajax_form_sc_log_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sc_log_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sc_log_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sc_log_navigate_form, function() {});
    } else {
      perform_ajax_form_sc_log_navigate_form();
    }
  }

  function perform_ajax_form_sc_log_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sc_log_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sc_log_navigate_form_cb);
  } // do_ajax_form_sc_log_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sc_log']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sc_log_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sc_log_navigate_form_cb_after_alert);
  } // do_ajax_form_sc_log_navigate_form_cb
  function do_ajax_form_sc_log_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sc_log_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sc_log_navigate_form_cb_after_alert

  function sc_hide_form_sc_log_form()
  {
