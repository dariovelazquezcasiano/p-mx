  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sc_log_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_sc_log_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_id(var_id, var_script_case_init, do_ajax_form_sc_log_mob_validate_id_cb);
  } // do_ajax_form_sc_log_mob_validate_id

  function do_ajax_form_sc_log_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_id_cb

  // ---------- Validate inserted_date
  function do_ajax_form_sc_log_mob_validate_inserted_date()
  {
    var nomeCampo_inserted_date = "inserted_date";
    var var_inserted_date = scAjaxGetFieldText(nomeCampo_inserted_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_inserted_date(var_inserted_date, var_script_case_init, do_ajax_form_sc_log_mob_validate_inserted_date_cb);
  } // do_ajax_form_sc_log_mob_validate_inserted_date

  function do_ajax_form_sc_log_mob_validate_inserted_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inserted_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_inserted_date_cb

  // ---------- Validate username
  function do_ajax_form_sc_log_mob_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldText(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_username(var_username, var_script_case_init, do_ajax_form_sc_log_mob_validate_username_cb);
  } // do_ajax_form_sc_log_mob_validate_username

  function do_ajax_form_sc_log_mob_validate_username_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_username_cb

  // ---------- Validate application
  function do_ajax_form_sc_log_mob_validate_application()
  {
    var nomeCampo_application = "application";
    var var_application = scAjaxGetFieldText(nomeCampo_application);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_application(var_application, var_script_case_init, do_ajax_form_sc_log_mob_validate_application_cb);
  } // do_ajax_form_sc_log_mob_validate_application

  function do_ajax_form_sc_log_mob_validate_application_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "application";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_application_cb

  // ---------- Validate creator
  function do_ajax_form_sc_log_mob_validate_creator()
  {
    var nomeCampo_creator = "creator";
    var var_creator = scAjaxGetFieldText(nomeCampo_creator);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_creator(var_creator, var_script_case_init, do_ajax_form_sc_log_mob_validate_creator_cb);
  } // do_ajax_form_sc_log_mob_validate_creator

  function do_ajax_form_sc_log_mob_validate_creator_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creator";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_creator_cb

  // ---------- Validate ip_user
  function do_ajax_form_sc_log_mob_validate_ip_user()
  {
    var nomeCampo_ip_user = "ip_user";
    var var_ip_user = scAjaxGetFieldText(nomeCampo_ip_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_ip_user(var_ip_user, var_script_case_init, do_ajax_form_sc_log_mob_validate_ip_user_cb);
  } // do_ajax_form_sc_log_mob_validate_ip_user

  function do_ajax_form_sc_log_mob_validate_ip_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip_user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_ip_user_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_sc_log_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_sc_log_mob_validate_sc_field_0_cb);
  } // do_ajax_form_sc_log_mob_validate_sc_field_0

  function do_ajax_form_sc_log_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_sc_field_0_cb

  // ---------- Validate description
  function do_ajax_form_sc_log_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sc_log_mob_validate_description(var_description, var_script_case_init, do_ajax_form_sc_log_mob_validate_description_cb);
  } // do_ajax_form_sc_log_mob_validate_description

  function do_ajax_form_sc_log_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sc_log_mob_validate_description_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sc_log_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sc_log_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_inserted_date = scAjaxGetFieldText("inserted_date");
    var var_username = scAjaxGetFieldText("username");
    var var_application = scAjaxGetFieldText("application");
    var var_creator = scAjaxGetFieldText("creator");
    var var_ip_user = scAjaxGetFieldText("ip_user");
    ...
    scAjaxProcOn();
    x_ajax_form_sc_log_mob_submit_form(var_id, var_inserted_date, var_username, var_application, var_creator, var_ip_user, var_sc_field_0, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sc_log_mob_submit_form_cb);
  } // do_ajax_form_sc_log_mob_submit_form

  function do_ajax_form_sc_log_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("inserted_date");
      scAjaxHideErrorDisplay("username");
      scAjaxHideErrorDisplay("application");
      scAjaxHideErrorDisplay("creator");
      scAjaxHideErrorDisplay("ip_user");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sc_log_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sc_log_mob_submit_form_cb
  function do_ajax_form_sc_log_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sc_log_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sc_log_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sc_log_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_sc_log_mob_navigate_form();
    }
  }

  function perform_ajax_form_sc_log_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sc_log_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sc_log_mob_navigate_form_cb);
  } // do_ajax_form_sc_log_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sc_log_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sc_log_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sc_log_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sc_log_mob_navigate_form_cb
  function do_ajax_form_sc_log_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sc_log_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sc_log_mob_navigate_form_cb_after_alert

  function sc_hide_form_sc_log_mob_form()
  {
  ...
  ajax_field_list[1] = "inserted_date";
  ajax_field_list[2] = "username";
  ajax_field_list[3] = "application";
  ajax_field_list[4] = "creator";
  ajax_field_list[5] = "ip_user";
  ajax_field_list[6] = "sc_field_0";
  ajax_field_list[7] = "description";
  ...
  var ajax_error_list = {
    ...
    "inserted_date": {"label": "Inserted Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "username": {"label": "Username", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "application": {"label": "Action", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "creator": {"label": "Description", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ip_user": {"label": "Ip User", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "Action", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["inserted_date"][1] = "inserted_date";
  ajax_field_mult["username"][1] = "username";
  ajax_field_mult["application"][1] = "application";
  ajax_field_mult["creator"][1] = "creator";
  ajax_field_mult["ip_user"][1] = "ip_user";
  ...
  var ajax_field_id = {
    ...
    "inserted_date": new Array("hidden_field_label_inserted_date", "hidden_field_data_inserted_date"),
    "username": new Array("hidden_field_label_username", "hidden_field_data_username"),
    "application": new Array("hidden_field_label_application", "hidden_field_data_application"),
    "creator": new Array("hidden_field_label_creator", "hidden_field_data_creator"),
    "ip_user": new Array("hidden_field_label_ip_user", "hidden_field_data_ip_user"),
