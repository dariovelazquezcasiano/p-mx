<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_aforo']['sc_process_barr'] = true;
require_once('../pdfreport_aforo/index.php');
unset($_SESSION['scriptcase']['pdfreport_aforo']['sc_process_barr']);
$ExportCtrl = new pdfreport_aforo_export_control;
$ExportCtrl->Export_barr();

class pdfreport_aforo_export_control
{
