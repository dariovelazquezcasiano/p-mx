...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_muestra_ingresoEluPre/form_muestra_ingresoEluPre_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_muestra_ingresoEluPre_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_muestra_ingresoEluPre_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_muestra_ingresoEluPre']['error_buffer']) && '' != $_SESSION['scriptcase']['form_muestra_ingresoEluPre']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_muestra_ingresoEluPre']['error_buffer'];
}
...
<?php
 include_once("form_muestra_ingresoEluPre_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_muestra_ingresoEluPre_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_muestra_ingresoEluPre_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_muestra_ingresoEluPre_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_consecutivo_line" id="hidden_field_data_consecutivo" style="<?php echo $sStyleHidden_consecutivo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consecutivo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_consecutivo_label" style=""><span id="id_label_consecutivo"><?php echo $this->nm_new_label['consecutivo']; ?></span></span><br><span id="id_read_on_consecutivo" class="css_consecutivo_line" style="<?php echo $sStyleReadLab_consecutivo; ?>"><?php echo $this->form_format_readonly("consecutivo", $this->form_encode_input($this->consecutivo)); ?></span><span id="id_read_off_consecutivo" class="css_read_off_consecutivo" style="<?php echo $sStyleReadInp_consecutivo; ?>"><input type="hidden" name="consecutivo" value="<?php echo $this->form_encode_input($consecutivo) . "\">"?><span id="id_ajax_label_consecutivo"><?php echo nl2br($consecutivo); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cuerpo_line" id="hidden_field_data_cuerpo" style="<?php echo $sStyleHidden_cuerpo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cuerpo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cuerpo_label" style=""><span id="id_label_cuerpo"><?php echo $this->nm_new_label['cuerpo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_carrilid_line" id="hidden_field_data_carrilid" style="<?php echo $sStyleHidden_carrilid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_carrilid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_carrilid_label" style=""><span id="id_label_carrilid"><?php echo $this->nm_new_label['carrilid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechaoperacion_line" id="hidden_field_data_fechaoperacion" style="<?php echo $sStyleHidden_fechaoperacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechaoperacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechaoperacion_label" style=""><span id="id_label_fechaoperacion"><?php echo $this->nm_new_label['fechaoperacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['php_cmp_required']['fechaoperacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['php_cmp_required']['fechaoperacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechaturno_line" id="hidden_field_data_fechaturno" style="<?php echo $sStyleHidden_fechaturno; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechaturno_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechaturno_label" style=""><span id="id_label_fechaturno"><?php echo $this->nm_new_label['fechaturno']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['php_cmp_required']['fechaturno']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['php_cmp_required']['fechaturno'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_horainicio_line" id="hidden_field_data_horainicio" style="<?php echo $sStyleHidden_horainicio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_horainicio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_horainicio_label" style=""><span id="id_label_horainicio"><?php echo $this->nm_new_label['horainicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['php_cmp_required']['horainicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_operacionid_line" id="hidden_field_data_operacionid" style="<?php echo $sStyleHidden_operacionid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_operacionid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_operacionid_label" style=""><span id="id_label_operacionid"><?php echo $this->nm_new_label['operacionid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliocierre_line" id="hidden_field_data_foliocierre" style="<?php echo $sStyleHidden_foliocierre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foliocierre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_foliocierre_label" style=""><span id="id_label_foliocierre"><?php echo $this->nm_new_label['foliocierre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estatuscarril_line" id="hidden_field_data_estatuscarril" style="<?php echo $sStyleHidden_estatuscarril; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estatuscarril_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estatuscarril_label" style=""><span id="id_label_estatuscarril"><?php echo $this->nm_new_label['estatuscarril']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_preliquidado_line" id="hidden_field_data_preliquidado" style="<?php echo $sStyleHidden_preliquidado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_preliquidado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_preliquidado_label" style=""><span id="id_label_preliquidado"><?php echo $this->nm_new_label['preliquidado']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_montocr_line" id="hidden_field_data_montocr" style="<?php echo $sStyleHidden_montocr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_montocr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_montocr_label" style=""><span id="id_label_montocr"><?php echo $this->nm_new_label['montocr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_montoana_line" id="hidden_field_data_montoana" style="<?php echo $sStyleHidden_montoana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_montoana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_montoana_label" style=""><span id="id_label_montoana"><?php echo $this->nm_new_label['montoana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantidadmxn_line" id="hidden_field_data_cantidadmxn" style="<?php echo $sStyleHidden_cantidadmxn; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cantidadmxn_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cantidadmxn_label" style=""><span id="id_label_cantidadmxn"><?php echo $this->nm_new_label['cantidadmxn']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantidadusd_line" id="hidden_field_data_cantidadusd" style="<?php echo $sStyleHidden_cantidadusd; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cantidadusd_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cantidadusd_label" style=""><span id="id_label_cantidadusd"><?php echo $this->nm_new_label['cantidadusd']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importemxn_line" id="hidden_field_data_importemxn" style="<?php echo $sStyleHidden_importemxn; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importemxn_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_importemxn_label" style=""><span id="id_label_importemxn"><?php echo $this->nm_new_label['importemxn']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importeusd_line" id="hidden_field_data_importeusd" style="<?php echo $sStyleHidden_importeusd; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importeusd_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_importeusd_label" style=""><span id="id_label_importeusd"><?php echo $this->nm_new_label['importeusd']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_folioinicialcr_line" id="hidden_field_data_folioinicialcr" style="<?php echo $sStyleHidden_folioinicialcr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_folioinicialcr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_folioinicialcr_label" style=""><span id="id_label_folioinicialcr"><?php echo $this->nm_new_label['folioinicialcr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliofinalcr_line" id="hidden_field_data_foliofinalcr" style="<?php echo $sStyleHidden_foliofinalcr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foliofinalcr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_foliofinalcr_label" style=""><span id="id_label_foliofinalcr"><?php echo $this->nm_new_label['foliofinalcr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_folioinicialeap_line" id="hidden_field_data_folioinicialeap" style="<?php echo $sStyleHidden_folioinicialeap; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_folioinicialeap_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_folioinicialeap_label" style=""><span id="id_label_folioinicialeap"><?php echo $this->nm_new_label['folioinicialeap']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliofinaleap_line" id="hidden_field_data_foliofinaleap" style="<?php echo $sStyleHidden_foliofinaleap; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foliofinaleap_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_foliofinaleap_label" style=""><span id="id_label_foliofinaleap"><?php echo $this->nm_new_label['foliofinaleap']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_faltante_line" id="hidden_field_data_faltante" style="<?php echo $sStyleHidden_faltante; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_faltante_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_faltante_label" style=""><span id="id_label_faltante"><?php echo $this->nm_new_label['faltante']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ingresoelu_pre_line" id="hidden_field_data_ingresoelu_pre" style="<?php echo $sStyleHidden_ingresoelu_pre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ingresoelu_pre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ingresoelu_pre_label" style=""><span id="id_label_ingresoelu_pre"><?php echo $this->nm_new_label['ingresoelu_pre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_entregado_line" id="hidden_field_data_entregado" style="<?php echo $sStyleHidden_entregado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_entregado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_entregado_label" style=""><span id="id_label_entregado"><?php echo $this->nm_new_label['entregado']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_administradorid_line" id="hidden_field_data_administradorid" style="<?php echo $sStyleHidden_administradorid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_administradorid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_administradorid_label" style=""><span id="id_label_administradorid"><?php echo $this->nm_new_label['administradorid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_encargadoturnoid_line" id="hidden_field_data_encargadoturnoid" style="<?php echo $sStyleHidden_encargadoturnoid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_encargadoturnoid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_encargadoturnoid_label" style=""><span id="id_label_encargadoturnoid"><?php echo $this->nm_new_label['encargadoturnoid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_encargadoturnoid_pre_line" id="hidden_field_data_encargadoturnoid_pre" style="<?php echo $sStyleHidden_encargadoturnoid_pre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_encargadoturnoid_pre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_encargadoturnoid_pre_label" style=""><span id="id_label_encargadoturnoid_pre"><?php echo $this->nm_new_label['encargadoturnoid_pre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechacierre_line" id="hidden_field_data_fechacierre" style="<?php echo $sStyleHidden_fechacierre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechacierre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechacierre_label" style=""><span id="id_label_fechacierre"><?php echo $this->nm_new_label['fechacierre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechapreliq_line" id="hidden_field_data_fechapreliq" style="<?php echo $sStyleHidden_fechapreliq; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechapreliq_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechapreliq_label" style=""><span id="id_label_fechapreliq"><?php echo $this->nm_new_label['fechapreliq']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechaliq_line" id="hidden_field_data_fechaliq" style="<?php echo $sStyleHidden_fechaliq; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechaliq_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechaliq_label" style=""><span id="id_label_fechaliq"><?php echo $this->nm_new_label['fechaliq']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_operacion_line" id="hidden_field_data_operacion" style="<?php echo $sStyleHidden_operacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_operacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_operacion_label" style=""><span id="id_label_operacion"><?php echo $this->nm_new_label['operacion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_liquidadorid_line" id="hidden_field_data_liquidadorid" style="<?php echo $sStyleHidden_liquidadorid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_liquidadorid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_liquidadorid_label" style=""><span id="id_label_liquidadorid"><?php echo $this->nm_new_label['liquidadorid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_faltanteana_line" id="hidden_field_data_faltanteana" style="<?php echo $sStyleHidden_faltanteana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_faltanteana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_faltanteana_label" style=""><span id="id_label_faltanteana"><?php echo $this->nm_new_label['faltanteana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ingresoelu_ana_line" id="hidden_field_data_ingresoelu_ana" style="<?php echo $sStyleHidden_ingresoelu_ana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ingresoelu_ana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ingresoelu_ana_label" style=""><span id="id_label_ingresoelu_ana"><?php echo $this->nm_new_label['ingresoelu_ana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_conteo_line" id="hidden_field_data_conteo" style="<?php echo $sStyleHidden_conteo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_conteo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_conteo_label" style=""><span id="id_label_conteo"><?php echo $this->nm_new_label['conteo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechainiciodictamen_line" id="hidden_field_data_fechainiciodictamen" style="<?php echo $sStyleHidden_fechainiciodictamen; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechainiciodictamen_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechainiciodictamen_label" style=""><span id="id_label_fechainiciodictamen"><?php echo $this->nm_new_label['fechainiciodictamen']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechafindictamen_line" id="hidden_field_data_fechafindictamen" style="<?php echo $sStyleHidden_fechafindictamen; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechafindictamen_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechafindictamen_label" style=""><span id="id_label_fechafindictamen"><?php echo $this->nm_new_label['fechafindictamen']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_muestra_ingresoEluPre_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_muestra_ingresoEluPre_mob");
 parent.scAjaxDetailHeight("form_muestra_ingresoEluPre_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_muestra_ingresoEluPre_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
