<?php
@session_start() ;
$_SESSION['scriptcase']['grid_aforo_liquidacionCR_psm']['sc_process_barr'] = true;
require_once('../grid_aforo_liquidacionCR_psm/index.php');
unset($_SESSION['scriptcase']['grid_aforo_liquidacionCR_psm']['sc_process_barr']);
$ExportCtrl = new grid_aforo_liquidacionCR_psm_export_control;
$ExportCtrl->Export_barr();

class grid_aforo_liquidacionCR_psm_export_control
{
