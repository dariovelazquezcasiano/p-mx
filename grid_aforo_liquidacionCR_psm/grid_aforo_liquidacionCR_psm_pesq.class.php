...
class grid_aforo_liquidacionCR_psm_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $this->Ini->Str_btn_filter = "TKZ/TKZ" . $_SESSION['scriptcase']['reg_conf']['css_dir'] . ".php";
      $this->Str_btn_filter_css  = "TKZ/TKZ.css";
      $this->Ini->str_google_fonts = (isset($str_google_fonts) && !empty($str_google_fonts))?$str_google_fonts:'';
      include($this->Ini->path_btn . $this->Ini->Str_btn_filter);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
 ...
 ?>
<script>
var widthBrowser = window.screen.width;
var heightBrowser = window.screen.height;
top.moveTo(0,0);
top.resizeTo(Width = widthBrowser, Height= heightBrowser);
</script>
<?php
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_aforo_liquidacionCR_psm_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_aforo_liquidacionCR_psm_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_aforo_liquidacionCR_psm_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_datas[] = "FechaTurno";$Nm_datas[] = "HoraEvento";$Nm_datas[] = "FechaEnvio";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE> Auditoría: Aforo | Ingreso</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_aforo_liquidacionCR_psm/grid_aforo_liquidacionCR_psm_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_aforo_liquidacionCR_psm/grid_aforo_liquidacionCR_psm_switch.css" />
</HEAD>
<?php
$vertical_center = '';
?>
<BODY id="grid_search" class="scFilterPage" style="<?php echo $vertical_center ?>margin-left:0.5px;margin-right:0.5px;margin-top:0.5px;margin-bottom:0.5px;">
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_aforo_liquidacionCR_psm_ajax_search.js"></script>
 <script type="text/javascript" src="grid_aforo_liquidacionCR_psm_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_aforo_liquidacionCR_psm_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_aforo_liquidacionCR_psm']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_aforo_liquidacionCR_psm']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_estatusana_cond#NMF#' + search_get_sel_txt('SC_estatusana_cond') + '@NMF@';
  str_out += 'SC_estatusana#NMF#' + search_get_radio('SC_estatusana') + '@NMF@';
  str_out += 'SC_discrepancia_cond#NMF#' + search_get_sel_txt('SC_discrepancia_cond') + '@NMF@';
  str_out += 'SC_discrepancia#NMF#' + search_get_checkbox('SC_discrepancia') + '@NMF@';
...
<?php
   ...
   {
      global 
             $estatusana_cond, $estatusana,
             $discrepancia_cond, $discrepancia,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $estatusana = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['estatusana']; 
          $estatusana_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['estatusana_cond']; 
          $discrepancia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['discrepancia']; 
          $discrepancia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['discrepancia_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['NM_operador']; 
      } 
      if (!isset($estatusana_cond) || empty($estatusana_cond))
      {
         $estatusana_cond = "eq";
      }
      if (!isset($discrepancia_cond) || empty($discrepancia_cond))
      {
         $discrepancia_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_estatusana = (in_array($estatusana_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_discrepancia = (in_array($discrepancia_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // discrepancia
      if (is_array($discrepancia) && !empty($discrepancia))
      {
         $tmp_array = array();
         $discrepancia_val_str = "";
         foreach ($discrepancia as $tmp_val_cmp)
         {
            if ("" != $discrepancia_val_str)
            {
               $discrepancia_val_str .= ",";
            }
            ...
            $discrepancia_val_str .= "'$tmp_val_cmp'";
         }
         $discrepancia = $tmp_array;
      }
      else
      {
         $discrepancia_val_str = "";
      }
      if (!isset($estatusana) || $estatusana == "")
      {
          $estatusana = "";
      }
      if (isset($estatusana) && !empty($estatusana))
      {
         $tmp_pos = (is_string($estatusana)) ? strpos($estatusana, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $estatusana = substr($estatusana, 0, $tmp_pos);
         }
      }
      if (!isset($discrepancia) || $discrepancia == "")
      {
          $discrepancia = array();
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_estatusana_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['estatusana'])) ? $this->New_label['estatusana'] : "Filtro"; ?></TD>
      
      <INPUT type="hidden" id="SC_estatusana_cond" name="estatusana_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd css_estatusana_fil_line">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_estatusana" <?php echo $str_hide_estatusana?> valign="top">
        <TD class="scFilterFieldFontOdd css_estatusana_fil_line">
           <?php
 $SC_Label = (isset($this->New_label['estatusana'])) ? $this->New_label['estatusana'] : "Filtro";
 $nmgp_tab_label .= "estatusana?#?" . $SC_Label . "?@?";
...
<?php
  if (!isset($estatusana)) {$estatusana = $estatusana;}
 ?>
...
<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd css_estatusana_fil_line"><div class="sc radio">
<input class="scFilterObjectOdd css_estatusana_fil_obj" type=radio id="SC_estatusana" name="estatusana" value="##@@Todo" onClick="nm_submit_form();" <?php if ("" == $estatusana)  { echo " checked" ;} ?>><span></span>Todo</div>
</TD>
  <TD class="scFilterFieldFontOdd css_estatusana_fil_line"><div class="sc radio">
<input class="scFilterObjectOdd css_estatusana_fil_obj" type=radio id="SC_estatusana" name="estatusana" value="1##@@Dictaminado" onClick="nm_submit_form();" <?php if ("1" == $estatusana)  { echo " checked" ;} ?>><span></span>Dictaminado</div>
</TD>
  <TD class="scFilterFieldFontOdd css_estatusana_fil_line"><div class="sc radio">
<input class="scFilterObjectOdd css_estatusana_fil_obj" type=radio id="SC_estatusana" name="estatusana" value="0##@@Sin Dictaminar" onClick="nm_submit_form();" <?php if ("0" == $estatusana)  { echo " checked" ;} ?>><span></span>Sin Dictaminar</div>
</TD>
</TR></TABLE>
      ...
      <TD id='SC_discrepancia_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['discrepancia'])) ? $this->New_label['discrepancia'] : "Discrepancia"; ?></TD>
      
      <INPUT type="hidden" id="SC_discrepancia_cond" name="discrepancia_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd css_estatusana_fil_line">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_discrepancia" <?php echo $str_hide_discrepancia?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['discrepancia'])) ? $this->New_label['discrepancia'] : "Discrepancia";
 $nmgp_tab_label .= "discrepancia?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  if (!isset($discrepancia)) {$discrepancia = explode(";", $discrepancia);}
 ?>
...
<INPUT class="scFilterObjectOdd" type="checkbox" id="SC_discrepancia" name="discrepancia[]" value="1##@@Si" onClick="nm_submit_form();" <?php if (in_array("1", $discrepancia))  { echo " checked" ;} ?>><span></span>Si</div>
</TD>
</TR></TABLE>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_aforo_liquidacionCR_psm_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_aforo_liquidacionCR_psm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_aforo_liquidacionCR_psm']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.estatusana_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_estatusana'), document.F1.estatusana_cond, 'estatusana');
   for (i = 0; i < document.F1.estatusana.length; i++)
   {
      if (document.F1.estatusana[i].checked)
      {
          document.F1.estatusana[i].checked = false;
      }
   }
   document.F1.discrepancia_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_discrepancia'), document.F1.discrepancia_cond, 'discrepancia');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'discrepancia[]' && document.F1.elements[i].checked)
      {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_aforo_liquidacionCR_psm/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_estatusana_cond'] = 'cond';
      $tp_fields['SC_estatusana'] = 'radio';
      $tp_fields['SC_discrepancia_cond'] = 'cond';
      $tp_fields['SC_discrepancia'] = 'checkbox';
   ...
   {
      global $estatusana_cond, $estatusana,
             $discrepancia_cond, $discrepancia, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $estatusana_cond_salva = $estatusana_cond; 
      if (!isset($estatusana_input_2) || $estatusana_input_2 == "")
      {
          $estatusana_input_2 = $estatusana;
      }
      $discrepancia_cond_salva = $discrepancia_cond; 
      if (!isset($discrepancia_input_2) || $discrepancia_input_2 == "")
      {
          $discrepancia_input_2 = $discrepancia;
      }
      $tmp_pos = (is_string($estatusana)) ? strpos($estatusana, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $estatusana;
          ...
          $L_lookup = substr($estatusana, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['psq_check_ret']['estatusana'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Filtro : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($discrepancia)) {
          foreach ($discrepancia as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['psq_check_ret']['discrepancia'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Discrepancia : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['estatusana'] = $estatusana; 
      if (is_array($estatusana) && !empty($estatusana))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['val'][0] = $estatusana;
      }
      elseif ($estatusana_cond_salva == "nu" || $estatusana_cond_salva == "nn" || $estatusana_cond_salva == "ep" || $estatusana_cond_salva == "ne" || !empty($estatusana))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['val'][0][0] = $estatusana;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['estatusana_cond'] = $estatusana_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['cmp'] = "estatusana"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['opc'] = $estatusana_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq']['estatusana'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['discrepancia'] = $discrepancia; 
      if (is_array($discrepancia) && !empty($discrepancia))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['val'][0] = $discrepancia;
      }
      elseif ($discrepancia_cond_salva == "nu" || $discrepancia_cond_salva == "nn" || $discrepancia_cond_salva == "ep" || $discrepancia_cond_salva == "ne" || !empty($discrepancia))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['val'][0][0] = $discrepancia;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['discrepancia_cond'] = $discrepancia_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['cmp'] = "discrepancia"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid]['opc'] = $discrepancia_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq']['discrepancia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['estatusana'] = $estatusana;
      if (strpos($this->cmp_formatado['estatusana'], "##@@") !== false)
      {
          $this->cmp_formatado['estatusana'] = substr($this->cmp_formatado['estatusana'], strpos($this->cmp_formatado['estatusana'], "##@@") + 4);
      }
      $this->cmp_formatado['estatusana_input_2'] = $estatusana_input_2;
      $this->cmp_formatado['discrepancia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']['discrepancia'];
      $this->cmp_formatado['discrepancia_input_2'] = $discrepancia_input_2;
      ...
      if (isset($estatusana))
      {
         $this->monta_condicao("EstatusANA", $estatusana_cond, $estatusana, "", "estatusana", "TINYINT", false);
      }
      ...
      $nm_aspas = "";
      if ($discrepancia_cond == "nu" || $discrepancia_cond == "nn" || $discrepancia_cond == "ep" || $discrepancia_cond == "ne")
      {
          $discrepancia = array();
      }
      if (is_array($discrepancia) && count($discrepancia) != 0)
      {
         foreach ($discrepancia as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($discrepancia[$i]);
            }
         }
      }
      if (is_array($discrepancia) && count($discrepancia) != 0)
      {
         ...
         foreach ($discrepancia as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($discrepancia) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$discrepancia_cond]) ? $Lang_descr[$discrepancia_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $nmgp_tab_label['discrepancia'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq']['discrepancia']['label'] = $nmgp_tab_label['discrepancia'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq']['discrepancia']['descr'] = $nmgp_tab_label['discrepancia'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['grid_pesq']['discrepancia']['hint'] = $nmgp_tab_label['discrepancia'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_liquidacionCR_psm']['cond_pesq'] .= $this->NM_operador;
