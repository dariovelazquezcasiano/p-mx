...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_estatusana"  <?php echo $str_hide_estatusana?>> 
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_discrepancia"  <?php echo $str_hide_discrepancia?>> 
<?php
...
<INPUT class="scFilterObjectEven" type="checkbox" id="SC_discrepancia" name="discrepancia[]" value="1##@@Si" onClick="nm_submit_form();" <?php if (in_array("1", $discrepancia))  { echo " checked" ;} ?>><span></span>Si</div>
</TD>
</TR></TABLE>
 </TD>
