...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_aforo_liquidacionCR_psm"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_aforo_liquidacionCR_psm"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_aforo_liquidacionCR_psm'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_aforo_liquidacionCR_psm']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_aforo_liquidacionCR_psm']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_aforo_liquidacionCR_psm']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_aforo_liquidacionCR_psm']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_aforo_liquidacionCR_psm']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_aforo_liquidacionCR_psm</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_aforo_liquidacionCR_psm']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_aforo_liquidacionCR_psm']['embutida_filho'] as $ind => $sc_init)
          {
