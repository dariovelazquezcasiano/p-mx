<?php
@session_start() ;
$_SESSION['scriptcase']['chart_aforo_1']['sc_process_barr'] = true;
require_once('../chart_aforo_1/index.php');
unset($_SESSION['scriptcase']['chart_aforo_1']['sc_process_barr']);
$ExportCtrl = new chart_aforo_1_export_control;
$ExportCtrl->Export_barr();

class chart_aforo_1_export_control
{
