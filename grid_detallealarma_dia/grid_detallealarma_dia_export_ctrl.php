<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallealarma_dia']['sc_process_barr'] = true;
require_once('../grid_detallealarma_dia/index.php');
unset($_SESSION['scriptcase']['grid_detallealarma_dia']['sc_process_barr']);
$ExportCtrl = new grid_detallealarma_dia_export_control;
$ExportCtrl->Export_barr();

class grid_detallealarma_dia_export_control
{
