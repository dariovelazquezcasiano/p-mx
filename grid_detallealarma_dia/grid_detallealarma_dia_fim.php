...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detallealarma_dia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detallealarma_dia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma_dia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallealarma_dia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma_dia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallealarma_dia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma_dia']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallealarma_dia</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma_dia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallealarma_dia']['embutida_filho'] as $ind => $sc_init)
          {
