...
class grid_detallealarma_dia_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_alarmaid = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_detallealarma_dia']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_detallealarma_dia']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['grid_detallealarma_dia']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['contr_total_geral'] == "OK")
      {
          $this->array_total_carrilid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_total']['carrilid'];
          $this->array_total_alarmaid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_total']['alarmaid'];
      }
      else
      {
          $this->array_total_carrilid = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_total']['carrilid'] = $this->array_total_carrilid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_total']['alarmaid'] = $this->array_total_alarmaid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['json_use_label'])
       {
          $Lab_carrilid = "CarrilID";
          $Lab_alarmaid = "AlarmaID";
       }
       else
       {
       $Lab_carrilid = "Carril";
       $Lab_alarmaid = "Tipo de alarma";
       }
       $this->comp_field = array(
           $Lab_carrilid,
           $Lab_alarmaid,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['turnoid'] = "Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['hora']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['hora'] = "Hora"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['usuarioid'] = "Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['descripcion'] = "Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['consecutivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['consecutivo'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['carrilid'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['carrilnacional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['carrilnacional'] = "Carril Nacional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['alarmaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['alarmaid'] = "Alarma"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['casetaid'] = "Caseta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['enviado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['enviado'] = "Enviado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['folio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['labels']['folio'] = "Folio"; 
       }
       //-----
       $this->comp_field_nm = array(
           'carrilid' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_msgs_totl'] . "",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_order']['group_alarma']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_order']['group_alarma'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_order']['group_alarma'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_display']['group_alarma'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_display']['group_alarma'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_display']['group_alarma'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_display']['group_alarma'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_display']['group_alarma'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_display']['group_alarma'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['summarizing_fields_display']['group_alarma'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_carrilid as $i_carrilid => $d_carrilid) {
           ...
           foreach ($this->array_total_alarmaid[$i_carrilid] as $i_alarmaid => $d_alarmaid) {
               if (!isset($i_alarmaid, $this->comp_label[1][ $d_carrilid[3] ]) || !in_array($i_alarmaid, $this->comp_label[1][ $d_carrilid[3] ], true)) {
                   $this->comp_index[1][ $d_alarmaid[3] ] = $d_alarmaid[2];
                   $this->comp_label[1][ $d_carrilid[3] ][ $d_alarmaid[3] ] = $d_alarmaid[2];
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_carrilid => $l_carrilid) {
           ...
           foreach ($this->comp_label[1][$i_carrilid] as $i_alarmaid => $l_alarmaid) {
               if (isset($this->array_total_alarmaid[$i_carrilid][$i_alarmaid])) {
                   $this->comp_group[$i_carrilid][$i_alarmaid] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_alarmaid;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_detallealarma_dia@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_msgs_totl'] . "")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'CarrilID',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_carrilid)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_msgs_totl'] . "")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_detallealarma_dia_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_detallealarma_dia_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_detallealarma_dia_total.class.php"); 
      }
      ...
      $this->Total   = new grid_detallealarma_dia_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_group_alarma("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_carrilid)) {
          ksort($this->array_total_carrilid);
      }
      if (is_array($this->array_total_alarmaid)) {
          ksort($this->array_total_alarmaid);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detallealarma_dia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_detallealarma_dia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detallealarma_dia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_detallealarma_dia/grid_detallealarma_dia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_detallealarma_dia_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detallealarma_dia']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detallealarma_dia']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_detallealarma_dia_config_pivot.php?nome_apl=grid_detallealarma_dia&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detallealarma_dia_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_detallealarma_dia/grid_detallealarma_dia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_detallealarma_dia_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_detallealarma_dia_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_detallealarma_dia_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_detallealarma_dia_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_detallealarma_dia_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallealarma_dia']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($quebra_carrilid, $quebra_alarmaid, $quebra_carrilid_orig, $quebra_alarmaid_orig)
   {
      //----- Carril
      ...
      //----- Alarma
      if (!isset($this->array_total_alarmaid[$quebra_carrilid_orig][$quebra_alarmaid_orig]))
      {
         $this->array_total_alarmaid[$quebra_carrilid_orig][$quebra_alarmaid_orig][0] = 1;
         $this->array_total_alarmaid[$quebra_carrilid_orig][$quebra_alarmaid_orig][1] = 1;
         $this->array_total_alarmaid[$quebra_carrilid_orig][$quebra_alarmaid_orig][2] = $quebra_alarmaid;
         $this->array_total_alarmaid[$quebra_carrilid_orig][$quebra_alarmaid_orig][3] = $quebra_alarmaid_orig;
      }
      else
      {
         $this->array_total_alarmaid[$quebra_carrilid_orig][$quebra_alarmaid_orig][0]++;
         $this->array_total_alarmaid[$quebra_carrilid_orig][$quebra_alarmaid_orig][2]++;
      }
   }
...
$_SESSION['scriptcase']['grid_detallealarma_dia']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('group_alarma', 'carrilid');
     $campos_order = $this->Ini->Get_date_order_groupby("CarrilID", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('group_alarma', 'alarmaid');
     $campos_order = $this->Ini->Get_date_order_groupby("AlarmaID", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->alarmaid = $rs_res->fields[6] ;  
            $this->casetaid = $rs_res->fields[7] ;  
            $this->consecutivo = $rs_res->fields[8] ;  
            $this->look_alarmaid = $this->alarmaid; 
            $this->Lookup->lookup_alarmaid($this->look_alarmaid, $this->alarmaid) ; 
            $this->carrilid_orig = $this->carrilid;
            $this->alarmaid_orig = $this->alarmaid;
            $this->alarmaid = $this->look_alarmaid ;
            nmgp_Form_Num_Val($this->carrilid, "", ".", "0", "S", "2", "", "N:", "-") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->carrilid, $this->alarmaid, $this->carrilid_orig,  $this->alarmaid_orig);
            }
   }
//
