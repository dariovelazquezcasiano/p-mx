...
<?php
   ...
   $Ord_Cmp = new grid_detalleturnocarrilL_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalleturnocarrilL_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fechaoperacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["fechaoperacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["fechaoperacion"] : "Fecha Operacion";
   $tab_ger_campos['turnoid'] = "on";
   $tab_def_campos['turnoid'] = "TurnoID";
   $tab_labels["turnoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["turnoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["turnoid"] : "Turno";
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["carrilid"] : "Carril";
   ...
   $tab_labels["liquidacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["liquidacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["liquidacion"] : "Liquidación";
   ...
   $tab_labels["liquida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["liquida"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["liquida"] : "Liquidación";
   ...
   $tab_labels["liquidacion_ok"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["liquidacion_ok"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["liquidacion_ok"] : "Liquidación";
   ...
   $tab_labels["resumen_blank"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["resumen_blank"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["resumen_blank"] : "Archivo";
   ...
   $tab_labels["resumen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["resumen"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['labels']["resumen"] : "Archivo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalleturnocarrilL_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalleturnocarrilL']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
