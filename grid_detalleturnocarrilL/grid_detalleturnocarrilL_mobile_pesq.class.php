...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_datas[] = "HoraInicio";$Nm_datas[] = "HoraFin";$Nm_numeric[] = "casetaid";$Nm_numeric[] = "turnoid";$Nm_numeric[] = "carrilid";$Nm_numeric[] = "avg(preliquidado)";$Nm_numeric[] = "encargadoturnoid_pre";
...
<span id='id_date_part_fechaoperacion_DD' style='display: inline-block'>
         ...
         <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fechaoperacion_dia" name="fechaoperacion_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_fechaoperacion_MM' style='display: inline-block'>
         ...
         <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fechaoperacion_mes" name="fechaoperacion_mes">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_fechaoperacion_AAAA' style='display: inline-block'>
         ...
         <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fechaoperacion_ano" name="fechaoperacion_ano">
  <option value=""></option>
<?php
  $Combo_ano_ini = 2018;
