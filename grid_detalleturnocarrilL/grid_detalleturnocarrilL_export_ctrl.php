<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleturnocarrilL']['sc_process_barr'] = true;
require_once('../grid_detalleturnocarrilL/index.php');
unset($_SESSION['scriptcase']['grid_detalleturnocarrilL']['sc_process_barr']);
$ExportCtrl = new grid_detalleturnocarrilL_export_control;
$ExportCtrl->Export_barr();

class grid_detalleturnocarrilL_export_control
{
