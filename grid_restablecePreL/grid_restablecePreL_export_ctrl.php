<?php
@session_start() ;
$_SESSION['scriptcase']['grid_restablecePreL']['sc_process_barr'] = true;
require_once('../grid_restablecePreL/index.php');
unset($_SESSION['scriptcase']['grid_restablecePreL']['sc_process_barr']);
$ExportCtrl = new grid_restablecePreL_export_control;
$ExportCtrl->Export_barr();

class grid_restablecePreL_export_control
{
