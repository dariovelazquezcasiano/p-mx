...
<?php
   ...
   $Ord_Cmp = new grid_restablecePreL_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_restablecePreL_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["carrilid"] : "Carril";
   $tab_ger_campos['cuerpo'] = "on";
   $tab_def_campos['cuerpo'] = "Cuerpo";
   $tab_labels["cuerpo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["cuerpo"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["cuerpo"] : "Cuerpo";
   $tab_ger_campos['usuarioid'] = "on";
   $tab_def_campos['usuarioid'] = "UsuarioID";
   $tab_labels["usuarioid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["usuarioid"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["usuarioid"] : "Usuario";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "HoraInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["horainicio"] : "Hora Inicio";
   $tab_ger_campos['horafin'] = "on";
   $tab_def_campos['horafin'] = "HoraFin";
   $tab_labels["horafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["horafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["horafin"] : "Hora Fin";
   $tab_ger_campos['encargadoturnoid_pre'] = "on";
   $tab_def_campos['encargadoturnoid_pre'] = "EncargadoTurnoID_Pre";
   $tab_labels["encargadoturnoid_pre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["encargadoturnoid_pre"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["encargadoturnoid_pre"] : "Encargado Turno PreLiquida";
   $tab_ger_campos['foliocierre'] = "on";
   $tab_def_campos['foliocierre'] = "FolioCierre";
   $tab_labels["foliocierre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["foliocierre"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["foliocierre"] : "Folio Cierre";
   ...
   $tab_labels["preliquidar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["preliquidar"])) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['labels']["preliquidar"] : "Reestablece";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_restablecePreL_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_restablecePreL']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
