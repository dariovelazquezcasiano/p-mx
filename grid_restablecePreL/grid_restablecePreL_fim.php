...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_restablecePreL"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_restablecePreL"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_restablecePreL']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_restablecePreL']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_restablecePreL']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_restablecePreL']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_restablecePreL']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_restablecePreL</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_restablecePreL']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_restablecePreL']['embutida_filho'] as $ind => $sc_init)
          {
