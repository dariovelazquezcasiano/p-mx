  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_eventosdiarios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_eventosdiarios_form();
	}
...
?>
  ...
  function do_ajax_control_eventosdiarios_validate_fecha_inicio()
  {
    ...
    setTimeout(function() {
      var var_fecha_inicio = scAjaxGetFieldText(nomeCampo_fecha_inicio);
      x_ajax_control_eventosdiarios_validate_fecha_inicio(var_fecha_inicio, var_script_case_init, do_ajax_control_eventosdiarios_validate_fecha_inicio_cb);
    }, 200);
  } // do_ajax_control_eventosdiarios_validate_fecha_inicio

  function do_ajax_control_eventosdiarios_validate_fecha_inicio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_eventosdiarios_validate_fecha_inicio_cb

  // ---------- Validate hora_inicio
  function do_ajax_control_eventosdiarios_validate_hora_inicio()
  {
    var nomeCampo_hora_inicio = "hora_inicio";
    var var_hora_inicio = scAjaxGetFieldText(nomeCampo_hora_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_eventosdiarios_validate_hora_inicio(var_hora_inicio, var_script_case_init, do_ajax_control_eventosdiarios_validate_hora_inicio_cb);
  } // do_ajax_control_eventosdiarios_validate_hora_inicio

  function do_ajax_control_eventosdiarios_validate_hora_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_eventosdiarios_validate_hora_inicio_cb

  // ---------- Validate fecha_fin
  function do_ajax_control_eventosdiarios_validate_fecha_fin()
  {
    ...
    setTimeout(function() {
      var var_fecha_fin = scAjaxGetFieldText(nomeCampo_fecha_fin);
      x_ajax_control_eventosdiarios_validate_fecha_fin(var_fecha_fin, var_script_case_init, do_ajax_control_eventosdiarios_validate_fecha_fin_cb);
    }, 200);
  } // do_ajax_control_eventosdiarios_validate_fecha_fin

  function do_ajax_control_eventosdiarios_validate_fecha_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_eventosdiarios_validate_fecha_fin_cb

  // ---------- Validate hora_fin
  function do_ajax_control_eventosdiarios_validate_hora_fin()
  {
    var nomeCampo_hora_fin = "hora_fin";
    var var_hora_fin = scAjaxGetFieldText(nomeCampo_hora_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_eventosdiarios_validate_hora_fin(var_hora_fin, var_script_case_init, do_ajax_control_eventosdiarios_validate_hora_fin_cb);
  } // do_ajax_control_eventosdiarios_validate_hora_fin

  function do_ajax_control_eventosdiarios_validate_hora_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_eventosdiarios_validate_hora_fin_cb

  // ---------- Validate carril
  function do_ajax_control_eventosdiarios_validate_carril()
  {
    var nomeCampo_carril = "carril";
    var var_carril = scAjaxGetFieldSelect(nomeCampo_carril);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_eventosdiarios_validate_carril(var_carril, var_script_case_init, do_ajax_control_eventosdiarios_validate_carril_cb);
  } // do_ajax_control_eventosdiarios_validate_carril

  function do_ajax_control_eventosdiarios_validate_carril_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "carril";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_eventosdiarios_validate_carril_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_eventosdiarios_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_eventosdiarios_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_eventosdiarios_submit_form(var_fecha_inicio, var_hora_inicio, var_fecha_fin, var_hora_fin, var_carril, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_eventosdiarios_submit_form_cb);
  } // do_ajax_control_eventosdiarios_submit_form

  function do_ajax_control_eventosdiarios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_eventosdiarios_submit_form_cb_after_alert);
  } // do_ajax_control_eventosdiarios_submit_form_cb
  function do_ajax_control_eventosdiarios_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_eventosdiarios_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_eventosdiarios_navigate_form()
  {
    perform_ajax_control_eventosdiarios_navigate_form();
  }

  function perform_ajax_control_eventosdiarios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_eventosdiarios_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventosdiarios']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_eventosdiarios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_eventosdiarios_navigate_form_cb_after_alert);
  } // do_ajax_control_eventosdiarios_navigate_form_cb
  function do_ajax_control_eventosdiarios_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_eventosdiarios_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_eventosdiarios_navigate_form_cb_after_alert

  function sc_hide_control_eventosdiarios_form()
  {
