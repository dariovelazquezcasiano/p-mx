...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_categoriatipopago"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_categoriatipopago"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_categoriatipopago']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_categoriatipopago']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_categoriatipopago']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_categoriatipopago']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_categoriatipopago']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_categoriatipopago</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_categoriatipopago']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_categoriatipopago']['embutida_filho'] as $ind => $sc_init)
          {
