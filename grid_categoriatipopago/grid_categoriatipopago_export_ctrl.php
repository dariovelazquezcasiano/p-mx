<?php
@session_start() ;
$_SESSION['scriptcase']['grid_categoriatipopago']['sc_process_barr'] = true;
require_once('../grid_categoriatipopago/index.php');
unset($_SESSION['scriptcase']['grid_categoriatipopago']['sc_process_barr']);
$ExportCtrl = new grid_categoriatipopago_export_control;
$ExportCtrl->Export_barr();

class grid_categoriatipopago_export_control
{
