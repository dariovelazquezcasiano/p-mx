<?php
@session_start() ;
$_SESSION['scriptcase']['grid_inventario_caseta']['sc_process_barr'] = true;
require_once('../grid_inventario_caseta/index.php');
unset($_SESSION['scriptcase']['grid_inventario_caseta']['sc_process_barr']);
$ExportCtrl = new grid_inventario_caseta_export_control;
$ExportCtrl->Export_barr();

class grid_inventario_caseta_export_control
{
