...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "status";$Nm_numeric[] = "id_caseta";$Nm_numeric[] = "id_inv_reemplazo";$Nm_numeric[] = "funcionamiento";$Nm_numeric[] = "id";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "status";$Nm_numeric[] = "id_caseta";$Nm_numeric[] = "id_inv_reemplazo";$Nm_numeric[] = "funcionamiento";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_id_caseta"  <?php echo $str_hide_id_caseta?>>
<?php
