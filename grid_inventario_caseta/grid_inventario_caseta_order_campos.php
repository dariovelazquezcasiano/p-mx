...
<?php
   ...
   $Ord_Cmp = new grid_inventario_caseta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inventario_caseta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["carril"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["carril"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["carril"] : "Ubicacion";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['marca'] = "on";
   $tab_def_campos['marca'] = "marca";
   $tab_labels["marca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["marca"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["marca"] : "Marca";
   $tab_ger_campos['modelo'] = "on";
   $tab_def_campos['modelo'] = "modelo";
   $tab_labels["modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["modelo"] : "Modelo";
   $tab_ger_campos['localizacion'] = "on";
   $tab_def_campos['localizacion'] = "localizacion";
   $tab_labels["localizacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["localizacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["localizacion"] : "Localizacion";
   $tab_ger_campos['numero_serie'] = "on";
   $tab_def_campos['numero_serie'] = "numero_serie";
   $tab_labels["numero_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["numero_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["numero_serie"] : "Numero Serie";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inventario_caseta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inventario_caseta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
