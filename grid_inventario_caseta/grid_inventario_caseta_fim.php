...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_inventario_caseta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_inventario_caseta"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_inventario_caseta'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_caseta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_caseta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_caseta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_caseta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inventario_caseta']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inventario_caseta</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_caseta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inventario_caseta']['embutida_filho'] as $ind => $sc_init)
          {
