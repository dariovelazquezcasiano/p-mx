...
$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_prod']       = "";
$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imagens']    = "";
$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imag_temp']  = "";
$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_doc']        = "";
...
//check prod
if(empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_dashboard_panel($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "dashboard_panel") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
            $_SESSION['scriptcase']['dashboard_panel']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_dashboard_panel($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['dashboard_panel']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['dashboard_panel']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$dashboard_panel_control = new dashboard_panel_control();
$dashboard_panel_control->control();

class dashboard_panel_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_panel'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_panel'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "dashboard_panel";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['dashboard_panel']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/dashboard_panel';
        ...
        if (isset($_SESSION['scriptcase']['dashboard_panel']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['dashboard_panel']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['dashboard_panel']['actual_lang']) || $_SESSION['scriptcase']['dashboard_panel']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['dashboard_panel']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir'])) {
...
';
            ...
            if ($_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['dashboard_panel']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao']) && $_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard_panel']['glo_nm_perfil']) && $_SESSION['scriptcase']['dashboard_panel']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard_panel']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard_panel']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['dashboard_panel']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['dashboard_panel']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['dashboard_panel']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['SC_sep_date1'];
      }
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['sc_outra_jan'] != 'dashboard_panel')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_oracle))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['dashboard_panel']['decimal_db'] = "."; 
      } 
  }

  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard_panel']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8);
    }
    else {
...
class dashboard_panel_control {
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new dashboard_panel_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['dashboard_panel'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['dashboard_panel'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_panel'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_panel']['dbifrm_widget1'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_panel'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_panel']['panel_control'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
    ...
    function checkSecurity()
    {
        ...
        {
            $_SESSION['scriptcase']['sc_apl_seg']['dashboard_panel'] = "on";
        }

        if (!isset($_SESSION['scriptcase']['dashboard_panel']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_panel']) || $_SESSION['scriptcase']['sc_apl_seg']['dashboard_panel'] != "on"))
        {
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['dashboard_panel'] as $sIframe => $iSCInit) {
?>
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="12" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        ...
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('panel_control'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_panel"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=dashboard_panel&own_widget=dbifrm_widget1&compact_mode=0&remove_margin=0&remove_border=0" alt="10"></iframe></div>
                    </div>
                </div></div>
...
} // dashboard_panel_control

function nm_limpa_str_dashboard_panel(&$str)
{
}
