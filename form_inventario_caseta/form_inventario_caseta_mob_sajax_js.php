  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inventario_caseta_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inventario_caseta_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_caseta
  function do_ajax_form_inventario_caseta_mob_validate_id_caseta()
  {
    var nomeCampo_id_caseta = "id_caseta";
    var var_id_caseta = scAjaxGetFieldSelect(nomeCampo_id_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_id_caseta(var_id_caseta, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_id_caseta_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_id_caseta

  function do_ajax_form_inventario_caseta_mob_validate_id_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_id_caseta_cb

  // ---------- Validate carril
  function do_ajax_form_inventario_caseta_mob_validate_carril()
  {
    var nomeCampo_carril = "carril";
    var var_carril = scAjaxGetFieldSelect(nomeCampo_carril);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_carril(var_carril, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_carril_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_carril

  function do_ajax_form_inventario_caseta_mob_validate_carril_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "carril";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_carril_cb

  // ---------- Validate descripcion
  function do_ajax_form_inventario_caseta_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_descripcion_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_descripcion

  function do_ajax_form_inventario_caseta_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_descripcion_cb

  // ---------- Validate marca
  function do_ajax_form_inventario_caseta_mob_validate_marca()
  {
    var nomeCampo_marca = "marca";
    var var_marca = scAjaxGetFieldText(nomeCampo_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_marca(var_marca, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_marca_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_marca

  function do_ajax_form_inventario_caseta_mob_validate_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "marca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_marca_cb

  // ---------- Validate modelo
  function do_ajax_form_inventario_caseta_mob_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_modelo_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_modelo

  function do_ajax_form_inventario_caseta_mob_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modelo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_modelo_cb

  // ---------- Validate numero_serie
  function do_ajax_form_inventario_caseta_mob_validate_numero_serie()
  {
    var nomeCampo_numero_serie = "numero_serie";
    var var_numero_serie = scAjaxGetFieldText(nomeCampo_numero_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_numero_serie(var_numero_serie, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_numero_serie_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_numero_serie

  function do_ajax_form_inventario_caseta_mob_validate_numero_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_serie";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_numero_serie_cb

  // ---------- Validate localizacion
  function do_ajax_form_inventario_caseta_mob_validate_localizacion()
  {
    var nomeCampo_localizacion = "localizacion";
    var var_localizacion = scAjaxGetFieldText(nomeCampo_localizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_localizacion(var_localizacion, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_localizacion_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_localizacion

  function do_ajax_form_inventario_caseta_mob_validate_localizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "localizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_localizacion_cb

  // ---------- Validate cantidad
  function do_ajax_form_inventario_caseta_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_cantidad_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_cantidad

  function do_ajax_form_inventario_caseta_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_cantidad_cb

  // ---------- Validate status
  function do_ajax_form_inventario_caseta_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_caseta_mob_validate_status(var_status, var_script_case_init, do_ajax_form_inventario_caseta_mob_validate_status_cb);
  } // do_ajax_form_inventario_caseta_mob_validate_status

  function do_ajax_form_inventario_caseta_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_validate_status_cb

  // ---------- Refresh id_caseta
  function do_ajax_form_inventario_caseta_mob_refresh_id_caseta()
  {
    var var_id_caseta = scAjaxGetFieldSelect("id_caseta");
    var var_nmgp_refresh_fields = "carril";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inventario_caseta_mob_refresh_id_caseta(var_id_caseta, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inventario_caseta_mob_refresh_id_caseta_cb);
  } // do_ajax_form_inventario_caseta_mob_refresh_id_caseta

  function do_ajax_form_inventario_caseta_mob_refresh_id_caseta_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_caseta_mob_refresh_id_caseta_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inventario_caseta_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inventario_caseta_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_caseta = scAjaxGetFieldSelect("id_caseta");
    var var_carril = scAjaxGetFieldSelect("carril");
    ...
    var var_numero_serie = scAjaxGetFieldText("numero_serie");
    var var_localizacion = scAjaxGetFieldText("localizacion");
    ...
    scAjaxProcOn();
    x_ajax_form_inventario_caseta_mob_submit_form(var_id_caseta, var_carril, var_descripcion, var_marca, var_modelo, var_numero_serie, var_localizacion, var_cantidad, var_status, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inventario_caseta_mob_submit_form_cb);
  } // do_ajax_form_inventario_caseta_mob_submit_form

  function do_ajax_form_inventario_caseta_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_caseta");
      scAjaxHideErrorDisplay("carril");
      scAjaxHideErrorDisplay("descripcion");
      scAjaxHideErrorDisplay("marca");
      scAjaxHideErrorDisplay("modelo");
      scAjaxHideErrorDisplay("numero_serie");
      scAjaxHideErrorDisplay("localizacion");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inventario_caseta_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inventario_caseta_mob_submit_form_cb
  function do_ajax_form_inventario_caseta_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inventario_caseta_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inventario_caseta_mob_navigate_form()
  {
    perform_ajax_form_inventario_caseta_mob_navigate_form();
  }

  function perform_ajax_form_inventario_caseta_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inventario_caseta_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inventario_caseta_mob_navigate_form_cb);
  } // do_ajax_form_inventario_caseta_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inventario_caseta_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inventario_caseta_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inventario_caseta_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inventario_caseta_mob_navigate_form_cb
  function do_ajax_form_inventario_caseta_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_inventario_caseta_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inventario_caseta_mob_navigate_form_cb_after_alert

  function sc_hide_form_inventario_caseta_mob_form()
  {
  ...
  ajax_field_list[0] = "id_caseta";
  ajax_field_list[1] = "carril";
  ajax_field_list[2] = "descripcion";
  ajax_field_list[3] = "marca";
  ajax_field_list[4] = "modelo";
  ajax_field_list[5] = "numero_serie";
  ajax_field_list[6] = "localizacion";
  ...
  var ajax_error_list = {
    "id_caseta": {"label": "Caseta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "carril": {"label": "Carril", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "numero_serie": {"label": "Numero Serie", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "localizacion": {"label": "Localizacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "marca": new Array(),
    "modelo": new Array(),
    "numero_serie": new Array(),
    "localizacion": new Array(),
    "cantidad": new Array(),
    "status": new Array()
  };
  ajax_field_mult["id_caseta"][1] = "id_caseta";
  ajax_field_mult["carril"][1] = "carril";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["marca"][1] = "marca";
  ajax_field_mult["modelo"][1] = "modelo";
  ajax_field_mult["numero_serie"][1] = "numero_serie";
  ajax_field_mult["localizacion"][1] = "localizacion";
  ajax_field_mult["cantidad"][1] = "cantidad";
  ajax_field_mult["status"][1] = "status";

  var ajax_field_id = {
    "id_caseta": new Array("hidden_field_label_id_caseta", "hidden_field_data_id_caseta"),
    "carril": new Array("hidden_field_label_carril", "hidden_field_data_carril"),
    ...
    "numero_serie": new Array("hidden_field_label_numero_serie", "hidden_field_data_numero_serie"),
    "localizacion": new Array("hidden_field_label_localizacion", "hidden_field_data_localizacion"),
