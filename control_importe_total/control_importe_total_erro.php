...
$old_error_handler = set_error_handler("control_importe_total_scriptcase_error_handler");

function control_importe_total_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['control_importe_total']['contr_erro']) && $_SESSION['scriptcase']['control_importe_total']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_importe_total->contr_control_importe_total->Apl_com_erro = true;
            if ($inicial_control_importe_total->contr_control_importe_total->NM_ajax_flag)
            {
                $inicial_control_importe_total->contr_control_importe_total->NM_ajax_info['errList']['geral_control_importe_total'][] = $msg;
                return;
            }
            control_importe_total_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_importe_total_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_importe_total'])  && '' != $_SESSION['scriptcase']['error_icon']['control_importe_total'])  ? $_SESSION['scriptcase']['error_icon']['control_importe_total']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_importe_total']) && '' != $_SESSION['scriptcase']['error_span_title']['control_importe_total']) ? $_SESSION['scriptcase']['error_span_title']['control_importe_total'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_importe_total']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_importe_total']) ? $_SESSION['scriptcase']['error_icon_title']['control_importe_total'] : '';
?>
