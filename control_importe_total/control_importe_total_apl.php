<?php
//
class control_importe_total_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['control_importe_total']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['control_importe_total']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_importe_total']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['control_importe_total']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_importe_total']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_importe_total']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_importe_total']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_importe_total']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->identificador)) 
          {
              $_SESSION['identificador'] = $this->identificador;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_importe_total']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_importe_total']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_importe_total']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_importe_total']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_importe_total']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_importe_total']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_importe_total']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_importe_total']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_importe_total']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_importe_total_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['control_importe_total']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_importe_total']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_importe_total'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_importe_total']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_importe_total']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_importe_total') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_importe_total']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['control_importe_total']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_importe_total'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_importe_total']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_importe_total'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_importe_total'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_importe_total_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_importe_total_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'control_importe_total/control_importe_total_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_importe_total_erro.class.php"); 
      }
      $this->Erro      = new control_importe_total_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_importe_total']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['final'];
      }
      else
      {
      }
...
//
      ...
      chdir($old_dir);
            ...
            $out1_img_cache = $_SESSION['scriptcase']['control_importe_total']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['control_importe_total']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->iden = "" ;  
          $this->fechacierre = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['campos']))
              { 
                  $leyenda = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['campos'][0]; 
                  $fld_complementa = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['campos'][1]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['campos'][0] = $this->leyenda; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['campos'][1] = $this->fld_complementa; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_importe_total", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_importe_total_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_importe_total.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="control_importe_total_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_importe_total"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_importe_total', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'control_importe_total', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_importe_total', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_importe_total']) || !is_array($this->NM_ajax_info['errList']['geral_control_importe_total']))
              {
                  $this->NM_ajax_info['errList']['geral_control_importe_total'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_importe_total'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['control_importe_total']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['control_importe_total']['contr_erro'] = 'off'; 
    ...
    function ValidateField_fld_complementa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->fld_complementa, 18, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values_fld_complementa($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if (false == $this->rs)     
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_control_importe_total';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['control_importe_total']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("control_importe_total_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "control_importe_total_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_importe_total_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_importe_total']['ordem_ord'] == " desc") {
