<?php
@session_start() ;
$_SESSION['scriptcase']['chart_aforo']['sc_process_barr'] = true;
require_once('../chart_aforo/index.php');
unset($_SESSION['scriptcase']['chart_aforo']['sc_process_barr']);
$ExportCtrl = new chart_aforo_export_control;
$ExportCtrl->Export_barr();

class chart_aforo_export_control
{
