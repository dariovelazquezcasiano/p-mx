...
$old_error_handler = set_error_handler("menu_atlacomulco_scriptcase_error_handler");

function menu_atlacomulco_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['menu_atlacomulco']['contr_erro']) && $_SESSION['scriptcase']['menu_atlacomulco']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_menu_atlacomulco->contr_menu_atlacomulco->Apl_com_erro = true;
            if ($inicial_menu_atlacomulco->contr_menu_atlacomulco->NM_ajax_flag)
            {
                $inicial_menu_atlacomulco->contr_menu_atlacomulco->NM_ajax_info['errList']['geral_menu_atlacomulco'][] = $msg;
                return;
            }
            menu_atlacomulco_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function menu_atlacomulco_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['menu_atlacomulco'])  && '' != $_SESSION['scriptcase']['error_icon']['menu_atlacomulco'])  ? $_SESSION['scriptcase']['error_icon']['menu_atlacomulco']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['menu_atlacomulco']) && '' != $_SESSION['scriptcase']['error_span_title']['menu_atlacomulco']) ? $_SESSION['scriptcase']['error_span_title']['menu_atlacomulco'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['menu_atlacomulco']) && '' != $_SESSION['scriptcase']['error_icon_title']['menu_atlacomulco']) ? $_SESSION['scriptcase']['error_icon_title']['menu_atlacomulco'] : '';
?>
