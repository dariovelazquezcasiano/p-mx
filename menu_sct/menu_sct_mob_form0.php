...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>menu_sct/menu_sct_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("menu_sct_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('menu_sct_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['menu_sct']['error_buffer']) && '' != $_SESSION['scriptcase']['menu_sct']['error_buffer'])
{
    echo $_SESSION['scriptcase']['menu_sct']['error_buffer'];
}
...
<?php
 include_once("menu_sct_mob_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['menu_sct_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['menu_sct_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_formato_line" id="hidden_field_data_formato" style="<?php echo $sStyleHidden_formato; ?>"> <span class="scFormLabelOddFormat css_formato_label" style=""><span id="id_label_formato"><?php echo $this->nm_new_label['formato']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['php_cmp_required']['formato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['php_cmp_required']['formato'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '1'; ?>
 <option  value="2" <?php  if ($this->formato == "2") { echo " selected" ;} ?>>IBVPM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '2'; ?>
 <option  value="5" <?php  if ($this->formato == "5") { echo " selected" ;} ?>>IDMN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '5'; ?>
 <option  value="3" <?php  if ($this->formato == "3") { echo " selected" ;} ?>>IDTCNM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '3'; ?>
 <option  value="6" <?php  if ($this->formato == "6") { echo " selected" ;} ?>>VACM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '6'; ?>
 <option  value="7" <?php  if ($this->formato == "7") { echo " selected" ;} ?>>VDMN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '7'; ?>
 <option  value="4" <?php  if ($this->formato == "4") { echo " selected" ;} ?>>VDTCNM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '4'; ?>
 <option  value="8" <?php  if ($this->formato == "8") { echo " selected" ;} ?>>VDTMNM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '8'; ?>
 <option  value="9" <?php  if ($this->formato == "9") { echo " selected" ;} ?>>VHMD</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_formato'][] = '9'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_year_line" id="hidden_field_data_year" style="<?php echo $sStyleHidden_year; ?>"> <span class="scFormLabelOddFormat css_year_label" style=""><span id="id_label_year"><?php echo $this->nm_new_label['year']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['php_cmp_required']['year']) || $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['php_cmp_required']['year'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mesini_line" id="hidden_field_data_mesini" style="<?php echo $sStyleHidden_mesini; ?>"> <span class="scFormLabelOddFormat css_mesini_label" style=""><span id="id_label_mesini"><?php echo $this->nm_new_label['mesini']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['php_cmp_required']['mesini']) || $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['php_cmp_required']['mesini'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '1'; ?>
 <option  value="2" <?php  if ($this->mesini == "2") { echo " selected" ;} ?>>02</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '2'; ?>
 <option  value="3" <?php  if ($this->mesini == "3") { echo " selected" ;} ?>>03</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '3'; ?>
 <option  value="4" <?php  if ($this->mesini == "4") { echo " selected" ;} ?>>04</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '4'; ?>
 <option  value="5" <?php  if ($this->mesini == "5") { echo " selected" ;} ?>>05</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '5'; ?>
 <option  value="6" <?php  if ($this->mesini == "6") { echo " selected" ;} ?>>06</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '6'; ?>
 <option  value="7" <?php  if ($this->mesini == "7") { echo " selected" ;} ?>>07</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '7'; ?>
 <option  value="8" <?php  if ($this->mesini == "8") { echo " selected" ;} ?>>08</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '8'; ?>
 <option  value="9" <?php  if ($this->mesini == "9") { echo " selected" ;} ?>>09</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '9'; ?>
 <option  value="10" <?php  if ($this->mesini == "10") { echo " selected" ;} ?>>10</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '10'; ?>
 <option  value="11" <?php  if ($this->mesini == "11") { echo " selected" ;} ?>>11</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '11'; ?>
 <option  value="12" <?php  if ($this->mesini == "12") { echo " selected" ;} ?>>12</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesini'][] = '12'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mesfin_line" id="hidden_field_data_mesfin" style="<?php echo $sStyleHidden_mesfin; ?>"> <span class="scFormLabelOddFormat css_mesfin_label" style=""><span id="id_label_mesfin"><?php echo $this->nm_new_label['mesfin']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '1'; ?>
 <option  value="2" <?php  if ($this->mesfin == "2") { echo " selected" ;} ?>>02</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '2'; ?>
 <option  value="3" <?php  if ($this->mesfin == "3") { echo " selected" ;} ?>>03</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '3'; ?>
 <option  value="4" <?php  if ($this->mesfin == "4") { echo " selected" ;} ?>>04</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '4'; ?>
 <option  value="5" <?php  if ($this->mesfin == "5") { echo " selected" ;} ?>>05</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '5'; ?>
 <option  value="6" <?php  if ($this->mesfin == "6") { echo " selected" ;} ?>>06</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '6'; ?>
 <option  value="7" <?php  if ($this->mesfin == "7") { echo " selected" ;} ?>>07</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '7'; ?>
 <option  value="8" <?php  if ($this->mesfin == "8") { echo " selected" ;} ?>>08</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '8'; ?>
 <option  value="9" <?php  if ($this->mesfin == "9") { echo " selected" ;} ?>>09</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '9'; ?>
 <option  value="10" <?php  if ($this->mesfin == "10") { echo " selected" ;} ?>>10</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '10'; ?>
 <option  value="11" <?php  if ($this->mesfin == "11") { echo " selected" ;} ?>>11</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '11'; ?>
 <option  value="12" <?php  if ($this->mesfin == "12") { echo " selected" ;} ?>>12</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_mesfin'][] = '12'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_sentido'][] = 'A'; ?>
 <option  value="B" <?php  if ($this->sentido == "B") { echo " selected" ;} ?>>B</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['Lookup_sentido'][] = 'B'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("menu_sct_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("menu_sct_mob");
 parent.scAjaxDetailHeight("menu_sct_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
