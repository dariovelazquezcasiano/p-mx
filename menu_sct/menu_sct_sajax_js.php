...
?>
  ...
  // ---------- Validate formato
  function do_ajax_menu_sct_validate_formato()
  {
    var nomeCampo_formato = "formato";
    var var_formato = scAjaxGetFieldSelect(nomeCampo_formato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_sct_validate_formato(var_formato, var_script_case_init, do_ajax_menu_sct_validate_formato_cb);
  } // do_ajax_menu_sct_validate_formato

  function do_ajax_menu_sct_validate_formato_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_sct_validate_formato_cb

  // ---------- Validate year
  function do_ajax_menu_sct_validate_year()
  {
    var nomeCampo_year = "year";
    var var_year = scAjaxGetFieldText(nomeCampo_year);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_sct_validate_year(var_year, var_script_case_init, do_ajax_menu_sct_validate_year_cb);
  } // do_ajax_menu_sct_validate_year

  function do_ajax_menu_sct_validate_year_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "year";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_sct_validate_year_cb

  // ---------- Validate mesini
  function do_ajax_menu_sct_validate_mesini()
  {
    var nomeCampo_mesini = "mesini";
    var var_mesini = scAjaxGetFieldSelect(nomeCampo_mesini);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_sct_validate_mesini(var_mesini, var_script_case_init, do_ajax_menu_sct_validate_mesini_cb);
  } // do_ajax_menu_sct_validate_mesini

  function do_ajax_menu_sct_validate_mesini_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mesini";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_sct_validate_mesini_cb

  // ---------- Validate mesfin
  function do_ajax_menu_sct_validate_mesfin()
  {
    var nomeCampo_mesfin = "mesfin";
    var var_mesfin = scAjaxGetFieldSelect(nomeCampo_mesfin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_sct_validate_mesfin(var_mesfin, var_script_case_init, do_ajax_menu_sct_validate_mesfin_cb);
  } // do_ajax_menu_sct_validate_mesfin

  function do_ajax_menu_sct_validate_mesfin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mesfin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_sct_validate_mesfin_cb

  // ---------- Validate caseta
  function do_ajax_menu_sct_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    var var_caseta = scAjaxGetFieldSelect(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_sct_validate_caseta(var_caseta, var_script_case_init, do_ajax_menu_sct_validate_caseta_cb);
  } // do_ajax_menu_sct_validate_caseta

  function do_ajax_menu_sct_validate_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_sct_validate_caseta_cb

  // ---------- Validate sentido
  function do_ajax_menu_sct_validate_sentido()
  {
    var nomeCampo_sentido = "sentido";
    var var_sentido = scAjaxGetFieldSelect(nomeCampo_sentido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_sct_validate_sentido(var_sentido, var_script_case_init, do_ajax_menu_sct_validate_sentido_cb);
  } // do_ajax_menu_sct_validate_sentido

  function do_ajax_menu_sct_validate_sentido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sentido";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_sct_validate_sentido_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_menu_sct_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_menu_sct_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_menu_sct_submit_form(var_formato, var_year, var_mesini, var_mesfin, var_caseta, var_sentido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_menu_sct_submit_form_cb);
  } // do_ajax_menu_sct_submit_form

  function do_ajax_menu_sct_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_menu_sct_submit_form_cb_after_alert);
  } // do_ajax_menu_sct_submit_form_cb
  function do_ajax_menu_sct_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_menu_sct_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_menu_sct_navigate_form()
  {
    perform_ajax_menu_sct_navigate_form();
  }

  function perform_ajax_menu_sct_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_menu_sct_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['menu_sct']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_menu_sct_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_menu_sct_navigate_form_cb_after_alert);
  } // do_ajax_menu_sct_navigate_form_cb
  function do_ajax_menu_sct_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_menu_sct_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_menu_sct_navigate_form_cb_after_alert

  function sc_hide_menu_sct_form()
  {
