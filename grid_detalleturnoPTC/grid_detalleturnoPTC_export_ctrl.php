<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleturnoPTC']['sc_process_barr'] = true;
require_once('../grid_detalleturnoPTC/index.php');
unset($_SESSION['scriptcase']['grid_detalleturnoPTC']['sc_process_barr']);
$ExportCtrl = new grid_detalleturnoPTC_export_control;
$ExportCtrl->Export_barr();

class grid_detalleturnoPTC_export_control
{
