...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_turno"  <?php echo $str_hide_turno?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_caseta"  <?php echo $str_hide_caseta?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_carril"  <?php echo $str_hide_carril?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pagoid"  <?php echo $str_hide_pagoid?>>
<?php
...
?>
   <span id="idAjaxSelect_pagoid">
      <SELECT class="scFilterObjectOdd" id="SC_pagoid" name="pagoid[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'pagoid[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "pagoid" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
