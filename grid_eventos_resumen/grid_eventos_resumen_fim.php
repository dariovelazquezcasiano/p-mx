...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_eventos_resumen"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_eventos_resumen"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_resumen']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos_resumen']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_resumen']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos_resumen']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_eventos_resumen']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_eventos_resumen</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_resumen']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_eventos_resumen']['embutida_filho'] as $ind => $sc_init)
          {
