...
class grid_eventos_resumen_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_eventos_resumen_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_eventos_resumen_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_eventos_resumen_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "sum(if(substr(ap_clasevehiculo_cr,1,1) = 'a',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(substr(ap_clasevehiculo_cr,1,1) = 'm',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'b2',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'b3',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'b4',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c2',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c3',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c4',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c5',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c6',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c7',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c8',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(ap_clasevehiculo_cr = 'c9',ap_importe_cr,0))";$Nm_numeric[] = "sum(if(substr(ap_clasevehiculo_cr,1,1) = 'a',ap_tarifaee_cr,0))";$Nm_numeric[] = "sum(if(substr(ap_clasevehiculo_cr,1,1) != 'a',ap_tarifaee_cr,0))";$Nm_numeric[] = "";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "ap.FechaOperacion";$Nm_datas[] = "ap_FechaOperacion";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Aforo e ingreso</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_eventos_resumen/grid_eventos_resumen_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_eventos_resumen_ajax_search.js"></script>
 <script type="text/javascript" src="grid_eventos_resumen_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_eventos_resumen_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_eventos_resumen']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_eventos_resumen']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_turno#NMF#' + search_get_select('SC_turno') + '@NMF@';
  str_out += 'SC_caseta_cond#NMF#' + search_get_sel_txt('SC_caseta_cond') + '@NMF@';
  str_out += 'SC_caseta#NMF#' + search_get_select('SC_caseta') + '@NMF@';
  str_out += 'SC_carril_cond#NMF#' + search_get_sel_txt('SC_carril_cond') + '@NMF@';
  str_out += 'SC_carril#NMF#' + search_get_select('SC_carril') + '@NMF@';
  str_out += 'SC_pagoid_cond#NMF#' + search_get_sel_txt('SC_pagoid_cond') + '@NMF@';
  str_out += 'SC_pagoid#NMF#' + search_get_Dselelect('SC_pagoid_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Aforo e ingreso</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_cond']; 
          $turno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['turno']; 
          $turno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['turno_cond']; 
          $caseta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['caseta']; 
          $caseta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['caseta_cond']; 
          $carril = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['carril']; 
          $carril_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['carril_cond']; 
          $pagoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['pagoid']; 
          $pagoid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['pagoid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['NM_operador']; 
      } 
      if (!isset($turno_cond) || empty($turno_cond))
      {
         $turno_cond = "eq";
      }
      if (!isset($caseta_cond) || empty($caseta_cond))
      {
         $caseta_cond = "eq";
      }
      if (!isset($carril_cond) || empty($carril_cond))
      {
         $carril_cond = "eq";
      }
      if (!isset($pagoid_cond) || empty($pagoid_cond))
      {
         $pagoid_cond = "eq";
      }
      if (!isset($fecha_cond) || empty($fecha_cond))
      {
         $fecha_cond = "bi_este_mes_full";
      }
      ...
      $str_hide_caseta = (in_array($caseta_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_carril = (in_array($carril_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pagoid = (in_array($pagoid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fecha = ('bw' == $fecha_cond || 'bi_' == substr($fecha_cond, 0, 3)) ? $display_aberto : $display_fechado;
      $str_display_turno = ('bw' == $turno_cond) ? $display_aberto : $display_fechado;
      $str_display_caseta = ('bw' == $caseta_cond) ? $display_aberto : $display_fechado;
      $str_display_carril = ('bw' == $carril_cond) ? $display_aberto : $display_fechado;
      $str_display_pagoid = ('bw' == $pagoid_cond) ? $display_aberto : $display_fechado;

      // pagoid
      if (is_array($pagoid) && !empty($pagoid))
      {
         $tmp_array = array();
         $pagoid_val_str = "";
         foreach ($pagoid as $tmp_val_cmp)
         {
            if ("" != $pagoid_val_str)
            {
               $pagoid_val_str .= ",";
      ...
      {
         $tmp_pos = (is_string($turno)) ? strpos($turno, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      if (!isset($caseta) || $caseta == "")
      {
          $caseta = "";
      }
      if (isset($caseta) && !empty($caseta))
      {
         $tmp_pos = (is_string($caseta)) ? strpos($caseta, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $caseta = substr($caseta, 0, $tmp_pos);
         }
      }
      if (!isset($carril) || $carril == "")
      {
          $carril = "";
      }
      if (isset($carril) && !empty($carril))
      {
         $tmp_pos = (is_string($carril)) ? strpos($carril, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $carril = substr($carril, 0, $tmp_pos);
         }
      }
      if (!isset($pagoid) || $pagoid == "")
      {
          $pagoid = array();
      }
?>
...
?>
      ...
      <TD id='SC_turno_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['turno'])) ? $this->New_label['turno'] : "Turno"; ?></TD>
      
      <INPUT type="hidden" id="SC_turno_cond" name="turno_cond" value="eq">
...
?>
   <span id="idAjaxSelect_turno">
      <SELECT class="scFilterObjectEven" id="SC_turno" name="turno"  size="1">
       <OPTION value=""></OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $turno)
            {
                    $turno_sel = ($nm_opc_cod === $turno) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $turno_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_caseta_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['caseta'])) ? $this->New_label['caseta'] : "Caseta"; ?></TD>
      
      <INPUT type="hidden" id="SC_caseta_cond" name="caseta_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_caseta" <?php echo $str_hide_caseta?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['caseta'])) ? $this->New_label['caseta'] : "Caseta";
 $nmgp_tab_label .= "caseta?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_caseta">
      <SELECT class="scFilterObjectOdd" id="SC_caseta" name="caseta"  size="1">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $caseta)
            {
                    $caseta_sel = ($nm_opc_cod === $caseta) ? "selected" : "";
            }
            else
            {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $caseta_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_carril_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['carril'])) ? $this->New_label['carril'] : "Carril"; ?></TD>
      
      <INPUT type="hidden" id="SC_carril_cond" name="carril_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_carril" <?php echo $str_hide_carril?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['carril'])) ? $this->New_label['carril'] : "Carril";
 $nmgp_tab_label .= "carril?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_carril">
      <SELECT class="scFilterObjectEven" id="SC_carril" name="carril"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $carril)
            {
                    $carril_sel = ($nm_opc_cod === $carril) ? "selected" : "";
            }
            else
            {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $carril_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_pagoid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pagoid'])) ? $this->New_label['pagoid'] : "Pago ID"; ?></TD>
      
      <INPUT type="hidden" id="SC_pagoid_cond" name="pagoid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pagoid" <?php echo $str_hide_pagoid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pagoid'])) ? $this->New_label['pagoid'] : "Pago ID";
 $nmgp_tab_label .= "pagoid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_pagoid_orig" name="pagoid_orig" size=7 multiple onDblClick="nm_add_sel('pagoid_orig', 'pagoid_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $pagoid_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('pagoid_orig', 'pagoid_dest', 'N', '');", "nm_add_all('pagoid_orig', 'pagoid_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('pagoid_orig', 'pagoid_dest', 'N', '');", "nm_add_sel('pagoid_orig', 'pagoid_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('pagoid_dest', 'pagoid_orig', 'N', '');", "nm_del_sel('pagoid_dest', 'pagoid_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('pagoid_dest', 'pagoid_orig', 'N', '');", "nm_del_all('pagoid_dest', 'pagoid_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_pagoid_dest" name="pagoid_dest" size=7 multiple  onDblClick="nm_del_sel('pagoid_dest', 'pagoid_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_pagoid" name="pagoid" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.pagoid_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_eventos_resumen_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fecha_cond.value = 'bi_este_mes_full';
   ...
   document.F1.turno_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_turno'), document.F1.turno_cond, 'turno');
   document.F1.turno.value = "";
   document.F1.caseta_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_caseta'), document.F1.caseta_cond, 'caseta');
   document.F1.caseta.value = "";
   document.F1.carril_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_carril'), document.F1.carril_cond, 'carril');
   document.F1.carril.value = "";
   document.F1.pagoid_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_pagoid'), document.F1.pagoid_cond, 'pagoid');
   nm_del_all('pagoid_dest', 'pagoid_orig', 'N', '');
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_eventos_resumen_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_eventos_resumen_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_eventos_resumen_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_eventos_resumen_valida_mes(this)});
 }
 function sc_grid_eventos_resumen_valida_dia(obj)
 {
 ...
 function sc_grid_eventos_resumen_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_turno'] = 'select';
      $tp_fields['SC_caseta_cond'] = 'cond';
      $tp_fields['SC_caseta'] = 'select';
      $tp_fields['SC_carril_cond'] = 'cond';
      $tp_fields['SC_carril'] = 'select';
      $tp_fields['SC_pagoid_cond'] = 'cond';
      $tp_fields['SC_pagoid'] = 'dselect';
   ...
   function trata_campos()
   {
      global $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             ...
             $caseta_cond, $caseta,
             $carril_cond, $carril,
             $pagoid_cond, $pagoid, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'pagoid')
              {
                  $$Cmps = implode("@?@", $Vals);
      ...
      $caseta_cond_salva = $caseta_cond; 
      if (!isset($caseta_input_2) || $caseta_input_2 == "")
      {
          $caseta_input_2 = $caseta;
      }
      $carril_cond_salva = $carril_cond; 
      if (!isset($carril_input_2) || $carril_input_2 == "")
      {
          $carril_input_2 = $carril;
      }
      $pagoid_cond_salva = $pagoid_cond; 
      if (!isset($pagoid_input_2) || $pagoid_input_2 == "")
      {
          $pagoid_input_2 = $pagoid;
      }
      $tmp_pos = (is_string($turno)) ? strpos($turno, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $turno;
          ...
          $L_lookup = substr($turno, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['psq_check_ret']['turno'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($caseta, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['psq_check_ret']['caseta'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($carril, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['psq_check_ret']['carril'])) {
      ...
      if (is_array($pagoid)) {
          foreach ($pagoid as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['psq_check_ret']['pagoid'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Pago ID : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['cmp'] = "fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['opc'] = $fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['turno'] = $turno; 
      if (is_array($turno) && !empty($turno))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0] = $turno;
      }
      elseif ($turno_cond_salva == "nu" || $turno_cond_salva == "nn" || $turno_cond_salva == "ep" || $turno_cond_salva == "ne" || !empty($turno))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0][0] = $turno;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['turno_cond'] = $turno_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['cmp'] = "turno"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['opc'] = $turno_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['turno'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['caseta'] = $caseta; 
      if (is_array($caseta) && !empty($caseta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0] = $caseta;
      }
      elseif ($caseta_cond_salva == "nu" || $caseta_cond_salva == "nn" || $caseta_cond_salva == "ep" || $caseta_cond_salva == "ne" || !empty($caseta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0][0] = $caseta;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['caseta_cond'] = $caseta_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['cmp'] = "caseta"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['opc'] = $caseta_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['caseta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['carril'] = $carril; 
      if (is_array($carril) && !empty($carril))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0] = $carril;
      }
      elseif ($carril_cond_salva == "nu" || $carril_cond_salva == "nn" || $carril_cond_salva == "ep" || $carril_cond_salva == "ne" || !empty($carril))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0][0] = $carril;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['carril_cond'] = $carril_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['cmp'] = "carril"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['opc'] = $carril_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['carril'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['pagoid'] = $pagoid; 
      if (is_array($pagoid) && !empty($pagoid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0] = $pagoid;
      }
      elseif ($pagoid_cond_salva == "nu" || $pagoid_cond_salva == "nn" || $pagoid_cond_salva == "ep" || $pagoid_cond_salva == "ne" || !empty($pagoid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['val'][0][0] = $pagoid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['pagoid_cond'] = $pagoid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['cmp'] = "pagoid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid]['opc'] = $pagoid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['pagoid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['caseta'] = $Conteudo;
      $Conteudo = $carril;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['carril'] = $Conteudo;
      $this->cmp_formatado['pagoid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['pagoid'];
      $this->cmp_formatado['pagoid_input_2'] = $pagoid_input_2;
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']['fecha_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("ap.FechaOperacion", $fecha_cond, $fecha, $fecha_input_2, 'fecha', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['fecha']['label'] = $nmgp_tab_label['fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['fecha']['descr'] = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['fecha']['hint']  = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (isset($turno))
      {
         $this->monta_condicao("ap.TurnoID", $turno_cond, $turno, "", "turno", "TINY", false);
      }
      ...
      if (isset($caseta))
      {
         $this->monta_condicao("ap.CasetaID", $caseta_cond, $caseta, "", "caseta", "VARCHAR", false);
      }
      ...
      if (isset($carril))
      {
         $this->monta_condicao("ap.CarrilID", $carril_cond, $carril, "", "carril", "TINY", false);
      }

      //----- $pagoid
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($pagoid_cond == "nu" || $pagoid_cond == "nn" || $pagoid_cond == "ep" || $pagoid_cond == "ne")
      {
          $pagoid = array();
      }
      if (is_array($pagoid) && count($pagoid) != 0)
      {
         foreach ($pagoid as $i => $dados)
         {
      ...
      if (is_array($pagoid) && count($pagoid) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($pagoid_cond == "df" || $pagoid_cond == "np")
         {
             $this->comando        .= " ap.PagoID not in (";
             $this->comando_sum    .= " aforo.ap.PagoID not in (";
             $this->comando_filtro .= " ap.PagoID not in (";
         }
         else
         {
             $this->comando        .= " ap.PagoID in (";
             $this->comando_sum    .= " aforo.ap.PagoID in (";
             $this->comando_filtro .= " ap.PagoID in (";
         }
         $x                     = count($pagoid);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($pagoid as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($pagoid) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$pagoid_cond]) ? $Lang_descr[$pagoid_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $nmgp_tab_label['pagoid'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['pagoid']['label'] = $nmgp_tab_label['pagoid'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['pagoid']['descr'] = $nmgp_tab_label['pagoid'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['grid_pesq']['pagoid']['hint'] = $nmgp_tab_label['pagoid'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($pagoid) && ($pagoid_cond == "nu" || $pagoid_cond == "nn" || $pagoid_cond == "ep" || $pagoid_cond == "ne"))
      {
         $this->monta_condicao("ap.PagoID", $pagoid_cond, "", "", "pagoid", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumen']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "turno" : return ('class="scFilterObjectEven"'); break;
         case "caseta" : return ('class="scFilterObjectOdd"'); break;
         case "carril" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
