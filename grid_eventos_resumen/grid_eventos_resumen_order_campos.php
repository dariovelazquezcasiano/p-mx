...
<?php
   ...
   $Ord_Cmp = new grid_eventos_resumen_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_eventos_resumen_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['nombretipopago'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nombretipopago'] = "nombretipopago";
   }
   else
   {
       $tab_def_campos['nombretipopago'] = "tp.Tipo";
   }
   $tab_labels["nombretipopago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["nombretipopago"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["nombretipopago"] : "Nombre Tipo Pago";
   $tab_ger_campos['a'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a'] = "a";
   ...
   {
       $tab_def_campos['a'] = "SUM(IF(SUBSTR(ap.ClaseVehiculo_CR,1,1) = 'A',ap.Importe_CR,0))";
   }
   $tab_labels["a"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["a"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["a"] : "A";
   $tab_ger_campos['m'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['m'] = "m";
   ...
   {
       $tab_def_campos['m'] = "SUM(IF(SUBSTR(ap.ClaseVehiculo_CR,1,1) = 'M',ap.Importe_CR,0))";
   }
   $tab_labels["m"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["m"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["m"] : "M";
   $tab_ger_campos['b2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b2'] = "b2";
   }
   else
   {
       $tab_def_campos['b2'] = "SUM(IF(ap.ClaseVehiculo_CR = 'B2',ap.Importe_CR,0))";
   }
   $tab_labels["b2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["b2"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["b2"] : "B2";
   $tab_ger_campos['b3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b3'] = "b3";
   }
   else
   {
       $tab_def_campos['b3'] = "SUM(IF(ap.ClaseVehiculo_CR = 'B3',ap.Importe_CR,0))";
   }
   $tab_labels["b3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["b3"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["b3"] : "B3";
   $tab_ger_campos['b4'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b4'] = "b4";
   }
   else
   {
       $tab_def_campos['b4'] = "SUM(IF(ap.ClaseVehiculo_CR = 'B4',ap.Importe_CR,0))";
   }
   $tab_labels["b4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["b4"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["b4"] : "B4";
   $tab_ger_campos['c2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c2'] = "c2";
   }
   else
   {
       $tab_def_campos['c2'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C2',ap.Importe_CR,0))";
   }
   $tab_labels["c2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c2"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c2"] : "C2";
   $tab_ger_campos['c3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c3'] = "c3";
   }
   else
   {
       $tab_def_campos['c3'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C3',ap.Importe_CR,0))";
   }
   $tab_labels["c3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c3"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c3"] : "C3";
   $tab_ger_campos['c4'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c4'] = "c4";
   }
   else
   {
       $tab_def_campos['c4'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C4',ap.Importe_CR,0))";
   }
   $tab_labels["c4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c4"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c4"] : "C4";
   $tab_ger_campos['c5'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c5'] = "c5";
   }
   else
   {
       $tab_def_campos['c5'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C5',ap.Importe_CR,0))";
   }
   $tab_labels["c5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c5"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c5"] : "C5";
   $tab_ger_campos['c6'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c6'] = "c6";
   }
   else
   {
       $tab_def_campos['c6'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C6',ap.Importe_CR,0))";
   }
   $tab_labels["c6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c6"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c6"] : "C6";
   $tab_ger_campos['c7'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c7'] = "c7";
   }
   else
   {
       $tab_def_campos['c7'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C7',ap.Importe_CR,0))";
   }
   $tab_labels["c7"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c7"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c7"] : "C7";
   $tab_ger_campos['c8'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c8'] = "c8";
   }
   else
   {
       $tab_def_campos['c8'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C8',ap.Importe_CR,0))";
   }
   $tab_labels["c8"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c8"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c8"] : "C8";
   $tab_ger_campos['c9'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c9'] = "c9";
   }
   else
   {
       $tab_def_campos['c9'] = "SUM(IF(ap.ClaseVehiculo_CR = 'C9',ap.Importe_CR,0))";
   }
   $tab_labels["c9"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c9"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["c9"] : "C9";
   $tab_ger_campos['eea'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['eea'] = "eea";
   }
   else
   {
       $tab_def_campos['eea'] = "SUM(IF(SUBSTR(ap.ClaseVehiculo_CR,1,1) = 'A',ap.TarifaEE_CR,0))";
   }
   $tab_labels["eea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["eea"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["eea"] : "EEA";
   $tab_ger_campos['eec'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['eec'] = "eec";
   }
   else
   {
       $tab_def_campos['eec'] = "SUM(IF(SUBSTR(ap.ClaseVehiculo_CR,1,1) != 'A',ap.TarifaEE_CR,0))";
   }
   $tab_labels["eec"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["eec"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["eec"] : "EEC";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['labels']["total"] : "Importe Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_eventos_resumen_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_eventos_resumen']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
