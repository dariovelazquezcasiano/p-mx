...
class grid_preliquidacion_fs_ok_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']))
      { 
