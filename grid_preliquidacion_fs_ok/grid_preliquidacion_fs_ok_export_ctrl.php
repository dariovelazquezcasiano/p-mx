<?php
@session_start() ;
$_SESSION['scriptcase']['grid_preliquidacion_fs_ok']['sc_process_barr'] = true;
require_once('../grid_preliquidacion_fs_ok/index.php');
unset($_SESSION['scriptcase']['grid_preliquidacion_fs_ok']['sc_process_barr']);
$ExportCtrl = new grid_preliquidacion_fs_ok_export_control;
$ExportCtrl->Export_barr();

class grid_preliquidacion_fs_ok_export_control
{
