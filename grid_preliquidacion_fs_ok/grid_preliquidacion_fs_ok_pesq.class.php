...
class grid_preliquidacion_fs_ok_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_preliquidacion_fs_ok_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_preliquidacion_fs_ok_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_preliquidacion_fs_ok_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_refresh_field")
      {
          ...
          if (in_array("carrilid", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_carrilid($casetaid);
              ...
              $this->Arr_result['set_option'][] = array('field' => 'SC_carrilid', 'value' => $list);
          }
      }
   }
   function lookup_ajax_carrilid($casetaid)
   {
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "consecutivo";$Nm_numeric[] = "turnoid";$Nm_numeric[] = "casetaid";$Nm_numeric[] = "tramoid";$Nm_numeric[] = "carrilid";$Nm_numeric[] = "preliquidado";$Nm_numeric[] = "montocr";$Nm_numeric[] = "montoana";$Nm_numeric[] = "cantidadmxn";$Nm_numeric[] = "cantidadusd";$Nm_numeric[] = "importemxn";$Nm_numeric[] = "importeusd";$Nm_numeric[] = "folioinicialcr";$Nm_numeric[] = "foliofinalcr";$Nm_numeric[] = "folioinicialeap";$Nm_numeric[] = "foliofinaleap";$Nm_numeric[] = "if(faltante>=0,faltante,0)";$Nm_numeric[] = "if(faltante<0,abs(faltante),0)";$Nm_numeric[] = "entregado";$Nm_numeric[] = "administradorid";$Nm_numeric[] = "encargadoturnoid";$Nm_numeric[] = "encargadoturnoid_pre";$Nm_numeric[] = "operacion";$Nm_numeric[] = "if(faltanteana>=0,faltanteana,0)";$Nm_numeric[] = "if(faltanteana<0,abs(faltanteana),0)";$Nm_numeric[] = "";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_datas[] = "FechaTurno";$Nm_datas[] = "HoraInicio";$Nm_datas[] = "FechaFin";$Nm_datas[] = "HoraFin";$Nm_datas[] = "FechaCierre";$Nm_datas[] = "FechaPreLiq";$Nm_datas[] = "FechaLiq";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_preliquidacion_fs_ok/grid_preliquidacion_fs_ok_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>_lib/css/peaje_module_ui.css?v=20260911-ui" />
</HEAD>
<?php
$vertical_center = '';
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_preliquidacion_fs_ok_ajax_search.js"></script>
 <script type="text/javascript" src="grid_preliquidacion_fs_ok_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_preliquidacion_fs_ok_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_preliquidacion_fs_ok']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_preliquidacion_fs_ok']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_carrilid#NMF#' + search_get_select('SC_carrilid') + '@NMF@';
  str_out += 'SC_cuerpo_cond#NMF#' + search_get_sel_txt('SC_cuerpo_cond') + '@NMF@';
  str_out += 'SC_cuerpo#NMF#' + search_get_select('SC_cuerpo') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Detalle de Preliquidaciones</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $casetaid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['casetaid']; 
          $casetaid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['casetaid_cond']; 
          $fechaoperacion_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_dia']; 
          $fechaoperacion_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_mes']; 
          $fechaoperacion_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_ano']; 
          $fechaoperacion_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_input_2_dia']; 
          $fechaoperacion_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_input_2_mes']; 
          $fechaoperacion_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_input_2_ano']; 
          $fechaoperacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_cond']; 
          $turnoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['turnoid']; 
          $turnoid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['turnoid_cond']; 
          $carrilid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['carrilid']; 
          $carrilid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['carrilid_cond']; 
          $cuerpo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['cuerpo']; 
          $cuerpo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['cuerpo_cond']; 
          $usuarioid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['usuarioid']; 
          $usuarioid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['usuarioid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_casetaid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['casetaid'])) ? $this->New_label['casetaid'] : "Caseta"; ?> <span class="scFilterRequiredOdd">*</span></TD>
...
?>
      ...
      <TD id='SC_fechaoperacion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fechaoperacion'])) ? $this->New_label['fechaoperacion'] : "Fecha Operacion"; ?> <span class="scFilterRequiredOdd">*</span></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fechaoperacion_cond" name="fechaoperacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaoperacion'), this, 'fechaoperacion')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="bi_HJ" <?php if ("bi_HJ" == $fechaoperacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
     ...
     <TD  class="scFilterFieldEven"><SPAN id="Nm_bi_dados_fechaoperacion" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_fechaoperacion"  style=display:  border="0" cellpadding="0" cellspacing="0">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fechaoperacion"  <?php echo $str_display_fechaoperacion; ?> class="scFilterFieldFontEven">
...
?>
      ...
      <TD id='SC_turnoid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['turnoid'])) ? $this->New_label['turnoid'] : "Turno"; ?></TD>
      
      <INPUT type="hidden" id="SC_turnoid_cond" name="turnoid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_turnoid" <?php echo $str_hide_turnoid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
      ...
      <TD id='SC_carrilid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['carrilid'])) ? $this->New_label['carrilid'] : "Carril"; ?></TD>
      
      <INPUT type="hidden" id="SC_carrilid_cond" name="carrilid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_carrilid" <?php echo $str_hide_carrilid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
   <span id="idAjaxSelect_carrilid">
      <SELECT class="scFilterObjectEven" id="SC_carrilid" name="carrilid"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
      ...
      <TD id='SC_cuerpo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cuerpo'])) ? $this->New_label['cuerpo'] : "Cuerpo"; ?></TD>
...
<?php
 ...
 <SELECT class="scFilterObjectOdd" id="SC_cuerpo"  name="cuerpo"  size="1">
 <OPTION value=""></option>
 ...
 <OPTION value="B##@@B"<?php if ($cuerpo == "B") { echo " selected" ;} ?>>B</option>
      ...
      <TD id='SC_usuarioid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['usuarioid'])) ? $this->New_label['usuarioid'] : "Cajero"; ?></TD>
      
      <INPUT type="hidden" id="SC_usuarioid_cond" name="usuarioid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usuarioid" <?php echo $str_hide_usuarioid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_preliquidacion_fs_ok_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fechaoperacion_cond.value = 'bi_HJ';
 ...
 {
    $('#SC_fechaoperacion_dia').bind('change', function() {sc_grid_preliquidacion_fs_ok_valida_dia(this)});
    $('#SC_fechaoperacion_input_2_dia').bind('change', function() {sc_grid_preliquidacion_fs_ok_valida_dia(this)});
    $('#SC_fechaoperacion_input_2_mes').bind('change', function() {sc_grid_preliquidacion_fs_ok_valida_mes(this)});
    $('#SC_fechaoperacion_mes').bind('change', function() {sc_grid_preliquidacion_fs_ok_valida_mes(this)});
 }
 function sc_grid_preliquidacion_fs_ok_valida_dia(obj)
 {
 ...
 function sc_grid_preliquidacion_fs_ok_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_carrilid'] = 'select';
      $tp_fields['SC_cuerpo_cond'] = 'cond';
      $tp_fields['SC_cuerpo'] = 'select';
   ...
   function trata_campos()
   {
      global $casetaid_cond, $casetaid,
             ...
             $carrilid_cond, $carrilid,
             $cuerpo_cond, $cuerpo,
             $usuarioid_cond, $usuarioid, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['psq_check_ret']['casetaid'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['psq_check_ret']['turnoid'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['psq_check_ret']['carrilid'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['psq_check_ret']['cuerpo'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['psq_check_ret']['usuarioid'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['casetaid'] = $casetaid; 
      if (is_array($casetaid) && !empty($casetaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0] = $casetaid;
      }
      elseif ($casetaid_cond_salva == "nu" || $casetaid_cond_salva == "nn" || $casetaid_cond_salva == "ep" || $casetaid_cond_salva == "ne" || !empty($casetaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][0] = $casetaid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['casetaid_cond'] = $casetaid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['cmp'] = "casetaid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['opc'] = $casetaid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['casetaid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_dia'] = $fechaoperacion_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_mes'] = $fechaoperacion_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_ano'] = $fechaoperacion_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_input_2_dia'] = $fechaoperacion_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_input_2_mes'] = $fechaoperacion_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_input_2_ano'] = $fechaoperacion_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fechaoperacion_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fechaoperacion_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fechaoperacion_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fechaoperacion_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fechaoperacion_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fechaoperacion_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_cond'] = $fechaoperacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['cmp'] = "fechaoperacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['opc'] = $fechaoperacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['fechaoperacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['turnoid'] = $turnoid; 
      if (is_array($turnoid) && !empty($turnoid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0] = $turnoid;
      }
      elseif ($turnoid_cond_salva == "nu" || $turnoid_cond_salva == "nn" || $turnoid_cond_salva == "ep" || $turnoid_cond_salva == "ne" || !empty($turnoid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][0] = $turnoid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['turnoid_cond'] = $turnoid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['cmp'] = "turnoid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['opc'] = $turnoid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['turnoid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['carrilid'] = $carrilid; 
      if (is_array($carrilid) && !empty($carrilid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0] = $carrilid;
      }
      elseif ($carrilid_cond_salva == "nu" || $carrilid_cond_salva == "nn" || $carrilid_cond_salva == "ep" || $carrilid_cond_salva == "ne" || !empty($carrilid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][0] = $carrilid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['carrilid_cond'] = $carrilid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['cmp'] = "carrilid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['opc'] = $carrilid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['carrilid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['cuerpo'] = $cuerpo; 
      if (is_array($cuerpo) && !empty($cuerpo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0] = $cuerpo;
      }
      elseif ($cuerpo_cond_salva == "nu" || $cuerpo_cond_salva == "nn" || $cuerpo_cond_salva == "ep" || $cuerpo_cond_salva == "ne" || !empty($cuerpo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][0] = $cuerpo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['cuerpo_cond'] = $cuerpo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['cmp'] = "cuerpo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['opc'] = $cuerpo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['cuerpo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['usuarioid'] = $usuarioid; 
      if (is_array($usuarioid) && !empty($usuarioid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0] = $usuarioid;
      }
      elseif ($usuarioid_cond_salva == "nu" || $usuarioid_cond_salva == "nn" || $usuarioid_cond_salva == "ep" || $usuarioid_cond_salva == "ne" || !empty($usuarioid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['val'][0][0] = $usuarioid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['usuarioid_cond'] = $usuarioid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['cmp'] = "usuarioid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid]['opc'] = $usuarioid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['usuarioid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($fechaoperacion_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion'] = $val[0];
          ...
          if ($fechaoperacion_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']['fechaoperacion_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['fechaoperacion']['label'] = $nmgp_tab_label['fechaoperacion'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['fechaoperacion']['descr'] = $nmgp_tab_label['fechaoperacion'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['grid_pesq']['fechaoperacion']['hint']  = $nmgp_tab_label['fechaoperacion'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (isset($cuerpo))
      {
         $this->monta_condicao("Cuerpo", $cuerpo_cond, $cuerpo, "", "cuerpo", "VARCHAR", false);
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs_ok']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "carrilid" : return ('class="scFilterObjectEven"'); break;
