<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tramo']['sc_process_barr'] = true;
require_once('../grid_tramo/index.php');
unset($_SESSION['scriptcase']['grid_tramo']['sc_process_barr']);
$ExportCtrl = new grid_tramo_export_control;
$ExportCtrl->Export_barr();

class grid_tramo_export_control
{
