  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detalleemergentes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detalleemergentes_form();
	}
...
?>
  ...
  function do_ajax_form_detalleemergentes_validate_estatusemergente()
  {
  } // do_ajax_form_detalleemergentes_validate_estatusemergente

  function do_ajax_form_detalleemergentes_validate_estatusemergente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_estatusemergente_cb

  // ---------- Validate casetaid
  function do_ajax_form_detalleemergentes_validate_casetaid()
  {
    var nomeCampo_casetaid = "casetaid";
    var var_casetaid = scAjaxGetFieldSelect(nomeCampo_casetaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_casetaid(var_casetaid, var_script_case_init, do_ajax_form_detalleemergentes_validate_casetaid_cb);
  } // do_ajax_form_detalleemergentes_validate_casetaid

  function do_ajax_form_detalleemergentes_validate_casetaid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_casetaid_cb

  // ---------- Validate fechaoperacion
  function do_ajax_form_detalleemergentes_validate_fechaoperacion()
  {
    ...
    setTimeout(function() {
      var var_fechaoperacion = scAjaxGetFieldText(nomeCampo_fechaoperacion);
      x_ajax_form_detalleemergentes_validate_fechaoperacion(var_fechaoperacion, var_script_case_init, do_ajax_form_detalleemergentes_validate_fechaoperacion_cb);
    }, 200);
  } // do_ajax_form_detalleemergentes_validate_fechaoperacion

  function do_ajax_form_detalleemergentes_validate_fechaoperacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_fechaoperacion_cb

  // ---------- Validate turnoid
  function do_ajax_form_detalleemergentes_validate_turnoid()
  {
    var nomeCampo_turnoid = "turnoid";
    var var_turnoid = scAjaxGetFieldSelect(nomeCampo_turnoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_turnoid(var_turnoid, var_script_case_init, do_ajax_form_detalleemergentes_validate_turnoid_cb);
  } // do_ajax_form_detalleemergentes_validate_turnoid

  function do_ajax_form_detalleemergentes_validate_turnoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "turnoid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_turnoid_cb

  // ---------- Validate usuarioid
  function do_ajax_form_detalleemergentes_validate_usuarioid()
  {
    var nomeCampo_usuarioid = "usuarioid";
    var var_usuarioid = scAjaxGetFieldSelect(nomeCampo_usuarioid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_usuarioid(var_usuarioid, var_script_case_init, do_ajax_form_detalleemergentes_validate_usuarioid_cb);
  } // do_ajax_form_detalleemergentes_validate_usuarioid

  function do_ajax_form_detalleemergentes_validate_usuarioid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_usuarioid_cb

  // ---------- Validate carrilid
  function do_ajax_form_detalleemergentes_validate_carrilid()
  {
    var nomeCampo_carrilid = "carrilid";
    var var_carrilid = scAjaxGetFieldSelect(nomeCampo_carrilid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_carrilid(var_carrilid, var_script_case_init, do_ajax_form_detalleemergentes_validate_carrilid_cb);
  } // do_ajax_form_detalleemergentes_validate_carrilid

  function do_ajax_form_detalleemergentes_validate_carrilid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_carrilid_cb

  // ---------- Validate cuerpo
  function do_ajax_form_detalleemergentes_validate_cuerpo()
  {
    var nomeCampo_cuerpo = "cuerpo";
    var var_cuerpo = scAjaxGetFieldSelect(nomeCampo_cuerpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_cuerpo(var_cuerpo, var_script_case_init, do_ajax_form_detalleemergentes_validate_cuerpo_cb);
  } // do_ajax_form_detalleemergentes_validate_cuerpo

  function do_ajax_form_detalleemergentes_validate_cuerpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cuerpo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_cuerpo_cb

  // ---------- Validate horainicio
  function do_ajax_form_detalleemergentes_validate_horainicio()
  {
    var nomeCampo_horainicio = "horainicio";
    var var_horainicio = scAjaxGetFieldText(nomeCampo_horainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_horainicio(var_horainicio, var_script_case_init, do_ajax_form_detalleemergentes_validate_horainicio_cb);
  } // do_ajax_form_detalleemergentes_validate_horainicio

  function do_ajax_form_detalleemergentes_validate_horainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_horainicio_cb

  // ---------- Validate horafin
  function do_ajax_form_detalleemergentes_validate_horafin()
  {
    var nomeCampo_horafin = "horafin";
    var var_horafin = scAjaxGetFieldText(nomeCampo_horafin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_horafin(var_horafin, var_script_case_init, do_ajax_form_detalleemergentes_validate_horafin_cb);
  } // do_ajax_form_detalleemergentes_validate_horafin

  function do_ajax_form_detalleemergentes_validate_horafin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horafin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_horafin_cb

  // ---------- Validate encargadoturnoid
  function do_ajax_form_detalleemergentes_validate_encargadoturnoid()
  {
    var nomeCampo_encargadoturnoid = "encargadoturnoid";
    var var_encargadoturnoid = scAjaxGetFieldSelect(nomeCampo_encargadoturnoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_encargadoturnoid(var_encargadoturnoid, var_script_case_init, do_ajax_form_detalleemergentes_validate_encargadoturnoid_cb);
  } // do_ajax_form_detalleemergentes_validate_encargadoturnoid

  function do_ajax_form_detalleemergentes_validate_encargadoturnoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_encargadoturnoid_cb

  // ---------- Validate emergentes
  function do_ajax_form_detalleemergentes_validate_emergentes()
  {
    var nomeCampo_emergentes = "emergentes";
    var var_emergentes = scAjaxGetFieldText(nomeCampo_emergentes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleemergentes_validate_emergentes(var_emergentes, var_script_case_init, do_ajax_form_detalleemergentes_validate_emergentes_cb);
  } // do_ajax_form_detalleemergentes_validate_emergentes

  function do_ajax_form_detalleemergentes_validate_emergentes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_emergentes_cb

  // ---------- Validate cantidadtotal
  function do_ajax_form_detalleemergentes_validate_cantidadtotal()
  {
  } // do_ajax_form_detalleemergentes_validate_cantidadtotal

  function do_ajax_form_detalleemergentes_validate_cantidadtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_validate_cantidadtotal_cb

  // ---------- Refresh casetaid
  function do_ajax_form_detalleemergentes_refresh_casetaid()
  {
    var var_casetaid = scAjaxGetFieldSelect("casetaid");
    var var_nmgp_refresh_fields = "carrilid";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detalleemergentes_refresh_casetaid(var_casetaid, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detalleemergentes_refresh_casetaid_cb);
  } // do_ajax_form_detalleemergentes_refresh_casetaid

  function do_ajax_form_detalleemergentes_refresh_casetaid_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_refresh_casetaid_cb

  // ---------- Refresh carrilid
  function do_ajax_form_detalleemergentes_refresh_carrilid()
  {
    var var_carrilid = scAjaxGetFieldSelect("carrilid");
    var var_nmgp_refresh_fields = "cuerpo";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detalleemergentes_refresh_carrilid(var_carrilid, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detalleemergentes_refresh_carrilid_cb);
  } // do_ajax_form_detalleemergentes_refresh_carrilid

  function do_ajax_form_detalleemergentes_refresh_carrilid_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleemergentes_refresh_carrilid_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_detalleemergentes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_detalleemergentes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_detalleemergentes_submit_form(var_estatusemergente, var_casetaid, var_fechaoperacion, var_turnoid, var_usuarioid, var_carrilid, var_cuerpo, var_horainicio, var_horafin, var_encargadoturnoid, var_cantidadtotal, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detalleemergentes_submit_form_cb);
  } // do_ajax_form_detalleemergentes_submit_form

  function do_ajax_form_detalleemergentes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_detalleemergentes_submit_form_cb_after_alert);
  } // do_ajax_form_detalleemergentes_submit_form_cb
  function do_ajax_form_detalleemergentes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detalleemergentes_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_emergentes"] = "off";

  function do_ajax_form_detalleemergentes_navigate_form()
  {
    perform_ajax_form_detalleemergentes_navigate_form();
  }

  function perform_ajax_form_detalleemergentes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_emergentes"] = "on";
    x_ajax_form_detalleemergentes_navigate_form(var_consecutivo, var_turnoid, var_casetaid, var_cuerpo, var_carrilid, var_fechaoperacion, var_horainicio, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detalleemergentes_navigate_form_cb);
  } // do_ajax_form_detalleemergentes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleemergentes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detalleemergentes_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_emergentes"] && "nmsc_iframe_liga_form_emergentes" != scMasterDetailIframe["nmsc_iframe_liga_form_emergentes"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_emergentes"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_emergentes').contentWindow.nm_move('apl_detalhe', true, '800');
        document.getElementById('nmsc_iframe_liga_form_emergentes').style.height = "800";
        document.getElementById('nmsc_iframe_liga_form_emergentes').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detalleemergentes_navigate_form_cb_after_alert);
  } // do_ajax_form_detalleemergentes_navigate_form_cb
  function do_ajax_form_detalleemergentes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_detalleemergentes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_detalleemergentes_navigate_form_cb_after_alert

  function sc_hide_form_detalleemergentes_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_emergentes"])
    {
      return true;
    }
    return false;
