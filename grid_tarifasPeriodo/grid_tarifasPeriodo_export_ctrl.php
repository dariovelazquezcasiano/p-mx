<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tarifasPeriodo']['sc_process_barr'] = true;
require_once('../grid_tarifasPeriodo/index.php');
unset($_SESSION['scriptcase']['grid_tarifasPeriodo']['sc_process_barr']);
$ExportCtrl = new grid_tarifasPeriodo_export_control;
$ExportCtrl->Export_barr();

class grid_tarifasPeriodo_export_control
{
