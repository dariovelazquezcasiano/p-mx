  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casetas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate casetaid_
  function do_ajax_form_casetas_validate_casetaid_(iNumLinha)
  {
    var nomeCampo_casetaid_ = "casetaid_" + iNumLinha;
    var var_casetaid_ = scAjaxGetFieldText(nomeCampo_casetaid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_casetaid_(var_casetaid_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_casetaid__cb);
  } // do_ajax_form_casetas_validate_casetaid_

  function do_ajax_form_casetas_validate_casetaid__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_casetaid__cb

  // ---------- Validate caseta_
  function do_ajax_form_casetas_validate_caseta_(iNumLinha)
  {
    var nomeCampo_caseta_ = "caseta_" + iNumLinha;
    var var_caseta_ = scAjaxGetFieldText(nomeCampo_caseta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_caseta_(var_caseta_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_caseta__cb);
  } // do_ajax_form_casetas_validate_caseta_

  function do_ajax_form_casetas_validate_caseta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "caseta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "caseta_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "caseta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "caseta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_caseta__cb

  // ---------- Validate troncal_
  function do_ajax_form_casetas_validate_troncal_(iNumLinha)
  {
    var nomeCampo_troncal_ = "troncal_" + iNumLinha;
    var var_troncal_ = scAjaxGetFieldRadio(nomeCampo_troncal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_troncal_(var_troncal_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_troncal__cb);
  } // do_ajax_form_casetas_validate_troncal_

  function do_ajax_form_casetas_validate_troncal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "troncal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "troncal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "troncal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "troncal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_troncal__cb

  // ---------- Validate modooperacion_
  function do_ajax_form_casetas_validate_modooperacion_(iNumLinha)
  {
    var nomeCampo_modooperacion_ = "modooperacion_" + iNumLinha;
    var var_modooperacion_ = scAjaxGetFieldSelect(nomeCampo_modooperacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_modooperacion_(var_modooperacion_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_modooperacion__cb);
  } // do_ajax_form_casetas_validate_modooperacion_

  function do_ajax_form_casetas_validate_modooperacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "modooperacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "modooperacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "modooperacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "modooperacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_modooperacion__cb

  // ---------- Validate videoip_
  function do_ajax_form_casetas_validate_videoip_(iNumLinha)
  {
    var nomeCampo_videoip_ = "videoip_" + iNumLinha;
    var var_videoip_ = scAjaxGetFieldText(nomeCampo_videoip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_videoip_(var_videoip_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_videoip__cb);
  } // do_ajax_form_casetas_validate_videoip_

  function do_ajax_form_casetas_validate_videoip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "videoip_" + iLineNumber;
    }
    else
    {
      sFieldValid = "videoip_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "videoip_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "videoip_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_videoip__cb

  // ---------- Validate toleranciacorte_
  function do_ajax_form_casetas_validate_toleranciacorte_(iNumLinha)
  {
    var nomeCampo_toleranciacorte_ = "toleranciacorte_" + iNumLinha;
    var var_toleranciacorte_ = scAjaxGetFieldText(nomeCampo_toleranciacorte_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_toleranciacorte_(var_toleranciacorte_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_toleranciacorte__cb);
  } // do_ajax_form_casetas_validate_toleranciacorte_

  function do_ajax_form_casetas_validate_toleranciacorte__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "toleranciacorte_" + iLineNumber;
    }
    else
    {
      sFieldValid = "toleranciacorte_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "toleranciacorte_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "toleranciacorte_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_toleranciacorte__cb

  // ---------- Validate toperetiro_
  function do_ajax_form_casetas_validate_toperetiro_(iNumLinha)
  {
    var nomeCampo_toperetiro_ = "toperetiro_" + iNumLinha;
    var var_toperetiro_ = scAjaxGetFieldText(nomeCampo_toperetiro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_toperetiro_(var_toperetiro_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_toperetiro__cb);
  } // do_ajax_form_casetas_validate_toperetiro_

  function do_ajax_form_casetas_validate_toperetiro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_toperetiro__cb

  // ---------- Validate carriles_
  function do_ajax_form_casetas_validate_carriles_(iNumLinha)
  {
    var nomeCampo_carriles_ = "carriles_" + iNumLinha;
    var var_carriles_ = scAjaxGetFieldText(nomeCampo_carriles_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_validate_carriles_(var_carriles_, iNumLinha, var_script_case_init, do_ajax_form_casetas_validate_carriles__cb);
  } // do_ajax_form_casetas_validate_carriles_

  function do_ajax_form_casetas_validate_carriles__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "carriles_" + iLineNumber;
    }
    else
    {
      sFieldValid = "carriles_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "carriles_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "carriles_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casetas_validate_carriles__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_casetas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_casetas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casetas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_casetas_add_new_line_cb);
  } // do_ajax_form_casetas_add_new_line

  function do_ajax_form_casetas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_casetas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_casetas_backup_line(iNumLinha)
  {
    var var_casetaid_ = scAjaxGetFieldText("casetaid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casetas_backup_line(var_casetaid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_casetas_backup_line_cb);
  } // do_ajax_form_casetas_backup_line

  function do_ajax_form_casetas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_casetas_backup_line_cb

  function do_ajax_form_casetas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_casetas_cancel_insert

  function do_ajax_form_casetas_cancel_update(iSeqVert)
  {
    do_ajax_form_casetas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_casetas_cancel_update

  function do_ajax_form_casetas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_casetas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_casetas_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_casetas_table_refresh(var_casetaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casetas_table_refresh_cb);
  } //  do_ajax_form_casetas_table_refresh

  function do_ajax_form_casetas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_casetas_table_refresh_cb_after_alert);
  } // do_ajax_form_casetas_table_refresh_cb
  function do_ajax_form_casetas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_casetas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_casetas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_casetas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_casetaid_ = scAjaxGetFieldText("casetaid_" + iNumLinha);
    var var_caseta_ = scAjaxGetFieldText("caseta_" + iNumLinha);
    var var_troncal_ = scAjaxGetFieldRadio("troncal_" + iNumLinha);
    var var_modooperacion_ = scAjaxGetFieldSelect("modooperacion_" + iNumLinha);
    var var_videoip_ = scAjaxGetFieldText("videoip_" + iNumLinha);
    var var_toleranciacorte_ = scAjaxGetFieldText("toleranciacorte_" + iNumLinha);
...
?>
    x_ajax_form_casetas_submit_form(var_casetaid_, var_caseta_, var_troncal_, var_modooperacion_, var_videoip_, var_toleranciacorte_, var_toperetiro_, var_carriles_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casetas_submit_form_cb);
  } // do_ajax_form_casetas_submit_form

  function do_ajax_form_casetas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("caseta_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("troncal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("modooperacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("videoip_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("toleranciacorte_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("toperetiro_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("carriles_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casetas_submit_form_cb_after_alert);
  } // do_ajax_form_casetas_submit_form_cb
  function do_ajax_form_casetas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casetas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_casetas_navigate_form()
  {
    perform_ajax_form_casetas_navigate_form();
  }

  function perform_ajax_form_casetas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_casetas_cancel_insert(sc_form_casetas_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("caseta_" + iNavForm);
      scAjaxHideErrorDisplay("troncal_" + iNavForm);
      scAjaxHideErrorDisplay("modooperacion_" + iNavForm);
      scAjaxHideErrorDisplay("videoip_" + iNavForm);
      scAjaxHideErrorDisplay("toleranciacorte_" + iNavForm);
      scAjaxHideErrorDisplay("toperetiro_" + iNavForm);
      scAjaxHideErrorDisplay("carriles_" + iNavForm);
    }
    var var_casetaid_ = document.F2.casetaid_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_casetas_navigate_form(var_casetaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casetas_navigate_form_cb);
  } // do_ajax_form_casetas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casetas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casetas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casetas_navigate_form_cb_after_alert);
  } // do_ajax_form_casetas_navigate_form_cb
  function do_ajax_form_casetas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_casetas_navigate_form_cb_after_alert

    function sc_form_casetas_get_last_line_number()
    {
    ...
    } //sc_form_casetas_get_last_line_number

  function sc_hide_form_casetas_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "caseta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "troncal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "modooperacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "videoip_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "toleranciacorte_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "toperetiro_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "carriles_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["casetaid_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["caseta_" + iNumLinha] = {"label": "Caseta<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["troncal_" + iNumLinha] = {"label": "Troncal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["modooperacion_" + iNumLinha] = {"label": "Modo Operacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["videoip_" + iNumLinha] = {"label": "Video IP<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["toleranciacorte_" + iNumLinha] = {"label": "Tolerancia Corte<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["carriles_" + iNumLinha] = {"label": "Carriles<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["casetaid_"][iNumLinha] = "casetaid_" + iNumLinha;
    ajax_field_mult["caseta_"][iNumLinha] = "caseta_" + iNumLinha;
    ajax_field_mult["troncal_"][iNumLinha] = "troncal_" + iNumLinha;
    ajax_field_mult["modooperacion_"][iNumLinha] = "modooperacion_" + iNumLinha;
    ajax_field_mult["videoip_"][iNumLinha] = "videoip_" + iNumLinha;
    ajax_field_mult["toleranciacorte_"][iNumLinha] = "toleranciacorte_" + iNumLinha;
    ajax_field_mult["toperetiro_"][iNumLinha] = "toperetiro_" + iNumLinha;
    ajax_field_mult["carriles_"][iNumLinha] = "carriles_" + iNumLinha;
    ajax_field_id["casetaid_" + iNumLinha] = new Array("hidden_field_label_casetaid_", "hidden_field_data_casetaid_" + iNumLinha);
    ajax_field_id["caseta_" + iNumLinha] = new Array("hidden_field_label_caseta_", "hidden_field_data_caseta_" + iNumLinha);
    ajax_field_id["troncal_" + iNumLinha] = new Array("hidden_field_label_troncal_", "hidden_field_data_troncal_" + iNumLinha);
    ajax_field_id["modooperacion_" + iNumLinha] = new Array("hidden_field_label_modooperacion_", "hidden_field_data_modooperacion_" + iNumLinha);
    ajax_field_id["videoip_" + iNumLinha] = new Array("hidden_field_label_videoip_", "hidden_field_data_videoip_" + iNumLinha);
    ajax_field_id["toleranciacorte_" + iNumLinha] = new Array("hidden_field_label_toleranciacorte_", "hidden_field_data_toleranciacorte_" + iNumLinha);
    ajax_field_id["toperetiro_" + iNumLinha] = new Array("hidden_field_label_toperetiro_", "hidden_field_data_toperetiro_" + iNumLinha);
    ajax_field_id["carriles_" + iNumLinha] = new Array("hidden_field_label_carriles_", "hidden_field_data_carriles_" + iNumLinha);
    ajax_error_count["casetaid_" + iNumLinha] = "off";
    ajax_error_count["caseta_" + iNumLinha] = "off";
    ajax_error_count["troncal_" + iNumLinha] = "off";
    ajax_error_count["modooperacion_" + iNumLinha] = "off";
    ajax_error_count["videoip_" + iNumLinha] = "off";
    ajax_error_count["toleranciacorte_" + iNumLinha] = "off";
    ajax_error_count["toperetiro_" + iNumLinha] = "off";
    ajax_error_count["carriles_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["casetaid_" + iNumLinha] = "on";
    ajax_read_only["caseta_" + iNumLinha] = "off";
    ajax_read_only["troncal_" + iNumLinha] = "off";
    ajax_read_only["modooperacion_" + iNumLinha] = "off";
    ajax_read_only["videoip_" + iNumLinha] = "off";
    ajax_read_only["toleranciacorte_" + iNumLinha] = "off";
    ajax_read_only["toperetiro_" + iNumLinha] = "off";
    ajax_read_only["carriles_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["casetaid_" + iNumLinha] = "on";
    ajax_read_only["caseta_" + iNumLinha] = "on";
    ajax_read_only["troncal_" + iNumLinha] = "on";
    ajax_read_only["modooperacion_" + iNumLinha] = "on";
    ajax_read_only["videoip_" + iNumLinha] = "on";
    ajax_read_only["toleranciacorte_" + iNumLinha] = "on";
    ajax_read_only["toperetiro_" + iNumLinha] = "on";
    ajax_read_only["carriles_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["caseta_" + iNumLinha] = null;
    ajax_error_list["troncal_" + iNumLinha] = null;
    ajax_error_list["modooperacion_" + iNumLinha] = null;
    ajax_error_list["videoip_" + iNumLinha] = null;
    ajax_error_list["toleranciacorte_" + iNumLinha] = null;
    ajax_error_list["toperetiro_" + iNumLinha] = null;
    ajax_error_list["carriles_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "caseta_": new Array(),
    "troncal_": new Array(),
    "modooperacion_": new Array(),
    "videoip_": new Array(),
    "toleranciacorte_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["caseta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["caseta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["caseta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["caseta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["caseta_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["troncal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["troncal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["troncal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["troncal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["troncal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["modooperacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["modooperacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["modooperacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["modooperacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["modooperacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["videoip_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["videoip_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["videoip_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["videoip_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["videoip_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["toleranciacorte_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["toleranciacorte_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["toleranciacorte_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["toleranciacorte_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["toleranciacorte_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["carriles_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["carriles_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["carriles_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["carriles_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["carriles_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['caseta_'])) ? $this->nmgp_cmp_readonly['caseta_'] : 'off';
?>
    scAjaxFieldRead("caseta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['troncal_'])) ? $this->nmgp_cmp_readonly['troncal_'] : 'off';
?>
    scAjaxFieldRead("troncal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['modooperacion_'])) ? $this->nmgp_cmp_readonly['modooperacion_'] : 'off';
?>
    scAjaxFieldRead("modooperacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['videoip_'])) ? $this->nmgp_cmp_readonly['videoip_'] : 'off';
?>
    scAjaxFieldRead("videoip_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['toleranciacorte_'])) ? $this->nmgp_cmp_readonly['toleranciacorte_'] : 'off';
?>
    scAjaxFieldRead("toleranciacorte_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['carriles_'])) ? $this->nmgp_cmp_readonly['carriles_'] : 'off';
?>
    scAjaxFieldRead("carriles_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("casetaid_" + iSeq, "on");
    scAjaxFieldRead("caseta_" + iSeq, "on");
    scAjaxFieldRead("troncal_" + iSeq, "on");
    scAjaxFieldRead("modooperacion_" + iSeq, "on");
    scAjaxFieldRead("videoip_" + iSeq, "on");
    scAjaxFieldRead("toleranciacorte_" + iSeq, "on");
    scAjaxFieldRead("toperetiro_" + iSeq, "on");
    scAjaxFieldRead("carriles_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["casetaid_" + iRow] || "on" == ajax_error_count["caseta_" + iRow] || "on" == ajax_error_count["troncal_" + iRow] || "on" == ajax_error_count["modooperacion_" + iRow] || "on" == ajax_error_count["videoip_" + iRow] || "on" == ajax_error_count["toleranciacorte_" + iRow] || "on" == ajax_error_count["toperetiro_" + iRow] || "on" == ajax_error_count["carriles_" + iRow]))
    {
      ...
      $("#hidden_field_data_caseta_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_troncal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_modooperacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_videoip_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_toleranciacorte_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_toperetiro_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_carriles_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["casetaid_" + iRow] && "off" == ajax_error_count["caseta_" + iRow] && "off" == ajax_error_count["troncal_" + iRow] && "off" == ajax_error_count["modooperacion_" + iRow] && "off" == ajax_error_count["videoip_" + iRow] && "off" == ajax_error_count["toleranciacorte_" + iRow] && "off" == ajax_error_count["toperetiro_" + iRow] && "off" == ajax_error_count["carriles_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["casetaid_" + iRow] = "off";
        ajax_error_count["caseta_" + iRow] = "off";
        ajax_error_count["troncal_" + iRow] = "off";
        ajax_error_count["modooperacion_" + iRow] = "off";
        ajax_error_count["videoip_" + iRow] = "off";
        ajax_error_count["toleranciacorte_" + iRow] = "off";
        ajax_error_count["toperetiro_" + iRow] = "off";
        ajax_error_count["carriles_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_caseta_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_troncal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_modooperacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_videoip_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_toleranciacorte_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_toperetiro_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_carriles_" + iRow).removeClass("scFormErrorLine");
    }
  }
