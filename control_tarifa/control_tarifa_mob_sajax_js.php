  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_tarifa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_tarifa_mob_form();
	}
...
?>
  ...
  // ---------- Validate caseta
  function do_ajax_control_tarifa_mob_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    var var_caseta = scAjaxGetFieldSelect(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_tarifa_mob_validate_caseta(var_caseta, var_script_case_init, do_ajax_control_tarifa_mob_validate_caseta_cb);
  } // do_ajax_control_tarifa_mob_validate_caseta

  function do_ajax_control_tarifa_mob_validate_caseta_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_tarifa_mob_validate_caseta_cb

  // ---------- Validate tipopago
  function do_ajax_control_tarifa_mob_validate_tipopago()
  {
    var nomeCampo_tipopago = "tipopago";
    var var_tipopago = scAjaxGetFieldSelect(nomeCampo_tipopago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_tarifa_mob_validate_tipopago(var_tipopago, var_script_case_init, do_ajax_control_tarifa_mob_validate_tipopago_cb);
  } // do_ajax_control_tarifa_mob_validate_tipopago

  function do_ajax_control_tarifa_mob_validate_tipopago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_tarifa_mob_validate_tipopago_cb

  // ---------- Validate fechainicial
  function do_ajax_control_tarifa_mob_validate_fechainicial()
  {
    var nomeCampo_fechainicial = "fechainicial";
    var var_fechainicial = scAjaxGetFieldText(nomeCampo_fechainicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_tarifa_mob_validate_fechainicial(var_fechainicial, var_script_case_init, do_ajax_control_tarifa_mob_validate_fechainicial_cb);
  } // do_ajax_control_tarifa_mob_validate_fechainicial

  function do_ajax_control_tarifa_mob_validate_fechainicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechainicial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_tarifa_mob_validate_fechainicial_cb

  // ---------- Validate fechafinal
  function do_ajax_control_tarifa_mob_validate_fechafinal()
  {
    var nomeCampo_fechafinal = "fechafinal";
    var var_fechafinal = scAjaxGetFieldText(nomeCampo_fechafinal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_tarifa_mob_validate_fechafinal(var_fechafinal, var_script_case_init, do_ajax_control_tarifa_mob_validate_fechafinal_cb);
  } // do_ajax_control_tarifa_mob_validate_fechafinal

  function do_ajax_control_tarifa_mob_validate_fechafinal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechafinal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_tarifa_mob_validate_fechafinal_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_tarifa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_tarifa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_caseta = scAjaxGetFieldSelect("caseta");
    var var_tipopago = scAjaxGetFieldSelect("tipopago");
    var var_fechainicial = scAjaxGetFieldText("fechainicial");
    var var_fechafinal = scAjaxGetFieldText("fechafinal");
    ...
    scAjaxProcOn();
    x_ajax_control_tarifa_mob_submit_form(var_caseta, var_tipopago, var_fechainicial, var_fechafinal, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_tarifa_mob_submit_form_cb);
  } // do_ajax_control_tarifa_mob_submit_form

  function do_ajax_control_tarifa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_tarifa_mob_submit_form_cb_after_alert);
  } // do_ajax_control_tarifa_mob_submit_form_cb
  function do_ajax_control_tarifa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_tarifa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_tarifa_mob_navigate_form()
  {
    perform_ajax_control_tarifa_mob_navigate_form();
  }

  function perform_ajax_control_tarifa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_tarifa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_tarifa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_tarifa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_tarifa_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_tarifa_mob_navigate_form_cb
  function do_ajax_control_tarifa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_tarifa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_tarifa_mob_navigate_form_cb_after_alert

  function sc_hide_control_tarifa_mob_form()
  {
  ...
  ajax_field_list[0] = "caseta";
  ajax_field_list[1] = "tipopago";
  ajax_field_list[2] = "fechainicial";
  ajax_field_list[3] = "fechafinal";
  ...
  var ajax_error_list = {
    ...
    "tipopago": {"label": "TipoPago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechainicial": {"label": "FechaInicial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechafinal": {"label": "FechaFinal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "fechafinal": new Array()
  };
  ajax_field_mult["caseta"][1] = "caseta";
  ajax_field_mult["tipopago"][1] = "tipopago";
  ajax_field_mult["fechainicial"][1] = "fechainicial";
  ajax_field_mult["fechafinal"][1] = "fechafinal";
  ...
  var ajax_field_id = {
    ...
    "fechainicial": new Array("hidden_field_label_fechainicial", "hidden_field_data_fechainicial"),
    "fechafinal": new Array("hidden_field_label_fechafinal", "hidden_field_data_fechafinal")
  };
