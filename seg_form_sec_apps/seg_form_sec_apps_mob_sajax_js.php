...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_seg_form_sec_apps_mob_submit_form_cb_after_alert);
  } // do_ajax_seg_form_sec_apps_mob_submit_form_cb
  function do_ajax_seg_form_sec_apps_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_seg_form_sec_apps_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_seg_form_sec_apps_mob_navigate_form()
  {
    perform_ajax_seg_form_sec_apps_mob_navigate_form();
  }

  function perform_ajax_seg_form_sec_apps_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
...
?>
  function do_ajax_seg_form_sec_apps_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_seg_form_sec_apps_mob_navigate_form_cb_after_alert);
  } // do_ajax_seg_form_sec_apps_mob_navigate_form_cb
  function do_ajax_seg_form_sec_apps_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_seg_form_sec_apps_mob_navigate_form_cb_after_alert
