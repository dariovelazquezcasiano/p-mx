...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_LDT"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_LDT"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LDT']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LDT']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LDT']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LDT']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LDT']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleturno_LDT</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LDT']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LDT']['embutida_filho'] as $ind => $sc_init)
          {
