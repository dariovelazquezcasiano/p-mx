...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_mensaje_buscar']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
if(isset($_POST['code'])){
	...
	$FILTRO = "WHERE Solicitud = ". $_POST['code'];
	$sql = "SELECT Descripcion,CarrilID, Hora FROM detallealarma ". $FILTRO;
	...
	if(!empty($this->ds )){
		foreach($this->ds  as $key => $value){
			...
			$arr_content[$key]['Mensaje'] = $value[0];
			$arr_content[$key]['Carril'] = $value[1];
			$arr_content[$key]['Hora'] = $value[2];
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['blank_mensaje_buscar'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_mensaje_buscar']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['blank_mensaje_buscar']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_mensaje_buscar']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_mensaje_buscar']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['blank_mensaje_buscar']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   if (isset($_POST["sm_global_login"])) 
   {
       ...
       nm_limpa_str_blank_mensaje_buscar($_SESSION["sm_global_login"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['blank_mensaje_buscar']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['blank_mensaje_buscar']['session_timeout']['lang'];
   }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['blank_mensaje_buscar'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['blank_mensaje_buscar']['opc_psq'] && !isset($_SESSION['scriptcase']['blank_mensaje_buscar']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_mensaje_buscar']) || $_SESSION['scriptcase']['sc_apl_seg']['blank_mensaje_buscar'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['blank_mensaje_buscar']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("blank_mensaje_buscar", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
