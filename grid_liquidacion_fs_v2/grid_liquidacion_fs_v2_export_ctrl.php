<?php
@session_start() ;
$_SESSION['scriptcase']['grid_liquidacion_fs_v2']['sc_process_barr'] = true;
require_once('../grid_liquidacion_fs_v2/index.php');
unset($_SESSION['scriptcase']['grid_liquidacion_fs_v2']['sc_process_barr']);
$ExportCtrl = new grid_liquidacion_fs_v2_export_control;
$ExportCtrl->Export_barr();

class grid_liquidacion_fs_v2_export_control
{
