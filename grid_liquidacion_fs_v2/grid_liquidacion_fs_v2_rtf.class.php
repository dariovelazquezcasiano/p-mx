...
class grid_liquidacion_fs_v2_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_liquidacion_fs_v2.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_liquidacion_fs_v2']['contr_erro'] = 'off'; 
   ...
   function NM_export_difanacr()
   {
         ...
         $this->difanacr = str_replace('<', '&lt;', $this->difanacr);
         $this->difanacr = str_replace('>', '&gt;', $this->difanacr);
         $this->Texto_tag .= "<td>" . $this->difanacr . "</td>\r\n";
   }
   //----- faltanteana
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
