...
class grid_liquidacion_fs_v2_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_fechaoperacion;
   var $array_total_usuarioid;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fechaoperacion = array();
      $this->array_total_usuarioid      = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_liquidacion_fs_v2']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_liquidacion_fs_v2']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['contr_total_geral'] == "OK")
      {
          $this->array_total_fechaoperacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['fechaoperacion'];
          $this->array_total_usuarioid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['usuarioid'];
      }
      else
      {
          $this->array_total_fechaoperacion = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][5];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][3];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['json_use_label'])
       {
          $Lab_fechaoperacion = "FechaOperacion";
          $Lab_usuarioid = "UsuarioID";
       }
       else
       {
       $Lab_fechaoperacion = "Fecha Operacion";
       $Lab_fechaoperacion =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fechaoperacion);
       $Lab_usuarioid = "Cajero";
       }
       $this->comp_field = array(
           $Lab_fechaoperacion,
           $Lab_usuarioid,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['turnoid'] = "Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['carril']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['carril'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['usuarioid'] = "Cajero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['montocr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['montocr'] = "Monto Marcado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['importemxn']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['importemxn'] = "Importe GxE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['operacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['operacion'] = "Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['faltante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['faltante'] = "Faltante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['sobrante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['sobrante'] = "Sobrante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['entregado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['entregado'] = "Entregado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['depositopre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['depositopre'] = "Deposito Preliquidación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['montoana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['montoana'] = "Monto ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['difanacr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['difanacr'] = "Sobrante ANA-Marc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['faltanteana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['faltanteana'] = "Faltante ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['sobranteana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['sobranteana'] = "Sobrante ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['depositototal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['depositototal'] = "Deposito Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['consecutivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['consecutivo'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['casetaid'] = "Caseta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['tramoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['tramoid'] = "Tramo ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['carrilid'] = "CarrilID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechaoperacion'] = "Fecha Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechaturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechaturno'] = "Fecha Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['horainicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['horainicio'] = "Hora Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechafin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechafin'] = "Fecha Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['horafin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['horafin'] = "Hora Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['operacionid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['operacionid'] = "Operacion ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['foliocierre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['foliocierre'] = "Folio Cierre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['estatuscarril']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['estatuscarril'] = "Estatus Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['observacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['observacion'] = "Observacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['preliquidado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['preliquidado'] = "Pre Liquidado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['cantidadmxn']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['cantidadmxn'] = "Cantidad MXN"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['cantidadusd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['cantidadusd'] = "Cantidad USD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['importeusd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['importeusd'] = "Importe USD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['folioinicialcr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['folioinicialcr'] = "Folio Inicial CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['foliofinalcr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['foliofinalcr'] = "Folio Final CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['folioinicialeap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['folioinicialeap'] = "Folio Inicial EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['foliofinaleap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['foliofinaleap'] = "Folio Final EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['administradorid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['administradorid'] = "Administrador ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['encargadoturnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['encargadoturnoid'] = "Encargado Turno ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['encargadoturnoid_pre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['encargadoturnoid_pre'] = "Encargado Turno ID Pre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechacierre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechacierre'] = "Fecha Cierre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechapreliq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechapreliq'] = "Fecha Pre Liq"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechaliq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['fechaliq'] = "Fecha Liq"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['liquidadorid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['labels']['liquidadorid'] = "Liquidador ID"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fechaoperacion' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Deposito Preliquidación (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Faltante ANA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "Sobrante ANA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           6 => "Monto ANA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           7 => "Deposito Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_order']['FechaUsuario']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_order']['FechaUsuario'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_order']['FechaUsuario'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['FechaUsuario'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['FechaUsuario'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['FechaUsuario'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['FechaUsuario'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['FechaUsuario'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['FechaUsuario'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['FechaUsuario'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "depositopre", 'show' => true),
           4 => array('field' => "faltanteana", 'show' => true),
           5 => array('field' => "sobranteana", 'show' => true),
           6 => array('field' => "montoana", 'show' => true),
           7 => array('field' => "depositototal", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css___nm_count_nm___cnt",
           3 => "css_depositopre_sum",
           4 => "css_faltanteana_sum",
           5 => "css_sobranteana_sum",
           6 => "css_montoana_sum",
           7 => "css_depositototal_sum",
       );
       ...
       //-----
       foreach ($this->array_total_fechaoperacion as $i_fechaoperacion => $d_fechaoperacion) {
           if (!isset($i_fechaoperacion, $this->comp_label[0]) || !in_array($i_fechaoperacion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fechaoperacion[8] ] = $d_fechaoperacion[7];
               $this->comp_label[0][ $d_fechaoperacion[8] ] = $d_fechaoperacion[7];
           }
           foreach ($this->array_total_usuarioid[$i_fechaoperacion] as $i_usuarioid => $d_usuarioid) {
               if (!isset($i_usuarioid, $this->comp_label[1][ $d_fechaoperacion[8] ]) || !in_array($i_usuarioid, $this->comp_label[1][ $d_fechaoperacion[8] ], true)) {
                   $this->comp_index[1][ $d_usuarioid[8] ] = $d_usuarioid[7];
                   $this->comp_label[1][ $d_fechaoperacion[8] ][ $d_usuarioid[8] ] = $d_usuarioid[7];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'fechaoperacion', 'prot' => '@aspass@'),
           array('name' => 'usuarioid', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_fechaoperacion => $l_fechaoperacion) {
           if (isset($this->array_total_fechaoperacion[$i_fechaoperacion])) {
               $this->comp_group[$i_fechaoperacion] = array();
           }
           foreach ($this->comp_label[1][$i_fechaoperacion] as $i_usuarioid => $l_usuarioid) {
               if (isset($this->array_total_usuarioid[$i_fechaoperacion][$i_usuarioid])) {
                   $this->comp_group[$i_fechaoperacion][$i_usuarioid] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fechaoperacion;
       }
       elseif (1 == $level) {
           $return = $this->array_total_usuarioid;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_liquidacion_fs_v2@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildTotalsX(&$row, $col, $level, $label, $sub)
   {
       ...
       foreach ($this->comp_sum as $i_sum => $l_sum)
       {
           if ('A' == $this->comp_sum_fn[$i_sum] && isset($this->comp_totals_x[$i_sum - 1]['values']) && is_numeric($this->comp_totals_x[$i_sum - 1]['values']))
           {
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_liquidacion_fs_v2_total.class.php"); 
      }
      ...
      $this->Total   = new grid_liquidacion_fs_v2_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_fechaoperacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['fechaoperacion'];
      $this->array_total_usuarioid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['usuarioid'];
      if (is_array($this->array_total_fechaoperacion)) {
          ksort($this->array_total_fechaoperacion);
      }
      if (is_array($this->array_total_usuarioid)) {
          ksort($this->array_total_usuarioid);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_v2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_v2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_v2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_liquidacion_fs_v2&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "", "", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          }
              $NM_btn = true;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_liquidacion_fs_v2_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_liquidacion_fs_v2']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_liquidacion_fs_v2']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_liquidacion_fs_v2_config_pivot.php?nome_apl=grid_liquidacion_fs_v2&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_v2_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_liquidacion_fs_v2/grid_liquidacion_fs_v2_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $casetaid = (isset($Busca_temp['casetaid'])) ? $Busca_temp['casetaid'] : ""; 
          $tmp_pos = (is_string($casetaid)) ? strpos($casetaid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($casetaid))
          {
              $casetaid = substr($casetaid, 0, $tmp_pos);
          }
          $fechaoperacion = (isset($Busca_temp['fechaoperacion'])) ? $Busca_temp['fechaoperacion'] : ""; 
          $tmp_pos = (is_string($fechaoperacion)) ? strpos($fechaoperacion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fechaoperacion))
          {
              $fechaoperacion = substr($fechaoperacion, 0, $tmp_pos);
          }
          $fechaoperacion_2 = (isset($Busca_temp['fechaoperacion_input_2'])) ? $Busca_temp['fechaoperacion_input_2'] : ""; 
          $turnoid = (isset($Busca_temp['turnoid'])) ? $Busca_temp['turnoid'] : ""; 
          $tmp_pos = (is_string($turnoid)) ? strpos($turnoid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($turnoid))
          {
              $turnoid = substr($turnoid, 0, $tmp_pos);
          }
          $carrilid = (isset($Busca_temp['carrilid'])) ? $Busca_temp['carrilid'] : ""; 
          $tmp_pos = (is_string($carrilid)) ? strpos($carrilid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($carrilid))
          {
              $carrilid = substr($carrilid, 0, $tmp_pos);
          }
          $cuerpo = (isset($Busca_temp['cuerpo'])) ? $Busca_temp['cuerpo'] : ""; 
          $tmp_pos = (is_string($cuerpo)) ? strpos($cuerpo, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cuerpo))
          {
              $cuerpo = substr($cuerpo, 0, $tmp_pos);
          }
          $usuarioid = (isset($Busca_temp['usuarioid'])) ? $Busca_temp['usuarioid'] : ""; 
          $tmp_pos = (is_string($usuarioid)) ? strpos($usuarioid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($usuarioid))
          {
   ...
   //---- 
   function adiciona_registro($sum_depositopre, $sum_montoana, $sum_faltanteana, $sum_sobranteana, $sum_depositototal, $quebra_fechaoperacion, $quebra_usuarioid, $quebra_fechaoperacion_orig, $quebra_usuarioid_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig]))
      {
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][0] = 1;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][1] = $sum_depositopre;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][2] = $sum_montoana;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][3] = $sum_faltanteana;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][4] = $sum_sobranteana;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][5] = $sum_depositototal;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][6] = 1;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][7] = $quebra_fechaoperacion;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][8] = $quebra_fechaoperacion_orig;
      }
      else
      {
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][0]++;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][1] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][1], $sum_depositopre, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][2] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][2], $sum_montoana, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][3] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][3], $sum_faltanteana, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][4] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][4], $sum_sobranteana, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][5] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][5], $sum_depositototal, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][6]++;
      }
      //----- Cajero
      if (!isset($this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig]))
      {
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][0] = 1;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][1] = $sum_depositopre;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][2] = $sum_montoana;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][3] = $sum_faltanteana;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][4] = $sum_sobranteana;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][5] = $sum_depositototal;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][6] = 1;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][7] = $quebra_usuarioid;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][8] = $quebra_usuarioid_orig;
      }
      else
      {
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][0]++;
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][1] = bcadd($this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][1], $sum_depositopre, 10);
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][2] = bcadd($this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][2], $sum_montoana, 10);
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][3] = bcadd($this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][3], $sum_faltanteana, 10);
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][4] = bcadd($this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][4], $sum_sobranteana, 10);
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][5] = bcadd($this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][5], $sum_depositototal, 10);
         $this->array_total_usuarioid[$quebra_fechaoperacion_orig][$quebra_usuarioid_orig][6]++;
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_depositopre;
         $this->array_total_geral[2] = $sum_montoana;
         $this->array_total_geral[3] = $sum_faltanteana;
         $this->array_total_geral[4] = $sum_sobranteana;
         $this->array_total_geral[5] = $sum_depositototal;
         $this->array_total_geral[6] = 1;
      }
      else
      {
         $this->array_total_geral[0]++;
         $this->array_total_geral[1] = bcadd($this->array_total_geral[1], $sum_depositopre, 10);
         $this->array_total_geral[2] = bcadd($this->array_total_geral[2], $sum_montoana, 10);
         $this->array_total_geral[3] = bcadd($this->array_total_geral[3], $sum_faltanteana, 10);
         $this->array_total_geral[4] = bcadd($this->array_total_geral[4], $sum_sobranteana, 10);
         $this->array_total_geral[5] = bcadd($this->array_total_geral[5], $sum_depositototal, 10);
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['fechaoperacion'] as $campo_fechaoperacion => $dados_fechaoperacion)
      {
         $this->array_total_fechaoperacion[$campo_fechaoperacion][2] = $dados_fechaoperacion[1];
         $this->array_total_fechaoperacion[$campo_fechaoperacion][5] = $dados_fechaoperacion[2];
         $this->array_total_fechaoperacion[$campo_fechaoperacion][3] = $dados_fechaoperacion[3];
         $this->array_total_fechaoperacion[$campo_fechaoperacion][4] = $dados_fechaoperacion[4];
         $this->array_total_fechaoperacion[$campo_fechaoperacion][6] = $dados_fechaoperacion[5];
         $this->array_total_fechaoperacion[$campo_fechaoperacion][1] = $dados_fechaoperacion[6];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['usuarioid'][$campo_fechaoperacion] as $campo_usuarioid => $dados_usuarioid)
         {
            $this->array_total_usuarioid[$campo_fechaoperacion][$campo_usuarioid][2] = $dados_usuarioid[1];
            $this->array_total_usuarioid[$campo_fechaoperacion][$campo_usuarioid][5] = $dados_usuarioid[2];
            $this->array_total_usuarioid[$campo_fechaoperacion][$campo_usuarioid][3] = $dados_usuarioid[3];
            $this->array_total_usuarioid[$campo_fechaoperacion][$campo_usuarioid][4] = $dados_usuarioid[4];
            $this->array_total_usuarioid[$campo_fechaoperacion][$campo_usuarioid][6] = $dados_usuarioid[5];
            $this->array_total_usuarioid[$campo_fechaoperacion][$campo_usuarioid][1] = $dados_usuarioid[6];
         }
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->casetaid = $Busca_temp['casetaid']; 
       $this->casetaid = (isset($Busca_temp['casetaid'])) ? $Busca_temp['casetaid'] : ""; 
       $tmp_pos = (is_string($this->casetaid)) ? strpos($this->casetaid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->casetaid))
       {
       ...
       $this->fechaoperacion = $Busca_temp['fechaoperacion']; 
       $this->fechaoperacion = (isset($Busca_temp['fechaoperacion'])) ? $Busca_temp['fechaoperacion'] : ""; 
       $tmp_pos = (is_string($this->fechaoperacion)) ? strpos($this->fechaoperacion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fechaoperacion))
       {
       ...
       $fechaoperacion_2 = (isset($Busca_temp['fechaoperacion_input_2'])) ? $Busca_temp['fechaoperacion_input_2'] : ""; 
       $this->fechaoperacion_2 = $fechaoperacion_2; 
       $this->turnoid = $Busca_temp['turnoid']; 
       $this->turnoid = (isset($Busca_temp['turnoid'])) ? $Busca_temp['turnoid'] : ""; 
       $tmp_pos = (is_string($this->turnoid)) ? strpos($this->turnoid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->turnoid))
       {
       ...
       $this->carrilid = $Busca_temp['carrilid']; 
       $this->carrilid = (isset($Busca_temp['carrilid'])) ? $Busca_temp['carrilid'] : ""; 
       $tmp_pos = (is_string($this->carrilid)) ? strpos($this->carrilid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->carrilid))
       {
       ...
       $this->usuarioid = $Busca_temp['usuarioid']; 
       $this->usuarioid = (isset($Busca_temp['usuarioid'])) ? $Busca_temp['usuarioid'] : ""; 
       $tmp_pos = (is_string($this->usuarioid)) ? strpos($this->usuarioid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->usuarioid))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('FechaUsuario', 'fechaoperacion');
     $campos_order = $this->Ini->Get_date_order_groupby("FechaOperacion", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('FechaUsuario', 'usuarioid');
     $campos_order = $this->Ini->Get_date_order_groupby("UsuarioID", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->turnoid = $rs_res->fields[0] ;  
            $this->carril = $rs_res->fields[1] ;  
            $this->usuarioid = $rs_res->fields[2] ;  
            $this->montocr = $rs_res->fields[3] ;  
            $this->montocr =  str_replace(",", ".", $this->montocr);
            $this->importemxn = $rs_res->fields[4] ;  
            $this->importemxn =  str_replace(",", ".", $this->importemxn);
            $this->operacion = $rs_res->fields[5] ;  
            $this->operacion =  str_replace(",", ".", $this->operacion);
            $this->faltante = $rs_res->fields[6] ;  
            $this->faltante =  str_replace(",", ".", $this->faltante);
            $this->sobrante = $rs_res->fields[7] ;  
            $this->sobrante =  str_replace(",", ".", $this->sobrante);
            $this->entregado = $rs_res->fields[8] ;  
            $this->entregado =  str_replace(",", ".", $this->entregado);
            $this->montoana = $rs_res->fields[9] ;  
            $this->montoana =  str_replace(",", ".", $this->montoana);
            $this->faltanteana = $rs_res->fields[10] ;  
            $this->faltanteana =  str_replace(",", ".", $this->faltanteana);
            $this->sobranteana = $rs_res->fields[11] ;  
            $this->sobranteana =  str_replace(",", ".", $this->sobranteana);
            $this->consecutivo = $rs_res->fields[12] ;  
            $this->casetaid = $rs_res->fields[13] ;  
            $this->tramoid = $rs_res->fields[14] ;  
            $this->cuerpo = $rs_res->fields[15] ;  
            $this->fechaoperacion = $rs_res->fields[16] ;  
            $this->carrilid = $rs_res->fields[17] ;  
            $this->horainicio = $rs_res->fields[18] ;  
...
$_SESSION['scriptcase']['grid_liquidacion_fs_v2']['contr_erro'] = 'off'; 
            ...
            $this->fechaoperacion_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->fechaoperacion, $Format_tst);
            $this->fechaoperacion = $this->Ini->GB_date_format($TP_Time . $this->fechaoperacion, $Format_tst, $Prefix_dat);
            $this->usuarioid_orig = $this->usuarioid;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->depositopre, $this->montoana, $this->faltanteana, $this->sobranteana, $this->depositototal, $this->fechaoperacion, $this->usuarioid, $this->fechaoperacion_orig,  $this->usuarioid_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_liquidacion_fs_v2']['contr_erro'] = 'off';
     ...
     $this->fechaoperacion = $this->Ini->GB_date_format($TP_Time . $fechaoperacion_SV, $Format_tst, $Prefix_dat); 
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->depositopre)), NM_encode_input(sc_strip_script($this->montoana)), NM_encode_input(sc_strip_script($this->faltanteana)), NM_encode_input(sc_strip_script($this->sobranteana)), NM_encode_input(sc_strip_script($this->depositototal)), NM_encode_input(sc_strip_script($this->fechaoperacion)), sc_strip_script($this->usuarioid), NM_encode_input(sc_strip_script($fechaoperacion_orig)), sc_strip_script($usuarioid_orig));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['fechaoperacion'] = $this->array_total_fechaoperacion;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['arr_total']['usuarioid'] = $this->array_total_usuarioid;
      }
   }
