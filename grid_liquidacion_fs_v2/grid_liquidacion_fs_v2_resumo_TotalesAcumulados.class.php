...
class grid_liquidacion_fs_v2_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][3];
      ...
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['tot_geral'][6];
   ...
   function completeMatrix()
   {
       ...
       $Lab_fechaoperacion =  sprintf("Fecha de Operación", $Lab_fechaoperacion);
       }
       $this->comp_field = array(
           $Lab_fechaoperacion,
       );
       ...
       //-----
       $this->comp_sum = array(
           2 => "Deposito Preliquidación (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Monto ANA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Faltante ANA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "Sobrante ANA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           6 => "Deposito Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_order']['TotalesAcumulados']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_order']['TotalesAcumulados'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_order']['TotalesAcumulados'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['TotalesAcumulados'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs_v2']['summarizing_fields_display']['TotalesAcumulados'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "depositopre", 'show' => true),
           3 => array('field' => "montoana", 'show' => true),
           4 => array('field' => "faltanteana", 'show' => true),
           5 => array('field' => "sobranteana", 'show' => true),
           6 => array('field' => "depositototal", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_depositopre_sum",
           3 => "css_montoana_sum",
           4 => "css_faltanteana_sum",
           5 => "css_sobranteana_sum",
           6 => "css_depositototal_sum",
       );
       ...
       foreach ($this->array_total_fechaoperacion as $i_fechaoperacion => $d_fechaoperacion) {
           if (!isset($i_fechaoperacion, $this->comp_label[0]) || !in_array($i_fechaoperacion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fechaoperacion[7] ] = $d_fechaoperacion[6];
               $this->comp_label[0][ $d_fechaoperacion[7] ] = $d_fechaoperacion[6];
           }
       }
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_depositopre, $sum_montoana, $sum_faltanteana, $sum_sobranteana, $sum_depositototal, $quebra_fechaoperacion, $quebra_fechaoperacion_orig)
   {
      //----- Fecha de Operación
      if (!isset($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig]))
      {
         ...
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][6] = $quebra_fechaoperacion;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][7] = $quebra_fechaoperacion_orig;
      }
      else
      {
   ...
   function compat_arrays()
   {
      ...
      {
         $this->array_total_fechaoperacion[$campo_fechaoperacion][1] = $dados_fechaoperacion[1];
         $this->array_total_fechaoperacion[$campo_fechaoperacion][2] = $dados_fechaoperacion[2];
         ...
         $this->array_total_fechaoperacion[$campo_fechaoperacion][5] = $dados_fechaoperacion[5];
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('TotalesAcumulados', 'fechaoperacion');
...
$_SESSION['scriptcase']['grid_liquidacion_fs_v2']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->depositopre, $this->montoana, $this->faltanteana, $this->sobranteana, $this->depositototal, $this->fechaoperacion, $this->fechaoperacion_orig);
            }
   }
//
