...
class grid_liquidacion_fs_v2_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_liquidacion_fs_v2']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_liquidacion_fs_v2']['campos_busca']))
      { 
