  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_eventos_min" == sTestField)
        {
...
?>
  ...
  function do_ajax_grid_eventos_min_validate_fechaoperacion()
  {
    ...
    setTimeout(function() {
      var var_fechaoperacion = scAjaxGetFieldText(nomeCampo_fechaoperacion);
      x_ajax_grid_eventos_min_validate_fechaoperacion(var_fechaoperacion, var_script_case_init, do_ajax_grid_eventos_min_validate_fechaoperacion_cb);
    }, 200);
  } // do_ajax_grid_eventos_min_validate_fechaoperacion

  function do_ajax_grid_eventos_min_validate_fechaoperacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_validate_fechaoperacion_cb

  // ---------- Validate caseta
  function do_ajax_grid_eventos_min_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    var var_caseta = scAjaxGetFieldSelect(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_validate_caseta(var_caseta, var_script_case_init, do_ajax_grid_eventos_min_validate_caseta_cb);
  } // do_ajax_grid_eventos_min_validate_caseta

  function do_ajax_grid_eventos_min_validate_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_validate_caseta_cb

  // ---------- Validate turno
  function do_ajax_grid_eventos_min_validate_turno()
  {
    var nomeCampo_turno = "turno";
    var var_turno = scAjaxGetFieldSelect(nomeCampo_turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_validate_turno(var_turno, var_script_case_init, do_ajax_grid_eventos_min_validate_turno_cb);
  } // do_ajax_grid_eventos_min_validate_turno

  function do_ajax_grid_eventos_min_validate_turno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "turno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_validate_turno_cb

  // ---------- Validate carril
  function do_ajax_grid_eventos_min_validate_carril()
  {
    var nomeCampo_carril = "carril";
    var var_carril = scAjaxGetFieldSelect(nomeCampo_carril);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_validate_carril(var_carril, var_script_case_init, do_ajax_grid_eventos_min_validate_carril_cb);
  } // do_ajax_grid_eventos_min_validate_carril

  function do_ajax_grid_eventos_min_validate_carril_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "carril";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_validate_carril_cb

  // ---------- Validate tipopago
  function do_ajax_grid_eventos_min_validate_tipopago()
  {
    var nomeCampo_tipopago = "tipopago";
    var var_tipopago = scAjaxGetFieldSelect(nomeCampo_tipopago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_validate_tipopago(var_tipopago, var_script_case_init, do_ajax_grid_eventos_min_validate_tipopago_cb);
  } // do_ajax_grid_eventos_min_validate_tipopago

  function do_ajax_grid_eventos_min_validate_tipopago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_validate_tipopago_cb

  // ---------- Validate discrepancia
  function do_ajax_grid_eventos_min_validate_discrepancia()
  {
    var nomeCampo_discrepancia = "discrepancia";
    var var_discrepancia = scAjaxGetFieldRadio(nomeCampo_discrepancia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_validate_discrepancia(var_discrepancia, var_script_case_init, do_ajax_grid_eventos_min_validate_discrepancia_cb);
  } // do_ajax_grid_eventos_min_validate_discrepancia

  function do_ajax_grid_eventos_min_validate_discrepancia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_validate_discrepancia_cb

  // ---------- Refresh caseta
  function do_ajax_grid_eventos_min_refresh_caseta()
  {
    var var_caseta = scAjaxGetFieldSelect("caseta");
    var var_nmgp_refresh_fields = "carril";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_grid_eventos_min_refresh_caseta(var_caseta, var_nmgp_refresh_fields, var_script_case_init, do_ajax_grid_eventos_min_refresh_caseta_cb);
  } // do_ajax_grid_eventos_min_refresh_caseta

  function do_ajax_grid_eventos_min_refresh_caseta_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_refresh_caseta_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_grid_eventos_min_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_grid_eventos_min_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_grid_eventos_min_submit_form(var_fechaoperacion, var_caseta, var_turno, var_carril, var_tipopago, var_discrepancia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_grid_eventos_min_submit_form_cb);
  } // do_ajax_grid_eventos_min_submit_form

  function do_ajax_grid_eventos_min_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_grid_eventos_min_submit_form_cb_after_alert);
  } // do_ajax_grid_eventos_min_submit_form_cb
  function do_ajax_grid_eventos_min_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_grid_eventos_min_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_grid_eventos_min_navigate_form()
  {
    perform_ajax_grid_eventos_min_navigate_form();
  }

  function perform_ajax_grid_eventos_min_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_grid_eventos_min_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_grid_eventos_min_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_grid_eventos_min_navigate_form_cb_after_alert);
  } // do_ajax_grid_eventos_min_navigate_form_cb
  function do_ajax_grid_eventos_min_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_grid_eventos_min_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_grid_eventos_min_navigate_form_cb_after_alert

  function sc_hide_grid_eventos_min_form()
  {
