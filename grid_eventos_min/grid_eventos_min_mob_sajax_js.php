  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_eventos_min_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_grid_eventos_min_mob_form();
	}
...
?>
  ...
  function do_ajax_grid_eventos_min_mob_validate_fechaoperacion()
  {
    ...
    setTimeout(function() {
      var var_fechaoperacion = scAjaxGetFieldText(nomeCampo_fechaoperacion);
      x_ajax_grid_eventos_min_mob_validate_fechaoperacion(var_fechaoperacion, var_script_case_init, do_ajax_grid_eventos_min_mob_validate_fechaoperacion_cb);
    }, 200);
  } // do_ajax_grid_eventos_min_mob_validate_fechaoperacion

  function do_ajax_grid_eventos_min_mob_validate_fechaoperacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_mob_validate_fechaoperacion_cb

  // ---------- Validate caseta
  function do_ajax_grid_eventos_min_mob_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    var var_caseta = scAjaxGetFieldSelect(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_mob_validate_caseta(var_caseta, var_script_case_init, do_ajax_grid_eventos_min_mob_validate_caseta_cb);
  } // do_ajax_grid_eventos_min_mob_validate_caseta

  function do_ajax_grid_eventos_min_mob_validate_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_mob_validate_caseta_cb

  // ---------- Validate turno
  function do_ajax_grid_eventos_min_mob_validate_turno()
  {
    var nomeCampo_turno = "turno";
    var var_turno = scAjaxGetFieldSelect(nomeCampo_turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_mob_validate_turno(var_turno, var_script_case_init, do_ajax_grid_eventos_min_mob_validate_turno_cb);
  } // do_ajax_grid_eventos_min_mob_validate_turno

  function do_ajax_grid_eventos_min_mob_validate_turno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "turno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_mob_validate_turno_cb

  // ---------- Validate carril
  function do_ajax_grid_eventos_min_mob_validate_carril()
  {
    var nomeCampo_carril = "carril";
    var var_carril = scAjaxGetFieldSelect(nomeCampo_carril);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_mob_validate_carril(var_carril, var_script_case_init, do_ajax_grid_eventos_min_mob_validate_carril_cb);
  } // do_ajax_grid_eventos_min_mob_validate_carril

  function do_ajax_grid_eventos_min_mob_validate_carril_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "carril";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_mob_validate_carril_cb

  // ---------- Validate tipopago
  function do_ajax_grid_eventos_min_mob_validate_tipopago()
  {
    var nomeCampo_tipopago = "tipopago";
    var var_tipopago = scAjaxGetFieldSelect(nomeCampo_tipopago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_mob_validate_tipopago(var_tipopago, var_script_case_init, do_ajax_grid_eventos_min_mob_validate_tipopago_cb);
  } // do_ajax_grid_eventos_min_mob_validate_tipopago

  function do_ajax_grid_eventos_min_mob_validate_tipopago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipopago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_mob_validate_tipopago_cb

  // ---------- Validate discrepancia
  function do_ajax_grid_eventos_min_mob_validate_discrepancia()
  {
    var nomeCampo_discrepancia = "discrepancia";
    var var_discrepancia = scAjaxGetFieldRadio(nomeCampo_discrepancia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_eventos_min_mob_validate_discrepancia(var_discrepancia, var_script_case_init, do_ajax_grid_eventos_min_mob_validate_discrepancia_cb);
  } // do_ajax_grid_eventos_min_mob_validate_discrepancia

  function do_ajax_grid_eventos_min_mob_validate_discrepancia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "discrepancia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_mob_validate_discrepancia_cb

  // ---------- Refresh caseta
  function do_ajax_grid_eventos_min_mob_refresh_caseta()
  {
    var var_caseta = scAjaxGetFieldSelect("caseta");
    var var_nmgp_refresh_fields = "carril";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_grid_eventos_min_mob_refresh_caseta(var_caseta, var_nmgp_refresh_fields, var_script_case_init, do_ajax_grid_eventos_min_mob_refresh_caseta_cb);
  } // do_ajax_grid_eventos_min_mob_refresh_caseta

  function do_ajax_grid_eventos_min_mob_refresh_caseta_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_eventos_min_mob_refresh_caseta_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_grid_eventos_min_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_grid_eventos_min_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_tipopago = scAjaxGetFieldSelect("tipopago");
    var var_discrepancia = scAjaxGetFieldRadio("discrepancia");
    ...
    scAjaxProcOn();
    x_ajax_grid_eventos_min_mob_submit_form(var_fechaoperacion, var_caseta, var_turno, var_carril, var_tipopago, var_discrepancia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_grid_eventos_min_mob_submit_form_cb);
  } // do_ajax_grid_eventos_min_mob_submit_form

  function do_ajax_grid_eventos_min_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_grid_eventos_min_mob_submit_form_cb_after_alert);
  } // do_ajax_grid_eventos_min_mob_submit_form_cb
  function do_ajax_grid_eventos_min_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_grid_eventos_min_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_grid_eventos_min_mob_navigate_form()
  {
    perform_ajax_grid_eventos_min_mob_navigate_form();
  }

  function perform_ajax_grid_eventos_min_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_grid_eventos_min_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_grid_eventos_min_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_grid_eventos_min_mob_navigate_form_cb_after_alert);
  } // do_ajax_grid_eventos_min_mob_navigate_form_cb
  function do_ajax_grid_eventos_min_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_grid_eventos_min_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_grid_eventos_min_mob_navigate_form_cb_after_alert

  function sc_hide_grid_eventos_min_mob_form()
  {
  ...
  ajax_field_list[0] = "fechaoperacion";
  ajax_field_list[1] = "caseta";
  ajax_field_list[2] = "turno";
  ajax_field_list[3] = "carril";
  ajax_field_list[4] = "tipopago";
  ajax_field_list[5] = "discrepancia";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fechaoperacion": {"label": "FechaOperacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "caseta": {"label": "Caseta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tipopago": {"label": "Tipo Pago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "discrepancia": {"label": "Discrepancias", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "carril": new Array(),
    "tipopago": new Array(),
    "discrepancia": new Array()
  };
  ajax_field_mult["fechaoperacion"][1] = "fechaoperacion";
  ajax_field_mult["caseta"][1] = "caseta";
  ajax_field_mult["turno"][1] = "turno";
  ajax_field_mult["carril"][1] = "carril";
  ajax_field_mult["tipopago"][1] = "tipopago";
  ajax_field_mult["discrepancia"][1] = "discrepancia";

  var ajax_field_id = {
    "fechaoperacion": new Array("hidden_field_label_fechaoperacion", "hidden_field_data_fechaoperacion"),
    "caseta": new Array("hidden_field_label_caseta", "hidden_field_data_caseta"),
    ...
    "tipopago": new Array("hidden_field_label_tipopago", "hidden_field_data_tipopago"),
    "discrepancia": new Array("hidden_field_label_discrepancia", "hidden_field_data_discrepancia")
  };
