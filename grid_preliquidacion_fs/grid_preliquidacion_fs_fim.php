...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_preliquidacion_fs"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_preliquidacion_fs"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_preliquidacion_fs']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_preliquidacion_fs']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_preliquidacion_fs']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_preliquidacion_fs']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_preliquidacion_fs']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_preliquidacion_fs</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_preliquidacion_fs']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_preliquidacion_fs']['embutida_filho'] as $ind => $sc_init)
          {
