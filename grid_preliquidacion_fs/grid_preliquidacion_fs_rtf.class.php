...
class grid_preliquidacion_fs_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_preliquidacion_fs.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_preliquidacion_fs']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_preliquidacion_fs']['contr_erro'] = 'off'; 
   ...
   function NM_export_sincajero()
   {
         ...
         $this->sincajero = str_replace('<', '&lt;', $this->sincajero);
         $this->sincajero = str_replace('>', '&gt;', $this->sincajero);
         $this->Texto_tag .= "<td>" . $this->sincajero . "</td>\r\n";
   }
   //----- consecutivo
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_preliquidacion_fs']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Detalle de Preliquidaciones :: RTF</TITLE>
