...
Table_sv_fil[0] = "casetaid";
Table_sv_fil[1] = "fechaoperacion";
Table_sv_fil[2] = "turnoid";
Table_sv_fil[3] = "carrilid";
Table_sv_fil[4] = "cuerpo";
Table_sv_fil[5] = "usuarioid";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fechaoperacion_cond") && search_get_sel_txt("SC_fechaoperacion_cond").substring(0, 3) == "bi_") {
            formata_bi_fechaoperacion(search_get_sel_txt("SC_fechaoperacion_cond"), SC_fechaoperacion_bi_opc, SC_fechaoperacion_bi_dt);
        }
