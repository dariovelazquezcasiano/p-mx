...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_mensaje_mostrar']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['blank_mensaje_mostrar']['embutida'])
      {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_mensaje_mostrar']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_mensaje_mostrar']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['blank_mensaje_mostrar']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['blank_mensaje_mostrar']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['blank_mensaje_mostrar']['session_timeout']['lang'];
   }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['blank_mensaje_mostrar'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['blank_mensaje_mostrar']['opc_psq'] && !isset($_SESSION['scriptcase']['blank_mensaje_mostrar']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_mensaje_mostrar']) || $_SESSION['scriptcase']['sc_apl_seg']['blank_mensaje_mostrar'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['blank_mensaje_mostrar']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("blank_mensaje_mostrar", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
