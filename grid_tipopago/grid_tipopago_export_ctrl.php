<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipopago']['sc_process_barr'] = true;
require_once('../grid_tipopago/index.php');
unset($_SESSION['scriptcase']['grid_tipopago']['sc_process_barr']);
$ExportCtrl = new grid_tipopago_export_control;
$ExportCtrl->Export_barr();

class grid_tipopago_export_control
{
