...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_tipopago"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_tipopago"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tipopago'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipopago']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tipopago']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipopago']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tipopago']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tipopago']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tipopago']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tipopago']['embutida_filho'] as $ind => $sc_init)
          {
