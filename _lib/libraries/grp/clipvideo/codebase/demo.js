...
$(function () {
    ...
    WebVideoCtrl.I_InitPlugin(400, 300, {
...
function clickLogin() {
    ...
    //return szDeviceIdentify;
            //clickStartPlayback(szDeviceIdentify);
}
...
// start play back
function clickStartPlayback(szDeviceIdentify) {
//  alert('Da clic en Aceptar para visualizar el contenido');
    var oWndInfo = WebVideoCtrl.I_GetWindowStatus(g_iWndIndex),
        szDeviceIdentify = $("#ip").val(),
        iRtspPort = parseInt($("#rtspport").val(), 10),
        iStreamType = parseInt($("#record_streamtype").val(), 10),
        ...
        iRet = -1;
    console.log(szDeviceIdentify+'*'+oWndInfo+'*'+iRtspPort+'*'+iStreamType+'*'+bZeroChannel+'*'+iChannelID+'*'+
        bChecked+'*'+iRet+'*' );
    ...
    var startPlayback = function () {
        if (bChecked) {// enable transcode playback
            var oTransCodeParam = {
                ...
                TransBitrate: "4"// 2：32K，3：48K，4：64K，5：80K，6：96K，7：128K，8：160K，9：192K，10：224K，11：256K，12：320K，13：384K，14：448K，15：512K，16：640K，17：768K，18：896K，19：1024K，20：1280K，21：1536K，22：1792K，23：2048K，24：3072K，25：4096K，26：8192K
            };
                console.log('++++');
            ...
            WebVideoCtrl.I_StartPlayback('172.25.15.247_80', {
                iRtspPort: iRtspPort,
                iStreamType: iStreamType,
                iChannelID: iChannelID,
                szStartTime: szStartTime,
