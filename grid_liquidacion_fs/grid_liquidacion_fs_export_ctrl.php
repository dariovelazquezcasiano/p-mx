<?php
@session_start() ;
$_SESSION['scriptcase']['grid_liquidacion_fs']['sc_process_barr'] = true;
require_once('../grid_liquidacion_fs/index.php');
unset($_SESSION['scriptcase']['grid_liquidacion_fs']['sc_process_barr']);
$ExportCtrl = new grid_liquidacion_fs_export_control;
$ExportCtrl->Export_barr();

class grid_liquidacion_fs_export_control
{
