...
class grid_liquidacion_fs_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_liquidacion_fs']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_liquidacion_fs']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['contr_total_geral'] == "OK")
      {
          $this->array_total_fechaoperacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_total']['fechaoperacion'];
          $this->array_total_usuarioid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_total']['usuarioid'];
      }
      else
      {
          $this->array_total_fechaoperacion = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][5];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][3];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['turnoid'] = "Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['carril']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['carril'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['usuarioid'] = "Cajero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['montocr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['montocr'] = "Monto Marcado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['importemxn']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['importemxn'] = "Importe GxE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['operacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['operacion'] = "Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['faltante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['faltante'] = "Faltante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['sobrante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['sobrante'] = "Sobrante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['entregado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['entregado'] = "Entregado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['depositopre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['depositopre'] = "Deposito Preliquidación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['montoana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['montoana'] = "Monto ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['faltanteana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['faltanteana'] = "Faltante ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['sobranteana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['sobranteana'] = "Sobrante ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['depositototal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['depositototal'] = "Deposito Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['consecutivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['consecutivo'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['casetaid'] = "Caseta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['tramoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['tramoid'] = "Tramo ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['carrilid'] = "CarrilID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechaoperacion'] = "Fecha Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechaturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechaturno'] = "Fecha Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['horainicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['horainicio'] = "Hora Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechafin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechafin'] = "Fecha Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['horafin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['horafin'] = "Hora Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['operacionid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['operacionid'] = "Operacion ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['foliocierre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['foliocierre'] = "Folio Cierre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['estatuscarril']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['estatuscarril'] = "Estatus Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['observacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['observacion'] = "Observacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['preliquidado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['preliquidado'] = "Pre Liquidado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['cantidadmxn']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['cantidadmxn'] = "Cantidad MXN"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['cantidadusd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['cantidadusd'] = "Cantidad USD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['importeusd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['importeusd'] = "Importe USD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['folioinicialcr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['folioinicialcr'] = "Folio Inicial CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['foliofinalcr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['foliofinalcr'] = "Folio Final CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['folioinicialeap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['folioinicialeap'] = "Folio Inicial EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['foliofinaleap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['foliofinaleap'] = "Folio Final EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['administradorid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['administradorid'] = "Administrador ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['encargadoturnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['encargadoturnoid'] = "Encargado Turno ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['encargadoturnoid_pre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['encargadoturnoid_pre'] = "Encargado Turno ID Pre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechacierre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechacierre'] = "Fecha Cierre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechapreliq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechapreliq'] = "Fecha Pre Liq"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechaliq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['fechaliq'] = "Fecha Liq"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['liquidadorid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['labels']['liquidadorid'] = "Liquidador ID"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fechaoperacion' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_order']['FechaUsuario']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_order']['FechaUsuario'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_order']['FechaUsuario'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['FechaUsuario'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['FechaUsuario'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['FechaUsuario'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['FechaUsuario'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['FechaUsuario'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['FechaUsuario'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['FechaUsuario'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_liquidacion_fs@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_liquidacion_fs_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_liquidacion_fs&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "", "", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          }
              $NM_btn = true;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_liquidacion_fs_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_liquidacion_fs']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_liquidacion_fs']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_liquidacion_fs_config_pivot.php?nome_apl=grid_liquidacion_fs&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_liquidacion_fs_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_liquidacion_fs/grid_liquidacion_fs_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_total']['fechaoperacion'] as $campo_fechaoperacion => $dados_fechaoperacion)
      {
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_total']['usuarioid'][$campo_fechaoperacion] as $campo_usuarioid => $dados_usuarioid)
         {
...
$_SESSION['scriptcase']['grid_liquidacion_fs']['contr_erro'] = 'off';
     ...
     $this->fechaoperacion = $this->Ini->GB_date_format($TP_Time . $fechaoperacion_SV, $Format_tst, $Prefix_dat); 
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_total']['fechaoperacion'] = $this->array_total_fechaoperacion;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['arr_total']['usuarioid'] = $this->array_total_usuarioid;
      }
   }
