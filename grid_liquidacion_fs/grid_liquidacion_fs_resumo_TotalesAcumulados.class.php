...
class grid_liquidacion_fs_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][3];
      ...
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['tot_geral'][6];
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_order']['TotalesAcumulados']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_order']['TotalesAcumulados'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_order']['TotalesAcumulados'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['TotalesAcumulados'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['TotalesAcumulados'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidacion_fs']['summarizing_fields_display']['TotalesAcumulados'] as $i_sum => $d_sum)
           {
