...
$old_error_handler = set_error_handler("Menu_Mensual_scriptcase_error_handler");

function Menu_Mensual_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['Menu_Mensual']['contr_erro']) && $_SESSION['scriptcase']['Menu_Mensual']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Menu_Mensual->contr_Menu_Mensual->Apl_com_erro = true;
            if ($inicial_Menu_Mensual->contr_Menu_Mensual->NM_ajax_flag)
            {
                $inicial_Menu_Mensual->contr_Menu_Mensual->NM_ajax_info['errList']['geral_Menu_Mensual'][] = $msg;
                return;
            }
            Menu_Mensual_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Menu_Mensual_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Menu_Mensual'])  && '' != $_SESSION['scriptcase']['error_icon']['Menu_Mensual'])  ? $_SESSION['scriptcase']['error_icon']['Menu_Mensual']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Menu_Mensual']) && '' != $_SESSION['scriptcase']['error_span_title']['Menu_Mensual']) ? $_SESSION['scriptcase']['error_span_title']['Menu_Mensual'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Menu_Mensual']) && '' != $_SESSION['scriptcase']['error_icon_title']['Menu_Mensual']) ? $_SESSION['scriptcase']['error_icon_title']['Menu_Mensual'] : '';
?>
