  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Menu_Mensual" == sTestField)
        {
...
?>
  ...
  // ---------- Validate caseta
  function do_ajax_Menu_Mensual_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    var var_caseta = scAjaxGetFieldSelect(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Menu_Mensual_validate_caseta(var_caseta, var_script_case_init, do_ajax_Menu_Mensual_validate_caseta_cb);
  } // do_ajax_Menu_Mensual_validate_caseta

  function do_ajax_Menu_Mensual_validate_caseta_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Menu_Mensual_validate_caseta_cb

  // ---------- Validate year
  function do_ajax_Menu_Mensual_validate_year()
  {
    ...
    setTimeout(function() {
      var var_year = scAjaxGetFieldText(nomeCampo_year);
      x_ajax_Menu_Mensual_validate_year(var_year, var_script_case_init, do_ajax_Menu_Mensual_validate_year_cb);
    }, 200);
  } // do_ajax_Menu_Mensual_validate_year

  function do_ajax_Menu_Mensual_validate_year_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "year";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Menu_Mensual_validate_year_cb

  // ---------- Validate mes
  function do_ajax_Menu_Mensual_validate_mes()
  {
    ...
    setTimeout(function() {
      var var_mes = scAjaxGetFieldText(nomeCampo_mes);
      x_ajax_Menu_Mensual_validate_mes(var_mes, var_script_case_init, do_ajax_Menu_Mensual_validate_mes_cb);
    }, 200);
  } // do_ajax_Menu_Mensual_validate_mes

  function do_ajax_Menu_Mensual_validate_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Menu_Mensual_validate_mes_cb

  // ---------- Event onchange caseta
  function do_ajax_Menu_Mensual_event_caseta_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Menu_Mensual_event_caseta_onchange(var_script_case_init, do_ajax_Menu_Mensual_event_caseta_onchange_cb);
  } // do_ajax_Menu_Mensual_event_caseta_onchange

  function do_ajax_Menu_Mensual_event_caseta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "caseta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Menu_Mensual_event_caseta_onchange_cb_after_alert);
  } // do_ajax_Menu_Mensual_event_caseta_onchange_cb
  function do_ajax_Menu_Mensual_event_caseta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Menu_Mensual_event_caseta_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Menu_Mensual_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Menu_Mensual_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_Menu_Mensual_submit_form(var_caseta, var_year, var_mes, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Menu_Mensual_submit_form_cb);
  } // do_ajax_Menu_Mensual_submit_form

  function do_ajax_Menu_Mensual_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Menu_Mensual_submit_form_cb_after_alert);
  } // do_ajax_Menu_Mensual_submit_form_cb
  function do_ajax_Menu_Mensual_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Menu_Mensual_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Menu_Mensual_navigate_form()
  {
    perform_ajax_Menu_Mensual_navigate_form();
  }

  function perform_ajax_Menu_Mensual_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Menu_Mensual_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Menu_Mensual']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Menu_Mensual_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Menu_Mensual_navigate_form_cb_after_alert);
  } // do_ajax_Menu_Mensual_navigate_form_cb
  function do_ajax_Menu_Mensual_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_Menu_Mensual_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Menu_Mensual_navigate_form_cb_after_alert

  function sc_hide_Menu_Mensual_form()
  {
