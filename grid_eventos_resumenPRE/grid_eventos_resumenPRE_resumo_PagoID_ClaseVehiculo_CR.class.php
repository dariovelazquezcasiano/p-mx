...
class grid_eventos_resumenPRE_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_pagoid;
   var $array_total_clasevehiculo_cr;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_pagoid           = array();
      $this->array_total_clasevehiculo_cr = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_eventos_resumenPRE']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_eventos_resumenPRE']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['contr_total_geral'] == "OK")
      {
          $this->array_total_pagoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['pagoid'];
          $this->array_total_clasevehiculo_cr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['clasevehiculo_cr'];
      }
      else
      {
          $this->array_total_pagoid = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['json_use_label'])
       {
          $Lab_pagoid = "PagoID";
          $Lab_clasevehiculo_cr = "ClaseVehiculo_CR";
       }
       else
       {
       $Lab_pagoid = "Tipo Pago";
       $Lab_clasevehiculo_cr = "Clase Vehiculo CR";
       }
       $this->comp_field = array(
           $Lab_pagoid,
           $Lab_clasevehiculo_cr,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['carrilid'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['horaevento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['horaevento'] = "Hora Evento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['secuencial'] = "Secuencial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['folio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['folio'] = "Folio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['pagoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['pagoid'] = "Tipo Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_cr'] = "Vehiculo CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_cr'] = "Clase Vehiculo CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_cr'] = "Importe CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_cr'] = "Cantidad Eje CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_cr'] = "Tarifa EE CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['excentoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['excentoid'] = "Excento ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['consecutivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['consecutivo'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['casetaid'] = "Caseta ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechaoperacion'] = "Fecha Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechaturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechaturno'] = "Fecha Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['turnoid'] = "Turno ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tramoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tramoid'] = "Tramo ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_ect'] = "Vehiculo ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_ect'] = "Clase Vehiculo ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_ect'] = "Importe ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_ect'] = "Cantidad Eje ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_ect'] = "Tarifa EE ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_eap'] = "Vehiculo EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_eap'] = "Clase Vehiculo EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_eap'] = "Importe EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_eap'] = "Cantidad Eje EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_eap'] = "Tarifa EE EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['usuarioid'] = "Usuario ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['placas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['placas'] = "Placas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['numerotarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['numerotarjeta'] = "Numero Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tipotarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tipotarjeta'] = "Tipo Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechaenvio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechaenvio'] = "Fecha Envio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['codigofacturacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['codigofacturacion'] = "Codigo Facturacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['vehiculoid_ana'] = "Vehiculo ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['clasevehiculo_ana'] = "Clase Vehiculo ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['importe_ana'] = "Importe ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['pagoid_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['pagoid_ana'] = "Pago ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['estatusana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['estatusana'] = "Estatus ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fld_ar_sct']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fld_ar_sct'] = "Fld Ar Sct"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['cantidadeje_ana'] = "Cantidad Eje ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tarifaee_ana'] = "Tarifa EE ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechamodificadoana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechamodificadoana'] = "Fecha Modificado ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['eludidoextra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['eludidoextra'] = "Eludido Extra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['revisado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['revisado'] = "Revisado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechamarcacioncr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechamarcacioncr'] = "Fecha Marcacion CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechadeteccionect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechadeteccionect'] = "Fecha Deteccion ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechadeteccioneap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['fechadeteccioneap'] = "Fecha Deteccion EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tramoidorigen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['tramoidorigen'] = "Tramo ID Origen"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['operacionid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['labels']['operacionid'] = "Operacion ID"; 
       }
       //-----
       $this->comp_field_nm = array(
           'pagoid' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_order']['PagoID_ClaseVehiculo_CR']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_order']['PagoID_ClaseVehiculo_CR'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_order']['PagoID_ClaseVehiculo_CR'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_display']['PagoID_ClaseVehiculo_CR'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_display']['PagoID_ClaseVehiculo_CR'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_display']['PagoID_ClaseVehiculo_CR'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_display']['PagoID_ClaseVehiculo_CR'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_display']['PagoID_ClaseVehiculo_CR'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_display']['PagoID_ClaseVehiculo_CR'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['summarizing_fields_display']['PagoID_ClaseVehiculo_CR'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_pagoid as $i_pagoid => $d_pagoid) {
           if (!isset($i_pagoid, $this->comp_label[0]) || !in_array($i_pagoid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_pagoid[4] ] = $d_pagoid[3];
               $this->comp_label[0][ $d_pagoid[4] ] = $d_pagoid[3];
           }
           foreach ($this->array_total_clasevehiculo_cr[$i_pagoid] as $i_clasevehiculo_cr => $d_clasevehiculo_cr) {
               if (!isset($i_clasevehiculo_cr, $this->comp_label[1][ $d_pagoid[4] ]) || !in_array($i_clasevehiculo_cr, $this->comp_label[1][ $d_pagoid[4] ], true)) {
                   $this->comp_index[1][ $d_clasevehiculo_cr[4] ] = $d_clasevehiculo_cr[3];
                   $this->comp_label[1][ $d_pagoid[4] ][ $d_clasevehiculo_cr[4] ] = $d_clasevehiculo_cr[3];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'pagoid', 'prot' => '@aspass@'),
           array('name' => 'clasevehiculo_cr', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_level'] = 1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_pagoid => $l_pagoid) {
           if (isset($this->array_total_pagoid[$i_pagoid])) {
               $this->comp_group[$i_pagoid] = array();
           }
           foreach ($this->comp_label[1][$i_pagoid] as $i_clasevehiculo_cr => $l_clasevehiculo_cr) {
               if (isset($this->array_total_clasevehiculo_cr[$i_pagoid][$i_clasevehiculo_cr])) {
                   $this->comp_group[$i_pagoid][$i_clasevehiculo_cr] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_pagoid;
       }
       elseif (1 == $level) {
           $return = $this->array_total_clasevehiculo_cr;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_eventos_resumenPRE@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_eventos_resumenPRE_total.class.php"); 
      }
      ...
      $this->Total   = new grid_eventos_resumenPRE_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_pagoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['pagoid'];
      $this->array_total_clasevehiculo_cr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['clasevehiculo_cr'];
      if (is_array($this->array_total_pagoid)) {
          ksort($this->array_total_pagoid);
      }
      if (is_array($this->array_total_clasevehiculo_cr)) {
          ksort($this->array_total_clasevehiculo_cr);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_eventos_resumenPRE_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_eventos_resumenPRE_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_eventos_resumenPRE_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_eventos_resumenPRE/grid_eventos_resumenPRE_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
          $Pdf_mod_export = "resume";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "nm_gp_move('pdf_res', '0', 'pb', '', '', '', '', '','','$Pdf_mod_export','__APL__','N','N','S','N');", "nm_gp_move('pdf_res', '0', 'pb', '', '', '', '', '','','$Pdf_mod_export','__APL__','N','N','S','N');", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "nm_gp_csv_conf('1','2','1','S','resume','');", "nm_gp_csv_conf('1','2','1','S','resume','');", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['group_2'] == "on")
      {
         ...
         if (is_file("grid_eventos_resumenPRE_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_eventos_resumenPRE']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_eventos_resumenPRE']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_eventos_resumenPRE_config_pivot.php?nome_apl=grid_eventos_resumenPRE&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_eventos_resumenPRE_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_eventos_resumenPRE/grid_eventos_resumenPRE_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   $sc_data_cab1 = $this->nm_data->FormataSaida(" d-m-Y");
      ...
      $nm_saida->saida("          " . "Fecha de consulta" . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
      $nm_saida->saida("       <TR valign=\"middle\">\r\n");
      $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_pagoid, $quebra_clasevehiculo_cr, $quebra_pagoid_orig, $quebra_clasevehiculo_cr_orig)
   {
      //----- Tipo Pago
      if (!isset($this->array_total_pagoid[$quebra_pagoid_orig]))
      {
         $this->array_total_pagoid[$quebra_pagoid_orig][0] = 1;
         $this->array_total_pagoid[$quebra_pagoid_orig][1] = $sum_total;
         $this->array_total_pagoid[$quebra_pagoid_orig][2] = 1;
         $this->array_total_pagoid[$quebra_pagoid_orig][3] = $quebra_pagoid;
         $this->array_total_pagoid[$quebra_pagoid_orig][4] = $quebra_pagoid_orig;
      }
      else
      {
         $this->array_total_pagoid[$quebra_pagoid_orig][0]++;
         $this->array_total_pagoid[$quebra_pagoid_orig][1] = bcadd($this->array_total_pagoid[$quebra_pagoid_orig][1], $sum_total, 10);
         $this->array_total_pagoid[$quebra_pagoid_orig][2]++;
      }
      //----- Clase Vehiculo CR
      if (!isset($this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig]))
      {
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][0] = 1;
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][1] = $sum_total;
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][2] = 1;
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][3] = $quebra_clasevehiculo_cr;
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][4] = $quebra_clasevehiculo_cr_orig;
      }
      else
      {
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][0]++;
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][1] = bcadd($this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][1], $sum_total, 10);
         $this->array_total_clasevehiculo_cr[$quebra_pagoid_orig][$quebra_clasevehiculo_cr_orig][2]++;
      }
      //----- Total
      ...
      else
      {
         ...
         $this->array_total_geral[1] = bcadd($this->array_total_geral[1], $sum_total, 10);
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['pagoid'] as $campo_pagoid => $dados_pagoid)
      {
         $this->array_total_pagoid[$campo_pagoid][1] = $dados_pagoid[1];
         $this->array_total_pagoid[$campo_pagoid][2] = $dados_pagoid[2];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['clasevehiculo_cr'][$campo_pagoid] as $campo_clasevehiculo_cr => $dados_clasevehiculo_cr)
         {
            $this->array_total_clasevehiculo_cr[$campo_pagoid][$campo_clasevehiculo_cr][1] = $dados_clasevehiculo_cr[1];
            $this->array_total_clasevehiculo_cr[$campo_pagoid][$campo_clasevehiculo_cr][2] = $dados_clasevehiculo_cr[2];
         }
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('PagoID_ClaseVehiculo_CR', 'pagoid');
     $campos_order = $this->Ini->Get_date_order_groupby("PagoID", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('PagoID_ClaseVehiculo_CR', 'clasevehiculo_cr');
     $campos_order = $this->Ini->Get_date_order_groupby("ClaseVehiculo_CR", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->carrilid = $rs_res->fields[0] ;  
            $this->cuerpo = $rs_res->fields[1] ;  
            $this->horaevento = $rs_res->fields[2] ;  
            $this->secuencial = $rs_res->fields[3] ;  
            $this->folio = $rs_res->fields[4] ;  
            $this->pagoid = $rs_res->fields[5] ;  
            $this->vehiculoid_cr = $rs_res->fields[6] ;  
            $this->clasevehiculo_cr = $rs_res->fields[7] ;  
            $this->importe_cr = $rs_res->fields[8] ;  
            $this->importe_cr =  str_replace(",", ".", $this->importe_cr);
            $this->cantidadeje_cr = $rs_res->fields[9] ;  
            $this->tarifaee_cr = $rs_res->fields[10] ;  
            $this->tarifaee_cr =  str_replace(",", ".", $this->tarifaee_cr);
            $this->excentoid = $rs_res->fields[11] ;  
            $this->consecutivo = $rs_res->fields[12] ;  
            $this->casetaid = $rs_res->fields[13] ;  
            $this->fechaoperacion = $rs_res->fields[14] ;  
            $this->fechaturno = $rs_res->fields[15] ;  
            $this->turnoid = $rs_res->fields[16] ;  
            $this->pagoid_ana = $rs_res->fields[17] ;  
            $this->look_pagoid = $this->pagoid; 
            $this->Lookup->lookup_pagoid($this->look_pagoid, $this->pagoid) ; 
...
$_SESSION['scriptcase']['grid_eventos_resumenPRE']['contr_erro'] = 'off'; 
            $this->pagoid_orig = $this->pagoid;
            $this->clasevehiculo_cr_orig = $this->clasevehiculo_cr;
            $this->pagoid = $this->look_pagoid ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->pagoid, $this->clasevehiculo_cr, $this->pagoid_orig,  $this->clasevehiculo_cr_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_eventos_resumenPRE']['contr_erro'] = 'off';
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->total)), sc_strip_script($this->pagoid), sc_strip_script($this->clasevehiculo_cr), sc_strip_script($pagoid_orig), sc_strip_script($clasevehiculo_cr_orig));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['pagoid'] = $this->array_total_pagoid;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_resumenPRE']['arr_total']['clasevehiculo_cr'] = $this->array_total_clasevehiculo_cr;
      }
   }
