<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_eventos_resumenPRE']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_eventos_resumenPRE_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_eventos_resumenPRE_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["carrilid"] : "Carril";
   $tab_ger_campos['cuerpo'] = "on";
   $tab_def_campos['cuerpo'] = "Cuerpo";
   $tab_labels["cuerpo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["cuerpo"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["cuerpo"] : "Cuerpo";
   $tab_ger_campos['horaevento'] = "on";
   $tab_def_campos['horaevento'] = "HoraEvento";
   $tab_labels["horaevento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["horaevento"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["horaevento"] : "Hora Evento";
   $tab_ger_campos['secuencial'] = "on";
   $tab_def_campos['secuencial'] = "Secuencial";
   $tab_labels["secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["secuencial"] : "Secuencial";
   $tab_ger_campos['folio'] = "on";
   $tab_def_campos['folio'] = "Folio";
   $tab_labels["folio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["folio"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["folio"] : "Folio";
   $tab_ger_campos['pagoid'] = "on";
   $tab_def_campos['pagoid'] = "PagoID";
   $tab_labels["pagoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["pagoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["pagoid"] : "Tipo Pago";
   $tab_ger_campos['vehiculoid_cr'] = "on";
   $tab_def_campos['vehiculoid_cr'] = "VehiculoID_CR";
   $tab_labels["vehiculoid_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["vehiculoid_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["vehiculoid_cr"] : "Vehiculo CR";
   $tab_ger_campos['clasevehiculo_cr'] = "on";
   $tab_def_campos['clasevehiculo_cr'] = "ClaseVehiculo_CR";
   $tab_labels["clasevehiculo_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["clasevehiculo_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["clasevehiculo_cr"] : "Clase Vehiculo CR";
   $tab_ger_campos['importe_cr'] = "on";
   $tab_def_campos['importe_cr'] = "Importe_CR";
   $tab_labels["importe_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["importe_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["importe_cr"] : "Importe CR";
   $tab_ger_campos['cantidadeje_cr'] = "on";
   $tab_def_campos['cantidadeje_cr'] = "CantidadEje_CR";
   $tab_labels["cantidadeje_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["cantidadeje_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["cantidadeje_cr"] : "Cantidad Eje CR";
   $tab_ger_campos['tarifaee_cr'] = "on";
   $tab_def_campos['tarifaee_cr'] = "TarifaEE_CR";
   $tab_labels["tarifaee_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["tarifaee_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["tarifaee_cr"] : "Tarifa EE CR";
   $tab_ger_campos['excentoid'] = "on";
   $tab_def_campos['excentoid'] = "ExcentoID";
   $tab_labels["excentoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["excentoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["excentoid"] : "Excento ID";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_eventos_resumenPRE_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_eventos_resumenPRE']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
