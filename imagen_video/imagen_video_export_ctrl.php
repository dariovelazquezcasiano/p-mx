<?php
@session_start() ;
$_SESSION['scriptcase']['imagen_video']['sc_process_barr'] = true;
require_once('../imagen_video/index.php');
unset($_SESSION['scriptcase']['imagen_video']['sc_process_barr']);
$ExportCtrl = new imagen_video_export_control;
$ExportCtrl->Export_barr();

class imagen_video_export_control
{
