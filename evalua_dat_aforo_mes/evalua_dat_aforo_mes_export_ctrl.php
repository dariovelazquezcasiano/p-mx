<?php
@session_start() ;
$_SESSION['scriptcase']['evalua_dat_aforo_mes']['sc_process_barr'] = true;
require_once('../evalua_dat_aforo_mes/index.php');
unset($_SESSION['scriptcase']['evalua_dat_aforo_mes']['sc_process_barr']);
$ExportCtrl = new evalua_dat_aforo_mes_export_control;
$ExportCtrl->Export_barr();

class evalua_dat_aforo_mes_export_control
{
