...
class evalua_dat_aforo_mes_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['evalua_dat_aforo_mes']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['evalua_dat_aforo_mes']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['array_graf_pdf'] = array();
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['contr_total_geral'] == "OK")
      {
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@evalua_dat_aforo_mes@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new evalua_dat_aforo_mes_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_evalua_dat_aforo_mes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_evalua_dat_aforo_mes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_evalua_dat_aforo_mes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "evalua_dat_aforo_mes/evalua_dat_aforo_mes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['responsive_chart']['active']) {
          ...
          {
              $summary_width = "width=\"70%\"";
          }
      }
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "evalua_dat_aforo_mes/evalua_dat_aforo_mes_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         ...
         $NM_btn = false;
         $NM_Gbtn = false;
         if (is_file("evalua_dat_aforo_mes_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "evalua_dat_aforo_mes/evalua_dat_aforo_mes_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['evalua_dat_aforo_mes']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['evalua_dat_aforo_mes']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'evalua_dat_aforo_mes_config_pivot.php?nome_apl=evalua_dat_aforo_mes&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_evalua_dat_aforo_mes_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "evalua_dat_aforo_mes/evalua_dat_aforo_mes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new evalua_dat_aforo_mes_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['pivot_charts']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           evalua_dat_aforo_mes_pdf_progress_call("\n", $this->Ini->Nm_lang);
           evalua_dat_aforo_mes_pdf_progress_call("\n", $this->Ini->Nm_lang);
           evalua_dat_aforo_mes_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['pivot_charts'] as $chart_index => $chart_data)
       {
           $qtd_col++;
           if ($qtd_col > $lim_col)
           {
           ...
           $nm_saida->saida("<TD align=\"left\" valign=\"top\" width=\"25%\">\r\n");
           if ($bPDF)
           {
               $this->Graf->monta_grafico($chart_index, 'pdf');
               if ($this->progress_fp)
               {
                   evalua_dat_aforo_mes_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       if ($bChartFP)
       {
           ...
           evalua_dat_aforo_mes_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
       }
   }
 }
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_dat_aforo'] . "</div>\r\n");
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
      ...
      $nm_saida->saida("        </td>\r\n");
      $nm_saida->saida("        <td>\r\n");
      $nm_saida->saida("            <span class=\"" . $this->css_scGridFooterFont . "\" id=\"rod_col2\"><IMG src=\"" . $this->NM_raiz_img . $this->Ini->path_imag_cab . "/sys__NM__ico__NM__compile.gif\" border=\"0\" title=\"\" /></span>\r\n");
      $nm_saida->saida("        </td>\r\n");
      $nm_saida->saida("    </tr>\r\n");
      $nm_saida->saida("</table>\r\n");
      $nm_saida->saida("  </TD>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_aforon, $sum_ingreson, $sum_aforoi, $sum_ingresoi, $sum_aforoe, $sum_ingresoe, $sum_aforov, $sum_ingresov, $sum_total_veh, $sum_total_ing, $avg_tpdpp)
   {
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_aforon;
         $this->array_total_geral[2] = $sum_ingreson;
         $this->array_total_geral[3] = $sum_aforoi;
         $this->array_total_geral[4] = $sum_ingresoi;
         $this->array_total_geral[5] = $sum_aforoe;
         $this->array_total_geral[6] = $sum_ingresoe;
         $this->array_total_geral[7] = $sum_aforov;
         $this->array_total_geral[8] = $sum_ingresov;
         $this->array_total_geral[9] = $sum_total_veh;
         $this->array_total_geral[10] = $sum_total_ing;
         $this->array_total_geral[11] = $avg_tpdpp;
      }
      else
      {
         $this->array_total_geral[0]++;
         $this->array_total_geral[1] = bcadd($this->array_total_geral[1], $sum_aforon, 10);
         $this->array_total_geral[2] = bcadd($this->array_total_geral[2], $sum_ingreson, 10);
         $this->array_total_geral[3] = bcadd($this->array_total_geral[3], $sum_aforoi, 10);
         $this->array_total_geral[4] = bcadd($this->array_total_geral[4], $sum_ingresoi, 10);
         $this->array_total_geral[5] = bcadd($this->array_total_geral[5], $sum_aforoe, 10);
         $this->array_total_geral[6] = bcadd($this->array_total_geral[6], $sum_ingresoe, 10);
         $this->array_total_geral[7] = bcadd($this->array_total_geral[7], $sum_aforov, 10);
         $this->array_total_geral[8] = bcadd($this->array_total_geral[8], $sum_ingresov, 10);
         $this->array_total_geral[9] = bcadd($this->array_total_geral[9], $sum_total_veh, 10);
         $this->array_total_geral[10] = bcadd($this->array_total_geral[10], $sum_total_ing, 10);
         $this->array_total_geral[11] = bcadd($this->array_total_geral[11], $avg_tpdpp, 10);
      }
   }
   ...
   {
         $this->array_total_geral[11] /= $this->array_total_geral[0];
   }
