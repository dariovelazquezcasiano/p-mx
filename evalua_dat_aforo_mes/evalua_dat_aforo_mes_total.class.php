...
class evalua_dat_aforo_mes_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['evalua_dat_aforo_mes']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['evalua_dat_aforo_mes']['campos_busca']))
      { 
