...
class evalua_dat_aforo_mes_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "evalua_dat_aforo_mes.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_name']);
      }
...
$_SESSION['scriptcase']['evalua_dat_aforo_mes']['contr_erro'] = 'off'; 
   ...
   function NM_export_mes()
   {
         ...
         $this->look_mes = str_replace('<', '&lt;', $this->look_mes);
         $this->look_mes = str_replace('>', '&gt;', $this->look_mes);
         $this->Texto_tag .= "<td>" . $this->look_mes . "</td>\r\n";
   }
   //----- aforon
   function NM_export_aforon()
   {
         ...
         $this->aforon = str_replace('<', '&lt;', $this->aforon);
         $this->aforon = str_replace('>', '&gt;', $this->aforon);
         $this->Texto_tag .= "<td>" . $this->aforon . "</td>\r\n";
   }
   //----- ingreson
   function NM_export_ingreson()
   {
         ...
         $this->ingreson = str_replace('<', '&lt;', $this->ingreson);
         $this->ingreson = str_replace('>', '&gt;', $this->ingreson);
         $this->Texto_tag .= "<td>" . $this->ingreson . "</td>\r\n";
   }
   //----- aforoi
   function NM_export_aforoi()
   {
         ...
         $this->aforoi = str_replace('<', '&lt;', $this->aforoi);
         $this->aforoi = str_replace('>', '&gt;', $this->aforoi);
         $this->Texto_tag .= "<td>" . $this->aforoi . "</td>\r\n";
   }
   //----- ingresoi
   function NM_export_ingresoi()
   {
         ...
         $this->ingresoi = str_replace('<', '&lt;', $this->ingresoi);
         $this->ingresoi = str_replace('>', '&gt;', $this->ingresoi);
         $this->Texto_tag .= "<td>" . $this->ingresoi . "</td>\r\n";
   }
   //----- aforoe
   function NM_export_aforoe()
   {
         ...
         $this->aforoe = str_replace('<', '&lt;', $this->aforoe);
         $this->aforoe = str_replace('>', '&gt;', $this->aforoe);
         $this->Texto_tag .= "<td>" . $this->aforoe . "</td>\r\n";
   }
   //----- ingresoe
   function NM_export_ingresoe()
   {
         ...
         $this->ingresoe = str_replace('<', '&lt;', $this->ingresoe);
         $this->ingresoe = str_replace('>', '&gt;', $this->ingresoe);
         $this->Texto_tag .= "<td>" . $this->ingresoe . "</td>\r\n";
   }
   //----- aforov
   function NM_export_aforov()
   {
         ...
         $this->aforov = str_replace('<', '&lt;', $this->aforov);
         $this->aforov = str_replace('>', '&gt;', $this->aforov);
         $this->Texto_tag .= "<td>" . $this->aforov . "</td>\r\n";
   }
   //----- ingresov
   function NM_export_ingresov()
   {
         ...
         $this->ingresov = str_replace('<', '&lt;', $this->ingresov);
         $this->ingresov = str_replace('>', '&gt;', $this->ingresov);
         $this->Texto_tag .= "<td>" . $this->ingresov . "</td>\r\n";
   }
   //----- aforoex
   function NM_export_aforoex()
   {
         ...
         $this->aforoex = str_replace('<', '&lt;', $this->aforoex);
         $this->aforoex = str_replace('>', '&gt;', $this->aforoex);
         $this->Texto_tag .= "<td>" . $this->aforoex . "</td>\r\n";
   }
   //----- ingresoex
   function NM_export_ingresoex()
   {
         ...
         $this->ingresoex = str_replace('<', '&lt;', $this->ingresoex);
         $this->ingresoex = str_replace('>', '&gt;', $this->ingresoex);
         $this->Texto_tag .= "<td>" . $this->ingresoex . "</td>\r\n";
   }
   //----- afororsp
   function NM_export_afororsp()
   {
         ...
         $this->afororsp = str_replace('<', '&lt;', $this->afororsp);
         $this->afororsp = str_replace('>', '&gt;', $this->afororsp);
         $this->Texto_tag .= "<td>" . $this->afororsp . "</td>\r\n";
   }
   //----- ingresorsp
   function NM_export_ingresorsp()
   {
         ...
         $this->ingresorsp = str_replace('<', '&lt;', $this->ingresorsp);
         $this->ingresorsp = str_replace('>', '&gt;', $this->ingresorsp);
         $this->Texto_tag .= "<td>" . $this->ingresorsp . "</td>\r\n";
   }
   //----- total_veh
   function NM_export_total_veh()
   {
         ...
         $this->total_veh = str_replace('<', '&lt;', $this->total_veh);
         $this->total_veh = str_replace('>', '&gt;', $this->total_veh);
         $this->Texto_tag .= "<td>" . $this->total_veh . "</td>\r\n";
   }
   //----- total_ing
   function NM_export_total_ing()
   {
         ...
         $this->total_ing = str_replace('<', '&lt;', $this->total_ing);
         $this->total_ing = str_replace('>', '&gt;', $this->total_ing);
         $this->Texto_tag .= "<td>" . $this->total_ing . "</td>\r\n";
   }
   //----- tpdpp
   function NM_export_tpdpp()
   {
         ...
         $this->tpdpp = str_replace('<', '&lt;', $this->tpdpp);
         $this->tpdpp = str_replace('>', '&gt;', $this->tpdpp);
         $this->Texto_tag .= "<td>" . $this->tpdpp . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['evalua_dat_aforo_mes']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_dat_aforo'] ?> :: RTF</TITLE>
