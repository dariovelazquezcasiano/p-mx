...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____evalua_dat_aforo_mes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____evalua_dat_aforo_mes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>evalua_dat_aforo_mes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['embutida_filho'] as $ind => $sc_init)
          {
