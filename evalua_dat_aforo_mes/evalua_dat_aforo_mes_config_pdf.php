...
*/
    ...
    $SC_apl_proc = "evalua_dat_aforo_mes";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['evalua_dat_aforo_mes']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['evalua_dat_aforo_mes']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['evalua_dat_aforo_mes']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['evalua_dat_aforo_mes']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['evalua_dat_aforo_mes']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
