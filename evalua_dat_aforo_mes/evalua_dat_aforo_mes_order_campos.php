<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['evalua_dat_aforo_mes']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new evalua_dat_aforo_mes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class evalua_dat_aforo_mes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['mes'] = "month(FechaOperacion)";
   }
   $tab_labels["mes"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["mes"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["mes"] : "Mes";
   $tab_ger_campos['aforon'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['aforon'] = "aforon";
   }
   else
   {
       $tab_def_campos['aforon'] = "sum((case when (PagoID='NOR' or PagoID='CRE' or PagoID='RPI' ) then CantidadVeh else 0 end))";
   }
   $tab_labels["aforon"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforon"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforon"] : "Aforo";
   $tab_ger_campos['ingreson'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ingreson'] = "ingreson";
   }
   else
   {
       $tab_def_campos['ingreson'] = "sum((case when (PagoID='NOR' or PagoID='CRE' or PagoID='RPI') then (Importe_ANA+TarifaEE_ANA) else 0 end))";
   }
   $tab_labels["ingreson"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingreson"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingreson"] : "Ingreso";
   $tab_ger_campos['aforoi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['aforoi'] = "aforoi";
   }
   else
   {
       $tab_def_campos['aforoi'] = "sum((case when (PagoID='IAV') then CantidadVeh else 0 end))";
   }
   $tab_labels["aforoi"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforoi"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforoi"] : "Aforo";
   $tab_ger_campos['ingresoi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ingresoi'] = "ingresoi";
   }
   else
   {
       $tab_def_campos['ingresoi'] = "sum((case when (PagoID='IAV') then (Importe_ANA+TarifaEE_ANA) else 0 end))";
   }
   $tab_labels["ingresoi"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresoi"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresoi"] : "Ingreso";
   $tab_ger_campos['aforoe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['aforoe'] = "aforoe";
   }
   else
   {
       $tab_def_campos['aforoe'] = "sum((case when (PagoID='ELU') then CantidadVeh else 0 end))";
   }
   $tab_labels["aforoe"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforoe"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforoe"] : "Aforo";
   $tab_ger_campos['ingresoe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ingresoe'] = "ingresoe";
   }
   else
   {
       $tab_def_campos['ingresoe'] = "sum((case when (PagoID='ELU') then (Importe_ANA+TarifaEE_ANA) else 0 end))";
   }
   $tab_labels["ingresoe"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresoe"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresoe"] : "Ingreso";
   $tab_ger_campos['aforov'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['aforov'] = "aforov";
   }
   else
   {
       $tab_def_campos['aforov'] = "sum((case when (PagoID='VSC') then CantidadVeh else 0 end))";
   }
   $tab_labels["aforov"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforov"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforov"] : "Aforo";
   $tab_ger_campos['ingresov'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ingresov'] = "ingresov";
   }
   else
   {
       $tab_def_campos['ingresov'] = "sum((case when (PagoID='VSC') then (Importe_ANA+TarifaEE_ANA) else 0 end))";
   }
   $tab_labels["ingresov"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresov"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresov"] : "Ingreso";
   $tab_ger_campos['aforoex'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['aforoex'] = "aforoex";
   }
   else
   {
       $tab_def_campos['aforoex'] = "sum((case when (PagoID='EXE') then CantidadVeh else 0 end))";
   }
   $tab_labels["aforoex"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforoex"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["aforoex"] : "Aforo";
   $tab_ger_campos['ingresoex'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ingresoex'] = "ingresoex";
   }
   else
   {
       $tab_def_campos['ingresoex'] = "sum((case when (PagoID='EXE') then (Importe_ANA+TarifaEE_ANA) else 0 end))";
   }
   $tab_labels["ingresoex"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresoex"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresoex"] : "Ingreso";
   $tab_ger_campos['afororsp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['afororsp'] = "afororsp";
   }
   else
   {
       $tab_def_campos['afororsp'] = "sum((case when (PagoID='RSP') then CantidadVeh else 0 end))";
   }
   $tab_labels["afororsp"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["afororsp"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["afororsp"] : "Aforo";
   $tab_ger_campos['ingresorsp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ingresorsp'] = "ingresorsp";
   }
   else
   {
       $tab_def_campos['ingresorsp'] = "sum((case when (PagoID='RSP') then (Importe_ANA+TarifaEE_ANA) else 0 end))";
   }
   $tab_labels["ingresorsp"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresorsp"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["ingresorsp"] : "Ingreso";
   $tab_ger_campos['total_veh'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['total_veh'] = "total_veh";
   }
   else
   {
       $tab_def_campos['total_veh'] = "";
   }
   $tab_labels["total_veh"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["total_veh"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["total_veh"] : "Aforo";
   $tab_ger_campos['total_ing'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['total_ing'] = "total_ing";
   }
   else
   {
       $tab_def_campos['total_ing'] = "";
   }
   $tab_labels["total_ing"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["total_ing"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["total_ing"] : "Ingreso";
   $tab_ger_campos['tpdpp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tpdpp'] = "tpdpp";
   }
   else
   {
       $tab_def_campos['tpdpp'] = "";
   }
   $tab_labels["tpdpp"]   = (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["tpdpp"])) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['labels']["tpdpp"] : "TDPP";
   $tab_ger_campos['total_veh'] = "none";
   $tab_ger_campos['total_ing'] = "none";
   $tab_ger_campos['tpdpp'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_dat_aforo'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "evalua_dat_aforo_mes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['evalua_dat_aforo_mes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
