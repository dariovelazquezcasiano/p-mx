  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pagos_peaje" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_pagos_peaje_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_pagos_peaje_validate_id__cb);
  } // do_ajax_pagos_peaje_validate_id_

  function do_ajax_pagos_peaje_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_validate_id__cb

  // ---------- Validate fecha_
  function do_ajax_pagos_peaje_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_pagos_peaje_validate_fecha__cb);
  } // do_ajax_pagos_peaje_validate_fecha_

  function do_ajax_pagos_peaje_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_validate_fecha__cb

  // ---------- Validate fecha_deposito_
  function do_ajax_pagos_peaje_validate_fecha_deposito_(iNumLinha)
  {
    var nomeCampo_fecha_deposito_ = "fecha_deposito_" + iNumLinha;
    var var_fecha_deposito_ = scAjaxGetFieldText(nomeCampo_fecha_deposito_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_validate_fecha_deposito_(var_fecha_deposito_, iNumLinha, var_script_case_init, do_ajax_pagos_peaje_validate_fecha_deposito__cb);
  } // do_ajax_pagos_peaje_validate_fecha_deposito_

  function do_ajax_pagos_peaje_validate_fecha_deposito__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fecha_deposito_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fecha_deposito_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fecha_deposito_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fecha_deposito_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_validate_fecha_deposito__cb

  // ---------- Validate monto_
  function do_ajax_pagos_peaje_validate_monto_(iNumLinha)
  {
    var nomeCampo_monto_ = "monto_" + iNumLinha;
    var var_monto_ = scAjaxGetFieldText(nomeCampo_monto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_validate_monto_(var_monto_, iNumLinha, var_script_case_init, do_ajax_pagos_peaje_validate_monto__cb);
  } // do_ajax_pagos_peaje_validate_monto_

  function do_ajax_pagos_peaje_validate_monto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_validate_monto__cb

  // ---------- Validate referencia_
  function do_ajax_pagos_peaje_validate_referencia_(iNumLinha)
  {
    var nomeCampo_referencia_ = "referencia_" + iNumLinha;
    var var_referencia_ = scAjaxGetFieldText(nomeCampo_referencia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_validate_referencia_(var_referencia_, iNumLinha, var_script_case_init, do_ajax_pagos_peaje_validate_referencia__cb);
  } // do_ajax_pagos_peaje_validate_referencia_

  function do_ajax_pagos_peaje_validate_referencia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "referencia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "referencia_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "referencia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "referencia_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_validate_referencia__cb

  // ---------- Validate caseta_
  function do_ajax_pagos_peaje_validate_caseta_(iNumLinha)
  {
    var nomeCampo_caseta_ = "caseta_" + iNumLinha;
    var var_caseta_ = scAjaxGetFieldSelect(nomeCampo_caseta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_validate_caseta_(var_caseta_, iNumLinha, var_script_case_init, do_ajax_pagos_peaje_validate_caseta__cb);
  } // do_ajax_pagos_peaje_validate_caseta_

  function do_ajax_pagos_peaje_validate_caseta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_validate_caseta__cb

  // ---------- Event onchange fecha_
  function do_ajax_pagos_peaje_event_fecha__onchange(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_pagos_peaje_event_fecha__onchange(var_fecha_, var_caseta_, var_script_case_init, var_nmgp_refresh_row, do_ajax_pagos_peaje_event_fecha__onchange_cb);
  } // do_ajax_pagos_peaje_event_fecha__onchange

  function do_ajax_pagos_peaje_event_fecha__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_pagos_peaje_event_fecha__onchange_cb_after_alert);
  } // do_ajax_pagos_peaje_event_fecha__onchange_cb
  function do_ajax_pagos_peaje_event_fecha__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_pagos_peaje_event_fecha__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_pagos_peaje_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_pagos_peaje_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_pagos_peaje_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_pagos_peaje_add_new_line_cb);
  } // do_ajax_pagos_peaje_add_new_line

  function do_ajax_pagos_peaje_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_pagos_peaje_add_new_line_cb

  // ---------- backup_line
  function do_ajax_pagos_peaje_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_pagos_peaje_backup_line_cb);
  } // do_ajax_pagos_peaje_backup_line

  function do_ajax_pagos_peaje_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_pagos_peaje_backup_line_cb

  function do_ajax_pagos_peaje_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_pagos_peaje_cancel_insert

  function do_ajax_pagos_peaje_cancel_update(iSeqVert)
  {
    do_ajax_pagos_peaje_backup_line(iSeqVert);
...
?>
  } // do_ajax_pagos_peaje_cancel_update

  function do_ajax_pagos_peaje_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_pagos_peaje_restore_buttons

  // ---------- table_refresh
  function do_ajax_pagos_peaje_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_pagos_peaje_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pagos_peaje_table_refresh_cb);
  } //  do_ajax_pagos_peaje_table_refresh

  function do_ajax_pagos_peaje_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_pagos_peaje_table_refresh_cb_after_alert);
  } // do_ajax_pagos_peaje_table_refresh_cb
  function do_ajax_pagos_peaje_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_pagos_peaje_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_pagos_peaje_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_pagos_peaje_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_fecha_deposito_ = scAjaxGetFieldText("fecha_deposito_" + iNumLinha);
    var var_monto_ = scAjaxGetFieldText("monto_" + iNumLinha);
    var var_referencia_ = scAjaxGetFieldText("referencia_" + iNumLinha);
...
?>
    x_ajax_pagos_peaje_submit_form(var_id_, var_fecha_, var_fecha_deposito_, var_monto_, var_referencia_, var_caseta_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_pagos_peaje_submit_form_cb);
  } // do_ajax_pagos_peaje_submit_form

  function do_ajax_pagos_peaje_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fecha_deposito_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("monto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("referencia_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_pagos_peaje_submit_form_cb_after_alert);
  } // do_ajax_pagos_peaje_submit_form_cb
  function do_ajax_pagos_peaje_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_pagos_peaje_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_pagos_peaje_navigate_form()
  {
    perform_ajax_pagos_peaje_navigate_form();
  }

  function perform_ajax_pagos_peaje_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_pagos_peaje_cancel_insert(sc_pagos_peaje_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fecha_deposito_" + iNavForm);
      scAjaxHideErrorDisplay("monto_" + iNavForm);
      scAjaxHideErrorDisplay("referencia_" + iNavForm);
    ...
    scAjaxProcOn();
    x_ajax_pagos_peaje_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pagos_peaje_navigate_form_cb);
  } // do_ajax_pagos_peaje_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pagos_peaje']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_pagos_peaje_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_pagos_peaje_navigate_form_cb_after_alert);
  } // do_ajax_pagos_peaje_navigate_form_cb
  function do_ajax_pagos_peaje_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_pagos_peaje_navigate_form_cb_after_alert

    function sc_pagos_peaje_get_last_line_number()
    {
    ...
    } //sc_pagos_peaje_get_last_line_number

  function sc_hide_pagos_peaje_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_deposito_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "monto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "referencia_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fecha_deposito_" + iNumLinha] = {"label": "Fecha Deposito<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["referencia_" + iNumLinha] = {"label": "Referencia<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fecha_deposito_"][iNumLinha] = "fecha_deposito_" + iNumLinha;
    ajax_field_mult["monto_"][iNumLinha] = "monto_" + iNumLinha;
    ajax_field_mult["referencia_"][iNumLinha] = "referencia_" + iNumLinha;
    ...
    ajax_field_id["fecha_deposito_" + iNumLinha] = new Array("hidden_field_label_fecha_deposito_", "hidden_field_data_fecha_deposito_" + iNumLinha);
    ajax_field_id["monto_" + iNumLinha] = new Array("hidden_field_label_monto_", "hidden_field_data_monto_" + iNumLinha);
    ajax_field_id["referencia_" + iNumLinha] = new Array("hidden_field_label_referencia_", "hidden_field_data_referencia_" + iNumLinha);
    ...
    ajax_error_count["fecha_deposito_" + iNumLinha] = "off";
    ajax_error_count["monto_" + iNumLinha] = "off";
    ajax_error_count["referencia_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fecha_deposito_" + iNumLinha] = "off";
    ajax_read_only["monto_" + iNumLinha] = "off";
    ajax_read_only["referencia_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fecha_deposito_" + iNumLinha] = "on";
    ajax_read_only["monto_" + iNumLinha] = "on";
    ajax_read_only["referencia_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fecha_deposito_" + iNumLinha] = null;
    ajax_error_list["monto_" + iNumLinha] = null;
    ajax_error_list["referencia_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "id_": new Array(),
    "fecha_": new Array(),
    "fecha_deposito_": new Array(),
    "monto_": new Array(),
    "referencia_": new Array(),
    "caseta_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fecha_deposito_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fecha_deposito_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fecha_deposito_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fecha_deposito_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fecha_deposito_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["referencia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["referencia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["referencia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["referencia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["referencia_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_deposito_'])) ? $this->nmgp_cmp_readonly['fecha_deposito_'] : 'off';
?>
    scAjaxFieldRead("fecha_deposito_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['referencia_'])) ? $this->nmgp_cmp_readonly['referencia_'] : 'off';
?>
    scAjaxFieldRead("referencia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("fecha_deposito_" + iSeq, "on");
    scAjaxFieldRead("monto_" + iSeq, "on");
    scAjaxFieldRead("referencia_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["fecha_" + iRow] || "on" == ajax_error_count["fecha_deposito_" + iRow] || "on" == ajax_error_count["monto_" + iRow] || "on" == ajax_error_count["referencia_" + iRow] || "on" == ajax_error_count["caseta_" + iRow]))
    {
      ...
      $("#hidden_field_data_fecha_deposito_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_monto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_referencia_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["fecha_" + iRow] && "off" == ajax_error_count["fecha_deposito_" + iRow] && "off" == ajax_error_count["monto_" + iRow] && "off" == ajax_error_count["referencia_" + iRow] && "off" == ajax_error_count["caseta_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["fecha_" + iRow] = "off";
        ajax_error_count["fecha_deposito_" + iRow] = "off";
        ajax_error_count["monto_" + iRow] = "off";
        ajax_error_count["referencia_" + iRow] = "off";
      ...
      $("#hidden_field_data_fecha_deposito_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_monto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_referencia_" + iRow).removeClass("scFormErrorLine");
