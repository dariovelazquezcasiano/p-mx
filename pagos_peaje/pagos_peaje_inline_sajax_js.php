  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pagos_peaje_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_pagos_peaje_inline_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_pagos_peaje_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_inline_validate_id_(var_id_, var_script_case_init, do_ajax_pagos_peaje_inline_validate_id__cb);
  } // do_ajax_pagos_peaje_inline_validate_id_

  function do_ajax_pagos_peaje_inline_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_inline_validate_id__cb

  // ---------- Validate fecha_
  function do_ajax_pagos_peaje_inline_validate_fecha_()
  {
    ...
    setTimeout(function() {
      var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
      x_ajax_pagos_peaje_inline_validate_fecha_(var_fecha_, var_script_case_init, do_ajax_pagos_peaje_inline_validate_fecha__cb);
    }, 200);
  } // do_ajax_pagos_peaje_inline_validate_fecha_

  function do_ajax_pagos_peaje_inline_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_inline_validate_fecha__cb

  // ---------- Validate fecha_deposito_
  function do_ajax_pagos_peaje_inline_validate_fecha_deposito_()
  {
    var nomeCampo_fecha_deposito_ = "fecha_deposito_";
    var var_fecha_deposito_ = scAjaxGetFieldText(nomeCampo_fecha_deposito_);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fecha_deposito_ = scAjaxGetFieldText(nomeCampo_fecha_deposito_);
      x_ajax_pagos_peaje_inline_validate_fecha_deposito_(var_fecha_deposito_, var_script_case_init, do_ajax_pagos_peaje_inline_validate_fecha_deposito__cb);
    }, 200);
  } // do_ajax_pagos_peaje_inline_validate_fecha_deposito_

  function do_ajax_pagos_peaje_inline_validate_fecha_deposito__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_inline_validate_fecha_deposito__cb

  // ---------- Validate monto_
  function do_ajax_pagos_peaje_inline_validate_monto_()
  {
    var nomeCampo_monto_ = "monto_";
    var var_monto_ = scAjaxGetFieldText(nomeCampo_monto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_inline_validate_monto_(var_monto_, var_script_case_init, do_ajax_pagos_peaje_inline_validate_monto__cb);
  } // do_ajax_pagos_peaje_inline_validate_monto_

  function do_ajax_pagos_peaje_inline_validate_monto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_inline_validate_monto__cb

  // ---------- Validate referencia_
  function do_ajax_pagos_peaje_inline_validate_referencia_()
  {
    var nomeCampo_referencia_ = "referencia_";
    var var_referencia_ = scAjaxGetFieldText(nomeCampo_referencia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_inline_validate_referencia_(var_referencia_, var_script_case_init, do_ajax_pagos_peaje_inline_validate_referencia__cb);
  } // do_ajax_pagos_peaje_inline_validate_referencia_

  function do_ajax_pagos_peaje_inline_validate_referencia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_inline_validate_referencia__cb

  // ---------- Validate caseta_
  function do_ajax_pagos_peaje_inline_validate_caseta_()
  {
    var nomeCampo_caseta_ = "caseta_";
    var var_caseta_ = scAjaxGetFieldSelect(nomeCampo_caseta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_peaje_inline_validate_caseta_(var_caseta_, var_script_case_init, do_ajax_pagos_peaje_inline_validate_caseta__cb);
  } // do_ajax_pagos_peaje_inline_validate_caseta_

  function do_ajax_pagos_peaje_inline_validate_caseta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_peaje_inline_validate_caseta__cb

  // ---------- Event onchange fecha_
  function do_ajax_pagos_peaje_inline_event_fecha__onchange()
  {
    var var_fecha_ = scAjaxGetFieldText("fecha_");
    var var_caseta_ = scAjaxGetFieldSelect("caseta_");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_pagos_peaje_inline_event_fecha__onchange(var_fecha_, var_caseta_, var_script_case_init, do_ajax_pagos_peaje_inline_event_fecha__onchange_cb);
  } // do_ajax_pagos_peaje_inline_event_fecha__onchange

  function do_ajax_pagos_peaje_inline_event_fecha__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_pagos_peaje_inline_event_fecha__onchange_cb_after_alert);
  } // do_ajax_pagos_peaje_inline_event_fecha__onchange_cb
  function do_ajax_pagos_peaje_inline_event_fecha__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_pagos_peaje_inline_event_fecha__onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_pagos_peaje_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_pagos_peaje_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_");
    var var_fecha_ = scAjaxGetFieldText("fecha_");
    var var_fecha_deposito_ = scAjaxGetFieldText("fecha_deposito_");
    var var_monto_ = scAjaxGetFieldText("monto_");
    var var_referencia_ = scAjaxGetFieldText("referencia_");
    var var_caseta_ = scAjaxGetFieldSelect("caseta_");
    ...
    scAjaxProcOn();
    x_ajax_pagos_peaje_inline_submit_form(var_id_, var_fecha_, var_fecha_deposito_, var_monto_, var_referencia_, var_caseta_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_pagos_peaje_inline_submit_form_cb);
  } // do_ajax_pagos_peaje_inline_submit_form

  function do_ajax_pagos_peaje_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fecha_deposito_");
      scAjaxHideErrorDisplay("monto_");
      scAjaxHideErrorDisplay("referencia_");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_pagos_peaje_inline_submit_form_cb_after_alert);
  } // do_ajax_pagos_peaje_inline_submit_form_cb
  function do_ajax_pagos_peaje_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_pagos_peaje_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_pagos_peaje_inline_navigate_form()
  {
    perform_ajax_pagos_peaje_inline_navigate_form();
  }

  function perform_ajax_pagos_peaje_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_pagos_peaje_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pagos_peaje_inline_navigate_form_cb);
  } // do_ajax_pagos_peaje_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pagos_peaje_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_pagos_peaje_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_pagos_peaje_inline_navigate_form_cb_after_alert);
  } // do_ajax_pagos_peaje_inline_navigate_form_cb
  function do_ajax_pagos_peaje_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_pagos_peaje_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_pagos_peaje_inline_navigate_form_cb_after_alert

  function sc_hide_pagos_peaje_inline_form()
  {
  ...
  ajax_field_list[2] = "fecha_deposito_";
  ajax_field_list[3] = "monto_";
  ajax_field_list[4] = "referencia_";
  ...
  var ajax_error_list = {
    ...
    "fecha_deposito_": {"label": "Fecha Deposito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "monto_": {"label": "Monto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "referencia_": {"label": "Referencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["fecha_deposito_"][1] = "fecha_deposito_";
  ajax_field_mult["monto_"][1] = "monto_";
  ajax_field_mult["referencia_"][1] = "referencia_";
  ...
  var ajax_field_id = {
    ...
    "fecha_deposito_": new Array("hidden_field_label_fecha_deposito_", "hidden_field_data_fecha_deposito_"),
    "monto_": new Array("hidden_field_label_monto_", "hidden_field_data_monto_"),
    "referencia_": new Array("hidden_field_label_referencia_", "hidden_field_data_referencia_"),
