<?php
@session_start() ;
$_SESSION['scriptcase']['grid_imagentitulacion']['sc_process_barr'] = true;
require_once('../grid_imagentitulacion/index.php');
unset($_SESSION['scriptcase']['grid_imagentitulacion']['sc_process_barr']);
$ExportCtrl = new grid_imagentitulacion_export_control;
$ExportCtrl->Export_barr();

class grid_imagentitulacion_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> imagentitulacion</TITLE>
