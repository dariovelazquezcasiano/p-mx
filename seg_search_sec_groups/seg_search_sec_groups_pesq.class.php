...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_search_sec_groups']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_search_sec_groups']['orig_pesq'] == "grid")
   {
