<?php
//
class control_formtarifa_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->FechaInicial) && isset($this->fechainicial)) 
          {
              $this->FechaInicial = $this->fechainicial;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_formtarifa_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['control_formtarifa_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_formtarifa_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_formtarifa_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_formtarifa_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_formtarifa_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_formtarifa_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_formtarifa_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['control_formtarifa_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_formtarifa_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_formtarifa_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_formtarifa_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_formtarifa_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_formtarifa_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_formtarifa_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'control_formtarifa/control_formtarifa_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_formtarifa_mob_erro.class.php"); 
      }
      $this->Erro      = new control_formtarifa_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_formtarifa_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['control_formtarifa_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['control_formtarifa_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->estatusc8 = "" ;  
          $this->estatusc9 = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos']))
              { 
                  $a = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][0]; 
                  $importea = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][1]; 
                  $importeela = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][2]; 
                  $importeepa = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][3]; 
                  $estatusa = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][4]; 
                  $m = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][5]; 
                  $importem = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][6]; 
                  $importeelm = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][7]; 
                  $importeepm = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][8]; 
                  $estatusm = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][9]; 
                  $b2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][10]; 
                  $importeb2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][11]; 
                  $importeelb2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][12]; 
                  $importeepb2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][13]; 
                  $estatusb2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][14]; 
                  $b3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][15]; 
                  $importeb3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][16]; 
                  $importeelb3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][17]; 
                  $importeepb3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][18]; 
                  $estatusb3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][19]; 
                  $b4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][20]; 
                  $importeb4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][21]; 
                  $importeelb4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][22]; 
                  $importeepb4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][23]; 
                  $estatusb4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][24]; 
                  $c2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][25]; 
                  $importec2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][26]; 
                  $importeelc2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][27]; 
                  $importeepc2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][28]; 
                  $estatusc2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][29]; 
                  $c3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][30]; 
                  $importec3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][31]; 
                  $importeelc3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][32]; 
                  $importeepc3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][33]; 
                  $estatusc3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][34]; 
                  $c4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][35]; 
                  $importec4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][36]; 
                  $importeelc4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][37]; 
                  $importeepc4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][38]; 
                  $estatusc4 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][39]; 
                  $c5 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][40]; 
                  $importec5 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][41]; 
                  $importeelc5 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][42]; 
                  $importeepc5 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][43]; 
                  $estatusc5 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][44]; 
                  $c6 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][45]; 
                  $importec6 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][46]; 
                  $importeelc6 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][47]; 
                  $importeepc6 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][48]; 
                  $estatusc6 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][49]; 
                  $c7 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][50]; 
                  $importec7 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][51]; 
                  $importeelc7 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][52]; 
                  $importeepc7 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][53]; 
                  $estatusc7 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][54]; 
                  $c8 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][55]; 
                  $importeelc8 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][56]; 
                  $importec8 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][57]; 
                  $importeepc8 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][58]; 
                  $estatusc8 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][59]; 
                  $c9 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][60]; 
                  $importec9 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][61]; 
                  $importeelc9 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][62]; 
                  $importeepc9 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][63]; 
                  $estatusc9 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][64]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][0] = $this->a; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][1] = $this->importea; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][2] = $this->importeela; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][3] = $this->importeepa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][4] = $this->estatusa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][5] = $this->m; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][6] = $this->importem; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][7] = $this->importeelm; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][8] = $this->importeepm; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][9] = $this->estatusm; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][10] = $this->b2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][11] = $this->importeb2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][12] = $this->importeelb2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][13] = $this->importeepb2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][14] = $this->estatusb2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][15] = $this->b3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][16] = $this->importeb3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][17] = $this->importeelb3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][18] = $this->importeepb3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][19] = $this->estatusb3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][20] = $this->b4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][21] = $this->importeb4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][22] = $this->importeelb4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][23] = $this->importeepb4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][24] = $this->estatusb4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][25] = $this->c2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][26] = $this->importec2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][27] = $this->importeelc2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][28] = $this->importeepc2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][29] = $this->estatusc2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][30] = $this->c3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][31] = $this->importec3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][32] = $this->importeelc3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][33] = $this->importeepc3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][34] = $this->estatusc3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][35] = $this->c4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][36] = $this->importec4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][37] = $this->importeelc4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][38] = $this->importeepc4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][39] = $this->estatusc4; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][40] = $this->c5; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][41] = $this->importec5; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][42] = $this->importeelc5; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][43] = $this->importeepc5; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][44] = $this->estatusc5; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][45] = $this->c6; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][46] = $this->importec6; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][47] = $this->importeelc6; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][48] = $this->importeepc6; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][49] = $this->estatusc6; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][50] = $this->c7; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][51] = $this->importec7; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][52] = $this->importeelc7; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][53] = $this->importeepc7; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][54] = $this->estatusc7; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][55] = $this->c8; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][56] = $this->importeelc8; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][57] = $this->importec8; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][58] = $this->importeepc8; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][59] = $this->estatusc8; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][60] = $this->c9; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][61] = $this->importec9; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][62] = $this->importeelc9; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][63] = $this->importeepc9; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['campos'][64] = $this->estatusc9; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_formtarifa_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_formtarifa_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_formtarifa_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="control_formtarifa_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_formtarifa_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="control_formtarifa_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_formtarifa_mob']) || !is_array($this->NM_ajax_info['errList']['geral_control_formtarifa_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_control_formtarifa_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_formtarifa_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['control_formtarifa_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['control_formtarifa_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_importea(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importea']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importea'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_importeela(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeela']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeela'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_importeepa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepa'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_estatusa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusa'] == "on")
        { 
          $hasError = true;
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusa']) && !in_array($this->estatusa, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusa']))
          {
              $hasError = true;
    ...
    function ValidateField_importem(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importem']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importem'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importem']))
    ...
    function ValidateField_importeelm(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelm'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelm']))
    ...
    function ValidateField_importeepm(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepm'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepm']))
    ...
    function ValidateField_estatusm(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusm'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusm']) && !in_array($this->estatusm, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusm']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusm']))
    ...
    function ValidateField_importeb2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeb2'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importeb2']))
    ...
    function ValidateField_importeelb2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelb2'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelb2']))
    ...
    function ValidateField_importeepb2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepb2'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepb2']))
    ...
    function ValidateField_estatusb2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusb2'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb2']) && !in_array($this->estatusb2, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb2']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusb2']))
    ...
    function ValidateField_importeb3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeb3'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importeb3']))
    ...
    function ValidateField_importeelb3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelb3'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelb3']))
    ...
    function ValidateField_importeepb3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepb3'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepb3']))
    ...
    function ValidateField_estatusb3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusb3'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb3']) && !in_array($this->estatusb3, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb3']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusb3']))
    ...
    function ValidateField_importeb4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeb4'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importeb4']))
    ...
    function ValidateField_importeelb4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelb4'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelb4']))
    ...
    function ValidateField_importeepb4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepb4'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepb4']))
    ...
    function ValidateField_estatusb4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusb4'] == "on")
        { 
          $hasError = true;
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb4']) && !in_array($this->estatusb4, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb4']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusb4']))
    ...
    function ValidateField_importec2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec2'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importec2']))
    ...
    function ValidateField_importeelc2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc2'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelc2']))
    ...
    function ValidateField_importeepc2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc2'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc2']))
    ...
    function ValidateField_estatusc2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc2'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc2']) && !in_array($this->estatusc2, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc2']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc2']))
    ...
    function ValidateField_importec3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec3'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importec3']))
    ...
    function ValidateField_importeelc3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc3'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelc3']))
    ...
    function ValidateField_importeepc3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc3'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc3']))
    ...
    function ValidateField_estatusc3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc3'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc3']) && !in_array($this->estatusc3, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc3']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc3']))
    ...
    function ValidateField_importec4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec4'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importec4']))
    ...
    function ValidateField_importeelc4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc4'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelc4']))
    ...
    function ValidateField_importeepc4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc4'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc4']))
    ...
    function ValidateField_estatusc4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc4'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc4']) && !in_array($this->estatusc4, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc4']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc4']))
    ...
    function ValidateField_importec5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec5'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importec5']))
    ...
    function ValidateField_importeelc5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc5'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelc5']))
    ...
    function ValidateField_importeepc5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc5'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc5']))
    ...
    function ValidateField_estatusc5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc5'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc5']) && !in_array($this->estatusc5, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc5']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc5']))
    ...
    function ValidateField_importec6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec6'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importec6']))
    ...
    function ValidateField_importeelc6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc6'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelc6']))
    ...
    function ValidateField_importeepc6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc6'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc6']))
    ...
    function ValidateField_estatusc6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc6'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc6']) && !in_array($this->estatusc6, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc6']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc6']))
    ...
    function ValidateField_importec7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec7'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importec7']))
    ...
    function ValidateField_importeelc7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc7'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelc7']))
    ...
    function ValidateField_importeepc7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc7'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc7']))
    ...
    function ValidateField_estatusc7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc7'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc7']) && !in_array($this->estatusc7, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc7']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc7']))
    ...
    function ValidateField_importeelc8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc8'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importeelc8']))
    ...
    function ValidateField_importec8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec8'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importec8']))
    ...
    function ValidateField_importeepc8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc8'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc8']))
    ...
    function ValidateField_estatusc8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc8'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc8']) && !in_array($this->estatusc8, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc8']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc8']))
    ...
    function ValidateField_importec9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importec9'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe" ; 
              if (!isset($Campos_Erros['importec9']))
    ...
    function ValidateField_importeelc9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeelc9'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEL" ; 
              if (!isset($Campos_Erros['importeelc9']))
    ...
    function ValidateField_importeepc9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['importeepc9'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Importe EEP" ; 
              if (!isset($Campos_Erros['importeepc9']))
    ...
    function ValidateField_estatusc9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['php_cmp_required']['estatusc9'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estatus" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc9']) && !in_array($this->estatusc9, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc9']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['estatusc9']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusa'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusa'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusa']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusm'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusm'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusm']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb2'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb2'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusb2']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb3'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb3'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusb3']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb4'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusb4'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusb4']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc2'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc2'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc2']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc3'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc3'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc3']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc4'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc4'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc4']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc5'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc5'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc5']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc6'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc6'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc6']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc7'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc7'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc7']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc8'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc8'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc8']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('1') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Activo")));
$aLookup[] = array(control_formtarifa_mob_pack_protect_string('0') => str_replace('<', '&lt;',control_formtarifa_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc9'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['Lookup_estatusc9'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatusc9']['valList'][$i] = control_formtarifa_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("control_formtarifa_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "control_formtarifa_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_formtarifa_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa_mob']['ordem_ord'] == " desc") {
