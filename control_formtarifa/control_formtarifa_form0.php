...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_formtarifa/control_formtarifa_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_formtarifa_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_formtarifa_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['link_info']['remove_border']) {
...
<?php
 include_once("control_formtarifa_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_formtarifa'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_formtarifa'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_a_label" id="hidden_field_label_a" style="<?php echo $sStyleHidden_a; ?>"><span id="id_label_a"><?php echo $this->nm_new_label['a']; ?></span></TD>
    <TD class="scFormDataOdd css_a_line" id="hidden_field_data_a" style="<?php echo $sStyleHidden_a; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importea_label" id="hidden_field_label_importea" style="<?php echo $sStyleHidden_importea; ?>"><span id="id_label_importea"><?php echo $this->nm_new_label['importea']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importea']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importea'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importea_line" id="hidden_field_data_importea" style="<?php echo $sStyleHidden_importea; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeela_label" id="hidden_field_label_importeela" style="<?php echo $sStyleHidden_importeela; ?>"><span id="id_label_importeela"><?php echo $this->nm_new_label['importeela']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeela']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeela'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeela_line" id="hidden_field_data_importeela" style="<?php echo $sStyleHidden_importeela; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepa_label" id="hidden_field_label_importeepa" style="<?php echo $sStyleHidden_importeepa; ?>"><span id="id_label_importeepa"><?php echo $this->nm_new_label['importeepa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepa_line" id="hidden_field_data_importeepa" style="<?php echo $sStyleHidden_importeepa; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusa_label" id="hidden_field_label_estatusa" style="<?php echo $sStyleHidden_estatusa; ?>"><span id="id_label_estatusa"><?php echo $this->nm_new_label['estatusa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusa_line" id="hidden_field_data_estatusa" style="<?php echo $sStyleHidden_estatusa; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusa'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusa'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_m_label" id="hidden_field_label_m" style="<?php echo $sStyleHidden_m; ?>"><span id="id_label_m"><?php echo $this->nm_new_label['m']; ?></span></TD>
    <TD class="scFormDataOdd css_m_line" id="hidden_field_data_m" style="<?php echo $sStyleHidden_m; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importem_label" id="hidden_field_label_importem" style="<?php echo $sStyleHidden_importem; ?>"><span id="id_label_importem"><?php echo $this->nm_new_label['importem']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importem']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importem'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importem_line" id="hidden_field_data_importem" style="<?php echo $sStyleHidden_importem; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelm_label" id="hidden_field_label_importeelm" style="<?php echo $sStyleHidden_importeelm; ?>"><span id="id_label_importeelm"><?php echo $this->nm_new_label['importeelm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelm_line" id="hidden_field_data_importeelm" style="<?php echo $sStyleHidden_importeelm; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepm_label" id="hidden_field_label_importeepm" style="<?php echo $sStyleHidden_importeepm; ?>"><span id="id_label_importeepm"><?php echo $this->nm_new_label['importeepm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepm_line" id="hidden_field_data_importeepm" style="<?php echo $sStyleHidden_importeepm; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusm_label" id="hidden_field_label_estatusm" style="<?php echo $sStyleHidden_estatusm; ?>"><span id="id_label_estatusm"><?php echo $this->nm_new_label['estatusm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusm'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusm'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_b2_label" id="hidden_field_label_b2" style="<?php echo $sStyleHidden_b2; ?>"><span id="id_label_b2"><?php echo $this->nm_new_label['b2']; ?></span></TD>
    <TD class="scFormDataOdd css_b2_line" id="hidden_field_data_b2" style="<?php echo $sStyleHidden_b2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeb2_label" id="hidden_field_label_importeb2" style="<?php echo $sStyleHidden_importeb2; ?>"><span id="id_label_importeb2"><?php echo $this->nm_new_label['importeb2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeb2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeb2_line" id="hidden_field_data_importeb2" style="<?php echo $sStyleHidden_importeb2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelb2_label" id="hidden_field_label_importeelb2" style="<?php echo $sStyleHidden_importeelb2; ?>"><span id="id_label_importeelb2"><?php echo $this->nm_new_label['importeelb2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelb2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelb2_line" id="hidden_field_data_importeelb2" style="<?php echo $sStyleHidden_importeelb2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepb2_label" id="hidden_field_label_importeepb2" style="<?php echo $sStyleHidden_importeepb2; ?>"><span id="id_label_importeepb2"><?php echo $this->nm_new_label['importeepb2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepb2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepb2_line" id="hidden_field_data_importeepb2" style="<?php echo $sStyleHidden_importeepb2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusb2_label" id="hidden_field_label_estatusb2" style="<?php echo $sStyleHidden_estatusb2; ?>"><span id="id_label_estatusb2"><?php echo $this->nm_new_label['estatusb2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusb2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusb2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusb2_line" id="hidden_field_data_estatusb2" style="<?php echo $sStyleHidden_estatusb2; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusb2'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusb2'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_b3_label" id="hidden_field_label_b3" style="<?php echo $sStyleHidden_b3; ?>"><span id="id_label_b3"><?php echo $this->nm_new_label['b3']; ?></span></TD>
    <TD class="scFormDataOdd css_b3_line" id="hidden_field_data_b3" style="<?php echo $sStyleHidden_b3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeb3_label" id="hidden_field_label_importeb3" style="<?php echo $sStyleHidden_importeb3; ?>"><span id="id_label_importeb3"><?php echo $this->nm_new_label['importeb3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeb3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeb3_line" id="hidden_field_data_importeb3" style="<?php echo $sStyleHidden_importeb3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelb3_label" id="hidden_field_label_importeelb3" style="<?php echo $sStyleHidden_importeelb3; ?>"><span id="id_label_importeelb3"><?php echo $this->nm_new_label['importeelb3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelb3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelb3_line" id="hidden_field_data_importeelb3" style="<?php echo $sStyleHidden_importeelb3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepb3_label" id="hidden_field_label_importeepb3" style="<?php echo $sStyleHidden_importeepb3; ?>"><span id="id_label_importeepb3"><?php echo $this->nm_new_label['importeepb3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepb3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepb3_line" id="hidden_field_data_importeepb3" style="<?php echo $sStyleHidden_importeepb3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusb3_label" id="hidden_field_label_estatusb3" style="<?php echo $sStyleHidden_estatusb3; ?>"><span id="id_label_estatusb3"><?php echo $this->nm_new_label['estatusb3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusb3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusb3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusb3_line" id="hidden_field_data_estatusb3" style="<?php echo $sStyleHidden_estatusb3; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusb3'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusb3'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_b4_label" id="hidden_field_label_b4" style="<?php echo $sStyleHidden_b4; ?>"><span id="id_label_b4"><?php echo $this->nm_new_label['b4']; ?></span></TD>
    <TD class="scFormDataOdd css_b4_line" id="hidden_field_data_b4" style="<?php echo $sStyleHidden_b4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeb4_label" id="hidden_field_label_importeb4" style="<?php echo $sStyleHidden_importeb4; ?>"><span id="id_label_importeb4"><?php echo $this->nm_new_label['importeb4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeb4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelb4_label" id="hidden_field_label_importeelb4" style="<?php echo $sStyleHidden_importeelb4; ?>"><span id="id_label_importeelb4"><?php echo $this->nm_new_label['importeelb4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelb4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelb4_line" id="hidden_field_data_importeelb4" style="<?php echo $sStyleHidden_importeelb4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepb4_label" id="hidden_field_label_importeepb4" style="<?php echo $sStyleHidden_importeepb4; ?>"><span id="id_label_importeepb4"><?php echo $this->nm_new_label['importeepb4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepb4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepb4_line" id="hidden_field_data_importeepb4" style="<?php echo $sStyleHidden_importeepb4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusb4_label" id="hidden_field_label_estatusb4" style="<?php echo $sStyleHidden_estatusb4; ?>"><span id="id_label_estatusb4"><?php echo $this->nm_new_label['estatusb4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusb4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusb4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusb4_line" id="hidden_field_data_estatusb4" style="<?php echo $sStyleHidden_estatusb4; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusb4'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusb4'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c2_label" id="hidden_field_label_c2" style="<?php echo $sStyleHidden_c2; ?>"><span id="id_label_c2"><?php echo $this->nm_new_label['c2']; ?></span></TD>
    <TD class="scFormDataOdd css_c2_line" id="hidden_field_data_c2" style="<?php echo $sStyleHidden_c2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec2_label" id="hidden_field_label_importec2" style="<?php echo $sStyleHidden_importec2; ?>"><span id="id_label_importec2"><?php echo $this->nm_new_label['importec2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec2_line" id="hidden_field_data_importec2" style="<?php echo $sStyleHidden_importec2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc2_label" id="hidden_field_label_importeelc2" style="<?php echo $sStyleHidden_importeelc2; ?>"><span id="id_label_importeelc2"><?php echo $this->nm_new_label['importeelc2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelc2_line" id="hidden_field_data_importeelc2" style="<?php echo $sStyleHidden_importeelc2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc2_label" id="hidden_field_label_importeepc2" style="<?php echo $sStyleHidden_importeepc2; ?>"><span id="id_label_importeepc2"><?php echo $this->nm_new_label['importeepc2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc2_line" id="hidden_field_data_importeepc2" style="<?php echo $sStyleHidden_importeepc2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc2_label" id="hidden_field_label_estatusc2" style="<?php echo $sStyleHidden_estatusc2; ?>"><span id="id_label_estatusc2"><?php echo $this->nm_new_label['estatusc2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusc2_line" id="hidden_field_data_estatusc2" style="<?php echo $sStyleHidden_estatusc2; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc2'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc2'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c3_label" id="hidden_field_label_c3" style="<?php echo $sStyleHidden_c3; ?>"><span id="id_label_c3"><?php echo $this->nm_new_label['c3']; ?></span></TD>
    <TD class="scFormDataOdd css_c3_line" id="hidden_field_data_c3" style="<?php echo $sStyleHidden_c3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec3_label" id="hidden_field_label_importec3" style="<?php echo $sStyleHidden_importec3; ?>"><span id="id_label_importec3"><?php echo $this->nm_new_label['importec3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec3_line" id="hidden_field_data_importec3" style="<?php echo $sStyleHidden_importec3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc3_label" id="hidden_field_label_importeelc3" style="<?php echo $sStyleHidden_importeelc3; ?>"><span id="id_label_importeelc3"><?php echo $this->nm_new_label['importeelc3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelc3_line" id="hidden_field_data_importeelc3" style="<?php echo $sStyleHidden_importeelc3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc3_label" id="hidden_field_label_importeepc3" style="<?php echo $sStyleHidden_importeepc3; ?>"><span id="id_label_importeepc3"><?php echo $this->nm_new_label['importeepc3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc3_line" id="hidden_field_data_importeepc3" style="<?php echo $sStyleHidden_importeepc3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc3_label" id="hidden_field_label_estatusc3" style="<?php echo $sStyleHidden_estatusc3; ?>"><span id="id_label_estatusc3"><?php echo $this->nm_new_label['estatusc3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc3'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc3'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c4_label" id="hidden_field_label_c4" style="<?php echo $sStyleHidden_c4; ?>"><span id="id_label_c4"><?php echo $this->nm_new_label['c4']; ?></span></TD>
    <TD class="scFormDataOdd css_c4_line" id="hidden_field_data_c4" style="<?php echo $sStyleHidden_c4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec4_label" id="hidden_field_label_importec4" style="<?php echo $sStyleHidden_importec4; ?>"><span id="id_label_importec4"><?php echo $this->nm_new_label['importec4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec4_line" id="hidden_field_data_importec4" style="<?php echo $sStyleHidden_importec4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc4_label" id="hidden_field_label_importeelc4" style="<?php echo $sStyleHidden_importeelc4; ?>"><span id="id_label_importeelc4"><?php echo $this->nm_new_label['importeelc4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelc4_line" id="hidden_field_data_importeelc4" style="<?php echo $sStyleHidden_importeelc4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc4_label" id="hidden_field_label_importeepc4" style="<?php echo $sStyleHidden_importeepc4; ?>"><span id="id_label_importeepc4"><?php echo $this->nm_new_label['importeepc4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc4_line" id="hidden_field_data_importeepc4" style="<?php echo $sStyleHidden_importeepc4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc4_label" id="hidden_field_label_estatusc4" style="<?php echo $sStyleHidden_estatusc4; ?>"><span id="id_label_estatusc4"><?php echo $this->nm_new_label['estatusc4']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc4'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusc4_line" id="hidden_field_data_estatusc4" style="<?php echo $sStyleHidden_estatusc4; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc4'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc4'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c5_label" id="hidden_field_label_c5" style="<?php echo $sStyleHidden_c5; ?>"><span id="id_label_c5"><?php echo $this->nm_new_label['c5']; ?></span></TD>
    <TD class="scFormDataOdd css_c5_line" id="hidden_field_data_c5" style="<?php echo $sStyleHidden_c5; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec5_label" id="hidden_field_label_importec5" style="<?php echo $sStyleHidden_importec5; ?>"><span id="id_label_importec5"><?php echo $this->nm_new_label['importec5']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec5'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec5_line" id="hidden_field_data_importec5" style="<?php echo $sStyleHidden_importec5; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc5_label" id="hidden_field_label_importeelc5" style="<?php echo $sStyleHidden_importeelc5; ?>"><span id="id_label_importeelc5"><?php echo $this->nm_new_label['importeelc5']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc5'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc5_label" id="hidden_field_label_importeepc5" style="<?php echo $sStyleHidden_importeepc5; ?>"><span id="id_label_importeepc5"><?php echo $this->nm_new_label['importeepc5']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc5'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc5_line" id="hidden_field_data_importeepc5" style="<?php echo $sStyleHidden_importeepc5; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc5_label" id="hidden_field_label_estatusc5" style="<?php echo $sStyleHidden_estatusc5; ?>"><span id="id_label_estatusc5"><?php echo $this->nm_new_label['estatusc5']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc5'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusc5_line" id="hidden_field_data_estatusc5" style="<?php echo $sStyleHidden_estatusc5; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc5'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc5'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c6_label" id="hidden_field_label_c6" style="<?php echo $sStyleHidden_c6; ?>"><span id="id_label_c6"><?php echo $this->nm_new_label['c6']; ?></span></TD>
    <TD class="scFormDataOdd css_c6_line" id="hidden_field_data_c6" style="<?php echo $sStyleHidden_c6; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec6_label" id="hidden_field_label_importec6" style="<?php echo $sStyleHidden_importec6; ?>"><span id="id_label_importec6"><?php echo $this->nm_new_label['importec6']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec6'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec6_line" id="hidden_field_data_importec6" style="<?php echo $sStyleHidden_importec6; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc6_label" id="hidden_field_label_importeelc6" style="<?php echo $sStyleHidden_importeelc6; ?>"><span id="id_label_importeelc6"><?php echo $this->nm_new_label['importeelc6']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc6'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelc6_line" id="hidden_field_data_importeelc6" style="<?php echo $sStyleHidden_importeelc6; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc6_label" id="hidden_field_label_importeepc6" style="<?php echo $sStyleHidden_importeepc6; ?>"><span id="id_label_importeepc6"><?php echo $this->nm_new_label['importeepc6']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc6'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc6_line" id="hidden_field_data_importeepc6" style="<?php echo $sStyleHidden_importeepc6; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc6_label" id="hidden_field_label_estatusc6" style="<?php echo $sStyleHidden_estatusc6; ?>"><span id="id_label_estatusc6"><?php echo $this->nm_new_label['estatusc6']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc6'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusc6_line" id="hidden_field_data_estatusc6" style="<?php echo $sStyleHidden_estatusc6; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc6'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc6'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c7_label" id="hidden_field_label_c7" style="<?php echo $sStyleHidden_c7; ?>"><span id="id_label_c7"><?php echo $this->nm_new_label['c7']; ?></span></TD>
    <TD class="scFormDataOdd css_c7_line" id="hidden_field_data_c7" style="<?php echo $sStyleHidden_c7; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec7_label" id="hidden_field_label_importec7" style="<?php echo $sStyleHidden_importec7; ?>"><span id="id_label_importec7"><?php echo $this->nm_new_label['importec7']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec7'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec7_line" id="hidden_field_data_importec7" style="<?php echo $sStyleHidden_importec7; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc7_label" id="hidden_field_label_importeelc7" style="<?php echo $sStyleHidden_importeelc7; ?>"><span id="id_label_importeelc7"><?php echo $this->nm_new_label['importeelc7']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc7'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelc7_line" id="hidden_field_data_importeelc7" style="<?php echo $sStyleHidden_importeelc7; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc7_label" id="hidden_field_label_importeepc7" style="<?php echo $sStyleHidden_importeepc7; ?>"><span id="id_label_importeepc7"><?php echo $this->nm_new_label['importeepc7']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc7'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc7_line" id="hidden_field_data_importeepc7" style="<?php echo $sStyleHidden_importeepc7; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc7_label" id="hidden_field_label_estatusc7" style="<?php echo $sStyleHidden_estatusc7; ?>"><span id="id_label_estatusc7"><?php echo $this->nm_new_label['estatusc7']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc7'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusc7_line" id="hidden_field_data_estatusc7" style="<?php echo $sStyleHidden_estatusc7; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc7'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc7'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c8_label" id="hidden_field_label_c8" style="<?php echo $sStyleHidden_c8; ?>"><span id="id_label_c8"><?php echo $this->nm_new_label['c8']; ?></span></TD>
    <TD class="scFormDataOdd css_c8_line" id="hidden_field_data_c8" style="<?php echo $sStyleHidden_c8; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc8_label" id="hidden_field_label_importeelc8" style="<?php echo $sStyleHidden_importeelc8; ?>"><span id="id_label_importeelc8"><?php echo $this->nm_new_label['importeelc8']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc8'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelc8_line" id="hidden_field_data_importeelc8" style="<?php echo $sStyleHidden_importeelc8; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec8_label" id="hidden_field_label_importec8" style="<?php echo $sStyleHidden_importec8; ?>"><span id="id_label_importec8"><?php echo $this->nm_new_label['importec8']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec8'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec8_line" id="hidden_field_data_importec8" style="<?php echo $sStyleHidden_importec8; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc8_label" id="hidden_field_label_importeepc8" style="<?php echo $sStyleHidden_importeepc8; ?>"><span id="id_label_importeepc8"><?php echo $this->nm_new_label['importeepc8']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc8'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc8_line" id="hidden_field_data_importeepc8" style="<?php echo $sStyleHidden_importeepc8; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc8_label" id="hidden_field_label_estatusc8" style="<?php echo $sStyleHidden_estatusc8; ?>"><span id="id_label_estatusc8"><?php echo $this->nm_new_label['estatusc8']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc8'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusc8_line" id="hidden_field_data_estatusc8" style="<?php echo $sStyleHidden_estatusc8; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc8'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc8'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_c9_label" id="hidden_field_label_c9" style="<?php echo $sStyleHidden_c9; ?>"><span id="id_label_c9"><?php echo $this->nm_new_label['c9']; ?></span></TD>
    <TD class="scFormDataOdd css_c9_line" id="hidden_field_data_c9" style="<?php echo $sStyleHidden_c9; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importec9_label" id="hidden_field_label_importec9" style="<?php echo $sStyleHidden_importec9; ?>"><span id="id_label_importec9"><?php echo $this->nm_new_label['importec9']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importec9'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importec9_line" id="hidden_field_data_importec9" style="<?php echo $sStyleHidden_importec9; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeelc9_label" id="hidden_field_label_importeelc9" style="<?php echo $sStyleHidden_importeelc9; ?>"><span id="id_label_importeelc9"><?php echo $this->nm_new_label['importeelc9']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeelc9'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeelc9_line" id="hidden_field_data_importeelc9" style="<?php echo $sStyleHidden_importeelc9; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importeepc9_label" id="hidden_field_label_importeepc9" style="<?php echo $sStyleHidden_importeepc9; ?>"><span id="id_label_importeepc9"><?php echo $this->nm_new_label['importeepc9']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['importeepc9'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_importeepc9_line" id="hidden_field_data_importeepc9" style="<?php echo $sStyleHidden_importeepc9; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatusc9_label" id="hidden_field_label_estatusc9" style="<?php echo $sStyleHidden_estatusc9; ?>"><span id="id_label_estatusc9"><?php echo $this->nm_new_label['estatusc9']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['php_cmp_required']['estatusc9'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatusc9_line" id="hidden_field_data_estatusc9" style="<?php echo $sStyleHidden_estatusc9; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc9'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['Lookup_estatusc9'][] = '0'; ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_formtarifa");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_formtarifa");
 parent.scAjaxDetailHeight("control_formtarifa", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
