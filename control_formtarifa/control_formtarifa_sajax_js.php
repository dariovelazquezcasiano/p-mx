  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_formtarifa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_formtarifa_form();
	}
...
?>
  ...
  // ---------- Validate a
  function do_ajax_control_formtarifa_validate_a()
  {
    var nomeCampo_a = "a";
    var var_a = scAjaxGetFieldText(nomeCampo_a);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_a(var_a, var_script_case_init, do_ajax_control_formtarifa_validate_a_cb);
  } // do_ajax_control_formtarifa_validate_a

  function do_ajax_control_formtarifa_validate_a_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_a_cb

  // ---------- Validate importea
  function do_ajax_control_formtarifa_validate_importea()
  {
    var nomeCampo_importea = "importea";
    var var_importea = scAjaxGetFieldText(nomeCampo_importea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importea(var_importea, var_script_case_init, do_ajax_control_formtarifa_validate_importea_cb);
  } // do_ajax_control_formtarifa_validate_importea

  function do_ajax_control_formtarifa_validate_importea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importea_cb

  // ---------- Validate importeela
  function do_ajax_control_formtarifa_validate_importeela()
  {
    var nomeCampo_importeela = "importeela";
    var var_importeela = scAjaxGetFieldText(nomeCampo_importeela);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeela(var_importeela, var_script_case_init, do_ajax_control_formtarifa_validate_importeela_cb);
  } // do_ajax_control_formtarifa_validate_importeela

  function do_ajax_control_formtarifa_validate_importeela_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeela_cb

  // ---------- Validate importeepa
  function do_ajax_control_formtarifa_validate_importeepa()
  {
    var nomeCampo_importeepa = "importeepa";
    var var_importeepa = scAjaxGetFieldText(nomeCampo_importeepa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepa(var_importeepa, var_script_case_init, do_ajax_control_formtarifa_validate_importeepa_cb);
  } // do_ajax_control_formtarifa_validate_importeepa

  function do_ajax_control_formtarifa_validate_importeepa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepa_cb

  // ---------- Validate estatusa
  function do_ajax_control_formtarifa_validate_estatusa()
  {
    var nomeCampo_estatusa = "estatusa";
    var var_estatusa = scAjaxGetFieldRadio(nomeCampo_estatusa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusa(var_estatusa, var_script_case_init, do_ajax_control_formtarifa_validate_estatusa_cb);
  } // do_ajax_control_formtarifa_validate_estatusa

  function do_ajax_control_formtarifa_validate_estatusa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusa_cb

  // ---------- Validate m
  function do_ajax_control_formtarifa_validate_m()
  {
    var nomeCampo_m = "m";
    var var_m = scAjaxGetFieldText(nomeCampo_m);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_m(var_m, var_script_case_init, do_ajax_control_formtarifa_validate_m_cb);
  } // do_ajax_control_formtarifa_validate_m

  function do_ajax_control_formtarifa_validate_m_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "m";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_m_cb

  // ---------- Validate importem
  function do_ajax_control_formtarifa_validate_importem()
  {
    var nomeCampo_importem = "importem";
    var var_importem = scAjaxGetFieldText(nomeCampo_importem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importem(var_importem, var_script_case_init, do_ajax_control_formtarifa_validate_importem_cb);
  } // do_ajax_control_formtarifa_validate_importem

  function do_ajax_control_formtarifa_validate_importem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importem_cb

  // ---------- Validate importeelm
  function do_ajax_control_formtarifa_validate_importeelm()
  {
    var nomeCampo_importeelm = "importeelm";
    var var_importeelm = scAjaxGetFieldText(nomeCampo_importeelm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelm(var_importeelm, var_script_case_init, do_ajax_control_formtarifa_validate_importeelm_cb);
  } // do_ajax_control_formtarifa_validate_importeelm

  function do_ajax_control_formtarifa_validate_importeelm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelm_cb

  // ---------- Validate importeepm
  function do_ajax_control_formtarifa_validate_importeepm()
  {
    var nomeCampo_importeepm = "importeepm";
    var var_importeepm = scAjaxGetFieldText(nomeCampo_importeepm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepm(var_importeepm, var_script_case_init, do_ajax_control_formtarifa_validate_importeepm_cb);
  } // do_ajax_control_formtarifa_validate_importeepm

  function do_ajax_control_formtarifa_validate_importeepm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepm_cb

  // ---------- Validate estatusm
  function do_ajax_control_formtarifa_validate_estatusm()
  {
    var nomeCampo_estatusm = "estatusm";
    var var_estatusm = scAjaxGetFieldRadio(nomeCampo_estatusm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusm(var_estatusm, var_script_case_init, do_ajax_control_formtarifa_validate_estatusm_cb);
  } // do_ajax_control_formtarifa_validate_estatusm

  function do_ajax_control_formtarifa_validate_estatusm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusm_cb

  // ---------- Validate b2
  function do_ajax_control_formtarifa_validate_b2()
  {
    var nomeCampo_b2 = "b2";
    var var_b2 = scAjaxGetFieldText(nomeCampo_b2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_b2(var_b2, var_script_case_init, do_ajax_control_formtarifa_validate_b2_cb);
  } // do_ajax_control_formtarifa_validate_b2

  function do_ajax_control_formtarifa_validate_b2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "b2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_b2_cb

  // ---------- Validate importeb2
  function do_ajax_control_formtarifa_validate_importeb2()
  {
    var nomeCampo_importeb2 = "importeb2";
    var var_importeb2 = scAjaxGetFieldText(nomeCampo_importeb2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeb2(var_importeb2, var_script_case_init, do_ajax_control_formtarifa_validate_importeb2_cb);
  } // do_ajax_control_formtarifa_validate_importeb2

  function do_ajax_control_formtarifa_validate_importeb2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeb2_cb

  // ---------- Validate importeelb2
  function do_ajax_control_formtarifa_validate_importeelb2()
  {
    var nomeCampo_importeelb2 = "importeelb2";
    var var_importeelb2 = scAjaxGetFieldText(nomeCampo_importeelb2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelb2(var_importeelb2, var_script_case_init, do_ajax_control_formtarifa_validate_importeelb2_cb);
  } // do_ajax_control_formtarifa_validate_importeelb2

  function do_ajax_control_formtarifa_validate_importeelb2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelb2_cb

  // ---------- Validate importeepb2
  function do_ajax_control_formtarifa_validate_importeepb2()
  {
    var nomeCampo_importeepb2 = "importeepb2";
    var var_importeepb2 = scAjaxGetFieldText(nomeCampo_importeepb2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepb2(var_importeepb2, var_script_case_init, do_ajax_control_formtarifa_validate_importeepb2_cb);
  } // do_ajax_control_formtarifa_validate_importeepb2

  function do_ajax_control_formtarifa_validate_importeepb2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepb2_cb

  // ---------- Validate estatusb2
  function do_ajax_control_formtarifa_validate_estatusb2()
  {
    var nomeCampo_estatusb2 = "estatusb2";
    var var_estatusb2 = scAjaxGetFieldRadio(nomeCampo_estatusb2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusb2(var_estatusb2, var_script_case_init, do_ajax_control_formtarifa_validate_estatusb2_cb);
  } // do_ajax_control_formtarifa_validate_estatusb2

  function do_ajax_control_formtarifa_validate_estatusb2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusb2_cb

  // ---------- Validate b3
  function do_ajax_control_formtarifa_validate_b3()
  {
    var nomeCampo_b3 = "b3";
    var var_b3 = scAjaxGetFieldText(nomeCampo_b3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_b3(var_b3, var_script_case_init, do_ajax_control_formtarifa_validate_b3_cb);
  } // do_ajax_control_formtarifa_validate_b3

  function do_ajax_control_formtarifa_validate_b3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "b3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_b3_cb

  // ---------- Validate importeb3
  function do_ajax_control_formtarifa_validate_importeb3()
  {
    var nomeCampo_importeb3 = "importeb3";
    var var_importeb3 = scAjaxGetFieldText(nomeCampo_importeb3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeb3(var_importeb3, var_script_case_init, do_ajax_control_formtarifa_validate_importeb3_cb);
  } // do_ajax_control_formtarifa_validate_importeb3

  function do_ajax_control_formtarifa_validate_importeb3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeb3_cb

  // ---------- Validate importeelb3
  function do_ajax_control_formtarifa_validate_importeelb3()
  {
    var nomeCampo_importeelb3 = "importeelb3";
    var var_importeelb3 = scAjaxGetFieldText(nomeCampo_importeelb3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelb3(var_importeelb3, var_script_case_init, do_ajax_control_formtarifa_validate_importeelb3_cb);
  } // do_ajax_control_formtarifa_validate_importeelb3

  function do_ajax_control_formtarifa_validate_importeelb3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelb3_cb

  // ---------- Validate importeepb3
  function do_ajax_control_formtarifa_validate_importeepb3()
  {
    var nomeCampo_importeepb3 = "importeepb3";
    var var_importeepb3 = scAjaxGetFieldText(nomeCampo_importeepb3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepb3(var_importeepb3, var_script_case_init, do_ajax_control_formtarifa_validate_importeepb3_cb);
  } // do_ajax_control_formtarifa_validate_importeepb3

  function do_ajax_control_formtarifa_validate_importeepb3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepb3_cb

  // ---------- Validate estatusb3
  function do_ajax_control_formtarifa_validate_estatusb3()
  {
    var nomeCampo_estatusb3 = "estatusb3";
    var var_estatusb3 = scAjaxGetFieldRadio(nomeCampo_estatusb3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusb3(var_estatusb3, var_script_case_init, do_ajax_control_formtarifa_validate_estatusb3_cb);
  } // do_ajax_control_formtarifa_validate_estatusb3

  function do_ajax_control_formtarifa_validate_estatusb3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusb3_cb

  // ---------- Validate b4
  function do_ajax_control_formtarifa_validate_b4()
  {
    var nomeCampo_b4 = "b4";
    var var_b4 = scAjaxGetFieldText(nomeCampo_b4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_b4(var_b4, var_script_case_init, do_ajax_control_formtarifa_validate_b4_cb);
  } // do_ajax_control_formtarifa_validate_b4

  function do_ajax_control_formtarifa_validate_b4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "b4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_b4_cb

  // ---------- Validate importeb4
  function do_ajax_control_formtarifa_validate_importeb4()
  {
    var nomeCampo_importeb4 = "importeb4";
    var var_importeb4 = scAjaxGetFieldText(nomeCampo_importeb4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeb4(var_importeb4, var_script_case_init, do_ajax_control_formtarifa_validate_importeb4_cb);
  } // do_ajax_control_formtarifa_validate_importeb4

  function do_ajax_control_formtarifa_validate_importeb4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeb4_cb

  // ---------- Validate importeelb4
  function do_ajax_control_formtarifa_validate_importeelb4()
  {
    var nomeCampo_importeelb4 = "importeelb4";
    var var_importeelb4 = scAjaxGetFieldText(nomeCampo_importeelb4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelb4(var_importeelb4, var_script_case_init, do_ajax_control_formtarifa_validate_importeelb4_cb);
  } // do_ajax_control_formtarifa_validate_importeelb4

  function do_ajax_control_formtarifa_validate_importeelb4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelb4_cb

  // ---------- Validate importeepb4
  function do_ajax_control_formtarifa_validate_importeepb4()
  {
    var nomeCampo_importeepb4 = "importeepb4";
    var var_importeepb4 = scAjaxGetFieldText(nomeCampo_importeepb4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepb4(var_importeepb4, var_script_case_init, do_ajax_control_formtarifa_validate_importeepb4_cb);
  } // do_ajax_control_formtarifa_validate_importeepb4

  function do_ajax_control_formtarifa_validate_importeepb4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepb4_cb

  // ---------- Validate estatusb4
  function do_ajax_control_formtarifa_validate_estatusb4()
  {
    var nomeCampo_estatusb4 = "estatusb4";
    var var_estatusb4 = scAjaxGetFieldRadio(nomeCampo_estatusb4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusb4(var_estatusb4, var_script_case_init, do_ajax_control_formtarifa_validate_estatusb4_cb);
  } // do_ajax_control_formtarifa_validate_estatusb4

  function do_ajax_control_formtarifa_validate_estatusb4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusb4_cb

  // ---------- Validate c2
  function do_ajax_control_formtarifa_validate_c2()
  {
    var nomeCampo_c2 = "c2";
    var var_c2 = scAjaxGetFieldText(nomeCampo_c2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c2(var_c2, var_script_case_init, do_ajax_control_formtarifa_validate_c2_cb);
  } // do_ajax_control_formtarifa_validate_c2

  function do_ajax_control_formtarifa_validate_c2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c2_cb

  // ---------- Validate importec2
  function do_ajax_control_formtarifa_validate_importec2()
  {
    var nomeCampo_importec2 = "importec2";
    var var_importec2 = scAjaxGetFieldText(nomeCampo_importec2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec2(var_importec2, var_script_case_init, do_ajax_control_formtarifa_validate_importec2_cb);
  } // do_ajax_control_formtarifa_validate_importec2

  function do_ajax_control_formtarifa_validate_importec2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec2_cb

  // ---------- Validate importeelc2
  function do_ajax_control_formtarifa_validate_importeelc2()
  {
    var nomeCampo_importeelc2 = "importeelc2";
    var var_importeelc2 = scAjaxGetFieldText(nomeCampo_importeelc2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc2(var_importeelc2, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc2_cb);
  } // do_ajax_control_formtarifa_validate_importeelc2

  function do_ajax_control_formtarifa_validate_importeelc2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc2_cb

  // ---------- Validate importeepc2
  function do_ajax_control_formtarifa_validate_importeepc2()
  {
    var nomeCampo_importeepc2 = "importeepc2";
    var var_importeepc2 = scAjaxGetFieldText(nomeCampo_importeepc2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc2(var_importeepc2, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc2_cb);
  } // do_ajax_control_formtarifa_validate_importeepc2

  function do_ajax_control_formtarifa_validate_importeepc2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc2_cb

  // ---------- Validate estatusc2
  function do_ajax_control_formtarifa_validate_estatusc2()
  {
    var nomeCampo_estatusc2 = "estatusc2";
    var var_estatusc2 = scAjaxGetFieldRadio(nomeCampo_estatusc2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc2(var_estatusc2, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc2_cb);
  } // do_ajax_control_formtarifa_validate_estatusc2

  function do_ajax_control_formtarifa_validate_estatusc2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc2_cb

  // ---------- Validate c3
  function do_ajax_control_formtarifa_validate_c3()
  {
    var nomeCampo_c3 = "c3";
    var var_c3 = scAjaxGetFieldText(nomeCampo_c3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c3(var_c3, var_script_case_init, do_ajax_control_formtarifa_validate_c3_cb);
  } // do_ajax_control_formtarifa_validate_c3

  function do_ajax_control_formtarifa_validate_c3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c3_cb

  // ---------- Validate importec3
  function do_ajax_control_formtarifa_validate_importec3()
  {
    var nomeCampo_importec3 = "importec3";
    var var_importec3 = scAjaxGetFieldText(nomeCampo_importec3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec3(var_importec3, var_script_case_init, do_ajax_control_formtarifa_validate_importec3_cb);
  } // do_ajax_control_formtarifa_validate_importec3

  function do_ajax_control_formtarifa_validate_importec3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec3_cb

  // ---------- Validate importeelc3
  function do_ajax_control_formtarifa_validate_importeelc3()
  {
    var nomeCampo_importeelc3 = "importeelc3";
    var var_importeelc3 = scAjaxGetFieldText(nomeCampo_importeelc3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc3(var_importeelc3, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc3_cb);
  } // do_ajax_control_formtarifa_validate_importeelc3

  function do_ajax_control_formtarifa_validate_importeelc3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc3_cb

  // ---------- Validate importeepc3
  function do_ajax_control_formtarifa_validate_importeepc3()
  {
    var nomeCampo_importeepc3 = "importeepc3";
    var var_importeepc3 = scAjaxGetFieldText(nomeCampo_importeepc3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc3(var_importeepc3, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc3_cb);
  } // do_ajax_control_formtarifa_validate_importeepc3

  function do_ajax_control_formtarifa_validate_importeepc3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc3_cb

  // ---------- Validate estatusc3
  function do_ajax_control_formtarifa_validate_estatusc3()
  {
    var nomeCampo_estatusc3 = "estatusc3";
    var var_estatusc3 = scAjaxGetFieldRadio(nomeCampo_estatusc3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc3(var_estatusc3, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc3_cb);
  } // do_ajax_control_formtarifa_validate_estatusc3

  function do_ajax_control_formtarifa_validate_estatusc3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc3_cb

  // ---------- Validate c4
  function do_ajax_control_formtarifa_validate_c4()
  {
    var nomeCampo_c4 = "c4";
    var var_c4 = scAjaxGetFieldText(nomeCampo_c4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c4(var_c4, var_script_case_init, do_ajax_control_formtarifa_validate_c4_cb);
  } // do_ajax_control_formtarifa_validate_c4

  function do_ajax_control_formtarifa_validate_c4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c4_cb

  // ---------- Validate importec4
  function do_ajax_control_formtarifa_validate_importec4()
  {
    var nomeCampo_importec4 = "importec4";
    var var_importec4 = scAjaxGetFieldText(nomeCampo_importec4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec4(var_importec4, var_script_case_init, do_ajax_control_formtarifa_validate_importec4_cb);
  } // do_ajax_control_formtarifa_validate_importec4

  function do_ajax_control_formtarifa_validate_importec4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec4_cb

  // ---------- Validate importeelc4
  function do_ajax_control_formtarifa_validate_importeelc4()
  {
    var nomeCampo_importeelc4 = "importeelc4";
    var var_importeelc4 = scAjaxGetFieldText(nomeCampo_importeelc4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc4(var_importeelc4, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc4_cb);
  } // do_ajax_control_formtarifa_validate_importeelc4

  function do_ajax_control_formtarifa_validate_importeelc4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc4_cb

  // ---------- Validate importeepc4
  function do_ajax_control_formtarifa_validate_importeepc4()
  {
    var nomeCampo_importeepc4 = "importeepc4";
    var var_importeepc4 = scAjaxGetFieldText(nomeCampo_importeepc4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc4(var_importeepc4, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc4_cb);
  } // do_ajax_control_formtarifa_validate_importeepc4

  function do_ajax_control_formtarifa_validate_importeepc4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc4_cb

  // ---------- Validate estatusc4
  function do_ajax_control_formtarifa_validate_estatusc4()
  {
    var nomeCampo_estatusc4 = "estatusc4";
    var var_estatusc4 = scAjaxGetFieldRadio(nomeCampo_estatusc4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc4(var_estatusc4, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc4_cb);
  } // do_ajax_control_formtarifa_validate_estatusc4

  function do_ajax_control_formtarifa_validate_estatusc4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc4_cb

  // ---------- Validate c5
  function do_ajax_control_formtarifa_validate_c5()
  {
    var nomeCampo_c5 = "c5";
    var var_c5 = scAjaxGetFieldText(nomeCampo_c5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c5(var_c5, var_script_case_init, do_ajax_control_formtarifa_validate_c5_cb);
  } // do_ajax_control_formtarifa_validate_c5

  function do_ajax_control_formtarifa_validate_c5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c5";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c5_cb

  // ---------- Validate importec5
  function do_ajax_control_formtarifa_validate_importec5()
  {
    var nomeCampo_importec5 = "importec5";
    var var_importec5 = scAjaxGetFieldText(nomeCampo_importec5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec5(var_importec5, var_script_case_init, do_ajax_control_formtarifa_validate_importec5_cb);
  } // do_ajax_control_formtarifa_validate_importec5

  function do_ajax_control_formtarifa_validate_importec5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec5_cb

  // ---------- Validate importeelc5
  function do_ajax_control_formtarifa_validate_importeelc5()
  {
    var nomeCampo_importeelc5 = "importeelc5";
    var var_importeelc5 = scAjaxGetFieldText(nomeCampo_importeelc5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc5(var_importeelc5, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc5_cb);
  } // do_ajax_control_formtarifa_validate_importeelc5

  function do_ajax_control_formtarifa_validate_importeelc5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc5_cb

  // ---------- Validate importeepc5
  function do_ajax_control_formtarifa_validate_importeepc5()
  {
    var nomeCampo_importeepc5 = "importeepc5";
    var var_importeepc5 = scAjaxGetFieldText(nomeCampo_importeepc5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc5(var_importeepc5, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc5_cb);
  } // do_ajax_control_formtarifa_validate_importeepc5

  function do_ajax_control_formtarifa_validate_importeepc5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc5_cb

  // ---------- Validate estatusc5
  function do_ajax_control_formtarifa_validate_estatusc5()
  {
    var nomeCampo_estatusc5 = "estatusc5";
    var var_estatusc5 = scAjaxGetFieldRadio(nomeCampo_estatusc5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc5(var_estatusc5, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc5_cb);
  } // do_ajax_control_formtarifa_validate_estatusc5

  function do_ajax_control_formtarifa_validate_estatusc5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc5_cb

  // ---------- Validate c6
  function do_ajax_control_formtarifa_validate_c6()
  {
    var nomeCampo_c6 = "c6";
    var var_c6 = scAjaxGetFieldText(nomeCampo_c6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c6(var_c6, var_script_case_init, do_ajax_control_formtarifa_validate_c6_cb);
  } // do_ajax_control_formtarifa_validate_c6

  function do_ajax_control_formtarifa_validate_c6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c6";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c6_cb

  // ---------- Validate importec6
  function do_ajax_control_formtarifa_validate_importec6()
  {
    var nomeCampo_importec6 = "importec6";
    var var_importec6 = scAjaxGetFieldText(nomeCampo_importec6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec6(var_importec6, var_script_case_init, do_ajax_control_formtarifa_validate_importec6_cb);
  } // do_ajax_control_formtarifa_validate_importec6

  function do_ajax_control_formtarifa_validate_importec6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec6_cb

  // ---------- Validate importeelc6
  function do_ajax_control_formtarifa_validate_importeelc6()
  {
    var nomeCampo_importeelc6 = "importeelc6";
    var var_importeelc6 = scAjaxGetFieldText(nomeCampo_importeelc6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc6(var_importeelc6, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc6_cb);
  } // do_ajax_control_formtarifa_validate_importeelc6

  function do_ajax_control_formtarifa_validate_importeelc6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc6_cb

  // ---------- Validate importeepc6
  function do_ajax_control_formtarifa_validate_importeepc6()
  {
    var nomeCampo_importeepc6 = "importeepc6";
    var var_importeepc6 = scAjaxGetFieldText(nomeCampo_importeepc6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc6(var_importeepc6, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc6_cb);
  } // do_ajax_control_formtarifa_validate_importeepc6

  function do_ajax_control_formtarifa_validate_importeepc6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc6_cb

  // ---------- Validate estatusc6
  function do_ajax_control_formtarifa_validate_estatusc6()
  {
    var nomeCampo_estatusc6 = "estatusc6";
    var var_estatusc6 = scAjaxGetFieldRadio(nomeCampo_estatusc6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc6(var_estatusc6, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc6_cb);
  } // do_ajax_control_formtarifa_validate_estatusc6

  function do_ajax_control_formtarifa_validate_estatusc6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc6_cb

  // ---------- Validate c7
  function do_ajax_control_formtarifa_validate_c7()
  {
    var nomeCampo_c7 = "c7";
    var var_c7 = scAjaxGetFieldText(nomeCampo_c7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c7(var_c7, var_script_case_init, do_ajax_control_formtarifa_validate_c7_cb);
  } // do_ajax_control_formtarifa_validate_c7

  function do_ajax_control_formtarifa_validate_c7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c7";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c7_cb

  // ---------- Validate importec7
  function do_ajax_control_formtarifa_validate_importec7()
  {
    var nomeCampo_importec7 = "importec7";
    var var_importec7 = scAjaxGetFieldText(nomeCampo_importec7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec7(var_importec7, var_script_case_init, do_ajax_control_formtarifa_validate_importec7_cb);
  } // do_ajax_control_formtarifa_validate_importec7

  function do_ajax_control_formtarifa_validate_importec7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec7_cb

  // ---------- Validate importeelc7
  function do_ajax_control_formtarifa_validate_importeelc7()
  {
    var nomeCampo_importeelc7 = "importeelc7";
    var var_importeelc7 = scAjaxGetFieldText(nomeCampo_importeelc7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc7(var_importeelc7, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc7_cb);
  } // do_ajax_control_formtarifa_validate_importeelc7

  function do_ajax_control_formtarifa_validate_importeelc7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc7_cb

  // ---------- Validate importeepc7
  function do_ajax_control_formtarifa_validate_importeepc7()
  {
    var nomeCampo_importeepc7 = "importeepc7";
    var var_importeepc7 = scAjaxGetFieldText(nomeCampo_importeepc7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc7(var_importeepc7, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc7_cb);
  } // do_ajax_control_formtarifa_validate_importeepc7

  function do_ajax_control_formtarifa_validate_importeepc7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc7_cb

  // ---------- Validate estatusc7
  function do_ajax_control_formtarifa_validate_estatusc7()
  {
    var nomeCampo_estatusc7 = "estatusc7";
    var var_estatusc7 = scAjaxGetFieldRadio(nomeCampo_estatusc7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc7(var_estatusc7, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc7_cb);
  } // do_ajax_control_formtarifa_validate_estatusc7

  function do_ajax_control_formtarifa_validate_estatusc7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc7_cb

  // ---------- Validate c8
  function do_ajax_control_formtarifa_validate_c8()
  {
    var nomeCampo_c8 = "c8";
    var var_c8 = scAjaxGetFieldText(nomeCampo_c8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c8(var_c8, var_script_case_init, do_ajax_control_formtarifa_validate_c8_cb);
  } // do_ajax_control_formtarifa_validate_c8

  function do_ajax_control_formtarifa_validate_c8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c8";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c8_cb

  // ---------- Validate importeelc8
  function do_ajax_control_formtarifa_validate_importeelc8()
  {
    var nomeCampo_importeelc8 = "importeelc8";
    var var_importeelc8 = scAjaxGetFieldText(nomeCampo_importeelc8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc8(var_importeelc8, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc8_cb);
  } // do_ajax_control_formtarifa_validate_importeelc8

  function do_ajax_control_formtarifa_validate_importeelc8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc8_cb

  // ---------- Validate importec8
  function do_ajax_control_formtarifa_validate_importec8()
  {
    var nomeCampo_importec8 = "importec8";
    var var_importec8 = scAjaxGetFieldText(nomeCampo_importec8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec8(var_importec8, var_script_case_init, do_ajax_control_formtarifa_validate_importec8_cb);
  } // do_ajax_control_formtarifa_validate_importec8

  function do_ajax_control_formtarifa_validate_importec8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec8_cb

  // ---------- Validate importeepc8
  function do_ajax_control_formtarifa_validate_importeepc8()
  {
    var nomeCampo_importeepc8 = "importeepc8";
    var var_importeepc8 = scAjaxGetFieldText(nomeCampo_importeepc8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc8(var_importeepc8, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc8_cb);
  } // do_ajax_control_formtarifa_validate_importeepc8

  function do_ajax_control_formtarifa_validate_importeepc8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc8_cb

  // ---------- Validate estatusc8
  function do_ajax_control_formtarifa_validate_estatusc8()
  {
    var nomeCampo_estatusc8 = "estatusc8";
    var var_estatusc8 = scAjaxGetFieldRadio(nomeCampo_estatusc8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc8(var_estatusc8, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc8_cb);
  } // do_ajax_control_formtarifa_validate_estatusc8

  function do_ajax_control_formtarifa_validate_estatusc8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc8_cb

  // ---------- Validate c9
  function do_ajax_control_formtarifa_validate_c9()
  {
    var nomeCampo_c9 = "c9";
    var var_c9 = scAjaxGetFieldText(nomeCampo_c9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_c9(var_c9, var_script_case_init, do_ajax_control_formtarifa_validate_c9_cb);
  } // do_ajax_control_formtarifa_validate_c9

  function do_ajax_control_formtarifa_validate_c9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "c9";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_c9_cb

  // ---------- Validate importec9
  function do_ajax_control_formtarifa_validate_importec9()
  {
    var nomeCampo_importec9 = "importec9";
    var var_importec9 = scAjaxGetFieldText(nomeCampo_importec9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importec9(var_importec9, var_script_case_init, do_ajax_control_formtarifa_validate_importec9_cb);
  } // do_ajax_control_formtarifa_validate_importec9

  function do_ajax_control_formtarifa_validate_importec9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importec9_cb

  // ---------- Validate importeelc9
  function do_ajax_control_formtarifa_validate_importeelc9()
  {
    var nomeCampo_importeelc9 = "importeelc9";
    var var_importeelc9 = scAjaxGetFieldText(nomeCampo_importeelc9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeelc9(var_importeelc9, var_script_case_init, do_ajax_control_formtarifa_validate_importeelc9_cb);
  } // do_ajax_control_formtarifa_validate_importeelc9

  function do_ajax_control_formtarifa_validate_importeelc9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeelc9_cb

  // ---------- Validate importeepc9
  function do_ajax_control_formtarifa_validate_importeepc9()
  {
    var nomeCampo_importeepc9 = "importeepc9";
    var var_importeepc9 = scAjaxGetFieldText(nomeCampo_importeepc9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_importeepc9(var_importeepc9, var_script_case_init, do_ajax_control_formtarifa_validate_importeepc9_cb);
  } // do_ajax_control_formtarifa_validate_importeepc9

  function do_ajax_control_formtarifa_validate_importeepc9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_importeepc9_cb

  // ---------- Validate estatusc9
  function do_ajax_control_formtarifa_validate_estatusc9()
  {
    var nomeCampo_estatusc9 = "estatusc9";
    var var_estatusc9 = scAjaxGetFieldRadio(nomeCampo_estatusc9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_formtarifa_validate_estatusc9(var_estatusc9, var_script_case_init, do_ajax_control_formtarifa_validate_estatusc9_cb);
  } // do_ajax_control_formtarifa_validate_estatusc9

  function do_ajax_control_formtarifa_validate_estatusc9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_formtarifa_validate_estatusc9_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_formtarifa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_formtarifa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_formtarifa_submit_form_cb_after_alert);
  } // do_ajax_control_formtarifa_submit_form_cb
  function do_ajax_control_formtarifa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_formtarifa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_formtarifa_navigate_form()
  {
    perform_ajax_control_formtarifa_navigate_form();
  }

  function perform_ajax_control_formtarifa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_formtarifa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_formtarifa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_formtarifa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_formtarifa_navigate_form_cb_after_alert);
  } // do_ajax_control_formtarifa_navigate_form_cb
  function do_ajax_control_formtarifa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_formtarifa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_formtarifa_navigate_form_cb_after_alert

  function sc_hide_control_formtarifa_form()
  {
