...
class chart_aforo_1_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['chart_aforo_1']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['chart_aforo_1']['campos_busca']))
      { 
