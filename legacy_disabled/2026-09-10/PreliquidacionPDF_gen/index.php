<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class PreliquidacionPDF_gen_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "PreliquidacionPDF_gen"; 
      $this->nm_nome_apl     = "Genera el Archivo PDF de Liquidacion Dia Turno"; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['PreliquidacionPDF_gen']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['PreliquidacionPDF_gen']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/PreliquidacionPDF_gen';
      ...
      $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['actual_lang']) || $_SESSION['scriptcase']['PreliquidacionPDF_gen']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['PreliquidacionPDF_gen']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("PreliquidacionPDF_gen_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["PreliquidacionPDF_gen"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["PreliquidacionPDF_gen"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "PreliquidacionPDF_gen_erro.class.php"); 
      $this->Erro = new PreliquidacionPDF_gen_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('PreliquidacionPDF_gen'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao']) && $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_perfil']) && $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['embutida_init']) 
      {
          if (!isset($_SESSION['FechaOperacionDT'])) 
          {
              $this->nm_falta_var .= "FechaOperacionDT; ";
          }
          if (!isset($_SESSION['TurnoDT'])) 
          {
              $this->nm_falta_var .= "TurnoDT; ";
          }
          if (!isset($_SESSION['CasetaDT'])) 
          {
              $this->nm_falta_var .= "CasetaDT; ";
          }
          if (!isset($_SESSION['CarrilDT'])) 
          {
              $this->nm_falta_var .= "CarrilDT; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['PreliquidacionPDF_gen']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class PreliquidacionPDF_gen_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new PreliquidacionPDF_gen_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['PreliquidacionPDF_gen']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['PreliquidacionPDF_gen']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['PreliquidacionPDF_gen']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['PreliquidacionPDF_gen'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['PreliquidacionPDF_gen']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['PreliquidacionPDF_gen']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('PreliquidacionPDF_gen') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['PreliquidacionPDF_gen']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['PreliquidacionPDF_gen']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['PreliquidacionPDF_gen']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['PreliquidacionPDF_gen']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "PreliquidacionPDF_gen_erro.class.php"); 
      $this->Erro      = new PreliquidacionPDF_gen_erro();
...
if (!isset($_SESSION['CarrilDT'])) {$_SESSION['CarrilDT'] = "";}
if (!isset($this->sc_temp_CarrilDT)) {$this->sc_temp_CarrilDT = (isset($_SESSION['CarrilDT'])) ? $_SESSION['CarrilDT'] : "";}
if (!isset($_SESSION['TurnoDT'])) {$_SESSION['TurnoDT'] = "";}
if (!isset($this->sc_temp_TurnoDT)) {$this->sc_temp_TurnoDT = (isset($_SESSION['TurnoDT'])) ? $_SESSION['TurnoDT'] : "";}
if (!isset($_SESSION['FechaOperacionDT'])) {$_SESSION['FechaOperacionDT'] = "";}
if (!isset($this->sc_temp_FechaOperacionDT)) {$this->sc_temp_FechaOperacionDT = (isset($_SESSION['FechaOperacionDT'])) ? $_SESSION['FechaOperacionDT'] : "";}
if (!isset($_SESSION['CasetaDT'])) {$_SESSION['CasetaDT'] = "";}
if (!isset($this->sc_temp_CasetaDT)) {$this->sc_temp_CasetaDT = (isset($_SESSION['CasetaDT'])) ? $_SESSION['CasetaDT'] : "";}
  $ruta = $this->leeConfig('RUTA','LiqTurnoPDF');

$CasetaDT = $this->sc_temp_CasetaDT;
$FechaOperacionDT = $this->sc_temp_FechaOperacionDT;
...
EOD;
$tblpre = $this->PreliquidacionGeneral($CasetaDT,$FechaOperacionDT,$TurnoDT,$CarrilDT);
...
$pdf->Output('LiquidacionCR_'.$nombrearchivo.'.pdf', 'I');
if (isset($this->sc_temp_CasetaDT)) {$_SESSION['CasetaDT'] = $this->sc_temp_CasetaDT;}
if (isset($this->sc_temp_FechaOperacionDT)) {$_SESSION['FechaOperacionDT'] = $this->sc_temp_FechaOperacionDT;}
if (isset($this->sc_temp_TurnoDT)) {$_SESSION['TurnoDT'] = $this->sc_temp_TurnoDT;}
if (isset($this->sc_temp_CarrilDT)) {$_SESSION['CarrilDT'] = $this->sc_temp_CarrilDT;}
...
if($this->sc_temp_turno == "" && $this->sc_temp_carril == ""){
	...
	$condicional = " CasetaID = ".$CasetaID." and FechaOperacion = '".$fechaOperacion."' and TurnoID = ".$this->sc_temp_turno;
	$carril = "Todos";
	$narchivo =$fechaOperacion.'_T'.$this->sc_temp_turno;
	$ruta = $this->leeConfig('RUTA','PreTurnoPDF');
	$titulo = "PRELIQUIDACIÓN DE TURNO";
	}else{
	$condicional = " CasetaID = ".$CasetaID." and FechaOperacion = '".$fechaOperacion."' and TurnoID = ".$this->sc_temp_turno. " and CarrilID = ".$this->sc_temp_carril;
...
$fld_horag=date("H:i:s", $dia_hora);
		...
		$Depositar = 0;
		$Detalle = "";
$check_sql = "SELECT MontoCR,ImporteMXN, if(Faltante>=0,Faltante,0) as Faltante,if(Faltante<0,ABS(Faltante),0) as Sobrante, Entregado, CarrilID, TurnoID , HoraInicio, Operacion
FROM detalleturno 
...
if (isset($rs[0][0]))     
{
	...
	$operacion = $rs[0][28];
	$faltanteCajero = $rs[0][29];
	$sobranteCajero = ABS($rs[0][30]);
}
		else     
{	
...
else
{
   while(!$rs->EOF)
	...
	$check_aforo = "SELECT 'CR',PagoID,SUM(Importe_CR + (TarifaEE_CR)), sum(CantidadVeh) FROM aforo_preliq WHERE $condicional AND PagoID = '". $rs->fields[0] ."'  and VehiculoID_CR <> '' GROUP BY PagoID";
    ...
    $rs->Close();
		...
		$check_aforo = "SELECT PagoID,SUM(Importe_CR + (TarifaEE_CR)), sum(CantidadVeh) FROM aforo_preliq WHERE $condicional";
...
$diferenciaCR_Efe2=0;
if($faltanteCajero >= $entregadoCajero){
	$diferenciaCR_Efe2 = $entregadoCajero-$faltanteCajero;
		}else{
	$sobranteCajero += $entregadoCajero-$faltanteCajero;
		}
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_PreliquidacionPDF_gen($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['PreliquidacionPDF_gen']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "PreliquidacionPDF_gen") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   if (isset($_POST["FechaOperacionDT"])) 
   {
       $_SESSION["FechaOperacionDT"] = $_POST["FechaOperacionDT"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["FechaOperacionDT"]);
   }
   if (!isset($_POST["FechaOperacionDT"]) && isset($_POST["fechaoperaciondt"])) 
   {
       $_SESSION["FechaOperacionDT"] = $_POST["fechaoperaciondt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["FechaOperacionDT"]);
   }
   if (isset($_GET["FechaOperacionDT"])) 
   {
       $_SESSION["FechaOperacionDT"] = $_GET["FechaOperacionDT"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["FechaOperacionDT"]);
   }
   if (!isset($_GET["FechaOperacionDT"]) && isset($_GET["fechaoperaciondt"])) 
   {
       $_SESSION["FechaOperacionDT"] = $_GET["fechaoperaciondt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["FechaOperacionDT"]);
   }
   if (!isset($_SESSION["FechaOperacionDT"])) 
   {
       $_SESSION["FechaOperacionDT"] = "";
   }
   if (isset($_POST["TurnoDT"])) 
   {
       $_SESSION["TurnoDT"] = $_POST["TurnoDT"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["TurnoDT"]);
   }
   if (!isset($_POST["TurnoDT"]) && isset($_POST["turnodt"])) 
   {
       $_SESSION["TurnoDT"] = $_POST["turnodt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["TurnoDT"]);
   }
   if (isset($_GET["TurnoDT"])) 
   {
       $_SESSION["TurnoDT"] = $_GET["TurnoDT"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["TurnoDT"]);
   }
   if (!isset($_GET["TurnoDT"]) && isset($_GET["turnodt"])) 
   {
       $_SESSION["TurnoDT"] = $_GET["turnodt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["TurnoDT"]);
   }
   ...
   if (isset($_POST["CasetaDT"])) 
   {
       $_SESSION["CasetaDT"] = $_POST["CasetaDT"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CasetaDT"]);
   }
   if (!isset($_POST["CasetaDT"]) && isset($_POST["casetadt"])) 
   {
       $_SESSION["CasetaDT"] = $_POST["casetadt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CasetaDT"]);
   }
   if (isset($_GET["CasetaDT"])) 
   {
       $_SESSION["CasetaDT"] = $_GET["CasetaDT"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CasetaDT"]);
   }
   if (!isset($_GET["CasetaDT"]) && isset($_GET["casetadt"])) 
   {
       $_SESSION["CasetaDT"] = $_GET["casetadt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CasetaDT"]);
   }
   ...
   if (isset($_POST["CarrilDT"])) 
   {
       ...
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CarrilDT"]);
   }
   if (!isset($_POST["CarrilDT"]) && isset($_POST["carrildt"])) 
   {
       $_SESSION["CarrilDT"] = $_POST["carrildt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CarrilDT"]);
   }
   if (isset($_GET["CarrilDT"])) 
   {
       $_SESSION["CarrilDT"] = $_GET["CarrilDT"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CarrilDT"]);
   }
   if (!isset($_GET["CarrilDT"]) && isset($_GET["carrildt"])) 
   {
       $_SESSION["CarrilDT"] = $_GET["carrildt"];
       nm_limpa_str_PreliquidacionPDF_gen($_SESSION["CarrilDT"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "PreliquidacionPDF_gen";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'PreliquidacionPDF_gen' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('PreliquidacionPDF_gen' == $sReferer || 'PreliquidacionPDF_gen_' == substr($sReferer, 0, 22))
       {
           $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['lang'];
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'PreliquidacionPDF_gen')
   {
       $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/PreliquidacionPDF_gen_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_PreliquidacionPDF_gen($cadapar[1]);
       ...
       if (!isset($FechaOperacionDT) && isset($fechaoperaciondt)) 
       {
           $_SESSION["FechaOperacionDT"] = $fechaoperaciondt;
       }
       if (isset($FechaOperacionDT)) 
       {
           $_SESSION['FechaOperacionDT'] = $FechaOperacionDT;
           nm_limpa_str_PreliquidacionPDF_gen($_SESSION["FechaOperacionDT"]);
       }
       if (!isset($TurnoDT) && isset($turnodt)) 
       {
           $_SESSION["TurnoDT"] = $turnodt;
       }
       if (isset($TurnoDT)) 
       {
           $_SESSION['TurnoDT'] = $TurnoDT;
       ...
       if (!isset($CasetaDT) && isset($casetadt)) 
       {
           $_SESSION["CasetaDT"] = $casetadt;
       }
       if (isset($CasetaDT)) 
       {
           $_SESSION['CasetaDT'] = $CasetaDT;
       ...
       if (!isset($CarrilDT) && isset($carrildt)) 
       {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['PreliquidacionPDF_gen'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['opc_psq'] && !isset($_SESSION['scriptcase']['PreliquidacionPDF_gen']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['PreliquidacionPDF_gen']) || $_SESSION['scriptcase']['sc_apl_seg']['PreliquidacionPDF_gen'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['PreliquidacionPDF_gen']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("PreliquidacionPDF_gen", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
   ...
   $contr_PreliquidacionPDF_gen = new PreliquidacionPDF_gen_apl();
   $contr_PreliquidacionPDF_gen->controle();
//
   function nm_limpa_str_PreliquidacionPDF_gen(&$str)
   {
   }
?>
