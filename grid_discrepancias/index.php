<?php
   include_once('grid_discrepancias_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_discrepancias_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_discrepancias"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_discrepancias']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_discrepancias']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_discrepancias']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_discrepancias';
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_discrepancias']['actual_lang']) || $_SESSION['scriptcase']['grid_discrepancias']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_discrepancias']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("grid_discrepancias_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_ch_bi_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dyn_search_ch_bi']['cmp'] = $_POST['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dyn_search_ch_bi']['opc'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_discrepancias"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_discrepancias"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_discrepancias_erro.class.php"); 
      $this->Erro = new grid_discrepancias_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_discrepancias'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['Gera_log_access'] = true;
...
$this->sc_temp_sqlDetectados = "SUM(
    IF(PagoID_ANA = 'ELU' && (fld_ar_sct != 2 || fld_ar_sct IS NULL), 1,
      IF(ClaseVehiculo_ANA = 'M' && (fld_ar_sct != 2 || fld_ar_sct IS NULL), 1, 
        IF(PagoID_ANA = 'GE' && fld_ar_sct != 2, 1, 
          IF(PagoID_ANA = 'DE' && (fld_ar_sct != 2 || fld_ar_sct IS NULL), 1, 
            IF(CONCAT(ClaseVehiculo_ECT, ClaseVehiculo_EAP) = '' && (fld_ar_sct IS NULL || fld_ar_sct = 2), 0, 1)
        )
      )
)))";
...
$this->sc_temp_sqlClasificados = "SUM(
	IF(PagoID_ANA = 'ELU' && (fld_ar_sct != 2 || fld_ar_sct IS NULL), 1,
       IF(ClaseVehiculo_ANA = 'M' && (fld_ar_sct != 2 || fld_ar_sct IS NULL), 1, 
         IF((PagoID_ANA = 'GE' && fld_ar_sct != 2), 1,
    	   IF(PagoID_ANA = 'DE' && (fld_ar_sct = 2 || fld_ar_sct IS NULL), 0, 
       	     IF(CONCAT(ClaseVehiculo_ECT, ClaseVehiculo_EAP) = ClaseVehiculo_ANA , 1,
               IF((CONCAT(ClaseVehiculo_ECT, ClaseVehiculo_EAP) = 'C2' && ClaseVehiculo_ANA = 'B2') || (CONCAT(ClaseVehiculo_ECT, ClaseVehiculo_EAP) = 'C3' && ClaseVehiculo_ANA = 'B3') || 
			   (CONCAT(ClaseVehiculo_ECT, ClaseVehiculo_EAP) = 'C4' && ClaseVehiculo_ANA = 'B4'), 1, IF(fld_ar_sct = 1 || fld_ar_sct = 3, 1, 0))))))))";
...
$_SESSION['scriptcase']['grid_discrepancias']['contr_erro'] = 'off'; 
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['initialize'] = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_discrepancias']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_discrepancias']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_sep_date1'];
           }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_discrepancias', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'grid_discrepancias', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_discrepancias', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_discrepancias']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class grid_discrepancias_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_discrepancias']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_discrepancias'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_discrepancias_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_discrepancias']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_discrepancias'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'] || $Parms_form_pdf)
      { 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_discrepancias_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_discrepancias']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_discrepancias'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_discrepancias']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_discrepancias']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_discrepancias') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_discrepancias']['label'] = "Sistema de clasificación";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_discrepancias_erro.class.php"); 
      } 
      $this->Erro      = new grid_discrepancias_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_discrepancias_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_discrepancias_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_discrepancias_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pivot_tabular']);
              }
              if ($nmgp_opcao == "ordem")
              {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_date_format'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_date_format']['Fecha']['fechaoperacion'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_date_format']['Fecha']['fechaoperacion'] = 'YYYYMMDD2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_def_sql']['Fecha']['fechaoperacion'] = 'FechaOperacion';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_date_format']['Carril']['fechaoperacion'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_date_format']['Carril']['fechaoperacion'] = 'YYYYMMDD2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_def_sql']['Carril']['fechaoperacion'] = 'FechaOperacion';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_All_Groupby'] = array('Fecha' => 'all', 'Carril' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'] == "Fecha")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "Fecha Operacion");
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'] == "Carril")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "Fecha Operacion");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['Labels_GB'][] = "Carril";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Fecha']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Fecha'][2] = array('label' => "Cruces (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Fecha'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Fecha'][3] = array('label' => "No Validos (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Fecha'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Fecha'][4] = array('label' => "Discrepancias (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Fecha'][] = 4;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Fecha'][5] = array('label' => "% Clasificacion correcta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Fecha'][] = 5;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Fecha'][6] = array('label' => "% Conteo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Fecha'][] = 6;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_control']['Fecha']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_control']['Fecha'] = array(
               array(
                   'cmp_res' => "cruces",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Carril']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Carril'][2] = array('label' => "Cruces (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Carril'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Carril'][3] = array('label' => "No Validos (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Carril'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Carril'][4] = array('label' => "Discrepancias (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Carril'][] = 4;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Carril'][5] = array('label' => "% Clasificacion correcta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Carril'][] = 5;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']['Carril'][6] = array('label' => "% Conteo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']['Carril'][] = 6;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_control']['Carril']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_control']['Carril'] = array(
               array(
                   'cmp_res' => "cruces",
                   'label' => "Cruces (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
                   'label_field' => "Cruces",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_discrepancias_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_discrepancias_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_discrepancias_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_discrepancias_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_subtitle_val'] = 'below';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_exibe_val']    = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "fechaoperacion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "carrilid";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "turnoid";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "cruces";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "novalidos";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "discrepancias";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "porcientodisc";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "porcientoconteo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "clasificados";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['field_order'][] = "detectados";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_discrepancias']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_discrepancias']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['grid_discrepancias']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['use_pass_pdf'] = "";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'] == "Fecha") 
      {
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ordem_select']))  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ordem_select'] = array(); 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ordem_select']['FechaOperacion'] = 'ASC'; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ordem_select']['TurnoID'] = 'ASC'; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ordem_select']['CarrilID'] = 'ASC'; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ordem_select']; 
          } 
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['SC_Ind_Groupby'] == "Carril") 
      {
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_orig'])) && !isset($_POST['reload_comb_chart']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "busca";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_discrepancias']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_discrepancias']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "pdf")
      { 
          $this->Ini->path_img_modelo = $this->Ini->path_img_modelo;
      } 
      $this->Ini->grid_search_change_fil = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq'] = 'res';
          } 
          $this->SC_proc_grid_search($_POST['parm']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['contr_array_resumo'] = "NAO";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['contr_total_geral']  = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = 'pesq';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_discrepancias_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_orig'] = " where (Cancelado = 0 and PagoID_ANA not in (\"MAN\",\"RHZ\",\"RVS\"))";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['where_pesq_ant'];  
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_discrepancias_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_discrepancias.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_discrepancias_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_discrepancias_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_discrepancias_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_xls.class.php"); 
          } 
          $this->xls  = new grid_discrepancias_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_res_xls.class.php"); 
          } 
          $this->xls  = new grid_discrepancias_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_xml.class.php"); 
          } 
          $this->xml  = new grid_discrepancias_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_res_xml.class.php"); 
          } 
          $this->xml  = new grid_discrepancias_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_json.class.php"); 
          } 
          $this->json  = new grid_discrepancias_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_res_json.class.php"); 
          } 
          $this->json  = new grid_discrepancias_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_csv.class.php"); 
          } 
          $this->csv  = new grid_discrepancias_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_res_csv.class.php"); 
          } 
          $this->csv  = new grid_discrepancias_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_discrepancias_res_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_discrepancias . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_discrepancias_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_pesq.class.php"); 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "resumo" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "pesq")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_discrepancias_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_discrepancias/grid_discrepancias_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_discrepancias_grid.class.php"); 
          } 
          $this->grid  = new grid_discrepancias_grid();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_discrepancias_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_discrepancias_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_discrepancias_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_discrepancias.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $Cmps_check_return = array('casetaid','carrilid','turnoid');
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['grid_pesq']);
               continue;
           }
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
                       echo $oJson->encode($this->Ini->Arr_result);
                       $this->close_emb();
                       exit;
           ...
           if (!isset($busca[$dats[0]]))
           {
               ...
               if ($dats[0] == "fechaoperacion")
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'][$dats[0] . '_' . $tp] = $vl;
                   }
                   if (!empty($val1))
                   {
                       foreach ($val1 as $tp => $vl)
                       {
                          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'][$dats[0] . '_input_2_' . $tp] = $vl;
                       }
                   }
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
                   }
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "grid_discrepancias_pesq.class.php"); 
   ...
   function proc_del_grid_search($cmp_del, $del_all)
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_ano"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_input_2_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_input_2_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_input_2_ano"] = "";
      }
      elseif (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_discrepancias']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_discrepancias($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_discrepancias($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_discrepancias']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_discrepancias") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_discrepancias']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_discrepancias']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_discrepancias']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']);
               $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_discrepancias']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_discrepancias']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_discrepancias']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_discrepancias']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_discrepancias']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_discrepancias']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_discrepancias";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_discrepancias' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_discrepancias/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['contr_total_geral'] = "NAO";
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "es";
   if (isset($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "rhino_tkz/rhino_tkz";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_discrepancias')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_discrepancias_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_discrepancias_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_discrepancias_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['mostra_edit'] = "N";   
           } 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_discrepancias']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_discrepancias']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_discrepancias'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("grid_discrepancias", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
...
<?php
       ...
       $contr_grid_discrepancias = new grid_discrepancias_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] = "busca";
          $contr_grid_discrepancias->NM_ajax_flag = true;
          $contr_grid_discrepancias->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_ch_bi_search' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] = "busca";
          $contr_grid_discrepancias->NM_ajax_flag = true;
          $contr_grid_discrepancias->NM_ajax_opcao = "ajax_ch_bi_search";
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] = "busca";
          $contr_grid_discrepancias->NM_ajax_flag = true;
          $contr_grid_discrepancias->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] = "busca";
          $contr_grid_discrepancias->NM_ajax_flag = true;
          $contr_grid_discrepancias->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] = "busca";
          $contr_grid_discrepancias->NM_ajax_flag = true;
          $contr_grid_discrepancias->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_discrepancias->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_discrepancias(&$str)
   {
   }
   function nm_protect_num_grid_discrepancias($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function grid_discrepancias_pack_protect_string($sString)
   {
    ...
    function grid_discrepancias_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
