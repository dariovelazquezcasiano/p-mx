...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_discrepancias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_discrepancias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_discrepancias</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_discrepancias']['embutida_filho'] as $ind => $sc_init)
          {
