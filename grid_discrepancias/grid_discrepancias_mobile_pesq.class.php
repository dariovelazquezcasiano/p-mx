...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_numeric[] = "carrilid";$Nm_numeric[] = "turnoid";$Nm_numeric[] = "count(*)";$Nm_numeric[] = "sum(if( pagoid_ana = 'ge' && fld_ar_sct != 2,1,0))";$Nm_numeric[] = "\" _ \$_session['sqldetectados'] _ \"";$Nm_numeric[] = "\" _ \$_session['sqlclasificados'] _ \"";$Nm_numeric[] = "";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fechaoperacion_cond" name="fechaoperacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaoperacion'), this, 'fechaoperacion')">
