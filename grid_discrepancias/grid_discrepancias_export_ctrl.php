<?php
@session_start() ;
$_SESSION['scriptcase']['grid_discrepancias']['sc_process_barr'] = true;
require_once('../grid_discrepancias/index.php');
unset($_SESSION['scriptcase']['grid_discrepancias']['sc_process_barr']);
$ExportCtrl = new grid_discrepancias_export_control;
$ExportCtrl->Export_barr();

class grid_discrepancias_export_control
{
