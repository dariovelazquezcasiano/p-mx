  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aforo_elu_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aforo_elu_mob_form();
	}
...
?>
  ...
  // ---------- Validate horaevento
  function do_ajax_form_aforo_elu_mob_validate_horaevento()
  {
    var nomeCampo_horaevento = "horaevento";
    var var_horaevento = scAjaxGetFieldText(nomeCampo_horaevento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_elu_mob_validate_horaevento(var_horaevento, var_script_case_init, do_ajax_form_aforo_elu_mob_validate_horaevento_cb);
  } // do_ajax_form_aforo_elu_mob_validate_horaevento

  function do_ajax_form_aforo_elu_mob_validate_horaevento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horaevento";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_elu_mob_validate_horaevento_cb

  // ---------- Validate vehiculoid_ana
  function do_ajax_form_aforo_elu_mob_validate_vehiculoid_ana()
  {
    var nomeCampo_vehiculoid_ana = "vehiculoid_ana";
    var var_vehiculoid_ana = scAjaxGetFieldSelect(nomeCampo_vehiculoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_elu_mob_validate_vehiculoid_ana(var_vehiculoid_ana, var_script_case_init, do_ajax_form_aforo_elu_mob_validate_vehiculoid_ana_cb);
  } // do_ajax_form_aforo_elu_mob_validate_vehiculoid_ana

  function do_ajax_form_aforo_elu_mob_validate_vehiculoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_elu_mob_validate_vehiculoid_ana_cb

  // ---------- Validate pagoid_ana
  function do_ajax_form_aforo_elu_mob_validate_pagoid_ana()
  {
    var nomeCampo_pagoid_ana = "pagoid_ana";
    var var_pagoid_ana = scAjaxGetFieldSelect(nomeCampo_pagoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_elu_mob_validate_pagoid_ana(var_pagoid_ana, var_script_case_init, do_ajax_form_aforo_elu_mob_validate_pagoid_ana_cb);
  } // do_ajax_form_aforo_elu_mob_validate_pagoid_ana

  function do_ajax_form_aforo_elu_mob_validate_pagoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_elu_mob_validate_pagoid_ana_cb

  // ---------- Validate numerotarjeta
  function do_ajax_form_aforo_elu_mob_validate_numerotarjeta()
  {
    var nomeCampo_numerotarjeta = "numerotarjeta";
    var var_numerotarjeta = scAjaxGetFieldText(nomeCampo_numerotarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_elu_mob_validate_numerotarjeta(var_numerotarjeta, var_script_case_init, do_ajax_form_aforo_elu_mob_validate_numerotarjeta_cb);
  } // do_ajax_form_aforo_elu_mob_validate_numerotarjeta

  function do_ajax_form_aforo_elu_mob_validate_numerotarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_elu_mob_validate_numerotarjeta_cb

  // ---------- Event onchange pagoid_ana
  function do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange()
  {
    var var_pagoid_ana = scAjaxGetFieldSelect("pagoid_ana");
    var var_numerotarjeta = scAjaxGetFieldText("numerotarjeta");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange(var_pagoid_ana, var_numerotarjeta, var_script_case_init, do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange_cb);
  } // do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange

  function do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pagoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange_cb_after_alert);
  } // do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange_cb
  function do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_elu_mob_event_pagoid_ana_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_aforo_elu_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aforo_elu_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_horaevento = scAjaxGetFieldText("horaevento");
    ...
    scAjaxProcOn();
    x_ajax_form_aforo_elu_mob_submit_form(var_horaevento, var_vehiculoid_ana, var_pagoid_ana, var_numerotarjeta, var_consecutivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aforo_elu_mob_submit_form_cb);
  } // do_ajax_form_aforo_elu_mob_submit_form

  function do_ajax_form_aforo_elu_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("horaevento");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aforo_elu_mob_submit_form_cb_after_alert);
  } // do_ajax_form_aforo_elu_mob_submit_form_cb
  function do_ajax_form_aforo_elu_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aforo_elu_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aforo_elu_mob_navigate_form()
  {
    perform_ajax_form_aforo_elu_mob_navigate_form();
  }

  function perform_ajax_form_aforo_elu_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aforo_elu_mob_navigate_form(var_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aforo_elu_mob_navigate_form_cb);
  } // do_ajax_form_aforo_elu_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_elu_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aforo_elu_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aforo_elu_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_aforo_elu_mob_navigate_form_cb
  function do_ajax_form_aforo_elu_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_aforo_elu_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aforo_elu_mob_navigate_form_cb_after_alert

  function sc_hide_form_aforo_elu_mob_form()
  {
  ...
  ajax_field_list[0] = "horaevento";
  ajax_field_list[1] = "vehiculoid_ana";
  ajax_field_list[2] = "pagoid_ana";
  ajax_field_list[3] = "numerotarjeta";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "horaevento": {"label": "Hora Evento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_id = {
    "horaevento": new Array("hidden_field_label_horaevento", "hidden_field_data_horaevento"),
