...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____seg_grid_sec_users_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____seg_grid_sec_users_groups"]);
   }
