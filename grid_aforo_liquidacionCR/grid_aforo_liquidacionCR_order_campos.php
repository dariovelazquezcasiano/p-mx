<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_aforo_liquidacionCR']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_aforo_liquidacionCR_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_aforo_liquidacionCR_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["horaevento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["horaevento"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["horaevento"] : "Hora Evento";
   $tab_ger_campos['secuencial'] = "on";
   $tab_def_campos['secuencial'] = "Secuencial";
   $tab_labels["secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["secuencial"] : "Evento";
   $tab_ger_campos['folio'] = "on";
   $tab_def_campos['folio'] = "Folio";
   $tab_labels["folio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["folio"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["folio"] : "Folio";
   $tab_ger_campos['vehiculoid_ect'] = "on";
   $tab_def_campos['vehiculoid_ect'] = "VehiculoID_ECT";
   $tab_labels["vehiculoid_ect"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_ect"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_ect"] : "Señal PRE";
   $tab_ger_campos['vehiculoid_cr'] = "on";
   $tab_def_campos['vehiculoid_cr'] = "VehiculoID_CR";
   $tab_labels["vehiculoid_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_cr"] : "Señal CR";
   $tab_ger_campos['vehiculoid_eap'] = "on";
   $tab_def_campos['vehiculoid_eap'] = "VehiculoID_EAP";
   $tab_labels["vehiculoid_eap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_eap"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_eap"] : "Señal POS";
   $tab_ger_campos['pagoid'] = "on";
   $tab_def_campos['pagoid'] = "PagoID";
   $tab_labels["pagoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["pagoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["pagoid"] : "Tipo Pago";
   $tab_ger_campos['vehiculoid_ana'] = "on";
   $tab_def_campos['vehiculoid_ana'] = "VehiculoID_ANA";
   $tab_labels["vehiculoid_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["vehiculoid_ana"] : "Veh. ANA";
   $tab_ger_campos['pagoid_ana'] = "on";
   $tab_def_campos['pagoid_ana'] = "PagoID_ANA";
   $tab_labels["pagoid_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["pagoid_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["pagoid_ana"] : "Pago ANA";
   $tab_ger_campos['placas'] = "on";
   $tab_def_campos['placas'] = "Placas";
   $tab_labels["placas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["placas"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["placas"] : "Placas";
   $tab_ger_campos['numerotarjeta'] = "on";
   $tab_def_campos['numerotarjeta'] = "NumeroTarjeta";
   $tab_labels["numerotarjeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["numerotarjeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['labels']["numerotarjeta"] : "Tarjeta";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_aforo_liquidacionCR_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_aforo_liquidacionCR']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
