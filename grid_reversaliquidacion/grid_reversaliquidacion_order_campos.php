<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_reversaliquidacion']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_reversaliquidacion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reversaliquidacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fechaoperacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["fechaoperacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["fechaoperacion"] : "Fecha Operacion";
   $tab_ger_campos['turnoid'] = "on";
   $tab_def_campos['turnoid'] = "TurnoID";
   $tab_labels["turnoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["turnoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["turnoid"] : "Turno";
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["carrilid"] : "Carril";
   $tab_ger_campos['cuerpo'] = "on";
   $tab_def_campos['cuerpo'] = "Cuerpo";
   $tab_labels["cuerpo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["cuerpo"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["cuerpo"] : "Cuerpo";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "HoraInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["horainicio"] : "Hora Inicio";
   $tab_ger_campos['horafin'] = "on";
   $tab_def_campos['horafin'] = "HoraFin";
   $tab_labels["horafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["horafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["horafin"] : "Hora Fin";
   $tab_ger_campos['encargadoturnoid_pre'] = "on";
   $tab_def_campos['encargadoturnoid_pre'] = "EncargadoTurnoID_Pre";
   $tab_labels["encargadoturnoid_pre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["encargadoturnoid_pre"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["encargadoturnoid_pre"] : "Enc Turno Preliquido";
   $tab_ger_campos['foliocierre'] = "on";
   $tab_def_campos['foliocierre'] = "FolioCierre";
   $tab_labels["foliocierre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["foliocierre"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["foliocierre"] : "Folio Cierre";
   ...
   $tab_labels["liquidacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["liquidacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["liquidacion"] : "Liquidación";
   ...
   $tab_labels["liquida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["liquida"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["liquida"] : "Liquidación";
   ...
   $tab_labels["liquidacion_ok"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["liquidacion_ok"])) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['labels']["liquidacion_ok"] : "Liquidación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reversaliquidacion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reversaliquidacion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
