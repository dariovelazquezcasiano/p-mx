<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reversaliquidacion']['sc_process_barr'] = true;
require_once('../grid_reversaliquidacion/index.php');
unset($_SESSION['scriptcase']['grid_reversaliquidacion']['sc_process_barr']);
$ExportCtrl = new grid_reversaliquidacion_export_control;
$ExportCtrl->Export_barr();

class grid_reversaliquidacion_export_control
{
