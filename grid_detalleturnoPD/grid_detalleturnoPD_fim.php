...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturnoPD"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturnoPD"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_detalleturnoPD']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_detalleturnoPD']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPD']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPD']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPD']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPD']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPD']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleturnoPD</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPD']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPD']['embutida_filho'] as $ind => $sc_init)
          {
