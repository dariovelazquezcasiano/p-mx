<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleturnoPD']['sc_process_barr'] = true;
require_once('../grid_detalleturnoPD/index.php');
unset($_SESSION['scriptcase']['grid_detalleturnoPD']['sc_process_barr']);
$ExportCtrl = new grid_detalleturnoPD_export_control;
$ExportCtrl->Export_barr();

class grid_detalleturnoPD_export_control
{
