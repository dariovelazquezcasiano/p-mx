  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_autopista" == sTestField)
        {
...
?>
  ...
  // ---------- Validate autopistaid_
  function do_ajax_form_autopista_validate_autopistaid_(iNumLinha)
  {
    var nomeCampo_autopistaid_ = "autopistaid_" + iNumLinha;
    var var_autopistaid_ = scAjaxGetFieldText(nomeCampo_autopistaid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autopista_validate_autopistaid_(var_autopistaid_, iNumLinha, var_script_case_init, do_ajax_form_autopista_validate_autopistaid__cb);
  } // do_ajax_form_autopista_validate_autopistaid_

  function do_ajax_form_autopista_validate_autopistaid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "autopistaid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "autopistaid_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "autopistaid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "autopistaid_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autopista_validate_autopistaid__cb

  // ---------- Validate autopista_
  function do_ajax_form_autopista_validate_autopista_(iNumLinha)
  {
    var nomeCampo_autopista_ = "autopista_" + iNumLinha;
    var var_autopista_ = scAjaxGetFieldText(nomeCampo_autopista_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autopista_validate_autopista_(var_autopista_, iNumLinha, var_script_case_init, do_ajax_form_autopista_validate_autopista__cb);
  } // do_ajax_form_autopista_validate_autopista_

  function do_ajax_form_autopista_validate_autopista__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "autopista_" + iLineNumber;
    }
    else
    {
      sFieldValid = "autopista_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "autopista_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "autopista_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autopista_validate_autopista__cb

  // ---------- Validate kmini_
  function do_ajax_form_autopista_validate_kmini_(iNumLinha)
  {
    var nomeCampo_kmini_ = "kmini_" + iNumLinha;
    var var_kmini_ = scAjaxGetFieldText(nomeCampo_kmini_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autopista_validate_kmini_(var_kmini_, iNumLinha, var_script_case_init, do_ajax_form_autopista_validate_kmini__cb);
  } // do_ajax_form_autopista_validate_kmini_

  function do_ajax_form_autopista_validate_kmini__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kmini_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kmini_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kmini_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kmini_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autopista_validate_kmini__cb

  // ---------- Validate kmfin_
  function do_ajax_form_autopista_validate_kmfin_(iNumLinha)
  {
    var nomeCampo_kmfin_ = "kmfin_" + iNumLinha;
    var var_kmfin_ = scAjaxGetFieldText(nomeCampo_kmfin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autopista_validate_kmfin_(var_kmfin_, iNumLinha, var_script_case_init, do_ajax_form_autopista_validate_kmfin__cb);
  } // do_ajax_form_autopista_validate_kmfin_

  function do_ajax_form_autopista_validate_kmfin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kmfin_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kmfin_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kmfin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kmfin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autopista_validate_kmfin__cb

  // ---------- Validate responsable_
  function do_ajax_form_autopista_validate_responsable_(iNumLinha)
  {
    var nomeCampo_responsable_ = "responsable_" + iNumLinha;
    var var_responsable_ = scAjaxGetFieldSelect(nomeCampo_responsable_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autopista_validate_responsable_(var_responsable_, iNumLinha, var_script_case_init, do_ajax_form_autopista_validate_responsable__cb);
  } // do_ajax_form_autopista_validate_responsable_

  function do_ajax_form_autopista_validate_responsable__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "responsable_" + iLineNumber;
    }
    else
    {
      sFieldValid = "responsable_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "responsable_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "responsable_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autopista_validate_responsable__cb

  // ---------- Validate telefono_
  function do_ajax_form_autopista_validate_telefono_(iNumLinha)
  {
    var nomeCampo_telefono_ = "telefono_" + iNumLinha;
    var var_telefono_ = scAjaxGetFieldText(nomeCampo_telefono_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autopista_validate_telefono_(var_telefono_, iNumLinha, var_script_case_init, do_ajax_form_autopista_validate_telefono__cb);
  } // do_ajax_form_autopista_validate_telefono_

  function do_ajax_form_autopista_validate_telefono__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autopista_validate_telefono__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_autopista_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_autopista_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_autopista_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_autopista_add_new_line_cb);
  } // do_ajax_form_autopista_add_new_line

  function do_ajax_form_autopista_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_autopista_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_autopista_backup_line(iNumLinha)
  {
    var var_autopistaid_ = scAjaxGetFieldText("autopistaid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autopista_backup_line(var_autopistaid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_autopista_backup_line_cb);
  } // do_ajax_form_autopista_backup_line

  function do_ajax_form_autopista_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_autopista_backup_line_cb

  function do_ajax_form_autopista_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_autopista_cancel_insert

  function do_ajax_form_autopista_cancel_update(iSeqVert)
  {
    do_ajax_form_autopista_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_autopista_cancel_update

  function do_ajax_form_autopista_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_autopista_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_autopista_table_refresh()
  {
    var var_autopistaid_ = document.F2.autopistaid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_autopista_table_refresh(var_autopistaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_autopista_table_refresh_cb);
  } //  do_ajax_form_autopista_table_refresh

  function do_ajax_form_autopista_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.autopistaid_.value = scAjaxGetKeyValue("autopistaid_");
    ...
    scAjaxAlert(do_ajax_form_autopista_table_refresh_cb_after_alert);
  } // do_ajax_form_autopista_table_refresh_cb
  function do_ajax_form_autopista_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_autopista_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_autopista_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_autopista_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_autopistaid_ = scAjaxGetFieldText("autopistaid_" + iNumLinha);
    var var_autopista_ = scAjaxGetFieldText("autopista_" + iNumLinha);
    var var_kmini_ = scAjaxGetFieldText("kmini_" + iNumLinha);
    var var_kmfin_ = scAjaxGetFieldText("kmfin_" + iNumLinha);
    var var_responsable_ = scAjaxGetFieldSelect("responsable_" + iNumLinha);
...
?>
    x_ajax_form_autopista_submit_form(var_autopistaid_, var_autopista_, var_kmini_, var_kmfin_, var_responsable_, var_telefono_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_autopista_submit_form_cb);
  } // do_ajax_form_autopista_submit_form

  function do_ajax_form_autopista_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("autopistaid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("autopista_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kmini_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kmfin_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("responsable_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_autopista_submit_form_cb_after_alert);
  } // do_ajax_form_autopista_submit_form_cb
  function do_ajax_form_autopista_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_autopista_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_autopista_navigate_form()
  {
    perform_ajax_form_autopista_navigate_form();
  }

  function perform_ajax_form_autopista_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_autopista_cancel_insert(sc_form_autopista_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("autopistaid_" + iNavForm);
      scAjaxHideErrorDisplay("autopista_" + iNavForm);
      scAjaxHideErrorDisplay("kmini_" + iNavForm);
      scAjaxHideErrorDisplay("kmfin_" + iNavForm);
      scAjaxHideErrorDisplay("responsable_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_autopista_navigate_form(var_autopistaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_autopista_navigate_form_cb);
  } // do_ajax_form_autopista_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_autopista']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_autopista_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.autopistaid_.value = scAjaxGetKeyValue("autopistaid_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_autopista_navigate_form_cb_after_alert);
  } // do_ajax_form_autopista_navigate_form_cb
  function do_ajax_form_autopista_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_autopista_navigate_form_cb_after_alert

    function sc_form_autopista_get_last_line_number()
    {
    ...
    } //sc_form_autopista_get_last_line_number

  function sc_hide_form_autopista_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "autopistaid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "autopista_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kmini_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kmfin_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "responsable_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "telefono_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["autopistaid_" + iNumLinha] = {"label": "Autopista ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["autopista_" + iNumLinha] = {"label": "Autopista<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["kmini_" + iNumLinha] = {"label": "Km Inicial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["kmfin_" + iNumLinha] = {"label": "Km Final<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["responsable_" + iNumLinha] = {"label": "Responsable<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["autopistaid_"][iNumLinha] = "autopistaid_" + iNumLinha;
    ajax_field_mult["autopista_"][iNumLinha] = "autopista_" + iNumLinha;
    ajax_field_mult["kmini_"][iNumLinha] = "kmini_" + iNumLinha;
    ajax_field_mult["kmfin_"][iNumLinha] = "kmfin_" + iNumLinha;
    ajax_field_mult["responsable_"][iNumLinha] = "responsable_" + iNumLinha;
    ajax_field_mult["telefono_"][iNumLinha] = "telefono_" + iNumLinha;
    ajax_field_id["autopistaid_" + iNumLinha] = new Array("hidden_field_label_autopistaid_", "hidden_field_data_autopistaid_" + iNumLinha);
    ajax_field_id["autopista_" + iNumLinha] = new Array("hidden_field_label_autopista_", "hidden_field_data_autopista_" + iNumLinha);
    ajax_field_id["kmini_" + iNumLinha] = new Array("hidden_field_label_kmini_", "hidden_field_data_kmini_" + iNumLinha);
    ajax_field_id["kmfin_" + iNumLinha] = new Array("hidden_field_label_kmfin_", "hidden_field_data_kmfin_" + iNumLinha);
    ajax_field_id["responsable_" + iNumLinha] = new Array("hidden_field_label_responsable_", "hidden_field_data_responsable_" + iNumLinha);
    ajax_field_id["telefono_" + iNumLinha] = new Array("hidden_field_label_telefono_", "hidden_field_data_telefono_" + iNumLinha);
    ajax_error_count["autopistaid_" + iNumLinha] = "off";
    ajax_error_count["autopista_" + iNumLinha] = "off";
    ajax_error_count["kmini_" + iNumLinha] = "off";
    ajax_error_count["kmfin_" + iNumLinha] = "off";
    ajax_error_count["responsable_" + iNumLinha] = "off";
    ajax_error_count["telefono_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["autopistaid_" + iNumLinha] = "on";
    ajax_read_only["autopista_" + iNumLinha] = "off";
    ajax_read_only["kmini_" + iNumLinha] = "off";
    ajax_read_only["kmfin_" + iNumLinha] = "off";
    ajax_read_only["responsable_" + iNumLinha] = "off";
...
?>
    ajax_read_only["autopistaid_" + iNumLinha] = "on";
    ajax_read_only["autopista_" + iNumLinha] = "on";
    ajax_read_only["kmini_" + iNumLinha] = "on";
    ajax_read_only["kmfin_" + iNumLinha] = "on";
    ajax_read_only["responsable_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["autopistaid_" + iNumLinha] = null;
    ajax_error_list["autopista_" + iNumLinha] = null;
    ajax_error_list["kmini_" + iNumLinha] = null;
    ajax_error_list["kmfin_" + iNumLinha] = null;
    ajax_error_list["responsable_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "autopistaid_": new Array(),
    "autopista_": new Array(),
    "kmini_": new Array(),
    "kmfin_": new Array(),
    "responsable_": new Array(),
    "telefono_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["autopistaid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["autopistaid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["autopistaid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["autopistaid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["autopistaid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["autopista_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["autopista_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["autopista_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["autopista_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["autopista_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["kmini_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kmini_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kmini_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kmini_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kmini_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["kmfin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kmfin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kmfin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kmfin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kmfin_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["responsable_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["responsable_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["responsable_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["responsable_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["responsable_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['autopistaid_'])) ? $this->nmgp_cmp_readonly['autopistaid_'] : 'on';
?>
    scAjaxFieldRead("autopistaid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['autopista_'])) ? $this->nmgp_cmp_readonly['autopista_'] : 'off';
?>
    scAjaxFieldRead("autopista_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kmini_'])) ? $this->nmgp_cmp_readonly['kmini_'] : 'off';
?>
    scAjaxFieldRead("kmini_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kmfin_'])) ? $this->nmgp_cmp_readonly['kmfin_'] : 'off';
?>
    scAjaxFieldRead("kmfin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['responsable_'])) ? $this->nmgp_cmp_readonly['responsable_'] : 'off';
?>
    scAjaxFieldRead("responsable_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("autopistaid_" + iSeq, "on");
    scAjaxFieldRead("autopista_" + iSeq, "on");
    scAjaxFieldRead("kmini_" + iSeq, "on");
    scAjaxFieldRead("kmfin_" + iSeq, "on");
    scAjaxFieldRead("responsable_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["autopistaid_" + iRow] || "on" == ajax_error_count["autopista_" + iRow] || "on" == ajax_error_count["kmini_" + iRow] || "on" == ajax_error_count["kmfin_" + iRow] || "on" == ajax_error_count["responsable_" + iRow] || "on" == ajax_error_count["telefono_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_autopistaid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_autopista_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kmini_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kmfin_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_responsable_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["autopistaid_" + iRow] && "off" == ajax_error_count["autopista_" + iRow] && "off" == ajax_error_count["kmini_" + iRow] && "off" == ajax_error_count["kmfin_" + iRow] && "off" == ajax_error_count["responsable_" + iRow] && "off" == ajax_error_count["telefono_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["autopistaid_" + iRow] = "off";
        ajax_error_count["autopista_" + iRow] = "off";
        ajax_error_count["kmini_" + iRow] = "off";
        ajax_error_count["kmfin_" + iRow] = "off";
        ajax_error_count["responsable_" + iRow] = "off";
      ...
      $("#hidden_field_data_autopistaid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_autopista_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kmini_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kmfin_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_responsable_" + iRow).removeClass("scFormErrorLine");
