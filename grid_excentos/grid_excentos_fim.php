...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_excentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_excentos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_excentos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_excentos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_excentos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_excentos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_excentos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_excentos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_excentos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_excentos']['embutida_filho'] as $ind => $sc_init)
          {
