...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "excentoid";$Nm_numeric[] = "esactivo";$Nm_numeric[] = "excentoid";$Nm_numeric[] = "esactivo";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_esactivo_cond" name="esactivo_cond" onChange="nm_campos_between(document.getElementById('id_vis_esactivo'), this, 'esactivo')">
      ...
      <br><span id="id_hide_esactivo"  <?php echo $str_hide_esactivo?>><?php
      if ($esactivo != "")
      {
      $esactivo_look = (is_string($esactivo) ? substr($this->Db->qstr($esactivo), 1, -1) : $esactivo); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_excentoid_cond" name="excentoid_cond" onChange="nm_campos_between(document.getElementById('id_vis_excentoid'), this, 'excentoid')">
      ...
      <br><span id="id_hide_excentoid"  <?php echo $str_hide_excentoid?>><?php
      if ($excentoid != "")
      {
      $excentoid_look = (is_string($excentoid) ? substr($this->Db->qstr($excentoid), 1, -1) : $excentoid); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dependencia_cond" name="dependencia_cond" onChange="nm_campos_between(document.getElementById('id_vis_dependencia'), this, 'dependencia')">
      ...
      <br><span id="id_hide_dependencia"  <?php echo $str_hide_dependencia?>><?php
      if ($dependencia != "")
      {
      $dependencia_look = (is_string($dependencia) ? substr($this->Db->qstr($dependencia), 1, -1) : $dependencia); 
      $nmgp_def_dados = array(); 
