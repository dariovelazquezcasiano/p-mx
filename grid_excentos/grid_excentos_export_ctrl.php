<?php
@session_start() ;
$_SESSION['scriptcase']['grid_excentos']['sc_process_barr'] = true;
require_once('../grid_excentos/index.php');
unset($_SESSION['scriptcase']['grid_excentos']['sc_process_barr']);
$ExportCtrl = new grid_excentos_export_control;
$ExportCtrl->Export_barr();

class grid_excentos_export_control
{
