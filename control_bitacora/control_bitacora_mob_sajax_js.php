  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_bitacora_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_bitacora_mob_form();
	}
...
?>
  ...
  function do_ajax_control_bitacora_mob_validate_fechaoperacion()
  {
    var nomeCampo_fechaoperacion = "fechaoperacion";
    var var_fechaoperacion = scAjaxGetFieldText(nomeCampo_fechaoperacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_bitacora_mob_validate_fechaoperacion(var_fechaoperacion, var_script_case_init, do_ajax_control_bitacora_mob_validate_fechaoperacion_cb);
  } // do_ajax_control_bitacora_mob_validate_fechaoperacion

  function do_ajax_control_bitacora_mob_validate_fechaoperacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_bitacora_mob_validate_fechaoperacion_cb

  // ---------- Validate caseta
  function do_ajax_control_bitacora_mob_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    var var_caseta = scAjaxGetFieldSelect(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_bitacora_mob_validate_caseta(var_caseta, var_script_case_init, do_ajax_control_bitacora_mob_validate_caseta_cb);
  } // do_ajax_control_bitacora_mob_validate_caseta

  function do_ajax_control_bitacora_mob_validate_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_bitacora_mob_validate_caseta_cb

  // ---------- Validate carril
  function do_ajax_control_bitacora_mob_validate_carril()
  {
    var nomeCampo_carril = "carril";
    var var_carril = scAjaxGetFieldSelect(nomeCampo_carril);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_bitacora_mob_validate_carril(var_carril, var_script_case_init, do_ajax_control_bitacora_mob_validate_carril_cb);
  } // do_ajax_control_bitacora_mob_validate_carril

  function do_ajax_control_bitacora_mob_validate_carril_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "carril";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_bitacora_mob_validate_carril_cb

  // ---------- Validate turno
  function do_ajax_control_bitacora_mob_validate_turno()
  {
    var nomeCampo_turno = "turno";
    var var_turno = scAjaxGetFieldRadio(nomeCampo_turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_bitacora_mob_validate_turno(var_turno, var_script_case_init, do_ajax_control_bitacora_mob_validate_turno_cb);
  } // do_ajax_control_bitacora_mob_validate_turno

  function do_ajax_control_bitacora_mob_validate_turno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "turno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_bitacora_mob_validate_turno_cb

  // ---------- Validate tipo
  function do_ajax_control_bitacora_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_bitacora_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_control_bitacora_mob_validate_tipo_cb);
  } // do_ajax_control_bitacora_mob_validate_tipo

  function do_ajax_control_bitacora_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_bitacora_mob_validate_tipo_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_bitacora_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_bitacora_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_turno = scAjaxGetFieldRadio("turno");
    ...
    scAjaxProcOn();
    x_ajax_control_bitacora_mob_submit_form(var_fechaoperacion, var_caseta, var_carril, var_turno, var_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_bitacora_mob_submit_form_cb);
  } // do_ajax_control_bitacora_mob_submit_form

  function do_ajax_control_bitacora_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_bitacora_mob_submit_form_cb_after_alert);
  } // do_ajax_control_bitacora_mob_submit_form_cb
  function do_ajax_control_bitacora_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_bitacora_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_bitacora_mob_navigate_form()
  {
    perform_ajax_control_bitacora_mob_navigate_form();
  }

  function perform_ajax_control_bitacora_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_bitacora_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_bitacora_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_bitacora_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_bitacora_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_bitacora_mob_navigate_form_cb
  function do_ajax_control_bitacora_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_bitacora_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_bitacora_mob_navigate_form_cb_after_alert

  function sc_hide_control_bitacora_mob_form()
  {
