<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_detallealarma_dia']['sc_process_barr'] = true;
require_once('../pdf_detallealarma_dia/index.php');
unset($_SESSION['scriptcase']['pdf_detallealarma_dia']['sc_process_barr']);
$ExportCtrl = new pdf_detallealarma_dia_export_control;
$ExportCtrl->Export_barr();

class pdf_detallealarma_dia_export_control
{
