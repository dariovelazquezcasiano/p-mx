...
<?php
   ...
   $Ord_Cmp = new pdf_detallealarma_dia_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class pdf_detallealarma_dia_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["fecha"] : "Fecha";
   ...
   {
       $tab_def_campos['turno'] = "";
   }
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["turno"] : "Turno";
   $tab_ger_campos['hora'] = "on";
   $tab_def_campos['hora'] = "Hora";
   $tab_labels["hora"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["hora"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["hora"] : "Hora";
   $tab_ger_campos['usuarioid'] = "on";
   $tab_def_campos['usuarioid'] = "UsuarioID";
   $tab_labels["usuarioid"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["usuarioid"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["usuarioid"] : "Usuario ID";
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["carrilid"] : "Carril ID";
   $tab_ger_campos['cuerpo'] = "on";
   $tab_def_campos['cuerpo'] = "Cuerpo";
   $tab_labels["cuerpo"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["cuerpo"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["cuerpo"] : "Cuerpo";
   $tab_ger_campos['alarmaid'] = "on";
   $tab_def_campos['alarmaid'] = "AlarmaID";
   $tab_labels["alarmaid"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["alarmaid"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["alarmaid"] : "Alarma ID";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "Descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['turno'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "pdf_detallealarma_dia_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['pdf_detallealarma_dia']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
