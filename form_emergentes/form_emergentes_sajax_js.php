  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_emergentes" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_emergentes_validate_vehiculoid_(iNumLinha)
  {
    var nomeCampo_vehiculoid_ = "vehiculoid_" + iNumLinha;
    var var_vehiculoid_ = scAjaxGetFieldSelect(nomeCampo_vehiculoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_validate_vehiculoid_(var_vehiculoid_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_validate_vehiculoid__cb);
  } // do_ajax_form_emergentes_validate_vehiculoid_

  function do_ajax_form_emergentes_validate_vehiculoid__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_validate_vehiculoid__cb

  // ---------- Validate pagoid_
  function do_ajax_form_emergentes_validate_pagoid_(iNumLinha)
  {
    var nomeCampo_pagoid_ = "pagoid_" + iNumLinha;
    var var_pagoid_ = scAjaxGetFieldSelect(nomeCampo_pagoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_validate_pagoid_(var_pagoid_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_validate_pagoid__cb);
  } // do_ajax_form_emergentes_validate_pagoid_

  function do_ajax_form_emergentes_validate_pagoid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_validate_pagoid__cb

  // ---------- Validate folioini_
  function do_ajax_form_emergentes_validate_folioini_(iNumLinha)
  {
    var nomeCampo_folioini_ = "folioini_" + iNumLinha;
    var var_folioini_ = scAjaxGetFieldText(nomeCampo_folioini_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_validate_folioini_(var_folioini_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_validate_folioini__cb);
  } // do_ajax_form_emergentes_validate_folioini_

  function do_ajax_form_emergentes_validate_folioini__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_validate_folioini__cb

  // ---------- Validate foliofin_
  function do_ajax_form_emergentes_validate_foliofin_(iNumLinha)
  {
    var nomeCampo_foliofin_ = "foliofin_" + iNumLinha;
    var var_foliofin_ = scAjaxGetFieldText(nomeCampo_foliofin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_validate_foliofin_(var_foliofin_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_validate_foliofin__cb);
  } // do_ajax_form_emergentes_validate_foliofin_

  function do_ajax_form_emergentes_validate_foliofin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_validate_foliofin__cb

  // ---------- Validate cantidad_
  function do_ajax_form_emergentes_validate_cantidad_(iNumLinha)
  {
  } // do_ajax_form_emergentes_validate_cantidad_

  function do_ajax_form_emergentes_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_validate_cantidad__cb

  // ---------- Validate id_
  function do_ajax_form_emergentes_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldText(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_emergentes_validate_id__cb);
  } // do_ajax_form_emergentes_validate_id_

  function do_ajax_form_emergentes_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_emergentes_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_emergentes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_emergentes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_emergentes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_emergentes_add_new_line_cb);
  } // do_ajax_form_emergentes_add_new_line

  function do_ajax_form_emergentes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_emergentes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_emergentes_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_emergentes_backup_line(var_id_, var_folioini_, var_foliofin_, var_vehiculoid_, var_pagoid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_emergentes_backup_line_cb);
  } // do_ajax_form_emergentes_backup_line

  function do_ajax_form_emergentes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_emergentes_backup_line_cb

  function do_ajax_form_emergentes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_emergentes_cancel_insert

  function do_ajax_form_emergentes_cancel_update(iSeqVert)
  {
    do_ajax_form_emergentes_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_emergentes_cancel_update

  function do_ajax_form_emergentes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_emergentes_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_emergentes_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_emergentes_table_refresh(var_id_, var_folioini_, var_foliofin_, var_vehiculoid_, var_pagoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_emergentes_table_refresh_cb);
  } //  do_ajax_form_emergentes_table_refresh

  function do_ajax_form_emergentes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_emergentes_table_refresh_cb_after_alert);
  } // do_ajax_form_emergentes_table_refresh_cb
  function do_ajax_form_emergentes_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_emergentes_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_emergentes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_emergentes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_emergentes_submit_form(var_vehiculoid_, var_pagoid_, var_folioini_, var_foliofin_, var_cantidad_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_emergentes_submit_form_cb);
  } // do_ajax_form_emergentes_submit_form

  function do_ajax_form_emergentes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_emergentes_submit_form_cb_after_alert);
  } // do_ajax_form_emergentes_submit_form_cb
  function do_ajax_form_emergentes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_emergentes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_emergentes_navigate_form()
  {
    perform_ajax_form_emergentes_navigate_form();
  }

  function perform_ajax_form_emergentes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_emergentes_cancel_insert(sc_form_emergentes_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_emergentes_navigate_form(var_id_, var_folioini_, var_foliofin_, var_vehiculoid_, var_pagoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_emergentes_navigate_form_cb);
  } // do_ajax_form_emergentes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_emergentes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_emergentes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_emergentes_navigate_form_cb_after_alert);
  } // do_ajax_form_emergentes_navigate_form_cb
  function do_ajax_form_emergentes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_emergentes_navigate_form_cb_after_alert

    function sc_form_emergentes_get_last_line_number()
    {
    ...
    } //sc_form_emergentes_get_last_line_number

  function sc_hide_form_emergentes_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["folioini_" + iNumLinha] = {"label": "Folio Inicio<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["foliofin_" + iNumLinha] = {"label": "Folio Final<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
