...
class grid_cat_tarifas_resumo
{
   ...
   var $array_total_fld_caseta;
   var $array_total_fld_fecha_ini;
   var $array_total_fld_fecha_fin;
   var $array_total_fld_grupo;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fld_caseta    = array();
      $this->array_total_fld_fecha_ini = array();
      $this->array_total_fld_fecha_fin = array();
      $this->array_total_fld_grupo     = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_cat_tarifas']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_cat_tarifas']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['contr_total_geral'] == "OK")
      {
          $this->array_total_fld_caseta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_caseta'];
          $this->array_total_fld_fecha_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_fecha_ini'];
          $this->array_total_fld_fecha_fin = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_fecha_fin'];
          $this->array_total_fld_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_grupo'];
      }
      else
      {
          $this->array_total_fld_caseta = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_caseta'] = $this->array_total_fld_caseta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_fecha_ini'] = $this->array_total_fld_fecha_ini;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_fecha_fin'] = $this->array_total_fld_fecha_fin;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total']['fld_grupo'] = $this->array_total_fld_grupo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['json_use_label'])
       {
          $Lab_fld_caseta = "fld_caseta";
          $Lab_fld_fecha_ini = "fld_fecha_ini";
          $Lab_fld_fecha_fin = "fld_fecha_fin";
          $Lab_fld_grupo = "fld_grupo";
       }
       else
       {
       $Lab_fld_caseta = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_caseta'] . "";
       $Lab_fld_fecha_ini = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_fecha_ini'] . "";
       $Lab_fld_fecha_ini =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fld_fecha_ini);
       $Lab_fld_fecha_fin = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_fecha_fin'] . "";
       $Lab_fld_fecha_fin =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fld_fecha_fin);
       $Lab_fld_grupo = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_grupo'] . "";
       }
       $this->comp_field = array(
           $Lab_fld_caseta,
           $Lab_fld_fecha_ini,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_caseta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_caseta'] = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_caseta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_fecha_ini']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_fecha_ini'] = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_fecha_ini'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_fecha_fin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_fecha_fin'] = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_fecha_fin'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_grupo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_grupo'] = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_grupo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_tarifa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['labels']['fld_tarifa'] = "" . $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_tarifa'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'fld_caseta' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_tarifa'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_order']['caseta']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_order']['caseta'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_order']['caseta'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_display']['caseta'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_display']['caseta'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_display']['caseta'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_display']['caseta'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_display']['caseta'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_display']['caseta'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['summarizing_fields_display']['caseta'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "fld_tarifa", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_fld_tarifa_sum",
       );
       ...
       //-----
       foreach ($this->array_total_fld_caseta as $i_fld_caseta => $d_fld_caseta) {
           if (!isset($i_fld_caseta, $this->comp_label[0]) || !in_array($i_fld_caseta, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fld_caseta[3] ] = $d_fld_caseta[2];
               $this->comp_label[0][ $d_fld_caseta[3] ] = $d_fld_caseta[2];
           }
           foreach ($this->array_total_fld_fecha_ini[$i_fld_caseta] as $i_fld_fecha_ini => $d_fld_fecha_ini) {
               if (!isset($i_fld_fecha_ini, $this->comp_label[1][ $d_fld_caseta[3] ]) || !in_array($i_fld_fecha_ini, $this->comp_label[1][ $d_fld_caseta[3] ], true)) {
                   $this->comp_index[1][ $d_fld_fecha_ini[3] ] = $d_fld_fecha_ini[2];
                   $this->comp_label[1][ $d_fld_caseta[3] ][ $d_fld_fecha_ini[3] ] = $d_fld_fecha_ini[2];
               }
               foreach ($this->array_total_fld_fecha_fin[$i_fld_caseta][$i_fld_fecha_ini] as $i_fld_fecha_fin => $d_fld_fecha_fin) {
                   if (!isset($i_fld_fecha_fin, $this->comp_label[2][ $d_fld_caseta[3] ][ $d_fld_fecha_ini[3] ]) || !in_array($i_fld_fecha_fin, $this->comp_label[2][ $d_fld_caseta[3] ][ $d_fld_fecha_ini[3] ], true)) {
                       $this->comp_index[2][ $d_fld_fecha_fin[3] ] = $d_fld_fecha_fin[2];
                       $this->comp_label[2][ $d_fld_caseta[3] ][ $d_fld_fecha_ini[3] ][ $d_fld_fecha_fin[3] ] = $d_fld_fecha_fin[2];
                   }
                   foreach ($this->array_total_fld_grupo[$i_fld_caseta][$i_fld_fecha_ini][$i_fld_fecha_fin] as $i_fld_grupo => $d_fld_grupo) {
                       if (!isset($i_fld_grupo, $this->comp_label[3][ $d_fld_caseta[3] ][ $d_fld_fecha_ini[3] ][ $d_fld_fecha_fin[3] ]) || !in_array($i_fld_grupo, $this->comp_label[3][ $d_fld_caseta[3] ][ $d_fld_fecha_ini[3] ][ $d_fld_fecha_fin[3] ], true)) {
                           $this->comp_index[3][ $d_fld_grupo[3] ] = $d_fld_grupo[2];
                           $this->comp_label[3][ $d_fld_caseta[3] ][ $d_fld_fecha_ini[3] ][ $d_fld_fecha_fin[3] ][ $d_fld_grupo[3] ] = $d_fld_grupo[2];
                       }
                   }
               }
           }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'fld_caseta', 'prot' => '@aspass@'),
           array('name' => 'fld_fecha_ini', 'prot' => '@aspass@'),
           array('name' => 'fld_fecha_fin', 'prot' => '@aspass@'),
           array('name' => 'fld_grupo', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_fld_caseta => $l_fld_caseta) {
           if (isset($this->array_total_fld_caseta[$i_fld_caseta])) {
               $this->comp_group[$i_fld_caseta] = array();
           }
           foreach ($this->comp_label[1][$i_fld_caseta] as $i_fld_fecha_ini => $l_fld_fecha_ini) {
               if (isset($this->array_total_fld_fecha_ini[$i_fld_caseta][$i_fld_fecha_ini])) {
                   $this->comp_group[$i_fld_caseta][$i_fld_fecha_ini] = array();
               }
               foreach ($this->comp_label[2][$i_fld_caseta][$i_fld_fecha_ini] as $i_fld_fecha_fin => $l_fld_fecha_fin) {
                   if (isset($this->array_total_fld_fecha_fin[$i_fld_caseta][$i_fld_fecha_ini][$i_fld_fecha_fin])) {
                       $this->comp_group[$i_fld_caseta][$i_fld_fecha_ini][$i_fld_fecha_fin] = array();
                   }
                   foreach ($this->comp_label[3][$i_fld_caseta][$i_fld_fecha_ini][$i_fld_fecha_fin] as $i_fld_grupo => $l_fld_grupo) {
                       if (isset($this->array_total_fld_grupo[$i_fld_caseta][$i_fld_fecha_ini][$i_fld_fecha_fin][$i_fld_grupo])) {
                           $this->comp_group[$i_fld_caseta][$i_fld_fecha_ini][$i_fld_fecha_fin][$i_fld_grupo] = array();
                       }
                   }
               }
           }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fld_caseta;
       }
       elseif (1 == $level) {
           $return = $this->array_total_fld_fecha_ini;
       }
       elseif (2 == $level) {
           $return = $this->array_total_fld_fecha_fin;
       }
       elseif (3 == $level) {
           $return = $this->array_total_fld_grupo;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_cat_tarifas@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_cat_tarifas_total.class.php"); 
      }
      ...
      $this->Total   = new grid_cat_tarifas_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_caseta("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_fld_caseta)) {
          ksort($this->array_total_fld_caseta);
      }
      if (is_array($this->array_total_fld_fecha_ini)) {
          ksort($this->array_total_fld_fecha_ini);
      }
      if (is_array($this->array_total_fld_fecha_fin)) {
          ksort($this->array_total_fld_fecha_fin);
      }
      if (is_array($this->array_total_fld_grupo)) {
          ksort($this->array_total_fld_grupo);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cat_tarifas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_cat_tarifas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cat_tarifas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_cat_tarifas/grid_cat_tarifas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cat_tarifas/grid_cat_tarifas_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_cat_tarifas_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_cat_tarifas']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_cat_tarifas']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_cat_tarifas_config_pivot.php?nome_apl=grid_cat_tarifas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cat_tarifas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_cat_tarifas/grid_cat_tarifas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cat_tarifas']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fld_grupo = (isset($Busca_temp['fld_grupo'])) ? $Busca_temp['fld_grupo'] : ""; 
          $tmp_pos = (is_string($fld_grupo)) ? strpos($fld_grupo, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fld_grupo))
          {
              $fld_grupo = substr($fld_grupo, 0, $tmp_pos);
          }
          $fld_caseta = (isset($Busca_temp['fld_caseta'])) ? $Busca_temp['fld_caseta'] : ""; 
          $tmp_pos = (is_string($fld_caseta)) ? strpos($fld_caseta, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fld_caseta))
          {
              $fld_caseta = substr($fld_caseta, 0, $tmp_pos);
          }
          $fld_fecha_ini = (isset($Busca_temp['fld_fecha_ini'])) ? $Busca_temp['fld_fecha_ini'] : ""; 
          $tmp_pos = (is_string($fld_fecha_ini)) ? strpos($fld_fecha_ini, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fld_fecha_ini))
          {
              $fld_fecha_ini = substr($fld_fecha_ini, 0, $tmp_pos);
          }
          $fld_fecha_ini_2 = (isset($Busca_temp['fld_fecha_ini_input_2'])) ? $Busca_temp['fld_fecha_ini_input_2'] : ""; 
          $fld_fecha_fin = (isset($Busca_temp['fld_fecha_fin'])) ? $Busca_temp['fld_fecha_fin'] : ""; 
          $tmp_pos = (is_string($fld_fecha_fin)) ? strpos($fld_fecha_fin, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fld_fecha_fin))
          {
              $fld_fecha_fin = substr($fld_fecha_fin, 0, $tmp_pos);
          }
          $fld_fecha_fin_2 = (isset($Busca_temp['fld_fecha_fin_input_2'])) ? $Busca_temp['fld_fecha_fin_input_2'] : ""; 
      } 
   ...
   //---- 
   function adiciona_registro($sum_fld_tarifa, $quebra_fld_caseta, $quebra_fld_fecha_ini, $quebra_fld_fecha_fin, $quebra_fld_grupo, $quebra_fld_caseta_orig, $quebra_fld_fecha_ini_orig, $quebra_fld_fecha_fin_orig, $quebra_fld_grupo_orig)
   {
      //----- fld_caseta
      if (!isset($this->array_total_fld_caseta[$quebra_fld_caseta_orig]))
      {
         $this->array_total_fld_caseta[$quebra_fld_caseta_orig][0] = 1;
         $this->array_total_fld_caseta[$quebra_fld_caseta_orig][1] = $sum_fld_tarifa;
         $this->array_total_fld_caseta[$quebra_fld_caseta_orig][2] = $quebra_fld_caseta;
         $this->array_total_fld_caseta[$quebra_fld_caseta_orig][3] = $quebra_fld_caseta_orig;
      }
      else
      {
         $this->array_total_fld_caseta[$quebra_fld_caseta_orig][0]++;
         $this->array_total_fld_caseta[$quebra_fld_caseta_orig][1] = bcadd($this->array_total_fld_caseta[$quebra_fld_caseta_orig][1], $sum_fld_tarifa, 10);
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig]))
      {
         $this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][0] = 1;
         $this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][1] = $sum_fld_tarifa;
         $this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][2] = $quebra_fld_fecha_ini;
         $this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][3] = $quebra_fld_fecha_ini_orig;
      }
      else
      {
         $this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][0]++;
         $this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][1] = bcadd($this->array_total_fld_fecha_ini[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][1], $sum_fld_tarifa, 10);
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig]))
      {
         $this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][0] = 1;
         $this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][1] = $sum_fld_tarifa;
         $this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][2] = $quebra_fld_fecha_fin;
         $this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][3] = $quebra_fld_fecha_fin_orig;
      }
      else
      {
         $this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][0]++;
         $this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][1] = bcadd($this->array_total_fld_fecha_fin[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][1], $sum_fld_tarifa, 10);
      }
      //----- fld_grupo
      if (!isset($this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig]))
      {
         $this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig][0] = 1;
         $this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig][1] = $sum_fld_tarifa;
         $this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig][2] = $quebra_fld_grupo;
         $this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig][3] = $quebra_fld_grupo_orig;
      }
      else
      {
         $this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig][0]++;
         $this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig][1] = bcadd($this->array_total_fld_grupo[$quebra_fld_caseta_orig][$quebra_fld_fecha_ini_orig][$quebra_fld_fecha_fin_orig][$quebra_fld_grupo_orig][1], $sum_fld_tarifa, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->fld_grupo = $Busca_temp['fld_grupo']; 
       $this->fld_grupo = (isset($Busca_temp['fld_grupo'])) ? $Busca_temp['fld_grupo'] : ""; 
       $tmp_pos = (is_string($this->fld_grupo)) ? strpos($this->fld_grupo, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fld_grupo))
       {
       ...
       $this->fld_caseta = $Busca_temp['fld_caseta']; 
       $this->fld_caseta = (isset($Busca_temp['fld_caseta'])) ? $Busca_temp['fld_caseta'] : ""; 
       $tmp_pos = (is_string($this->fld_caseta)) ? strpos($this->fld_caseta, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fld_caseta))
       {
       ...
       $this->fld_fecha_ini = $Busca_temp['fld_fecha_ini']; 
       $this->fld_fecha_ini = (isset($Busca_temp['fld_fecha_ini'])) ? $Busca_temp['fld_fecha_ini'] : ""; 
       $tmp_pos = (is_string($this->fld_fecha_ini)) ? strpos($this->fld_fecha_ini, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fld_fecha_ini))
       {
       ...
       $fld_fecha_ini_2 = (isset($Busca_temp['fld_fecha_ini_input_2'])) ? $Busca_temp['fld_fecha_ini_input_2'] : ""; 
       $this->fld_fecha_ini_2 = $fld_fecha_ini_2; 
       $this->fld_fecha_fin = $Busca_temp['fld_fecha_fin']; 
       $this->fld_fecha_fin = (isset($Busca_temp['fld_fecha_fin'])) ? $Busca_temp['fld_fecha_fin'] : ""; 
       $tmp_pos = (is_string($this->fld_fecha_fin)) ? strpos($this->fld_fecha_fin, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fld_fecha_fin))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('caseta', 'fld_caseta');
     $campos_order = $this->Ini->Get_date_order_groupby("fld_caseta", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('caseta', 'fld_fecha_ini');
     $campos_order = $this->Ini->Get_date_order_groupby("fld_fecha_ini", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('caseta', 'fld_fecha_fin');
     $campos_order = $this->Ini->Get_date_order_groupby("fld_fecha_fin", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('caseta', 'fld_grupo');
     $campos_order = $this->Ini->Get_date_order_groupby("fld_grupo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fld_caseta = $rs_res->fields[0] ;  
            $this->fld_fecha_ini = $rs_res->fields[1] ;  
            $this->fld_fecha_fin = $rs_res->fields[2] ;  
            $this->fld_grupo = $rs_res->fields[3] ;  
            $this->fld_tarifa = $rs_res->fields[4] ;  
            $this->fld_tarifa =  str_replace(",", ".", $this->fld_tarifa);
            $this->look_fld_caseta = $this->fld_caseta; 
            $this->Lookup->lookup_fld_caseta($this->look_fld_caseta, $this->fld_caseta) ; 
            $this->fld_caseta_orig = $this->fld_caseta;
            ...
            $this->fld_fecha_ini_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->fld_fecha_ini, $Format_tst);
            $this->fld_fecha_ini = $this->Ini->GB_date_format($TP_Time . $this->fld_fecha_ini, $Format_tst, $Prefix_dat);
            ...
            $this->fld_fecha_fin_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->fld_fecha_fin, $Format_tst);
            $this->fld_fecha_fin = $this->Ini->GB_date_format($TP_Time . $this->fld_fecha_fin, $Format_tst, $Prefix_dat);
            $this->fld_grupo_orig = $this->fld_grupo;
            $this->fld_caseta = $this->look_fld_caseta ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fld_tarifa, $this->fld_caseta, $this->fld_fecha_ini, $this->fld_fecha_fin, $this->fld_grupo, $this->fld_caseta_orig,  $this->fld_fecha_ini_orig,  $this->fld_fecha_fin_orig,  $this->fld_grupo_orig);
            }
   }
//
