...
<?php
   ...
   $Ord_Cmp = new grid_cat_tarifas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cat_tarifas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['fld_caseta'] = "fld_caseta";
   $tab_labels["fld_caseta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_caseta"])) ? $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_caseta"] : "" . $this->Nm_lang['lang_cat_tarifas_fld_fld_caseta'] . "";
   $tab_ger_campos['fld_fecha_ini'] = "on";
   $tab_def_campos['fld_fecha_ini'] = "fld_fecha_ini";
   $tab_labels["fld_fecha_ini"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_fecha_ini"])) ? $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_fecha_ini"] : "" . $this->Nm_lang['lang_cat_tarifas_fld_fld_fecha_ini'] . "";
   $tab_ger_campos['fld_fecha_fin'] = "on";
   $tab_def_campos['fld_fecha_fin'] = "fld_fecha_fin";
   $tab_labels["fld_fecha_fin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_fecha_fin"])) ? $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_fecha_fin"] : "" . $this->Nm_lang['lang_cat_tarifas_fld_fld_fecha_fin'] . "";
   $tab_ger_campos['fld_grupo'] = "on";
   $tab_def_campos['fld_grupo'] = "fld_grupo";
   $tab_labels["fld_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_grupo"] : "" . $this->Nm_lang['lang_cat_tarifas_fld_fld_grupo'] . "";
   $tab_ger_campos['fld_tarifa'] = "on";
   $tab_def_campos['fld_tarifa'] = "fld_tarifa";
   $tab_labels["fld_tarifa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_tarifa"])) ? $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['labels']["fld_tarifa"] : "" . $this->Nm_lang['lang_cat_tarifas_fld_fld_tarifa'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cat_tarifas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cat_tarifas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
