<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cat_tarifas']['sc_process_barr'] = true;
require_once('../grid_cat_tarifas/index.php');
unset($_SESSION['scriptcase']['grid_cat_tarifas']['sc_process_barr']);
$ExportCtrl = new grid_cat_tarifas_export_control;
$ExportCtrl->Export_barr();

class grid_cat_tarifas_export_control
{
