<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleturnoPT']['sc_process_barr'] = true;
require_once('../grid_detalleturnoPT/index.php');
unset($_SESSION['scriptcase']['grid_detalleturnoPT']['sc_process_barr']);
$ExportCtrl = new grid_detalleturnoPT_export_control;
$ExportCtrl->Export_barr();

class grid_detalleturnoPT_export_control
{
