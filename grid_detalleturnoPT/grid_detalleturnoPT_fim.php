...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturnoPT"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturnoPT"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_detalleturnoPT']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_detalleturnoPT']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPT']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPT']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPT']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPT']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPT']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleturnoPT</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPT']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleturnoPT']['embutida_filho'] as $ind => $sc_init)
          {
