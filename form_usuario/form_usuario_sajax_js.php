...
?>
  ...
  // ---------- Validate casetaid
  function do_ajax_form_usuario_validate_casetaid()
  {
    var nomeCampo_casetaid = "casetaid";
    var var_casetaid = scAjaxGetFieldSelect(nomeCampo_casetaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_casetaid(var_casetaid, var_script_case_init, do_ajax_form_usuario_validate_casetaid_cb);
  } // do_ajax_form_usuario_validate_casetaid

  function do_ajax_form_usuario_validate_casetaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_casetaid_cb

  // ---------- Validate usuarioid
  function do_ajax_form_usuario_validate_usuarioid()
  {
    var nomeCampo_usuarioid = "usuarioid";
    var var_usuarioid = scAjaxGetFieldText(nomeCampo_usuarioid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_usuarioid(var_usuarioid, var_script_case_init, do_ajax_form_usuario_validate_usuarioid_cb);
  } // do_ajax_form_usuario_validate_usuarioid

  function do_ajax_form_usuario_validate_usuarioid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_usuarioid_cb

  // ---------- Validate nombre
  function do_ajax_form_usuario_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_usuario_validate_nombre_cb);
  } // do_ajax_form_usuario_validate_nombre

  function do_ajax_form_usuario_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_nombre_cb

  // ---------- Validate apellidopaterno
  function do_ajax_form_usuario_validate_apellidopaterno()
  {
    var nomeCampo_apellidopaterno = "apellidopaterno";
    var var_apellidopaterno = scAjaxGetFieldText(nomeCampo_apellidopaterno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_apellidopaterno(var_apellidopaterno, var_script_case_init, do_ajax_form_usuario_validate_apellidopaterno_cb);
  } // do_ajax_form_usuario_validate_apellidopaterno

  function do_ajax_form_usuario_validate_apellidopaterno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_apellidopaterno_cb

  // ---------- Validate apellidomaterno
  function do_ajax_form_usuario_validate_apellidomaterno()
  {
    var nomeCampo_apellidomaterno = "apellidomaterno";
    var var_apellidomaterno = scAjaxGetFieldText(nomeCampo_apellidomaterno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_apellidomaterno(var_apellidomaterno, var_script_case_init, do_ajax_form_usuario_validate_apellidomaterno_cb);
  } // do_ajax_form_usuario_validate_apellidomaterno

  function do_ajax_form_usuario_validate_apellidomaterno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_apellidomaterno_cb

  // ---------- Validate password
  function do_ajax_form_usuario_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_password(var_password, var_script_case_init, do_ajax_form_usuario_validate_password_cb);
  } // do_ajax_form_usuario_validate_password

  function do_ajax_form_usuario_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_password_cb

  // ---------- Validate usuariotipoid
  function do_ajax_form_usuario_validate_usuariotipoid()
  {
    var nomeCampo_usuariotipoid = "usuariotipoid";
    var var_usuariotipoid = scAjaxGetFieldSelect(nomeCampo_usuariotipoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_usuariotipoid(var_usuariotipoid, var_script_case_init, do_ajax_form_usuario_validate_usuariotipoid_cb);
  } // do_ajax_form_usuario_validate_usuariotipoid

  function do_ajax_form_usuario_validate_usuariotipoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_usuariotipoid_cb

  // ---------- Validate activo
  function do_ajax_form_usuario_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuario_validate_activo(var_activo, var_script_case_init, do_ajax_form_usuario_validate_activo_cb);
  } // do_ajax_form_usuario_validate_activo

  function do_ajax_form_usuario_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuario_validate_activo_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_usuario_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_usuario_submit_form(var_casetaid, var_usuarioid, var_nombre, var_apellidopaterno, var_apellidomaterno, var_password, var_usuariotipoid, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_usuario_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_usuario_submit_form_cb_after_alert);
  } // do_ajax_form_usuario_submit_form_cb
  function do_ajax_form_usuario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_usuario_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_usuario_navigate_form()
  {
    perform_ajax_form_usuario_navigate_form();
  }

  function perform_ajax_form_usuario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_usuario_navigate_form(var_usuarioid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_usuario_navigate_form_cb);
  } // do_ajax_form_usuario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_usuario_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_usuario_navigate_form_cb_after_alert);
  } // do_ajax_form_usuario_navigate_form_cb
  function do_ajax_form_usuario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_usuario_navigate_form_cb_after_alert

  function sc_hide_form_usuario_form()
  {
