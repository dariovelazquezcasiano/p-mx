...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "DATE(inserted_date)";$Nm_datas[] = "TIME(inserted_date)";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_hora_cond" name="hora_cond" onChange="nm_campos_between(document.getElementById('id_vis_hora'), this, 'hora')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_usuario_cond" name="usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuario'), this, 'usuario')">
