...
<?php
   ...
   $Ord_Cmp = new grid_reseteos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reseteos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["id"] : "ID";
   ...
   {
       $tab_def_campos['fecha'] = "DATE(inserted_date)";
   }
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["fecha"] : "Fecha";
   ...
   {
       $tab_def_campos['hora'] = "TIME(inserted_date)";
   }
   $tab_labels["hora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["hora"])) ? $_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["hora"] : "Hora";
   ...
   {
       $tab_def_campos['usuario'] = "username";
   }
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["usuario"] : "Usuario";
   ...
   {
       $tab_def_campos['accion'] = "action";
   }
   $tab_labels["accion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["accion"])) ? $_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["accion"] : "Accion";
   $tab_ger_campos['description'] = "on";
   $tab_def_campos['description'] = "description";
   $tab_labels["description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["description"])) ? $_SESSION['sc_session'][$sc_init]['grid_reseteos']['labels']["description"] : "Description";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reseteos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reseteos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reseteos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reseteos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
