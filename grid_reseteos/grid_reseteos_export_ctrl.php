<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reseteos']['sc_process_barr'] = true;
require_once('../grid_reseteos/index.php');
unset($_SESSION['scriptcase']['grid_reseteos']['sc_process_barr']);
$ExportCtrl = new grid_reseteos_export_control;
$ExportCtrl->Export_barr();

class grid_reseteos_export_control
{
