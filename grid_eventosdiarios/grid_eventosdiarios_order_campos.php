<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_eventosdiarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_eventosdiarios_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_eventosdiarios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["carrilid"] : "Carril";
   $tab_ger_campos['cuerpo'] = "on";
   $tab_def_campos['cuerpo'] = "Cuerpo";
   $tab_labels["cuerpo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cuerpo"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cuerpo"] : "Cuerpo";
   $tab_ger_campos['horaevento'] = "on";
   $tab_def_campos['horaevento'] = "HoraEvento";
   $tab_labels["horaevento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["horaevento"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["horaevento"] : "Hora Evento";
   $tab_ger_campos['secuencial'] = "on";
   $tab_def_campos['secuencial'] = "Secuencial";
   $tab_labels["secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["secuencial"] : "Secuencial";
   $tab_ger_campos['folio'] = "on";
   $tab_def_campos['folio'] = "Folio";
   $tab_labels["folio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["folio"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["folio"] : "Folio";
   $tab_ger_campos['pagoid'] = "on";
   $tab_def_campos['pagoid'] = "PagoID";
   $tab_labels["pagoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["pagoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["pagoid"] : "Tipo Pago";
   $tab_ger_campos['vehiculoid_ect'] = "on";
   $tab_def_campos['vehiculoid_ect'] = "VehiculoID_ECT";
   $tab_labels["vehiculoid_ect"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_ect"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_ect"] : "Vehiculo ECT";
   $tab_ger_campos['clasevehiculo_ect'] = "on";
   $tab_def_campos['clasevehiculo_ect'] = "ClaseVehiculo_ECT";
   $tab_labels["clasevehiculo_ect"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_ect"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_ect"] : "Clase Vehiculo ECT";
   $tab_ger_campos['importe_ect'] = "on";
   $tab_def_campos['importe_ect'] = "Importe_ECT";
   $tab_labels["importe_ect"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_ect"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_ect"] : "Importe ECT";
   $tab_ger_campos['cantidadeje_ect'] = "on";
   $tab_def_campos['cantidadeje_ect'] = "CantidadEje_ECT";
   $tab_labels["cantidadeje_ect"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_ect"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_ect"] : "Cantidad Eje ECT";
   $tab_ger_campos['tarifaee_ect'] = "on";
   $tab_def_campos['tarifaee_ect'] = "TarifaEE_ECT";
   $tab_labels["tarifaee_ect"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_ect"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_ect"] : "Tarifa EE ECT";
   $tab_ger_campos['vehiculoid_cr'] = "on";
   $tab_def_campos['vehiculoid_cr'] = "VehiculoID_CR";
   $tab_labels["vehiculoid_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_cr"] : "Vehiculo CR";
   $tab_ger_campos['clasevehiculo_cr'] = "on";
   $tab_def_campos['clasevehiculo_cr'] = "ClaseVehiculo_CR";
   $tab_labels["clasevehiculo_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_cr"] : "Clase Vehiculo CR";
   $tab_ger_campos['importe_cr'] = "on";
   $tab_def_campos['importe_cr'] = "Importe_CR";
   $tab_labels["importe_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_cr"] : "Importe CR";
   $tab_ger_campos['cantidadeje_cr'] = "on";
   $tab_def_campos['cantidadeje_cr'] = "CantidadEje_CR";
   $tab_labels["cantidadeje_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_cr"] : "Cantidad Eje CR";
   $tab_ger_campos['tarifaee_cr'] = "on";
   $tab_def_campos['tarifaee_cr'] = "TarifaEE_CR";
   $tab_labels["tarifaee_cr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_cr"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_cr"] : "Tarifa EE CR";
   $tab_ger_campos['vehiculoid_eap'] = "on";
   $tab_def_campos['vehiculoid_eap'] = "VehiculoID_EAP";
   $tab_labels["vehiculoid_eap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_eap"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_eap"] : "Vehiculo EAP";
   $tab_ger_campos['clasevehiculo_eap'] = "on";
   $tab_def_campos['clasevehiculo_eap'] = "ClaseVehiculo_EAP";
   $tab_labels["clasevehiculo_eap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_eap"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_eap"] : "Clase Vehiculo EAP";
   $tab_ger_campos['importe_eap'] = "on";
   $tab_def_campos['importe_eap'] = "Importe_EAP";
   $tab_labels["importe_eap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_eap"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_eap"] : "Importe EAP";
   $tab_ger_campos['cantidadeje_eap'] = "on";
   $tab_def_campos['cantidadeje_eap'] = "CantidadEje_EAP";
   $tab_labels["cantidadeje_eap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_eap"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_eap"] : "Cantidad Eje EAP";
   $tab_ger_campos['tarifaee_eap'] = "on";
   $tab_def_campos['tarifaee_eap'] = "TarifaEE_EAP";
   $tab_labels["tarifaee_eap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_eap"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_eap"] : "Tarifa EE EAP";
   $tab_ger_campos['vehiculoid_ana'] = "on";
   $tab_def_campos['vehiculoid_ana'] = "VehiculoID_ANA";
   $tab_labels["vehiculoid_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["vehiculoid_ana"] : "Vehiculo ANA";
   $tab_ger_campos['clasevehiculo_ana'] = "on";
   $tab_def_campos['clasevehiculo_ana'] = "ClaseVehiculo_ANA";
   $tab_labels["clasevehiculo_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["clasevehiculo_ana"] : "Clase Vehiculo ANA";
   $tab_ger_campos['pagoid_ana'] = "on";
   $tab_def_campos['pagoid_ana'] = "PagoID_ANA";
   $tab_labels["pagoid_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["pagoid_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["pagoid_ana"] : "Pago ANA";
   $tab_ger_campos['importe_ana'] = "on";
   $tab_def_campos['importe_ana'] = "Importe_ANA";
   $tab_labels["importe_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["importe_ana"] : "Importe ANA";
   $tab_ger_campos['cantidadeje_ana'] = "on";
   $tab_def_campos['cantidadeje_ana'] = "CantidadEje_ANA";
   $tab_labels["cantidadeje_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["cantidadeje_ana"] : "Cantidad Eje ANA";
   $tab_ger_campos['tarifaee_ana'] = "on";
   $tab_def_campos['tarifaee_ana'] = "TarifaEE_ANA";
   $tab_labels["tarifaee_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['labels']["tarifaee_ana"] : "Tarifa EE ANA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> aforo</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_eventosdiarios_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_eventosdiarios']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
