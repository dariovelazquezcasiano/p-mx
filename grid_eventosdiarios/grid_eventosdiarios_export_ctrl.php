<?php
@session_start() ;
$_SESSION['scriptcase']['grid_eventosdiarios']['sc_process_barr'] = true;
require_once('../grid_eventosdiarios/index.php');
unset($_SESSION['scriptcase']['grid_eventosdiarios']['sc_process_barr']);
$ExportCtrl = new grid_eventosdiarios_export_control;
$ExportCtrl->Export_barr();

class grid_eventosdiarios_export_control
{
