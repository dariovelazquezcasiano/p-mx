  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_flujo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_flujo_mob_form();
	}
...
?>
  ...
  // ---------- Validate fld_caseta
  function do_ajax_control_flujo_mob_validate_fld_caseta()
  {
    var nomeCampo_fld_caseta = "fld_caseta";
    var var_fld_caseta = scAjaxGetFieldSelect(nomeCampo_fld_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_flujo_mob_validate_fld_caseta(var_fld_caseta, var_script_case_init, do_ajax_control_flujo_mob_validate_fld_caseta_cb);
  } // do_ajax_control_flujo_mob_validate_fld_caseta

  function do_ajax_control_flujo_mob_validate_fld_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_flujo_mob_validate_fld_caseta_cb

  // ---------- Validate fld_usuario
  function do_ajax_control_flujo_mob_validate_fld_usuario()
  {
    var nomeCampo_fld_usuario = "fld_usuario";
    var var_fld_usuario = scAjaxGetFieldCheckbox(nomeCampo_fld_usuario, "','");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_flujo_mob_validate_fld_usuario(var_fld_usuario, var_script_case_init, do_ajax_control_flujo_mob_validate_fld_usuario_cb);
  } // do_ajax_control_flujo_mob_validate_fld_usuario

  function do_ajax_control_flujo_mob_validate_fld_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_flujo_mob_validate_fld_usuario_cb

  // ---------- Validate fecha_ini
  function do_ajax_control_flujo_mob_validate_fecha_ini()
  {
    var nomeCampo_fecha_ini = "fecha_ini";
    var var_fecha_ini = scAjaxGetFieldText(nomeCampo_fecha_ini);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_flujo_mob_validate_fecha_ini(var_fecha_ini, var_script_case_init, do_ajax_control_flujo_mob_validate_fecha_ini_cb);
  } // do_ajax_control_flujo_mob_validate_fecha_ini

  function do_ajax_control_flujo_mob_validate_fecha_ini_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_ini";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_flujo_mob_validate_fecha_ini_cb

  // ---------- Validate fecha_fin
  function do_ajax_control_flujo_mob_validate_fecha_fin()
  {
    var nomeCampo_fecha_fin = "fecha_fin";
    var var_fecha_fin = scAjaxGetFieldText(nomeCampo_fecha_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_flujo_mob_validate_fecha_fin(var_fecha_fin, var_script_case_init, do_ajax_control_flujo_mob_validate_fecha_fin_cb);
  } // do_ajax_control_flujo_mob_validate_fecha_fin

  function do_ajax_control_flujo_mob_validate_fecha_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_flujo_mob_validate_fecha_fin_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_flujo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_flujo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fld_caseta = scAjaxGetFieldSelect("fld_caseta");
    var var_fld_usuario = scAjaxGetFieldCheckbox("fld_usuario", "','");
    var var_fecha_ini = scAjaxGetFieldText("fecha_ini");
    ...
    scAjaxProcOn();
    x_ajax_control_flujo_mob_submit_form(var_fld_caseta, var_fld_usuario, var_fecha_ini, var_fecha_fin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_flujo_mob_submit_form_cb);
  } // do_ajax_control_flujo_mob_submit_form

  function do_ajax_control_flujo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_flujo_mob_submit_form_cb_after_alert);
  } // do_ajax_control_flujo_mob_submit_form_cb
  function do_ajax_control_flujo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_flujo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_flujo_mob_navigate_form()
  {
    perform_ajax_control_flujo_mob_navigate_form();
  }

  function perform_ajax_control_flujo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_flujo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_flujo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_flujo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_flujo_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_flujo_mob_navigate_form_cb
  function do_ajax_control_flujo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_flujo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_flujo_mob_navigate_form_cb_after_alert

  function sc_hide_control_flujo_mob_form()
  {
  ...
  ajax_field_list[0] = "fld_caseta";
  ajax_field_list[1] = "fld_usuario";
  ajax_field_list[2] = "fecha_ini";
  ajax_field_list[3] = "fecha_fin";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fld_caseta": {"label": "Caseta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fld_usuario": {"label": "TipoPago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_ini": {"label": "Fecha inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_fin": {"label": "Fecha final", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "fld_caseta": new Array(),
    "fld_usuario": new Array(),
    "fecha_ini": new Array(),
    "fecha_fin": new Array()
  };
  ajax_field_mult["fld_caseta"][1] = "fld_caseta";
  ajax_field_mult["fld_usuario"][1] = "fld_usuario";
  ajax_field_mult["fecha_ini"][1] = "fecha_ini";
  ajax_field_mult["fecha_fin"][1] = "fecha_fin";

  var ajax_field_id = {
    "fld_caseta": new Array("hidden_field_label_fld_caseta", "hidden_field_data_fld_caseta"),
    "fld_usuario": new Array("hidden_field_label_fld_usuario", "hidden_field_data_fld_usuario"),
    "fecha_ini": new Array("hidden_field_label_fecha_ini", "hidden_field_data_fecha_ini"),
