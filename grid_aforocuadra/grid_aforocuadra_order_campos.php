<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_aforocuadra']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_aforocuadra_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_aforocuadra_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['casetaid'] = "CasetaID";
   $tab_labels["casetaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["casetaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["casetaid"] : "Caseta ID";
   $tab_ger_campos['fechaoperacion'] = "on";
   $tab_def_campos['fechaoperacion'] = "FechaOperacion";
   $tab_labels["fechaoperacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["fechaoperacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["fechaoperacion"] : "Fecha Operacion";
   $tab_ger_campos['fechaturno'] = "on";
   $tab_def_campos['fechaturno'] = "FechaTurno";
   $tab_labels["fechaturno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["fechaturno"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["fechaturno"] : "Fecha Turno";
   $tab_ger_campos['turnoid'] = "on";
   $tab_def_campos['turnoid'] = "TurnoID";
   $tab_labels["turnoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["turnoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["turnoid"] : "Turno ID";
   $tab_ger_campos['horaevento'] = "on";
   $tab_def_campos['horaevento'] = "HoraEvento";
   $tab_labels["horaevento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["horaevento"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["horaevento"] : "Hora Evento";
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["carrilid"] : "Carril ID";
   $tab_ger_campos['cuerpo'] = "on";
   $tab_def_campos['cuerpo'] = "Cuerpo";
   $tab_labels["cuerpo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["cuerpo"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["cuerpo"] : "Cuerpo";
   $tab_ger_campos['vehiculoid_ana'] = "on";
   $tab_def_campos['vehiculoid_ana'] = "VehiculoID_ANA";
   $tab_labels["vehiculoid_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["vehiculoid_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["vehiculoid_ana"] : "Vehiculo ID ANA";
   $tab_ger_campos['clasevehiculo_ana'] = "on";
   $tab_def_campos['clasevehiculo_ana'] = "ClaseVehiculo_ANA";
   $tab_labels["clasevehiculo_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["clasevehiculo_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["clasevehiculo_ana"] : "Clase Vehiculo ANA";
   $tab_ger_campos['importe_ana'] = "on";
   $tab_def_campos['importe_ana'] = "Importe_ANA";
   $tab_labels["importe_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["importe_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["importe_ana"] : "Importe ANA";
   $tab_ger_campos['pagoid_ana'] = "on";
   $tab_def_campos['pagoid_ana'] = "PagoID_ANA";
   $tab_labels["pagoid_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["pagoid_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["pagoid_ana"] : "Pago ID ANA";
   $tab_ger_campos['estatusana'] = "on";
   $tab_def_campos['estatusana'] = "EstatusANA";
   $tab_labels["estatusana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["estatusana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["estatusana"] : "Estatus ANA";
   $tab_ger_campos['tarifaee_ana'] = "on";
   $tab_def_campos['tarifaee_ana'] = "TarifaEE_ANA";
   $tab_labels["tarifaee_ana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["tarifaee_ana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["tarifaee_ana"] : "Tarifa EE ANA";
   $tab_ger_campos['impana'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['impana'] = "impana";
   }
   else
   {
       $tab_def_campos['impana'] = "(Importe_ANA+TarifaEE_ANA)";
   }
   $tab_labels["impana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["impana"])) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['labels']["impana"] : "Imp ANA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_aforocuadra_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_aforocuadra']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
