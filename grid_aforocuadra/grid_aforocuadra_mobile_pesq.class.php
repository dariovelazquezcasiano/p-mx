...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fechaoperacion"  <?php echo $str_hide_fechaoperacion?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_casetaid"  <?php echo $str_hide_casetaid?>>
<?php
...
?>
   <span id="idAjaxSelect_pagoid_ana">
      <SELECT class="scFilterObjectOdd" id="SC_pagoid_ana" name="pagoid_ana[]"  size="9" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'pagoid_ana[]')
      {
