...
class grid_aforocuadra_resumo
{
   ...
   var $array_total_clasevehiculo_ana;
   var $array_total_carrilid;
   var $array_total_turnoid;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_clasevehiculo_ana = array();
      $this->array_total_carrilid          = array();
      $this->array_total_turnoid           = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_aforocuadra']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_aforocuadra']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['contr_total_geral'] == "OK")
      {
          $this->array_total_clasevehiculo_ana = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total']['clasevehiculo_ana'];
          $this->array_total_carrilid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total']['carrilid'];
          $this->array_total_turnoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total']['turnoid'];
      }
      else
      {
          $this->array_total_clasevehiculo_ana = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total']['clasevehiculo_ana'] = $this->array_total_clasevehiculo_ana;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total']['carrilid'] = $this->array_total_carrilid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total']['turnoid'] = $this->array_total_turnoid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['json_use_label'])
       {
          $Lab_clasevehiculo_ana = "ClaseVehiculo_ANA";
          $Lab_carrilid = "CarrilID";
          $Lab_turnoid = "TurnoID";
       }
       else
       {
       $Lab_clasevehiculo_ana = "Clase Vehiculo ANA";
       $Lab_carrilid = "Carril ID";
       $Lab_turnoid = "Turno ID";
       }
       $this->comp_field = array(
           $Lab_clasevehiculo_ana,
           $Lab_carrilid,
           $Lab_turnoid,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['casetaid'] = "Caseta ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechaoperacion'] = "Fecha Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechaturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechaturno'] = "Fecha Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['turnoid'] = "Turno ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['horaevento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['horaevento'] = "Hora Evento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['carrilid'] = "Carril ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_ana'] = "Vehiculo ID ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_ana'] = "Clase Vehiculo ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_ana'] = "Importe ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['pagoid_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['pagoid_ana'] = "Pago ID ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['estatusana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['estatusana'] = "Estatus ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_ana'] = "Tarifa EE ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['impana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['impana'] = "Imp ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['consecutivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['consecutivo'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tramoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tramoid'] = "Tramo ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['secuencial'] = "Secuencial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['folio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['folio'] = "Folio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_ect'] = "Vehiculo ID ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_ect'] = "Clase Vehiculo ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_ect'] = "Importe ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_ect'] = "Cantidad Eje ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_ect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_ect'] = "Tarifa EE ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_cr'] = "Vehiculo ID CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_cr'] = "Clase Vehiculo CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_cr'] = "Importe CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_cr'] = "Cantidad Eje CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_cr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_cr'] = "Tarifa EE CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['vehiculoid_eap'] = "Vehiculo ID EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['clasevehiculo_eap'] = "Clase Vehiculo EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['importe_eap'] = "Importe EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_eap'] = "Cantidad Eje EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_eap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tarifaee_eap'] = "Tarifa EE EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['pagoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['pagoid'] = "Pago ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['excentoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['excentoid'] = "Excento ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['usuarioid'] = "Usuario ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['placas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['placas'] = "Placas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['numerotarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['numerotarjeta'] = "Numero Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tipotarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tipotarjeta'] = "Tipo Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechaenvio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechaenvio'] = "Fecha Envio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['codigofacturacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['codigofacturacion'] = "Codigo Facturacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fld_ar_sct']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fld_ar_sct'] = "Fld Ar Sct"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_ana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['cantidadeje_ana'] = "Cantidad Eje ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechamodificadoana']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechamodificadoana'] = "Fecha Modificado ANA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['eludidoextra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['eludidoextra'] = "Eludido Extra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['revisado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['revisado'] = "Revisado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechamarcacioncr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechamarcacioncr'] = "Fecha Marcacion CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechadeteccionect']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechadeteccionect'] = "Fecha Deteccion ECT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechadeteccioneap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['fechadeteccioneap'] = "Fecha Deteccion EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tramoidorigen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['tramoidorigen'] = "Tramo ID Origen"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['operacionid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['operacionid'] = "Operacion ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['residente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['labels']['residente'] = "Residente"; 
       }
       //-----
       $this->comp_field_nm = array(
           'clasevehiculo_ana' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_order']['CarrilID_TurnoID']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_order']['CarrilID_TurnoID'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_order']['CarrilID_TurnoID'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_display']['CarrilID_TurnoID'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_display']['CarrilID_TurnoID'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_display']['CarrilID_TurnoID'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_display']['CarrilID_TurnoID'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_display']['CarrilID_TurnoID'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_display']['CarrilID_TurnoID'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['summarizing_fields_display']['CarrilID_TurnoID'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_clasevehiculo_ana as $i_clasevehiculo_ana => $d_clasevehiculo_ana) {
           if (!isset($i_clasevehiculo_ana, $this->comp_label[0]) || !in_array($i_clasevehiculo_ana, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_clasevehiculo_ana[3] ] = $d_clasevehiculo_ana[2];
               $this->comp_label[0][ $d_clasevehiculo_ana[3] ] = $d_clasevehiculo_ana[2];
           }
           foreach ($this->array_total_carrilid[$i_clasevehiculo_ana] as $i_carrilid => $d_carrilid) {
               if (!isset($i_carrilid, $this->comp_label[1][ $d_clasevehiculo_ana[3] ]) || !in_array($i_carrilid, $this->comp_label[1][ $d_clasevehiculo_ana[3] ], true)) {
                   $this->comp_index[1][ $d_carrilid[3] ] = $d_carrilid[2];
                   $this->comp_label[1][ $d_clasevehiculo_ana[3] ][ $d_carrilid[3] ] = $d_carrilid[2];
               }
               foreach ($this->array_total_turnoid[$i_clasevehiculo_ana][$i_carrilid] as $i_turnoid => $d_turnoid) {
                   if (!isset($i_turnoid, $this->comp_label[2][ $d_clasevehiculo_ana[3] ][ $d_carrilid[3] ]) || !in_array($i_turnoid, $this->comp_label[2][ $d_clasevehiculo_ana[3] ][ $d_carrilid[3] ], true)) {
                       $this->comp_index[2][ $d_turnoid[3] ] = $d_turnoid[2];
                       $this->comp_label[2][ $d_clasevehiculo_ana[3] ][ $d_carrilid[3] ][ $d_turnoid[3] ] = $d_turnoid[2];
                   }
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'clasevehiculo_ana', 'prot' => '@aspass@'),
           array('name' => 'carrilid', 'prot' => ''),
           array('name' => 'turnoid', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_clasevehiculo_ana => $l_clasevehiculo_ana) {
           if (isset($this->array_total_clasevehiculo_ana[$i_clasevehiculo_ana])) {
               $this->comp_group[$i_clasevehiculo_ana] = array();
           }
           foreach ($this->comp_label[1][$i_clasevehiculo_ana] as $i_carrilid => $l_carrilid) {
               if (isset($this->array_total_carrilid[$i_clasevehiculo_ana][$i_carrilid])) {
                   $this->comp_group[$i_clasevehiculo_ana][$i_carrilid] = array();
               }
               foreach ($this->comp_label[2][$i_clasevehiculo_ana][$i_carrilid] as $i_turnoid => $l_turnoid) {
                   if (isset($this->array_total_turnoid[$i_clasevehiculo_ana][$i_carrilid][$i_turnoid])) {
                       $this->comp_group[$i_clasevehiculo_ana][$i_carrilid][$i_turnoid] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_clasevehiculo_ana;
       }
       elseif (1 == $level) {
           $return = $this->array_total_carrilid;
       }
       elseif (2 == $level) {
           $return = $this->array_total_turnoid;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_aforocuadra@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_aforocuadra_total.class.php"); 
      }
      ...
      $this->Total   = new grid_aforocuadra_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_CarrilID_TurnoID("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_clasevehiculo_ana)) {
          ksort($this->array_total_clasevehiculo_ana);
      }
      if (is_array($this->array_total_carrilid)) {
          ksort($this->array_total_carrilid);
      }
      if (is_array($this->array_total_turnoid)) {
          ksort($this->array_total_turnoid);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " aforo</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_aforocuadra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_aforocuadra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_aforocuadra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_aforocuadra/grid_aforocuadra_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_aforocuadra/grid_aforocuadra_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_aforocuadra&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_aforocuadra/grid_aforocuadra_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_aforocuadra_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_aforocuadra']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_aforocuadra']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_aforocuadra_config_pivot.php?nome_apl=grid_aforocuadra&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_aforocuadra_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_aforocuadra/grid_aforocuadra_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforocuadra']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $pagoid_ana = (isset($Busca_temp['pagoid_ana'])) ? $Busca_temp['pagoid_ana'] : ""; 
          $tmp_pos = (is_string($pagoid_ana)) ? strpos($pagoid_ana, "##@@") : false;
          if ($tmp_pos !== false && !is_array($pagoid_ana))
          {
   ...
   //---- 
   function adiciona_registro($quebra_clasevehiculo_ana, $quebra_carrilid, $quebra_turnoid, $quebra_clasevehiculo_ana_orig, $quebra_carrilid_orig, $quebra_turnoid_orig)
   {
      //----- Clase Vehiculo ANA
      if (!isset($this->array_total_clasevehiculo_ana[$quebra_clasevehiculo_ana_orig]))
      {
         $this->array_total_clasevehiculo_ana[$quebra_clasevehiculo_ana_orig][0] = 1;
         $this->array_total_clasevehiculo_ana[$quebra_clasevehiculo_ana_orig][1] = 1;
         $this->array_total_clasevehiculo_ana[$quebra_clasevehiculo_ana_orig][2] = $quebra_clasevehiculo_ana;
         $this->array_total_clasevehiculo_ana[$quebra_clasevehiculo_ana_orig][3] = $quebra_clasevehiculo_ana_orig;
      }
      else
      {
         $this->array_total_clasevehiculo_ana[$quebra_clasevehiculo_ana_orig][0]++;
         $this->array_total_clasevehiculo_ana[$quebra_clasevehiculo_ana_orig][2]++;
      }
      //----- Carril ID
      if (!isset($this->array_total_carrilid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig]))
      {
         $this->array_total_carrilid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][0] = 1;
         $this->array_total_carrilid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][1] = 1;
         $this->array_total_carrilid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][2] = $quebra_carrilid;
         $this->array_total_carrilid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][3] = $quebra_carrilid_orig;
      }
      else
      {
         $this->array_total_carrilid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][0]++;
         $this->array_total_carrilid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][2]++;
      }
      //----- Turno ID
      if (!isset($this->array_total_turnoid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][$quebra_turnoid_orig]))
      {
         $this->array_total_turnoid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][$quebra_turnoid_orig][0] = 1;
         $this->array_total_turnoid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][$quebra_turnoid_orig][1] = 1;
         $this->array_total_turnoid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][$quebra_turnoid_orig][2] = $quebra_turnoid;
         $this->array_total_turnoid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][$quebra_turnoid_orig][3] = $quebra_turnoid_orig;
      }
      else
      {
         $this->array_total_turnoid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][$quebra_turnoid_orig][0]++;
         $this->array_total_turnoid[$quebra_clasevehiculo_ana_orig][$quebra_carrilid_orig][$quebra_turnoid_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->pagoid_ana = $Busca_temp['pagoid_ana']; 
       $this->pagoid_ana = (isset($Busca_temp['pagoid_ana'])) ? $Busca_temp['pagoid_ana'] : ""; 
       $tmp_pos = (is_string($this->pagoid_ana)) ? strpos($this->pagoid_ana, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->pagoid_ana))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('CarrilID_TurnoID', 'clasevehiculo_ana');
     $campos_order = $this->Ini->Get_date_order_groupby("ClaseVehiculo_ANA", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('CarrilID_TurnoID', 'carrilid');
     $campos_order = $this->Ini->Get_date_order_groupby("CarrilID", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('CarrilID_TurnoID', 'turnoid');
     $campos_order = $this->Ini->Get_date_order_groupby("TurnoID", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->casetaid = $rs_res->fields[0] ;  
            $this->fechaoperacion = $rs_res->fields[1] ;  
            $this->fechaturno = $rs_res->fields[2] ;  
            $this->turnoid = $rs_res->fields[3] ;  
            $this->horaevento = $rs_res->fields[4] ;  
            $this->carrilid = $rs_res->fields[5] ;  
            $this->cuerpo = $rs_res->fields[6] ;  
            $this->vehiculoid_ana = $rs_res->fields[7] ;  
            $this->clasevehiculo_ana = $rs_res->fields[8] ;  
            $this->importe_ana = $rs_res->fields[9] ;  
            $this->importe_ana =  str_replace(",", ".", $this->importe_ana);
            $this->pagoid_ana = $rs_res->fields[10] ;  
            $this->estatusana = $rs_res->fields[11] ;  
            $this->tarifaee_ana = $rs_res->fields[12] ;  
            $this->tarifaee_ana =  str_replace(",", ".", $this->tarifaee_ana);
            $this->impana = $rs_res->fields[13] ;  
            $this->impana =  str_replace(",", ".", $this->impana);
            $this->consecutivo = $rs_res->fields[14] ;  
            $this->clasevehiculo_ana_orig = $this->clasevehiculo_ana;
            $this->carrilid_orig = $this->carrilid;
            $this->turnoid_orig = $this->turnoid;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->clasevehiculo_ana, $this->carrilid, $this->turnoid, $this->clasevehiculo_ana_orig,  $this->carrilid_orig,  $this->turnoid_orig);
            }
   }
//
