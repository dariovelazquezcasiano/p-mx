<?php
@session_start() ;
$_SESSION['scriptcase']['grid_aforocuadra']['sc_process_barr'] = true;
require_once('../grid_aforocuadra/index.php');
unset($_SESSION['scriptcase']['grid_aforocuadra']['sc_process_barr']);
$ExportCtrl = new grid_aforocuadra_export_control;
$ExportCtrl->Export_barr();

class grid_aforocuadra_export_control
{
