...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "Fecha";$Nm_numeric[] = "id";$Nm_numeric[] = "casetaid";$Nm_numeric[] = "carrilid";$Nm_numeric[] = "alarmaid";
...
?>
   <span id="idAjaxSelect_carrilid">
      <SELECT class="scFilterObjectEven" id="SC_carrilid" name="carrilid" onChange="nm_submit_form();" size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estadodispositivos2']['opc_psq'])
   {
       ...
       {
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bvoltar", "self.parent.tb_remove();", "self.parent.tb_remove();", "sai_fields_right", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
       }
       else
