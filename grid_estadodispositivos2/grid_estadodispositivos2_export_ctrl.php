<?php
@session_start() ;
$_SESSION['scriptcase']['grid_estadodispositivos2']['sc_process_barr'] = true;
require_once('../grid_estadodispositivos2/index.php');
unset($_SESSION['scriptcase']['grid_estadodispositivos2']['sc_process_barr']);
$ExportCtrl = new grid_estadodispositivos2_export_control;
$ExportCtrl->Export_barr();

class grid_estadodispositivos2_export_control
{
