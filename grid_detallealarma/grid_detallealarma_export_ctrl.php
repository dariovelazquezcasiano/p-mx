<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallealarma']['sc_process_barr'] = true;
require_once('../grid_detallealarma/index.php');
unset($_SESSION['scriptcase']['grid_detallealarma']['sc_process_barr']);
$ExportCtrl = new grid_detallealarma_export_control;
$ExportCtrl->Export_barr();

class grid_detallealarma_export_control
{
