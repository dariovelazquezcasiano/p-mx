...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detallealarma"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detallealarma"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallealarma']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallealarma']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallealarma</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallealarma']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallealarma']['embutida_filho'] as $ind => $sc_init)
          {
