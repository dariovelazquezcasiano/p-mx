  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_carril" == sTestField)
        {
...
?>
  ...
  // ---------- Validate casetaid_
  function do_ajax_form_carril_validate_casetaid_(iNumLinha)
  {
    var nomeCampo_casetaid_ = "casetaid_" + iNumLinha;
    var var_casetaid_ = scAjaxGetFieldSelect(nomeCampo_casetaid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_casetaid_(var_casetaid_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_casetaid__cb);
  } // do_ajax_form_carril_validate_casetaid_

  function do_ajax_form_carril_validate_casetaid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "casetaid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "casetaid_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "casetaid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "casetaid_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_casetaid__cb

  // ---------- Validate carrilid_
  function do_ajax_form_carril_validate_carrilid_(iNumLinha)
  {
    var nomeCampo_carrilid_ = "carrilid_" + iNumLinha;
    var var_carrilid_ = scAjaxGetFieldText(nomeCampo_carrilid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_carrilid_(var_carrilid_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_carrilid__cb);
  } // do_ajax_form_carril_validate_carrilid_

  function do_ajax_form_carril_validate_carrilid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "carrilid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "carrilid_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "carrilid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "carrilid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_carrilid__cb

  // ---------- Validate carrilnacional_
  function do_ajax_form_carril_validate_carrilnacional_(iNumLinha)
  {
    var nomeCampo_carrilnacional_ = "carrilnacional_" + iNumLinha;
    var var_carrilnacional_ = scAjaxGetFieldText(nomeCampo_carrilnacional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_carrilnacional_(var_carrilnacional_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_carrilnacional__cb);
  } // do_ajax_form_carril_validate_carrilnacional_

  function do_ajax_form_carril_validate_carrilnacional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "carrilnacional_" + iLineNumber;
    }
    else
    {
      sFieldValid = "carrilnacional_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "carrilnacional_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "carrilnacional_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_carrilnacional__cb

  // ---------- Validate cuerpo_
  function do_ajax_form_carril_validate_cuerpo_(iNumLinha)
  {
    var nomeCampo_cuerpo_ = "cuerpo_" + iNumLinha;
    var var_cuerpo_ = scAjaxGetFieldRadio(nomeCampo_cuerpo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_cuerpo_(var_cuerpo_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_cuerpo__cb);
  } // do_ajax_form_carril_validate_cuerpo_

  function do_ajax_form_carril_validate_cuerpo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cuerpo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cuerpo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cuerpo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cuerpo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_cuerpo__cb

  // ---------- Validate toperetiro_
  function do_ajax_form_carril_validate_toperetiro_(iNumLinha)
  {
    var nomeCampo_toperetiro_ = "toperetiro_" + iNumLinha;
    var var_toperetiro_ = scAjaxGetFieldText(nomeCampo_toperetiro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_toperetiro_(var_toperetiro_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_toperetiro__cb);
  } // do_ajax_form_carril_validate_toperetiro_

  function do_ajax_form_carril_validate_toperetiro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "toperetiro_" + iLineNumber;
    }
    else
    {
      sFieldValid = "toperetiro_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "toperetiro_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "toperetiro_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_toperetiro__cb

  // ---------- Validate tramoid_
  function do_ajax_form_carril_validate_tramoid_(iNumLinha)
  {
    var nomeCampo_tramoid_ = "tramoid_" + iNumLinha;
    var var_tramoid_ = scAjaxGetFieldSelect(nomeCampo_tramoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_tramoid_(var_tramoid_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_tramoid__cb);
  } // do_ajax_form_carril_validate_tramoid_

  function do_ajax_form_carril_validate_tramoid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tramoid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tramoid_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tramoid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tramoid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_tramoid__cb

  // ---------- Validate v1_
  function do_ajax_form_carril_validate_v1_(iNumLinha)
  {
    var nomeCampo_v1_ = "v1_" + iNumLinha;
    var var_v1_ = scAjaxGetFieldText(nomeCampo_v1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_v1_(var_v1_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_v1__cb);
  } // do_ajax_form_carril_validate_v1_

  function do_ajax_form_carril_validate_v1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "v1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "v1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_v1__cb

  // ---------- Validate v2_
  function do_ajax_form_carril_validate_v2_(iNumLinha)
  {
    var nomeCampo_v2_ = "v2_" + iNumLinha;
    var var_v2_ = scAjaxGetFieldText(nomeCampo_v2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_v2_(var_v2_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_v2__cb);
  } // do_ajax_form_carril_validate_v2_

  function do_ajax_form_carril_validate_v2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "v2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "v2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_v2__cb

  // ---------- Validate v3_
  function do_ajax_form_carril_validate_v3_(iNumLinha)
  {
    var nomeCampo_v3_ = "v3_" + iNumLinha;
    var var_v3_ = scAjaxGetFieldText(nomeCampo_v3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_v3_(var_v3_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_v3__cb);
  } // do_ajax_form_carril_validate_v3_

  function do_ajax_form_carril_validate_v3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "v3_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "v3_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_v3__cb

  // ---------- Validate esexclusivo_
  function do_ajax_form_carril_validate_esexclusivo_(iNumLinha)
  {
    var nomeCampo_esexclusivo_ = "esexclusivo_" + iNumLinha;
    var var_esexclusivo_ = scAjaxGetFieldSelect(nomeCampo_esexclusivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_esexclusivo_(var_esexclusivo_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_esexclusivo__cb);
  } // do_ajax_form_carril_validate_esexclusivo_

  function do_ajax_form_carril_validate_esexclusivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "esexclusivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "esexclusivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "esexclusivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "esexclusivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_esexclusivo__cb

  // ---------- Validate ip_
  function do_ajax_form_carril_validate_ip_(iNumLinha)
  {
    var nomeCampo_ip_ = "ip_" + iNumLinha;
    var var_ip_ = scAjaxGetFieldText(nomeCampo_ip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_validate_ip_(var_ip_, iNumLinha, var_script_case_init, do_ajax_form_carril_validate_ip__cb);
  } // do_ajax_form_carril_validate_ip_

  function do_ajax_form_carril_validate_ip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ip_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ip_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_carril_validate_ip__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_carril_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_carril_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_carril_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_carril_add_new_line_cb);
  } // do_ajax_form_carril_add_new_line

  function do_ajax_form_carril_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_carril_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_carril_backup_line(iNumLinha)
  {
    var var_carrilid_ = scAjaxGetFieldText("carrilid_" + iNumLinha);
    var var_casetaid_ = scAjaxGetFieldSelect("casetaid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_carril_backup_line(var_carrilid_, var_casetaid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_carril_backup_line_cb);
  } // do_ajax_form_carril_backup_line

  function do_ajax_form_carril_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_carril_backup_line_cb

  function do_ajax_form_carril_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_carril_cancel_insert

  function do_ajax_form_carril_cancel_update(iSeqVert)
  {
    do_ajax_form_carril_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_carril_cancel_update

  function do_ajax_form_carril_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_carril_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_carril_table_refresh()
  {
    var var_carrilid_ = document.F2.carrilid_.value;
    var var_casetaid_ = document.F2.casetaid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_carril_table_refresh(var_carrilid_, var_casetaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_carril_table_refresh_cb);
  } //  do_ajax_form_carril_table_refresh

  function do_ajax_form_carril_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.carrilid_.value = scAjaxGetKeyValue("carrilid_");
    document.F2.casetaid_.value = scAjaxGetKeyValue("casetaid_");
    ...
    scAjaxAlert(do_ajax_form_carril_table_refresh_cb_after_alert);
  } // do_ajax_form_carril_table_refresh_cb
  function do_ajax_form_carril_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_carril_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_carril_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_carril_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_casetaid_ = scAjaxGetFieldSelect("casetaid_" + iNumLinha);
    var var_carrilid_ = scAjaxGetFieldText("carrilid_" + iNumLinha);
    var var_carrilnacional_ = scAjaxGetFieldText("carrilnacional_" + iNumLinha);
    var var_cuerpo_ = scAjaxGetFieldRadio("cuerpo_" + iNumLinha);
    var var_toperetiro_ = scAjaxGetFieldText("toperetiro_" + iNumLinha);
    var var_tramoid_ = scAjaxGetFieldSelect("tramoid_" + iNumLinha);
    var var_v1_ = scAjaxGetFieldText("v1_" + iNumLinha);
    var var_v2_ = scAjaxGetFieldText("v2_" + iNumLinha);
    var var_v3_ = scAjaxGetFieldText("v3_" + iNumLinha);
    var var_esexclusivo_ = scAjaxGetFieldSelect("esexclusivo_" + iNumLinha);
    var var_ip_ = scAjaxGetFieldText("ip_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_carril_submit_form(var_casetaid_, var_carrilid_, var_carrilnacional_, var_cuerpo_, var_toperetiro_, var_tramoid_, var_v1_, var_v2_, var_v3_, var_esexclusivo_, var_ip_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_carril_submit_form_cb);
  } // do_ajax_form_carril_submit_form

  function do_ajax_form_carril_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("casetaid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("carrilid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("carrilnacional_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cuerpo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("toperetiro_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tramoid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("v1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("v2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("v3_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("esexclusivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ip_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_carril_submit_form_cb_after_alert);
  } // do_ajax_form_carril_submit_form_cb
  function do_ajax_form_carril_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_carril_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_carril_navigate_form()
  {
    perform_ajax_form_carril_navigate_form();
  }

  function perform_ajax_form_carril_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_carril_cancel_insert(sc_form_carril_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("casetaid_" + iNavForm);
      scAjaxHideErrorDisplay("carrilid_" + iNavForm);
      scAjaxHideErrorDisplay("carrilnacional_" + iNavForm);
      scAjaxHideErrorDisplay("cuerpo_" + iNavForm);
      scAjaxHideErrorDisplay("toperetiro_" + iNavForm);
      scAjaxHideErrorDisplay("tramoid_" + iNavForm);
      scAjaxHideErrorDisplay("v1_" + iNavForm);
      scAjaxHideErrorDisplay("v2_" + iNavForm);
      scAjaxHideErrorDisplay("v3_" + iNavForm);
      scAjaxHideErrorDisplay("esexclusivo_" + iNavForm);
      scAjaxHideErrorDisplay("ip_" + iNavForm);
    }
    var var_carrilid_ = document.F2.carrilid_.value;
    var var_casetaid_ = document.F2.casetaid_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_carril_navigate_form(var_carrilid_, var_casetaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_carril_navigate_form_cb);
  } // do_ajax_form_carril_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_carril']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_carril_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.carrilid_.value = scAjaxGetKeyValue("carrilid_" + var_last_index);
    document.F2.casetaid_.value = scAjaxGetKeyValue("casetaid_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_carril_navigate_form_cb_after_alert);
  } // do_ajax_form_carril_navigate_form_cb
  function do_ajax_form_carril_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_carril_navigate_form_cb_after_alert

    function sc_form_carril_get_last_line_number()
    {
    ...
    } //sc_form_carril_get_last_line_number

  function sc_hide_form_carril_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "casetaid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "carrilid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "carrilnacional_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cuerpo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "toperetiro_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tramoid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "v1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "v2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "v3_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "esexclusivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ip_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["casetaid_" + iNumLinha] = {"label": "Caseta ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["carrilid_" + iNumLinha] = {"label": "Carril<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["carrilnacional_" + iNumLinha] = {"label": "Carril Nacional<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cuerpo_" + iNumLinha] = {"label": "Cuerpo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["toperetiro_" + iNumLinha] = {"label": "Tope Retiro<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tramoid_" + iNumLinha] = {"label": "Tramo ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["v1_" + iNumLinha] = {"label": "V1<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["v2_" + iNumLinha] = {"label": "V2<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["v3_" + iNumLinha] = {"label": "V3<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["esexclusivo_" + iNumLinha] = {"label": "Es Exclusivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ip_" + iNumLinha] = {"label": "IP<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["casetaid_"][iNumLinha] = "casetaid_" + iNumLinha;
    ajax_field_mult["carrilid_"][iNumLinha] = "carrilid_" + iNumLinha;
    ajax_field_mult["carrilnacional_"][iNumLinha] = "carrilnacional_" + iNumLinha;
    ajax_field_mult["cuerpo_"][iNumLinha] = "cuerpo_" + iNumLinha;
    ajax_field_mult["toperetiro_"][iNumLinha] = "toperetiro_" + iNumLinha;
    ajax_field_mult["tramoid_"][iNumLinha] = "tramoid_" + iNumLinha;
    ajax_field_mult["v1_"][iNumLinha] = "v1_" + iNumLinha;
    ajax_field_mult["v2_"][iNumLinha] = "v2_" + iNumLinha;
    ajax_field_mult["v3_"][iNumLinha] = "v3_" + iNumLinha;
    ajax_field_mult["esexclusivo_"][iNumLinha] = "esexclusivo_" + iNumLinha;
    ajax_field_mult["ip_"][iNumLinha] = "ip_" + iNumLinha;
    ajax_field_id["casetaid_" + iNumLinha] = new Array("hidden_field_label_casetaid_", "hidden_field_data_casetaid_" + iNumLinha);
    ajax_field_id["carrilid_" + iNumLinha] = new Array("hidden_field_label_carrilid_", "hidden_field_data_carrilid_" + iNumLinha);
    ajax_field_id["carrilnacional_" + iNumLinha] = new Array("hidden_field_label_carrilnacional_", "hidden_field_data_carrilnacional_" + iNumLinha);
    ajax_field_id["cuerpo_" + iNumLinha] = new Array("hidden_field_label_cuerpo_", "hidden_field_data_cuerpo_" + iNumLinha);
    ajax_field_id["toperetiro_" + iNumLinha] = new Array("hidden_field_label_toperetiro_", "hidden_field_data_toperetiro_" + iNumLinha);
    ajax_field_id["tramoid_" + iNumLinha] = new Array("hidden_field_label_tramoid_", "hidden_field_data_tramoid_" + iNumLinha);
    ajax_field_id["v1_" + iNumLinha] = new Array("hidden_field_label_v1_", "hidden_field_data_v1_" + iNumLinha);
    ajax_field_id["v2_" + iNumLinha] = new Array("hidden_field_label_v2_", "hidden_field_data_v2_" + iNumLinha);
    ajax_field_id["v3_" + iNumLinha] = new Array("hidden_field_label_v3_", "hidden_field_data_v3_" + iNumLinha);
    ajax_field_id["esexclusivo_" + iNumLinha] = new Array("hidden_field_label_esexclusivo_", "hidden_field_data_esexclusivo_" + iNumLinha);
    ajax_field_id["ip_" + iNumLinha] = new Array("hidden_field_label_ip_", "hidden_field_data_ip_" + iNumLinha);
    ajax_error_count["casetaid_" + iNumLinha] = "off";
    ajax_error_count["carrilid_" + iNumLinha] = "off";
    ajax_error_count["carrilnacional_" + iNumLinha] = "off";
    ajax_error_count["cuerpo_" + iNumLinha] = "off";
    ajax_error_count["toperetiro_" + iNumLinha] = "off";
    ajax_error_count["tramoid_" + iNumLinha] = "off";
    ajax_error_count["v1_" + iNumLinha] = "off";
    ajax_error_count["v2_" + iNumLinha] = "off";
    ajax_error_count["v3_" + iNumLinha] = "off";
    ajax_error_count["esexclusivo_" + iNumLinha] = "off";
    ajax_error_count["ip_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["casetaid_" + iNumLinha] = "on";
    ajax_read_only["carrilid_" + iNumLinha] = "on";
    ajax_read_only["carrilnacional_" + iNumLinha] = "off";
    ajax_read_only["cuerpo_" + iNumLinha] = "off";
    ajax_read_only["toperetiro_" + iNumLinha] = "off";
    ajax_read_only["tramoid_" + iNumLinha] = "off";
    ajax_read_only["v1_" + iNumLinha] = "off";
    ajax_read_only["v2_" + iNumLinha] = "off";
    ajax_read_only["v3_" + iNumLinha] = "off";
    ajax_read_only["esexclusivo_" + iNumLinha] = "off";
    ajax_read_only["ip_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["casetaid_" + iNumLinha] = "on";
    ajax_read_only["carrilid_" + iNumLinha] = "on";
    ajax_read_only["carrilnacional_" + iNumLinha] = "on";
    ajax_read_only["cuerpo_" + iNumLinha] = "on";
    ajax_read_only["toperetiro_" + iNumLinha] = "on";
    ajax_read_only["tramoid_" + iNumLinha] = "on";
    ajax_read_only["v1_" + iNumLinha] = "on";
    ajax_read_only["v2_" + iNumLinha] = "on";
    ajax_read_only["v3_" + iNumLinha] = "on";
    ajax_read_only["esexclusivo_" + iNumLinha] = "on";
    ajax_read_only["ip_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["casetaid_" + iNumLinha] = null;
    ajax_error_list["carrilid_" + iNumLinha] = null;
    ajax_error_list["carrilnacional_" + iNumLinha] = null;
    ajax_error_list["cuerpo_" + iNumLinha] = null;
    ajax_error_list["toperetiro_" + iNumLinha] = null;
    ajax_error_list["tramoid_" + iNumLinha] = null;
    ajax_error_list["v1_" + iNumLinha] = null;
    ajax_error_list["v2_" + iNumLinha] = null;
    ajax_error_list["v3_" + iNumLinha] = null;
    ajax_error_list["esexclusivo_" + iNumLinha] = null;
    ajax_error_list["ip_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "casetaid_": new Array(),
    "carrilid_": new Array(),
    "carrilnacional_": new Array(),
    "cuerpo_": new Array(),
    "toperetiro_": new Array(),
    "tramoid_": new Array(),
    "v1_": new Array(),
    "v2_": new Array(),
    "v3_": new Array(),
    "esexclusivo_": new Array(),
    "ip_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["casetaid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["casetaid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["casetaid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["casetaid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["casetaid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["carrilid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["carrilid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["carrilid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["carrilid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["carrilid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["carrilnacional_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["carrilnacional_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["carrilnacional_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["carrilnacional_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["carrilnacional_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cuerpo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cuerpo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cuerpo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cuerpo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cuerpo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["toperetiro_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["toperetiro_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["toperetiro_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["toperetiro_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["toperetiro_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tramoid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tramoid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tramoid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tramoid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tramoid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["v1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["v1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["v1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["v1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["v1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["v2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["v2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["v2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["v2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["v2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["v3_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["v3_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["v3_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["v3_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["v3_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["esexclusivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["esexclusivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["esexclusivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["esexclusivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["esexclusivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ip_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ip_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ip_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ip_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ip_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['casetaid_'])) ? $this->nmgp_cmp_readonly['casetaid_'] : 'on';
?>
    scAjaxFieldRead("casetaid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['carrilid_'])) ? $this->nmgp_cmp_readonly['carrilid_'] : 'on';
?>
    scAjaxFieldRead("carrilid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['carrilnacional_'])) ? $this->nmgp_cmp_readonly['carrilnacional_'] : 'off';
?>
    scAjaxFieldRead("carrilnacional_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cuerpo_'])) ? $this->nmgp_cmp_readonly['cuerpo_'] : 'off';
?>
    scAjaxFieldRead("cuerpo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['toperetiro_'])) ? $this->nmgp_cmp_readonly['toperetiro_'] : 'off';
?>
    scAjaxFieldRead("toperetiro_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tramoid_'])) ? $this->nmgp_cmp_readonly['tramoid_'] : 'off';
?>
    scAjaxFieldRead("tramoid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['v1_'])) ? $this->nmgp_cmp_readonly['v1_'] : 'off';
?>
    scAjaxFieldRead("v1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['v2_'])) ? $this->nmgp_cmp_readonly['v2_'] : 'off';
?>
    scAjaxFieldRead("v2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['v3_'])) ? $this->nmgp_cmp_readonly['v3_'] : 'off';
?>
    scAjaxFieldRead("v3_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['esexclusivo_'])) ? $this->nmgp_cmp_readonly['esexclusivo_'] : 'off';
?>
    scAjaxFieldRead("esexclusivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ip_'])) ? $this->nmgp_cmp_readonly['ip_'] : 'off';
?>
    scAjaxFieldRead("ip_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("casetaid_" + iSeq, "on");
    scAjaxFieldRead("carrilid_" + iSeq, "on");
    scAjaxFieldRead("carrilnacional_" + iSeq, "on");
    scAjaxFieldRead("cuerpo_" + iSeq, "on");
    scAjaxFieldRead("toperetiro_" + iSeq, "on");
    scAjaxFieldRead("tramoid_" + iSeq, "on");
    scAjaxFieldRead("v1_" + iSeq, "on");
    scAjaxFieldRead("v2_" + iSeq, "on");
    scAjaxFieldRead("v3_" + iSeq, "on");
    scAjaxFieldRead("esexclusivo_" + iSeq, "on");
    scAjaxFieldRead("ip_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["casetaid_" + iRow] || "on" == ajax_error_count["carrilid_" + iRow] || "on" == ajax_error_count["carrilnacional_" + iRow] || "on" == ajax_error_count["cuerpo_" + iRow] || "on" == ajax_error_count["toperetiro_" + iRow] || "on" == ajax_error_count["tramoid_" + iRow] || "on" == ajax_error_count["v1_" + iRow] || "on" == ajax_error_count["v2_" + iRow] || "on" == ajax_error_count["v3_" + iRow] || "on" == ajax_error_count["esexclusivo_" + iRow] || "on" == ajax_error_count["ip_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_casetaid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_carrilid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_carrilnacional_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cuerpo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_toperetiro_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tramoid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_v1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_v2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_v3_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_esexclusivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ip_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["casetaid_" + iRow] && "off" == ajax_error_count["carrilid_" + iRow] && "off" == ajax_error_count["carrilnacional_" + iRow] && "off" == ajax_error_count["cuerpo_" + iRow] && "off" == ajax_error_count["toperetiro_" + iRow] && "off" == ajax_error_count["tramoid_" + iRow] && "off" == ajax_error_count["v1_" + iRow] && "off" == ajax_error_count["v2_" + iRow] && "off" == ajax_error_count["v3_" + iRow] && "off" == ajax_error_count["esexclusivo_" + iRow] && "off" == ajax_error_count["ip_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["casetaid_" + iRow] = "off";
        ajax_error_count["carrilid_" + iRow] = "off";
        ajax_error_count["carrilnacional_" + iRow] = "off";
        ajax_error_count["cuerpo_" + iRow] = "off";
        ajax_error_count["toperetiro_" + iRow] = "off";
        ajax_error_count["tramoid_" + iRow] = "off";
        ajax_error_count["v1_" + iRow] = "off";
        ajax_error_count["v2_" + iRow] = "off";
        ajax_error_count["v3_" + iRow] = "off";
        ajax_error_count["esexclusivo_" + iRow] = "off";
        ajax_error_count["ip_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_casetaid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_carrilid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_carrilnacional_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cuerpo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_toperetiro_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tramoid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_v1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_v2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_v3_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_esexclusivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ip_" + iRow).removeClass("scFormErrorLine");
    }
  }
