<?php
include_once('menu_emergente_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_emergente']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_emergente']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_emergente']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_emergente_class
{
  var $Db;
 ...
 function menu_emergente_menu()
 {
    global $menu_emergente_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_emergente']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_emergente/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_emergente');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_emergente_erro.php");
}
include_once(dirname(__FILE__) . "/menu_emergente_erro.class.php"); 
$this->Erro = new menu_emergente_erro();
$str_path = substr($_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_emergente']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_emergente_menuData         = array();
$menu_emergente_menuData['path'] = array();
$menu_emergente_menuData['url']  = array();
$menu_emergente_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_emergente_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_emergente_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_emergente_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_emergente_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_emergente_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_emergente_menuData['url']['web']   = str_replace("\\", '/', $menu_emergente_menuData['url']['web']);
$menu_emergente_menuData['path']['root'] = substr($menu_emergente_menuData['path']['sys'],  0, -1 * strlen($menu_emergente_menuData['url']['web']));
$menu_emergente_menuData['path']['app']  = substr($menu_emergente_menuData['path']['sys'],  0, strrpos($menu_emergente_menuData['path']['sys'],  '/'));
$menu_emergente_menuData['path']['link'] = substr($menu_emergente_menuData['path']['app'],  0, strrpos($menu_emergente_menuData['path']['app'],  '/'));
$menu_emergente_menuData['path']['link'] = substr($menu_emergente_menuData['path']['link'], 0, strrpos($menu_emergente_menuData['path']['link'], '/')) . '/';
$menu_emergente_menuData['path']['app'] .= '/';
$menu_emergente_menuData['url']['app']   = substr($menu_emergente_menuData['url']['web'],  0, strrpos($menu_emergente_menuData['url']['web'],  '/'));
$menu_emergente_menuData['url']['link']  = substr($menu_emergente_menuData['url']['app'],  0, strrpos($menu_emergente_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] == "S")
{
    $menu_emergente_menuData['url']['link']  = substr($menu_emergente_menuData['url']['link'], 0, strrpos($menu_emergente_menuData['url']['link'], '/'));
}
$menu_emergente_menuData['url']['link']  .= '/';
$menu_emergente_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_emergente']['sc_apl_link'] = $menu_emergente_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_emergente']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_emergente']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_emergente']['actual_lang']) || $_SESSION['scriptcase']['menu_emergente']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_emergente']['actual_lang'] = $this->str_lang;
...
include_once("menu_emergente_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_emergente";
     $_SESSION['scriptcase']['menu_apls']['menu_emergente'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_emergente']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_emergente']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_emergente']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_emergente']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_emergente']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_emergente']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_emergente']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_emergente']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_emergente']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_emergente']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_emergente']['init']))
{
    $_SESSION['sc_session'][1]['menu_emergente']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_emergente']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_emergente'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_emergente'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_emergente'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_emergente'] = "on";
} 
if (!isset($_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_emergente']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_emergente'] != "on"))
{ 
...
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
      $_SESSION['scriptcase']['menu_emergente']['contr_erro'] = 'on';
if (!isset($_SESSION['fld_modulo'])) {$_SESSION['fld_modulo'] = "";}
if (!isset($this->sc_temp_fld_modulo)) {$this->sc_temp_fld_modulo = (isset($_SESSION['fld_modulo'])) ? $_SESSION['fld_modulo'] : "";}
...
if($this->sc_temp_sm_global_login == ''){
 ...
 if (isset($this->sc_temp_fld_modulo)) {$_SESSION['fld_modulo'] = $this->sc_temp_fld_modulo;}
 if (!isset($Campos_Mens_erro) || empty($Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($menu_emergente_menuData['url']['link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('app_login') . "/", "menu_emergente.php", "","_self", 440, 630);
 }}
unset($_SESSION['scriptcase']['sc_menu_del']['menu_emergente']);switch ($this->sc_temp_fld_modulo) {
    case 1://Administracion usuario
		$NM_tmp_del = 'item_17';
...
{
    $_SESSION['scriptcase']['sc_menu_del']['menu_emergente'][] = trim($Cada_del);
}
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_emergente'))
{
    $_SESSION['sc_session'][1]['menu_emergente']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_emergente'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_emergente_menuData['iframe'] = TRUE;
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("control_preturno") . "/control_preturno_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_preturno']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['control_preturno'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("control_pre_dia") . "/control_pre_dia_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_pre_dia']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['control_pre_dia'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("control_auditoria") . "/control_auditoria_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_auditoria']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['control_auditoria'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("control_liqu_dia") . "/control_liqu_dia_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_liqu_dia']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['control_liqu_dia'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_sec_users") . "/grid_sec_users_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sec_users']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_sec_users'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
		...
		function getDatabaseMessage(){
			...
			request.done(function(response){
				...
				if(total>0){
					...
					$(".show-on-hover").css("pointer-events","");
					$.each(response, function( index, value ) {
  						display_local = "Hora: "+value.Hora+"<br> Carril: "+value.Carril+"<br>"+value.Mensaje;
						cont_local = '<a href="#" class="list-group-item list-group-item-action">'+display_local+'</a>';
						content = content + cont_local+"\n";
					});
					$("#dropdow-main").html(content);
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Pre Liquidación Carril";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Pre Liquidación Turno";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "Pre Liquidación Día";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[16]))
{
 ...
 $nm_var_lab[17] = "Categorias de pago";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_emergente'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['portada']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['portada']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|menu_emergente_form_php.php?sc_item_menu=item_1&sc_apl_menu=portada&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
$menu_emergente_menuData['data'] .= "item_12|.|" . $nm_var_lab[1] . "||" . $nm_var_hint[1] . "|grp__NM__ico__NM__Auditoria.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_detalleturno']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_detalleturno']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_2|..|" . $nm_var_lab[2] . "|menu_emergente_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_detalleturno&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_2|..|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['control_preturno']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_preturno']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_13|..|" . $nm_var_lab[3] . "|menu_emergente_form_php.php?sc_item_menu=item_13&sc_apl_menu=control_preturno&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_13|..|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['control_pre_dia']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_pre_dia']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_3|..|" . $nm_var_lab[4] . "|menu_emergente_form_php.php?sc_item_menu=item_3&sc_apl_menu=control_pre_dia&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_3|..|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
$menu_emergente_menuData['data'] .= "item_14|.|" . $nm_var_lab[5] . "||" . $nm_var_hint[5] . "|grp__NM__ico__NM__Datos-jimenez.png|_self|\n";
...
{
    $menu_emergente_menuData['data'] .= "item_4|..|" . $nm_var_lab[6] . "|menu_emergente_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_eventos_resumen&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_4|..|" . $nm_var_lab[6] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_trafico']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_trafico']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_5|..|" . $nm_var_lab[7] . "|menu_emergente_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_trafico&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_5|..|" . $nm_var_lab[7] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_eventos_min']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_eventos_min']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_6|..|" . $nm_var_lab[8] . "|menu_emergente_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_eventos_min&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_6|..|" . $nm_var_lab[8] . "||||_self|disabled\n";
}
...
{
    $menu_emergente_menuData['data'] .= "item_11|..|" . $nm_var_lab[9] . "|menu_emergente_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_detallealarma_dia&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_11|..|" . $nm_var_lab[9] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['control_auditoria']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_auditoria']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_7|.|" . $nm_var_lab[10] . "|menu_emergente_form_php.php?sc_item_menu=item_7&sc_apl_menu=control_auditoria&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "|grp__NM__ico__NM__Editar1.png|" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_7|.|" . $nm_var_lab[10] . "|||grp__NM__ico__NM__Editar1.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['control_liqu_dia']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_liqu_dia']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_15|.|" . $nm_var_lab[11] . "|menu_emergente_form_php.php?sc_item_menu=item_15&sc_apl_menu=control_liqu_dia&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "|grp__NM__ico__NM__Registros-auditados.png|" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_15|.|" . $nm_var_lab[11] . "|||grp__NM__ico__NM__Registros-auditados.png|_self|disabled\n";
}
...
{
    $menu_emergente_menuData['data'] .= "item_8|.|" . $nm_var_lab[12] . "|menu_emergente_form_php.php?sc_item_menu=item_8&sc_apl_menu=control_cfacturacion&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "|grp__NM__ico__NM__Download1.png|" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_8|.|" . $nm_var_lab[12] . "|||grp__NM__ico__NM__Download1.png|_self|disabled\n";
}
$menu_emergente_menuData['data'] .= "item_17|.|" . $nm_var_lab[13] . "||" . $nm_var_hint[13] . "|grp__NM__ico__NM__Configuracion.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_usuario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_usuario']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_9|..|" . $nm_var_lab[14] . "|menu_emergente_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_usuario&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[14] . "|grp__NM__ico__NM__user.png|" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_9|..|" . $nm_var_lab[14] . "|||grp__NM__ico__NM__user.png|_self|disabled\n";
}
...
{
    $menu_emergente_menuData['data'] .= "item_16|..|" . $nm_var_lab[15] . "|menu_emergente_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_tarifasPeriodo&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "|scriptcase__NM__ico__NM__symbol_dollar_16.png|" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_16|..|" . $nm_var_lab[15] . "|||scriptcase__NM__ico__NM__symbol_dollar_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_categoria']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_categoria']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_18|..|" . $nm_var_lab[16] . "|menu_emergente_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_categoria&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_18|..|" . $nm_var_lab[16] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipopago']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipopago']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_19|..|" . $nm_var_lab[17] . "|menu_emergente_form_php.php?sc_item_menu=item_19&sc_apl_menu=form_tipopago&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[17] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_19|..|" . $nm_var_lab[17] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sec_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_sec_users']) == "on")
{
    $menu_emergente_menuData['data'] .= "item_20|..|" . $nm_var_lab[18] . "|menu_emergente_form_php.php?sc_item_menu=item_20&sc_apl_menu=grid_sec_users&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[18] . "||" . $this->menu_emergente_target('_self') . "|" . "\n";
}
else
{
    $menu_emergente_menuData['data'] .= "item_20|..|" . $nm_var_lab[18] . "||||_self|disabled\n";
}
$menu_emergente_menuData['data'] .= "item_21|.|" . $nm_var_lab[19] . "||" . $nm_var_hint[19] . "|scriptcase__NM__ico__NM__exit_24.png|_self|\n";
...
$menu_emergente_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_1&sc_apl_menu=portada&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['portada']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['portada']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_emergente_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_emergente_target('_self') . "\"",
        'sc_id'    => "item_1",
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__Auditoria.png";
$icon_aba = "";
$icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_detalleturno&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_detalleturno']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_detalleturno']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_13&sc_apl_menu=control_preturno&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_preturno']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_preturno']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_3&sc_apl_menu=control_pre_dia&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_pre_dia']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_pre_dia']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__Datos-jimenez.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_eventos_resumen&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_eventos_resumen']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_eventos_resumen']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_trafico&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_trafico']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_trafico']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_eventos_min&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_eventos_min']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_eventos_min']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_detallealarma_dia&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_detallealarma_dia']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_detallealarma_dia']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_7&sc_apl_menu=control_auditoria&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_auditoria']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_auditoria']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "grp__NM__ico__NM__Editar1.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
    {
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_15&sc_apl_menu=control_liqu_dia&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_liqu_dia']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_liqu_dia']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "grp__NM__ico__NM__Registros-auditados.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
    {
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_8&sc_apl_menu=control_cfacturacion&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_cfacturacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_cfacturacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "grp__NM__ico__NM__Download1.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($icon_aba) && isset($arr_menuicons['contr']['active']))
    {
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_usuario&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_usuario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_usuario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "grp__NM__ico__NM__user.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($icon_aba) && isset($arr_menuicons['cons']['active']))
    {
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_tarifasPeriodo&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tarifasPeriodo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tarifasPeriodo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__symbol_dollar_16.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($icon_aba) && isset($arr_menuicons['cons']['active']))
    {
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_categoria&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_categoria']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_categoria']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_19&sc_apl_menu=form_tipopago&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipopago']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipopago']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_emergente_form_php.php?sc_item_menu=item_20&sc_apl_menu=grid_sec_users&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_emergente']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_emergente']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_emergente');
    $menu_emergente_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_emergente_help.txt"))
{
    $Arq_WebHelp = file("menu_emergente_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_emergente_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_emergente_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_emergente']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_emergente']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_emergente_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_emergente']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_emergente_menuData['data'][$i_menu]);
       }
    ...
    $menu_emergente_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_emergente']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_emergente']))
{
    $disable_menu = false;
    foreach ($menu_emergente_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_emergente']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_emergente_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($menu_emergente_menuData['iframe'])
{
    $menu_emergente_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/grp_Scriptcase_TKZ2_<?php echo ($this->menu_orientacao!='vertical')?'hor':'vert'; ?>_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "grp_Scriptcase_TKZ2" . '_' . (($this->menu_orientacao!='vertical')?'hor':'vert') . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "grp_Scriptcase_TKZ2" . '_' . (($this->menu_orientacao=='horizontal')?'hor':'vert') . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
{
    $menu_emergente_menuData['height'] = '30px';
}
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="menu_emergente_message.js"></script>
...
Iframe_atual = "menu_emergente_iframe";
...
{
  if (str_id != "iframe_menu_emergente")
  {
      str_id        = str_id.replace("menu_emergente_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_emergente', 'menu_emergente');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_menu_emergente').length)
        $('#iframe_menu_emergente')[0].contentWindow.focus();
  }
}
</script>
<?php
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        <TD align="left" rowspan="3" class="scMenuHHeaderFont">
             <IMG SRC="<?php echo $path_imag_cab ?>/grp__NM__img__NM__tkz_system.png" BORDER="0"/>
        </TD>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_emergente_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->menu_emergente_escreveMenu($menu_emergente_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_emergente_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_emergente');\" item-href=\"menu_emergente_form_php.php?sc_item_menu=menu_emergente&sc_apl_menu=portada&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_emergente_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_emergente_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_emergente" name="menu_emergente_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
<div style="width: 100%; height:20px;" class="scMenuHFooter">
        ...
        <span class="scMenuHFooterFont" id="rod_col2"><?php echo "Usuario:  " . $_SESSION['fld_usuarios'] . "" ?></span>
</div>    </td>
  </tr>
</table>
</body>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_emergente').click()";
    echo "</script>";
}
...
/* Control de Target */
function menu_emergente_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
?>
        <td class='sc-layer-1' style='width:5%;text-align:left;'>
...
function menu_emergente_target($str_target)
{
    global $menu_emergente_menuData;
    ...
    elseif ($menu_emergente_menuData['iframe'])
    {
        return 'menu_emergente_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_emergente_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_emergente_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_emergente_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_emergente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_emergente']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_emergente_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_emergente']['sc_init'][$apl_menu] = 1;
        return  1;
   }
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0)
   {
      ...
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][1]['menu_emergente'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      {
          $nm_apl_dest = str_replace(".php", "", $nm_apl_dest);
          $nm_apl_dest = $menu_emergente_menuData['url']['link'] . $this->tab_grupo[0] .$nm_apl_dest . "/" . $nm_apl_dest . ".php";
      }
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_emergente']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_emergente") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_emergente']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
            $_SESSION['scriptcase']['menu_emergente']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
        }
    }
}
...
$contr_menu_emergente = new menu_emergente_class;
$contr_menu_emergente->menu_emergente_menu();
