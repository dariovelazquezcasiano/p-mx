...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_emergente"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>rhino_tkz/rhino_tkz_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>rhino_tkz/rhino_tkz_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_emergente"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_emergente"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_emergente_menuData["data"]) && is_array($menu_emergente_menuData["data"]) && !empty($menu_emergente_menuData["data"]))
    {
        foreach($menu_emergente_menuData["data"] as $arr_item)
        {
   ...
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($menu_emergente_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
