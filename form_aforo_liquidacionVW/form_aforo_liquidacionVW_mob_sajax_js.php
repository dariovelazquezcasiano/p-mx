  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aforo_liquidacionVW_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aforo_liquidacionVW_mob_form();
	}
...
?>
  ...
  function do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculocorrecto()
  {
    ...
    x_ajax_form_aforo_liquidacionVW_mob_validate_vehiculocorrecto(var_vehiculocorrecto, var_script_case_init, do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculocorrecto_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculocorrecto

  function do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculocorrecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculocorrecto_cb

  // ---------- Validate pagoid_ana
  function do_ajax_form_aforo_liquidacionVW_mob_validate_pagoid_ana()
  {
    var nomeCampo_pagoid_ana = "pagoid_ana";
    var var_pagoid_ana = scAjaxGetFieldHidden(nomeCampo_pagoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionVW_mob_validate_pagoid_ana(var_pagoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionVW_mob_validate_pagoid_ana_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_validate_pagoid_ana

  function do_ajax_form_aforo_liquidacionVW_mob_validate_pagoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionVW_mob_validate_pagoid_ana_cb

  // ---------- Validate vehiculoid_ana
  function do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculoid_ana()
  {
    var nomeCampo_vehiculoid_ana = "vehiculoid_ana";
    var var_vehiculoid_ana = scAjaxGetFieldHidden(nomeCampo_vehiculoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionVW_mob_validate_vehiculoid_ana(var_vehiculoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculoid_ana_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculoid_ana

  function do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionVW_mob_validate_vehiculoid_ana_cb

  // ---------- Event onchange pagoid_ana
  function do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange()
  {
    var var_pagoid_ana = scAjaxGetFieldHidden("pagoid_ana");
    var var_vehiculoid_ana = scAjaxGetFieldHidden("vehiculoid_ana");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange(var_pagoid_ana, var_vehiculoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange

  function do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pagoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange_cb
  function do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionVW_mob_event_pagoid_ana_onchange_cb_after_alert

  // ---------- Event onclick vehiculocorrecto
  function do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick(var_vehiculocorrecto, var_vehiculoid_ana, var_pagoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick

  function do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculocorrecto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick_cb
  function do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionVW_mob_event_vehiculocorrecto_onclick_cb_after_alert

  // ---------- Event onchange vehiculoid_ana
  function do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange()
  {
    var var_pagoid_ana = scAjaxGetFieldHidden("pagoid_ana");
    var var_vehiculoid_ana = scAjaxGetFieldHidden("vehiculoid_ana");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange(var_pagoid_ana, var_vehiculoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange

  function do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange_cb
  function do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionVW_mob_event_vehiculoid_ana_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_aforo_liquidacionVW_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aforo_liquidacionVW_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_vehiculocorrecto = scAjaxGetFieldRadio("vehiculocorrecto");
    ...
    scAjaxProcOn();
    x_ajax_form_aforo_liquidacionVW_mob_submit_form(var_vehiculocorrecto, var_pagoid_ana, var_vehiculoid_ana, var_consecutivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aforo_liquidacionVW_mob_submit_form_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_submit_form

  function do_ajax_form_aforo_liquidacionVW_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aforo_liquidacionVW_mob_submit_form_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionVW_mob_submit_form_cb
  function do_ajax_form_aforo_liquidacionVW_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aforo_liquidacionVW_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aforo_liquidacionVW_mob_navigate_form()
  {
    perform_ajax_form_aforo_liquidacionVW_mob_navigate_form();
  }

  function perform_ajax_form_aforo_liquidacionVW_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aforo_liquidacionVW_mob_navigate_form(var_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aforo_liquidacionVW_mob_navigate_form_cb);
  } // do_ajax_form_aforo_liquidacionVW_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionVW_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aforo_liquidacionVW_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aforo_liquidacionVW_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionVW_mob_navigate_form_cb
  function do_ajax_form_aforo_liquidacionVW_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_aforo_liquidacionVW_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aforo_liquidacionVW_mob_navigate_form_cb_after_alert

  function sc_hide_form_aforo_liquidacionVW_mob_form()
  {
