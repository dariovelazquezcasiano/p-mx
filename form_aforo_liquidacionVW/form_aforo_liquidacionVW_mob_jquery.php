...
function scHidePage(pageNo) {
	$("#id_form_aforo_liquidacionVW_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_aforo_liquidacionVW_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
