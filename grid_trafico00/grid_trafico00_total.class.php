...
class grid_trafico00_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_trafico00']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_trafico00']['campos_busca']))
      { 
