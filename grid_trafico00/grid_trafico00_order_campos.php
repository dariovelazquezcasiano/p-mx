<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_trafico00']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_trafico00_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_trafico00_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["hora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["hora"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["hora"] : "Hora";
   $tab_ger_campos['a'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a'] = "a";
   ...
   {
       $tab_def_campos['a'] = "SUM(A)";
   }
   $tab_labels["a"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["a"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["a"] : "A";
   $tab_ger_campos['ar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ar'] = "ar";
   }
   else
   {
       $tab_def_campos['ar'] = "SUM(AR)";
   }
   $tab_labels["ar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["ar"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["ar"] : "AR";
   $tab_ger_campos['m'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['m'] = "m";
   ...
   {
       $tab_def_campos['m'] = "SUM(M)";
   }
   $tab_labels["m"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["m"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["m"] : "M";
   ...
   {
       $tab_def_campos['b2'] = "SUM(B2)";
   }
   $tab_labels["b2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["b2"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["b2"] : "B2";
   ...
   {
       $tab_def_campos['b3'] = "SUM(B3)";
   }
   $tab_labels["b3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["b3"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["b3"] : "B3";
   ...
   {
       $tab_def_campos['b4'] = "SUM(B4)";
   }
   $tab_labels["b4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["b4"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["b4"] : "B4";
   ...
   {
       $tab_def_campos['c2'] = "SUM(C2)";
   }
   $tab_labels["c2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c2"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c2"] : "C2";
   ...
   {
       $tab_def_campos['c3'] = "SUM(C3)";
   }
   $tab_labels["c3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c3"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c3"] : "C3";
   ...
   {
       $tab_def_campos['c4'] = "SUM(C4)";
   }
   $tab_labels["c4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c4"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c4"] : "C4";
   ...
   {
       $tab_def_campos['c5'] = "SUM(C5)";
   }
   $tab_labels["c5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c5"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c5"] : "C5";
   ...
   {
       $tab_def_campos['c6'] = "SUM(C6)";
   }
   $tab_labels["c6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c6"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c6"] : "C6";
   ...
   {
       $tab_def_campos['c7'] = "SUM(C7)";
   }
   $tab_labels["c7"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c7"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c7"] : "C7";
   ...
   {
       $tab_def_campos['c8'] = "SUM(C8)";
   }
   $tab_labels["c8"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c8"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c8"] : "C8";
   ...
   {
       $tab_def_campos['c9'] = "SUM(C9)";
   }
   $tab_labels["c9"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c9"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["c9"] : "C9";
   $tab_ger_campos['exe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['exe'] = "exe";
   }
   else
   {
       $tab_def_campos['exe'] = "SUM(EXE)";
   }
   $tab_labels["exe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["exe"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["exe"] : "EXE";
   $tab_ger_campos['elu'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['elu'] = "elu";
   }
   else
   {
       $tab_def_campos['elu'] = "SUM(ELU)";
   }
   $tab_labels["elu"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["elu"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["elu"] : "ELU";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_trafico00']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_trafico00']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> aforohora</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_trafico00_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_trafico00']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
