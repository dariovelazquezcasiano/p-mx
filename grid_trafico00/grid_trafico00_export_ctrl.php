<?php
@session_start() ;
$_SESSION['scriptcase']['grid_trafico00']['sc_process_barr'] = true;
require_once('../grid_trafico00/index.php');
unset($_SESSION['scriptcase']['grid_trafico00']['sc_process_barr']);
$ExportCtrl = new grid_trafico00_export_control;
$ExportCtrl->Export_barr();

class grid_trafico00_export_control
{
