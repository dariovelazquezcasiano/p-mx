...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_LCR"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_LCR"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LCR']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LCR']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LCR']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LCR']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LCR']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleturno_LCR</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LCR']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_LCR']['embutida_filho'] as $ind => $sc_init)
          {
