<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleturno_LCR']['sc_process_barr'] = true;
require_once('../grid_detalleturno_LCR/index.php');
unset($_SESSION['scriptcase']['grid_detalleturno_LCR']['sc_process_barr']);
$ExportCtrl = new grid_detalleturno_LCR_export_control;
$ExportCtrl->Export_barr();

class grid_detalleturno_LCR_export_control
{
