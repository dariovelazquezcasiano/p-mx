...
$_SESSION['scriptcase']['seg_Login']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['seg_Login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['seg_Login']['label'] = "Login - SCC";
      ...
      { 
          require_once($this->Ini->path_embutida . 'acceso/seg_Login_erro.class.php');
      }
      else
      { 
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['opc_ant'] : "";
      } 
...
$_SESSION['scriptcase']['seg_Login']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("seg_Login_form0.php");
        $this->hideFormPages();
 }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['link_info']['compact_mode']) {
            return;
        }
?>
