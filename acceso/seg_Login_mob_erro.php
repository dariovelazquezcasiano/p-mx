...
$old_error_handler = set_error_handler("seg_Login_mob_scriptcase_error_handler");

function seg_Login_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['seg_Login_mob']['contr_erro']) && $_SESSION['scriptcase']['seg_Login_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_seg_Login_mob->contr_seg_Login_mob->Apl_com_erro = true;
            if ($inicial_seg_Login_mob->contr_seg_Login_mob->NM_ajax_flag)
            {
                $inicial_seg_Login_mob->contr_seg_Login_mob->NM_ajax_info['errList']['geral_seg_Login_mob'][] = $msg;
                return;
            }
            seg_Login_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function seg_Login_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['seg_Login_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['seg_Login_mob'])  ? $_SESSION['scriptcase']['error_icon']['seg_Login_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['seg_Login_mob']) && '' != $_SESSION['scriptcase']['error_close']['seg_Login_mob']) ? $_SESSION['scriptcase']['error_close']['seg_Login_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['seg_Login_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['seg_Login_mob']) ? $_SESSION['scriptcase']['error_span_title']['seg_Login_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['seg_Login_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['seg_Login_mob']) ? $_SESSION['scriptcase']['error_icon_title']['seg_Login_mob'] : '';
?>
