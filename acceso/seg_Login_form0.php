...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>acceso/seg_Login_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
else
{
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['link_info']['remove_border']) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_login_label" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>">
        
    <!-- <span id="id_label_login"><?php //echo $this->nm_new_label['login']; ?></span> -->
    <span id="id_label_login"><?php echo "Usuario"; ?></span>
    
    <?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['php_cmp_required']['login'] == "on") { ?> 
        
        <!-- <span class="scFormRequiredOdd">*</span> -->
        <span class="scFormRequiredOdd"></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pswd_label" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>">
        
    <!-- <span id="id_label_pswd"><?php //echo $this->nm_new_label['pswd']; ?></span> -->
    <span id="id_label_pswd"><?php echo "Contraseña"; ?></span>
    
    <?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['php_cmp_required']['pswd'] == "on") { ?> 
