...
include_once('resumen_mensual2_session.php');
...
$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_perfil']          = "";
$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_prod']       = "";
$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imagens']    = "";
$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imag_temp']  = "";
$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_doc']        = "";
...
//check prod
if(empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_resumen_mensual2($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "resumen_mensual2") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
            $_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_resumen_mensual2($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['resumen_mensual2']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['resumen_mensual2']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$resumen_mensual2_control = new resumen_mensual2_control();
$resumen_mensual2_control->control();

class resumen_mensual2_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['resumen_mensual2'])) {
            $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "resumen_mensual2";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/resumen_mensual2';
        ...
        if (isset($_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['resumen_mensual2']['actual_lang']) || $_SESSION['scriptcase']['resumen_mensual2']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['resumen_mensual2']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir'])) {
...
';
            ...
            if ($_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['resumen_mensual2']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['resumen_mensual2']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao']) && $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_perfil']) && $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['resumen_mensual2']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['resumen_mensual2']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['resumen_mensual2']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['SC_sep_date1'];
      }
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['sc_outra_jan'] != 'resumen_mensual2')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_oracle))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['resumen_mensual2']['decimal_db'] = "."; 
      } 
  }

  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['resumen_mensual2']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8);
    }
    else {
...
} // resumen_mensual2_ini

class resumen_mensual2_control {
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new resumen_mensual2_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['resumen_mensual2'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['resumen_mensual2'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['resumen_mensual2'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['resumen_mensual2']['dbifrm_widget1'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['resumen_mensual2']['dbifrm_widget2'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['resumen_mensual2'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['resumen_mensual2']['evalua_dat_aforo_mes'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['resumen_mensual2']['grafica_mes_ai'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="resumen_mensual2_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['resumen_mensual2'] as $sIframe => $iSCInit) {
?>
...
<div class='grid-stack'>
                ...
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="5" data-gs-width="8" data-gs-height="6"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        ...
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grafica_mes_ai'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["resumen_mensual2"]["dbifrm_widget2"] ?>&under_dashboard=1&dashboard_app=resumen_mensual2&own_widget=dbifrm_widget2&compact_mode=0&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div></div>
...
} // resumen_mensual2_control

function nm_limpa_str_resumen_mensual2(&$str)
{
}
