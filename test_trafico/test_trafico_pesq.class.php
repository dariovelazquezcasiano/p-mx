...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> turnoperiodo</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_turno_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['turno'])) ? $this->New_label['turno'] : "Turno"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_turno" name="turno_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_periodo_cond" name="periodo_cond" onChange="nm_campos_between(document.getElementById('id_vis_periodo'), this, 'periodo')">
