...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____test_trafico"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____test_trafico"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['test_trafico']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['test_trafico']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['test_trafico']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['test_trafico']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['test_trafico']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['test_trafico']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['test_trafico']['embutida_filho'] as $ind => $sc_init)
          {
