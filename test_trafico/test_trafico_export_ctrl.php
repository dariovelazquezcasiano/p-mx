<?php
@session_start() ;
$_SESSION['scriptcase']['test_trafico']['sc_process_barr'] = true;
require_once('../test_trafico/index.php');
unset($_SESSION['scriptcase']['test_trafico']['sc_process_barr']);
$ExportCtrl = new test_trafico_export_control;
$ExportCtrl->Export_barr();

class test_trafico_export_control
{
