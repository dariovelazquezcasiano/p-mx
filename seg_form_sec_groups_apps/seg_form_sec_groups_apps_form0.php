...
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['link_info']['remove_border']) {
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
