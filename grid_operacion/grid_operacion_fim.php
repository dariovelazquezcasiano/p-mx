...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_operacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_operacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_operacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_operacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_operacion']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_operacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_operacion']['embutida_filho'] as $ind => $sc_init)
          {
