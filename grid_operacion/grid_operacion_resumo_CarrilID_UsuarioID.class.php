...
class grid_operacion_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_operacion']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_operacion']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['contr_total_geral'] == "OK")
      {
          $this->array_total_carrilid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_total']['carrilid'];
          $this->array_total_usuarioid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_total']['usuarioid'];
      }
      else
      {
          $this->array_total_carrilid = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_total']['carrilid'] = $this->array_total_carrilid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_total']['usuarioid'] = $this->array_total_usuarioid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['fechaoperacion'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['carril']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['carril'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['usuarioid'] = "Cajero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['tipooperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['tipooperacion'] = "Tipo Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['importe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['importe'] = "Importe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['retiroid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['retiroid'] = "Retiro ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['casetaid'] = "Caseta ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['carrilid'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['carrilnacional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['carrilnacional'] = "Carril Nacional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['turnoid'] = "Turno ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['fechaturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['fechaturno'] = "Fecha Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['horainicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['horainicio'] = "Hora Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['folio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['folio'] = "Folio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['tipomoneda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['tipomoneda'] = "Tipo Moneda"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['deorigenarqueo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['deorigenarqueo'] = "De Origen Arqueo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['retirofondo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['retirofondo'] = "Retiro Fondo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['tramoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['labels']['tramoid'] = "Tramo ID"; 
       }
       //-----
       $this->comp_field_nm = array(
           'carrilid' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_order']['CarrilID_UsuarioID']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_order']['CarrilID_UsuarioID'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_order']['CarrilID_UsuarioID'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_display']['CarrilID_UsuarioID'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_display']['CarrilID_UsuarioID'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_display']['CarrilID_UsuarioID'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_display']['CarrilID_UsuarioID'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_display']['CarrilID_UsuarioID'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_display']['CarrilID_UsuarioID'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['summarizing_fields_display']['CarrilID_UsuarioID'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_carrilid as $i_carrilid => $d_carrilid) {
           if (!isset($i_carrilid, $this->comp_label[0]) || !in_array($i_carrilid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_carrilid[3] ] = $d_carrilid[2];
               $this->comp_label[0][ $d_carrilid[3] ] = $d_carrilid[2];
           }
           foreach ($this->array_total_usuarioid[$i_carrilid] as $i_usuarioid => $d_usuarioid) {
               if (!isset($i_usuarioid, $this->comp_label[1][ $d_carrilid[3] ]) || !in_array($i_usuarioid, $this->comp_label[1][ $d_carrilid[3] ], true)) {
                   $this->comp_index[1][ $d_usuarioid[3] ] = $d_usuarioid[2];
                   $this->comp_label[1][ $d_carrilid[3] ][ $d_usuarioid[3] ] = $d_usuarioid[2];
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_carrilid => $l_carrilid) {
           if (isset($this->array_total_carrilid[$i_carrilid])) {
               $this->comp_group[$i_carrilid] = array();
           }
           foreach ($this->comp_label[1][$i_carrilid] as $i_usuarioid => $l_usuarioid) {
               if (isset($this->array_total_usuarioid[$i_carrilid][$i_usuarioid])) {
                   $this->comp_group[$i_carrilid][$i_usuarioid] = array();
               }
           }
       }
     }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_operacion@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_operacion_total.class.php"); 
      }
      ...
      $this->Total   = new grid_operacion_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_CarrilID_UsuarioID("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_operacion/grid_operacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operacion/grid_operacion_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_operacion&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operacion/grid_operacion_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_operacion_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_operacion']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_operacion']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_operacion_config_pivot.php?nome_apl=grid_operacion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_operacion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_operacion/grid_operacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operacion']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $retiroid = (isset($Busca_temp['retiroid'])) ? $Busca_temp['retiroid'] : ""; 
          $tmp_pos = (is_string($retiroid)) ? strpos($retiroid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($retiroid))
          {
              $retiroid = substr($retiroid, 0, $tmp_pos);
          }
   ...
   {
      //----- Carril
      if (!isset($this->array_total_carrilid[$quebra_carrilid_orig]))
      {
         $this->array_total_carrilid[$quebra_carrilid_orig][0] = 1;
         $this->array_total_carrilid[$quebra_carrilid_orig][1] = 1;
         $this->array_total_carrilid[$quebra_carrilid_orig][2] = $quebra_carrilid;
         $this->array_total_carrilid[$quebra_carrilid_orig][3] = $quebra_carrilid_orig;
      }
      else
      {
         $this->array_total_carrilid[$quebra_carrilid_orig][0]++;
         $this->array_total_carrilid[$quebra_carrilid_orig][2]++;
      }
      //----- Cajero
      if (!isset($this->array_total_usuarioid[$quebra_carrilid_orig][$quebra_usuarioid_orig]))
      {
         $this->array_total_usuarioid[$quebra_carrilid_orig][$quebra_usuarioid_orig][0] = 1;
         $this->array_total_usuarioid[$quebra_carrilid_orig][$quebra_usuarioid_orig][1] = 1;
         $this->array_total_usuarioid[$quebra_carrilid_orig][$quebra_usuarioid_orig][2] = $quebra_usuarioid;
         $this->array_total_usuarioid[$quebra_carrilid_orig][$quebra_usuarioid_orig][3] = $quebra_usuarioid_orig;
      }
      else
      {
         $this->array_total_usuarioid[$quebra_carrilid_orig][$quebra_usuarioid_orig][0]++;
         $this->array_total_usuarioid[$quebra_carrilid_orig][$quebra_usuarioid_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->retiroid = $Busca_temp['retiroid']; 
       $this->retiroid = (isset($Busca_temp['retiroid'])) ? $Busca_temp['retiroid'] : ""; 
       $tmp_pos = (is_string($this->retiroid)) ? strpos($this->retiroid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->retiroid))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('CarrilID_UsuarioID', 'carrilid');
     $campos_order = $this->Ini->Get_date_order_groupby("CarrilID", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('CarrilID_UsuarioID', 'usuarioid');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tipooperacion = $rs_res->fields[3] ;  
            $this->importe = $rs_res->fields[4] ;  
            $this->importe =  str_replace(",", ".", $this->importe);
            $this->retiroid = $rs_res->fields[5] ;  
            $this->casetaid = $rs_res->fields[6] ;  
            $this->carrilid = $rs_res->fields[7] ;  
            $this->cuerpo = $rs_res->fields[8] ;  
            $this->carrilnacional = $rs_res->fields[9] ;  
