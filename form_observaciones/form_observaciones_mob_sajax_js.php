...
?>
  ...
  // ---------- Validate turnoid
  function do_ajax_form_observaciones_mob_validate_turnoid()
  {
    var nomeCampo_turnoid = "turnoid";
    var var_turnoid = scAjaxGetFieldText(nomeCampo_turnoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_observaciones_mob_validate_turnoid(var_turnoid, var_script_case_init, do_ajax_form_observaciones_mob_validate_turnoid_cb);
  } // do_ajax_form_observaciones_mob_validate_turnoid

  function do_ajax_form_observaciones_mob_validate_turnoid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_observaciones_mob_validate_turnoid_cb

  // ---------- Validate casetaid
  function do_ajax_form_observaciones_mob_validate_casetaid()
  {
    var nomeCampo_casetaid = "casetaid";
    var var_casetaid = scAjaxGetFieldSelect(nomeCampo_casetaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_observaciones_mob_validate_casetaid(var_casetaid, var_script_case_init, do_ajax_form_observaciones_mob_validate_casetaid_cb);
  } // do_ajax_form_observaciones_mob_validate_casetaid

  function do_ajax_form_observaciones_mob_validate_casetaid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_observaciones_mob_validate_casetaid_cb

  // ---------- Validate usuarioid
  function do_ajax_form_observaciones_mob_validate_usuarioid()
  {
    var nomeCampo_usuarioid = "usuarioid";
    var var_usuarioid = scAjaxGetFieldText(nomeCampo_usuarioid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_observaciones_mob_validate_usuarioid(var_usuarioid, var_script_case_init, do_ajax_form_observaciones_mob_validate_usuarioid_cb);
  } // do_ajax_form_observaciones_mob_validate_usuarioid

  function do_ajax_form_observaciones_mob_validate_usuarioid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_observaciones_mob_validate_usuarioid_cb

  // ---------- Validate observacion
  function do_ajax_form_observaciones_mob_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_observaciones_mob_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_observaciones_mob_validate_observacion_cb);
  } // do_ajax_form_observaciones_mob_validate_observacion

  function do_ajax_form_observaciones_mob_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_observaciones_mob_validate_observacion_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_observaciones_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_observaciones_mob_submit_form(var_turnoid, var_casetaid, var_usuarioid, var_observacion, var_consecutivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_observaciones_mob_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_observaciones_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_observaciones_mob_navigate_form(var_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_observaciones_mob_navigate_form_cb);
...
?>
  ...
  ajax_field_list[0] = "turnoid";
  ajax_field_list[1] = "casetaid";
  ajax_field_list[2] = "usuarioid";
  ajax_field_list[3] = "observacion";
