...
<?php
   ...
   $Ord_Cmp = new grid_alarma_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_alarma_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["alarmaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['labels']["alarmaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_alarma']['labels']["alarmaid"] : "Alarma ID";
   $tab_ger_campos['tipoid'] = "on";
   $tab_def_campos['tipoid'] = "TipoID";
   $tab_labels["tipoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['labels']["tipoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_alarma']['labels']["tipoid"] : "Tipo ID";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "Descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_alarma']['labels']["descripcion"] : "Descripcion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_alarma']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_alarma']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_alarma_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_alarma']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
