...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_alarma"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_alarma"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_alarma'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alarma']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_alarma']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alarma']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_alarma']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_alarma']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_alarma']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_alarma']['embutida_filho'] as $ind => $sc_init)
          {
