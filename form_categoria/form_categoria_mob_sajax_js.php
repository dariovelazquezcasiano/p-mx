...
?>
  ...
  function do_ajax_form_categoria_mob_validate_categoriaid()
  {
    var nomeCampo_categoriaid = "categoriaid";
    var var_categoriaid = scAjaxGetFieldText(nomeCampo_categoriaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_mob_validate_categoriaid(var_categoriaid, var_script_case_init, do_ajax_form_categoria_mob_validate_categoriaid_cb);
  } // do_ajax_form_categoria_mob_validate_categoriaid

  function do_ajax_form_categoria_mob_validate_categoriaid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoriaid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_mob_validate_categoriaid_cb

  // ---------- Validate descripcion
  function do_ajax_form_categoria_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_categoria_mob_validate_descripcion_cb);
  } // do_ajax_form_categoria_mob_validate_descripcion

  function do_ajax_form_categoria_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_mob_validate_descripcion_cb

  // ---------- Validate efectivo
  function do_ajax_form_categoria_mob_validate_efectivo()
  {
    var nomeCampo_efectivo = "efectivo";
    var var_efectivo = scAjaxGetFieldSelect(nomeCampo_efectivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_mob_validate_efectivo(var_efectivo, var_script_case_init, do_ajax_form_categoria_mob_validate_efectivo_cb);
  } // do_ajax_form_categoria_mob_validate_efectivo

  function do_ajax_form_categoria_mob_validate_efectivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_mob_validate_efectivo_cb

  // ---------- Validate orden
  function do_ajax_form_categoria_mob_validate_orden()
  {
    var nomeCampo_orden = "orden";
    var var_orden = scAjaxGetFieldText(nomeCampo_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_mob_validate_orden(var_orden, var_script_case_init, do_ajax_form_categoria_mob_validate_orden_cb);
  } // do_ajax_form_categoria_mob_validate_orden

  function do_ajax_form_categoria_mob_validate_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "orden";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_mob_validate_orden_cb

  // ---------- Validate categoriapago
  function do_ajax_form_categoria_mob_validate_categoriapago()
  {
    var nomeCampo_categoriapago = "categoriapago";
    nm_pack(nomeCampo_categoriapago + '_dest', nomeCampo_categoriapago);
    var var_categoriapago = scAjaxGetFieldText(nomeCampo_categoriapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_mob_validate_categoriapago(var_categoriapago, var_script_case_init, do_ajax_form_categoria_mob_validate_categoriapago_cb);
  } // do_ajax_form_categoria_mob_validate_categoriapago

  function do_ajax_form_categoria_mob_validate_categoriapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoriapago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_mob_validate_categoriapago_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_categoria_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_categoriaid = scAjaxGetFieldText("categoriaid");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_efectivo = scAjaxGetFieldSelect("efectivo");
    var var_orden = scAjaxGetFieldText("orden");
    nm_pack("categoriapago_dest", "categoriapago");
    var var_categoriapago = scAjaxGetFieldText("categoriapago", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_categoria_mob_submit_form(var_categoriaid, var_descripcion, var_efectivo, var_orden, var_categoriapago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categoria_mob_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_categoria_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("orden");
    scAjaxHideErrorDisplay("categoriapago");
    var var_categoriaid = document.F2.categoriaid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_categoria_mob_navigate_form(var_categoriaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categoria_mob_navigate_form_cb);
...
?>
  function do_ajax_form_categoria_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.categoriaid.value = scAjaxGetKeyValue("categoriaid");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
?>
  ...
  ajax_field_list[0] = "categoriaid";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "efectivo";
  ajax_field_list[3] = "orden";
  ajax_field_list[4] = "categoriapago";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "categoriaid": {"label": "Categoria ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "efectivo": {"label": "Campos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "orden": {"label": "Orden", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "categoriapago": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "efectivo": new Array(),
    "orden": new Array(),
    "categoriapago": new Array()
  };
  ajax_field_mult["categoriaid"][1] = "categoriaid";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["efectivo"][1] = "efectivo";
  ajax_field_mult["orden"][1] = "orden";
  ajax_field_mult["categoriapago"][1] = "categoriapago";

  var ajax_field_id = {
    "categoriaid": new Array("hidden_field_label_categoriaid", "hidden_field_data_categoriaid"),
    ...
    "categoriapago": new Array("hidden_field_label_categoriapago", "hidden_field_data_categoriapago")
  };
