<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="categoriaid" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['categoriaid']); ?>">
...
function scForm_packMultiSelect_multi() {
	...
	for (var Nm_x = 1; Nm_x < NM_count_mult; Nm_x++) {
		nm_pack('categoriapago' + Nm_x + '_dest', 'categoriapago' + Nm_x);
	}
