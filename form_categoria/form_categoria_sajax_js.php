...
?>
  ...
  function do_ajax_form_categoria_validate_categoriaid()
  {
    var nomeCampo_categoriaid = "categoriaid";
    var var_categoriaid = scAjaxGetFieldText(nomeCampo_categoriaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_validate_categoriaid(var_categoriaid, var_script_case_init, do_ajax_form_categoria_validate_categoriaid_cb);
  } // do_ajax_form_categoria_validate_categoriaid

  function do_ajax_form_categoria_validate_categoriaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_validate_categoriaid_cb

  // ---------- Validate descripcion
  function do_ajax_form_categoria_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_categoria_validate_descripcion_cb);
  } // do_ajax_form_categoria_validate_descripcion

  function do_ajax_form_categoria_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_validate_descripcion_cb

  // ---------- Validate efectivo
  function do_ajax_form_categoria_validate_efectivo()
  {
    var nomeCampo_efectivo = "efectivo";
    var var_efectivo = scAjaxGetFieldSelect(nomeCampo_efectivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_validate_efectivo(var_efectivo, var_script_case_init, do_ajax_form_categoria_validate_efectivo_cb);
  } // do_ajax_form_categoria_validate_efectivo

  function do_ajax_form_categoria_validate_efectivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_validate_efectivo_cb

  // ---------- Validate orden
  function do_ajax_form_categoria_validate_orden()
  {
    var nomeCampo_orden = "orden";
    var var_orden = scAjaxGetFieldText(nomeCampo_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_validate_orden(var_orden, var_script_case_init, do_ajax_form_categoria_validate_orden_cb);
  } // do_ajax_form_categoria_validate_orden

  function do_ajax_form_categoria_validate_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "orden";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_validate_orden_cb

  // ---------- Validate categoriapago
  function do_ajax_form_categoria_validate_categoriapago()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_validate_categoriapago(var_categoriapago, var_script_case_init, do_ajax_form_categoria_validate_categoriapago_cb);
  } // do_ajax_form_categoria_validate_categoriapago

  function do_ajax_form_categoria_validate_categoriapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_validate_categoriapago_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_categoria_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_categoria_submit_form(var_categoriaid, var_descripcion, var_efectivo, var_orden, var_categoriapago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categoria_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_categoria_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_categoria_navigate_form(var_categoriaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categoria_navigate_form_cb);
