<?php
@session_start() ;
$_SESSION['scriptcase']['chart_operacion']['sc_process_barr'] = true;
require_once('../chart_operacion/index.php');
unset($_SESSION['scriptcase']['chart_operacion']['sc_process_barr']);
$ExportCtrl = new chart_operacion_export_control;
$ExportCtrl->Export_barr();

class chart_operacion_export_control
{
