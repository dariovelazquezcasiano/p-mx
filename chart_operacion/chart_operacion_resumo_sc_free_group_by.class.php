...
class chart_operacion_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_operacion'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_operacion'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_operacion']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_operacion']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_operacion']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_step'] = 'end';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_operacion']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search']))
      { 
         $this->res_contr = new chart_operacion_apl();
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_type']        = 'stackedcolumn2d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_order_rule_groupby']["carrilid"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_order_field_groupby']["carrilid"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_order_rule_groupby']["usuarioid"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_combination_order_field_groupby']["usuarioid"] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys'][1] = 1;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_display_values'][2] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pesq_tab_label'] = "";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_search_add']);
          exit;
      }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $Sv_tot_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['tot_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot);
      $this->array_total_geral = array();
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['tot_geral'][1] == 0)
      {
          $this->NM_res_sem_reg = true;
      }
      if (isset($Sv_tot_ger))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['tot_geral'] = $Sv_tot_ger;
          unset($Sv_tot_ger);
      }
      $this->resumo_init();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['arr_total']['carrilid'] = $this->array_total_carrilid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['arr_total']['usuarioid'] = $this->array_total_usuarioid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['json_use_label'])
       {
       ...
       $Lab_usuarioid = "Usuario ID";
       }
       $prep_field = array();
       $prep_field['carrilid'] = $Lab_carrilid;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['carrilid'] = $Lab_carrilid; 
       $prep_field['usuarioid'] = $Lab_usuarioid;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['usuarioid'] = $Lab_usuarioid; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['retiroid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['retiroid'] = "Retiro ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['casetaid'] = "Caseta ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['usuarioid'] = "Usuario ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['carrilid'] = "Carril ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['carrilnacional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['carrilnacional'] = "Carril Nacional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['turnoid'] = "Turno ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['fechaoperacion'] = "Fecha Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['fechaturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['fechaturno'] = "Fecha Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['horainicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['horainicio'] = "Hora Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['importe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['importe'] = "Importe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['folio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['folio'] = "Folio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['tipomoneda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['tipomoneda'] = "Tipo Moneda"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['tipooperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['tipooperacion'] = "Tipo Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['deorigenarqueo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['deorigenarqueo'] = "De Origen Arqueo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['retirofondo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['retirofondo'] = "Retiro Fondo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['tramoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['labels']['tramoid'] = "Tramo ID"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['carrilid']['alin'] = "''";
       $Arr_parms['carrilid']['link'] = "S";
       $Arr_parms['usuarioid']['alin'] = "''";
       $Arr_parms['usuarioid']['link'] = "S";
       $Arr_parms['carrilid']['fill'] = "true";
       $Arr_parms['carrilid']['order'] = "value";
       $Arr_parms['carrilid']['order_start'] = 'asc';
       $Arr_parms['carrilid']['order_invert'] = 'false';
       $Arr_parms['carrilid']['order_enabled'] = 'true';
       $Arr_parms['carrilid']['order_datatype'] = 'tinyint';
       $Arr_parms['usuarioid']['fill'] = "true";
       $Arr_parms['usuarioid']['order'] = "label";
       $Arr_parms['usuarioid']['order_start'] = 'asc';
       $Arr_parms['usuarioid']['order_invert'] = 'false';
       $Arr_parms['usuarioid']['order_enabled'] = 'true';
       $Arr_parms['usuarioid']['order_datatype'] = 'char';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['carrilid'] = array(0 => 'carrilid', 1 => '');
       $prep_links_fl['usuarioid'] = array(0 => 'usuarioid', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_operacion@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'field_x'  => 'usuarioid',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_usuarioid)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_operacion_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_chart_operacion_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_operacion_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_operacion_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
      ...
      { 
         ...
         { 
             $seq_search = 1;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq'] as $cmp => $def)
             {
                $Seq_grid      = $seq_search;
                $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_operacion']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_operacion']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_operacion']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_operacion']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_operacion_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new chart_operacion_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " operacion</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_operacion_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_operacion_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_operacion_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_operacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_operacion/chart_operacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_chart\" class=\"" . $this->css_scGridPage . " sc-app-chart\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['embutida'])
      {
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['where_resumo_search']))
      {
          $this->NM_res_sem_reg = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['embutida'])
      {
         ...
         $NM_btn = false;
         $NM_Gbtn = false;
         if (is_file("chart_operacion_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_operacion_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_operacion/chart_operacion_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=es&conf_socor=N&is_chart_app=Y&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_operacion&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_operacion/chart_operacion_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=chart&nm_all_modules=chart&password=n&origem=chart&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_operacion']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_operacion']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_operacion_config_pivot.php?nome_apl=chart_operacion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_operacion_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"chart_operacion_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"chart_operacion_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_operacion_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_operacion@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_operacion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_operacion/chart_operacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'] as $chart_index => $chart_data)
       {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               chart_operacion_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if ($bChartFP)
       {
           ...
           chart_operacion_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_operacion_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           chart_operacion_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           chart_operacion_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_operacion_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_operacion_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   chart_operacion_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['cond_pesq'], 0, $trab_pos);
   ...
   function monta_resumo_search()
   {
      ...
      $this->html_resumo_search();
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look']))
           { 
               $this->Ini->Arr_result['setArr'][] = array('var' => 'Tab_obj_res_combo', 'value' => '');
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look'] as $cada_combo => $opcs_combo)
               { 
               ...
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look']))
               { 
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['res_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search']         = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look']    = array();
       ...
       $lin_obj  = $this->resumo_search_FechaOperacion_SC_1();
   ...
   function resumo_search_FechaOperacion_SC_1()
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search']['FechaOperacion_SC_1']))
       {
       ...
       $lin_obj .= "FechaOperacion_1";
     if (!$_SESSION['scriptcase']['proc_mobile']) {
       $Cod_Btn  = nmButtonOutput($this->arr_buttons, "blimparsummaryfield", "nm_proc_res_search('FechaOperacion_SC_1', '', '', '', 'clear_search_obj', '', '');", "nm_proc_res_search('FechaOperacion_SC_1', '', '', '', 'clear_search_obj', '', '');", "FechaOperacion_SC_1_clear", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
       $lin_obj .= "<span id=\"btn_clear_FechaOperacion_SC_1\" style='float:right; display: none;' class='scGridSummarySearchLabelclean'>". $Cod_Btn ."</span>"; 
     }
       $lin_obj .= "     </div>";
       $lin_obj  .= "   <div class='scGridSummarySearchObjeto' id=\"id_tab_FechaOperacion_SC_1\" style=\" \">";
       $val       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look']['FechaOperacion_SC_1'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look']['FechaOperacion_SC_1'][0] : "";
       $lin_obj  .= "   <input type=text class=\"sc-js-input css_toolbar_obj\" style=\"vertical-align: middle;\" id=\"FechaOperacion_SC_1_1\" name=\"FechaOperacion_SC_1_1\" value=\"" . $val . "\" size=10 alt=\"{datatype: 'date', dateSep: '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "', dateFormat: '" . $_SESSION['scriptcase']['reg_conf']['date_format'] . "', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}\"    onChange=\"\">";
       $lin_obj  .= "   <input type=hidden id=\"jq_FechaOperacion_SC_1_1\">";
       $lin_obj  .= "   <div class='searchInputSpacer' style='display: inline-block; width: 10px;'></div>";
       $val       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look']['FechaOperacion_SC_1'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['resumo_search_look']['FechaOperacion_SC_1'][1] : "";
       $lin_obj  .= "   <input type=text class=\"sc-js-input css_toolbar_obj\" style=\"vertical-align: middle;\" id=\"FechaOperacion_SC_1_2\" name=\"FechaOperacion_SC_1_2\" value=\"" . $val . "\" size=10 alt=\"{datatype: 'date', dateSep: '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "', dateFormat: '" . $_SESSION['scriptcase']['reg_conf']['date_format'] . "', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}\"    onChange=\"\">";
       $lin_obj  .= "   <input type=hidden id=\"jq_FechaOperacion_SC_1_2\">";
       $Cod_Btn  = nmButtonOutput($this->arr_buttons, "boksummary", "nm_proc_res_search('FechaOperacion_SC_1', 'FechaOperacion', 'input', 'dt', 'bw', 'range', '');", "nm_proc_res_search('FechaOperacion_SC_1', 'FechaOperacion', 'input', 'dt', 'bw', 'range', '');", "bok_FechaOperacion_SC_1", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
       $lin_obj .= $Cod_Btn; 
       $lin_obj  .= "   </div>";
       $lin_obj .= "    </div>";
       return $lin_obj;
   ...
   function JS_resumo_search()
   {
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida("     function JQCalendarAdd() {\r\n");
       $nm_saida->saida("      $(\"#jq_FechaOperacion_SC_1_1\").datepicker({\r\n");
       $nm_saida->saida("        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("              document.getElementById('jq_FechaOperacion_SC_1_1').value = document.getElementById('FechaOperacion_SC_1_1').value;\r\n");
       $nm_saida->saida("        },\r\n");
       $nm_saida->saida("        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("              document.getElementById('FechaOperacion_SC_1_1').value = dateText;\r\n");
       $nm_saida->saida("        },\r\n");
       $nm_saida->saida("        numberOfMonths: 1,\r\n");
       $nm_saida->saida("        changeMonth: true,\r\n");
       $nm_saida->saida("        changeYear: true,\r\n");
       $nm_saida->saida("        yearRange: 'c-10:c+10',\r\n");
       ...
       $nm_saida->saida("        firstDay: " . $this->jqueryCalendarWeekInit_rs("" . $_SESSION['scriptcase']['reg_conf']['date_week_ini'] . "") . ",\r\n");
       $nm_saida->saida("        dateFormat: \"" . $this->jqueryCalendarDtFormat_rs("" . str_replace(array('/', 'aaaa', $_SESSION['scriptcase']['reg_conf']['date_sep']), array('', 'yyyy', ''), $_SESSION['scriptcase']['reg_conf']['date_format']) . "", "" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "") . "\",\r\n");
       ...
       $nm_saida->saida("      });\r\n");
       $nm_saida->saida("      $(\"#jq_FechaOperacion_SC_1_2\").datepicker({\r\n");
       $nm_saida->saida("        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("              document.getElementById('jq_FechaOperacion_SC_1_2').value = document.getElementById('FechaOperacion_SC_1_2').value;\r\n");
       $nm_saida->saida("        },\r\n");
       $nm_saida->saida("        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("              document.getElementById('FechaOperacion_SC_1_2').value = dateText;\r\n");
       $nm_saida->saida("        },\r\n");
       $nm_saida->saida("        numberOfMonths: 1,\r\n");
       $nm_saida->saida("        changeMonth: true,\r\n");
       $nm_saida->saida("        changeYear: true,\r\n");
   ...
   function jqueryCalendarDtFormat_rs($sFormat, $sSep)
   {
   ...
   function jqueryCalendarWeekInit_rs($sDay)
   {
       switch ($sDay) {
   ...
   //---- 
   function adiciona_registro($quebra_carrilid, $quebra_usuarioid, $quebra_carrilid_orig, $quebra_usuarioid_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT RetiroID, CasetaID, UsuarioID, CarrilID, Cuerpo, CarrilNacional, TurnoID, str_replace (convert(char(10),FechaOperacion,102), '.', '-') + ' ' + convert(char(8),FechaOperacion,20), str_replace (convert(char(10),FechaTurno,102), '.', '-') + ' ' + convert(char(8),FechaTurno,20), str_replace (convert(char(10),HoraInicio,102), '.', '-') + ' ' + convert(char(8),HoraInicio,20), Importe, Folio, str_replace (convert(char(10),Fecha,102), '.', '-') + ' ' + convert(char(8),Fecha,20), TipoMoneda, TipoOperacion, DeOrigenArqueo, RetiroFondo, TramoID from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT RetiroID, CasetaID, UsuarioID, CarrilID, Cuerpo, CarrilNacional, TurnoID, FechaOperacion, FechaTurno, HoraInicio, Importe, Folio, Fecha, TipoMoneda, TipoOperacion, DeOrigenArqueo, RetiroFondo, TramoID from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT RetiroID, CasetaID, UsuarioID, CarrilID, Cuerpo, CarrilNacional, TurnoID, convert(char(23),FechaOperacion,121), convert(char(23),FechaTurno,121), convert(char(23),HoraInicio,121), Importe, Folio, convert(char(23),Fecha,121), TipoMoneda, TipoOperacion, DeOrigenArqueo, RetiroFondo, TramoID from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT RetiroID, CasetaID, UsuarioID, CarrilID, Cuerpo, CarrilNacional, TurnoID, FechaOperacion, FechaTurno, HoraInicio, Importe, Folio, Fecha, TipoMoneda, TipoOperacion, DeOrigenArqueo, RetiroFondo, TramoID from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->retiroid = $rs_res->fields[0] ;  
            $this->casetaid = $rs_res->fields[1] ;  
            $this->usuarioid = $rs_res->fields[2] ;  
            $this->carrilid = $rs_res->fields[3] ;  
            $this->cuerpo = $rs_res->fields[4] ;  
            $this->carrilnacional = $rs_res->fields[5] ;  
            $this->turnoid = $rs_res->fields[6] ;  
            $this->fechaoperacion = $rs_res->fields[7] ;  
            $this->fechaturno = $rs_res->fields[8] ;  
            $this->horainicio = $rs_res->fields[9] ;  
            $this->importe = $rs_res->fields[10] ;  
            $this->importe =  str_replace(",", ".", $this->importe);
            $this->folio = $rs_res->fields[11] ;  
            $this->fecha = $rs_res->fields[12] ;  
            $this->tipomoneda = $rs_res->fields[13] ;  
            $this->tipooperacion = $rs_res->fields[14] ;  
            $this->deorigenarqueo = $rs_res->fields[15] ;  
            $this->retirofondo = $rs_res->fields[16] ;  
            $this->tramoid = $rs_res->fields[17] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->carrilid, $this->usuarioid, $this->carrilid_orig,  $this->usuarioid_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq']) < 0)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_operacion']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "BackOffice_Acapulco/chart_operacion";
