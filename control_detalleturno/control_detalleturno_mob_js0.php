...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_detalleturno_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_mas_ok()
{
    ...
    document.F1.action = "control_detalleturno_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno_mob']['where_detal']))
  {
?>  
...
function nm_saida_glo()
{
  ...
  document.F4.action = "control_detalleturno_mob_fim.php";
  document.F4.submit();
}
