...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_mxn' + iSeqRow).bind('blur', function() { sc_control_detalleturno_mxn_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_control_detalleturno_mxn_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_usd' + iSeqRow).bind('blur', function() { sc_control_detalleturno_usd_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_control_detalleturno_usd_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cantidadmxn' + iSeqRow).bind('blur', function() { sc_control_detalleturno_cantidadmxn_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_control_detalleturno_cantidadmxn_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cantidadusd' + iSeqRow).bind('blur', function() { sc_control_detalleturno_cantidadusd_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_control_detalleturno_cantidadusd_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_importemxn' + iSeqRow).bind('blur', function() { sc_control_detalleturno_importemxn_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_importemxn_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_importeusd' + iSeqRow).bind('blur', function() { sc_control_detalleturno_importeusd_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_importeusd_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_folioinicialcr' + iSeqRow).bind('blur', function() { sc_control_detalleturno_folioinicialcr_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_control_detalleturno_folioinicialcr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_foliofinalcr' + iSeqRow).bind('blur', function() { sc_control_detalleturno_foliofinalcr_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_control_detalleturno_foliofinalcr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_folioinicialeap' + iSeqRow).bind('blur', function() { sc_control_detalleturno_folioinicialeap_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_control_detalleturno_folioinicialeap_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_foliofinaleap' + iSeqRow).bind('blur', function() { sc_control_detalleturno_foliofinaleap_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_control_detalleturno_foliofinaleap_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_folioinir1' + iSeqRow).bind('blur', function() { sc_control_detalleturno_folioinir1_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_folioinir1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_foliofinr1' + iSeqRow).bind('blur', function() { sc_control_detalleturno_foliofinr1_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_foliofinr1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_folioinir2' + iSeqRow).bind('blur', function() { sc_control_detalleturno_folioinir2_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_folioinir2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_foliofinr2' + iSeqRow).bind('blur', function() { sc_control_detalleturno_foliofinr2_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_foliofinr2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_folioinir3' + iSeqRow).bind('blur', function() { sc_control_detalleturno_folioinir3_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_folioinir3_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_foliofinr3' + iSeqRow).bind('blur', function() { sc_control_detalleturno_foliofinr3_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_detalleturno_foliofinr3_onchange(this, iSeqRow) })
...
function sc_control_detalleturno_mxn_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_usd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_cantidadmxn_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_cantidadusd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_importemxn_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_importeusd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_folioinicialcr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_foliofinalcr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_folioinicialeap_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_foliofinaleap_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_folioinir1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_foliofinr1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_folioinir2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_foliofinr2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_folioinir3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_detalleturno_foliofinr3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_control_detalleturno_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_detalleturno')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
