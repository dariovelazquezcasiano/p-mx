<?php
//
class control_detalleturno_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_detalleturno']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_detalleturno']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_detalleturno']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_detalleturno']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_detalleturno_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['control_detalleturno']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_detalleturno']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_detalleturno'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_detalleturno']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_detalleturno']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_detalleturno') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_detalleturno']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['control_detalleturno']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_detalleturno'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_detalleturno']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_detalleturno'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_detalleturno'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("control_detalleturno", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_detalleturno_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_detalleturno_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'control_detalleturno/control_detalleturno_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_detalleturno_erro.class.php"); 
      }
      $this->Erro      = new control_detalleturno_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_detalleturno']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['sigue'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['botoes']['sigue'];
          $this->nmgp_botoes['mas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['botoes']['mas'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['control_detalleturno']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['control_detalleturno']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->folioinir3 = "" ;  
          $this->foliofinr3 = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos']))
              { 
                  $mxn = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][0]; 
                  $usd = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][1]; 
                  $cantidadmxn = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][2]; 
                  $cantidadusd = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][3]; 
                  $importemxn = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][4]; 
                  $importeusd = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][5]; 
                  $folioinicialcr = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][6]; 
                  $foliofinalcr = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][7]; 
                  $folioinicialeap = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][8]; 
                  $foliofinaleap = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][9]; 
                  $folioinir1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][10]; 
                  $foliofinr1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][11]; 
                  $folioinir2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][12]; 
                  $foliofinr2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][13]; 
                  $folioinir3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][14]; 
                  $foliofinr3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][15]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][0] = $this->mxn; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][1] = $this->usd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][2] = $this->cantidadmxn; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][3] = $this->cantidadusd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][4] = $this->importemxn; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][5] = $this->importeusd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][6] = $this->folioinicialcr; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][7] = $this->foliofinalcr; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][8] = $this->folioinicialeap; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][9] = $this->foliofinaleap; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][10] = $this->folioinir1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][11] = $this->foliofinr1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][12] = $this->folioinir2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][13] = $this->foliofinr2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][14] = $this->folioinir3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['campos'][15] = $this->foliofinr3; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_detalleturno", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_detalleturno_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_detalleturno.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="control_detalleturno_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_detalleturno"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_detalleturno', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'control_detalleturno', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_detalleturno', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->mxn) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form']['mxn']))
          {
              $varloc_btn_php['mxn'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form']['mxn'];
          }
      }
      $nm_f_saida = "./";
      ...
      $_SESSION['scriptcase']['control_detalleturno']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_detalleturno']) || !is_array($this->NM_ajax_info['errList']['geral_control_detalleturno']))
              {
                  $this->NM_ajax_info['errList']['geral_control_detalleturno'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_detalleturno'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_control_detalleturno';
...
$_SESSION['scriptcase']['control_detalleturno']['contr_erro'] = 'off'; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values_foliofinr3($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("control_detalleturno_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "control_detalleturno_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_detalleturno_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['ordem_ord'] == " desc") {
