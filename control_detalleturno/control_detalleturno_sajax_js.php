  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_detalleturno" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_detalleturno_form();
	}
...
?>
  ...
  // ---------- Validate mxn
  function do_ajax_control_detalleturno_validate_mxn()
  {
    var nomeCampo_mxn = "mxn";
    var var_mxn = scAjaxGetFieldText(nomeCampo_mxn);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_mxn(var_mxn, var_script_case_init, do_ajax_control_detalleturno_validate_mxn_cb);
  } // do_ajax_control_detalleturno_validate_mxn

  function do_ajax_control_detalleturno_validate_mxn_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_mxn_cb

  // ---------- Validate usd
  function do_ajax_control_detalleturno_validate_usd()
  {
    var nomeCampo_usd = "usd";
    var var_usd = scAjaxGetFieldText(nomeCampo_usd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_usd(var_usd, var_script_case_init, do_ajax_control_detalleturno_validate_usd_cb);
  } // do_ajax_control_detalleturno_validate_usd

  function do_ajax_control_detalleturno_validate_usd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_usd_cb

  // ---------- Validate cantidadmxn
  function do_ajax_control_detalleturno_validate_cantidadmxn()
  {
    var nomeCampo_cantidadmxn = "cantidadmxn";
    var var_cantidadmxn = scAjaxGetFieldText(nomeCampo_cantidadmxn);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_cantidadmxn(var_cantidadmxn, var_script_case_init, do_ajax_control_detalleturno_validate_cantidadmxn_cb);
  } // do_ajax_control_detalleturno_validate_cantidadmxn

  function do_ajax_control_detalleturno_validate_cantidadmxn_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_cantidadmxn_cb

  // ---------- Validate cantidadusd
  function do_ajax_control_detalleturno_validate_cantidadusd()
  {
    var nomeCampo_cantidadusd = "cantidadusd";
    var var_cantidadusd = scAjaxGetFieldText(nomeCampo_cantidadusd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_cantidadusd(var_cantidadusd, var_script_case_init, do_ajax_control_detalleturno_validate_cantidadusd_cb);
  } // do_ajax_control_detalleturno_validate_cantidadusd

  function do_ajax_control_detalleturno_validate_cantidadusd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_cantidadusd_cb

  // ---------- Validate importemxn
  function do_ajax_control_detalleturno_validate_importemxn()
  {
    var nomeCampo_importemxn = "importemxn";
    var var_importemxn = scAjaxGetFieldText(nomeCampo_importemxn);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_importemxn(var_importemxn, var_script_case_init, do_ajax_control_detalleturno_validate_importemxn_cb);
  } // do_ajax_control_detalleturno_validate_importemxn

  function do_ajax_control_detalleturno_validate_importemxn_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_importemxn_cb

  // ---------- Validate importeusd
  function do_ajax_control_detalleturno_validate_importeusd()
  {
    var nomeCampo_importeusd = "importeusd";
    var var_importeusd = scAjaxGetFieldText(nomeCampo_importeusd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_importeusd(var_importeusd, var_script_case_init, do_ajax_control_detalleturno_validate_importeusd_cb);
  } // do_ajax_control_detalleturno_validate_importeusd

  function do_ajax_control_detalleturno_validate_importeusd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_importeusd_cb

  // ---------- Validate folioinicialcr
  function do_ajax_control_detalleturno_validate_folioinicialcr()
  {
    var nomeCampo_folioinicialcr = "folioinicialcr";
    var var_folioinicialcr = scAjaxGetFieldText(nomeCampo_folioinicialcr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_folioinicialcr(var_folioinicialcr, var_script_case_init, do_ajax_control_detalleturno_validate_folioinicialcr_cb);
  } // do_ajax_control_detalleturno_validate_folioinicialcr

  function do_ajax_control_detalleturno_validate_folioinicialcr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_folioinicialcr_cb

  // ---------- Validate foliofinalcr
  function do_ajax_control_detalleturno_validate_foliofinalcr()
  {
    var nomeCampo_foliofinalcr = "foliofinalcr";
    var var_foliofinalcr = scAjaxGetFieldText(nomeCampo_foliofinalcr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_foliofinalcr(var_foliofinalcr, var_script_case_init, do_ajax_control_detalleturno_validate_foliofinalcr_cb);
  } // do_ajax_control_detalleturno_validate_foliofinalcr

  function do_ajax_control_detalleturno_validate_foliofinalcr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_foliofinalcr_cb

  // ---------- Validate folioinicialeap
  function do_ajax_control_detalleturno_validate_folioinicialeap()
  {
    var nomeCampo_folioinicialeap = "folioinicialeap";
    var var_folioinicialeap = scAjaxGetFieldText(nomeCampo_folioinicialeap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_folioinicialeap(var_folioinicialeap, var_script_case_init, do_ajax_control_detalleturno_validate_folioinicialeap_cb);
  } // do_ajax_control_detalleturno_validate_folioinicialeap

  function do_ajax_control_detalleturno_validate_folioinicialeap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_folioinicialeap_cb

  // ---------- Validate foliofinaleap
  function do_ajax_control_detalleturno_validate_foliofinaleap()
  {
    var nomeCampo_foliofinaleap = "foliofinaleap";
    var var_foliofinaleap = scAjaxGetFieldText(nomeCampo_foliofinaleap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_foliofinaleap(var_foliofinaleap, var_script_case_init, do_ajax_control_detalleturno_validate_foliofinaleap_cb);
  } // do_ajax_control_detalleturno_validate_foliofinaleap

  function do_ajax_control_detalleturno_validate_foliofinaleap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_foliofinaleap_cb

  // ---------- Validate folioinir1
  function do_ajax_control_detalleturno_validate_folioinir1()
  {
    var nomeCampo_folioinir1 = "folioinir1";
    var var_folioinir1 = scAjaxGetFieldText(nomeCampo_folioinir1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_folioinir1(var_folioinir1, var_script_case_init, do_ajax_control_detalleturno_validate_folioinir1_cb);
  } // do_ajax_control_detalleturno_validate_folioinir1

  function do_ajax_control_detalleturno_validate_folioinir1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_folioinir1_cb

  // ---------- Validate foliofinr1
  function do_ajax_control_detalleturno_validate_foliofinr1()
  {
    var nomeCampo_foliofinr1 = "foliofinr1";
    var var_foliofinr1 = scAjaxGetFieldText(nomeCampo_foliofinr1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_foliofinr1(var_foliofinr1, var_script_case_init, do_ajax_control_detalleturno_validate_foliofinr1_cb);
  } // do_ajax_control_detalleturno_validate_foliofinr1

  function do_ajax_control_detalleturno_validate_foliofinr1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_foliofinr1_cb

  // ---------- Validate folioinir2
  function do_ajax_control_detalleturno_validate_folioinir2()
  {
    var nomeCampo_folioinir2 = "folioinir2";
    var var_folioinir2 = scAjaxGetFieldText(nomeCampo_folioinir2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_folioinir2(var_folioinir2, var_script_case_init, do_ajax_control_detalleturno_validate_folioinir2_cb);
  } // do_ajax_control_detalleturno_validate_folioinir2

  function do_ajax_control_detalleturno_validate_folioinir2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_folioinir2_cb

  // ---------- Validate foliofinr2
  function do_ajax_control_detalleturno_validate_foliofinr2()
  {
    var nomeCampo_foliofinr2 = "foliofinr2";
    var var_foliofinr2 = scAjaxGetFieldText(nomeCampo_foliofinr2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_foliofinr2(var_foliofinr2, var_script_case_init, do_ajax_control_detalleturno_validate_foliofinr2_cb);
  } // do_ajax_control_detalleturno_validate_foliofinr2

  function do_ajax_control_detalleturno_validate_foliofinr2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_foliofinr2_cb

  // ---------- Validate folioinir3
  function do_ajax_control_detalleturno_validate_folioinir3()
  {
    var nomeCampo_folioinir3 = "folioinir3";
    var var_folioinir3 = scAjaxGetFieldText(nomeCampo_folioinir3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_folioinir3(var_folioinir3, var_script_case_init, do_ajax_control_detalleturno_validate_folioinir3_cb);
  } // do_ajax_control_detalleturno_validate_folioinir3

  function do_ajax_control_detalleturno_validate_folioinir3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_folioinir3_cb

  // ---------- Validate foliofinr3
  function do_ajax_control_detalleturno_validate_foliofinr3()
  {
    var nomeCampo_foliofinr3 = "foliofinr3";
    var var_foliofinr3 = scAjaxGetFieldText(nomeCampo_foliofinr3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_detalleturno_validate_foliofinr3(var_foliofinr3, var_script_case_init, do_ajax_control_detalleturno_validate_foliofinr3_cb);
  } // do_ajax_control_detalleturno_validate_foliofinr3

  function do_ajax_control_detalleturno_validate_foliofinr3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_detalleturno_validate_foliofinr3_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_detalleturno_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_detalleturno_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mxn = scAjaxGetFieldText("mxn");
    var var_usd = scAjaxGetFieldText("usd");
    ...
    scAjaxProcOn();
    x_ajax_control_detalleturno_submit_form(var_mxn, var_usd, var_cantidadmxn, var_cantidadusd, var_importemxn, var_importeusd, var_folioinicialcr, var_foliofinalcr, var_folioinicialeap, var_foliofinaleap, var_folioinir1, var_foliofinr1, var_folioinir2, var_foliofinr2, var_folioinir3, var_foliofinr3, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_detalleturno_submit_form_cb);
  } // do_ajax_control_detalleturno_submit_form

  function do_ajax_control_detalleturno_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_detalleturno_submit_form_cb_after_alert);
  } // do_ajax_control_detalleturno_submit_form_cb
  function do_ajax_control_detalleturno_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_detalleturno_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_detalleturno_navigate_form()
  {
    perform_ajax_control_detalleturno_navigate_form();
  }

  function perform_ajax_control_detalleturno_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_detalleturno_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_detalleturno']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_detalleturno_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_detalleturno_navigate_form_cb_after_alert);
  } // do_ajax_control_detalleturno_navigate_form_cb
  function do_ajax_control_detalleturno_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_detalleturno_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_detalleturno_navigate_form_cb_after_alert

  function sc_hide_control_detalleturno_form()
  {
  ...
  var ajax_error_list = {
    "mxn": {"label": "Moneda (MXN)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usd": {"label": "Dolares (USD)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_id = {
    ...
    "usd": new Array("hidden_field_label_usd", "hidden_field_data_usd"),
