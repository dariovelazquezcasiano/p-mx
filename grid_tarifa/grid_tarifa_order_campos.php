...
<?php
   ...
   $Ord_Cmp = new grid_tarifa_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tarifa_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["casetaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["casetaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["casetaid"] : "Caseta";
   $tab_ger_campos['tipopagoid'] = "on";
   $tab_def_campos['tipopagoid'] = "TipoPagoID";
   $tab_labels["tipopagoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["tipopagoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["tipopagoid"] : "Tipo Pago";
   $tab_ger_campos['vehiculoid'] = "on";
   $tab_def_campos['vehiculoid'] = "VehiculoID";
   $tab_labels["vehiculoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["vehiculoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["vehiculoid"] : "Vehiculo";
   $tab_ger_campos['fechainicio'] = "on";
   $tab_def_campos['fechainicio'] = "FechaInicio";
   $tab_labels["fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["fechainicio"] : "Fecha Inicio";
   $tab_ger_campos['fechafin'] = "on";
   $tab_def_campos['fechafin'] = "FechaFin";
   $tab_labels["fechafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["fechafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["fechafin"] : "Fecha Fin";
   $tab_ger_campos['importe'] = "on";
   $tab_def_campos['importe'] = "Importe";
   $tab_labels["importe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["importe"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["importe"] : "Importe";
   $tab_ger_campos['importeejeligero'] = "on";
   $tab_def_campos['importeejeligero'] = "ImporteEjeLigero";
   $tab_labels["importeejeligero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["importeejeligero"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["importeejeligero"] : "Importe Eje Ligero";
   $tab_ger_campos['importeejepesado'] = "on";
   $tab_def_campos['importeejepesado'] = "ImporteEjePesado";
   $tab_labels["importeejepesado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["importeejepesado"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["importeejepesado"] : "Importe Eje Pesado";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "Activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['labels']["activo"] : "Activo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tarifa']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tarifa']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tarifa_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tarifa']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
