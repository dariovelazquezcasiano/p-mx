<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tarifa']['sc_process_barr'] = true;
require_once('../grid_tarifa/index.php');
unset($_SESSION['scriptcase']['grid_tarifa']['sc_process_barr']);
$ExportCtrl = new grid_tarifa_export_control;
$ExportCtrl->Export_barr();

class grid_tarifa_export_control
{
