...
class grid_sc_log_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_sc_log/grid_sc_log_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['xls_name']))
      {
          ...
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['xls_name'] .= $this->Xls_tp;
          }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?>  log :: Excel</TITLE>
