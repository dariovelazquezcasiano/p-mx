<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["inserted_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["inserted_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["inserted_date"] : "Fecha Hora";
   ...
   $tab_labels["application"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["application"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["application"] : "Aplicacion";
   $tab_ger_campos['ip_user'] = "on";
   $tab_def_campos['ip_user'] = "ip_user";
   $tab_labels["ip_user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["ip_user"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["ip_user"] : "IP Usuario";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["sc_field_0"] : "Accion";
   $tab_ger_campos['description'] = "on";
   $tab_def_campos['description'] = "description";
   $tab_labels["description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["description"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["description"] : "Descripcion";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sc_log']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sc_log']['ordem_quebra'][$campo][$sqldef] = $ordem;
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?>  log</TITLE>
