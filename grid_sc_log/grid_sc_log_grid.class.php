...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'])) {
   ...
   { 
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao_print'] != 'print')
       { 
       $nm_saida->saida("     <TR>\r\n");
       $nm_saida->saida("      <TD id=\"div_refin_search\" class=\"scGridRefinedSearchPadding\" valign='top'>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['ajax_nav'])
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['refresh_interativ']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['refresh_interativ'] == "S") {
                   $this->Ini->Arr_result['setValue'][] = array('field' => 'div_refin_search', 'value' => NM_charset_to_utf8($_SESSION['scriptcase']['saida_html']));
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['refresh_interativ']);
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
...
//
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pesq_tab_label']))
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pesq_tab_label'] .= "inserted_date?#?" . "Fecha Hora" . "?@?";
   ...
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_sc_log']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_sc_log']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_sc_log']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_sc_log']['lig_edit'] = "N";}
   ...
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT str_replace (convert(char(10),inserted_date,102), '.', '-') + ' ' + convert(char(8),inserted_date,20), username, application, ip_user, `action` as sc_field_0, description, id, creator from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT inserted_date, username, application, ip_user, `action` as sc_field_0, description, id, creator from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT convert(char(23),inserted_date,121), username, application, ip_user, `action` as sc_field_0, description, id, creator from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT EXTEND(inserted_date, YEAR TO FRACTION), username, application, ip_user, `action` as sc_field_0, description, id, creator from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT inserted_date, username, application, ip_user, `action` as sc_field_0, description, id, creator from " . $this->Ini->nm_tabela; 
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?>  log :: PDF</TITLE>
...
<?php
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_sc_log_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_sc_log_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_sc_log_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_sc_log_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_sc_log_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_title'] . "  log</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_sc_log_jquery-3.6.0.min.js\"></script>\r\n");
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_sc_log-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_sc_log-1\");\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['proc_pdf_vert'])
  {
   ...
   { 
       ...
       else
       {
          ...
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
...
//----- 
 function cabecalho_normal()
 {
   ...
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_grid_title'] . "  log</div>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_creator_label'] . "\" >&nbsp;</TD>\r\n");
   } 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['inserted_date'])) ? $this->New_label['inserted_date'] : "Fecha Hora";
   $classColFld = "";
   $classColTitle = "";
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['application'])) ? $this->New_label['application'] : "Aplicacion";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ip_user'])) ? $this->New_label['ip_user'] : "IP Usuario";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_ip_user_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ip_user_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('ip_user');
        $fieldSortIcon = $this->scGetColumnOrderIcon('ip_user', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('ip_user')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Accion";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['description'])) ? $this->New_label['description'] : "Descripcion";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['creator'])) ? $this->New_label['creator'] : "Creador";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['ordem_cmp'] == $fieldName) {
...
// 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_refresh'] = false;
   }
...
// 
          ...
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              ...
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_sc_log_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sc_log/grid_sc_log_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_sc_log&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sc_log/grid_sc_log_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid&nm_all_modules=grid&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sc_log/grid_sc_log_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
   ...
   {
       global $nm_saida;
       $this->Cmps_required = array('inserted_date');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('inserted_date','username');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']) < 2)
       {
   ...
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_inserted_date_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_inserted_date_cond_" . $ind . "' name='cond_grid_search_inserted_date_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "y")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_inserted_date_ano_val_" . $ind . "' name='val_grid_search_inserted_date_ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_inserted_date_mes_val_" . $ind . "' name='val_grid_search_inserted_date_mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_inserted_date_dia_val_" . $ind . "' name='val_grid_search_inserted_date_dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "     <input type=\"hidden\" id=\"sc_grid_inserted_date_jq_" . $ind . "\">";
       $lin_obj .= "&nbsp;";
   ...
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_username_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_username_cond_" . $ind . "' name='cond_grid_search_username_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['psq_check_ret']['username'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['psq_check_ret']['username'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_username_val_" . $ind . "\" name=\"val_grid_search_username_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       ...
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $username_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "BackOffice_Acapulco/grid_sc_log";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("                     $('#sc_grid_inserted_date_jq_' + i).datepicker({\r\n");
       $nm_saida->saida("                        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("                          var_dt_ini  = document.getElementById('grid_search_inserted_date_dia_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_inserted_date_mes_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_inserted_date_ano_val_' + i_calendar).value;\r\n");
       $nm_saida->saida("                          document.getElementById('sc_grid_inserted_date_jq_' + i_calendar).value = var_dt_ini;\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("                          aParts  = dateText.split(\"/\");\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_inserted_date_dia_val_' + i_calendar).value = aParts[0];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_inserted_date_mes_val_' + i_calendar).value = aParts[1];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_inserted_date_ano_val_' + i_calendar).value = aParts[2];\r\n");
       $nm_saida->saida("                        },\r\n");
   ...
   function html_interativ_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_dados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_dados'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_label']['username'] = (isset($this->New_label['username'])) ? $this->New_label['username'] : 'Usuario';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_sql']['username']   = "username";
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search']["username"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search']["username"])) ? "none" : "";
       $displ_open= false;
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_label']['username'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'];
       }
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search']['username'])) ? "" : "none";
       ...
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_dados']['username'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_dados']['username'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
           ...
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search']['username']))
           {
               $lin_obj  .= "        <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear_opc', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_label']['username']) . "','username','id_int_search_username','username', '" . NM_encode_input($dados . "##@@" . $formatado) . "', 'S');\"/>";
           }
           $lin_obj  .= "        <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_label']['username']) . "','username','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'username', '', 'N');\" class='scGridRefinedSearchCampoFont'>";
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search']['username']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search']['username']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'grid_sc_log_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=username&tp_obj=tx&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       $lin_obj  .= "   </div></td></tr>";
       {
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bmultiselect", "nm_mult_int_search('username', false);", "nm_mult_int_search('username', false);", "mult_int_search_username", "", "", "display: $disp_show_multi_btn;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "multiselect", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $disp_multi_btn = 'none';
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_label']['username']) . "','username','id_int_search_username','username', '', 'N');", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_label']['username']) . "','username','id_int_search_username','username', '', 'N');", "app_int_search_username", "", "", "display: $disp_multi_btn ;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_cancel", "nm_single_int_search('username');", "nm_single_int_search('username');", "single_int_search_username", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $lin_obj .= "    </div>";
       }
       $lin_obj .= "    </td>";
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_sc_log', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_sc_log')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_sc_log', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
