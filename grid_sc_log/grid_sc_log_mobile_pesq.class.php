...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_inserted_date"  <?php echo $str_hide_inserted_date?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
