...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_title'] ?>  log :: PDF</title>
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_sc_log']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['grid_sc_log']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['grid_sc_log']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_sc_log']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_sc_log']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_grid_sc_log.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_sc_log'][$path_doc_md5][0] = $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
