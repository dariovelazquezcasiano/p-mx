...
class grid_sc_log_xml
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_sc_log/grid_sc_log_res_xml.class.php"))
      {
          $this->Tem_xml_res  = false;
      }
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['xml_name']))
      {
          ...
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['xml_name'] .= ".xml";
          }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?>  log :: XML</TITLE>
