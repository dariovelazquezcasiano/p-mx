<?php
   ...
   $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_doc']        = "";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_sc_log']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_sc_log']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_sc_log']['save_session']['data'] = '';
      } 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_sc_log']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_sc_log']['embutida'])
      {
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'])) {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_sc_log']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_sc_log']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . "  log";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['grid_sc_log']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['pivot_tabular']);
              }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] = "json_res"; 
      }
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_orig'])) && !isset($_POST['reload_comb_chart']))
      {
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_refresh'] = true;
          } 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] == "interativ_search")
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_refresh'] = true;
      } 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_lookup'] = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['contr_total_geral'] = "NAO";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_sc_log.pdf";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_sc_log/grid_sc_log_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_sc_log_json.class.php"); 
          } 
          $this->json  = new grid_sc_log_json();
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_sc_log_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pdf_name'], 1);
                }
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_sc_log_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_sc_log_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
$downloadFileName = "grid_sc_log.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'] . ")"; 
              }
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['fast_search'][0] = $in_fields;
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $Cmps_check_return = array('username');
       ...
       foreach ($tmp as $cada_f)
       {
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
                       echo $oJson->encode($this->Ini->Arr_result);
                       $this->close_emb();
                       exit;
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           ...
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   ...
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           elseif ($prep == "" && $delim != "")
           {
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
       }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_orig'])) 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_fast'] . ")";
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?>  log :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['grid_sc_log']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   { 
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_sc_log']['mostra_edit'] = "S";
       }
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_sc_log']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_sc_log']['sc_modal'] = false;
       }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_sc_log']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_sc_log']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
...
//
   ...
   function grid_sc_log_pack_protect_string($sString)
   {
    ...
    function grid_sc_log_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_sc_log']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
