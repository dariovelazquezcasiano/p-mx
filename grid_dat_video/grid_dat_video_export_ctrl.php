<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dat_video']['sc_process_barr'] = true;
require_once('../grid_dat_video/index.php');
unset($_SESSION['scriptcase']['grid_dat_video']['sc_process_barr']);
$ExportCtrl = new grid_dat_video_export_control;
$ExportCtrl->Export_barr();

class grid_dat_video_export_control
{
