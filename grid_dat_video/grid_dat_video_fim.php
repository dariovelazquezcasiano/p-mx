...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_dat_video"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_dat_video"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dat_video']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dat_video']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dat_video']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dat_video']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dat_video']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dat_video']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dat_video']['embutida_filho'] as $ind => $sc_init)
          {
