...
class grid_rep_participacion_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $count_tipo;
   var $sum_tipo_t_vehiculos;
   var $sum_tipo_porciento;
   var $sc_proc_quebra_t_usuario;
   var $count_t_usuario;
   var $sum_t_usuario_t_vehiculos;
   var $sum_t_usuario_porciento;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_t_usuario = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_rep_participacion'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_rep_participacion'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_rep_participacion']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_rep_participacion']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_rep_participacion']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_rep_participacion']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_rep_participacion']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_total_geral'] == "OK")
      {
          $this->array_total_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['tipo'];
          $this->array_total_t_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['t_usuario'];
      }
      else
      {
          $this->array_total_tipo = array();
          $this->array_total_t_usuario = array();
          $this->totaliza_php_porciento();
      }
      $this->array_total_geral = array();
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['json_use_label'])
       {
          $Lab_tipo = "Tipo";
          $Lab_t_usuario = "t_usuario";
       }
       else
       {
       $Lab_tipo = "Tipo";
       $Lab_t_usuario = "Usuario";
       }
       $this->comp_field = array(
           $Lab_tipo,
           $Lab_t_usuario,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['t_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['t_usuario'] = "Forma de Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['t_vehiculos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['t_vehiculos'] = "Vehiculos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['porciento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['labels']['porciento'] = "Porcentaje"; 
       }
       //-----
       $this->comp_field_nm = array(
           'tipo' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_order']['porciento']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_order']['porciento'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_order']['porciento'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_display']['porciento'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_display']['porciento'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_display']['porciento'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_display']['porciento'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_display']['porciento'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_display']['porciento'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['summarizing_fields_display']['porciento'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "t_vehiculos", 'show' => true),
           3 => array('field' => "porciento", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_t_vehiculos_sum",
           3 => "css_porciento_sum",
       );
       ...
       foreach ($this->array_total_tipo as $i_tipo => $d_tipo) {
           if (!isset($i_tipo, $this->comp_label[0]) || !in_array($i_tipo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tipo[4] ] = $d_tipo[3];
               $this->comp_label[0][ $d_tipo[4] ] = $d_tipo[3];
           }
           foreach ($this->array_total_t_usuario[$i_tipo] as $i_t_usuario => $d_t_usuario) {
               if (!isset($i_t_usuario, $this->comp_label[1][ $d_tipo[4] ]) || !in_array($i_t_usuario, $this->comp_label[1][ $d_tipo[4] ], true)) {
                   $this->comp_index[1][ $d_t_usuario[4] ] = $d_t_usuario[3];
                   $this->comp_label[1][ $d_tipo[4] ][ $d_t_usuario[4] ] = $d_t_usuario[3];
               }
           }
       }
       ...
       //-----
       $this->comp_align = array('center', 'center');
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 't_usuario', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_tipo => $l_tipo) {
           ...
           foreach ($this->comp_label[1][$i_tipo] as $i_t_usuario => $l_t_usuario) {
               if (isset($this->array_total_t_usuario[$i_tipo][$i_t_usuario])) {
                   $this->comp_group[$i_tipo][$i_t_usuario] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_t_usuario;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_rep_participacion@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_rep_participacion_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_rep_participacion_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_rep_participacion']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_rep_participacion']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_rep_participacion']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_rep_participacion']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      $this->monta_rodape();
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "grid_rep_participacion_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_rep_participacion_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['tipo'];
      $this->array_total_t_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['t_usuario'];
      if (is_array($this->array_total_tipo)) {
          ksort($this->array_total_tipo);
      }
      if (is_array($this->array_total_t_usuario)) {
          ksort($this->array_total_t_usuario);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Participación vehícular</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_rep_participacion_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_rep_participacion_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_rep_participacion_message.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_rep_participacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_rep_participacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_rep_participacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_rep_participacion/grid_rep_participacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . " sc-app-grid\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_rep_participacion/grid_rep_participacion_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         ...
         $NM_btn = false;
         $NM_Gbtn = false;
         if (is_file("grid_rep_participacion_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_rep_participacion_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_rep_participacion/grid_rep_participacion_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_rep_participacion']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_rep_participacion']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['graf_pdf'] == "S")
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_rep_participacion_config_pivot.php?nome_apl=grid_rep_participacion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_rep_participacion_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
          ...
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_rep_participacion/grid_rep_participacion_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("               document.Fdoc_word.action = \"grid_rep_participacion_export_ctrl.php\";\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"grid_rep_participacion_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
          ...
          $nm_saida->saida("               document.Fexport.action = \"grid_rep_participacion_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['grid_rep_participacion_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_rep_participacion@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_rep_participacion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_rep_participacion/grid_rep_participacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_rep_participacion_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_rep_participacion_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_rep_participacion_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TABLE id=\"res_chart_table\" border=\"0px\" cellpadding=\"0px\" cellspacing=\"4px\" align=\"center\" valign=\"top\" " . $summary_width . ">\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ajax_nav'])
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
       } 
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_rep_participacion_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           grid_rep_participacion_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_rep_participacion_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_rep_participacion_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_rep_participacion_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " "  : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_t_vehiculos, $sum_porciento, $quebra_tipo, $quebra_t_usuario, $quebra_tipo_orig, $quebra_t_usuario_orig)
   {
      //----- Tipo
      if (!isset($this->array_total_tipo[$quebra_tipo_orig]))
      {
         $this->array_total_tipo[$quebra_tipo_orig][0] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][1] = $sum_t_vehiculos;
         $this->array_total_tipo[$quebra_tipo_orig][2] = $sum_porciento;
      ...
      else
      {
         ...
         $this->array_total_tipo[$quebra_tipo_orig][1] = bcadd($this->array_total_tipo[$quebra_tipo_orig][1], $sum_t_vehiculos, 10);
         $this->array_total_tipo[$quebra_tipo_orig][2] = bcadd($this->array_total_tipo[$quebra_tipo_orig][2], $sum_porciento, 10);
      }
      //----- Forma de Pago
      if (!isset($this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig]))
      {
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][0] = 1;
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][1] = $sum_t_vehiculos;
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][2] = $sum_porciento;
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][3] = $quebra_t_usuario;
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][4] = $quebra_t_usuario_orig;
      }
      else
      {
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][0]++;
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][1] = bcadd($this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][1], $sum_t_vehiculos, 10);
         $this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][2] = bcadd($this->array_total_t_usuario[$quebra_tipo_orig][$quebra_t_usuario_orig][2], $sum_porciento, 10);
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_t_vehiculos;
         $this->array_total_geral[2] = $sum_porciento;
      }
      else
      {
         $this->array_total_geral[0]++;
         $this->array_total_geral[1] = bcadd($this->array_total_geral[1], $sum_t_vehiculos, 10);
         $this->array_total_geral[2] = bcadd($this->array_total_geral[2], $sum_porciento, 10);
      }
   }
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['tipo'] as $campo_tipo => $dados_tipo)
      {
         $this->array_total_tipo[$campo_tipo][1] = $dados_tipo[1];
         $this->array_total_tipo[$campo_tipo][2] = $dados_tipo[2];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['t_usuario'][$campo_tipo] as $campo_t_usuario => $dados_t_usuario)
         {
            $this->array_total_t_usuario[$campo_tipo][$campo_t_usuario][1] = $dados_t_usuario[1];
            $this->array_total_t_usuario[$campo_tipo][$campo_t_usuario][2] = $dados_t_usuario[2];
         }
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT t_usuario, Tipo, t_vehiculos from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('porciento', 'tipo');
     $campos_order = $this->Ini->Get_date_order_groupby("Tipo", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('porciento', 't_usuario');
     $campos_order = $this->Ini->Get_date_order_groupby("t_usuario", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->t_usuario = $rs_res->fields[0] ;  
            $this->tipo = $rs_res->fields[1] ;  
            $this->t_vehiculos = $rs_res->fields[2] ;  
            $this->look_t_usuario = $this->t_usuario; 
            $this->Lookup->lookup_t_usuario($this->look_t_usuario, $this->t_usuario) ; 
            $_SESSION['scriptcase']['grid_rep_participacion']['contr_erro'] = 'on';
 $check_sql = "SELECT
    sum(fld_cantveh_dia)
FROM
    dat_aforo_dia
WHERE 
	fld_usuario_dia = 'NOR' or fld_usuario_dia = 'IAV' or fld_usuario_dia = 'ELU' or fld_usuario_dia = 'VSC'";
...
$this->porciento  = number_format(($this->t_vehiculos /$vtotal)*100,2, '.', '');
$_SESSION['scriptcase']['grid_rep_participacion']['contr_erro'] = 'off'; 
            $this->tipo_orig = $this->tipo;
            $this->t_usuario_orig = $this->t_usuario;
            $this->t_usuario = $this->look_t_usuario ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->t_vehiculos, $this->porciento, $this->tipo, $this->t_usuario, $this->tipo_orig,  $this->t_usuario_orig);
            }
   }
//
   ...
   function totaliza_php_porciento()
   {
      $this->sc_proc_grid = true;
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_total_geral'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_array_resumo'] == "OK")
      {
          return;
      }
      //----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][1] = 0;
         return;
      }  
      $this->inicializa_arrays();
      ...
      {
         $this->t_usuario = $this->rs_grid->fields[0] ;  
         $this->tipo = $this->rs_grid->fields[1] ;  
         $this->t_vehiculos = $this->rs_grid->fields[2] ;  
         $this->t_vehiculos = (string)$this->t_vehiculos;  
         $tipo_orig = $this->tipo;
         $t_usuario_orig = $this->t_usuario;
         $_SESSION['scriptcase']['grid_rep_participacion']['contr_erro'] = 'on';
 $check_sql = "SELECT
    sum(fld_cantveh_dia)
FROM
...
$this->porciento  = number_format(($this->t_vehiculos /$vtotal)*100,2, '.', '');
$_SESSION['scriptcase']['grid_rep_participacion']['contr_erro'] = 'off';
         $this->arg_sum_t_usuario = " = " . $this->Db->qstr($this->t_usuario);
         $this->arg_sum_tipo = " = " . $this->Db->qstr($this->tipo);
         $this->Lookup->lookup_t_usuario($this->t_usuario, $this->t_usuario) ; 
         $this->GB_tipo = $this->tipo;
         $this->Lookup->lookup_porciento_tipo($this->GB_tipo); 
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->t_vehiculos)), NM_encode_input(sc_strip_script($this->porciento)), sc_strip_script($this->GB_tipo), sc_strip_script($this->t_usuario), sc_strip_script($tipo_orig), sc_strip_script($t_usuario_orig));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][1] = $this->array_total_geral[0];
      $count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][1];
      $sum_t_vehiculos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][2];
      $sum_porciento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['tot_geral'][3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['SC_Ind_Groupby'] == "porciento")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['tipo'] = $this->array_total_tipo;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rep_participacion']['arr_total']['t_usuario'] = $this->array_total_t_usuario;
      }
   }
