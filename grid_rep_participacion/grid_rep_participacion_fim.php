...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_rep_participacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_rep_participacion"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_rep_participacion']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_rep_participacion']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rep_participacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_rep_participacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rep_participacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_rep_participacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_rep_participacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_rep_participacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_rep_participacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_rep_participacion']['embutida_filho'] as $ind => $sc_init)
          {
