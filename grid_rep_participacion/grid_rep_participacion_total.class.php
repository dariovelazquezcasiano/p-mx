...
class grid_rep_participacion_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_rep_participacion']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_rep_participacion']['campos_busca']))
      { 
