<?php
@session_start() ;
$_SESSION['scriptcase']['grid_rep_participacion']['sc_process_barr'] = true;
require_once('../grid_rep_participacion/index.php');
unset($_SESSION['scriptcase']['grid_rep_participacion']['sc_process_barr']);
$ExportCtrl = new grid_rep_participacion_export_control;
$ExportCtrl->Export_barr();

class grid_rep_participacion_export_control
{
