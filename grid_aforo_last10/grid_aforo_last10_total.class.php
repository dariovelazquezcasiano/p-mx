...
class grid_aforo_last10_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_aforo_last10']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_aforo_last10']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_last10']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_last10']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from (SELECT     Consecutivo,     CasetaID,     FechaOperacion,     TurnoID,     HoraEvento,     CarrilID,     Cuerpo,     Secuencial,     Folio,     VehiculoID_ECT,     VehiculoID_CR,     PagoID FROM     aforo Order By Consecutivo DESC Limit 10) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_last10']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from (SELECT     Consecutivo,     CasetaID,     FechaOperacion,     TurnoID,     HoraEvento,     CarrilID,     Cuerpo,     Secuencial,     Folio,     VehiculoID_ECT,     VehiculoID_CR,     PagoID FROM     aforo Order By Consecutivo DESC Limit 10) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_last10']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_last10']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_last10']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aforo_last10']['contr_total_geral'] = "OK";
   } 
