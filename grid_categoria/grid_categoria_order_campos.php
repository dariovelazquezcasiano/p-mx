<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_categoria']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_categoria']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_categoria']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['efectivo'] = "on";
   $tab_def_campos['efectivo'] = "Efectivo";
   $tab_labels["efectivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_categoria']['labels']["efectivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_categoria']['labels']["efectivo"] : "Efectivo";
   $tab_ger_campos['categoriapago'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['categoriapago'] = "categoriapago";
   }
   else
   {
       $tab_def_campos['categoriapago'] = "";
   }
   $tab_labels["categoriapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_categoria']['labels']["categoriapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_categoria']['labels']["categoriapago"] : "Categoría Pago";
   $tab_ger_campos['categoriapago'] = "none";
