<?php
@session_start() ;
$_SESSION['scriptcase']['grid_estadodispositivos']['sc_process_barr'] = true;
require_once('../grid_estadodispositivos/index.php');
unset($_SESSION['scriptcase']['grid_estadodispositivos']['sc_process_barr']);
$ExportCtrl = new grid_estadodispositivos_export_control;
$ExportCtrl->Export_barr();

class grid_estadodispositivos_export_control
{
