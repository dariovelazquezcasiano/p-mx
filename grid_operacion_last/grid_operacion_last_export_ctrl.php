<?php
@session_start() ;
$_SESSION['scriptcase']['grid_operacion_last']['sc_process_barr'] = true;
require_once('../grid_operacion_last/index.php');
unset($_SESSION['scriptcase']['grid_operacion_last']['sc_process_barr']);
$ExportCtrl = new grid_operacion_last_export_control;
$ExportCtrl->Export_barr();

class grid_operacion_last_export_control
{
