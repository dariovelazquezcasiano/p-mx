...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_datas[] = "FechaTurno";$Nm_datas[] = "HoraInicio";$Nm_datas[] = "Fecha";$Nm_numeric[] = "retiroid";$Nm_numeric[] = "casetaid";$Nm_numeric[] = "carrilid";$Nm_numeric[] = "importe";$Nm_numeric[] = "deorigenarqueo";$Nm_numeric[] = "retirofondo";$Nm_numeric[] = "tramoid";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_retiroid_cond" name="retiroid_cond" onChange="nm_campos_between(document.getElementById('id_vis_retiroid'), this, 'retiroid')">
      ...
      <br><span id="id_hide_retiroid"  <?php echo $str_hide_retiroid?>><INPUT  type="text" id="SC_retiroid" name="retiroid" value="<?php echo NM_encode_input($retiroid) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_casetaid_cond" name="casetaid_cond" onChange="nm_campos_between(document.getElementById('id_vis_casetaid'), this, 'casetaid')">
      ...
      <br><span id="id_hide_casetaid"  <?php echo $str_hide_casetaid?>><INPUT  type="text" id="SC_casetaid" name="casetaid" value="<?php echo NM_encode_input($casetaid) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_usuarioid_cond" name="usuarioid_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuarioid'), this, 'usuarioid')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_carrilid_cond" name="carrilid_cond" onChange="nm_campos_between(document.getElementById('id_vis_carrilid'), this, 'carrilid')">
      ...
      <br><span id="id_hide_carrilid"  <?php echo $str_hide_carrilid?>><INPUT  type="text" id="SC_carrilid" name="carrilid" value="<?php echo NM_encode_input($carrilid) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
