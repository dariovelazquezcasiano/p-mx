...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_operacion_last"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_operacion_last"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_operacion_last']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_operacion_last']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operacion_last']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_operacion_last']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operacion_last']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_operacion_last']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_operacion_last']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_operacion_last</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_operacion_last']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_operacion_last']['embutida_filho'] as $ind => $sc_init)
          {
