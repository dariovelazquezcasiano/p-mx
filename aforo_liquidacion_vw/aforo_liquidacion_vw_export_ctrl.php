<?php
@session_start() ;
$_SESSION['scriptcase']['aforo_liquidacion_vw']['sc_process_barr'] = true;
require_once('../aforo_liquidacion_vw/index.php');
unset($_SESSION['scriptcase']['aforo_liquidacion_vw']['sc_process_barr']);
$ExportCtrl = new aforo_liquidacion_vw_export_control;
$ExportCtrl->Export_barr();

class aforo_liquidacion_vw_export_control
{
