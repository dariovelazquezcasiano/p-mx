...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____aforo_liquidacion_vw"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____aforo_liquidacion_vw"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_aforo_liquidacionVW'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['aforo_liquidacion_vw']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['aforo_liquidacion_vw']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['aforo_liquidacion_vw']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['aforo_liquidacion_vw']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['aforo_liquidacion_vw']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>aforo_liquidacion_vw</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['aforo_liquidacion_vw']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['aforo_liquidacion_vw']['embutida_filho'] as $ind => $sc_init)
          {
