...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_aforo_liquidacion_vw').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_aforo_liquidacion_vw').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_aforo_liquidacion_vw').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_aforo_liquidacion_vw').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_aforo_liquidacion_vw').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_aforo_liquidacion_vw').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_aforo_liquidacion_vw').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_aforo_liquidacion_vw').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_aforo_liquidacion_vw').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_aforo_liquidacion_vw').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_aforo_liquidacion_vw').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_aforo_liquidacion_vw').style.width  = '0px';
        }
        if (oResp["setValue"]) {
