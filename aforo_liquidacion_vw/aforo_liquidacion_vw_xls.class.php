...
class aforo_liquidacion_vw_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "aforo_liquidacion_vw/aforo_liquidacion_vw_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "aforo_liquidacion_vw_res_xls.class.php");
              $this->Res_xls = new aforo_liquidacion_vw_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_aforo_liquidacion_vw.zip";
          $this->Arquivo   .= "_aforo_liquidacion_vw" . $this->Xls_tp;
          $this->Tit_doc    = "aforo_liquidacion_vw" . $this->Xls_tp;
          $this->Tit_zip    = "aforo_liquidacion_vw.zip";
      ...
      require_once($this->Ini->path_aplicacao . "aforo_liquidacion_vw_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['aforo_liquidacion_vw']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->turnoid = $rs->fields[15] ;  
         $this->turnoid = (string)$this->turnoid;
         $this->carrilid = $rs->fields[16] ;  
         $this->carrilid = (string)$this->carrilid;
         $this->cuerpo = $rs->fields[17] ;  
...
$_SESSION['scriptcase']['aforo_liquidacion_vw']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
         static $placas_val;
         if (!isset($placas_val) || $placas_val != $this->placas) {
             $placas_val = $this->placas;
         } else {
             $this->placas = "";
         }
         $current_cell_ref = $this->calc_cell($this->Xls_col);
   ...
   {
         static $sub_placas_val;
         if (!isset($sub_placas_val) || $sub_placas_val != $this->placas) {
             $sub_placas_val = $this->placas;
         } else {
             $this->placas = "";
         }
         $this->placas = html_entity_decode($this->placas, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['aforo_liquidacion_vw']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
