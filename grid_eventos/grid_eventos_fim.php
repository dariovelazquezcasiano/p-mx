...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_eventos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_eventos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_eventos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_eventos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_eventos']['embutida_filho'] as $ind => $sc_init)
          {
