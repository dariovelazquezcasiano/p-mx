  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sec_configura" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sec_configura_form();
	}
...
?>
  ...
  function do_ajax_form_sec_configura_validate_descripcion_(iNumLinha)
  {
    ...
    x_ajax_form_sec_configura_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sec_configura_validate_descripcion__cb);
  } // do_ajax_form_sec_configura_validate_descripcion_

  function do_ajax_form_sec_configura_validate_descripcion__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_configura_validate_descripcion__cb

  // ---------- Validate params_
  function do_ajax_form_sec_configura_validate_params_(iNumLinha)
  {
    var nomeCampo_params_ = "params_" + iNumLinha;
    var var_params_ = scAjaxGetFieldText(nomeCampo_params_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_configura_validate_params_(var_params_, iNumLinha, var_script_case_init, do_ajax_form_sec_configura_validate_params__cb);
  } // do_ajax_form_sec_configura_validate_params_

  function do_ajax_form_sec_configura_validate_params__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "params_" + iLineNumber;
    }
    else
    {
      sFieldValid = "params_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "params_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "params_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_configura_validate_params__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sec_configura_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sec_configura_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sec_configura_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sec_configura_add_new_line_cb);
  } // do_ajax_form_sec_configura_add_new_line

  function do_ajax_form_sec_configura_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sec_configura_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sec_configura_backup_line(iNumLinha)
  {
    var var_identidad_ = scAjaxGetFieldText("identidad_" + iNumLinha);
    var var_clasifica_ = scAjaxGetFieldText("clasifica_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_configura_backup_line(var_identidad_, var_clasifica_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sec_configura_backup_line_cb);
  } // do_ajax_form_sec_configura_backup_line

  function do_ajax_form_sec_configura_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sec_configura_backup_line_cb

  function do_ajax_form_sec_configura_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sec_configura_cancel_insert

  function do_ajax_form_sec_configura_cancel_update(iSeqVert)
  {
    do_ajax_form_sec_configura_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sec_configura_cancel_update

  function do_ajax_form_sec_configura_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sec_configura_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sec_configura_table_refresh()
  {
    var var_identidad_ = document.F2.identidad_.value;
    var var_clasifica_ = document.F2.clasifica_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sec_configura_table_refresh(var_identidad_, var_clasifica_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sec_configura_table_refresh_cb);
  } //  do_ajax_form_sec_configura_table_refresh

  function do_ajax_form_sec_configura_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.identidad_.value = scAjaxGetKeyValue("identidad_");
    document.F2.clasifica_.value = scAjaxGetKeyValue("clasifica_");
    ...
    scAjaxAlert(do_ajax_form_sec_configura_table_refresh_cb_after_alert);
  } // do_ajax_form_sec_configura_table_refresh_cb
  function do_ajax_form_sec_configura_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sec_configura_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sec_configura_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sec_configura_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_params_ = scAjaxGetFieldText("params_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sec_configura_submit_form(var_descripcion_, var_params_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sec_configura_submit_form_cb);
  } // do_ajax_form_sec_configura_submit_form

  function do_ajax_form_sec_configura_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("params_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sec_configura_submit_form_cb_after_alert);
  } // do_ajax_form_sec_configura_submit_form_cb
  function do_ajax_form_sec_configura_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sec_configura_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sec_configura_navigate_form()
  {
    perform_ajax_form_sec_configura_navigate_form();
  }

  function perform_ajax_form_sec_configura_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("params_" + iNavForm);
    }
    var var_identidad_ = document.F2.identidad_.value;
    var var_clasifica_ = document.F2.clasifica_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sec_configura_navigate_form(var_identidad_, var_clasifica_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sec_configura_navigate_form_cb);
  } // do_ajax_form_sec_configura_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_configura']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sec_configura_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.identidad_.value = scAjaxGetKeyValue("identidad_" + var_last_index);
    document.F2.clasifica_.value = scAjaxGetKeyValue("clasifica_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sec_configura_navigate_form_cb_after_alert);
  } // do_ajax_form_sec_configura_navigate_form_cb
  function do_ajax_form_sec_configura_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sec_configura_navigate_form_cb_after_alert

    function sc_form_sec_configura_get_last_line_number()
    {
    ...
    } //sc_form_sec_configura_get_last_line_number

  function sc_hide_form_sec_configura_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "params_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["params_" + iNumLinha] = {"label": "Params<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["descripcion_"][iNumLinha] = "descripcion_" + iNumLinha;
    ajax_field_mult["params_"][iNumLinha] = "params_" + iNumLinha;
    ajax_field_id["descripcion_" + iNumLinha] = new Array("hidden_field_label_descripcion_", "hidden_field_data_descripcion_" + iNumLinha);
    ajax_field_id["params_" + iNumLinha] = new Array("hidden_field_label_params_", "hidden_field_data_params_" + iNumLinha);
    ajax_error_count["descripcion_" + iNumLinha] = "off";
    ajax_error_count["params_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["descripcion_" + iNumLinha] = "off";
    ajax_read_only["params_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["params_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["params_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["params_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["params_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["params_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["params_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["params_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['params_'])) ? $this->nmgp_cmp_readonly['params_'] : 'off';
?>
    scAjaxFieldRead("params_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("descripcion_" + iSeq, "on");
    scAjaxFieldRead("params_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["params_" + iRow]))
    {
      ...
      $("#hidden_field_data_params_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["params_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["descripcion_" + iRow] = "off";
        ajax_error_count["params_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_params_" + iRow).removeClass("scFormErrorLine");
    }
  }
