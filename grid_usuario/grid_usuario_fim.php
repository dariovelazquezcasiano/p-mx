...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_usuario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_usuario"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_usuario'] = array();
   $fecha_janela = false;
