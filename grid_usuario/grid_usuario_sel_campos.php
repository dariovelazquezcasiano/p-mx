...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_ger_campos['usuariotipoid'] = "on";
      ...
      if ($this->restore)
      {
          if (isset($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel_orig']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel_orig']))
          {
              foreach ($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel_orig'] as $NM_cada_field => $NM_cada_opc)
              {
...
<?php
   ...
   if ($this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['field_order_orig']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['field_order_orig'] as $NM_cada_field)
       {
...
<?php
   ...
   if (!$this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['field_order']))
   {
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel']) && isset($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel_orig']) && $_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel'] != $_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel_orig']) {
      $disp_rest = "";
  }
  else {
      $order_orig = array();
      $order_atu  = array();
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['field_order_orig'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel_orig'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel_orig'][$cmp] != "off") {
              $order_orig[] = $cmp;
          }
      }
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['field_order'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_usuario']['usr_cmp_sel'][$cmp] != "off") {
              $order_atu[] = $cmp;
          }
      }
