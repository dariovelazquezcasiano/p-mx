...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "Fecha";$Nm_numeric[] = "usuarioid";$Nm_numeric[] = "usuariotipoid";$Nm_numeric[] = "casetaid";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_apellidomaterno_cond" name="apellidomaterno_cond" onChange="nm_campos_between(document.getElementById('id_vis_apellidomaterno'), this, 'apellidomaterno')">
      ...
      <br><span id="id_hide_apellidomaterno"  <?php echo $str_hide_apellidomaterno?>><?php
      if ($apellidomaterno != "")
      {
      $apellidomaterno_look = (is_string($apellidomaterno) ? substr($this->Db->qstr($apellidomaterno), 1, -1) : $apellidomaterno); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_usuarioid_cond" name="usuarioid_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuarioid'), this, 'usuarioid')">
      ...
      <br><span id="id_hide_usuarioid"  <?php echo $str_hide_usuarioid?>><?php
      if ($usuarioid != "")
      {
      $usuarioid_look = (is_string($usuarioid) ? substr($this->Db->qstr($usuarioid), 1, -1) : $usuarioid); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_apellidopaterno_cond" name="apellidopaterno_cond" onChange="nm_campos_between(document.getElementById('id_vis_apellidopaterno'), this, 'apellidopaterno')">
      ...
      <br><span id="id_hide_apellidopaterno"  <?php echo $str_hide_apellidopaterno?>><?php
      if ($apellidopaterno != "")
      {
      $apellidopaterno_look = (is_string($apellidopaterno) ? substr($this->Db->qstr($apellidopaterno), 1, -1) : $apellidopaterno); 
      $nmgp_def_dados = array(); 
