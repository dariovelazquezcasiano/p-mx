<?php
@session_start() ;
$_SESSION['scriptcase']['grid_usuario']['sc_process_barr'] = true;
require_once('../grid_usuario/index.php');
unset($_SESSION['scriptcase']['grid_usuario']['sc_process_barr']);
$ExportCtrl = new grid_usuario_export_control;
$ExportCtrl->Export_barr();

class grid_usuario_export_control
{
