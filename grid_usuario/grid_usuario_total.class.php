...
class grid_usuario_total
{
   ...
   //---- 
   function quebra_geral_UsuarioTipoID($res_limit=false)
   {
      global $nada, $nm_lang ;
   ...
   //-----  usuariotipoid
   function quebra_usuariotipoid_UsuarioTipoID($usuariotipoid, $arg_sum_usuariotipoid) 
   {
      global $tot_usuariotipoid;
      $tot_usuariotipoid = array() ;  
      $tot_usuariotipoid[0] = $usuariotipoid ; 
   }
