...
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_usuario']['grid_usuario_iframe_params']))
{
    ...
    $str_google_fonts   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_usuario']['grid_usuario_iframe_params']['str_google_fonts'];
}
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['opc_pdf']['pdf_zip']     = (isset($aParams['pdf_zip']))         ? $aParams['pdf_zip']         : "N";
$Nm_lang     = array();
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_title'] ?> usuario :: PDF</title>
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_grid_usuario.pdf';
...
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['opc_pdf']['pdf_zip']) && $_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario']['opc_pdf']['pdf_zip'] == "S")
 {
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_usuario'][$path_doc_md5][0] = $_SESSION['scriptcase']['grid_usuario']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
