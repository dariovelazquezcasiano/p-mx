<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_usuario']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["casetaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["casetaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["casetaid"] : "Caseta";
   $tab_ger_campos['usuarioid'] = "on";
   $tab_def_campos['usuarioid'] = "UsuarioID";
   $tab_labels["usuarioid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuarioid"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuarioid"] : "Usuario ID";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "Nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['apellidopaterno'] = "on";
   $tab_def_campos['apellidopaterno'] = "ApellidoPaterno";
   $tab_labels["apellidopaterno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["apellidopaterno"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["apellidopaterno"] : "Apellido Paterno";
   $tab_ger_campos['apellidomaterno'] = "on";
   $tab_def_campos['apellidomaterno'] = "ApellidoMaterno";
   $tab_labels["apellidomaterno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["apellidomaterno"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["apellidomaterno"] : "Apellido Materno";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "Activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["activo"] : "Estatus";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> usuario</TITLE>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
