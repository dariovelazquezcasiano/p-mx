...
class grid_usuario_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_usuariotipoid = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_usuario']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_usuario']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['contr_total_geral'] == "OK")
      {
          $this->array_total_usuariotipoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['arr_total']['usuariotipoid'];
      }
      else
      {
          $this->array_total_usuariotipoid = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['arr_total']['usuariotipoid'] = $this->array_total_usuariotipoid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['json_use_label'])
       {
          $Lab_usuariotipoid = "UsuarioTipoID";
       }
       else
       {
       $Lab_usuariotipoid = "Usuario";
       }
       $this->comp_field = array(
           $Lab_usuariotipoid,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['casetaid'] = "Caseta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['usuarioid'] = "Usuario ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['nombre'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['apellidopaterno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['apellidopaterno'] = "Apellido Paterno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['apellidomaterno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['apellidomaterno'] = "Apellido Materno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['activo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['activo'] = "Estatus"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['password']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['password'] = "Password"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['usuariotipoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['usuariotipoid'] = "Usuario Tipo ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['labels']['fecha'] = "Fecha"; 
       }
       //-----
       $this->comp_field_nm = array(
           'usuariotipoid' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_order']['UsuarioTipoID']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_order']['UsuarioTipoID'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_order']['UsuarioTipoID'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_display']['UsuarioTipoID'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_display']['UsuarioTipoID'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_display']['UsuarioTipoID'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_display']['UsuarioTipoID'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_display']['UsuarioTipoID'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_display']['UsuarioTipoID'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['summarizing_fields_display']['UsuarioTipoID'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_usuariotipoid as $i_usuariotipoid => $d_usuariotipoid) {
           if (!isset($i_usuariotipoid, $this->comp_label[0]) || !in_array($i_usuariotipoid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_usuariotipoid[2] ] = $d_usuariotipoid[1];
               $this->comp_label[0][ $d_usuariotipoid[2] ] = $d_usuariotipoid[1];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_usuariotipoid => $l_usuariotipoid) {
           if (isset($this->array_total_usuariotipoid[$i_usuariotipoid])) {
               $this->comp_group[$i_usuariotipoid] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_usuariotipoid;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_usuario@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_usuario_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_UsuarioTipoID("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_usuariotipoid)) {
          ksort($this->array_total_usuariotipoid);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_usuario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_usuario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_usuario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_usuario/grid_usuario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_usuario_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_usuario']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_usuario']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_usuario_config_pivot.php?nome_apl=grid_usuario&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_usuario_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_usuario/grid_usuario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $apellidomaterno = (isset($Busca_temp['apellidomaterno'])) ? $Busca_temp['apellidomaterno'] : ""; 
          $tmp_pos = (is_string($apellidomaterno)) ? strpos($apellidomaterno, "##@@") : false;
          if ($tmp_pos !== false && !is_array($apellidomaterno))
          {
          ...
          $apellidopaterno = (isset($Busca_temp['apellidopaterno'])) ? $Busca_temp['apellidopaterno'] : ""; 
          $tmp_pos = (is_string($apellidopaterno)) ? strpos($apellidopaterno, "##@@") : false;
          if ($tmp_pos !== false && !is_array($apellidopaterno))
          {
   ...
   //---- 
   function adiciona_registro($quebra_usuariotipoid, $quebra_usuariotipoid_orig)
   {
      //----- Usuario Tipo ID
      if (!isset($this->array_total_usuariotipoid[$quebra_usuariotipoid_orig]))
      {
         $this->array_total_usuariotipoid[$quebra_usuariotipoid_orig][0] = 1;
         $this->array_total_usuariotipoid[$quebra_usuariotipoid_orig][1] = $quebra_usuariotipoid;
         $this->array_total_usuariotipoid[$quebra_usuariotipoid_orig][2] = $quebra_usuariotipoid_orig;
      }
      else
      {
         $this->array_total_usuariotipoid[$quebra_usuariotipoid_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->apellidomaterno = $Busca_temp['apellidomaterno']; 
       $this->apellidomaterno = (isset($Busca_temp['apellidomaterno'])) ? $Busca_temp['apellidomaterno'] : ""; 
       $tmp_pos = (is_string($this->apellidomaterno)) ? strpos($this->apellidomaterno, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->apellidomaterno))
       {
       ...
       $this->apellidopaterno = $Busca_temp['apellidopaterno']; 
       $this->apellidopaterno = (isset($Busca_temp['apellidopaterno'])) ? $Busca_temp['apellidopaterno'] : ""; 
       $tmp_pos = (is_string($this->apellidopaterno)) ? strpos($this->apellidopaterno, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->apellidopaterno))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('UsuarioTipoID', 'usuariotipoid');
     $campos_order = $this->Ini->Get_date_order_groupby("UsuarioTipoID", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->usuarioid = $rs_res->fields[1] ;  
            $this->nombre = $rs_res->fields[2] ;  
            $this->apellidopaterno = $rs_res->fields[3] ;  
            $this->apellidomaterno = $rs_res->fields[4] ;  
            $this->activo = $rs_res->fields[5] ;  
            $this->password = $rs_res->fields[6] ;  
            $this->usuariotipoid = $rs_res->fields[7] ;  
...
$_SESSION['scriptcase']['grid_usuario']['contr_erro'] = 'off'; 
            $this->usuariotipoid_orig = $this->usuariotipoid;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->usuariotipoid, $this->usuariotipoid_orig);
            }
   }
//
