<?php
@session_start() ;
$_SESSION['scriptcase']['otme1y2r1']['sc_process_barr'] = true;
require_once('../otme1y2r1/index.php');
unset($_SESSION['scriptcase']['otme1y2r1']['sc_process_barr']);
$ExportCtrl = new otme1y2r1_export_control;
$ExportCtrl->Export_barr();

class otme1y2r1_export_control
{
