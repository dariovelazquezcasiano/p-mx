<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['otme1y2r1']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new otme1y2r1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class otme1y2r1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['caseta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['caseta'] = "caseta";
   }
   else
   {
       $tab_def_campos['caseta'] = "fld_caseta";
   }
   $tab_labels["caseta"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["caseta"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["caseta"] : "" . $this->Nm_lang['lang_dat_tag_fld_fld_caseta'] . "";
   $tab_ger_campos['carril'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['carril'] = "carril";
   }
   else
   {
       $tab_def_campos['carril'] = "fld_carril";
   }
   $tab_labels["carril"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["carril"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["carril"] : "" . $this->Nm_lang['lang_dat_tag_fld_fld_carril'] . "";
   $tab_ger_campos['id_tag'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['id_tag'] = "id_tag";
   }
   else
   {
       $tab_def_campos['id_tag'] = "fld_tarjeta";
   }
   $tab_labels["id_tag"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["id_tag"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["id_tag"] : "Identificador TAG";
   ...
   {
       $tab_def_campos['placas'] = "fld_placas";
   }
   $tab_labels["placas"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["placas"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["placas"] : "" . $this->Nm_lang['lang_dat_aforo_fld_fld_placas'] . "";
   ...
   {
       $tab_def_campos['fecha'] = "fld_fecha";
   }
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["fecha"] : "" . $this->Nm_lang['lang_dat_tag_fld_fld_fecha'] . "";
   ...
   {
       $tab_def_campos['hora'] = "fld_hora";
   }
   $tab_labels["hora"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["hora"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["hora"] : "Hora";
   $tab_ger_campos['clase'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['clase'] = "clase";
   }
   else
   {
       $tab_def_campos['clase'] = "fld_veh_analista";
   }
   $tab_labels["clase"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["clase"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["clase"] : "" . $this->Nm_lang['lang_dat_tag_fld_fld_clase'] . "";
   $tab_ger_campos['ejes'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ejes'] = "ejes";
   }
   else
   {
       $tab_def_campos['ejes'] = "(fld_eea_ana+fld_eec_ana)";
   }
   $tab_labels["ejes"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["ejes"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["ejes"] : "Ejes";
   ...
   {
       $tab_def_campos['importe'] = "fld_importe_ana+(fld_eea_ana*fld_tarifa_eea)+(fld_tarifa_eec*fld_eec_ana)";
   }
   $tab_labels["importe"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["importe"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["importe"] : "Importe";
   ...
   {
       $tab_def_campos['usuario'] = "fld_usuario_ana";
   }
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['labels']["usuario"] : "Tipo de usuario";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['otme1y2r1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['otme1y2r1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "otme1y2r1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['otme1y2r1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
