...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fld_fecha";$Nm_datas[] = "fld_fecha_op";$Nm_numeric[] = "(fld_eea_ana+fld_eec_ana)";$Nm_numeric[] = "fld_importe_ana+(fld_eea_ana*fld_tarifa_eea)+(fld_tarifa_eec*fld_eec_ana)";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fld_fecha_op"  <?php echo $str_hide_fld_fecha_op?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
