...
class otme1y2r1_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . otme1y2r1_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . otme1y2r1_pack_protect_string($Tipo_filter[0]) . "\">.." . otme1y2r1_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fld_fecha";$Nm_datas[] = "fld_fecha_op";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>otme1y2r1/otme1y2r1_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="otme1y2r1_ajax_search.js"></script>
 <script type="text/javascript" src="otme1y2r1_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="otme1y2r1_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['otme1y2r1']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['otme1y2r1']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_fld_fecha_op_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fld_fecha_op_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fld_fecha_op_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fld_fecha_op_ano').value;
          document.getElementById('sc_fld_fecha_op_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fld_fecha_op_dia').value = aParts[0];
          document.getElementById('SC_fld_fecha_op_mes').value = aParts[1];
          document.getElementById('SC_fld_fecha_op_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fld_fecha_op_cond#NMF#' + search_get_sel_txt('SC_fld_fecha_op_cond') + '@NMF@';
  str_out += 'SC_fld_fecha_op_dia#NMF#' + search_get_sel_txt('SC_fld_fecha_op_dia') + '@NMF@';
  str_out += 'SC_fld_fecha_op_mes#NMF#' + search_get_sel_txt('SC_fld_fecha_op_mes') + '@NMF@';
  str_out += 'SC_fld_fecha_op_ano#NMF#' + search_get_sel_txt('SC_fld_fecha_op_ano') + '@NMF@';
  str_out += 'SC_fld_fecha_op_input_2_dia#NMF#' + search_get_sel_txt('SC_fld_fecha_op_input_2_dia') + '@NMF@';
  str_out += 'SC_fld_fecha_op_input_2_mes#NMF#' + search_get_sel_txt('SC_fld_fecha_op_input_2_mes') + '@NMF@';
  str_out += 'SC_fld_fecha_op_input_2_ano#NMF#' + search_get_sel_txt('SC_fld_fecha_op_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>TAG</span></td>
...
<?php
   ...
   {
      global 
             $fld_fecha_op_cond, $fld_fecha_op, $fld_fecha_op_dia, $fld_fecha_op_mes, $fld_fecha_op_ano,
             $caseta_cond, $caseta,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fld_fecha_op_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_dia']; 
          $fld_fecha_op_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_mes']; 
          $fld_fecha_op_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_ano']; 
          $fld_fecha_op_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_cond']; 
          $caseta = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['caseta']; 
          $caseta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['caseta_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fld_fecha_op_cond) || empty($fld_fecha_op_cond))
      {
         $fld_fecha_op_cond = "eq";
      }
      ...
      $str_hide_fld_fecha_op = (in_array($fld_fecha_op_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_caseta = (in_array($caseta_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($fld_fecha_op) || $fld_fecha_op == "")
      {
          $fld_fecha_op = "";
      }
      if (isset($fld_fecha_op) && !empty($fld_fecha_op))
      {
         $tmp_pos = (is_string($fld_fecha_op)) ? strpos($fld_fecha_op, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $fld_fecha_op = substr($fld_fecha_op, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fld_fecha_op_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fld_fecha_op'])) ? $this->New_label['fld_fecha_op'] : "Fecha de operacion"; ?></TD>
      
      <INPUT type="hidden" id="SC_fld_fecha_op_cond" name="fld_fecha_op_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fld_fecha_op" <?php echo $str_hide_fld_fecha_op?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fld_fecha_op'])) ? $this->New_label['fld_fecha_op'] : "Fecha de operacion";
 $nmgp_tab_label .= "fld_fecha_op?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
  ...
  {
?>
<span id='id_date_part_fld_fecha_op_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fld_fecha_op_dia" name="fld_fecha_op_dia" value="<?php echo NM_encode_input($fld_fecha_op_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fld_fecha_op_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fld_fecha_op_mes" name="fld_fecha_op_mes" value="<?php echo NM_encode_input($fld_fecha_op_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fld_fecha_op_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fld_fecha_op_ano" name="fld_fecha_op_ano" value="<?php echo NM_encode_input($fld_fecha_op_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fld_fecha_op_jq">
</span>
...
?>
      ...
      <TD id='SC_caseta_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['caseta'])) ? $this->New_label['caseta'] : "" . $this->Ini->Nm_lang['lang_dat_tag_fld_fld_caseta'] . ""; ?></TD>
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['psq_check_ret']['caseta'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['psq_check_ret']['caseta'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_caseta">
      <SELECT class="scFilterObjectEven" id="SC_caseta" name="caseta"  size="1">
       <OPTION value=""></OPTION>
<?php
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fld_fecha_op_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fld_fecha_op'), document.F1.fld_fecha_op_cond, 'fld_fecha_op');
   document.F1.fld_fecha_op_dia.value = "";
   document.F1.fld_fecha_op_mes.value = "";
   document.F1.fld_fecha_op_ano.value = "";
 ...
 {
    $('#SC_fld_fecha_op_dia').bind('change', function() {sc_otme1y2r1_valida_dia(this)});
    $('#SC_fld_fecha_op_mes').bind('change', function() {sc_otme1y2r1_valida_mes(this)});
 }
 function sc_otme1y2r1_valida_dia(obj)
 {
 ...
 function sc_otme1y2r1_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "BackOffice_Acapulco/otme1y2r1";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fld_fecha_op_cond'] = 'cond';
      $tp_fields['SC_fld_fecha_op_dia'] = 'text';
      $tp_fields['SC_fld_fecha_op_mes'] = 'text';
      $tp_fields['SC_fld_fecha_op_ano'] = 'text';
      $tp_fields['SC_fld_fecha_op_input_2_dia'] = 'text';
      $tp_fields['SC_fld_fecha_op_input_2_mes'] = 'text';
      $tp_fields['SC_fld_fecha_op_input_2_ano'] = 'text';
   ...
   {
      global $fld_fecha_op_cond, $fld_fecha_op, $fld_fecha_op_dia, $fld_fecha_op_mes, $fld_fecha_op_ano,
             $caseta_cond, $caseta, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $fld_fecha_op_cond_salva = $fld_fecha_op_cond; 
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['psq_check_ret']['caseta'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_dat_tag_fld_fld_caseta'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_dia'] = $fld_fecha_op_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_mes'] = $fld_fecha_op_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_ano'] = $fld_fecha_op_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_cond'] = $fld_fecha_op_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['caseta'] = $caseta; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['caseta_cond'] = $caseta_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($fld_fecha_op_cond != "bi_TP")
      {
          $fld_fecha_op_cond = strtoupper($fld_fecha_op_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fld_fecha_op_ano;
          $Dtxt .= $fld_fecha_op_mes;
          $Dtxt .= $fld_fecha_op_dia;
          $val[0]['ano'] = $fld_fecha_op_ano;
          $val[0]['mes'] = $fld_fecha_op_mes;
          $val[0]['dia'] = $fld_fecha_op_dia;
          if ($fld_fecha_op_cond == "BW")
          {
              $val[1]['ano'] = $fld_fecha_op_input_2_ano;
              $val[1]['mes'] = $fld_fecha_op_input_2_mes;
              $val[1]['dia'] = $fld_fecha_op_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fld_fecha_op_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fld_fecha_op_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fld_fecha_op = $val[0];
          $this->cmp_formatado['fld_fecha_op'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fld_fecha_op'], "YYYY-MM-DD");
          $this->cmp_formatado['fld_fecha_op'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fld_fecha_op_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fld_fecha_op_input_2     = $val[1];
              $this->cmp_formatado['fld_fecha_op_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']['fld_fecha_op_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fld_fecha_op_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fld_fecha_op_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fld_fecha_op_cond == "NU" || $fld_fecha_op_cond == "NN"|| $fld_fecha_op_cond == "EP"|| $fld_fecha_op_cond == "NE")
          {
              $this->monta_condicao("fld_fecha_op", $fld_fecha_op_cond, $fld_fecha_op, $fld_fecha_op_input_2, 'fld_fecha_op', 'DATE');
          }
      }
      ...
      if (isset($caseta))
      {
         $this->monta_condicao("fld_caseta", $caseta_cond, $caseta, "", "caseta", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['otme1y2r1']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "caseta" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
