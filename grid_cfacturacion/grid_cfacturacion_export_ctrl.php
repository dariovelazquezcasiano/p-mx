<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cfacturacion']['sc_process_barr'] = true;
require_once('../grid_cfacturacion/index.php');
unset($_SESSION['scriptcase']['grid_cfacturacion']['sc_process_barr']);
$ExportCtrl = new grid_cfacturacion_export_control;
$ExportCtrl->Export_barr();

class grid_cfacturacion_export_control
{
