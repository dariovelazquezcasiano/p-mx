...
class grid_cfacturacion_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_cfacturacion/grid_cfacturacion_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_cfacturacion_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_cfacturacion.zip";
          $this->Arquivo   .= "_grid_cfacturacion" . $this->Xls_tp;
          $this->Tit_doc    = "grid_cfacturacion" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_cfacturacion']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_casetaid0()
   {
         ...
         $this->casetaid0 = html_entity_decode($this->casetaid0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->casetaid0 = strip_tags($this->casetaid0);
         $this->casetaid0 = NM_charset_to_utf8($this->casetaid0);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->casetaid0, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->casetaid0, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- casetaid
   ...
   function NM_export_cascar()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->cascar = html_entity_decode($this->cascar, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cascar = strip_tags($this->cascar);
         $this->cascar = NM_charset_to_utf8($this->cascar);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cascar, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cascar, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- turnoid
   function NM_export_turnoid()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->turnoid = html_entity_decode($this->turnoid, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->turnoid = strip_tags($this->turnoid);
         $this->turnoid = NM_charset_to_utf8($this->turnoid);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->turnoid, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->turnoid, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tramoid
   ...
   function NM_export_folio()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->folio = html_entity_decode($this->folio, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->folio = strip_tags($this->folio);
         $this->folio = NM_charset_to_utf8($this->folio);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->folio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->folio, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vehiculoid_cr0
   function NM_export_vehiculoid_cr0()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->vehiculoid_cr0 = html_entity_decode($this->vehiculoid_cr0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->vehiculoid_cr0 = strip_tags($this->vehiculoid_cr0);
         $this->vehiculoid_cr0 = NM_charset_to_utf8($this->vehiculoid_cr0);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vehiculoid_cr0, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vehiculoid_cr0, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- clasecr
   function NM_export_clasecr()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->clasecr = html_entity_decode($this->clasecr, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->clasecr = strip_tags($this->clasecr);
         $this->clasecr = NM_charset_to_utf8($this->clasecr);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->clasecr, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->clasecr, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pagoid
   ...
   function NM_export_usuarioid0()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->usuarioid0 = html_entity_decode($this->usuarioid0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->usuarioid0 = strip_tags($this->usuarioid0);
         $this->usuarioid0 = NM_charset_to_utf8($this->usuarioid0);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuarioid0, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuarioid0, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nom_empleado
   function NM_export_nom_empleado()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->nom_empleado = html_entity_decode($this->nom_empleado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nom_empleado = strip_tags($this->nom_empleado);
         $this->nom_empleado = NM_charset_to_utf8($this->nom_empleado);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_empleado, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_empleado, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- numerotarjeta
   ...
   function NM_export_importecr0()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->importecr0 = html_entity_decode($this->importecr0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->importecr0 = strip_tags($this->importecr0);
         $this->importecr0 = NM_charset_to_utf8($this->importecr0);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->importecr0, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->importecr0, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- importecr_tag
   function NM_export_importecr_tag()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->importecr_tag = html_entity_decode($this->importecr_tag, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->importecr_tag = strip_tags($this->importecr_tag);
         $this->importecr_tag = NM_charset_to_utf8($this->importecr_tag);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->importecr_tag, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->importecr_tag, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- claseana
   function NM_export_claseana()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->claseana = html_entity_decode($this->claseana, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->claseana = strip_tags($this->claseana);
         $this->claseana = NM_charset_to_utf8($this->claseana);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->claseana, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->claseana, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vehiculoid_cr
   ...
   function NM_export_importeana0()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->importeana0 = html_entity_decode($this->importeana0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->importeana0 = strip_tags($this->importeana0);
         $this->importeana0 = NM_charset_to_utf8($this->importeana0);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->importeana0, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->importeana0, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- usuarioid
   ...
   //----- casetaid0
   function NM_sub_cons_casetaid0()
   {
         $this->casetaid0 = html_entity_decode($this->casetaid0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->casetaid0 = strip_tags($this->casetaid0);
         $this->casetaid0 = NM_charset_to_utf8($this->casetaid0);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->casetaid0;
   ...
   //----- cascar
   function NM_sub_cons_cascar()
   {
         $this->cascar = html_entity_decode($this->cascar, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cascar = strip_tags($this->cascar);
         $this->cascar = NM_charset_to_utf8($this->cascar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cascar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- vehiculoid_cr0
   function NM_sub_cons_vehiculoid_cr0()
   {
         $this->vehiculoid_cr0 = html_entity_decode($this->vehiculoid_cr0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->vehiculoid_cr0 = strip_tags($this->vehiculoid_cr0);
         $this->vehiculoid_cr0 = NM_charset_to_utf8($this->vehiculoid_cr0);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vehiculoid_cr0;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- clasecr
   function NM_sub_cons_clasecr()
   {
         $this->clasecr = html_entity_decode($this->clasecr, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->clasecr = strip_tags($this->clasecr);
         $this->clasecr = NM_charset_to_utf8($this->clasecr);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->clasecr;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- usuarioid0
   function NM_sub_cons_usuarioid0()
   {
         $this->usuarioid0 = html_entity_decode($this->usuarioid0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->usuarioid0 = strip_tags($this->usuarioid0);
         $this->usuarioid0 = NM_charset_to_utf8($this->usuarioid0);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuarioid0;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nom_empleado
   function NM_sub_cons_nom_empleado()
   {
         $this->nom_empleado = html_entity_decode($this->nom_empleado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nom_empleado = strip_tags($this->nom_empleado);
         $this->nom_empleado = NM_charset_to_utf8($this->nom_empleado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nom_empleado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- importecr0
   function NM_sub_cons_importecr0()
   {
         $this->importecr0 = html_entity_decode($this->importecr0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->importecr0 = strip_tags($this->importecr0);
         $this->importecr0 = NM_charset_to_utf8($this->importecr0);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->importecr0;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- importecr_tag
   function NM_sub_cons_importecr_tag()
   {
         $this->importecr_tag = html_entity_decode($this->importecr_tag, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->importecr_tag = strip_tags($this->importecr_tag);
         $this->importecr_tag = NM_charset_to_utf8($this->importecr_tag);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->importecr_tag;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- claseana
   function NM_sub_cons_claseana()
   {
         $this->claseana = html_entity_decode($this->claseana, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->claseana = strip_tags($this->claseana);
         $this->claseana = NM_charset_to_utf8($this->claseana);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->claseana;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- importeana0
   function NM_sub_cons_importeana0()
   {
         $this->importeana0 = html_entity_decode($this->importeana0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->importeana0 = strip_tags($this->importeana0);
         $this->importeana0 = NM_charset_to_utf8($this->importeana0);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->importeana0;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cfacturacion']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
