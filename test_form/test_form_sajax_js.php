...
?>
  ...
  function do_ajax_test_form_validate_consecutivo()
  {
    var nomeCampo_consecutivo = "consecutivo";
    var var_consecutivo = scAjaxGetFieldText(nomeCampo_consecutivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_consecutivo(var_consecutivo, var_script_case_init, do_ajax_test_form_validate_consecutivo_cb);
  } // do_ajax_test_form_validate_consecutivo

  function do_ajax_test_form_validate_consecutivo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_consecutivo_cb

  // ---------- Validate secuencial
  function do_ajax_test_form_validate_secuencial()
  {
    var nomeCampo_secuencial = "secuencial";
    var var_secuencial = scAjaxGetFieldText(nomeCampo_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_secuencial(var_secuencial, var_script_case_init, do_ajax_test_form_validate_secuencial_cb);
  } // do_ajax_test_form_validate_secuencial

  function do_ajax_test_form_validate_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_secuencial_cb

  // ---------- Validate vehiculocorrecto
  function do_ajax_test_form_validate_vehiculocorrecto()
  {
    var nomeCampo_vehiculocorrecto = "vehiculocorrecto";
    var var_vehiculocorrecto = scAjaxGetFieldRadio(nomeCampo_vehiculocorrecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_vehiculocorrecto(var_vehiculocorrecto, var_script_case_init, do_ajax_test_form_validate_vehiculocorrecto_cb);
  } // do_ajax_test_form_validate_vehiculocorrecto

  function do_ajax_test_form_validate_vehiculocorrecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_vehiculocorrecto_cb

  // ---------- Validate pagoid_ana
  function do_ajax_test_form_validate_pagoid_ana()
  {
    var nomeCampo_pagoid_ana = "pagoid_ana";
    var var_pagoid_ana = scAjaxGetFieldSelect(nomeCampo_pagoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_pagoid_ana(var_pagoid_ana, var_script_case_init, do_ajax_test_form_validate_pagoid_ana_cb);
  } // do_ajax_test_form_validate_pagoid_ana

  function do_ajax_test_form_validate_pagoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_pagoid_ana_cb

  // ---------- Validate vehiculoid_ana
  function do_ajax_test_form_validate_vehiculoid_ana()
  {
    var nomeCampo_vehiculoid_ana = "vehiculoid_ana";
    var var_vehiculoid_ana = scAjaxGetFieldSelect(nomeCampo_vehiculoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_vehiculoid_ana(var_vehiculoid_ana, var_script_case_init, do_ajax_test_form_validate_vehiculoid_ana_cb);
  } // do_ajax_test_form_validate_vehiculoid_ana

  function do_ajax_test_form_validate_vehiculoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_vehiculoid_ana_cb

  // ---------- Validate importe_ana
  function do_ajax_test_form_validate_importe_ana()
  {
    var nomeCampo_importe_ana = "importe_ana";
    var var_importe_ana = scAjaxGetFieldText(nomeCampo_importe_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_importe_ana(var_importe_ana, var_script_case_init, do_ajax_test_form_validate_importe_ana_cb);
  } // do_ajax_test_form_validate_importe_ana

  function do_ajax_test_form_validate_importe_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_importe_ana_cb

  // ---------- Validate cantidadeje_ana
  function do_ajax_test_form_validate_cantidadeje_ana()
  {
    var nomeCampo_cantidadeje_ana = "cantidadeje_ana";
    var var_cantidadeje_ana = scAjaxGetFieldText(nomeCampo_cantidadeje_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_cantidadeje_ana(var_cantidadeje_ana, var_script_case_init, do_ajax_test_form_validate_cantidadeje_ana_cb);
  } // do_ajax_test_form_validate_cantidadeje_ana

  function do_ajax_test_form_validate_cantidadeje_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_cantidadeje_ana_cb

  // ---------- Validate tarifaee_ana
  function do_ajax_test_form_validate_tarifaee_ana()
  {
    var nomeCampo_tarifaee_ana = "tarifaee_ana";
    var var_tarifaee_ana = scAjaxGetFieldText(nomeCampo_tarifaee_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_tarifaee_ana(var_tarifaee_ana, var_script_case_init, do_ajax_test_form_validate_tarifaee_ana_cb);
  } // do_ajax_test_form_validate_tarifaee_ana

  function do_ajax_test_form_validate_tarifaee_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_tarifaee_ana_cb

  // ---------- Validate fld_importe_eeana
  function do_ajax_test_form_validate_fld_importe_eeana()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_test_form_validate_fld_importe_eeana(var_fld_importe_eeana, var_script_case_init, do_ajax_test_form_validate_fld_importe_eeana_cb);
  } // do_ajax_test_form_validate_fld_importe_eeana

  function do_ajax_test_form_validate_fld_importe_eeana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_test_form_validate_fld_importe_eeana_cb

  // ---------- Event onchange pagoid_ana
  function do_ajax_test_form_event_pagoid_ana_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_test_form_event_pagoid_ana_onchange(var_pagoid_ana, var_vehiculoid_ana, var_cantidadeje_ana, var_importe_ana, var_fld_importe_eeana, var_tarifaee_ana, var_script_case_init, do_ajax_test_form_event_pagoid_ana_onchange_cb);
  } // do_ajax_test_form_event_pagoid_ana_onchange

  function do_ajax_test_form_event_pagoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pagoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_test_form_event_pagoid_ana_onchange_cb_after_alert);
  } // do_ajax_test_form_event_pagoid_ana_onchange_cb
  function do_ajax_test_form_event_pagoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_test_form_event_pagoid_ana_onchange_cb_after_alert

  // ---------- Event onclick vehiculocorrecto
  function do_ajax_test_form_event_vehiculocorrecto_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_test_form_event_vehiculocorrecto_onclick(var_vehiculocorrecto, var_vehiculoid_ana, var_pagoid_ana, var_cantidadeje_ana, var_importe_ana, var_fld_importe_eeana, var_tarifaee_ana, var_script_case_init, do_ajax_test_form_event_vehiculocorrecto_onclick_cb);
  } // do_ajax_test_form_event_vehiculocorrecto_onclick

  function do_ajax_test_form_event_vehiculocorrecto_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculocorrecto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_test_form_event_vehiculocorrecto_onclick_cb_after_alert);
  } // do_ajax_test_form_event_vehiculocorrecto_onclick_cb
  function do_ajax_test_form_event_vehiculocorrecto_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_test_form_event_vehiculocorrecto_onclick_cb_after_alert

  // ---------- Event onchange vehiculoid_ana
  function do_ajax_test_form_event_vehiculoid_ana_onchange()
  {
    var var_pagoid_ana = scAjaxGetFieldSelect("pagoid_ana");
    var var_vehiculoid_ana = scAjaxGetFieldSelect("vehiculoid_ana");
    var var_cantidadeje_ana = scAjaxGetFieldText("cantidadeje_ana");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_test_form_event_vehiculoid_ana_onchange(var_pagoid_ana, var_vehiculoid_ana, var_cantidadeje_ana, var_importe_ana, var_fld_importe_eeana, var_tarifaee_ana, var_script_case_init, do_ajax_test_form_event_vehiculoid_ana_onchange_cb);
  } // do_ajax_test_form_event_vehiculoid_ana_onchange

  function do_ajax_test_form_event_vehiculoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_test_form_event_vehiculoid_ana_onchange_cb_after_alert);
  } // do_ajax_test_form_event_vehiculoid_ana_onchange_cb
  function do_ajax_test_form_event_vehiculoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_test_form_event_vehiculoid_ana_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_test_form_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_test_form_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_test_form_submit_form(var_consecutivo, var_secuencial, var_vehiculocorrecto, var_pagoid_ana, var_vehiculoid_ana, var_importe_ana, var_cantidadeje_ana, var_tarifaee_ana, var_fld_importe_eeana, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_test_form_submit_form_cb);
  } // do_ajax_test_form_submit_form

  function do_ajax_test_form_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_test_form_submit_form_cb_after_alert);
  } // do_ajax_test_form_submit_form_cb
  function do_ajax_test_form_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_test_form_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_test_form_navigate_form()
  {
    perform_ajax_test_form_navigate_form();
  }

  function perform_ajax_test_form_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_test_form_navigate_form(var_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_test_form_navigate_form_cb);
  } // do_ajax_test_form_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['test_form']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_test_form_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_test_form_navigate_form_cb_after_alert);
  } // do_ajax_test_form_navigate_form_cb
  function do_ajax_test_form_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_test_form_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_test_form_navigate_form_cb_after_alert

  function sc_hide_test_form_form()
  {
