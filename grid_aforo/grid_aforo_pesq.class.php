...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_aforo/peaje_grid_aforo.css?v=20260911-ui" />
</HEAD>
<?php
$vertical_center = '';
?>
...
?>
<?php echo $SC_Label ?><br>
      <SELECT class="scFilterObjectOdd" id="SC_horaevento_cond" name="horaevento_cond" onChange="nm_campos_between(document.getElementById('id_vis_horaevento'), this, 'horaevento')">
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_pagoid_ana"  <?php echo $str_hide_pagoid_ana?>>
<?php
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_vehiculoid_ana"  <?php echo $str_hide_vehiculoid_ana?>>
<?php
...
?>
   <span id="idAjaxSelect_vehiculoid_ana">
      <SELECT class="scFilterObjectOdd" id="SC_vehiculoid_ana" name="vehiculoid_ana"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_operadortlp"  <?php echo $str_hide_operadortlp?>><?php
      if ($operadortlp != "")
      {
      $operadortlp_look = (is_string($operadortlp) ? substr($this->Db->qstr($operadortlp), 1, -1) : $operadortlp); 
      $nmgp_def_dados = array(); 
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_excentoid"  <?php echo $str_hide_excentoid?>>
<?php
      $excentoid_look = (is_string($excentoid) ? substr($this->Db->qstr($excentoid), 1, -1) : $excentoid); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT ExcentoID, Dependencia  FROM excentos  WHERE CasetaID = " . peaje_sql_int($casetaid, '0') . " ORDER BY Dependencia";
...
?>
   <span id="idAjaxSelect_excentoid">
      <SELECT class="scFilterObjectEven" id="SC_excentoid" name="excentoid"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_fld_ar_sct"  <?php echo $str_hide_fld_ar_sct?>> 
<?php
...
$_SESSION['scriptcase']['grid_aforo']['contr_erro'] = 'off'; 
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "vehiculoid_ana" : return ('class="scFilterObjectOdd"'); break;
         case "usuarioid" : return ('class="scFilterObjectEven"'); break;
         case "excentoid" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
