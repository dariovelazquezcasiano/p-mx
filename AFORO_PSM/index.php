<?php
   include_once('AFORO_PSM_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_samesite', 'Lax');
   @ini_set('session.cookie_secure', (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 1 : 0);
   @session_start() ;
   $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "AFORO_PSM"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['AFORO_PSM']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['AFORO_PSM']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['AFORO_PSM']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/AFORO_PSM';
      ...
      $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['AFORO_PSM']['actual_lang']) || $_SESSION['scriptcase']['AFORO_PSM']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['AFORO_PSM']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("AFORO_PSM_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["AFORO_PSM"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["AFORO_PSM"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "AFORO_PSM_erro.class.php"); 
      $this->Erro = new AFORO_PSM_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('AFORO_PSM'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['AFORO_PSM']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao']) && $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_perfil']) && $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['AFORO_PSM']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['AFORO_PSM']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['AFORO_PSM']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['AFORO_PSM']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new AFORO_PSM_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AFORO_PSM']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['AFORO_PSM']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['AFORO_PSM']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['AFORO_PSM'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AFORO_PSM']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AFORO_PSM']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('AFORO_PSM') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AFORO_PSM']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AFORO_PSM']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['AFORO_PSM']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['AFORO_PSM']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "AFORO_PSM_erro.class.php"); 
      $this->Erro      = new AFORO_PSM_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['AFORO_PSM']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_caseta)) {$this->sc_temp_caseta = (isset($_SESSION['caseta'])) ? $_SESSION['caseta'] : "";}
 if(!empty($this->sc_temp_caseta) && !empty($this->sc_temp_year) && !empty($this->sc_temp_mes)){
	...
	$meces1 = array('01' => "ENE", '02' => "FEB", '03' => "MAR", '04' => "ABR", '05' => "MAY", '06' => "JUN", 
				   '07' => "JUL", '08' => "AGO", '09' => "SET", '10' => "OCT", '11' => "NOV", '12' => "DIC");
	$meces = array('01' => "ENERO", '02' => "FEBRERO", '03' => "MARZO", '04' => "ABRIL", '05' => "MAYO", '06' => "JUNIO", 
				   '07' => "JULIO", '08' => "AGOSTO", '09' => "SEPTIEMBRE", '10' => "OCTUBRE", '11' => "NOVIEMBRE", '12' => "DICIEMBRE");
	$year1 = substr($this->sc_temp_year, -2);
	
	$columnas = ['C', 'D', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Z', 'AA'];
	$columnas2 = ['AF', 'AG'];
	$filas = [
				'1' => ['1' => 5, '2' => 6, '3' => 7],
				'2' => ['1' => 10, '2' => 11, '3' => 12],
		...
		if (file_exists("../PHPExcel-1.8/Classes/PHPExcel/IOFactory.php")){
			...
			if (file_exists("../FormatosCuliacan/AFORO_PSM.xlsx") ) {
      ...
      { 
          ...
          $this->kz_erro = $this->Db->ErrorMsg();
				...
				$sql = "SELECT
						...
						CarrilID,
						TurnoID,
                        SUM(IF(ClaseVehiculo_ANA = 'M' && PagoID_ANA = 'NOR', 1, 0)) AS M,
						SUM(IF(ClaseVehiculo_ANA LIKE 'A%' && PagoID_ANA = 'NOR', 1, 0)) AS A,
						SUM(IF(ClaseVehiculo_ANA = 'B2' && PagoID_ANA = 'NOR', 1, 0)) AS B2,
						SUM(IF(ClaseVehiculo_ANA = 'B3' && PagoID_ANA = 'NOR', 1, 0)) AS B3,
						SUM(IF(ClaseVehiculo_ANA = 'B4' && PagoID_ANA = 'NOR', 1, 0)) AS B4,
						SUM(IF(ClaseVehiculo_ANA = 'C2' && PagoID_ANA = 'NOR', 1, 0)) AS C2,
						SUM(IF(ClaseVehiculo_ANA = 'C3' && PagoID_ANA = 'NOR', 1, 0)) AS C3,
						SUM(IF(ClaseVehiculo_ANA = 'C4' && PagoID_ANA = 'NOR', 1, 0)) AS C4,
						SUM(IF(ClaseVehiculo_ANA = 'C5' && PagoID_ANA = 'NOR', 1, 0)) AS C5,
						SUM(IF(ClaseVehiculo_ANA = 'C6' && PagoID_ANA = 'NOR', 1, 0)) AS C6,
						SUM(IF(ClaseVehiculo_ANA = 'C7' && PagoID_ANA = 'NOR', 1, 0)) AS C7,
						SUM(IF(ClaseVehiculo_ANA = 'C8' && PagoID_ANA = 'NOR', 1, 0)) AS C8,
						SUM(IF((ClaseVehiculo_ANA = 'C9' || ClaseVehiculo_ANA LIKE 'C__') && PagoID_ANA = 'NOR', 1, 0)) AS C9,
                        
                        SUM(IF(PagoID_ANA = 'CRE' && (ClaseVehiculo_ANA LIKE 'M%' || ClaseVehiculo_ANA LIKE 'A%'), 1, 0)) AS RSP1,
                        SUM(IF(PagoID_ANA = 'CRE' && (ClaseVehiculo_ANA = 'C2' || ClaseVehiculo_ANA = 'B2'), 1, 0)) AS RSP2,
                        SUM(IF(PagoID_ANA = 'CRE' && (ClaseVehiculo_ANA = 'C3' || ClaseVehiculo_ANA = 'B3'), 1, 0)) AS RSP3,
                        SUM(IF(PagoID_ANA = 'CRE' && (ClaseVehiculo_ANA = 'C5' || ClaseVehiculo_ANA = 'C6'), 1, 0)) AS RSP6,
                       
						SUM(IF((ClaseVehiculo_ANA LIKE 'A_%' && PagoID_ANA = 'NOR') || (ClaseVehiculo_ANA = 'M_' && PagoID_ANA = 'NOR'), CantidadEje_ANA, 0)) AS EEA,
						SUM(IF(ClaseVehiculo_ANA LIKE 'C__' && PagoID_ANA = 'NOR', CantidadEje_ANA, 0)) AS EEC,
                        
                        SUM(IF(PagoID_ANA = 'VSC', 1, 0)) AS EXE,
						...
						AND UsuarioID != 51
						AND PagoID_ANA IN('NOR', 'CRE','VSC', 'ELU')
						AND Cancelado = 0

						GROUP BY dia, CarrilID, TurnoID
						ORDER BY dia, CarrilID, TurnoID ASC";
					
				$sql2 = "SELECT 
							DATE_FORMAT(FechaOperacion, '%d') AS dia,
                            CarrilID,
                            TurnoID,
							SUM(IF(FaltanteANA < 0, ABS(FaltanteANA), 0)) AS sobranteliq,
                            SUM(IF(FaltanteANA > 0, ABS(Faltante), 0)) AS faltantepre
							

							FROM detalleturno
							WHERE CasetaID = $this->sc_temp_caseta AND FechaOperacion like '$this->sc_temp_year-$this->sc_temp_mes%' 
							GROUP BY dia, CarrilID, TurnoID ORDER BY dia, CarrilID, TurnoID ASC";
      ...
      { 
          ...
          $this->h1_erro = $this->Db->ErrorMsg();
				...
				$objPHPExcel = PHPExcel_IOFactory::load("../FormatosCuliacan/AFORO_PSM.xlsx");
				
				$objPHPExcel->setActiveSheetIndex(0);
				$dia = 1;
				$objPHPExcel->getActiveSheet()->setCellValue('AC3', '0'.$dia.'-'.$meces1["$this->sc_temp_mes"].'-'.$year1);
				...
				if(!empty($this->h1 )){
					foreach($this->h1  as $registro){
						foreach($registro as $index => $valor){
							if($dia != $registro[0]){
								$dia = $registro[0];
								$objPHPExcel->setActiveSheetIndex($dia - 1);
								$dia1 = $dia;
								if($dia < 10){
									$dia1 = '0'.$dia;
								}
								$objPHPExcel->getActiveSheet()->setCellValue('AC3', $dia.'-'.$meces1["$this->sc_temp_mes"].'-'.$year1);
							}
							
							if($index > 2){
								$objPHPExcel->getActiveSheet()->setCellValue($columnas[$index - 3].$filas[$registro[1]][$registro[2]], $valor);
							}
						}
						$fila++;
					}
          ...
          $this->h2_erro = $this->Db->ErrorMsg();
					...
					foreach($this->h2  as $registro){
						foreach($registro as $index => $valor){
							...
							if($index > 2){
								$objPHPExcel->getActiveSheet()->setCellValue($columnas2[$index - 3].$filas[$registro[1]][$registro[2]], $valor);
							}
						}
						$fila++;
					}
					...
					header("Content-Disposition: attachment;filename=AFORO $caseta(".$meces["$this->sc_temp_mes"]."-$this->sc_temp_year).xlsx");
					...
					echo '<center><h2>Error: Caseta no encontrada.</h2></center>';			
				}
			}else{
				echo '<center><h2>Error: Formato base no encontrado.</h2></center>';
			}
		}else{
			echo '<center><h2>Error: Libreria no encontrada.</h2></center>';
		}
}else{
...
$_SESSION['scriptcase']['AFORO_PSM']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_AFORO_PSM($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['AFORO_PSM']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "AFORO_PSM") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['AFORO_PSM']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   if (isset($_POST["caseta"])) 
   {
       ...
       nm_limpa_str_AFORO_PSM($_SESSION["caseta"]);
   }
   ...
   if (isset($_POST["year"])) 
   {
       ...
       nm_limpa_str_AFORO_PSM($_SESSION["year"]);
   }
   if (isset($_GET["year"])) 
   {
   ...
   if (isset($_POST["mes"])) 
   {
       ...
       nm_limpa_str_AFORO_PSM($_SESSION["mes"]);
   }
   if (isset($_GET["mes"])) 
   {
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "AFORO_PSM";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'AFORO_PSM' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('AFORO_PSM' == $sReferer || 'AFORO_PSM_' == substr($sReferer, 0, 10))
       {
           $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'AFORO_PSM')
   {
       $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['AFORO_PSM']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/AFORO_PSM_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_AFORO_PSM($cadapar[1]);
   ...
   $contr_AFORO_PSM = new AFORO_PSM_apl();
   $contr_AFORO_PSM->controle();
//
   function nm_limpa_str_AFORO_PSM(&$str)
   {
   }
?>
