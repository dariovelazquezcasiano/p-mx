<?php
   include_once('vhmd_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_samesite', 'Lax');
   @ini_set('session.cookie_secure', (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 1 : 0);
   @session_start() ;
   $_SESSION['scriptcase']['vhmd']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['vhmd']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['vhmd']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['vhmd']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['vhmd']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['vhmd']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['vhmd']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['vhmd']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['vhmd']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['vhmd']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['vhmd']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['vhmd']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['vhmd']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['vhmd']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['vhmd']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "vhmd"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['vhmd']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['vhmd']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['vhmd']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['vhmd']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['vhmd']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['vhmd']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['vhmd']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['vhmd']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/vhmd';
      ...
      $_SESSION['sc_session'][$this->sc_page]['vhmd']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['vhmd']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['vhmd']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['vhmd']['actual_lang']) || $_SESSION['scriptcase']['vhmd']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['vhmd']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("vhmd_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['vhmd']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["vhmd"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["vhmd"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['vhmd']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['vhmd']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['vhmd']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['vhmd']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['vhmd']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['vhmd']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['vhmd']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['vhmd']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['vhmd']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "vhmd_erro.class.php"); 
      $this->Erro = new vhmd_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('vhmd'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['vhmd']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['vhmd']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['vhmd']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['vhmd']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['vhmd']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['vhmd']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['vhmd']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['vhmd']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['vhmd']['glo_nm_conexao']) && $_SESSION['scriptcase']['vhmd']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['vhmd']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['vhmd']['glo_nm_perfil']) && $_SESSION['scriptcase']['vhmd']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['vhmd']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['vhmd']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['vhmd']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['vhmd']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['vhmd']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['vhmd']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['vhmd']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['vhmd']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['vhmd']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['vhmd']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['vhmd']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['vhmd']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['vhmd']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['vhmd']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['vhmd']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['vhmd']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['vhmd']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new vhmd_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['vhmd']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['vhmd']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['vhmd']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['vhmd'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['vhmd']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['vhmd']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('vhmd') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['vhmd']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['vhmd']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['vhmd']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['vhmd']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "vhmd_erro.class.php"); 
      $this->Erro      = new vhmd_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['vhmd']['contr_erro'] = 'on';
...
$filas = array('0' => '13','1' => '14','2' => '15','3' => '16','4' => '17','5' => '18','6' => '19','7' => '20','8' => '21','9' => '22','10' => '23','11' => '24','12' => '25','13' => '26','14' => '27','15' => '28','16' => '29','17' => '30','18' => '31','19' => '32','20' => '33','21' => '34','22' => '35','23' => '36');
$encabezados = ['E1', 'E2', 'E3', 'E4', 'E5', 'B9', 'C9', 'D9'];
$columnas = ['B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R'];
if(!empty($this->sc_temp_caseta) && !empty($this->sc_temp_year) && !empty($this->sc_temp_mesini)){
	...
	if (file_exists("../PHPExcel-1.8/Classes/PHPExcel/IOFactory.php")) {
		...
		if (file_exists("../FormatosSct/VHMD.xlsx")) {
			
			$objPHPExcel = PHPExcel_IOFactory::load("../FormatosSct/VHMD.xlsx");
      ...
      { 
          ...
          $this->at_erro = $this->Db->ErrorMsg();
			...
			$sql_direccionA = "SELECT Direccion FROM `sentido` WHERE Cuerpo = 'A'";
			$sql_direccionB = "SELECT Direccion FROM `sentido` WHERE Cuerpo = 'B'";
			
			 
      $nm_select = $sql_direccionA; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->da = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      ...
      { 
          ...
          $this->db_erro = $this->Db->ErrorMsg();
				...
				$extra = " && (PagoID_ANA not in ('VSC','ELU','TAG')) ";
				$sql = "SELECT 
				SUM(IF((ClaseVehiculo_ANA = 'M' || ClaseVehiculo_ANA = 'M1') $extra, 1, 0)) AS M, 
				SUM(IF((ClaseVehiculo_ANA LIKE 'A') $extra , 1, 0)) AS A, 
				SUM(IF((ClaseVehiculo_ANA LIKE 'A1') $extra , 1, 0)) AS A1, 
				SUM(IF((ClaseVehiculo_ANA != 'A1' && ClaseVehiculo_ANA LIKE 'A_%') $extra , 1, 0)) AS A2, 
				SUM(IF((ClaseVehiculo_ANA = 'B2') $extra , 1, 0)) AS B2, 
				SUM(IF((ClaseVehiculo_ANA = 'B3') $extra , 1, 0)) AS B3, 
				SUM(IF((ClaseVehiculo_ANA = 'B4') $extra , 1, 0)) AS B4, 
				SUM(IF((ClaseVehiculo_ANA = 'C2') $extra , 1, 0)) AS C2, 
				SUM(IF((ClaseVehiculo_ANA = 'C3') $extra , 1, 0)) AS C3, 
				SUM(IF((ClaseVehiculo_ANA = 'C4') $extra , 1, 0)) AS C4, 
				SUM(IF((ClaseVehiculo_ANA = 'C5') $extra , 1, 0)) AS C5, 
				SUM(IF((ClaseVehiculo_ANA = 'C6') $extra , 1, 0)) AS C6, 
				SUM(IF((ClaseVehiculo_ANA = 'C7') $extra , 1, 0)) AS C7, 
				SUM(IF((ClaseVehiculo_ANA = 'C8') $extra , 1, 0)) AS C8, 
				SUM(IF((ClaseVehiculo_ANA = 'C9' || ClaseVehiculo_ANA LIKE 'C__') $extra , 1, 0)) AS C9, 
				SUM(IF((PagoID_ANA IN ('VSC','ELU','TAG')), 1, 0)) AS vsc, HOUR(HoraEvento) AS 'hora' 
				FROM `aforo` 
				WHERE CasetaID = $this->sc_temp_caseta AND FechaOperacion = ";

			
			
			$fecha_nombre = $meces[$this->sc_temp_mesini];
			
			$sql_dias = "SELECT DISTINCT CONCAT(DAY(FechaOperacion), '-', Cuerpo), DAY(FechaOperacion) AS dia, Cuerpo FROM `aforo` WHERE CasetaID = $this->sc_temp_caseta AND MONTH(FechaOperacion) = '$this->sc_temp_mesini' AND PagoID != 'GE' AND PagoID != 'DE' AND PagoID != 'RVS' AND Cancelado = 0 ORDER BY dia ASC";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->di[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
          ...
          $this->di_erro = $this->Db->ErrorMsg();
			...
			if(!empty($this->di )){
				...
				$objPHPExcel->getActiveSheet()->setCellValue($encabezados[0], $this->at[0][0])
											  ...
											  ->setCellValue($encabezados[5], $this->sc_temp_mesini)
											  ->setCellValue($encabezados[7], $this->sc_temp_year);

				$hoja = $objPHPExcel->getActiveSheet()->copy();

				$numHojas = 0;
				foreach($this->di  as $dia){
					$sql2 = "'$this->sc_temp_year-$this->sc_temp_mesini-".$dia[1]."' AND Cuerpo = '".$dia[2]."' AND PagoID != 'GE' AND PagoID != 'DE' AND PagoID != 'RVS' AND Cancelado = 0 GROUP BY hora ORDER BY hora ASC";
					$consulta = $sql.$sql2;
      ...
      { 
          ...
          $this->rg_erro = $this->Db->ErrorMsg();
					...
					if($numHojas > 0){
						...
						$objPHPExcel->setActiveSheetIndex(0);
						$objPHPExcel->getActiveSheet()->setTitle(''.$dia[0]);
						$numHojas++;
					}
					
					if($dia[2] == 'A'){
						$objPHPExcel->getActiveSheet()->setCellValue($encabezados[3], $this->da[0][0]);
					}
					if($dia[2] == 'B'){
						$objPHPExcel->getActiveSheet()->setCellValue($encabezados[3], $this->db[0][0]);
					}
					
					if($dia[0] < 10){
					$objPHPExcel->getActiveSheet()->setCellValue($encabezados[6], "0$dia[1]");
					}else{
						$objPHPExcel->getActiveSheet()->setCellValue($encabezados[6], $dia[1]);
					}
					...
					foreach($totales as $key => $valor){
							$objPHPExcel->getActiveSheet()->setCellValue($columnas[$key].'37', $valor);
					}
				}
				...
				header("Content-Disposition: attachment;filename=VHMD(".$this->kz[0][0]."-$fecha_nombre-$this->sc_temp_year).xlsx");
				...
				echo "NO EXISTEN REGISTROS (".$this->kz[0][0]."-$fecha_nombre-$this->sc_temp_year)";
			}
		}else{
			echo "Error: El formato base de Excel (VHMD.xlsx) no se encontro <br>"; 
		}
	}else{
...
$_SESSION['scriptcase']['vhmd']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['vhmd']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "vhmd") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['vhmd']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['vhmd']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['vhmd']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['vhmd']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   if (isset($_POST["caseta"])) 
   {
       ...
       nm_limpa_str_vhmd($_SESSION["caseta"]);
   }
   ...
   if (isset($_POST["year"])) 
   {
       ...
       nm_limpa_str_vhmd($_SESSION["year"]);
   }
   if (isset($_GET["year"])) 
   {
   ...
   if (isset($_POST["mesini"])) 
   {
       ...
       nm_limpa_str_vhmd($_SESSION["mesini"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['vhmd']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['vhmd']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['vhmd']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "vhmd";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'vhmd' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['vhmd']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['vhmd']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['vhmd']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['vhmd']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['vhmd']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('vhmd' == $sReferer || 'vhmd_' == substr($sReferer, 0, 5))
       {
           $_SESSION['sc_session'][$script_case_init]['vhmd']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'vhmd')
   {
       $_SESSION['sc_session'][$script_case_init]['vhmd']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['vhmd']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/vhmd_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
   ...
   $contr_vhmd = new vhmd_apl();
   $contr_vhmd->controle();
//
   function nm_limpa_str_vhmd(&$str)
   {
   }
?>
