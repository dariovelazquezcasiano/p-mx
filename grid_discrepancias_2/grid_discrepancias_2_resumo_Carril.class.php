...
class grid_discrepancias_2_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_carrilid       = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_discrepancias_2']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_discrepancias_2']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['contr_total_geral'] == "OK")
      {
          $this->array_total_fechaoperacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_total']['fechaoperacion'];
          $this->array_total_carrilid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_total']['carrilid'];
      }
      else
      {
          $this->array_total_fechaoperacion = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][5];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['json_use_label'])
       {
          $Lab_fechaoperacion = "FechaOperacion";
          $Lab_carrilid = "CarrilID";
       }
       else
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['fechaoperacion'] = "Fecha Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['carrilid'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['cruces']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['cruces'] = "Cruces"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['novalidos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['novalidos'] = "No Validos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['discrepancias']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['discrepancias'] = "Discrepancias"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['porcientodisc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['porcientodisc'] = "% Clasificacion correcta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['porcientoconteo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['porcientoconteo'] = "% Conteo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['clasificados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['clasificados'] = "Clasificacion correcta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['detectados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['detectados'] = "Conteo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['labels']['casetaid'] = "Caseta"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fechaoperacion' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Cruces (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "No Validos (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Discrepancias (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "% Clasificacion correcta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
           6 => "% Conteo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_order']['Carril']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_order']['Carril'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_order']['Carril'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Carril'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Carril'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Carril'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Carril'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Carril'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Carril'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Carril'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "cruces", 'show' => true),
           3 => array('field' => "novalidos", 'show' => true),
           4 => array('field' => "discrepancias", 'show' => true),
           5 => array('field' => "porcientodisc", 'show' => true),
           6 => array('field' => "porcientoconteo", 'show' => true),
       );
       ...
       $this->comp_sum_css = array(
           2 => "css_cruces_sum",
           3 => "css_novalidos_sum",
           4 => "css_discrepancias_sum",
           5 => "css_porcientodisc_avg",
           6 => "css_porcientoconteo_avg",
       );
       ...
       foreach ($this->array_total_fechaoperacion as $i_fechaoperacion => $d_fechaoperacion) {
           ...
           foreach ($this->array_total_carrilid[$i_fechaoperacion] as $i_carrilid => $d_carrilid) {
               if (!isset($i_carrilid, $this->comp_label[1][ $d_fechaoperacion[7] ]) || !in_array($i_carrilid, $this->comp_label[1][ $d_fechaoperacion[7] ], true)) {
                   $this->comp_index[1][ $d_carrilid[7] ] = $d_carrilid[6];
                   $this->comp_label[1][ $d_fechaoperacion[7] ][ $d_carrilid[7] ] = $d_carrilid[6];
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_fechaoperacion => $l_fechaoperacion) {
           ...
           foreach ($this->comp_label[1][$i_fechaoperacion] as $i_carrilid => $l_carrilid) {
               if (isset($this->array_total_carrilid[$i_fechaoperacion][$i_carrilid])) {
                   $this->comp_group[$i_fechaoperacion][$i_carrilid] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_carrilid;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_discrepancias_2@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Cruces (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'FechaOperacion',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaoperacion)),
               'label_y'  => $this->getChartText(strip_tags("Cruces (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("No Validos (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'FechaOperacion',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaoperacion)),
               'label_y'  => $this->getChartText(strip_tags("No Validos (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("Discrepancias (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'FechaOperacion',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaoperacion)),
               'label_y'  => $this->getChartText(strip_tags("Discrepancias (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(3),
           ),
           '0|4' => array(
               'title'    => $this->getChartText(strip_tags("% Clasificacion correcta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'FechaOperacion',
               'field_y'  => $this->comp_sum_nm[5],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaoperacion)),
               'label_y'  => $this->getChartText(strip_tags("% Clasificacion correcta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(4),
           ),
           '0|5' => array(
               'title'    => $this->getChartText(strip_tags("% Conteo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'FechaOperacion',
               'field_y'  => $this->comp_sum_nm[6],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaoperacion)),
               'label_y'  => $this->getChartText(strip_tags("% Conteo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'CarrilID',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_carrilid)),
               'label_y'  => $this->getChartText(strip_tags("Cruces (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_discrepancias_2_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_discrepancias_2_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['proc_pdf_vert']){ 
   ...
   public static function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 3)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "", "", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']);
       }
       if ($total == 4)
       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_discrepancias_2_total.class.php"); 
      }
      ...
      $this->Total   = new grid_discrepancias_2_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      if (is_array($this->array_total_carrilid)) {
          ksort($this->array_total_carrilid);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_discrepancias_2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_discrepancias_2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_discrepancias_2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_discrepancias_2/grid_discrepancias_2_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_discrepancias_2/grid_discrepancias_2_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_discrepancias_2&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_discrepancias_2/grid_discrepancias_2_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_discrepancias_2/grid_discrepancias_2_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_discrepancias_2/grid_discrepancias_2_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_discrepancias_2_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_discrepancias_2']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_discrepancias_2']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_discrepancias_2_config_pivot.php?nome_apl=grid_discrepancias_2&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_discrepancias_2_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_discrepancias_2/grid_discrepancias_2_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_discrepancias_2_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_discrepancias_2_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_discrepancias_2_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_discrepancias_2_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_discrepancias_2_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_cruces, $sum_novalidos, $sum_discrepancias, $avg_porcientodisc, $avg_porcientoconteo, $quebra_fechaoperacion, $quebra_carrilid, $quebra_fechaoperacion_orig, $quebra_carrilid_orig)
   {
      ...
      if (!isset($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig]))
      {
         ...
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][1] = $sum_cruces;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][2] = $sum_novalidos;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][3] = $sum_discrepancias;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][4] = $avg_porcientodisc;
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][5] = $avg_porcientoconteo;
      ...
      else
      {
         ...
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][1] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][1], $sum_cruces, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][2] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][2], $sum_novalidos, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][3] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][3], $sum_discrepancias, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][4] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][4], $avg_porcientodisc, 10);
         $this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][5] = bcadd($this->array_total_fechaoperacion[$quebra_fechaoperacion_orig][5], $avg_porcientoconteo, 10);
      }
      //----- Carril
      if (!isset($this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig]))
      {
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][0] = 1;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][1] = $sum_cruces;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][2] = $sum_novalidos;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][3] = $sum_discrepancias;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][4] = $avg_porcientodisc;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][5] = $avg_porcientoconteo;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][6] = $quebra_carrilid;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][7] = $quebra_carrilid_orig;
      }
      else
      {
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][0]++;
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][1] = bcadd($this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][1], $sum_cruces, 10);
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][2] = bcadd($this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][2], $sum_novalidos, 10);
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][3] = bcadd($this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][3], $sum_discrepancias, 10);
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][4] = bcadd($this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][4], $avg_porcientodisc, 10);
         $this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][5] = bcadd($this->array_total_carrilid[$quebra_fechaoperacion_orig][$quebra_carrilid_orig][5], $avg_porcientoconteo, 10);
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_cruces;
         $this->array_total_geral[2] = $sum_novalidos;
         $this->array_total_geral[3] = $sum_discrepancias;
         $this->array_total_geral[4] = $avg_porcientodisc;
         $this->array_total_geral[5] = $avg_porcientoconteo;
      }
      else
      {
         $this->array_total_geral[0]++;
         $this->array_total_geral[1] = bcadd($this->array_total_geral[1], $sum_cruces, 10);
         $this->array_total_geral[2] = bcadd($this->array_total_geral[2], $sum_novalidos, 10);
         $this->array_total_geral[3] = bcadd($this->array_total_geral[3], $sum_discrepancias, 10);
         $this->array_total_geral[4] = bcadd($this->array_total_geral[4], $avg_porcientodisc, 10);
         $this->array_total_geral[5] = bcadd($this->array_total_geral[5], $avg_porcientoconteo, 10);
      }
   }
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_total']['fechaoperacion'] as $campo_fechaoperacion => $dados_fechaoperacion)
      {
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_total']['carrilid'][$campo_fechaoperacion] as $campo_carrilid => $dados_carrilid)
         {
            $this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][1] = $dados_carrilid[1];
            $this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][2] = $dados_carrilid[2];
            $this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][3] = $dados_carrilid[3];
            $this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][4] = $dados_carrilid[4];
            $this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][5] = $dados_carrilid[5];
         }
      }
   }
   //---- 
   ...
   {
      foreach ($this->array_total_fechaoperacion as $campo_fechaoperacion => $dados_fechaoperacion)
      {
         nmgp_Trunc_Num($this->array_total_fechaoperacion[$campo_fechaoperacion][1], 0);
         nmgp_Trunc_Num($this->array_total_fechaoperacion[$campo_fechaoperacion][2], 0);
         nmgp_Trunc_Num($this->array_total_fechaoperacion[$campo_fechaoperacion][3], 0);
         if ($this->array_total_fechaoperacion[$campo_fechaoperacion][0] != 0) {$this->array_total_fechaoperacion[$campo_fechaoperacion][4] /= $this->array_total_fechaoperacion[$campo_fechaoperacion][0];}
         nmgp_Trunc_Num($this->array_total_fechaoperacion[$campo_fechaoperacion][4], 2);
         if ($this->array_total_fechaoperacion[$campo_fechaoperacion][0] != 0) {$this->array_total_fechaoperacion[$campo_fechaoperacion][5] /= $this->array_total_fechaoperacion[$campo_fechaoperacion][0];}
         nmgp_Trunc_Num($this->array_total_fechaoperacion[$campo_fechaoperacion][5], 2);
         foreach ($this->array_total_carrilid[$campo_fechaoperacion] as $campo_carrilid => $dados_carrilid)
         {
            nmgp_Trunc_Num($this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][1], 0);
            nmgp_Trunc_Num($this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][2], 0);
            nmgp_Trunc_Num($this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][3], 0);
            if ($this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][0] != 0) {$this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][4] /= $this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][0];}
            nmgp_Trunc_Num($this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][4], 2);
            if ($this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][0] != 0) {$this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][5] /= $this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][0];}
            nmgp_Trunc_Num($this->array_total_carrilid[$campo_fechaoperacion][$campo_carrilid][5], 2);
         }
      }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('Carril', 'fechaoperacion');
     $campos_order = $this->Ini->Get_date_order_groupby("FechaOperacion", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('Carril', 'carrilid');
     $campos_order = $this->Ini->Get_date_order_groupby("CarrilID", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fechaoperacion = $rs_res->fields[0] ;  
            $this->carrilid = $rs_res->fields[1] ;  
            $this->cruces = $rs_res->fields[2] ;  
            $this->novalidos = $rs_res->fields[3] ;  
            $this->clasificados = $rs_res->fields[4] ;  
            $this->detectados = $rs_res->fields[5] ;  
...
$_SESSION['scriptcase']['grid_discrepancias_2']['contr_erro'] = 'off'; 
            ...
            $this->carrilid_orig = $this->carrilid;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cruces, $this->novalidos, $this->discrepancias, $this->porcientodisc, $this->porcientoconteo, $this->fechaoperacion, $this->carrilid, $this->fechaoperacion_orig,  $this->carrilid_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_discrepancias_2']['contr_erro'] = 'off';
     ...
     $this->fechaoperacion = $this->Ini->GB_date_format($TP_Time . $fechaoperacion_SV, $Format_tst, $Prefix_dat); 
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->cruces)), NM_encode_input(sc_strip_script($this->novalidos)), NM_encode_input(sc_strip_script($this->discrepancias)), NM_encode_input(sc_strip_script($this->porcientodisc)), NM_encode_input(sc_strip_script($this->porcientoconteo)), NM_encode_input(sc_strip_script($this->fechaoperacion)), NM_encode_input(sc_strip_script($this->GB_carrilid)), NM_encode_input(sc_strip_script($fechaoperacion_orig)), NM_encode_input(sc_strip_script($carrilid_orig)));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_total']['fechaoperacion'] = $this->array_total_fechaoperacion;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['arr_total']['carrilid'] = $this->array_total_carrilid;
      }
   }
