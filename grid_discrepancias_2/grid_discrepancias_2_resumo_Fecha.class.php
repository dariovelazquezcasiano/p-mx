...
class grid_discrepancias_2_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_order']['Fecha']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_order']['Fecha'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_order']['Fecha'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Fecha'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Fecha'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Fecha'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Fecha'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Fecha'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Fecha'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['summarizing_fields_display']['Fecha'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_discrepancias_2']['proc_pdf_vert']){ 
   ...
   public static function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 3)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']);
       }
       if ($total == 4)
       {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cruces, $sum_novalidos, $sum_discrepancias, $avg_porcientodisc, $avg_porcientoconteo, $quebra_fechaoperacion, $quebra_fechaoperacion_orig)
   {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('Fecha', 'fechaoperacion');
...
$_SESSION['scriptcase']['grid_discrepancias_2']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cruces, $this->novalidos, $this->discrepancias, $this->porcientodisc, $this->porcientoconteo, $this->fechaoperacion, $this->fechaoperacion_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_discrepancias_2']['contr_erro'] = 'off';
     ...
     $this->fechaoperacion = $this->Ini->GB_date_format($TP_Time . $fechaoperacion_SV, $Format_tst, $Prefix_dat); 
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->cruces)), NM_encode_input(sc_strip_script($this->novalidos)), NM_encode_input(sc_strip_script($this->discrepancias)), NM_encode_input(sc_strip_script($this->porcientodisc)), NM_encode_input(sc_strip_script($this->porcientoconteo)), NM_encode_input(sc_strip_script($this->fechaoperacion)), NM_encode_input(sc_strip_script($fechaoperacion_orig)));
