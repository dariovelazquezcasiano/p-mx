...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_numeric[] = "carrilid";$Nm_numeric[] = "count(*)";$Nm_numeric[] = "sum(if( pagoid_ana = 'ge' && fld_ar_sct != 2,1,0))";$Nm_numeric[] = "\" _ \$_session['sqldetectados'] _ \"";$Nm_numeric[] = "\" _ \$_session['sqlclasificados'] _ \"";$Nm_numeric[] = "";
