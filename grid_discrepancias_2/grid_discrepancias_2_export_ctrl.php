<?php
@session_start() ;
$_SESSION['scriptcase']['grid_discrepancias_2']['sc_process_barr'] = true;
require_once('../grid_discrepancias_2/index.php');
unset($_SESSION['scriptcase']['grid_discrepancias_2']['sc_process_barr']);
$ExportCtrl = new grid_discrepancias_2_export_control;
$ExportCtrl->Export_barr();

class grid_discrepancias_2_export_control
{
