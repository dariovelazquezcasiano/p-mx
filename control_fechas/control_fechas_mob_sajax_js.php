  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_fechas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_fechas_mob_form();
	}
...
?>
  ...
  // ---------- Validate fecha_ini
  function do_ajax_control_fechas_mob_validate_fecha_ini()
  {
    var nomeCampo_fecha_ini = "fecha_ini";
    var var_fecha_ini = scAjaxGetFieldText(nomeCampo_fecha_ini);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_fechas_mob_validate_fecha_ini(var_fecha_ini, var_script_case_init, do_ajax_control_fechas_mob_validate_fecha_ini_cb);
  } // do_ajax_control_fechas_mob_validate_fecha_ini

  function do_ajax_control_fechas_mob_validate_fecha_ini_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_fechas_mob_validate_fecha_ini_cb

  // ---------- Validate fecha_fin
  function do_ajax_control_fechas_mob_validate_fecha_fin()
  {
    var nomeCampo_fecha_fin = "fecha_fin";
    var var_fecha_fin = scAjaxGetFieldText(nomeCampo_fecha_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_fechas_mob_validate_fecha_fin(var_fecha_fin, var_script_case_init, do_ajax_control_fechas_mob_validate_fecha_fin_cb);
  } // do_ajax_control_fechas_mob_validate_fecha_fin

  function do_ajax_control_fechas_mob_validate_fecha_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_fechas_mob_validate_fecha_fin_cb

  // ---------- Validate fld_caseta
  function do_ajax_control_fechas_mob_validate_fld_caseta()
  {
    var nomeCampo_fld_caseta = "fld_caseta";
    var var_fld_caseta = scAjaxGetFieldSelect(nomeCampo_fld_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_fechas_mob_validate_fld_caseta(var_fld_caseta, var_script_case_init, do_ajax_control_fechas_mob_validate_fld_caseta_cb);
  } // do_ajax_control_fechas_mob_validate_fld_caseta

  function do_ajax_control_fechas_mob_validate_fld_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_fechas_mob_validate_fld_caseta_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_fechas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_fechas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_fechas_mob_submit_form(var_fecha_ini, var_fecha_fin, var_fld_caseta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_fechas_mob_submit_form_cb);
  } // do_ajax_control_fechas_mob_submit_form

  function do_ajax_control_fechas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_fechas_mob_submit_form_cb_after_alert);
  } // do_ajax_control_fechas_mob_submit_form_cb
  function do_ajax_control_fechas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_fechas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_fechas_mob_navigate_form()
  {
    perform_ajax_control_fechas_mob_navigate_form();
  }

  function perform_ajax_control_fechas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_fechas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_fechas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_fechas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_fechas_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_fechas_mob_navigate_form_cb
  function do_ajax_control_fechas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_fechas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_fechas_mob_navigate_form_cb_after_alert

  function sc_hide_control_fechas_mob_form()
  {
  ...
  ajax_field_list[0] = "fecha_ini";
  ajax_field_list[1] = "fecha_fin";
  ajax_field_list[2] = "fld_caseta";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fecha_ini": {"label": "Fecha de Inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
