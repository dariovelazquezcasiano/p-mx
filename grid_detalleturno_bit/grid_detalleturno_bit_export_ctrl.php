<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleturno_bit']['sc_process_barr'] = true;
require_once('../grid_detalleturno_bit/index.php');
unset($_SESSION['scriptcase']['grid_detalleturno_bit']['sc_process_barr']);
$ExportCtrl = new grid_detalleturno_bit_export_control;
$ExportCtrl->Export_barr();

class grid_detalleturno_bit_export_control
{
