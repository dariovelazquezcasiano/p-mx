...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_bit"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_bit"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_bit']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_bit']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_bit']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_bit']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_bit']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleturno_bit</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_bit']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_bit']['embutida_filho'] as $ind => $sc_init)
          {
