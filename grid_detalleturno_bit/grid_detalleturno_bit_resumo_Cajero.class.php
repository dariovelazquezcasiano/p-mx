...
class grid_detalleturno_bit_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_detalleturno_bit']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_detalleturno_bit']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['contr_total_geral'] == "OK")
      {
          $this->array_total_usuarioid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['arr_total']['usuarioid'];
      }
      else
      {
          $this->array_total_usuarioid = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['arr_total']['usuarioid'] = $this->array_total_usuarioid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['json_use_label'])
       {
          $Lab_usuarioid = "UsuarioID";
       }
       else
       {
       $Lab_usuarioid = "Usuario";
       }
       $this->comp_field = array(
           $Lab_usuarioid,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['casetaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['casetaid'] = "Caseta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['turnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['turnoid'] = "Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['carrilid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['carrilid'] = "Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['estatuscarril']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['estatuscarril'] = "Estatus Carril"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['usuarioid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['usuarioid'] = "Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['fechaoperacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['fechaoperacion'] = "Fecha Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['horainicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['horainicio'] = "Hora Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['fechafin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['fechafin'] = "Fecha Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['horafin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['horafin'] = "Hora Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['tiempodif']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['tiempodif'] = "Tiempo Operado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['consecutivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['consecutivo'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['tramoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['tramoid'] = "Tramo ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['cuerpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['cuerpo'] = "Cuerpo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['fechaturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['fechaturno'] = "Fecha Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['operacionid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['operacionid'] = "Operacion ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['foliocierre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['foliocierre'] = "Folio Cierre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['observacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['observacion'] = "Observacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['preliquidado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['preliquidado'] = "Pre Liquidado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['montocr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['montocr'] = "Monto CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['cantidadmxn']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['cantidadmxn'] = "Cantidad MXN"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['cantidadusd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['cantidadusd'] = "Cantidad USD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['importemxn']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['importemxn'] = "Importe MXN"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['importeusd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['importeusd'] = "Importe USD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['folioinicialcr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['folioinicialcr'] = "Folio Inicial CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['foliofinalcr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['foliofinalcr'] = "Folio Final CR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['folioinicialeap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['folioinicialeap'] = "Folio Inicial EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['foliofinaleap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['foliofinaleap'] = "Folio Final EAP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['faltante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['faltante'] = "Faltante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['administradorid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['administradorid'] = "Administrador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['encargadoturnoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['encargadoturnoid'] = "Encargado Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['encargadoturnoid_pre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['labels']['encargadoturnoid_pre'] = "Encargado Turno PreLiquida"; 
       }
       //-----
       $this->comp_field_nm = array(
           'usuarioid' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_order']['Cajero']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_order']['Cajero'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_order']['Cajero'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_display']['Cajero'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_display']['Cajero'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_display']['Cajero'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_display']['Cajero'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_display']['Cajero'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_display']['Cajero'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['summarizing_fields_display']['Cajero'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_usuarioid as $i_usuarioid => $d_usuarioid) {
           if (!isset($i_usuarioid, $this->comp_label[0]) || !in_array($i_usuarioid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_usuarioid[3] ] = $d_usuarioid[2];
               $this->comp_label[0][ $d_usuarioid[3] ] = $d_usuarioid[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_usuarioid => $l_usuarioid) {
           if (isset($this->array_total_usuarioid[$i_usuarioid])) {
               $this->comp_group[$i_usuarioid] = array();
           }
       }
     }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_detalleturno_bit@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_detalleturno_bit_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_Cajero("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detalleturno_bit_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_detalleturno_bit_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detalleturno_bit_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_detalleturno_bit/grid_detalleturno_bit_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detalleturno_bit/grid_detalleturno_bit_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_detalleturno_bit_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detalleturno_bit']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detalleturno_bit']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_detalleturno_bit_config_pivot.php?nome_apl=grid_detalleturno_bit&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detalleturno_bit_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_detalleturno_bit/grid_detalleturno_bit_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($quebra_usuarioid, $quebra_usuarioid_orig)
   {
      //----- Usuario
      if (!isset($this->array_total_usuarioid[$quebra_usuarioid_orig]))
      {
         $this->array_total_usuarioid[$quebra_usuarioid_orig][0] = 1;
         $this->array_total_usuarioid[$quebra_usuarioid_orig][1] = 1;
         $this->array_total_usuarioid[$quebra_usuarioid_orig][2] = $quebra_usuarioid;
         $this->array_total_usuarioid[$quebra_usuarioid_orig][3] = $quebra_usuarioid_orig;
      }
      else
      {
         $this->array_total_usuarioid[$quebra_usuarioid_orig][0]++;
         $this->array_total_usuarioid[$quebra_usuarioid_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('Cajero', 'usuarioid');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->turnoid = $rs_res->fields[1] ;  
            $this->carrilid = $rs_res->fields[2] ;  
            $this->estatuscarril = $rs_res->fields[3] ;  
            $this->usuarioid = $rs_res->fields[4] ;  
            $this->fechaoperacion = $rs_res->fields[5] ;  
            $this->horainicio = $rs_res->fields[6] ;  
            $this->fechafin = $rs_res->fields[7] ;  
            $this->horafin = $rs_res->fields[8] ;  
            $this->tiempodif = $rs_res->fields[9] ;  
            $this->consecutivo = $rs_res->fields[10] ;  
            $this->tramoid = $rs_res->fields[11] ;  
            $this->cuerpo = $rs_res->fields[12] ;  
            $this->administradorid = $rs_res->fields[13] ;  
            $this->encargadoturnoid = $rs_res->fields[14] ;  
            $this->encargadoturnoid_pre = $rs_res->fields[15] ;  
...
$_SESSION['scriptcase']['grid_detalleturno_bit']['contr_erro'] = 'off'; 
            ...
            $this->usuarioid = $this->look_usuarioid ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->usuarioid, $this->usuarioid_orig);
            }
   }
//
