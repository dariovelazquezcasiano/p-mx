<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detalleturno_bit']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detalleturno_bit_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalleturno_bit_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["casetaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["casetaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["casetaid"] : "Caseta";
   $tab_ger_campos['turnoid'] = "on";
   $tab_def_campos['turnoid'] = "TurnoID";
   $tab_labels["turnoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["turnoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["turnoid"] : "Turno";
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["carrilid"] : "Carril";
   $tab_ger_campos['estatuscarril'] = "on";
   $tab_def_campos['estatuscarril'] = "EstatusCarril";
   $tab_labels["estatuscarril"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["estatuscarril"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["estatuscarril"] : "Estatus Carril";
   $tab_ger_campos['usuarioid'] = "on";
   $tab_def_campos['usuarioid'] = "UsuarioID";
   $tab_labels["usuarioid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["usuarioid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["usuarioid"] : "Usuario";
   $tab_ger_campos['fechaoperacion'] = "on";
   $tab_def_campos['fechaoperacion'] = "FechaOperacion";
   $tab_labels["fechaoperacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["fechaoperacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["fechaoperacion"] : "Fecha Inicio";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "HoraInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["horainicio"] : "Hora Inicio";
   $tab_ger_campos['fechafin'] = "on";
   $tab_def_campos['fechafin'] = "FechaFin";
   $tab_labels["fechafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["fechafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["fechafin"] : "Fecha Fin";
   $tab_ger_campos['horafin'] = "on";
   $tab_def_campos['horafin'] = "HoraFin";
   $tab_labels["horafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["horafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["horafin"] : "Hora Fin";
   $tab_ger_campos['tiempodif'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tiempodif'] = "tiempodif";
   }
   else
   {
       $tab_def_campos['tiempodif'] = "TIMEDIFF(CONCAT(FechaFin,\" \",HoraFin),CONCAT(FechaOperacion,\" \",HoraInicio))";
   }
   $tab_labels["tiempodif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["tiempodif"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['labels']["tiempodif"] : "Tiempo Operado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalleturno_bit_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalleturno_bit']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
