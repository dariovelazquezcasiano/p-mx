...
class grid_detalleturno_bit_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detalleturno_bit_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detalleturno_bit_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detalleturno_bit_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_refresh_field")
      {
          ...
          if (in_array("turnoid", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_turnoid();
              ...
              $this->Arr_result['set_option'][] = array('field' => 'SC_turnoid', 'value' => $list);
          }
          if (in_array("usuarioid", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_usuarioid($casetaid);
              foreach ($nmgp_def_dados as $ind => $parms)
              {
                  foreach ($parms as $opt => $val)
                  {
              ...
              $this->Arr_result['set_option'][] = array('field' => 'SC_usuarioid', 'value' => $list);
          }
      }
      if ($this->NM_ajax_opcao == 'autocomp_carrilid')
      {
          $carrilid = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_carrilid($carrilid);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_usuarioid($casetaid)
   {
   ...
   {
      $carrilid = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $carrilid);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_datas[] = "FechaTurno";$Nm_datas[] = "HoraInicio";$Nm_datas[] = "FechaFin";$Nm_datas[] = "HoraFin";$Nm_datas[] = "TIMEDIFF(CONCAT(FechaFin,\" \",HoraFin),CONCAT(FechaOperacion,\" \",HoraInicio))";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Turno</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detalleturno_bit/grid_detalleturno_bit_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>_lib/css/peaje_module_ui.css?v=20260911-ui" />
</HEAD>
<?php
$vertical_center = '';
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detalleturno_bit_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detalleturno_bit_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detalleturno_bit_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detalleturno_bit']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detalleturno_bit']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_usuarioid_cond#NMF#' + search_get_sel_txt('SC_usuarioid_cond') + '@NMF@';
  str_out += 'SC_usuarioid#NMF#' + search_get_select('SC_usuarioid') + '@NMF@';
  str_out += 'SC_fechaoperacion_cond#NMF#' + search_get_sel_txt('SC_fechaoperacion_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_fechaoperacion_cond');
  if (opc.substring(0, 3) != "bi_")
  {
  ...
  str_out += 'SC_carrilid_cond#NMF#' + search_get_sel_txt('SC_carrilid_cond') + '@NMF@';
  str_out += 'SC_carrilid#NMF#' + search_get_text('SC_carrilid') + '@NMF@';
  str_out += 'id_ac_carrilid#NMF#' + search_get_text('id_ac_carrilid') + '@NMF@';
 ...
 {
   var parms  = "";
   var fields = "turnoid@NMF@usuarioid";
...
<script type="text/javascript">
 $(function() {
   var temp_vl_carrilid_autocomp = $('#id_ac_carrilid').val();
   scClass = $("#id_ac_carrilid").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_carrilid").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_carrilid",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_carrilid").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
       temp_vl_carrilid_autocomp = ui.item.label;
     },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_carrilid").val( $(this).val() );
          temp_vl_carrilid_autocomp = ui.item.label;
       }
     }
   });
   $('#id_ac_carrilid').keypress(function(e) {
     if (e.keyCode == $.ui.keyCode.ENTER) {
        if (temp_vl_carrilid_autocomp != $('#id_ac_carrilid').val()) {
             document.getElementById('SC_carrilid').value = $('#id_ac_carrilid').val();
         }
          nm_submit_form();
     }
   });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Turno</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $carrilid_cond, $carrilid, $carrilid_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $casetaid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['casetaid']; 
          $casetaid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['casetaid_cond']; 
          $usuarioid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['usuarioid']; 
          $usuarioid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['usuarioid_cond']; 
          $fechaoperacion_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_dia']; 
          $fechaoperacion_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_mes']; 
          $fechaoperacion_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_ano']; 
          $fechaoperacion_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_input_2_dia']; 
          $fechaoperacion_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_input_2_mes']; 
          $fechaoperacion_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_input_2_ano']; 
          $fechaoperacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_cond']; 
          $turnoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['turnoid']; 
          $turnoid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['turnoid_cond']; 
          $carrilid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['carrilid']; 
          $carrilid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['carrilid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['NM_operador']; 
      } 
...
?>
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_casetaid"  <?php echo $str_hide_casetaid?>>
<?php
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_usuarioid"  <?php echo $str_hide_usuarioid?>>
<?php
      $usuarioid_look = (is_string($usuarioid) ? substr($this->Db->qstr($usuarioid), 1, -1) : $usuarioid); 
      $nmgp_def_dados = "" ; 
   if (is_numeric($casetaid))
...
?>
   <span id="idAjaxSelect_usuarioid">
      <SELECT class="scFilterObjectOdd" id="SC_usuarioid" name="usuarioid"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br>
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fechaoperacion_cond" name="fechaoperacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaoperacion'), this, 'fechaoperacion')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="bi_OT" <?php if ("bi_OT" == $fechaoperacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_dia" name="fechaoperacion_dia" value="<?php echo NM_encode_input($fechaoperacion_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_mes" name="fechaoperacion_mes" value="<?php echo NM_encode_input($fechaoperacion_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_ano" name="fechaoperacion_ano" value="<?php echo NM_encode_input($fechaoperacion_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechaoperacion"  <?php echo $str_display_fechaoperacion; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_input_2_dia" name="fechaoperacion_input_2_dia" value="<?php echo NM_encode_input($fechaoperacion_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_input_2_mes" name="fechaoperacion_input_2_mes" value="<?php echo NM_encode_input($fechaoperacion_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_input_2_ano" name="fechaoperacion_input_2_ano" value="<?php echo NM_encode_input($fechaoperacion_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_turnoid"  <?php echo $str_hide_turnoid?>>
<?php
      $turnoid_look = (is_string($turnoid) ? substr($this->Db->qstr($turnoid), 1, -1) : $turnoid); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT TipoID, Nombre  FROM turnos  ORDER BY TipoID"; 
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_carrilid"  <?php echo $str_hide_carrilid?>><?php
      if ($carrilid != "")
      {
      $carrilid_look = (is_string($carrilid) ? substr($this->Db->qstr($carrilid), 1, -1) : $carrilid); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($carrilid, "", "", "0", "S", "2", "", "N:1", "-") ; 
          $sAutocompValue = $carrilid;
      }
?>
<INPUT  type="text" id="SC_carrilid" name="carrilid" value="<?php echo NM_encode_input($carrilid) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_carrilid" name="carrilid_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_detalleturno_bit_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fechaoperacion_cond.value = 'bi_OT';
   ...
   document.F1.carrilid_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fechaoperacion_dia').bind('change', function() {sc_grid_detalleturno_bit_valida_dia(this)});
    $('#SC_fechaoperacion_input_2_dia').bind('change', function() {sc_grid_detalleturno_bit_valida_dia(this)});
    $('#SC_fechaoperacion_input_2_mes').bind('change', function() {sc_grid_detalleturno_bit_valida_mes(this)});
    $('#SC_fechaoperacion_mes').bind('change', function() {sc_grid_detalleturno_bit_valida_mes(this)});
 }
 function sc_grid_detalleturno_bit_valida_dia(obj)
 {
 ...
 function sc_grid_detalleturno_bit_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_detalleturno_bit/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_usuarioid_cond'] = 'cond';
      $tp_fields['SC_usuarioid'] = 'select';
      ...
      $tp_fields['SC_carrilid_cond'] = 'cond';
      $tp_fields['SC_carrilid'] = 'text_aut';
      $tp_fields['id_ac_carrilid'] = 'text_aut';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              else
              {
                  ...
                  if ($Cada_cmp[0] == 'SC_fechaoperacion_cond')
                  {
                      $opc = $Cada_cmp[1];
   ...
   function trata_campos()
   {
      global $casetaid_cond, $casetaid,
             ...
             $fechaoperacion_cond, $fechaoperacion, $fechaoperacion_dia, $fechaoperacion_mes, $fechaoperacion_ano, $fechaoperacion_input_2_dia, $fechaoperacion_input_2_mes, $fechaoperacion_input_2_ano,
             $turnoid_cond, $turnoid,
             $carrilid_cond, $carrilid, $carrilid_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($carrilid_autocomp) && empty($carrilid))
      {
          $carrilid = $carrilid_autocomp;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['psq_check_ret']['casetaid'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['psq_check_ret']['usuarioid'])) {
      ...
      if (!$this->NM_ajax_flag || $this->NM_ajax_opcao != "ajax_grid_search")
      {
          if (substr($fechaoperacion_cond, 0, 3) != "bi_" && $fechaoperacion_cond != "nu" && $fechaoperacion_cond != "nn" && $fechaoperacion_cond != "ep" && $fechaoperacion_cond != "ne")
          {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['psq_check_ret']['turnoid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Turno : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if ($carrilid_cond != "in")
      {
          nm_limpa_numero($carrilid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['casetaid'] = $casetaid; 
      if (is_array($casetaid) && !empty($casetaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0] = $casetaid;
      }
      elseif ($casetaid_cond_salva == "nu" || $casetaid_cond_salva == "nn" || $casetaid_cond_salva == "ep" || $casetaid_cond_salva == "ne" || !empty($casetaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0][0] = $casetaid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['casetaid_cond'] = $casetaid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['cmp'] = "casetaid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['opc'] = $casetaid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['casetaid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['usuarioid'] = $usuarioid; 
      if (is_array($usuarioid) && !empty($usuarioid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0] = $usuarioid;
      }
      elseif ($usuarioid_cond_salva == "nu" || $usuarioid_cond_salva == "nn" || $usuarioid_cond_salva == "ep" || $usuarioid_cond_salva == "ne" || !empty($usuarioid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0][0] = $usuarioid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['usuarioid_cond'] = $usuarioid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['cmp'] = "usuarioid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['opc'] = $usuarioid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['usuarioid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_dia'] = $fechaoperacion_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_mes'] = $fechaoperacion_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_ano'] = $fechaoperacion_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_input_2_dia'] = $fechaoperacion_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_input_2_mes'] = $fechaoperacion_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_input_2_ano'] = $fechaoperacion_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fechaoperacion_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fechaoperacion_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fechaoperacion_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fechaoperacion_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fechaoperacion_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fechaoperacion_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_cond'] = $fechaoperacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['cmp'] = "fechaoperacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['opc'] = $fechaoperacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['fechaoperacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['turnoid'] = $turnoid; 
      if (is_array($turnoid) && !empty($turnoid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0] = $turnoid;
      }
      elseif ($turnoid_cond_salva == "nu" || $turnoid_cond_salva == "nn" || $turnoid_cond_salva == "ep" || $turnoid_cond_salva == "ne" || !empty($turnoid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0][0] = $turnoid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['turnoid_cond'] = $turnoid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['cmp'] = "turnoid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['opc'] = $turnoid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['turnoid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['carrilid'] = $carrilid; 
      if (is_array($carrilid) && !empty($carrilid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0] = $carrilid;
      }
      elseif ($carrilid_cond_salva == "nu" || $carrilid_cond_salva == "nn" || $carrilid_cond_salva == "ep" || $carrilid_cond_salva == "ne" || !empty($carrilid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['val'][0][0] = $carrilid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['carrilid_cond'] = $carrilid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['cmp'] = "carrilid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid]['opc'] = $carrilid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['carrilid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'] = $Temp_Busca;
      }
      if ($carrilid_cond != "in" && $carrilid_cond != "bw" && !empty($carrilid) && !is_numeric($carrilid))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Carril";
      }
      if ($carrilid_cond == "bw" && ((!empty($carrilid) && !is_numeric($carrilid)) || (!empty($carrilid_input_2) && !is_numeric($carrilid_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Carril";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['carrilid'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['carrilid'] = $cmp1;
      }
      else
      {
          $cmp1 = $carrilid;
      ...
      if (isset($usuarioid))
      {
         $this->monta_condicao("UsuarioID", $usuarioid_cond, $usuarioid, "", "usuarioid", "VARCHAR", false);
      }
      ...
      if ($fechaoperacion_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion'] = $val[0];
          ...
          if ($fechaoperacion_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']['fechaoperacion_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['fechaoperacion']['label'] = $nmgp_tab_label['fechaoperacion'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['fechaoperacion']['descr'] = $nmgp_tab_label['fechaoperacion'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['grid_pesq']['fechaoperacion']['hint']  = $nmgp_tab_label['fechaoperacion'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      //----- $carrilid
      $this->Date_part = false;
      if (isset($carrilid) || $carrilid_cond == "nu" || $carrilid_cond == "nn" || $carrilid_cond == "ep" || $carrilid_cond == "ne")
      {
         $this->monta_condicao("CarrilID", $carrilid_cond, $carrilid, "", "carrilid", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno_bit']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "usuarioid" : return ('class="scFilterObjectOdd"'); break;
