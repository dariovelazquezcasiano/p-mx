  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipopago" == sTestField)
        {
...
?>
  ...
  // ---------- Validate tipopagoid_
  function do_ajax_form_tipopago_validate_tipopagoid_(iNumLinha)
  {
    var nomeCampo_tipopagoid_ = "tipopagoid_" + iNumLinha;
    var var_tipopagoid_ = scAjaxGetFieldText(nomeCampo_tipopagoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipopago_validate_tipopagoid_(var_tipopagoid_, iNumLinha, var_script_case_init, do_ajax_form_tipopago_validate_tipopagoid__cb);
  } // do_ajax_form_tipopago_validate_tipopagoid_

  function do_ajax_form_tipopago_validate_tipopagoid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tipopagoid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipopagoid_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tipopagoid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipopagoid_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipopago_validate_tipopagoid__cb

  // ---------- Validate tipo_
  function do_ajax_form_tipopago_validate_tipo_(iNumLinha)
  {
    var nomeCampo_tipo_ = "tipo_" + iNumLinha;
    var var_tipo_ = scAjaxGetFieldText(nomeCampo_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipopago_validate_tipo_(var_tipo_, iNumLinha, var_script_case_init, do_ajax_form_tipopago_validate_tipo__cb);
  } // do_ajax_form_tipopago_validate_tipo_

  function do_ajax_form_tipopago_validate_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipopago_validate_tipo__cb

  // ---------- Validate pagoefectivo_
  function do_ajax_form_tipopago_validate_pagoefectivo_(iNumLinha)
  {
    var nomeCampo_pagoefectivo_ = "pagoefectivo_" + iNumLinha;
    var var_pagoefectivo_ = scAjaxGetFieldRadio(nomeCampo_pagoefectivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipopago_validate_pagoefectivo_(var_pagoefectivo_, iNumLinha, var_script_case_init, do_ajax_form_tipopago_validate_pagoefectivo__cb);
  } // do_ajax_form_tipopago_validate_pagoefectivo_

  function do_ajax_form_tipopago_validate_pagoefectivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pagoefectivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pagoefectivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pagoefectivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pagoefectivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipopago_validate_pagoefectivo__cb

  // ---------- Validate esmarcacion_
  function do_ajax_form_tipopago_validate_esmarcacion_(iNumLinha)
  {
    var nomeCampo_esmarcacion_ = "esmarcacion_" + iNumLinha;
    var var_esmarcacion_ = scAjaxGetFieldRadio(nomeCampo_esmarcacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipopago_validate_esmarcacion_(var_esmarcacion_, iNumLinha, var_script_case_init, do_ajax_form_tipopago_validate_esmarcacion__cb);
  } // do_ajax_form_tipopago_validate_esmarcacion_

  function do_ajax_form_tipopago_validate_esmarcacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "esmarcacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "esmarcacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "esmarcacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "esmarcacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipopago_validate_esmarcacion__cb

  // ---------- Validate activo_
  function do_ajax_form_tipopago_validate_activo_(iNumLinha)
  {
    var nomeCampo_activo_ = "activo_" + iNumLinha;
    var var_activo_ = scAjaxGetFieldRadio(nomeCampo_activo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipopago_validate_activo_(var_activo_, iNumLinha, var_script_case_init, do_ajax_form_tipopago_validate_activo__cb);
  } // do_ajax_form_tipopago_validate_activo_

  function do_ajax_form_tipopago_validate_activo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipopago_validate_activo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipopago_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipopago_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipopago_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipopago_add_new_line_cb);
  } // do_ajax_form_tipopago_add_new_line

  function do_ajax_form_tipopago_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tipopago_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipopago_backup_line(iNumLinha)
  {
    var var_tipopagoid_ = scAjaxGetFieldText("tipopagoid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipopago_backup_line(var_tipopagoid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipopago_backup_line_cb);
  } // do_ajax_form_tipopago_backup_line

  function do_ajax_form_tipopago_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipopago_backup_line_cb

  function do_ajax_form_tipopago_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tipopago_cancel_insert

  function do_ajax_form_tipopago_cancel_update(iSeqVert)
  {
    do_ajax_form_tipopago_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipopago_cancel_update

  function do_ajax_form_tipopago_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipopago_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipopago_table_refresh()
  {
    var var_tipopagoid_ = document.F2.tipopagoid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipopago_table_refresh(var_tipopagoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipopago_table_refresh_cb);
  } //  do_ajax_form_tipopago_table_refresh

  function do_ajax_form_tipopago_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipopagoid_.value = scAjaxGetKeyValue("tipopagoid_");
    ...
    scAjaxAlert(do_ajax_form_tipopago_table_refresh_cb_after_alert);
  } // do_ajax_form_tipopago_table_refresh_cb
  function do_ajax_form_tipopago_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipopago_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipopago_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipopago_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_pagoefectivo_ = scAjaxGetFieldRadio("pagoefectivo_" + iNumLinha);
    var var_esmarcacion_ = scAjaxGetFieldRadio("esmarcacion_" + iNumLinha);
    var var_activo_ = scAjaxGetFieldRadio("activo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tipopago_submit_form(var_tipopagoid_, var_tipo_, var_pagoefectivo_, var_esmarcacion_, var_activo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipopago_submit_form_cb);
  } // do_ajax_form_tipopago_submit_form

  function do_ajax_form_tipopago_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tipopagoid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tipo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pagoefectivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("esmarcacion_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tipopago_submit_form_cb_after_alert);
  } // do_ajax_form_tipopago_submit_form_cb
  function do_ajax_form_tipopago_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipopago_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipopago_navigate_form()
  {
    perform_ajax_form_tipopago_navigate_form();
  }

  function perform_ajax_form_tipopago_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipopago_cancel_insert(sc_form_tipopago_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tipopagoid_" + iNavForm);
      scAjaxHideErrorDisplay("tipo_" + iNavForm);
      scAjaxHideErrorDisplay("pagoefectivo_" + iNavForm);
      scAjaxHideErrorDisplay("esmarcacion_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipopago_navigate_form(var_tipopagoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipopago_navigate_form_cb);
  } // do_ajax_form_tipopago_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipopago']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipopago_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tipopagoid_.value = scAjaxGetKeyValue("tipopagoid_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipopago_navigate_form_cb_after_alert);
  } // do_ajax_form_tipopago_navigate_form_cb
  function do_ajax_form_tipopago_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tipopago_navigate_form_cb_after_alert

    function sc_form_tipopago_get_last_line_number()
    {
    ...
    } //sc_form_tipopago_get_last_line_number

  function sc_hide_form_tipopago_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tipopagoid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pagoefectivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "esmarcacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "activo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tipopagoid_" + iNumLinha] = {"label": "Tipo Pago ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["pagoefectivo_" + iNumLinha] = {"label": "Pago Efectivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["esmarcacion_" + iNumLinha] = {"label": "Es Marcacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["activo_" + iNumLinha] = {"label": "Estatus<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tipopagoid_"][iNumLinha] = "tipopagoid_" + iNumLinha;
    ajax_field_mult["tipo_"][iNumLinha] = "tipo_" + iNumLinha;
    ajax_field_mult["pagoefectivo_"][iNumLinha] = "pagoefectivo_" + iNumLinha;
    ajax_field_mult["esmarcacion_"][iNumLinha] = "esmarcacion_" + iNumLinha;
    ajax_field_mult["activo_"][iNumLinha] = "activo_" + iNumLinha;
    ajax_field_id["tipopagoid_" + iNumLinha] = new Array("hidden_field_label_tipopagoid_", "hidden_field_data_tipopagoid_" + iNumLinha);
    ajax_field_id["tipo_" + iNumLinha] = new Array("hidden_field_label_tipo_", "hidden_field_data_tipo_" + iNumLinha);
    ajax_field_id["pagoefectivo_" + iNumLinha] = new Array("hidden_field_label_pagoefectivo_", "hidden_field_data_pagoefectivo_" + iNumLinha);
    ajax_field_id["esmarcacion_" + iNumLinha] = new Array("hidden_field_label_esmarcacion_", "hidden_field_data_esmarcacion_" + iNumLinha);
    ajax_field_id["activo_" + iNumLinha] = new Array("hidden_field_label_activo_", "hidden_field_data_activo_" + iNumLinha);
    ajax_error_count["tipopagoid_" + iNumLinha] = "off";
    ajax_error_count["tipo_" + iNumLinha] = "off";
    ajax_error_count["pagoefectivo_" + iNumLinha] = "off";
    ajax_error_count["esmarcacion_" + iNumLinha] = "off";
    ajax_error_count["activo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tipopagoid_" + iNumLinha] = "on";
    ajax_read_only["tipo_" + iNumLinha] = "off";
    ajax_read_only["pagoefectivo_" + iNumLinha] = "off";
    ajax_read_only["esmarcacion_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["pagoefectivo_" + iNumLinha] = "on";
    ajax_read_only["esmarcacion_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["tipopagoid_" + iNumLinha] = null;
    ajax_error_list["tipo_" + iNumLinha] = null;
    ajax_error_list["pagoefectivo_" + iNumLinha] = null;
    ajax_error_list["esmarcacion_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "tipopagoid_": new Array(),
    "tipo_": new Array(),
    "pagoefectivo_": new Array(),
    "esmarcacion_": new Array(),
    "activo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tipopagoid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipopagoid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipopagoid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipopagoid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipopagoid_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["pagoefectivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pagoefectivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pagoefectivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pagoefectivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pagoefectivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["esmarcacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["esmarcacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["esmarcacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["esmarcacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["esmarcacion_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipopagoid_'])) ? $this->nmgp_cmp_readonly['tipopagoid_'] : 'on';
?>
    scAjaxFieldRead("tipopagoid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pagoefectivo_'])) ? $this->nmgp_cmp_readonly['pagoefectivo_'] : 'off';
?>
    scAjaxFieldRead("pagoefectivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['esmarcacion_'])) ? $this->nmgp_cmp_readonly['esmarcacion_'] : 'off';
?>
    scAjaxFieldRead("esmarcacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tipopagoid_" + iSeq, "on");
    scAjaxFieldRead("tipo_" + iSeq, "on");
    scAjaxFieldRead("pagoefectivo_" + iSeq, "on");
    scAjaxFieldRead("esmarcacion_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tipopagoid_" + iRow] || "on" == ajax_error_count["tipo_" + iRow] || "on" == ajax_error_count["pagoefectivo_" + iRow] || "on" == ajax_error_count["esmarcacion_" + iRow] || "on" == ajax_error_count["activo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipopagoid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pagoefectivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_esmarcacion_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tipopagoid_" + iRow] && "off" == ajax_error_count["tipo_" + iRow] && "off" == ajax_error_count["pagoefectivo_" + iRow] && "off" == ajax_error_count["esmarcacion_" + iRow] && "off" == ajax_error_count["activo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tipopagoid_" + iRow] = "off";
        ajax_error_count["tipo_" + iRow] = "off";
        ajax_error_count["pagoefectivo_" + iRow] = "off";
        ajax_error_count["esmarcacion_" + iRow] = "off";
      ...
      $("#hidden_field_data_tipopagoid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tipo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pagoefectivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_esmarcacion_" + iRow).removeClass("scFormErrorLine");
