<?php
@session_start() ;
$_SESSION['scriptcase']['tarifas_periodo']['sc_process_barr'] = true;
require_once('../tarifas_periodo/index.php');
unset($_SESSION['scriptcase']['tarifas_periodo']['sc_process_barr']);
$ExportCtrl = new tarifas_periodo_export_control;
$ExportCtrl->Export_barr();

class tarifas_periodo_export_control
{
