...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____tarifas_periodo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____tarifas_periodo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tarifas_periodo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['tarifas_periodo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tarifas_periodo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['tarifas_periodo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['tarifas_periodo']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['tarifas_periodo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['tarifas_periodo']['embutida_filho'] as $ind => $sc_init)
          {
