...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>seg_change_pswd/seg_change_pswd_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
else
{
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['link_info']['remove_border']) {
