  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aforo_liquidacionCR" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aforo_liquidacionCR_form();
	}
...
?>
  ...
  // ---------- Validate eventod
  function do_ajax_form_aforo_liquidacionCR_validate_eventod()
  {
  } // do_ajax_form_aforo_liquidacionCR_validate_eventod

  function do_ajax_form_aforo_liquidacionCR_validate_eventod_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_eventod_cb

  // ---------- Validate vehiculocorrecto
  function do_ajax_form_aforo_liquidacionCR_validate_vehiculocorrecto()
  {
    ...
    x_ajax_form_aforo_liquidacionCR_validate_vehiculocorrecto(var_vehiculocorrecto, var_script_case_init, do_ajax_form_aforo_liquidacionCR_validate_vehiculocorrecto_cb);
  } // do_ajax_form_aforo_liquidacionCR_validate_vehiculocorrecto

  function do_ajax_form_aforo_liquidacionCR_validate_vehiculocorrecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_vehiculocorrecto_cb

  // ---------- Validate pagoid_ana
  function do_ajax_form_aforo_liquidacionCR_validate_pagoid_ana()
  {
    var nomeCampo_pagoid_ana = "pagoid_ana";
    var var_pagoid_ana = scAjaxGetFieldSelect(nomeCampo_pagoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_validate_pagoid_ana(var_pagoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_validate_pagoid_ana_cb);
  } // do_ajax_form_aforo_liquidacionCR_validate_pagoid_ana

  function do_ajax_form_aforo_liquidacionCR_validate_pagoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_pagoid_ana_cb

  // ---------- Validate vehiculoid_ana
  function do_ajax_form_aforo_liquidacionCR_validate_vehiculoid_ana()
  {
    var nomeCampo_vehiculoid_ana = "vehiculoid_ana";
    var var_vehiculoid_ana = scAjaxGetFieldSelect(nomeCampo_vehiculoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_validate_vehiculoid_ana(var_vehiculoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_validate_vehiculoid_ana_cb);
  } // do_ajax_form_aforo_liquidacionCR_validate_vehiculoid_ana

  function do_ajax_form_aforo_liquidacionCR_validate_vehiculoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_vehiculoid_ana_cb

  // ---------- Validate excentoid
  function do_ajax_form_aforo_liquidacionCR_validate_excentoid()
  {
    var nomeCampo_excentoid = "excentoid";
    var var_excentoid = scAjaxGetFieldSelect(nomeCampo_excentoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_validate_excentoid(var_excentoid, var_script_case_init, do_ajax_form_aforo_liquidacionCR_validate_excentoid_cb);
  } // do_ajax_form_aforo_liquidacionCR_validate_excentoid

  function do_ajax_form_aforo_liquidacionCR_validate_excentoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_excentoid_cb

  // ---------- Validate numerotarjeta
  function do_ajax_form_aforo_liquidacionCR_validate_numerotarjeta()
  {
    var nomeCampo_numerotarjeta = "numerotarjeta";
    var var_numerotarjeta = scAjaxGetFieldText(nomeCampo_numerotarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_validate_numerotarjeta(var_numerotarjeta, var_script_case_init, do_ajax_form_aforo_liquidacionCR_validate_numerotarjeta_cb);
  } // do_ajax_form_aforo_liquidacionCR_validate_numerotarjeta

  function do_ajax_form_aforo_liquidacionCR_validate_numerotarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_numerotarjeta_cb

  // ---------- Validate observacion
  function do_ajax_form_aforo_liquidacionCR_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_aforo_liquidacionCR_validate_observacion_cb);
  } // do_ajax_form_aforo_liquidacionCR_validate_observacion

  function do_ajax_form_aforo_liquidacionCR_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_observacion_cb

  // ---------- Validate fld_ar_sct
  function do_ajax_form_aforo_liquidacionCR_validate_fld_ar_sct()
  {
    var nomeCampo_fld_ar_sct = "fld_ar_sct";
    var var_fld_ar_sct = scAjaxGetFieldRadio(nomeCampo_fld_ar_sct);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_validate_fld_ar_sct(var_fld_ar_sct, var_script_case_init, do_ajax_form_aforo_liquidacionCR_validate_fld_ar_sct_cb);
  } // do_ajax_form_aforo_liquidacionCR_validate_fld_ar_sct

  function do_ajax_form_aforo_liquidacionCR_validate_fld_ar_sct_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_validate_fld_ar_sct_cb

  // ---------- Event onchange pagoid_ana
  function do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange(var_pagoid_ana, var_excentoid, var_numerotarjeta, var_vehiculoid_ana, var_fld_ar_sct, var_script_case_init, do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange_cb);
  } // do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange

  function do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pagoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange_cb
  function do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionCR_event_pagoid_ana_onchange_cb_after_alert

  // ---------- Event onclick vehiculocorrecto
  function do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick(var_vehiculocorrecto, var_vehiculoid_ana, var_fld_ar_sct, var_pagoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick_cb);
  } // do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick

  function do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculocorrecto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick_cb
  function do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionCR_event_vehiculocorrecto_onclick_cb_after_alert

  // ---------- Event onchange vehiculoid_ana
  function do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange()
  {
    var var_pagoid_ana = scAjaxGetFieldSelect("pagoid_ana");
    var var_vehiculoid_ana = scAjaxGetFieldSelect("vehiculoid_ana");
    var var_fld_ar_sct = scAjaxGetFieldRadio("fld_ar_sct");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange(var_pagoid_ana, var_vehiculoid_ana, var_fld_ar_sct, var_script_case_init, do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange_cb);
  } // do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange

  function do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange_cb
  function do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionCR_event_vehiculoid_ana_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_aforo_liquidacionCR_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aforo_liquidacionCR_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_aforo_liquidacionCR_submit_form(var_eventod, var_vehiculocorrecto, var_pagoid_ana, var_vehiculoid_ana, var_excentoid, var_numerotarjeta, var_observacion, var_fld_ar_sct, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aforo_liquidacionCR_submit_form_cb);
  } // do_ajax_form_aforo_liquidacionCR_submit_form

  function do_ajax_form_aforo_liquidacionCR_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_submit_form_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_submit_form_cb
  function do_ajax_form_aforo_liquidacionCR_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aforo_liquidacionCR_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aforo_liquidacionCR_navigate_form()
  {
    perform_ajax_form_aforo_liquidacionCR_navigate_form();
  }

  function perform_ajax_form_aforo_liquidacionCR_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aforo_liquidacionCR_navigate_form(var_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aforo_liquidacionCR_navigate_form_cb);
  } // do_ajax_form_aforo_liquidacionCR_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aforo_liquidacionCR_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_navigate_form_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_navigate_form_cb
  function do_ajax_form_aforo_liquidacionCR_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_aforo_liquidacionCR_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aforo_liquidacionCR_navigate_form_cb_after_alert

  function sc_hide_form_aforo_liquidacionCR_form()
  {
