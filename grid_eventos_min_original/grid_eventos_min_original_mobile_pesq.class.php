...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fechaoperacion_cond" name="fechaoperacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaoperacion'), this, 'fechaoperacion')">
