...
class grid_eventos_min_original_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_eventos_min_original_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_eventos_min_original_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_eventos_min_original_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "FechaOperacion";$Nm_datas[] = "FechaTurno";$Nm_datas[] = "FechaEnvio";$Nm_datas[] = "FechaModificadoANA";$Nm_datas[] = "FechaMarcacionCR";$Nm_datas[] = "FechaDeteccionECT";$Nm_datas[] = "FechaDeteccionEAP";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['prim_vez'] == "N") 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_eventos_min_original').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_eventos_min_original').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_eventos_min_original').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Bitácora de eventos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_eventos_min_original/grid_eventos_min_original_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_eventos_min_original/grid_eventos_min_original_switch.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_eventos_min_original_ajax_search.js"></script>
 <script type="text/javascript" src="grid_eventos_min_original_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_eventos_min_original_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_eventos_min_original']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_eventos_min_original']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_pagoid#NMF#' + search_get_select('SC_pagoid') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Bitácora de eventos</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechaoperacion_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_dia']; 
          $fechaoperacion_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_mes']; 
          $fechaoperacion_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_ano']; 
          $fechaoperacion_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_dia']; 
          $fechaoperacion_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_mes']; 
          $fechaoperacion_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_ano']; 
          $fechaoperacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_cond']; 
          $casetaid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['casetaid']; 
          $casetaid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['casetaid_cond']; 
          $turnoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['turnoid']; 
          $turnoid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['turnoid_cond']; 
          $pagoid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['pagoid']; 
          $pagoid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['pagoid_cond']; 
          $carrilid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['carrilid']; 
          $carrilid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['carrilid_cond']; 
          $discrepancia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['discrepancia']; 
          $discrepancia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['discrepancia_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_display_discrepancia = ('bw' == $discrepancia_cond) ? $display_aberto : $display_fechado;
...
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br>
      <SELECT class="scFilterObjectOdd" id="SC_fechaoperacion_cond" name="fechaoperacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaoperacion'), this, 'fechaoperacion')">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_input_2_dia" name="fechaoperacion_input_2_dia" value="<?php echo NM_encode_input($fechaoperacion_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_input_2_mes" name="fechaoperacion_input_2_mes" value="<?php echo NM_encode_input($fechaoperacion_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaoperacion_input_2_ano" name="fechaoperacion_input_2_ano" value="<?php echo NM_encode_input($fechaoperacion_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['casetaid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['casetaid'][] = trim($rs->fields[0]);
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['turnoid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['turnoid'][] = trim($rs->fields[0]);
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_pagoid"  <?php echo $str_hide_pagoid?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['pagoid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['pagoid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[0]) . " - " . trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_pagoid">
      <SELECT class="scFilterObjectEven" id="SC_pagoid" name="pagoid"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $pagoid)
            {
                    $pagoid_sel = ($nm_opc_cod === $pagoid) ? "selected" : "";
            }
            else
            {
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_carrilid"  <?php echo $str_hide_carrilid?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['carrilid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['carrilid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_discrepancia"  <?php echo $str_hide_discrepancia?>> 
<?php
  if (!isset($discrepancia)) {$discrepancia = explode(";", $discrepancia);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['discrepancia'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['discrepancia'][] = "1";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><div class="sc switch">
<INPUT class="scFilterObjectEven" type="checkbox" id="SC_discrepancia" name="discrepancia[]" value="1##@@"  <?php if (in_array("1", $discrepancia))  { echo " checked" ;} ?>><span></span></div>
</TD>
</TR></TABLE>
 </TD>
...
?>
<?php
   if (is_file("grid_eventos_min_original_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['opc_psq'])
   {
...
<?php
    ...
    {
?>
       <iframe id="nmsc_iframe_grid_eventos_min_original" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_eventos_min_original" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_eventos_min_original" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_eventos_min_original" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_eventos_min_original_pesq"  name="nm_iframe_grid_eventos_min_original_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_eventos_min_original_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_eventos_min_original').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
 ...
 {
    $('#SC_fechaoperacion_dia').bind('change', function() {sc_grid_eventos_min_original_valida_dia(this)});
    $('#SC_fechaoperacion_input_2_dia').bind('change', function() {sc_grid_eventos_min_original_valida_dia(this)});
    $('#SC_fechaoperacion_input_2_mes').bind('change', function() {sc_grid_eventos_min_original_valida_mes(this)});
    $('#SC_fechaoperacion_mes').bind('change', function() {sc_grid_eventos_min_original_valida_mes(this)});
 }
 function sc_grid_eventos_min_original_valida_dia(obj)
 {
 ...
 function sc_grid_eventos_min_original_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "BackOffice_Acapulco/grid_eventos_min_original";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_eventos_min_original/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $fechaoperacion_cond, $fechaoperacion, $fechaoperacion_dia, $fechaoperacion_mes, $fechaoperacion_ano, $fechaoperacion_input_2_dia, $fechaoperacion_input_2_mes, $fechaoperacion_input_2_ano,
             $casetaid_cond, $casetaid,
             $turnoid_cond, $turnoid,
             $pagoid_cond, $pagoid,
             $carrilid_cond, $carrilid,
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'];
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['casetaid'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['turnoid'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($pagoid, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['pagoid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Tipo Pago : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = (is_string($carrilid)) ? strpos($carrilid, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $carrilid;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['carrilid'])) {
      ...
      if (is_array($discrepancia)) {
          foreach ($discrepancia as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['psq_check_ret']['discrepancia'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_dia'] = $fechaoperacion_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_mes'] = $fechaoperacion_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_ano'] = $fechaoperacion_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_dia'] = $fechaoperacion_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_mes'] = $fechaoperacion_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_ano'] = $fechaoperacion_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_cond'] = $fechaoperacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['casetaid'] = $casetaid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['casetaid_cond'] = $casetaid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['turnoid'] = $turnoid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['turnoid_cond'] = $turnoid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['pagoid'] = $pagoid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['pagoid_cond'] = $pagoid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['carrilid'] = $carrilid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['carrilid_cond'] = $carrilid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['discrepancia'] = $discrepancia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['discrepancia_cond'] = $discrepancia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'] = $Temp_Busca;
      }
 ...
 if($carrilid <>"" && $turnoid <>""){
	$check_sql = "Select min(PreLiquidado) From detalleturno where FechaOperacion = '".$fechaoperacion ."' and CasetaID  = ".$casetaid ." and CarrilID = ".$carrilid ." and TurnoID = ".$turnoid ;
}
	
elseif($carrilid =="" && $turnoid <>""){
	$check_sql = "Select min(PreLiquidado) From detalleturno where FechaOperacion = '".$fechaoperacion ."' and CasetaID  = ".$casetaid ." and TurnoID = ".$turnoid ;
	}
elseif($turnoid  == "" && $carrilid <>""){
	$check_sql = "Select min(PreLiquidado) From detalleturno where FechaOperacion = '".$fechaoperacion ."' and CasetaID  = ".$casetaid ." and CarrilID = ".$carrilid ;
	}else{
	$check_sql = "Select min(PreLiquidado) From detalleturno where FechaOperacion = '".$fechaoperacion ."' and CasetaID  = ".$casetaid ;
	}
...
$_SESSION['scriptcase']['grid_eventos_min_original']['contr_erro'] = 'off'; 
      ...
      if (isset($fechaoperacionXX[2]) && $fechaoperacionXX[2] != $fechaoperacion_diaSv)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_dia'] = $fechaoperacionXX[2]; 
      }
      if (isset($fechaoperacionXX[1]) && $fechaoperacionXX[1] != $fechaoperacion_mesSv)
      {
          $fechaoperacion_mes = $fechaoperacionXX[1]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_mes'] = $fechaoperacionXX[1]; 
      }
      if (isset($fechaoperacionXX[0]) && $fechaoperacionXX[0] != $fechaoperacion_anoSv)
      {
          $fechaoperacion_ano = $fechaoperacionXX[0]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_ano'] = $fechaoperacionXX[0]; 
      }
      ...
      if (isset($fechaoperacionXX[2]) && $fechaoperacionXX[2] != $fechaoperacion_input_2_diaSv)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_dia'] = $fechaoperacionXX[2]; 
      }
      if (isset($fechaoperacionXX[1]) && $fechaoperacionXX[1] != $fechaoperacion_input_2_mesSv)
      {
          $fechaoperacion_input_2_mes = $fechaoperacionXX[1]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_mes'] = $fechaoperacionXX[1]; 
      }
      if (isset($fechaoperacionXX[0]) && $fechaoperacionXX[0] != $fechaoperacion_input_2_anoSv)
      {
          $fechaoperacion_input_2_ano = $fechaoperacionXX[0]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2_ano'] = $fechaoperacionXX[0]; 
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['pagoid'] = $Conteudo;
      $Conteudo = $carrilid;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      $this->cmp_formatado['discrepancia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['discrepancia'];
      $this->cmp_formatado['discrepancia_input_2'] = $discrepancia_input_2;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'];
      }
      ...
      if ($fechaoperacion_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion'] = $val[0];
          ...
          if ($fechaoperacion_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']['fechaoperacion_input_2'] = $val[1];
      ...
      if (isset($pagoid))
      {
         $this->monta_condicao("PagoID", $pagoid_cond, $pagoid, "", "pagoid", "VARCHAR", false);
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eventos_min_original']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "pagoid" : return ('class="scFilterObjectEven"'); break;
