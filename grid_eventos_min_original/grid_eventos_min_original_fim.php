...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_eventos_min_original"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_eventos_min_original"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_min_original']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos_min_original']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_min_original']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos_min_original']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_eventos_min_original']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_eventos_min_original</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_min_original']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_eventos_min_original']['embutida_filho'] as $ind => $sc_init)
          {
