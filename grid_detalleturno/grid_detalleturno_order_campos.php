<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detalleturno']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detalleturno_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalleturno_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["turnoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["turnoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["turnoid"] : "Turno";
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["carrilid"] : "Carril";
   $tab_ger_campos['estatuscarril'] = "on";
   $tab_def_campos['estatuscarril'] = "EstatusCarril";
   $tab_labels["estatuscarril"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["estatuscarril"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["estatuscarril"] : "Estatus Carril";
   $tab_ger_campos['usuarioid'] = "on";
   $tab_def_campos['usuarioid'] = "UsuarioID";
   $tab_labels["usuarioid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["usuarioid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["usuarioid"] : "Usuario";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "HoraInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["horainicio"] : "Hora Inicio";
   $tab_ger_campos['fechafin'] = "on";
   $tab_def_campos['fechafin'] = "FechaFin";
   $tab_labels["fechafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["fechafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["fechafin"] : "Fecha Fin";
   $tab_ger_campos['horafin'] = "on";
   $tab_def_campos['horafin'] = "HoraFin";
   $tab_labels["horafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["horafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["horafin"] : "Hora Fin";
   $tab_ger_campos['administradorid'] = "on";
   $tab_def_campos['administradorid'] = "AdministradorID";
   $tab_labels["administradorid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["administradorid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["administradorid"] : "Administrador";
   $tab_ger_campos['encargadoturnoid_pre'] = "on";
   $tab_def_campos['encargadoturnoid_pre'] = "EncargadoTurnoID_Pre";
   $tab_labels["encargadoturnoid_pre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["encargadoturnoid_pre"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["encargadoturnoid_pre"] : "Encargado Turno PreLiquida";
   ...
   $tab_labels["preliquidar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["preliquidar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["preliquidar"] : "Preliquidar";
   ...
   $tab_labels["preliquidado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["preliquidado"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["preliquidado"] : "Preliquidar";
   ...
   $tab_labels["preliquidacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["preliquidacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["preliquidacion"] : "Pre Liquidación";
   ...
   $tab_labels["comparativo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["comparativo"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["comparativo"] : "Pre Liquidación";
   ...
   $tab_labels["bitacora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["bitacora"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['labels']["bitacora"] : "Bitacora";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalleturno_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalleturno']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
