...
<?php
    ...
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_detalleturno').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_detalleturno').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_detalleturno').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleturno']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Carril</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>_lib/css/peaje_module_ui.css?v=20260918-preliq-carril-grid2" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;">Preliquidacion Por Carril</div>
...
?>
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_admonbusqueda"  <?php echo $str_hide_admonbusqueda?>>
<?php
      $admonbusqueda_look = (is_string($admonbusqueda) ? substr($this->Db->qstr($admonbusqueda), 1, -1) : $admonbusqueda); 
      $nmgp_def_dados = "" ; 
   if (is_numeric($casetaid))
...
?>
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_encargadopreliquida"  <?php echo $str_hide_encargadopreliquida?>>
<?php
      $encargadopreliquida_look = (is_string($encargadopreliquida) ? substr($this->Db->qstr($encargadopreliquida), 1, -1) : $encargadopreliquida); 
      $nmgp_def_dados = "" ; 
   if (is_numeric($casetaid))
...
?>
   <span id="idAjaxSelect_encargadopreliquida">
      <SELECT class="scFilterObjectEven" id="SC_encargadopreliquida" name="encargadopreliquida" onChange="nm_submit_form();" size="1">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
<?php
    ...
    {
?>
       <iframe id="nmsc_iframe_grid_detalleturno" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="700px" name="nm_iframe_grid_detalleturno" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_detalleturno" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="700px" name="nm_iframe_grid_detalleturno" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_detalleturno_pesq"  name="nm_iframe_grid_detalleturno_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_detalleturno_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_detalleturno').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
...
$_SESSION['scriptcase']['grid_detalleturno']['contr_erro'] = 'off'; 
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "encargadopreliquida" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
