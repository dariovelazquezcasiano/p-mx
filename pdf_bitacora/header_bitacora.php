  ...
  //Configuracion de tabla
   ...
   function SetAligns($a){
    ...
    public function Dados_Header($titulo, $array_label, $array_widht){
		...
		$this->fecha=$titulo[2];
		$this->turno=$titulo[3];
		$this->carril=$titulo[4];
		$this->pago=$titulo[5];
		$this->discrepancia=$titulo[6];
...
function Header()
{
    ...
    $this->SetX(80);
    $this->SetFont('times','B',10);
    $this->Cell(0,6,"Turno: ".$this->turno,0,1,'L','');
	$this->Sety(19);
	$this->SetX(80);
	$this->Cell(0,6,"Carril: ".$this->carril,0,1,'L','');
	
	$this->Sety(15);
    $this->SetX(130);
    $this->SetFont('times','B',10);
    $this->Cell(0,6,"Tipo Pago: ".$this->pago,0,1,'L','');
	$this->Sety(19);
	$this->SetX(130);
	$this->Cell(0,6,"Discrepancia: ".$this->discrepancia,0,1,'L','');
