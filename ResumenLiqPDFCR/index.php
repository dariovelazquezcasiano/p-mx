<?php
   include_once('ResumenLiqPDFCR_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class ResumenLiqPDFCR_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "ResumenLiqPDFCR"; 
      $this->nm_nome_apl     = "Genera el Archivo PDF de Liquidacion CR"; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['ResumenLiqPDFCR']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['ResumenLiqPDFCR']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/ResumenLiqPDFCR';
      ...
      $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['actual_lang']) || $_SESSION['scriptcase']['ResumenLiqPDFCR']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['ResumenLiqPDFCR']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("ResumenLiqPDFCR_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["ResumenLiqPDFCR"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["ResumenLiqPDFCR"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "ResumenLiqPDFCR_erro.class.php"); 
      $this->Erro = new ResumenLiqPDFCR_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('ResumenLiqPDFCR'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao']) && $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_perfil']) && $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['embutida_init']) 
      {
          if (!isset($_SESSION['FolioCierre'])) 
          {
              $this->nm_falta_var .= "FolioCierre; ";
          }
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_conexao'], $this->root . $this->path_prod, 'BackOffice_Acapulco', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['ResumenLiqPDFCR']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new ResumenLiqPDFCR_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ResumenLiqPDFCR']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['ResumenLiqPDFCR']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['ResumenLiqPDFCR']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['ResumenLiqPDFCR'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['ResumenLiqPDFCR']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['ResumenLiqPDFCR']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('ResumenLiqPDFCR') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['ResumenLiqPDFCR']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['ResumenLiqPDFCR']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['ResumenLiqPDFCR']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['ResumenLiqPDFCR']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "ResumenLiqPDFCR_erro.class.php"); 
      $this->Erro      = new ResumenLiqPDFCR_erro();
...
//
      ...
      $_SESSION['scriptcase']['ResumenLiqPDFCR']['contr_erro'] = 'on';
if (!isset($_SESSION['Fecha'])) {$_SESSION['Fecha'] = "";}
if (!isset($this->sc_temp_Fecha)) {$this->sc_temp_Fecha = (isset($_SESSION['Fecha'])) ? $_SESSION['Fecha'] : "";}
if (!isset($_SESSION['FolioCierre'])) {$_SESSION['FolioCierre'] = "";}
if (!isset($this->sc_temp_FolioCierre)) {$this->sc_temp_FolioCierre = (isset($_SESSION['FolioCierre'])) ? $_SESSION['FolioCierre'] : "";}
...
EOD;
$tblpre = $this->LiquidacionCR($identificador, $FechaOperacion);
...
if (isset($this->sc_temp_FolioCierre)) {$_SESSION['FolioCierre'] = $this->sc_temp_FolioCierre;}
if (isset($this->sc_temp_Fecha)) {$_SESSION['Fecha'] = $this->sc_temp_Fecha;}
$_SESSION['scriptcase']['ResumenLiqPDFCR']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
function LiquidacionCR($identificador,$FechaOperacion){
$_SESSION['scriptcase']['ResumenLiqPDFCR']['contr_erro'] = 'on';
...
if (isset($rs[0][0]))     
{
	...
	$OperacionID = $rs[0][29];
	$Operacion = $rs[0][30];
	$ingreso_ELU_PRE = $rs[0][31];
	$ingreso_ELU_ANA = $rs[0][32];
} else {	
}
...
$leyenda = "";	
	...
	$PorEntregarPre = $entregadoCajero-$fld_faltante;
...
$nombrearchivo = "Liq_".$identificador;
...
$MontoMarcado =0;
	...
	$check_aforo = "SELECT Discrepancia, MontoDisc FROM discrepancias WHERE FolioCierre = '$identificador' and Fecha = '$FechaOperacion' ";
...
$check_aforo = "SELECT SUM(Importe_CR + TarifaEE_CR), sum(cantidadveh) FROM aforo_preliq WHERE FechaOperacion = '$FechaOperacion' and FolioCierre = '".$identificador."' AND $PagoEfectivo[0] ";	  
...
$check_aforo = "SELECT SUM(Importe_ANA + TarifaEE_ANA) , sum(CantidadVeh) FROM aforo_liq WHERE FechaOperacion = '$FechaOperacion' and FolioCierre = '".$identificador."' AND $PagoEfectivo[1] ";
...
$check_aforo = "SELECT SUM(Importe_ANA + TarifaEE_ANA) , sum(cantidadveh) FROM aforo_liq WHERE FechaOperacion = '$FechaOperacion' and FolioCierre = '".$identificador."' and PagoID = 'GE' ";	   
...
$cantidadMarcadoANA = $cantidadMarcado-$cantidadMarcadoGE;	
	...
	$TotalCajeroCR = $Operacion + $entregadoCajero; 
...
;
   ...
   while(!$rs->EOF)
		{
		$style = ''; 
		$check_aforo = "SELECT PagoID,SUM(Importe_CR + TarifaEE_CR), sum(CantidadVeh) FROM aforo_preliq WHERE FechaOperacion = '$FechaOperacion' and FolioCierre = '".$identificador."'  AND PagoID = '".$rs->fields[0]."'" ;
	...
	$check_aforo = "SELECT PagoID,SUM(Importe_ANA + TarifaEE_ANA), sum(CantidadVeh) FROM aforo_liq WHERE FechaOperacion = '$FechaOperacion' and FolioCierre = '".$identificador."'  AND PagoID = '". $rs->fields[0]."'" ;
...
$codigo .= '
		...
		<td width="10%" align="right">'.$FoliosMarcado.'</td>
		<td width="10%" align="right">'.number_format(($TotalMarcado+$montoTAG-$TotalCajero),2).'</td>
		<td width="10%" align="right">'.($FoliosEfectivo-$FoliosMarcado).'</td>
		</tr>
		';
$style = 'style= "background-color:#dfdfdf; font-weight: bold";';
...
$check_aforo = "SELECT 'CR',PagoID,SUM(Importe_ANA + TarifaEE_ANA), sum(cantidadveh) FROM aforo_liq WHERE FechaOperacion = '$FechaOperacion' and FolioCierre = '".$identificador."' and PagoID = 'DE' ";	   
	...
	if (isset($dataset[0][0]))     
	{
      ...
      $nm_select = "SELECT Observacion FROM observacionesana where FolioCierre = '$identificador'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $Dataset = array();
      $dataset = array();
	...
	if (isset($dataset[0][0]))     
	{
		$observacionana = $dataset[0][0];
	}
	
$faltanteacumulado = $PorEntregarPre;
$diferenciaCR_Efe= 0;
$faltanteliquidado = 0;	
$SobranteL=$FaltanteL=0;
$depositar = 0;
	$faltanteliquidado =  ($Operacion + $entregadoCajero) - ($MontoMarcadoANA + $ingreso_ELU_ANA);
	
	
$depositar = $faltanteliquidado > 0 ? $MontoMarcadoANA + $faltanteliquidado + $ingreso_ELU_ANA : $MontoMarcadoANA + $ingreso_ELU_ANA;
	

if($fld_faltante>=0){
	if($faltanteliquidado>=0){
		$faltanteacumulado = $faltanteacumulado + $faltanteliquidado;
		}else{
		if($faltanteacumulado>=0){
			$faltanteacumulado =  $faltanteacumulado > $faltanteliquidado ?  $faltanteliquidado + $faltanteacumulado :  $faltanteacumulado + $faltanteliquidado;
			}else{
			$faltanteacumulado =  $faltanteacumulado > $faltanteliquidado ?  $faltanteliquidado - $faltanteacumulado :  $faltanteacumulado - $faltanteliquidado;
			}
	...
	if($faltanteliquidado>=0){
		$faltanteacumulado =  -$fld_faltante > $faltanteliquidado ? -$fld_faltante - $faltanteliquidado : $faltanteliquidado + $fld_faltante;
		}else{
		$faltanteacumulado = - $fld_faltante + $faltanteliquidado;	
		}
}
...
if($faltanteacumulado>=0){
	$SobranteL = $faltanteacumulado;
}else{
	$FaltanteL = $faltanteacumulado*(-1);	
}	
$tbl = '
	<table class = "roundedCorners" cellpadding="5" cellspacing="2">
	<tr>
		<th style="background-color:#FFFFFF";color:#0000FF; colspan="5" align="center"><b>LIQUIDACIÓN DE CAJERO-RECEPTOR<br>Tránsito Vehicular</b>
		</th>
	</tr>
</table>
...
<table class = "roundedCorners" cellpadding="2" cellspacing="0">
	<tr>
		<th style="background-color:#FFFF00";color:#0000FF; colspan="7"; align="center"><b>Dictamen de Liquidación de Cajero Receptor</b>
		</th>
	</tr>
	...
	<tr>
		...
		<td width="10%" align="right">'.$ingreso_ELU_PRE.'</td>
		<td width="10%" align="right">0</td>
		<td width="10%" align="right"><b>'.$ingreso_ELU_ANA.'</b></td>
		<td width="10%" align="right"><b>0</b></td>
		<td width="10%" align="right">'.($ingreso_ELU_ANA - $ingreso_ELU_PRE).'</td>
		<td width="10%" align="right">0</td>
	</tr>
	<tr>
		<td width="100%"> </td>
	...
	<tr style= "background-color:#dfdfdf; font-weight: bold"; >
		...
		<td width="10%" align="right">Preliquidacion:</td>
		<td width="10%" align="right">$'.number_format($PorEntregarPre,2).'</td>
		<td width="10%" align="right">Liquidacion:</td>
		<td width="10%" align="right">$'.number_format($faltanteliquidado,2).'</td>
		<td width="10%" align="right">Desviación:</td>
		<td width="10%" align="right">$'.number_format($faltanteacumulado,2).'</td>
		</tr>
	<tr>
		<td width="100%"> </td>
	</tr>
...
<table class = "estilo1" cellpadding="1" cellspacing="0">
	...
	<tr  align="right">
		...
		<td style= "border-bottom: 0.5px solid Black; border-right: 0.5px solid Black"><b>'.$this->diferencia($fld_folio_fincr,$fld_folio_inicr).'</b></td>
	...
	<tr align="right">
		...
		<td style="border-bottom: 0.5px solid Black; border-right: 0.5px solid Black">'.($this->diferencia($fld_folio_fincr,$fld_folio_inicr) - ($fld_ccant_mxn + $fld_ccant_usd)) .'</td>
	...
	<tr align="right">
		...
		<td style="background-color:#FFFF00; border-right: 0.5px solid Black"><b>'.($this->diferencia($fld_folio_fincr,$fld_folio_inicr) - ($fld_ccant_mxn + $fld_ccant_usd)).'</b></td>
...
<table class = "estilo1" cellpadding="1" cellspacing="0">
	...
	<tr>
		...
		<td width="90%" style= "border-bottom: 0.25px solid Black">'.$observacionana.'</td>
	</tr>
		<tr>
		<td ></td>
	</tr>
	...
	<tr>
		<td width="5%"></td>
		<td width="25%" align="center"><br><br><br><br></td>
		<td width="10%" align="right"></td>
...
function ComparativoCR($identificador,$FechaOperacion){
$_SESSION['scriptcase']['ResumenLiqPDFCR']['contr_erro'] = 'on';
  
	$check_sql = "SELECT TurnoID, CasetaID, TramoID, Cuerpo, UsuarioID, CarrilID, FechaOperacion, FechaTurno, HoraInicio, FechaFin, HoraFin, OperacionID, FolioInicialCR, FolioFinalCR, EncargadoTurnoID_Pre , FolioInicialEAP, FolioFinalEAP, OperacionID
FROM detalleturno WHERE FolioCierre = '".$identificador."';";
...
;
	...
	while(!$rs->EOF){
		if($categoria <> $rs->fields[0]){
			if($tipospago <> ""){
				...
				$tipospago .= ") AND" ; 
				$fila_a= $this->saca_aforo($tipospago, "Total" , " FechaOperacion = '$FechaOperacion' and FolioCierre = '$identificador' ");
		...
		$fila_a = $this->saca_aforo("PagoID = '".$rs->fields[1]."' AND", $rs->fields[1], " FechaOperacion = '$FechaOperacion' and FolioCierre = '$identificador' ");
		$codigo_html .= $fila_a[0];
	...
	$tipospago = substr($tipospago,0,-3);	
	$tipospago .= ")";
	$fila_a= $this->saca_aforo($tipospago, "Total" , " AND FechaOperacion = '$FechaOperacion' and FolioCierre = '$identificador' ");
	$codigo_html .= $fila_a[0];
    $rs->Close();
}
...
<table class = "roundedCorners" cellpadding="2" cellspacing="0">
	<tr>
		<th style="background-color:#FFFFFF";color:#0000FF; colspan="5" align="center"><b>REPORTE COMPARATIVO VERIFICADO DE AFORO E INGRESO POR CAJERO-RECEPTOR<br>LIQUIDACION DE TRANSITO VEHICULAR</b>
		</th>
	</tr>
</table>
...
$check_sql = "SELECT TipoPagoID,Tipo FROM tipopago WHERE EsMarcacion = 1 and PagoEfectivo = 1 order by Orden";
...
$EEA_i=0;
$EEC_i=0;
$check_sql = "SELECT VehiculoID_ANA, ClaseVehiculo_ANA, SUBSTR(ClaseVehiculo_ANA,1,1), SUBSTR(VehiculoID_ANA,4,1), CantidadEje_ANA,count(*), SUM(Importe_ANA), SUM(CantidadEje_ANA), SUM(TarifaEE_ANA), PagoID FROM aforo_liq 
WHERE VehiculoID_ANA<>VehiculoID_CR AND $sql_where
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_ResumenLiqPDFCR($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['ResumenLiqPDFCR']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "ResumenLiqPDFCR") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
               $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
           }
       }
   }
   ...
   if (isset($_POST["FolioCierre"])) 
   {
       $_SESSION["FolioCierre"] = $_POST["FolioCierre"];
       nm_limpa_str_ResumenLiqPDFCR($_SESSION["FolioCierre"]);
   }
   if (!isset($_POST["FolioCierre"]) && isset($_POST["foliocierre"])) 
   {
       $_SESSION["FolioCierre"] = $_POST["foliocierre"];
       nm_limpa_str_ResumenLiqPDFCR($_SESSION["FolioCierre"]);
   }
   if (isset($_GET["FolioCierre"])) 
   {
       $_SESSION["FolioCierre"] = $_GET["FolioCierre"];
       nm_limpa_str_ResumenLiqPDFCR($_SESSION["FolioCierre"]);
   }
   if (!isset($_GET["FolioCierre"]) && isset($_GET["foliocierre"])) 
   {
       $_SESSION["FolioCierre"] = $_GET["foliocierre"];
       nm_limpa_str_ResumenLiqPDFCR($_SESSION["FolioCierre"]);
   }
   ...
   if (!isset($_POST["Fecha"]) && isset($_POST["fecha"])) 
   {
       $_SESSION["Fecha"] = $_POST["fecha"];
       nm_limpa_str_ResumenLiqPDFCR($_SESSION["Fecha"]);
   }
   ...
   if (!isset($_GET["Fecha"]) && isset($_GET["fecha"])) 
   {
       $_SESSION["Fecha"] = $_GET["fecha"];
       nm_limpa_str_ResumenLiqPDFCR($_SESSION["Fecha"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "ResumenLiqPDFCR";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'ResumenLiqPDFCR' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('ResumenLiqPDFCR' == $sReferer || 'ResumenLiqPDFCR_' == substr($sReferer, 0, 16))
       {
           $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['lang'];
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'ResumenLiqPDFCR')
   {
       $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/ResumenLiqPDFCR_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_ResumenLiqPDFCR($cadapar[1]);
       ...
       if (!isset($FolioCierre) && isset($foliocierre)) 
       {
           $_SESSION["FolioCierre"] = $foliocierre;
       }
       if (isset($FolioCierre)) 
       {
           $_SESSION['FolioCierre'] = $FolioCierre;
           nm_limpa_str_ResumenLiqPDFCR($_SESSION["FolioCierre"]);
       }
       if (!isset($Fecha) && isset($fecha)) 
       {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['ResumenLiqPDFCR'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['opc_psq'] && !isset($_SESSION['scriptcase']['ResumenLiqPDFCR']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ResumenLiqPDFCR']) || $_SESSION['scriptcase']['sc_apl_seg']['ResumenLiqPDFCR'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['ResumenLiqPDFCR']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("ResumenLiqPDFCR", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
   ...
   $contr_ResumenLiqPDFCR = new ResumenLiqPDFCR_apl();
   $contr_ResumenLiqPDFCR->controle();
//
   function nm_limpa_str_ResumenLiqPDFCR(&$str)
   {
   }
?>
