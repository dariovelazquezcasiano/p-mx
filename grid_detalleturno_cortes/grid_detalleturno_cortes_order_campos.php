...
<?php
   ...
   $Ord_Cmp = new grid_detalleturno_cortes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalleturno_cortes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["casetaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["casetaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["casetaid"] : "Caseta";
   $tab_ger_campos['turnoid'] = "on";
   $tab_def_campos['turnoid'] = "TurnoID";
   $tab_labels["turnoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["turnoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["turnoid"] : "Turno";
   $tab_ger_campos['carrilid'] = "on";
   $tab_def_campos['carrilid'] = "CarrilID";
   $tab_labels["carrilid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["carrilid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["carrilid"] : "Carril";
   $tab_ger_campos['fechaoperacion'] = "on";
   $tab_def_campos['fechaoperacion'] = "FechaOperacion";
   $tab_labels["fechaoperacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["fechaoperacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["fechaoperacion"] : "Fecha Operacion";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "HoraInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["horainicio"] : "Hora Inicio";
   $tab_ger_campos['fechafin'] = "on";
   $tab_def_campos['fechafin'] = "FechaFin";
   $tab_labels["fechafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["fechafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["fechafin"] : "Fecha Fin";
   $tab_ger_campos['horafin'] = "on";
   $tab_def_campos['horafin'] = "HoraFin";
   $tab_labels["horafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["horafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["horafin"] : "Hora Fin";
   $tab_ger_campos['liga'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['liga'] = "liga";
   }
   else
   {
       $tab_def_campos['liga'] = "";
   }
   $tab_labels["liga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["liga"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['labels']["liga"] : "Ver";
   $tab_ger_campos['liga'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalleturno_cortes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalleturno_cortes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
