  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_alarma_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate alarmaid
  function do_ajax_form_alarma_mob_validate_alarmaid()
  {
    var nomeCampo_alarmaid = "alarmaid";
    var var_alarmaid = scAjaxGetFieldText(nomeCampo_alarmaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alarma_mob_validate_alarmaid(var_alarmaid, var_script_case_init, do_ajax_form_alarma_mob_validate_alarmaid_cb);
  } // do_ajax_form_alarma_mob_validate_alarmaid

  function do_ajax_form_alarma_mob_validate_alarmaid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alarmaid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alarma_mob_validate_alarmaid_cb

  // ---------- Validate tipoid
  function do_ajax_form_alarma_mob_validate_tipoid()
  {
    var nomeCampo_tipoid = "tipoid";
    var var_tipoid = scAjaxGetFieldText(nomeCampo_tipoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alarma_mob_validate_tipoid(var_tipoid, var_script_case_init, do_ajax_form_alarma_mob_validate_tipoid_cb);
  } // do_ajax_form_alarma_mob_validate_tipoid

  function do_ajax_form_alarma_mob_validate_tipoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipoid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alarma_mob_validate_tipoid_cb

  // ---------- Validate descripcion
  function do_ajax_form_alarma_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alarma_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_alarma_mob_validate_descripcion_cb);
  } // do_ajax_form_alarma_mob_validate_descripcion

  function do_ajax_form_alarma_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alarma_mob_validate_descripcion_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_alarma_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_alarma_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_alarmaid = scAjaxGetFieldText("alarmaid");
    var var_tipoid = scAjaxGetFieldText("tipoid");
    ...
    scAjaxProcOn();
    x_ajax_form_alarma_mob_submit_form(var_alarmaid, var_tipoid, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_alarma_mob_submit_form_cb);
  } // do_ajax_form_alarma_mob_submit_form

  function do_ajax_form_alarma_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("alarmaid");
      scAjaxHideErrorDisplay("tipoid");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_alarma_mob_submit_form_cb_after_alert);
  } // do_ajax_form_alarma_mob_submit_form_cb
  function do_ajax_form_alarma_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_alarma_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_alarma_mob_navigate_form()
  {
    perform_ajax_form_alarma_mob_navigate_form();
  }

  function perform_ajax_form_alarma_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipoid");
    scAjaxHideErrorDisplay("descripcion");
    var var_alarmaid = document.F2.alarmaid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_alarma_mob_navigate_form(var_alarmaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_alarma_mob_navigate_form_cb);
  } // do_ajax_form_alarma_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_alarma_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_alarma_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.alarmaid.value = scAjaxGetKeyValue("alarmaid");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_alarma_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_alarma_mob_navigate_form_cb
  function do_ajax_form_alarma_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_alarma_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_alarma_mob_navigate_form_cb_after_alert

  function sc_hide_form_alarma_mob_form()
  {
  ...
  ajax_field_list[0] = "alarmaid";
  ajax_field_list[1] = "tipoid";
  ...
  var ajax_error_list = {
    "alarmaid": {"label": "Alarma ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipoid": {"label": "Tipo ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["alarmaid"][1] = "alarmaid";
  ajax_field_mult["tipoid"][1] = "tipoid";
  ajax_field_mult["descripcion"][1] = "descripcion";

  var ajax_field_id = {
    "alarmaid": new Array("hidden_field_label_alarmaid", "hidden_field_data_alarmaid"),
    "tipoid": new Array("hidden_field_label_tipoid", "hidden_field_data_tipoid"),
