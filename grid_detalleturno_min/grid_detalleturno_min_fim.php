...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_min"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BackOffice_Acapulco_____grid_detalleturno_min"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_detalleturno_min']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_detalleturno_min']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_min']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_min']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_min']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleturno_min']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_min']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleturno_min</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_min']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleturno_min']['embutida_filho'] as $ind => $sc_init)
          {
