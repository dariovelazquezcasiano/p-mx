  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_menu_pisal_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate formato
  function do_ajax_menu_pisal_mob_validate_formato()
  {
    var nomeCampo_formato = "formato";
    var var_formato = scAjaxGetFieldSelect(nomeCampo_formato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_pisal_mob_validate_formato(var_formato, var_script_case_init, do_ajax_menu_pisal_mob_validate_formato_cb);
  } // do_ajax_menu_pisal_mob_validate_formato

  function do_ajax_menu_pisal_mob_validate_formato_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_pisal_mob_validate_formato_cb

  // ---------- Validate caseta
  function do_ajax_menu_pisal_mob_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    var var_caseta = scAjaxGetFieldSelect(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_pisal_mob_validate_caseta(var_caseta, var_script_case_init, do_ajax_menu_pisal_mob_validate_caseta_cb);
  } // do_ajax_menu_pisal_mob_validate_caseta

  function do_ajax_menu_pisal_mob_validate_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_pisal_mob_validate_caseta_cb

  // ---------- Validate fecha
  function do_ajax_menu_pisal_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_menu_pisal_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_menu_pisal_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_menu_pisal_mob_validate_fecha

  function do_ajax_menu_pisal_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_pisal_mob_validate_fecha_cb

  // ---------- Validate opcion
  function do_ajax_menu_pisal_mob_validate_opcion()
  {
    var nomeCampo_opcion = "opcion";
    var var_opcion = scAjaxGetFieldSelect(nomeCampo_opcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_menu_pisal_mob_validate_opcion(var_opcion, var_script_case_init, do_ajax_menu_pisal_mob_validate_opcion_cb);
  } // do_ajax_menu_pisal_mob_validate_opcion

  function do_ajax_menu_pisal_mob_validate_opcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opcion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_menu_pisal_mob_validate_opcion_cb

  // ---------- Event onchange caseta
  function do_ajax_menu_pisal_mob_event_caseta_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_menu_pisal_mob_event_caseta_onchange(var_script_case_init, do_ajax_menu_pisal_mob_event_caseta_onchange_cb);
  } // do_ajax_menu_pisal_mob_event_caseta_onchange

  function do_ajax_menu_pisal_mob_event_caseta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "caseta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_menu_pisal_mob_event_caseta_onchange_cb_after_alert);
  } // do_ajax_menu_pisal_mob_event_caseta_onchange_cb
  function do_ajax_menu_pisal_mob_event_caseta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_menu_pisal_mob_event_caseta_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_menu_pisal_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_menu_pisal_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_menu_pisal_mob_submit_form(var_formato, var_caseta, var_fecha, var_opcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_menu_pisal_mob_submit_form_cb);
  } // do_ajax_menu_pisal_mob_submit_form

  function do_ajax_menu_pisal_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_menu_pisal_mob_submit_form_cb_after_alert);
  } // do_ajax_menu_pisal_mob_submit_form_cb
  function do_ajax_menu_pisal_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_menu_pisal_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_menu_pisal_mob_navigate_form()
  {
    perform_ajax_menu_pisal_mob_navigate_form();
  }

  function perform_ajax_menu_pisal_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_menu_pisal_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['menu_pisal_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_menu_pisal_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_menu_pisal_mob_navigate_form_cb_after_alert);
  } // do_ajax_menu_pisal_mob_navigate_form_cb
  function do_ajax_menu_pisal_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_menu_pisal_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_menu_pisal_mob_navigate_form_cb_after_alert

  function sc_hide_menu_pisal_mob_form()
  {
