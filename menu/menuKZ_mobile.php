...
<html>
    <head>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menuKZ"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menuKZ"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menuKZ_menuData["data"]) && is_array($menuKZ_menuData["data"]) && !empty($menuKZ_menuData["data"]))
    {
        foreach($menuKZ_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($menuKZ_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
