<?php
@session_start() ;
$_SESSION['scriptcase']['grid_trafico']['sc_process_barr'] = true;
require_once('../grid_trafico/index.php');
unset($_SESSION['scriptcase']['grid_trafico']['sc_process_barr']);
$ExportCtrl = new grid_trafico_export_control;
$ExportCtrl->Export_barr();

class grid_trafico_export_control
{
