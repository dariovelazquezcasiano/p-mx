  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_excentos" == sTestField)
        {
...
?>
  ...
  // ---------- Validate casetaid
  function do_ajax_form_excentos_validate_casetaid()
  {
    var nomeCampo_casetaid = "casetaid";
    var var_casetaid = scAjaxGetFieldSelect(nomeCampo_casetaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_validate_casetaid(var_casetaid, var_script_case_init, do_ajax_form_excentos_validate_casetaid_cb);
  } // do_ajax_form_excentos_validate_casetaid

  function do_ajax_form_excentos_validate_casetaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_validate_casetaid_cb

  // ---------- Validate excentoid
  function do_ajax_form_excentos_validate_excentoid()
  {
    var nomeCampo_excentoid = "excentoid";
    var var_excentoid = scAjaxGetFieldHidden(nomeCampo_excentoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_validate_excentoid(var_excentoid, var_script_case_init, do_ajax_form_excentos_validate_excentoid_cb);
  } // do_ajax_form_excentos_validate_excentoid

  function do_ajax_form_excentos_validate_excentoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_validate_excentoid_cb

  // ---------- Validate dependencia
  function do_ajax_form_excentos_validate_dependencia()
  {
    var nomeCampo_dependencia = "dependencia";
    var var_dependencia = scAjaxGetFieldText(nomeCampo_dependencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_validate_dependencia(var_dependencia, var_script_case_init, do_ajax_form_excentos_validate_dependencia_cb);
  } // do_ajax_form_excentos_validate_dependencia

  function do_ajax_form_excentos_validate_dependencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_validate_dependencia_cb

  // ---------- Validate esactivo
  function do_ajax_form_excentos_validate_esactivo()
  {
    var nomeCampo_esactivo = "esactivo";
    var var_esactivo = scAjaxGetFieldSelect(nomeCampo_esactivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_validate_esactivo(var_esactivo, var_script_case_init, do_ajax_form_excentos_validate_esactivo_cb);
  } // do_ajax_form_excentos_validate_esactivo

  function do_ajax_form_excentos_validate_esactivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_validate_esactivo_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_excentos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_excentos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_excentos_submit_form(var_casetaid, var_excentoid, var_dependencia, var_esactivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_excentos_submit_form_cb);
  } // do_ajax_form_excentos_submit_form

  function do_ajax_form_excentos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_excentos_submit_form_cb_after_alert);
  } // do_ajax_form_excentos_submit_form_cb
  function do_ajax_form_excentos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_excentos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_excentos_navigate_form()
  {
    perform_ajax_form_excentos_navigate_form();
  }

  function perform_ajax_form_excentos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_excentos_navigate_form(var_excentoid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_excentos_navigate_form_cb);
  } // do_ajax_form_excentos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_excentos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_excentos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_excentos_navigate_form_cb_after_alert);
  } // do_ajax_form_excentos_navigate_form_cb
  function do_ajax_form_excentos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_excentos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_excentos_navigate_form_cb_after_alert

  function sc_hide_form_excentos_form()
  {
