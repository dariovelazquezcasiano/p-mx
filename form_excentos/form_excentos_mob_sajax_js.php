  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_excentos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_excentos_mob_form();
	}
...
?>
  ...
  // ---------- Validate casetaid
  function do_ajax_form_excentos_mob_validate_casetaid()
  {
    var nomeCampo_casetaid = "casetaid";
    var var_casetaid = scAjaxGetFieldSelect(nomeCampo_casetaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_mob_validate_casetaid(var_casetaid, var_script_case_init, do_ajax_form_excentos_mob_validate_casetaid_cb);
  } // do_ajax_form_excentos_mob_validate_casetaid

  function do_ajax_form_excentos_mob_validate_casetaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_mob_validate_casetaid_cb

  // ---------- Validate excentoid
  function do_ajax_form_excentos_mob_validate_excentoid()
  {
    var nomeCampo_excentoid = "excentoid";
    var var_excentoid = scAjaxGetFieldHidden(nomeCampo_excentoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_mob_validate_excentoid(var_excentoid, var_script_case_init, do_ajax_form_excentos_mob_validate_excentoid_cb);
  } // do_ajax_form_excentos_mob_validate_excentoid

  function do_ajax_form_excentos_mob_validate_excentoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_mob_validate_excentoid_cb

  // ---------- Validate dependencia
  function do_ajax_form_excentos_mob_validate_dependencia()
  {
    var nomeCampo_dependencia = "dependencia";
    var var_dependencia = scAjaxGetFieldText(nomeCampo_dependencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_mob_validate_dependencia(var_dependencia, var_script_case_init, do_ajax_form_excentos_mob_validate_dependencia_cb);
  } // do_ajax_form_excentos_mob_validate_dependencia

  function do_ajax_form_excentos_mob_validate_dependencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dependencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_mob_validate_dependencia_cb

  // ---------- Validate esactivo
  function do_ajax_form_excentos_mob_validate_esactivo()
  {
    var nomeCampo_esactivo = "esactivo";
    var var_esactivo = scAjaxGetFieldSelect(nomeCampo_esactivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_excentos_mob_validate_esactivo(var_esactivo, var_script_case_init, do_ajax_form_excentos_mob_validate_esactivo_cb);
  } // do_ajax_form_excentos_mob_validate_esactivo

  function do_ajax_form_excentos_mob_validate_esactivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esactivo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_excentos_mob_validate_esactivo_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_excentos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_excentos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_casetaid = scAjaxGetFieldSelect("casetaid");
    var var_excentoid = scAjaxGetFieldHidden("excentoid");
    var var_dependencia = scAjaxGetFieldText("dependencia");
    var var_esactivo = scAjaxGetFieldSelect("esactivo");
    ...
    scAjaxProcOn();
    x_ajax_form_excentos_mob_submit_form(var_casetaid, var_excentoid, var_dependencia, var_esactivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_excentos_mob_submit_form_cb);
  } // do_ajax_form_excentos_mob_submit_form

  function do_ajax_form_excentos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("dependencia");
      scAjaxHideErrorDisplay("esactivo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_excentos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_excentos_mob_submit_form_cb
  function do_ajax_form_excentos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_excentos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_excentos_mob_navigate_form()
  {
    perform_ajax_form_excentos_mob_navigate_form();
  }

  function perform_ajax_form_excentos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("dependencia");
    scAjaxHideErrorDisplay("esactivo");
    var var_excentoid = document.F2.excentoid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_excentos_mob_navigate_form(var_excentoid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_excentos_mob_navigate_form_cb);
  } // do_ajax_form_excentos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_excentos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_excentos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.excentoid.value = scAjaxGetKeyValue("excentoid");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_excentos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_excentos_mob_navigate_form_cb
  function do_ajax_form_excentos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_excentos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_excentos_mob_navigate_form_cb_after_alert

  function sc_hide_form_excentos_mob_form()
  {
  ...
  ajax_field_list[2] = "dependencia";
  ajax_field_list[3] = "esactivo";
  ...
  var ajax_error_list = {
    ...
    "excentoid": {"label": "Excento ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dependencia": {"label": "Dependencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esactivo": {"label": "Activo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["dependencia"][1] = "dependencia";
  ajax_field_mult["esactivo"][1] = "esactivo";
  ...
  var ajax_field_id = {
    ...
    "dependencia": new Array("hidden_field_label_dependencia", "hidden_field_data_dependencia"),
    "esactivo": new Array("hidden_field_label_esactivo", "hidden_field_data_esactivo")
  };
