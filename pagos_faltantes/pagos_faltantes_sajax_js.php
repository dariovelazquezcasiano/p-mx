  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pagos_faltantes" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_pagos_faltantes_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_pagos_faltantes_validate_id__cb);
  } // do_ajax_pagos_faltantes_validate_id_

  function do_ajax_pagos_faltantes_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_validate_id__cb

  // ---------- Validate fecha_
  function do_ajax_pagos_faltantes_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_pagos_faltantes_validate_fecha__cb);
  } // do_ajax_pagos_faltantes_validate_fecha_

  function do_ajax_pagos_faltantes_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_validate_fecha__cb

  // ---------- Validate fecha_pago_
  function do_ajax_pagos_faltantes_validate_fecha_pago_(iNumLinha)
  {
    var nomeCampo_fecha_pago_ = "fecha_pago_" + iNumLinha;
    var var_fecha_pago_ = scAjaxGetFieldText(nomeCampo_fecha_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_validate_fecha_pago_(var_fecha_pago_, iNumLinha, var_script_case_init, do_ajax_pagos_faltantes_validate_fecha_pago__cb);
  } // do_ajax_pagos_faltantes_validate_fecha_pago_

  function do_ajax_pagos_faltantes_validate_fecha_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fecha_pago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fecha_pago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fecha_pago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fecha_pago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_validate_fecha_pago__cb

  // ---------- Validate faltante_
  function do_ajax_pagos_faltantes_validate_faltante_(iNumLinha)
  {
    var nomeCampo_faltante_ = "faltante_" + iNumLinha;
    var var_faltante_ = scAjaxGetFieldText(nomeCampo_faltante_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_validate_faltante_(var_faltante_, iNumLinha, var_script_case_init, do_ajax_pagos_faltantes_validate_faltante__cb);
  } // do_ajax_pagos_faltantes_validate_faltante_

  function do_ajax_pagos_faltantes_validate_faltante__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "faltante_" + iLineNumber;
    }
    else
    {
      sFieldValid = "faltante_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "faltante_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "faltante_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_validate_faltante__cb

  // ---------- Validate referencia_pago_
  function do_ajax_pagos_faltantes_validate_referencia_pago_(iNumLinha)
  {
    var nomeCampo_referencia_pago_ = "referencia_pago_" + iNumLinha;
    var var_referencia_pago_ = scAjaxGetFieldText(nomeCampo_referencia_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_validate_referencia_pago_(var_referencia_pago_, iNumLinha, var_script_case_init, do_ajax_pagos_faltantes_validate_referencia_pago__cb);
  } // do_ajax_pagos_faltantes_validate_referencia_pago_

  function do_ajax_pagos_faltantes_validate_referencia_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "referencia_pago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "referencia_pago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "referencia_pago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "referencia_pago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_validate_referencia_pago__cb

  // ---------- Validate caseta_
  function do_ajax_pagos_faltantes_validate_caseta_(iNumLinha)
  {
    var nomeCampo_caseta_ = "caseta_" + iNumLinha;
    var var_caseta_ = scAjaxGetFieldSelect(nomeCampo_caseta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_validate_caseta_(var_caseta_, iNumLinha, var_script_case_init, do_ajax_pagos_faltantes_validate_caseta__cb);
  } // do_ajax_pagos_faltantes_validate_caseta_

  function do_ajax_pagos_faltantes_validate_caseta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_validate_caseta__cb

  // ---------- Event onchange fecha_
  function do_ajax_pagos_faltantes_event_fecha__onchange(iSeqForm)
  {
    var var_fecha_ = scAjaxGetFieldText("fecha_" + iSeqForm);
    var var_caseta_ = scAjaxGetFieldSelect("caseta_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_pagos_faltantes_event_fecha__onchange(var_fecha_, var_caseta_, var_script_case_init, var_nmgp_refresh_row, do_ajax_pagos_faltantes_event_fecha__onchange_cb);
  } // do_ajax_pagos_faltantes_event_fecha__onchange

  function do_ajax_pagos_faltantes_event_fecha__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_pagos_faltantes_event_fecha__onchange_cb_after_alert);
  } // do_ajax_pagos_faltantes_event_fecha__onchange_cb
  function do_ajax_pagos_faltantes_event_fecha__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_pagos_faltantes_event_fecha__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_pagos_faltantes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_pagos_faltantes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_pagos_faltantes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_pagos_faltantes_add_new_line_cb);
  } // do_ajax_pagos_faltantes_add_new_line

  function do_ajax_pagos_faltantes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_pagos_faltantes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_pagos_faltantes_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_pagos_faltantes_backup_line_cb);
  } // do_ajax_pagos_faltantes_backup_line

  function do_ajax_pagos_faltantes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_pagos_faltantes_backup_line_cb

  function do_ajax_pagos_faltantes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_pagos_faltantes_cancel_insert

  function do_ajax_pagos_faltantes_cancel_update(iSeqVert)
  {
    do_ajax_pagos_faltantes_backup_line(iSeqVert);
...
?>
  } // do_ajax_pagos_faltantes_cancel_update

  function do_ajax_pagos_faltantes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_pagos_faltantes_restore_buttons

  // ---------- table_refresh
  function do_ajax_pagos_faltantes_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_pagos_faltantes_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pagos_faltantes_table_refresh_cb);
  } //  do_ajax_pagos_faltantes_table_refresh

  function do_ajax_pagos_faltantes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_pagos_faltantes_table_refresh_cb_after_alert);
  } // do_ajax_pagos_faltantes_table_refresh_cb
  function do_ajax_pagos_faltantes_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_pagos_faltantes_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_pagos_faltantes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_pagos_faltantes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_fecha_pago_ = scAjaxGetFieldText("fecha_pago_" + iNumLinha);
    var var_faltante_ = scAjaxGetFieldText("faltante_" + iNumLinha);
    var var_referencia_pago_ = scAjaxGetFieldText("referencia_pago_" + iNumLinha);
    var var_caseta_ = scAjaxGetFieldSelect("caseta_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_pagos_faltantes_submit_form(var_id_, var_fecha_, var_fecha_pago_, var_faltante_, var_referencia_pago_, var_caseta_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_pagos_faltantes_submit_form_cb);
  } // do_ajax_pagos_faltantes_submit_form

  function do_ajax_pagos_faltantes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fecha_pago_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("faltante_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("referencia_pago_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_pagos_faltantes_submit_form_cb_after_alert);
  } // do_ajax_pagos_faltantes_submit_form_cb
  function do_ajax_pagos_faltantes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_pagos_faltantes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_pagos_faltantes_navigate_form()
  {
    perform_ajax_pagos_faltantes_navigate_form();
  }

  function perform_ajax_pagos_faltantes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_pagos_faltantes_cancel_insert(sc_pagos_faltantes_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fecha_pago_" + iNavForm);
      scAjaxHideErrorDisplay("faltante_" + iNavForm);
      scAjaxHideErrorDisplay("referencia_pago_" + iNavForm);
    ...
    scAjaxProcOn();
    x_ajax_pagos_faltantes_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pagos_faltantes_navigate_form_cb);
  } // do_ajax_pagos_faltantes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pagos_faltantes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_pagos_faltantes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_pagos_faltantes_navigate_form_cb_after_alert);
  } // do_ajax_pagos_faltantes_navigate_form_cb
  function do_ajax_pagos_faltantes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_pagos_faltantes_navigate_form_cb_after_alert

    function sc_pagos_faltantes_get_last_line_number()
    {
    ...
    } //sc_pagos_faltantes_get_last_line_number

  function sc_hide_pagos_faltantes_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_pago_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "faltante_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "referencia_pago_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fecha_pago_" + iNumLinha] = {"label": "Fecha Pago<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["faltante_" + iNumLinha] = {"label": "Faltante<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["referencia_pago_" + iNumLinha] = {"label": "Referencia Pago<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fecha_pago_"][iNumLinha] = "fecha_pago_" + iNumLinha;
    ajax_field_mult["faltante_"][iNumLinha] = "faltante_" + iNumLinha;
    ajax_field_mult["referencia_pago_"][iNumLinha] = "referencia_pago_" + iNumLinha;
    ...
    ajax_field_id["fecha_pago_" + iNumLinha] = new Array("hidden_field_label_fecha_pago_", "hidden_field_data_fecha_pago_" + iNumLinha);
    ajax_field_id["faltante_" + iNumLinha] = new Array("hidden_field_label_faltante_", "hidden_field_data_faltante_" + iNumLinha);
    ajax_field_id["referencia_pago_" + iNumLinha] = new Array("hidden_field_label_referencia_pago_", "hidden_field_data_referencia_pago_" + iNumLinha);
    ...
    ajax_error_count["fecha_pago_" + iNumLinha] = "off";
    ajax_error_count["faltante_" + iNumLinha] = "off";
    ajax_error_count["referencia_pago_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fecha_pago_" + iNumLinha] = "off";
    ajax_read_only["faltante_" + iNumLinha] = "off";
    ajax_read_only["referencia_pago_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fecha_pago_" + iNumLinha] = "on";
    ajax_read_only["faltante_" + iNumLinha] = "on";
    ajax_read_only["referencia_pago_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fecha_pago_" + iNumLinha] = null;
    ajax_error_list["faltante_" + iNumLinha] = null;
    ajax_error_list["referencia_pago_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "id_": new Array(),
    "fecha_": new Array(),
    "fecha_pago_": new Array(),
    "faltante_": new Array(),
    "referencia_pago_": new Array(),
    "caseta_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fecha_pago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fecha_pago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fecha_pago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fecha_pago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fecha_pago_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["faltante_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["faltante_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["faltante_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["faltante_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["faltante_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["referencia_pago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["referencia_pago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["referencia_pago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["referencia_pago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["referencia_pago_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_pago_'])) ? $this->nmgp_cmp_readonly['fecha_pago_'] : 'off';
?>
    scAjaxFieldRead("fecha_pago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['faltante_'])) ? $this->nmgp_cmp_readonly['faltante_'] : 'off';
?>
    scAjaxFieldRead("faltante_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['referencia_pago_'])) ? $this->nmgp_cmp_readonly['referencia_pago_'] : 'off';
?>
    scAjaxFieldRead("referencia_pago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("fecha_pago_" + iSeq, "on");
    scAjaxFieldRead("faltante_" + iSeq, "on");
    scAjaxFieldRead("referencia_pago_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["fecha_" + iRow] || "on" == ajax_error_count["fecha_pago_" + iRow] || "on" == ajax_error_count["faltante_" + iRow] || "on" == ajax_error_count["referencia_pago_" + iRow] || "on" == ajax_error_count["caseta_" + iRow]))
    {
      ...
      $("#hidden_field_data_fecha_pago_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_faltante_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_referencia_pago_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["fecha_" + iRow] && "off" == ajax_error_count["fecha_pago_" + iRow] && "off" == ajax_error_count["faltante_" + iRow] && "off" == ajax_error_count["referencia_pago_" + iRow] && "off" == ajax_error_count["caseta_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["fecha_" + iRow] = "off";
        ajax_error_count["fecha_pago_" + iRow] = "off";
        ajax_error_count["faltante_" + iRow] = "off";
        ajax_error_count["referencia_pago_" + iRow] = "off";
      ...
      $("#hidden_field_data_fecha_pago_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_faltante_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_referencia_pago_" + iRow).removeClass("scFormErrorLine");
