  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pagos_faltantes_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_pagos_faltantes_inline_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_pagos_faltantes_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_inline_validate_id_(var_id_, var_script_case_init, do_ajax_pagos_faltantes_inline_validate_id__cb);
  } // do_ajax_pagos_faltantes_inline_validate_id_

  function do_ajax_pagos_faltantes_inline_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_inline_validate_id__cb

  // ---------- Validate fecha_
  function do_ajax_pagos_faltantes_inline_validate_fecha_()
  {
    var nomeCampo_fecha_ = "fecha_";
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
      x_ajax_pagos_faltantes_inline_validate_fecha_(var_fecha_, var_script_case_init, do_ajax_pagos_faltantes_inline_validate_fecha__cb);
    }, 200);
  } // do_ajax_pagos_faltantes_inline_validate_fecha_

  function do_ajax_pagos_faltantes_inline_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_inline_validate_fecha__cb

  // ---------- Validate fecha_pago_
  function do_ajax_pagos_faltantes_inline_validate_fecha_pago_()
  {
    var nomeCampo_fecha_pago_ = "fecha_pago_";
    var var_fecha_pago_ = scAjaxGetFieldText(nomeCampo_fecha_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fecha_pago_ = scAjaxGetFieldText(nomeCampo_fecha_pago_);
      x_ajax_pagos_faltantes_inline_validate_fecha_pago_(var_fecha_pago_, var_script_case_init, do_ajax_pagos_faltantes_inline_validate_fecha_pago__cb);
    }, 200);
  } // do_ajax_pagos_faltantes_inline_validate_fecha_pago_

  function do_ajax_pagos_faltantes_inline_validate_fecha_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_inline_validate_fecha_pago__cb

  // ---------- Validate faltante_
  function do_ajax_pagos_faltantes_inline_validate_faltante_()
  {
    var nomeCampo_faltante_ = "faltante_";
    var var_faltante_ = scAjaxGetFieldText(nomeCampo_faltante_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_inline_validate_faltante_(var_faltante_, var_script_case_init, do_ajax_pagos_faltantes_inline_validate_faltante__cb);
  } // do_ajax_pagos_faltantes_inline_validate_faltante_

  function do_ajax_pagos_faltantes_inline_validate_faltante__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_inline_validate_faltante__cb

  // ---------- Validate referencia_pago_
  function do_ajax_pagos_faltantes_inline_validate_referencia_pago_()
  {
    var nomeCampo_referencia_pago_ = "referencia_pago_";
    var var_referencia_pago_ = scAjaxGetFieldText(nomeCampo_referencia_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_inline_validate_referencia_pago_(var_referencia_pago_, var_script_case_init, do_ajax_pagos_faltantes_inline_validate_referencia_pago__cb);
  } // do_ajax_pagos_faltantes_inline_validate_referencia_pago_

  function do_ajax_pagos_faltantes_inline_validate_referencia_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_inline_validate_referencia_pago__cb

  // ---------- Validate caseta_
  function do_ajax_pagos_faltantes_inline_validate_caseta_()
  {
    var nomeCampo_caseta_ = "caseta_";
    var var_caseta_ = scAjaxGetFieldSelect(nomeCampo_caseta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pagos_faltantes_inline_validate_caseta_(var_caseta_, var_script_case_init, do_ajax_pagos_faltantes_inline_validate_caseta__cb);
  } // do_ajax_pagos_faltantes_inline_validate_caseta_

  function do_ajax_pagos_faltantes_inline_validate_caseta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pagos_faltantes_inline_validate_caseta__cb

  // ---------- Event onchange fecha_
  function do_ajax_pagos_faltantes_inline_event_fecha__onchange()
  {
    var var_fecha_ = scAjaxGetFieldText("fecha_");
    var var_caseta_ = scAjaxGetFieldSelect("caseta_");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_pagos_faltantes_inline_event_fecha__onchange(var_fecha_, var_caseta_, var_script_case_init, do_ajax_pagos_faltantes_inline_event_fecha__onchange_cb);
  } // do_ajax_pagos_faltantes_inline_event_fecha__onchange

  function do_ajax_pagos_faltantes_inline_event_fecha__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_pagos_faltantes_inline_event_fecha__onchange_cb_after_alert);
  } // do_ajax_pagos_faltantes_inline_event_fecha__onchange_cb
  function do_ajax_pagos_faltantes_inline_event_fecha__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_pagos_faltantes_inline_event_fecha__onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_pagos_faltantes_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_pagos_faltantes_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_");
    var var_fecha_ = scAjaxGetFieldText("fecha_");
    var var_fecha_pago_ = scAjaxGetFieldText("fecha_pago_");
    var var_faltante_ = scAjaxGetFieldText("faltante_");
    var var_referencia_pago_ = scAjaxGetFieldText("referencia_pago_");
    var var_caseta_ = scAjaxGetFieldSelect("caseta_");
    ...
    scAjaxProcOn();
    x_ajax_pagos_faltantes_inline_submit_form(var_id_, var_fecha_, var_fecha_pago_, var_faltante_, var_referencia_pago_, var_caseta_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_pagos_faltantes_inline_submit_form_cb);
  } // do_ajax_pagos_faltantes_inline_submit_form

  function do_ajax_pagos_faltantes_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fecha_");
      scAjaxHideErrorDisplay("fecha_pago_");
      scAjaxHideErrorDisplay("faltante_");
      scAjaxHideErrorDisplay("referencia_pago_");
      scAjaxHideErrorDisplay("caseta_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_pagos_faltantes_inline_submit_form_cb_after_alert);
  } // do_ajax_pagos_faltantes_inline_submit_form_cb
  function do_ajax_pagos_faltantes_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_pagos_faltantes_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_pagos_faltantes_inline_navigate_form()
  {
    perform_ajax_pagos_faltantes_inline_navigate_form();
  }

  function perform_ajax_pagos_faltantes_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_pagos_faltantes_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pagos_faltantes_inline_navigate_form_cb);
  } // do_ajax_pagos_faltantes_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pagos_faltantes_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_pagos_faltantes_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_pagos_faltantes_inline_navigate_form_cb_after_alert);
  } // do_ajax_pagos_faltantes_inline_navigate_form_cb
  function do_ajax_pagos_faltantes_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_pagos_faltantes_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_pagos_faltantes_inline_navigate_form_cb_after_alert

  function sc_hide_pagos_faltantes_inline_form()
  {
  ...
  ajax_field_list[1] = "fecha_";
  ajax_field_list[2] = "fecha_pago_";
  ajax_field_list[3] = "faltante_";
  ajax_field_list[4] = "referencia_pago_";
  ajax_field_list[5] = "caseta_";
  ...
  var ajax_error_list = {
    ...
    "fecha_": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_pago_": {"label": "Fecha Pago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "faltante_": {"label": "Faltante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "referencia_pago_": {"label": "Referencia Pago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "caseta_": {"label": "Caseta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fecha_"][1] = "fecha_";
  ajax_field_mult["fecha_pago_"][1] = "fecha_pago_";
  ajax_field_mult["faltante_"][1] = "faltante_";
  ajax_field_mult["referencia_pago_"][1] = "referencia_pago_";
  ajax_field_mult["caseta_"][1] = "caseta_";

  var ajax_field_id = {
    "id_": new Array("hidden_field_label_id_", "hidden_field_data_id_"),
    "fecha_": new Array("hidden_field_label_fecha_", "hidden_field_data_fecha_"),
    "fecha_pago_": new Array("hidden_field_label_fecha_pago_", "hidden_field_data_fecha_pago_"),
    "faltante_": new Array("hidden_field_label_faltante_", "hidden_field_data_faltante_"),
    "referencia_pago_": new Array("hidden_field_label_referencia_pago_", "hidden_field_data_referencia_pago_"),
    "caseta_": new Array("hidden_field_label_caseta_", "hidden_field_data_caseta_")
  };
