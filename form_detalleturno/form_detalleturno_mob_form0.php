...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_detalleturno/form_detalleturno_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_detalleturno_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_detalleturno_mob_jquery.php');
...
<?php
$str_iframe_body = 'margin-left: 0.1px; margin-right: 0.1px; margin-top: 0.1px; margin-bottom: 0.1px;';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_detalleturno']['error_buffer']) && '' != $_SESSION['scriptcase']['form_detalleturno']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_detalleturno']['error_buffer'];
}
...
<?php
 include_once("form_detalleturno_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_detalleturno_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_detalleturno_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_detalleturno_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['update'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "Preliquidar", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['mxn'] = "Moneda Nal. (MXN)";
    }
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mxn_line" id="hidden_field_data_mxn" style="<?php echo $sStyleHidden_mxn; ?>"> <span class="scFormLabelOddFormat css_mxn_label" style=""><span id="id_label_mxn"><?php echo $this->nm_new_label['mxn']; ?></span></span><br>
...
<span id="id_read_on_mxn" class="sc-ui-readonly-mxn css_mxn_line" style="<?php echo $sStyleReadLab_mxn; ?>"><?php echo $this->form_format_readonly("mxn", $this->form_encode_input($this->mxn)); ?></span><span id="id_read_off_mxn" class="css_read_off_mxn<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_mxn; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'currency', currencySymbol: '<?php echo $this->field_config['mxn']['symbol_mon']; ?>', currencyPosition: '<?php echo ((1 == $this->field_config['mxn']['format_pos'] || 3 == $this->field_config['mxn']['format_pos']) ? 'left' : 'right'); ?>', maxLength: 20, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['mxn']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['mxn']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['mxn']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['mxn']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ ', alignment: 'left'}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['ingresoelu']))
    {
        $this->nm_new_label['ingresoelu'] = "Ingreso por Eludidos";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $ingresoelu = $this->ingresoelu;
   $sStyleHidden_ingresoelu = '';
   if (isset($this->nmgp_cmp_hidden['ingresoelu']) && $this->nmgp_cmp_hidden['ingresoelu'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['ingresoelu']);
       $sStyleHidden_ingresoelu = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_ingresoelu = 'display: none;';
   $sStyleReadInp_ingresoelu = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['ingresoelu']) && $this->nmgp_cmp_readonly['ingresoelu'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['ingresoelu']);
       $sStyleReadLab_ingresoelu = '';
       $sStyleReadInp_ingresoelu = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['ingresoelu']) && $this->nmgp_cmp_hidden['ingresoelu'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="ingresoelu" value="<?php echo $this->form_encode_input($ingresoelu) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_ingresoelu_line" id="hidden_field_data_ingresoelu" style="<?php echo $sStyleHidden_ingresoelu; ?>"> <span class="scFormLabelOddFormat css_ingresoelu_label" style=""><span id="id_label_ingresoelu"><?php echo $this->nm_new_label['ingresoelu']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ingresoelu"]) &&  $this->nmgp_cmp_readonly["ingresoelu"] == "on") { 

 ?>
<input type="hidden" name="ingresoelu" value="<?php echo $this->form_encode_input($ingresoelu) . "\">" . $ingresoelu . ""; ?>
<?php } else { ?>
<span id="id_read_on_ingresoelu" class="sc-ui-readonly-ingresoelu css_ingresoelu_line" style="<?php echo $sStyleReadLab_ingresoelu; ?>"><?php echo $this->form_format_readonly("ingresoelu", $this->form_encode_input($this->ingresoelu)); ?></span><span id="id_read_off_ingresoelu" class="css_read_off_ingresoelu<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ingresoelu; ?>">
 <input class="sc-js-input scFormObjectOdd css_ingresoelu_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_ingresoelu" type=text name="ingresoelu" value="<?php echo $this->form_encode_input($ingresoelu) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'currency', currencySymbol: '<?php echo $this->field_config['ingresoelu']['symbol_mon']; ?>', currencyPosition: '<?php echo ((1 == $this->field_config['ingresoelu']['format_pos'] || 3 == $this->field_config['ingresoelu']['format_pos']) ? 'left' : 'right'); ?>', maxLength: 20, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['ingresoelu']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['ingresoelu']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['ingresoelu']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['ingresoelu']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ ', alignment: 'left'}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php $sStyleHidden_ingresoelu_dumb = ('' == $sStyleHidden_ingresoelu) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_ingresoelu_dumb" style="<?php echo $sStyleHidden_ingresoelu_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantidadmxn_line" id="hidden_field_data_cantidadmxn" style="<?php echo $sStyleHidden_cantidadmxn; ?>"> <span class="scFormLabelOddFormat css_cantidadmxn_label" style=""><span id="id_label_cantidadmxn"><?php echo $this->nm_new_label['cantidadmxn']; ?></span></span><br>
...
<span id="id_read_on_cantidadmxn" class="sc-ui-readonly-cantidadmxn css_cantidadmxn_line" style="<?php echo $sStyleReadLab_cantidadmxn; ?>"><?php echo $this->form_format_readonly("cantidadmxn", $this->form_encode_input($this->cantidadmxn)); ?></span><span id="id_read_off_cantidadmxn" class="css_read_off_cantidadmxn<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_cantidadmxn; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=18"; } ?> alt="{datatype: 'integer', maxLength: 18, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['cantidadmxn']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['cantidadmxn']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['cantidadmxn']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantidadusd_line" id="hidden_field_data_cantidadusd" style="<?php echo $sStyleHidden_cantidadusd; ?>"> <span class="scFormLabelOddFormat css_cantidadusd_label" style=""><span id="id_label_cantidadusd"><?php echo $this->nm_new_label['cantidadusd']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importemxn_line" id="hidden_field_data_importemxn" style="<?php echo $sStyleHidden_importemxn; ?>"> <span class="scFormLabelOddFormat css_importemxn_label" style=""><span id="id_label_importemxn"><?php echo $this->nm_new_label['importemxn']; ?></span></span><br>
...
<span id="id_read_on_importemxn" class="sc-ui-readonly-importemxn css_importemxn_line" style="<?php echo $sStyleReadLab_importemxn; ?>"><?php echo $this->form_format_readonly("importemxn", $this->form_encode_input($this->importemxn)); ?></span><span id="id_read_off_importemxn" class="css_read_off_importemxn<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_importemxn; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=18"; } ?> alt="{datatype: 'currency', currencySymbol: '<?php echo $this->field_config['importemxn']['symbol_mon']; ?>', currencyPosition: '<?php echo ((1 == $this->field_config['importemxn']['format_pos'] || 3 == $this->field_config['importemxn']['format_pos']) ? 'left' : 'right'); ?>', maxLength: 18, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['importemxn']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['importemxn']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['importemxn']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['importemxn']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['folioinicialcr']))
           {
               $this->nmgp_cmp_readonly['folioinicialcr'] = 'on';
           }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importeusd_line" id="hidden_field_data_importeusd" style="<?php echo $sStyleHidden_importeusd; ?>"> <span class="scFormLabelOddFormat css_importeusd_label" style=""><span id="id_label_importeusd"><?php echo $this->nm_new_label['importeusd']; ?></span></span><br>
...
<?php $sStyleHidden_importeusd_dumb = ('' == $sStyleHidden_importeusd) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_importeusd_dumb" style="<?php echo $sStyleHidden_importeusd_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['foliofinalcr']))
           {
               $this->nmgp_cmp_readonly['foliofinalcr'] = 'on';
           }
?>
...
<?php
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["folioinicialcr"]) &&  $this->nmgp_cmp_readonly["folioinicialcr"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_folioinicialcr_line" id="hidden_field_data_folioinicialcr" style="<?php echo $sStyleHidden_folioinicialcr; ?>"> <span class="scFormLabelOddFormat css_folioinicialcr_label" style=""><span id="id_label_folioinicialcr"><?php echo $this->nm_new_label['folioinicialcr']; ?></span></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["folioinicialcr"]) &&  $this->nmgp_cmp_readonly["folioinicialcr"] == "on")) { 

 ?>
<input type="hidden" name="folioinicialcr" value="<?php echo $this->form_encode_input($folioinicialcr) . "\"><span id=\"id_ajax_label_folioinicialcr\">" . $folioinicialcr . "</span>"; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['folioinicialeap']))
           {
               $this->nmgp_cmp_readonly['folioinicialeap'] = 'on';
           }
?>
...
<?php
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["foliofinalcr"]) &&  $this->nmgp_cmp_readonly["foliofinalcr"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliofinalcr_line" id="hidden_field_data_foliofinalcr" style="<?php echo $sStyleHidden_foliofinalcr; ?>"> <span class="scFormLabelOddFormat css_foliofinalcr_label" style=""><span id="id_label_foliofinalcr"><?php echo $this->nm_new_label['foliofinalcr']; ?></span></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["foliofinalcr"]) &&  $this->nmgp_cmp_readonly["foliofinalcr"] == "on")) { 

 ?>
<input type="hidden" name="foliofinalcr" value="<?php echo $this->form_encode_input($foliofinalcr) . "\"><span id=\"id_ajax_label_foliofinalcr\">" . $foliofinalcr . "</span>"; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['foliofinaleap']))
           {
               $this->nmgp_cmp_readonly['foliofinaleap'] = 'on';
           }
?>
...
<?php
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["folioinicialeap"]) &&  $this->nmgp_cmp_readonly["folioinicialeap"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_folioinicialeap_line" id="hidden_field_data_folioinicialeap" style="<?php echo $sStyleHidden_folioinicialeap; ?>"> <span class="scFormLabelOddFormat css_folioinicialeap_label" style=""><span id="id_label_folioinicialeap"><?php echo $this->nm_new_label['folioinicialeap']; ?></span></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["folioinicialeap"]) &&  $this->nmgp_cmp_readonly["folioinicialeap"] == "on")) { 

 ?>
<input type="hidden" name="folioinicialeap" value="<?php echo $this->form_encode_input($folioinicialeap) . "\"><span id=\"id_ajax_label_folioinicialeap\">" . $folioinicialeap . "</span>"; ?>
<?php } else { ?>
...
<?php
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["foliofinaleap"]) &&  $this->nmgp_cmp_readonly["foliofinaleap"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliofinaleap_line" id="hidden_field_data_foliofinaleap" style="<?php echo $sStyleHidden_foliofinaleap; ?>"> <span class="scFormLabelOddFormat css_foliofinaleap_label" style=""><span id="id_label_foliofinaleap"><?php echo $this->nm_new_label['foliofinaleap']; ?></span></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["foliofinaleap"]) &&  $this->nmgp_cmp_readonly["foliofinaleap"] == "on")) { 

 ?>
<input type="hidden" name="foliofinaleap" value="<?php echo $this->form_encode_input($foliofinaleap) . "\"><span id=\"id_ajax_label_foliofinaleap\">" . $foliofinaleap . "</span>"; ?>
<?php } else { ?>
...
<?php $sStyleHidden_foliofinaleap_dumb = ('' == $sStyleHidden_foliofinaleap) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_foliofinaleap_dumb" style="<?php echo $sStyleHidden_foliofinaleap_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_folioinir1_line" id="hidden_field_data_folioinir1" style="<?php echo $sStyleHidden_folioinir1; ?>"> <span class="scFormLabelOddFormat css_folioinir1_label" style=""><span id="id_label_folioinir1"><?php echo $this->nm_new_label['folioinir1']; ?></span></span><br>
...
<span id="id_read_on_folioinir1" class="sc-ui-readonly-folioinir1 css_folioinir1_line" style="<?php echo $sStyleReadLab_folioinir1; ?>"><?php echo $this->form_format_readonly("folioinir1", $this->form_encode_input($this->folioinir1)); ?></span><span id="id_read_off_folioinir1" class="css_read_off_folioinir1<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_folioinir1; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("0123456789") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliofinr1_line" id="hidden_field_data_foliofinr1" style="<?php echo $sStyleHidden_foliofinr1; ?>"> <span class="scFormLabelOddFormat css_foliofinr1_label" style=""><span id="id_label_foliofinr1"><?php echo $this->nm_new_label['foliofinr1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['php_cmp_required']['foliofinr1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['php_cmp_required']['foliofinr1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_folioinir2_line" id="hidden_field_data_folioinir2" style="<?php echo $sStyleHidden_folioinir2; ?>"> <span class="scFormLabelOddFormat css_folioinir2_label" style=""><span id="id_label_folioinir2"><?php echo $this->nm_new_label['folioinir2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliofinr2_line" id="hidden_field_data_foliofinr2" style="<?php echo $sStyleHidden_foliofinr2; ?>"> <span class="scFormLabelOddFormat css_foliofinr2_label" style=""><span id="id_label_foliofinr2"><?php echo $this->nm_new_label['foliofinr2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_folioinir3_line" id="hidden_field_data_folioinir3" style="<?php echo $sStyleHidden_folioinir3; ?>"> <span class="scFormLabelOddFormat css_folioinir3_label" style=""><span id="id_label_folioinir3"><?php echo $this->nm_new_label['folioinir3']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foliofinr3_line" id="hidden_field_data_foliofinr3" style="<?php echo $sStyleHidden_foliofinr3; ?>"> <span class="scFormLabelOddFormat css_foliofinr3_label" style=""><span id="id_label_foliofinr3"><?php echo $this->nm_new_label['foliofinr3']; ?></span></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_detalleturno_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_detalleturno_mob");
 parent.scAjaxDetailHeight("form_detalleturno_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleturno_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
