...
$menu_notificacion_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_notificacion'] = "on";
} 
if (!isset($_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_notificacion']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_notificacion'] != "on"))
{ 
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_menu_notificacion" name="menu_notificacion_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_notificacion_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_imag_temp'] . "/sc_apl_default_BackOffice_Acapulco.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_BackOffice_Acapulco'])) {
            $_SESSION['scriptcase']['menu_notificacion']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_BackOffice_Acapulco'];
        }
    }
}
