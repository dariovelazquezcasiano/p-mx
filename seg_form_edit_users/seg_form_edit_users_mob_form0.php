...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>seg_form_edit_users/seg_form_edit_users_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['last'] : 'off'); ?>";
...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['link_info']['remove_border']) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['exit'];
        }
?>
...
<?php  $this->caseta_1 = explode(",", trim($this->caseta)) ; ?>
    <TD class="scFormDataOdd css_caseta_line" id="hidden_field_data_caseta" style="<?php echo $sStyleHidden_caseta; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_caseta_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_caseta_label" style=""><span id="id_label_caseta"><?php echo $this->nm_new_label['caseta']; ?></span></span><br>
...
<?php
   ...
   echo " <span id=\"idAjaxSelect_caseta\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_caseta_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_caseta\" name=\"caseta[]\" size=\"4\" alt=\"{type: 'select', enterTab: false}\" multiple>" ; 
   echo "\r" ; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['btn_label']['delete'];
        }
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
