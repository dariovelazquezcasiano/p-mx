...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['last'] : 'off'); ?>";
...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['link_info']['remove_border']) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['exit'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_name_label" id="hidden_field_label_name" style="<?php echo $sStyleHidden_name; ?>"><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['php_cmp_required']['name'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
else
{
   ...
   {
       if (is_array($this->caseta))
       {
           $Tmp_array = $this->caseta;
       }
       else
       {
           $Tmp_array = explode(",", $this->caseta);
       }
       $caseta_val_str = "";
       foreach ($Tmp_array as $Tmp_val_cmp)
       {
...
<?php } else { $sc_hidden_no++; ?>
<?php  $this->caseta_1 = explode(",", trim($this->caseta)) ; ?>
    ...
    <TD class="scFormDataOdd css_caseta_line" id="hidden_field_data_caseta" style="<?php echo $sStyleHidden_caseta; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_caseta_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["caseta"]) &&  $this->nmgp_cmp_readonly["caseta"] == "on") { 
 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['Lookup_caseta']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['Lookup_caseta'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['Lookup_caseta']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['Lookup_caseta'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['Lookup_caseta'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          foreach ($this->caseta_1 as $Dados)
          {
              if ($Dados === $cadaselect[1])
              {
                  $caseta_look .= $cadaselect[0] . "&nbsp;";
                  break;
              }
          }
          $x++; 
...
<?php
   ...
   echo " <span id=\"idAjaxSelect_caseta\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_caseta_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_caseta\" name=\"caseta_orig\" size=\"4\" multiple onDblClick=\"nm_add_sel('caseta_orig', 'caseta_dest', null);  \" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   ...
   echo "<div class='scBtnPassField' id='caseta_all_right'>";
   echo         $sCondStyle = '';
?>
<?php
        $buttonMacroDisabled = '';
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_rightall']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_rightall']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_rightall']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_rightall']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_rightall'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('caseta_orig', 'caseta_dest', null);    return false;", "nm_add_all('caseta_orig', 'caseta_dest', null);    return false;", "Bbpassfld_rightall", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_right']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_right']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_right']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_right']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_right'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('caseta_orig', 'caseta_dest', null);    return false;", "nm_add_sel('caseta_orig', 'caseta_dest', null);    return false;", "Bbpassfld_righ", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_left']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_left']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_left']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_left']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_left'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('caseta_dest', 'caseta_orig', null);    return false;", "nm_del_sel('caseta_dest', 'caseta_orig', null);    return false;", "Bbpassfld_left", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
 
<?php
;
   echo "</div>";
   echo "<div class='scBtnPassField' id='caseta_all_left'>";
   echo         $sCondStyle = '';
?>
<?php
        $buttonMacroDisabled = '';
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_leftall']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['bpassfld_leftall']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_leftall']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_leftall']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['bpassfld_leftall'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('caseta_dest', 'caseta_orig', null);    return false;", "nm_del_all('caseta_dest', 'caseta_orig', null);    return false;", "Bbpassfld_leftall", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
;
   ...
   echo "</td>";
   echo "<td>";
   echo " <select class=\"sc-js-input scFormObjectOdd css_caseta_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" name=\"caseta_dest\"  onBlur=\"scCssBlur(this);\"  onFocus=\"scCssFocus(this);\"  size=4 multiple onDblClick=\"nm_del_sel('caseta_dest', 'caseta_orig', null);  \" alt=\"{type: 'select', enterTab: false}\">";
   $x = 0 ; 
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo " </select>" ; 
   echo " <input type=\"hidden\" name=\"caseta\" value=\"\">" ; 
   echo "</td></tr></table>";
   echo " <script>document.F1.caseta_dest.selectedIndex = -1;</script>" ; 
   echo "\r" ; 
   echo "</span>";
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_caseta_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_caseta_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['btn_label']['delete'];
        }
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
