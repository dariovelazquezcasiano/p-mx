...
?>
  ...
  // ---------- Validate caseta
  function do_ajax_seg_form_edit_users_validate_caseta()
  {
    var nomeCampo_caseta = "caseta";
    nm_pack(nomeCampo_caseta + '_dest', nomeCampo_caseta);
    var var_caseta = scAjaxGetFieldText(nomeCampo_caseta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_caseta(var_caseta, var_script_case_init, do_ajax_seg_form_edit_users_validate_caseta_cb);
  } // do_ajax_seg_form_edit_users_validate_caseta

  function do_ajax_seg_form_edit_users_validate_caseta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "caseta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_caseta_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_seg_form_edit_users_submit_form()
  {
    ...
    nm_pack("caseta_dest", "caseta");
    var var_caseta = scAjaxGetFieldText("caseta");
    ...
    scAjaxProcOn();
    x_ajax_seg_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_caseta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_form_edit_users_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_seg_form_edit_users_submit_form_cb_after_alert);
  } // do_ajax_seg_form_edit_users_submit_form_cb
  function do_ajax_seg_form_edit_users_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_seg_form_edit_users_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_seg_form_edit_users_navigate_form()
  {
    perform_ajax_seg_form_edit_users_navigate_form();
  }

  function perform_ajax_seg_form_edit_users_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
...
?>
  function do_ajax_seg_form_edit_users_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_seg_form_edit_users_navigate_form_cb_after_alert);
  } // do_ajax_seg_form_edit_users_navigate_form_cb
  function do_ajax_seg_form_edit_users_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_seg_form_edit_users_navigate_form_cb_after_alert
