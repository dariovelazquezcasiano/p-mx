...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_aforo_liquidacionCR_tramo/form_aforo_liquidacionCR_tramo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_aforo_liquidacionCR_tramo_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['link_info']['remove_border']) {
...
<?php
 include_once("form_aforo_liquidacionCR_tramo_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_aforo_liquidacionCR_tramo'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aforo_liquidacionCR_tramo'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['liquida']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['liquida']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['liquida']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['liquida']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['liquida'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['salir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['salir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['salir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['salir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['salir'];
        }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['Lookup_vehiculocorrecto'][] = '1'; ?>
<?php  if ("1" == $this->vehiculocorrecto)  { echo " checked" ;} ?>  onClick="do_ajax_form_aforo_liquidacionCR_tramo_event_vehiculocorrecto_onclick();" ><label for="<?php echo $tempOptionId ?>">PRE</label></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['Lookup_vehiculocorrecto'][] = '2'; ?>
<?php  if ("2" == $this->vehiculocorrecto)  { echo " checked" ;} ?><?php  if (empty($this->vehiculocorrecto)) { echo " checked" ;} ?>  onClick="do_ajax_form_aforo_liquidacionCR_tramo_event_vehiculocorrecto_onclick();" ><label for="<?php echo $tempOptionId ?>">CR</label></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['Lookup_vehiculocorrecto'][] = '3'; ?>
<?php  if ("3" == $this->vehiculocorrecto)  { echo " checked" ;} ?>  onClick="do_ajax_form_aforo_liquidacionCR_tramo_event_vehiculocorrecto_onclick();" ><label for="<?php echo $tempOptionId ?>">POS</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['video']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['video']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['video2']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['video2']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video2']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video2']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video2'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['video3']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['video3']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video3']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video3']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['video3'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['btn_label']['exit'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_aforo_liquidacionCR_tramo");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_aforo_liquidacionCR_tramo");
 parent.scAjaxDetailHeight("form_aforo_liquidacionCR_tramo", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
