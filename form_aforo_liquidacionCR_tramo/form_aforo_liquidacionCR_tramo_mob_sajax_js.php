  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aforo_liquidacionCR_tramo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aforo_liquidacionCR_tramo_mob_form();
	}
...
?>
  ...
  // ---------- Validate vehiculocorrecto
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculocorrecto()
  {
    var nomeCampo_vehiculocorrecto = "vehiculocorrecto";
    var var_vehiculocorrecto = scAjaxGetFieldRadio(nomeCampo_vehiculocorrecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculocorrecto(var_vehiculocorrecto, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculocorrecto_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculocorrecto

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculocorrecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vehiculocorrecto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculocorrecto_cb

  // ---------- Validate pagoid_ana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_pagoid_ana()
  {
    var nomeCampo_pagoid_ana = "pagoid_ana";
    var var_pagoid_ana = scAjaxGetFieldSelect(nomeCampo_pagoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_tramo_mob_validate_pagoid_ana(var_pagoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_pagoid_ana_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_pagoid_ana

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_pagoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagoid_ana";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_pagoid_ana_cb

  // ---------- Validate vehiculoid_ana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculoid_ana()
  {
    var nomeCampo_vehiculoid_ana = "vehiculoid_ana";
    var var_vehiculoid_ana = scAjaxGetFieldSelect(nomeCampo_vehiculoid_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculoid_ana(var_vehiculoid_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculoid_ana_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculoid_ana

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculoid_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vehiculoid_ana";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_vehiculoid_ana_cb

  // ---------- Validate importe_ana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_importe_ana()
  {
    var nomeCampo_importe_ana = "importe_ana";
    var var_importe_ana = scAjaxGetFieldText(nomeCampo_importe_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_tramo_mob_validate_importe_ana(var_importe_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_importe_ana_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_importe_ana

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_importe_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "importe_ana";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_importe_ana_cb

  // ---------- Validate cantidadeje_ana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_cantidadeje_ana()
  {
    var nomeCampo_cantidadeje_ana = "cantidadeje_ana";
    var var_cantidadeje_ana = scAjaxGetFieldText(nomeCampo_cantidadeje_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_tramo_mob_validate_cantidadeje_ana(var_cantidadeje_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_cantidadeje_ana_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_cantidadeje_ana

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_cantidadeje_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cantidadeje_ana";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_cantidadeje_ana_cb

  // ---------- Validate tarifaee_ana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_tarifaee_ana()
  {
    var nomeCampo_tarifaee_ana = "tarifaee_ana";
    var var_tarifaee_ana = scAjaxGetFieldText(nomeCampo_tarifaee_ana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_tramo_mob_validate_tarifaee_ana(var_tarifaee_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_tarifaee_ana_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_tarifaee_ana

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_tarifaee_ana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarifaee_ana";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_tarifaee_ana_cb

  // ---------- Validate fld_importe_eeana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_fld_importe_eeana()
  {
    var nomeCampo_fld_importe_eeana = "fld_importe_eeana";
    var var_fld_importe_eeana = scAjaxGetFieldText(nomeCampo_fld_importe_eeana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aforo_liquidacionCR_tramo_mob_validate_fld_importe_eeana(var_fld_importe_eeana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_fld_importe_eeana_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_fld_importe_eeana

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_fld_importe_eeana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_importe_eeana";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_validate_fld_importe_eeana_cb

  // ---------- Event onchange pagoid_ana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange()
  {
    var var_pagoid_ana = scAjaxGetFieldSelect("pagoid_ana");
    var var_vehiculoid_ana = scAjaxGetFieldSelect("vehiculoid_ana");
    var var_cantidadeje_ana = scAjaxGetFieldText("cantidadeje_ana");
    var var_importe_ana = scAjaxGetFieldText("importe_ana");
    var var_fld_importe_eeana = scAjaxGetFieldText("fld_importe_eeana");
    var var_tarifaee_ana = scAjaxGetFieldText("tarifaee_ana");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange(var_pagoid_ana, var_vehiculoid_ana, var_cantidadeje_ana, var_importe_ana, var_fld_importe_eeana, var_tarifaee_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pagoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange_cb
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_pagoid_ana_onchange_cb_after_alert

  // ---------- Event onclick vehiculocorrecto
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick()
  {
    var var_vehiculocorrecto = scAjaxGetFieldRadio("vehiculocorrecto");
    var var_vehiculoid_ana = scAjaxGetFieldSelect("vehiculoid_ana");
    var var_pagoid_ana = scAjaxGetFieldSelect("pagoid_ana");
    var var_cantidadeje_ana = scAjaxGetFieldText("cantidadeje_ana");
    var var_importe_ana = scAjaxGetFieldText("importe_ana");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick(var_vehiculocorrecto, var_vehiculoid_ana, var_pagoid_ana, var_cantidadeje_ana, var_importe_ana, var_fld_importe_eeana, var_tarifaee_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculocorrecto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick_cb
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick_cb_after_alert

  // ---------- Event onchange vehiculoid_ana
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange()
  {
    var var_pagoid_ana = scAjaxGetFieldSelect("pagoid_ana");
    var var_vehiculoid_ana = scAjaxGetFieldSelect("vehiculoid_ana");
    var var_cantidadeje_ana = scAjaxGetFieldText("cantidadeje_ana");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange(var_pagoid_ana, var_vehiculoid_ana, var_cantidadeje_ana, var_importe_ana, var_fld_importe_eeana, var_tarifaee_ana, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vehiculoid_ana";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange_cb
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculoid_ana_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_vehiculocorrecto = scAjaxGetFieldRadio("vehiculocorrecto");
    ...
    scAjaxProcOn();
    x_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form(var_vehiculocorrecto, var_pagoid_ana, var_vehiculoid_ana, var_importe_ana, var_cantidadeje_ana, var_tarifaee_ana, var_fld_importe_eeana, var_consecutivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("vehiculocorrecto");
      scAjaxHideErrorDisplay("pagoid_ana");
      scAjaxHideErrorDisplay("vehiculoid_ana");
      scAjaxHideErrorDisplay("importe_ana");
      scAjaxHideErrorDisplay("cantidadeje_ana");
      scAjaxHideErrorDisplay("tarifaee_ana");
      scAjaxHideErrorDisplay("fld_importe_eeana");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form_cb
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form()
  {
    perform_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form();
  }

  function perform_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form(var_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form_cb);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form_cb
  function do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_aforo_liquidacionCR_tramo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aforo_liquidacionCR_tramo_mob_navigate_form_cb_after_alert

  function sc_hide_form_aforo_liquidacionCR_tramo_mob_form()
  {
  ...
  ajax_field_list[0] = "vehiculocorrecto";
  ajax_field_list[1] = "pagoid_ana";
  ajax_field_list[2] = "vehiculoid_ana";
  ajax_field_list[3] = "importe_ana";
  ajax_field_list[4] = "cantidadeje_ana";
  ajax_field_list[5] = "tarifaee_ana";
  ajax_field_list[6] = "fld_importe_eeana";
  ...
  var ajax_error_list = {
    "vehiculocorrecto": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pagoid_ana": {"label": "Pago ANA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vehiculoid_ana": {"label": "Vehiculo ANA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "importe_ana": {"label": "Importe ANA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cantidadeje_ana": {"label": "Cantidad EE ANA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tarifaee_ana": {"label": "Tarifa EE ANA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fld_importe_eeana": {"label": "EjeEx($)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "vehiculocorrecto": new Array(),
    "pagoid_ana": new Array(),
    "vehiculoid_ana": new Array(),
    "importe_ana": new Array(),
    "cantidadeje_ana": new Array(),
    "tarifaee_ana": new Array(),
    "fld_importe_eeana": new Array()
  };
  ajax_field_mult["vehiculocorrecto"][1] = "vehiculocorrecto";
  ajax_field_mult["pagoid_ana"][1] = "pagoid_ana";
  ajax_field_mult["vehiculoid_ana"][1] = "vehiculoid_ana";
  ajax_field_mult["importe_ana"][1] = "importe_ana";
  ajax_field_mult["cantidadeje_ana"][1] = "cantidadeje_ana";
  ajax_field_mult["tarifaee_ana"][1] = "tarifaee_ana";
  ajax_field_mult["fld_importe_eeana"][1] = "fld_importe_eeana";

  var ajax_field_id = {
    "vehiculocorrecto": new Array("hidden_field_label_vehiculocorrecto", "hidden_field_data_vehiculocorrecto"),
    "pagoid_ana": new Array("hidden_field_label_pagoid_ana", "hidden_field_data_pagoid_ana"),
    "vehiculoid_ana": new Array("hidden_field_label_vehiculoid_ana", "hidden_field_data_vehiculoid_ana"),
    "importe_ana": new Array("hidden_field_label_importe_ana", "hidden_field_data_importe_ana"),
    "cantidadeje_ana": new Array("hidden_field_label_cantidadeje_ana", "hidden_field_data_cantidadeje_ana"),
    "tarifaee_ana": new Array("hidden_field_label_tarifaee_ana", "hidden_field_data_tarifaee_ana"),
    "fld_importe_eeana": new Array("hidden_field_label_fld_importe_eeana", "hidden_field_data_fld_importe_eeana")
  };

  var ajax_read_only = {
    "vehiculocorrecto": "off",
    "pagoid_ana": "off",
    "vehiculoid_ana": "off",
    "importe_ana": "on",
    "cantidadeje_ana": "on",
    "tarifaee_ana": "on",
    "fld_importe_eeana": "on"
  };
