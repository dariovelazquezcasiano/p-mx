...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_aforo_liquidacionCR_tramo"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    // window.open("http://localhost:8090/webs/en/clip_video.php?camaraid=33", "Video", "left=700, top=450, width=500, height=500");
// window.open("http://localhost:8090/webs/en/clip_video.php?d=<?php echo $_SESSION['Fechat'] ?>&h=<?php echo $_SESSION['Hora'] ?>&c=<?php echo $_SESSION['Camara'] ?>", "Video", "left=700, top=450, width=500, height=500");

parent.document.getElementById('id-iframe-3').src="http://localhost:8090/webs/en/clip_video.php?d=<?php echo $_SESSION['Fechat'] ?>&h=<?php echo $_SESSION['Hora'] ?>&c=<?php echo $_SESSION['Camara'] ?>";
// parent.document.getElementById('id-iframe-3').src="http://localhost:8090/webs/en/clip_video.php?camaraid=33";
...
{ 
    ...
    parent.document.getElementById('id-iframe-3').src="http://localhost:8090/webs/en/clip_video.php?d=<?php echo $_SESSION['Fechat'] ?>&h=<?php echo $_SESSION['Hora'] ?>&c=35";
...
{ 
    ...
    parent.document.getElementById('id-iframe-3').src="http://localhost:8090/webs/en/clip_video.php?d=<?php echo $_SESSION['Fechat'] ?>&h=<?php echo $_SESSION['Hora'] ?>&c=37";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo']['where_detal']))
  {
?>  
