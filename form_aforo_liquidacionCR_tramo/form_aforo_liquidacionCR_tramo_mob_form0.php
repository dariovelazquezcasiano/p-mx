...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_aforo_liquidacionCR_tramo/form_aforo_liquidacionCR_tramo_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['last'] : 'off'); ?>";
...
function nav_desliga_img()
{
 ...
 function clip_video(fecha, hora) {
  var dire = "http://localhost:8090/webs/en/clip_video.php?d=".concat(fecha,"&h=",hora,"&c=33");
  parent.document.getElementById('id-iframe-3').src=dire;
  
 } // clip_video
<?php

include_once('form_aforo_liquidacionCR_tramo_mob_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_aforo_liquidacionCR_tramo']['error_buffer']) && '' != $_SESSION['scriptcase']['form_aforo_liquidacionCR_tramo']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_aforo_liquidacionCR_tramo']['error_buffer'];
}
...
<?php
 include_once("form_aforo_liquidacionCR_tramo_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_aforo_liquidacionCR_tramo_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_aforo_liquidacionCR_tramo_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aforo_liquidacionCR_tramo_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['liquida']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['liquida']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['liquida']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['liquida']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['liquida'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['salir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['salir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['salir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['salir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['salir'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculocorrecto_line" id="hidden_field_data_vehiculocorrecto" style="<?php echo $sStyleHidden_vehiculocorrecto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculocorrecto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculocorrecto_label" style=""><span id="id_label_vehiculocorrecto"><?php echo $this->nm_new_label['vehiculocorrecto']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['Lookup_vehiculocorrecto'][] = '1'; ?>
<?php  if ("1" == $this->vehiculocorrecto)  { echo " checked" ;} ?>  onClick="do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick();" ><label for="<?php echo $tempOptionId ?>">PRE</label></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['Lookup_vehiculocorrecto'][] = '2'; ?>
<?php  if ("2" == $this->vehiculocorrecto)  { echo " checked" ;} ?><?php  if (empty($this->vehiculocorrecto)) { echo " checked" ;} ?>  onClick="do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick();" ><label for="<?php echo $tempOptionId ?>">CR</label></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['Lookup_vehiculocorrecto'][] = '3'; ?>
<?php  if ("3" == $this->vehiculocorrecto)  { echo " checked" ;} ?>  onClick="do_ajax_form_aforo_liquidacionCR_tramo_mob_event_vehiculocorrecto_onclick();" ><label for="<?php echo $tempOptionId ?>">POS</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php $sStyleHidden_vehiculocorrecto_dumb = ('' == $sStyleHidden_vehiculocorrecto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculocorrecto_dumb" style="<?php echo $sStyleHidden_vehiculocorrecto_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pagoid_ana_line" id="hidden_field_data_pagoid_ana" style="<?php echo $sStyleHidden_pagoid_ana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pagoid_ana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pagoid_ana_label" style=""><span id="id_label_pagoid_ana"><?php echo $this->nm_new_label['pagoid_ana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculoid_ana_line" id="hidden_field_data_vehiculoid_ana" style="<?php echo $sStyleHidden_vehiculoid_ana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculoid_ana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculoid_ana_label" style=""><span id="id_label_vehiculoid_ana"><?php echo $this->nm_new_label['vehiculoid_ana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importe_ana_line" id="hidden_field_data_importe_ana" style="<?php echo $sStyleHidden_importe_ana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importe_ana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_importe_ana_label" style=""><span id="id_label_importe_ana"><?php echo $this->nm_new_label['importe_ana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantidadeje_ana_line" id="hidden_field_data_cantidadeje_ana" style="<?php echo $sStyleHidden_cantidadeje_ana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cantidadeje_ana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cantidadeje_ana_label" style=""><span id="id_label_cantidadeje_ana"><?php echo $this->nm_new_label['cantidadeje_ana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarifaee_ana_line" id="hidden_field_data_tarifaee_ana" style="<?php echo $sStyleHidden_tarifaee_ana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tarifaee_ana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tarifaee_ana_label" style=""><span id="id_label_tarifaee_ana"><?php echo $this->nm_new_label['tarifaee_ana']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fld_importe_eeana_line" id="hidden_field_data_fld_importe_eeana" style="<?php echo $sStyleHidden_fld_importe_eeana; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fld_importe_eeana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fld_importe_eeana_label" style=""><span id="id_label_fld_importe_eeana"><?php echo $this->nm_new_label['fld_importe_eeana']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['video']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['video']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['video2']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['video2']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video2']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video2']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video2'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['video3']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['video3']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video3']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video3']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['video3'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['btn_label']['exit'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_aforo_liquidacionCR_tramo_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_aforo_liquidacionCR_tramo_mob");
 parent.scAjaxDetailHeight("form_aforo_liquidacionCR_tramo_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aforo_liquidacionCR_tramo_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
