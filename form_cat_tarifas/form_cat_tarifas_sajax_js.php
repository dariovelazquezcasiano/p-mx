  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cat_tarifas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate fld_grupo_
  function do_ajax_form_cat_tarifas_validate_fld_grupo_(iNumLinha)
  {
    var nomeCampo_fld_grupo_ = "fld_grupo_" + iNumLinha;
    var var_fld_grupo_ = scAjaxGetFieldSelect(nomeCampo_fld_grupo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cat_tarifas_validate_fld_grupo_(var_fld_grupo_, iNumLinha, var_script_case_init, do_ajax_form_cat_tarifas_validate_fld_grupo__cb);
  } // do_ajax_form_cat_tarifas_validate_fld_grupo_

  function do_ajax_form_cat_tarifas_validate_fld_grupo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "fld_grupo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fld_grupo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "fld_grupo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fld_grupo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cat_tarifas_validate_fld_grupo__cb

  // ---------- Validate fld_caseta_
  function do_ajax_form_cat_tarifas_validate_fld_caseta_(iNumLinha)
  {
    var nomeCampo_fld_caseta_ = "fld_caseta_" + iNumLinha;
    var var_fld_caseta_ = scAjaxGetFieldSelect(nomeCampo_fld_caseta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cat_tarifas_validate_fld_caseta_(var_fld_caseta_, iNumLinha, var_script_case_init, do_ajax_form_cat_tarifas_validate_fld_caseta__cb);
  } // do_ajax_form_cat_tarifas_validate_fld_caseta_

  function do_ajax_form_cat_tarifas_validate_fld_caseta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fld_caseta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fld_caseta_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fld_caseta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fld_caseta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cat_tarifas_validate_fld_caseta__cb

  // ---------- Validate fld_fecha_ini_
  function do_ajax_form_cat_tarifas_validate_fld_fecha_ini_(iNumLinha)
  {
    var nomeCampo_fld_fecha_ini_ = "fld_fecha_ini_" + iNumLinha;
    var var_fld_fecha_ini_ = scAjaxGetFieldText(nomeCampo_fld_fecha_ini_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cat_tarifas_validate_fld_fecha_ini_(var_fld_fecha_ini_, iNumLinha, var_script_case_init, do_ajax_form_cat_tarifas_validate_fld_fecha_ini__cb);
  } // do_ajax_form_cat_tarifas_validate_fld_fecha_ini_

  function do_ajax_form_cat_tarifas_validate_fld_fecha_ini__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fld_fecha_ini_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fld_fecha_ini_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fld_fecha_ini_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fld_fecha_ini_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cat_tarifas_validate_fld_fecha_ini__cb

  // ---------- Validate fld_fecha_fin_
  function do_ajax_form_cat_tarifas_validate_fld_fecha_fin_(iNumLinha)
  {
    var nomeCampo_fld_fecha_fin_ = "fld_fecha_fin_" + iNumLinha;
    var var_fld_fecha_fin_ = scAjaxGetFieldText(nomeCampo_fld_fecha_fin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cat_tarifas_validate_fld_fecha_fin_(var_fld_fecha_fin_, iNumLinha, var_script_case_init, do_ajax_form_cat_tarifas_validate_fld_fecha_fin__cb);
  } // do_ajax_form_cat_tarifas_validate_fld_fecha_fin_

  function do_ajax_form_cat_tarifas_validate_fld_fecha_fin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fld_fecha_fin_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fld_fecha_fin_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fld_fecha_fin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fld_fecha_fin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cat_tarifas_validate_fld_fecha_fin__cb

  // ---------- Validate fld_tarifa_
  function do_ajax_form_cat_tarifas_validate_fld_tarifa_(iNumLinha)
  {
    var nomeCampo_fld_tarifa_ = "fld_tarifa_" + iNumLinha;
    var var_fld_tarifa_ = scAjaxGetFieldText(nomeCampo_fld_tarifa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cat_tarifas_validate_fld_tarifa_(var_fld_tarifa_, iNumLinha, var_script_case_init, do_ajax_form_cat_tarifas_validate_fld_tarifa__cb);
  } // do_ajax_form_cat_tarifas_validate_fld_tarifa_

  function do_ajax_form_cat_tarifas_validate_fld_tarifa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fld_tarifa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fld_tarifa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fld_tarifa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fld_tarifa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cat_tarifas_validate_fld_tarifa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cat_tarifas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cat_tarifas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cat_tarifas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cat_tarifas_add_new_line_cb);
  } // do_ajax_form_cat_tarifas_add_new_line

  function do_ajax_form_cat_tarifas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cat_tarifas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cat_tarifas_backup_line(iNumLinha)
  {
    var var_fld_grupo_ = scAjaxGetFieldSelect("fld_grupo_" + iNumLinha);
    var var_fld_caseta_ = scAjaxGetFieldSelect("fld_caseta_" + iNumLinha);
    var var_fld_fecha_ini_ = scAjaxGetFieldText("fld_fecha_ini_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cat_tarifas_backup_line(var_fld_grupo_, var_fld_caseta_, var_fld_fecha_ini_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cat_tarifas_backup_line_cb);
  } // do_ajax_form_cat_tarifas_backup_line

  function do_ajax_form_cat_tarifas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cat_tarifas_backup_line_cb

  function do_ajax_form_cat_tarifas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cat_tarifas_cancel_insert

  function do_ajax_form_cat_tarifas_cancel_update(iSeqVert)
  {
    do_ajax_form_cat_tarifas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cat_tarifas_cancel_update

  function do_ajax_form_cat_tarifas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cat_tarifas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cat_tarifas_table_refresh()
  {
    var var_fld_grupo_ = document.F2.fld_grupo_.value;
    var var_fld_caseta_ = document.F2.fld_caseta_.value;
    var var_fld_fecha_ini_ = document.F2.fld_fecha_ini_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cat_tarifas_table_refresh(var_fld_grupo_, var_fld_caseta_, var_fld_fecha_ini_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cat_tarifas_table_refresh_cb);
  } //  do_ajax_form_cat_tarifas_table_refresh

  function do_ajax_form_cat_tarifas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.fld_grupo_.value = scAjaxGetKeyValue("fld_grupo_");
    document.F2.fld_caseta_.value = scAjaxGetKeyValue("fld_caseta_");
    document.F2.fld_fecha_ini_.value = scAjaxGetKeyValue("fld_fecha_ini_");
    ...
    scAjaxAlert(do_ajax_form_cat_tarifas_table_refresh_cb_after_alert);
  } // do_ajax_form_cat_tarifas_table_refresh_cb
  function do_ajax_form_cat_tarifas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cat_tarifas_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cat_tarifas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cat_tarifas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_fld_caseta_ = scAjaxGetFieldSelect("fld_caseta_" + iNumLinha);
    var var_fld_fecha_ini_ = scAjaxGetFieldText("fld_fecha_ini_" + iNumLinha);
    var var_fld_fecha_fin_ = scAjaxGetFieldText("fld_fecha_fin_" + iNumLinha);
    var var_fld_tarifa_ = scAjaxGetFieldText("fld_tarifa_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_cat_tarifas_submit_form(var_fld_grupo_, var_fld_caseta_, var_fld_fecha_ini_, var_fld_fecha_fin_, var_fld_tarifa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cat_tarifas_submit_form_cb);
  } // do_ajax_form_cat_tarifas_submit_form

  function do_ajax_form_cat_tarifas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fld_grupo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fld_caseta_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fld_fecha_ini_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fld_fecha_fin_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fld_tarifa_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cat_tarifas_submit_form_cb_after_alert);
  } // do_ajax_form_cat_tarifas_submit_form_cb
  function do_ajax_form_cat_tarifas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cat_tarifas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cat_tarifas_navigate_form()
  {
    perform_ajax_form_cat_tarifas_navigate_form();
  }

  function perform_ajax_form_cat_tarifas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("fld_grupo_" + iNavForm);
      scAjaxHideErrorDisplay("fld_caseta_" + iNavForm);
      scAjaxHideErrorDisplay("fld_fecha_ini_" + iNavForm);
      scAjaxHideErrorDisplay("fld_fecha_fin_" + iNavForm);
      scAjaxHideErrorDisplay("fld_tarifa_" + iNavForm);
    }
    var var_fld_grupo_ = document.F2.fld_grupo_.value;
    var var_fld_caseta_ = document.F2.fld_caseta_.value;
    var var_fld_fecha_ini_ = document.F2.fld_fecha_ini_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cat_tarifas_navigate_form(var_fld_grupo_, var_fld_caseta_, var_fld_fecha_ini_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cat_tarifas_navigate_form_cb);
  } // do_ajax_form_cat_tarifas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cat_tarifas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cat_tarifas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.fld_grupo_.value = scAjaxGetKeyValue("fld_grupo_" + var_last_index);
    document.F2.fld_caseta_.value = scAjaxGetKeyValue("fld_caseta_" + var_last_index);
    document.F2.fld_fecha_ini_.value = scAjaxGetKeyValue("fld_fecha_ini_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cat_tarifas_navigate_form_cb_after_alert);
  } // do_ajax_form_cat_tarifas_navigate_form_cb
  function do_ajax_form_cat_tarifas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cat_tarifas_navigate_form_cb_after_alert

    function sc_form_cat_tarifas_get_last_line_number()
    {
    ...
    } //sc_form_cat_tarifas_get_last_line_number

  function sc_hide_form_cat_tarifas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "fld_grupo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fld_caseta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fld_fecha_ini_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fld_fecha_fin_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fld_tarifa_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["fld_grupo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cat_graficas_tag_fld_k_tipo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fld_caseta_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dat_tag_fld_fld_caseta'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fld_fecha_ini_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_fecha_ini'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fld_fecha_fin_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cat_tarifas_fld_fld_fecha_fin'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fld_tarifa_" + iNumLinha] = {"label": "Tarifa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["fld_grupo_"][iNumLinha] = "fld_grupo_" + iNumLinha;
    ajax_field_mult["fld_caseta_"][iNumLinha] = "fld_caseta_" + iNumLinha;
    ajax_field_mult["fld_fecha_ini_"][iNumLinha] = "fld_fecha_ini_" + iNumLinha;
    ajax_field_mult["fld_fecha_fin_"][iNumLinha] = "fld_fecha_fin_" + iNumLinha;
    ajax_field_mult["fld_tarifa_"][iNumLinha] = "fld_tarifa_" + iNumLinha;
    ajax_field_id["fld_grupo_" + iNumLinha] = new Array("hidden_field_label_fld_grupo_", "hidden_field_data_fld_grupo_" + iNumLinha);
    ajax_field_id["fld_caseta_" + iNumLinha] = new Array("hidden_field_label_fld_caseta_", "hidden_field_data_fld_caseta_" + iNumLinha);
    ajax_field_id["fld_fecha_ini_" + iNumLinha] = new Array("hidden_field_label_fld_fecha_ini_", "hidden_field_data_fld_fecha_ini_" + iNumLinha);
    ajax_field_id["fld_fecha_fin_" + iNumLinha] = new Array("hidden_field_label_fld_fecha_fin_", "hidden_field_data_fld_fecha_fin_" + iNumLinha);
    ajax_field_id["fld_tarifa_" + iNumLinha] = new Array("hidden_field_label_fld_tarifa_", "hidden_field_data_fld_tarifa_" + iNumLinha);
    ajax_error_count["fld_grupo_" + iNumLinha] = "off";
    ajax_error_count["fld_caseta_" + iNumLinha] = "off";
    ajax_error_count["fld_fecha_ini_" + iNumLinha] = "off";
    ajax_error_count["fld_fecha_fin_" + iNumLinha] = "off";
    ajax_error_count["fld_tarifa_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["fld_grupo_" + iNumLinha] = "on";
    ajax_read_only["fld_caseta_" + iNumLinha] = "on";
    ajax_read_only["fld_fecha_ini_" + iNumLinha] = "on";
    ajax_read_only["fld_fecha_fin_" + iNumLinha] = "off";
    ajax_read_only["fld_tarifa_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["fld_caseta_" + iNumLinha] = "on";
    ajax_read_only["fld_fecha_ini_" + iNumLinha] = "on";
    ajax_read_only["fld_fecha_fin_" + iNumLinha] = "on";
    ajax_read_only["fld_tarifa_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["fld_grupo_" + iNumLinha] = null;
    ajax_error_list["fld_caseta_" + iNumLinha] = null;
    ajax_error_list["fld_fecha_ini_" + iNumLinha] = null;
    ajax_error_list["fld_fecha_fin_" + iNumLinha] = null;
    ajax_error_list["fld_tarifa_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "fld_grupo_": new Array(),
    "fld_caseta_": new Array(),
    "fld_fecha_ini_": new Array(),
    "fld_fecha_fin_": new Array(),
    "fld_tarifa_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["fld_grupo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fld_grupo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fld_grupo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fld_grupo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fld_grupo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fld_caseta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fld_caseta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fld_caseta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fld_caseta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fld_caseta_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fld_fecha_ini_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fld_fecha_ini_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fld_fecha_ini_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fld_fecha_ini_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fld_fecha_ini_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fld_fecha_fin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fld_fecha_fin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fld_fecha_fin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fld_fecha_fin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fld_fecha_fin_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fld_tarifa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fld_tarifa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fld_tarifa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fld_tarifa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fld_tarifa_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fld_grupo_'])) ? $this->nmgp_cmp_readonly['fld_grupo_'] : 'on';
?>
    scAjaxFieldRead("fld_grupo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fld_caseta_'])) ? $this->nmgp_cmp_readonly['fld_caseta_'] : 'on';
?>
    scAjaxFieldRead("fld_caseta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fld_fecha_ini_'])) ? $this->nmgp_cmp_readonly['fld_fecha_ini_'] : 'on';
?>
    scAjaxFieldRead("fld_fecha_ini_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fld_fecha_fin_'])) ? $this->nmgp_cmp_readonly['fld_fecha_fin_'] : 'off';
?>
    scAjaxFieldRead("fld_fecha_fin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fld_tarifa_'])) ? $this->nmgp_cmp_readonly['fld_tarifa_'] : 'off';
?>
    scAjaxFieldRead("fld_tarifa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("fld_grupo_" + iSeq, "on");
    scAjaxFieldRead("fld_caseta_" + iSeq, "on");
    scAjaxFieldRead("fld_fecha_ini_" + iSeq, "on");
    scAjaxFieldRead("fld_fecha_fin_" + iSeq, "on");
    scAjaxFieldRead("fld_tarifa_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fld_grupo_" + iRow] || "on" == ajax_error_count["fld_caseta_" + iRow] || "on" == ajax_error_count["fld_fecha_ini_" + iRow] || "on" == ajax_error_count["fld_fecha_fin_" + iRow] || "on" == ajax_error_count["fld_tarifa_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fld_grupo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fld_caseta_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fld_fecha_ini_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fld_fecha_fin_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fld_tarifa_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fld_grupo_" + iRow] && "off" == ajax_error_count["fld_caseta_" + iRow] && "off" == ajax_error_count["fld_fecha_ini_" + iRow] && "off" == ajax_error_count["fld_fecha_fin_" + iRow] && "off" == ajax_error_count["fld_tarifa_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["fld_grupo_" + iRow] = "off";
        ajax_error_count["fld_caseta_" + iRow] = "off";
        ajax_error_count["fld_fecha_ini_" + iRow] = "off";
        ajax_error_count["fld_fecha_fin_" + iRow] = "off";
        ajax_error_count["fld_tarifa_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_fld_grupo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fld_caseta_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fld_fecha_ini_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fld_fecha_fin_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fld_tarifa_" + iRow).removeClass("scFormErrorLine");
    }
  }
