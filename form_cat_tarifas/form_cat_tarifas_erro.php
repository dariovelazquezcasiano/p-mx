...
$old_error_handler = set_error_handler("form_cat_tarifas_scriptcase_error_handler");

function form_cat_tarifas_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['form_cat_tarifas']['contr_erro']) && $_SESSION['scriptcase']['form_cat_tarifas']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_cat_tarifas->contr_form_cat_tarifas->Apl_com_erro = true;
            if ($inicial_form_cat_tarifas->contr_form_cat_tarifas->NM_ajax_flag)
            {
                $inicial_form_cat_tarifas->contr_form_cat_tarifas->NM_ajax_info['errList']['geral_form_cat_tarifas'][] = $msg;
                return;
            }
            form_cat_tarifas_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_cat_tarifas_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_cat_tarifas'])  && '' != $_SESSION['scriptcase']['error_icon']['form_cat_tarifas'])  ? $_SESSION['scriptcase']['error_icon']['form_cat_tarifas']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_cat_tarifas']) && '' != $_SESSION['scriptcase']['error_span_title']['form_cat_tarifas']) ? $_SESSION['scriptcase']['error_span_title']['form_cat_tarifas'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_cat_tarifas']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_cat_tarifas']) ? $_SESSION['scriptcase']['error_icon_title']['form_cat_tarifas'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_cat_tarifas']['error_buffer'] .= ob_get_flush();
}
